...
- (void)stop;	// IMP=0x001000000000275c
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000002665
- (id)createTaskScheduler;	// IMP=0x0010000000002635
- (id)criteria;	// IMP=0x00100000000024e0
