...
- (void).cxx_destruct;	// IMP=0x00200000000081a5
...
- (_Bool)commitWithError:(id *)arg1;	// IMP=0x0010000000008038
- (id)description;	// IMP=0x0010000000007fba
- (id)initWithPluginID:(id)arg1;	// IMP=0x0010000000007e53
