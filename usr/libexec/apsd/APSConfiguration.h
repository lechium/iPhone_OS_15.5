...
+ (void)invalidateConfigurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x004000000006994b
+ (void)loadConfigurationForEnvironment:(id)arg1 interface:(long long)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00100000000695dd
+ (id)configurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x001000000006937b
+ (id)_onQueue_configurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x001000000006915d
+ (void)initialize;	// IMP=0x0010000000069106
- (void).cxx_destruct;	// IMP=0x002000000006b3d8
...
- (void)setExpiryInterval:(double)arg1 expirationBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000006b197
- (_Bool)_isExpired;	// IMP=0x001000000006b137
- (_Bool)_isLoaded;	// IMP=0x001000000006b12e
...
- (id)bagExpiryInterval;	// IMP=0x001000000006b080
...
- (id)ExpensiveConditionsBackOffInterval;	// IMP=0x001000000006af24
...
- (void)_finishLoadWithResponse:(id)arg1 urlHost:(id)arg2 data:(id)arg3;	// IMP=0x001000000006a785
- (void)_failWithError:(id)arg1;	// IMP=0x001000000006a666
- (void)_callCompletionBlocksWithError:(id)arg1;	// IMP=0x001000000006a3e7
- (void)addCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000006a295
- (id)pendingCompletionBocks;	// IMP=0x001000000006a287
- (void)dealloc;	// IMP=0x001000000006a248
- (id)initWithEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x0010000000069c0e
