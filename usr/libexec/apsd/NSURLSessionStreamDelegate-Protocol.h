...
@class MISSING_TYPE, NSInputStream, NSOutputStream, NSURLSession, NSURLSessionStreamTask;
...
- (MISSING_TYPE *)URLSession:writeClosedForStreamTask: /* Error: Ran out of types for this method. */;
