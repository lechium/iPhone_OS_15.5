...
+ (id)sharedInstance;	// IMP=0x0040000000091c7a
- (void).cxx_destruct;	// IMP=0x002000000009252e
...
- (void)removeListener:(id)arg1;	// IMP=0x0010000000092456
- (void)addListener:(id)arg1;	// IMP=0x00100000000923c2
- (void)_setSystemLockState:(_Bool)arg1;	// IMP=0x0010000000092271
- (void)_setSystemScreenState:(_Bool)arg1;	// IMP=0x0010000000092120
- (void)_systemWillSleep;	// IMP=0x0010000000092069
- (void)_systemDidWake;	// IMP=0x001000000009204c
- (void)_deliverNotificationSelector:(SEL)arg1;	// IMP=0x0010000000091f9b
- (void)dealloc;	// IMP=0x0010000000091d39
- (id)init;	// IMP=0x0010000000091ccf
