...
- (void).cxx_destruct;	// IMP=0x002000000008191f
...
- (void)setHasTimedOut:(_Bool)arg1;	// IMP=0x00100000000818d9
- (_Bool)hasTimedOut;	// IMP=0x00100000000818d0
@property(nonatomic) _Bool sent; // @synthesize sent=_sent;
- (id)initWithSendBlock:(CDUnknownBlockType)arg1 completionBlock:(CDUnknownBlockType)arg2 timeout:(double)arg3;	// IMP=0x00100000000817ec
