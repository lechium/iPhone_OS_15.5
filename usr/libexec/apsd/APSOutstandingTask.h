...
- (void).cxx_destruct;	// IMP=0x0020000000002dac
...
- (id)initWithDNSTask:(id)arg1 messageId:(unsigned long long)arg2 taskId:(unsigned long long)arg3 taskStatus:(unsigned long long)arg4;	// IMP=0x0010000000002c9f
- (id)initWithDNSTask:(id)arg1;	// IMP=0x0010000000002c2c
