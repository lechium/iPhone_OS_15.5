...
- (void).cxx_destruct;	// IMP=0x00200000000118a2
...
- (id)name;	// IMP=0x00100000000116f9
- (id)initWithGuid:(id)arg1 topic:(id)arg2 changedReason:(long long)arg3 didCauseFilterChange:(_Bool)arg4;	// IMP=0x001000000001162e
