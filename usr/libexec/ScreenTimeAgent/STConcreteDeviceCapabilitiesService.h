...
- (void).cxx_destruct;	// IMP=0x0020000000060255
@property __weak id <STDeviceCapabilitiesServiceDelegate> delegate; // @synthesize delegate;
- (void)isCapabilityEnabledForUser:(id)arg1 capability:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000060194
