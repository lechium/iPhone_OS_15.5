...
- (void).cxx_destruct;	// IMP=0x0020000000004e52
...
- (void)reloadAccountState:(_Bool)arg1;	// IMP=0x0010000000003cf3
- (void)debouncer:(id)arg1 didDebounce:(id)arg2;	// IMP=0x0010000000003cdf
- (id)initWithDelegate:(id)arg1;	// IMP=0x001000000000351a
- (void)dealloc;	// IMP=0x001000000000349c
