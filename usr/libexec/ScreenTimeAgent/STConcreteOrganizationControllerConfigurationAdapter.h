...
- (void).cxx_destruct;	// IMP=0x0020000000019335
...
- (id)_handleConfigurationAsSettings:(id)arg1;	// IMP=0x0010000000018e44
- (id)_handleConfigurationAsBlueprint:(id)arg1 timeout:(unsigned long long)arg2;	// IMP=0x0010000000018775
- (id)handleConfigurationChange:(id)arg1;	// IMP=0x0010000000018369
- (id)initWithFamilySettingsManager:(id)arg1 requestManager:(id)arg2 persistentContainer:(id)arg3;	// IMP=0x00100000000182a6
