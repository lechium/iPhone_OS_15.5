...
- (void).cxx_destruct;	// IMP=0x00200000000272ec
...
- (void)observer:(id)arg1 didObserveCoreDataChanges:(id)arg2;	// IMP=0x001000000002715a
- (id)writeDeviceStateChange:(id)arg1;	// IMP=0x00100000000270d7
- (id)readDeviceStateChangeForLocalDevice;	// IMP=0x0010000000027087
- (id)initWithObserver:(id)arg1 transformer:(id)arg2 reverseTransformer:(id)arg3;	// IMP=0x0010000000026f6f
