...
- (void).cxx_destruct;	// IMP=0x0020000000099411
...
- (void)localTransport:(id)arg1 didReceivePayload:(id)arg2;	// IMP=0x001000000009930b
- (void)transport:(id)arg1 didReceiveUpdatedState:(unsigned long long)arg2 forPayloadUUID:(id)arg3 context:(id)arg4 error:(id)arg5;	// IMP=0x0010000000099266
- (void)transport:(id)arg1 didReceiveData:(id)arg2 altURI:(id)arg3 appleID:(id)arg4 serverReceivedTime:(id)arg5;	// IMP=0x0010000000098bac
- (void)_forwardPayloadToLocalTransport:(id)arg1;	// IMP=0x0010000000098660
- (void)_updatePayloadUUID:(id)arg1 toState:(unsigned long long)arg2 context:(id)arg3;	// IMP=0x0000000000098523
- (void)_sendPayload:(id)arg1;	// IMP=0x00100000000980da
- (void)_operation:(id)arg1 finishedDidChange:(_Bool)arg2;	// IMP=0x0010000000097ff8
- (void)_operation:(id)arg1 executingDidChange:(_Bool)arg2;	// IMP=0x0010000000097f78
- (void)_operation:(id)arg1 cancelledDidChange:(_Bool)arg2;	// IMP=0x0010000000097ef8
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000097c53
- (void)_processEnqueuedPayloads;	// IMP=0x00100000000976ed
- (void)enqueuePayload:(id)arg1;	// IMP=0x0010000000097533
- (void)invalidate;	// IMP=0x0010000000097364
- (void)resume;	// IMP=0x00100000000971c9
- (id)initWithTransport:(id)arg1 localTransport:(id)arg2 persistenceController:(id)arg3;	// IMP=0x0010000000096d98
