...
- (void).cxx_destruct;	// IMP=0x00200000000a5b6e
...
- (id)_createCommunicationSafetyStateEventWithContext:(id)arg1;	// IMP=0x00100000000a5a67
- (void)startSendingEvents;	// IMP=0x00100000000a58b8
- (id)initWithPersistenceController:(id)arg1;	// IMP=0x00100000000a581c
