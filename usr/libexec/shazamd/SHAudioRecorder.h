...
+ (id)audioBufferFromData:(void *)arg1 byteSize:(unsigned long long)arg2 inFormat:(id)arg3;	// IMP=0x0020000000012f81
- (void).cxx_destruct;	// IMP=0x0020000000013607
...
- (void)startAudioQueueAfterRetrySecondsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000132f9
- (_Bool)hasAudioQueueFailedWithStatus:(int)arg1 annotateError:(id *)arg2;	// IMP=0x00100000000132a3
- (_Bool)stopAudioQueueAndClearBuffersWithError:(id *)arg1;	// IMP=0x001000000001309a
- (_Bool)isAudioQueueRunning;	// IMP=0x0010000000013035
- (_Bool)stopRecordingWithError:(id *)arg1;	// IMP=0x0010000000012f45
- (void)startRecordingWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000128e4
- (id)initWithRecordingSource:(long long)arg1;	// IMP=0x0010000000012881
- (void)dealloc;	// IMP=0x00100000000127e5
