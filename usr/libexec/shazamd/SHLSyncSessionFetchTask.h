...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001c966
- (void).cxx_destruct;	// IMP=0x002000000001ca0c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001c8df
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001c7f8
@property(readonly, nonatomic) long long size;
@property(readonly, nonatomic) long long type;
- (id)init;	// IMP=0x001000000001c715
