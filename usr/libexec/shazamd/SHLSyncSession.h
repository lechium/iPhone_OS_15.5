...
- (void).cxx_destruct;	// IMP=0x0020000000035c6f
...
- (_Bool)cleanupTransactionsWithError:(id *)arg1;	// IMP=0x0010000000035b03
- (_Bool)undoTransactionWithError:(id *)arg1;	// IMP=0x0010000000035a9f
- (_Bool)commitTransactionWithError:(id *)arg1;	// IMP=0x0010000000035a3b
- (_Bool)startTransactionWithError:(id *)arg1;	// IMP=0x0010000000035988
- (void)executeFetchTask:(id)arg1;	// IMP=0x00100000000354a7
- (void)executeModifyTask:(id)arg1;	// IMP=0x0010000000034f8e
- (void)executeTask:(id)arg1;	// IMP=0x0010000000034f34
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0010000000034e91
