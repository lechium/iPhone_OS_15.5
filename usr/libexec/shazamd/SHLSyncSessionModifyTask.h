...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000039380
...
- (void)updateProgress;	// IMP=0x0010000000039388
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000392ae
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000390bf
@property(readonly, nonatomic) NSArray *allItemIdentifiers;
@property(readonly, nonatomic) long long size;
@property(readonly, nonatomic) long long type;
- (id)subdivideTaskIntoBatchesOfSize:(long long)arg1;	// IMP=0x00100000000386ab
- (id)_init;	// IMP=0x001000000003857f
- (id)initWithTracksToModify:(id)arg1 groupsToModify:(id)arg2;	// IMP=0x00100000000383f8
