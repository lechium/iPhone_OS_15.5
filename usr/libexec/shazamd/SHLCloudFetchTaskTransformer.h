...
- (void).cxx_destruct;	// IMP=0x0020000000034d8c
...
- (id)configurationsByRecordZoneIDUsingCache:(id)arg1;	// IMP=0x00100000000349a7
- (id)recordIDsFromCloudBackedZones:(id)arg1;	// IMP=0x001000000003477e
- (id)cloudBackedZoneChangesOperationFromFetchTask:(id)arg1 forChangedZones:(id)arg2 container:(id)arg3;	// IMP=0x001000000003367b
- (id)cloudBackedDatabaseChangesOperationFromFetchTask:(id)arg1 container:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000032655
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0010000000032581
