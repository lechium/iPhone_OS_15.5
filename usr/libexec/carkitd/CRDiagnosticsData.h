...
- (void).cxx_destruct;	// IMP=0x002000000002c63f
...
- (id)description;	// IMP=0x001000000002c48f
- (void)_createCarPlayDiagnosticsFolder;	// IMP=0x001000000002b91d
- (id)initWithDeviceScreenshot:(id)arg1 carScreenshot:(id)arg2 configuration:(id)arg3 attachmentURLs:(id)arg4 siriInfo:(id)arg5 activeBundleID:(id)arg6 transportType:(unsigned long long)arg7;	// IMP=0x001000000002b778
