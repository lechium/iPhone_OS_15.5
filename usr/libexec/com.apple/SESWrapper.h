...
- (void).cxx_destruct;	// IMP=0x00200000000600e6
...
- (void)dealloc;	// IMP=0x001000000005ff6c
- (id)recoveryResponseForBlob:(id)arg1;	// IMP=0x001000000005f6d9
- (id)srpResponseForEscrowBlob:(id)arg1 withKey:(struct __SecKey *)arg2 withFullCCKey:(struct ccrsa_full_ctx *)arg3;	// IMP=0x001000000005eb2b
- (id)decodedEscrowRecordFromData:(id)arg1 stingray:(_Bool)arg2 env:(id)arg3 duplicate:(_Bool)arg4;	// IMP=0x001000000005dcb4
- (id)encodedEscrowRecordWithPublicKey:(struct __SecKey *)arg1 error:(id *)arg2;	// IMP=0x001000000005bd4d
- (id)srpRecoveryBlobFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000005adcd
- (void)srpRecoveryUpdateDSID:(id)arg1 recoveryPassphrase:(id)arg2;	// IMP=0x001000000005ad4f
- (unsigned long long)srpPublicKeySize;	// IMP=0x001000000005acf5
- (unsigned long long)srpKeySize;	// IMP=0x001000000005ac7c
- (id)srpInitBlob;	// IMP=0x001000000005aaf4
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5 ckvrFlag:(_Bool)arg6 reqVersion:(int)arg7;	// IMP=0x001000000005a882
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5;	// IMP=0x001000000005a79d
- (id)initWithRequest:(id)arg1 ckvrFlag:(_Bool)arg2 reqVersion:(int)arg3;	// IMP=0x001000000005a5e0
- (id)initWithRequest:(id)arg1 reqVersion:(int)arg2;	// IMP=0x001000000005a57f
- (id)initWithRequest:(id)arg1;	// IMP=0x001000000005a56b
