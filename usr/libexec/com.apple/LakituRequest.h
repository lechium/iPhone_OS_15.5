...
- (void)performRequestWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000040703
- (id)sessionConfig;	// IMP=0x00100000000405cf
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000040270
@property(readonly, nonatomic) NSMutableURLRequest *urlRequest;
- (id)protectionSpace;	// IMP=0x00100000000401b4
- (id)credential;	// IMP=0x00100000000401ac
- (id)validateInput;	// IMP=0x0010000000040062
- (id)additionalHeaders;	// IMP=0x0010000000040055
- (id)authorizationHeader;	// IMP=0x001000000004004d
- (id)bodyDictionary;	// IMP=0x0010000000040045
