...
+ (id)createPrerecordFromCandidate:(id)arg1 storedCertificate:(id)arg2 request:(id)arg3 error:(id *)arg4;	// IMP=0x001000000004d069
- (void).cxx_destruct;	// IMP=0x001000000004250e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000421d4
- (unsigned long long)hash;	// IMP=0x0010000000042073
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000041daa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000041b7e
- (void)copyTo:(id)arg1;	// IMP=0x00100000000419db
- (void)writeTo:(id)arg1;	// IMP=0x0010000000041855
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000041848
- (id)dictionaryRepresentation;	// IMP=0x0010000000041253
- (id)description;	// IMP=0x00100000000411a4
@property(readonly, nonatomic) _Bool hasDuplicateEscrowBlob;
- (int)StringAsPassphraseType:(id)arg1;	// IMP=0x00100000000410e0
- (id)passphraseTypeAsString:(int)arg1;	// IMP=0x0010000000041062
...
- (id)initWithCandidate:(id)arg1 certificate:(id)arg2 escrowBlob:(id)arg3 passphraseType:(int)arg4;	// IMP=0x001000000004ce20
