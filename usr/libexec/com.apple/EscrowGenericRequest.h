...
- (void).cxx_destruct;	// IMP=0x0020000000019aff
...
- (id)_filteredMetadataForDoubleEnrollment:(id)arg1;	// IMP=0x001000000001970f
- (id)urlString;	// IMP=0x001000000001965f
- (id)urlRequest;	// IMP=0x0010000000019525
- (id)authorizationHeader;	// IMP=0x0010000000019415
- (id)authorizationHeaderWithUser:(id)arg1 password:(id)arg2 authType:(id)arg3;	// IMP=0x0010000000019218
- (id)bodyDictionary;	// IMP=0x0010000000018ef7
- (id)validateInput;	// IMP=0x0010000000018ba8
...
- (id)currentAccount;	// IMP=0x0010000000018729
@property(readonly, copy, nonatomic) NSString *recoveryPassphrase; // @synthesize recoveryPassphrase=_recoveryPassphrase;
- (id)loggingDescription;	// IMP=0x0010000000018555
- (id)initWithRequest:(id)arg1;	// IMP=0x00100000000180b3
