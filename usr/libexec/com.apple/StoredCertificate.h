...
- (void).cxx_destruct;	// IMP=0x00200000000177f7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000001767b
- (unsigned long long)hash;	// IMP=0x00100000000175d8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000017478
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000017360
- (void)copyTo:(id)arg1;	// IMP=0x001000000001729d
- (void)writeTo:(id)arg1;	// IMP=0x00100000000171e9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000171dc
- (id)dictionaryRepresentation;	// IMP=0x0010000000016ee0
- (id)description;	// IMP=0x0010000000016e31
