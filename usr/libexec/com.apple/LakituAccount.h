...
+ (id)personaAwareAccountWithDSID:(id)arg1;	// IMP=0x004000000004de12
- (void).cxx_destruct;	// IMP=0x002000000004e8ea
...
- (id)initWithACAccount:(id)arg1;	// IMP=0x001000000004e05b
