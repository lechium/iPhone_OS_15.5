...
@class MISSING_TYPE, NSCachedURLResponse, NSData, NSURLSession, NSURLSessionDataTask, NSURLSessionDownloadTask, NSURLSessionStreamTask;
...
- (MISSING_TYPE *)URLSession:dataTask:didReceiveResponse:completionHandler: /* Error: Ran out of types for this method. */;
@end
