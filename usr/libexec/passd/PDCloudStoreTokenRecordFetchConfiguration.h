...
- (void).cxx_destruct;	// IMP=0x002000000016d632
...
- (id)description;	// IMP=0x001000000016d46b
- (_Bool)hasContainerDatabase;	// IMP=0x001000000016d45d
- (_Bool)hasCloudStoreZones;	// IMP=0x001000000016d2e4
