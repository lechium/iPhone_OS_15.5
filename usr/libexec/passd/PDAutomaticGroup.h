...
+ (id)createAutomaticGroupForPass:(id)arg1 withGroupingProfile:(id)arg2;	// IMP=0x0040000000316009
- (void).cxx_destruct;	// IMP=0x0020000000316e0c
...
- (_Bool)updateOrderWithCatalogGroup:(id)arg1;	// IMP=0x001000000031697c
- (_Bool)removePass:(id)arg1;	// IMP=0x00100000003167dd
- (_Bool)addPass:(id)arg1 withGroupingProfile:(id)arg2;	// IMP=0x00100000003162c6
