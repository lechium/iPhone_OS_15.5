...
+ (_Bool)supportsCoalescing;	// IMP=0x00200000001c5f92
+ (_Bool)allowReinsertionAfterDismissal;	// IMP=0x00100000001c5f8a
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001c5a03
- (void).cxx_destruct;	// IMP=0x00200000001c6ad0
...
- (id)notificationContentWithDataSource:(id)arg1;	// IMP=0x00100000001c5fb2
- (unsigned long long)coalesceWithExistingUserNotification:(id)arg1;	// IMP=0x00100000001c5faa
@property(readonly, nonatomic) unsigned long long notificationType;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isCashFamilyNotification;	// IMP=0x00100000001c5f68
- (id)description;	// IMP=0x00100000001c5e25
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001c5cb4
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001c5a0b
- (id)initWithNotificationIdentifier:(id)arg1 forPassUniqueIdentifier:(id)arg2;	// IMP=0x00100000001c5928
