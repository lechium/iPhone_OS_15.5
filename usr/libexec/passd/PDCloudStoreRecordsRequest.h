...
- (void).cxx_destruct;	// IMP=0x002000000024d46c
...
- (_Bool)canCoalesceWithRequest:(id)arg1;	// IMP=0x001000000024ccc4
- (id)description;	// IMP=0x001000000024c98a
- (void)callCompletionsWithResponse:(id)arg1 error:(id)arg2;	// IMP=0x001000000024c807
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000024c7c4
- (id)initWithRequestType:(unsigned long long)arg1 storeChanges:(_Bool)arg2 returnRecords:(_Bool)arg3 qualityOfService:(long long)arg4 groupName:(id)arg5 groupNameSuffix:(id)arg6;	// IMP=0x001000000024c6e4
