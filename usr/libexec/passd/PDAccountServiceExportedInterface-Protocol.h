...
@class CNContact, MISSING_TYPE, NSArray, NSData, NSDate, NSSet, NSString, NSTimeZone, PKAccount, PKAccountAction, PKAccountUserNotificationSettings, PKAccountUserPreferences, PKAccountWebServicePhysicalCardActionRequest, PKAccountWebServiceRequestPhysicalCardRequest, PKApplePayTrustSignature, PKPaymentDeviceMetadata, PKPhysicalCardAction, PKPhysicalCardOrder, PKVirtualCard;
...
- (MISSING_TYPE *)virtualCardsInKeychainWithCompletion: /* Error: Ran out of types for this method. */;
