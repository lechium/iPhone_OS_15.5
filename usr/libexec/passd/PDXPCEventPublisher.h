...
- (void).cxx_destruct;	// IMP=0x00200000001fd0dd
...
- (void)sendEvent:(id)arg1;	// IMP=0x00100000001fcc7a
- (void)handleEventWithAction:(unsigned int)arg1 token:(unsigned long long)arg2 descriptor:(id)arg3;	// IMP=0x00100000001fc8c8
- (id)initWithStreamName:(id)arg1;	// IMP=0x00100000001fc5a3
