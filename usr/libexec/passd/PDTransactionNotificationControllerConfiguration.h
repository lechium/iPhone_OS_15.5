...
- (void).cxx_destruct;	// IMP=0x002000000020958a
...
- (id)description;	// IMP=0x001000000020923b
- (_Bool)shouldReceiveNotificationsForPeerPaymentNotificationType:(unsigned long long)arg1;	// IMP=0x00100000002091b0
- (id)passUniqueIdentifier;	// IMP=0x001000000020919a
