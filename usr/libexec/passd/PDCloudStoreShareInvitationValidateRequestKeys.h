...
- (void).cxx_destruct;	// IMP=0x002000000013720a
...
- (id)description;	// IMP=0x00100000001370a5
- (_Bool)canCoalesceRequest:(id)arg1;	// IMP=0x0010000000136dde
- (id)initWithInvitation:(id)arg1 recipientHandle:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000136d2f
