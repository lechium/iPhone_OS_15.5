...
@class MISSING_TYPE, NSArray, NSCalendar, NSDate, NSSet, NSString, PKExpressPassInformation, PKMerchant, PKOSVersionRequirement, PKPass, PKPassUpgradeRequest, PKPaymentApplication, PKPaymentBalance, PKPaymentBalanceReminder, PKPaymentCommutePlanReminder, PKPaymentPass, PKPaymentTransactionRequest, PKPaymentWebService, PKTransitCommutePlan;
...
- (MISSING_TYPE *)setExpressWithPassInformation:credential:completion: /* Error: Ran out of types for this method. */;
