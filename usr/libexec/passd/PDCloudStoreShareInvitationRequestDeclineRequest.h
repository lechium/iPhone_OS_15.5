...
- (void).cxx_destruct;	// IMP=0x002000000013830b
...
- (id)description;	// IMP=0x0010000000138127
- (_Bool)canCoalesceRequest:(id)arg1;	// IMP=0x0010000000137e55
- (id)initWithHandle:(id)arg1 zoneName:(id)arg2 containerName:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0010000000137d77
