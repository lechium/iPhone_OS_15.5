...
- (void).cxx_destruct;	// IMP=0x002000000029a162
@property(readonly, nonatomic) PKCloudRecordArray *cloudStoreRecords; // @synthesize cloudStoreRecords=_cloudStoreRecords;
- (unsigned long long)type;	// IMP=0x001000000029a146
- (id)initWithCloudStoreRecords:(id)arg1 success:(_Bool)arg2 error:(id)arg3;	// IMP=0x001000000029a0c4
