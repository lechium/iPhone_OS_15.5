...
- (void).cxx_destruct;	// IMP=0x00200000000a9557
...
- (unsigned long long)hash;	// IMP=0x00100000000a945a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000a93ad
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a92da
