...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001dbe90
- (void).cxx_destruct;	// IMP=0x00200000001dc176
...
- (void)generateNewDeviceIdentifier;	// IMP=0x00100000001dc0b5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001dc00c
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001dbe98
- (id)description;	// IMP=0x00100000001dbda4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001dbbab
