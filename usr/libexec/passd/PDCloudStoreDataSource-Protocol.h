...
@class CKDatabaseSubscription, CKRecord, CKRecordID, NSArray, NSData, NSDate, NSDictionary, NSSet, NSString, PDCloudStoreContainerDatabase, PKAccount, PKAccountEvent, PKAccountUser, PKCloudStoreZone, PKPass, PKPaymentTransaction, PKPaymentTransactionArchive, PKPeerPaymentAccount, PKSharedAccountCloudStore;
...
- (void)markAllPassesAsUnsynced;
- (void)updatePassesWithSyncInformation:(NSArray *)arg1;
- (void)markPassAsSynced:(PKPass *)arg1 inStore:(long long)arg2;
- (NSSet *)unsyncedPassesInStore:(long long)arg1;
