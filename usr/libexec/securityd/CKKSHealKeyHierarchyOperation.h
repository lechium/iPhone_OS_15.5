...
- (void).cxx_destruct;	// IMP=0x0020000000091c8a
...
- (_Bool)ensureKeyPresent:(id)arg1 viewState:(id)arg2;	// IMP=0x0010000000091649
- (void)attemptToHealView:(id)arg1 currentTrustStates:(id)arg2;	// IMP=0x00100000000914e9
- (void)groupStart;	// IMP=0x0010000000091069
- (id)initWithDependencies:(id)arg1 allowFullRefetchResult:(_Bool)arg2 intending:(id)arg3 errorState:(id)arg4;	// IMP=0x0010000000090f53
- (id)init;	// IMP=0x0010000000090f45
