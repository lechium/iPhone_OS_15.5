...
- (void).cxx_destruct;	// IMP=0x0020000000026a7b
...
- (void)performWithStatus:(int)arg1;	// IMP=0x00100000000266bf
- (void)groupStart;	// IMP=0x0010000000026117
- (id)initWithDependencies:(id)arg1 intendedViewStatus:(int)arg2 intendedState:(id)arg3 peerMissingState:(id)arg4 errorState:(id)arg5;	// IMP=0x0010000000026017
