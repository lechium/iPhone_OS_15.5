...
- (void).cxx_destruct;	// IMP=0x00200000001bf776
...
- (void)halt;	// IMP=0x00100000001bf370
- (void)cancel;	// IMP=0x00100000001bf333
- (void)holdFetchesUntil:(id)arg1;	// IMP=0x00100000001bf321
- (id)createSuccesfulFetchDependency;	// IMP=0x00100000001bf2b6
- (void)_onqueueCreateNewFetch;	// IMP=0x00100000001beb26
- (void)maybeCreateNewFetch;	// IMP=0x00100000001beab5
- (void)maybeCreateNewFetchOnQueue;	// IMP=0x00100000001be8b3
- (id)inflightFetch;	// IMP=0x00100000001be7bc
- (id)requestSuccessfulFetchForManyReasons:(id)arg1;	// IMP=0x00100000001be67f
- (id)requestFetchDueToAPNS:(id)arg1;	// IMP=0x00100000001be2d3
- (void)notifyZoneChange:(id)arg1;	// IMP=0x00100000001be1f8
- (id)requestSuccessfulFetch:(id)arg1;	// IMP=0x00100000001be192
- (id)strongClientMap;	// IMP=0x00100000001bdf0a
- (void)registerClient:(id)arg1 zoneID:(id)arg2;	// IMP=0x00100000001bde3e
@property(readonly, copy) NSString *description;
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 reachabilityTracker:(id)arg3;	// IMP=0x00100000001bd9ba
