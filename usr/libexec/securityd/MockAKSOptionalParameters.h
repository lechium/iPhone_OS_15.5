...
- (void).cxx_destruct;	// IMP=0x002000000001060f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000001051d
- (unsigned long long)hash;	// IMP=0x00100000000104b0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000103b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000102f4
- (void)copyTo:(id)arg1;	// IMP=0x0010000000010271
- (void)writeTo:(id)arg1;	// IMP=0x00100000000101f7
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000001008b
- (id)dictionaryRepresentation;	// IMP=0x001000000000ffe1
- (id)description;	// IMP=0x001000000000ff32
