...
+ (id)trust;	// IMP=0x000000000020f648
- (void).cxx_destruct;	// IMP=0x002000000020f615
...
- (void)dealloc;	// IMP=0x001000000020f3ea
- (id)initWithRetirees:(id)arg1 fpi:(struct __OpaqueSOSFullPeerInfo *)arg2 circle:(struct __OpaqueSOSCircle *)arg3 departureCode:(int)arg4 peerExpansion:(id)arg5;	// IMP=0x001000000020f30b
- (id)init;	// IMP=0x001000000020f220
