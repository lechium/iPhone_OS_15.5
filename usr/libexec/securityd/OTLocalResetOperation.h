...
- (void).cxx_destruct;	// IMP=0x002000000002c0aa
...
- (void)groupStart;	// IMP=0x001000000002bdcd
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x001000000002bd07
