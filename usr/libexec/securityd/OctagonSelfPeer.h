...
- (void).cxx_destruct;	// IMP=0x0020000000044bca
...
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x0010000000044ad0
...
- (id)initWithPeerID:(id)arg1 signingIdentity:(id)arg2 encryptionIdentity:(id)arg3;	// IMP=0x001000000004485d
