...
- (void).cxx_destruct;	// IMP=0x00200000000c990e
...
- (void)groupStart;	// IMP=0x00100000000c91ee
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 peerUnknownState:(id)arg3 errorState:(id)arg4 forceRefetch:(_Bool)arg5 retryFlag:(id)arg6;	// IMP=0x00100000000c90c8
