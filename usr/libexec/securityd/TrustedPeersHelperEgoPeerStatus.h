...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001b7033
- (void).cxx_destruct;	// IMP=0x00200000001b6ff5
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001b6d96
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001b69bf
- (id)description;	// IMP=0x00100000001b692c
- (id)initWithEgoPeerID:(id)arg1 egoPeerMachineID:(id)arg2 status:(unsigned long long)arg3 viablePeerCountsByModelID:(id)arg4 peerCountsByMachineID:(id)arg5 isExcluded:(_Bool)arg6 isLocked:(_Bool)arg7;	// IMP=0x00100000001b66c9
