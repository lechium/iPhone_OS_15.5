...
- (void).cxx_destruct;	// IMP=0x002000000012e0a1
...
- (void);	// IMP=0x001000000012df5e
@property(retain, nonatomic) CKDatabase *database; // @synthesize database=_database;
@property(retain, nonatomic) CKContainer *container; // @synthesize container=_container;
- (_Bool)checkRampStateWithError:(id *)arg1;	// IMP=0x001000000012d237
- (void)fetchRampRecord:(unsigned long long)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x001000000012cf68
- (id)initWithRecordName:(id)arg1 localSettingName:(id)arg2 container:(id)arg3 database:(id)arg4 zoneID:(id)arg5 accountTracker:(id)arg6 lockStateTracker:(id)arg7 reachabilityTracker:(id)arg8 fetchRecordRecordsOperationClass:(Class)arg9;	// IMP=0x001000000012cd9e
