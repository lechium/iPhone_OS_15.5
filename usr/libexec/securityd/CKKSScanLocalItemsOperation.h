...
- (void).cxx_destruct;	// IMP=0x00200000000bbd5f
...
- (_Bool)areEquivalent:(struct SecDbItem *)arg1 ckksItem:(id)arg2 keyCache:(id)arg3;	// IMP=0x00100000000bb73c
- (void)main;	// IMP=0x00100000000ba688
- (void)retriggerMissingMirrorEntries:(id)arg1 databaseProvider:(id)arg2;	// IMP=0x00100000000ba57c
- (void)fixUUIDlessItemsInZone:(id)arg1 primaryKeys:(id)arg2 databaseProvider:(id)arg3;	// IMP=0x00100000000ba3a7
- (void)onboardItemsInView:(id)arg1 uuids:(id)arg2 itemClass:(id)arg3 databaseProvider:(id)arg4;	// IMP=0x00100000000ba096
- (_Bool)onboardItemToCKKS:(struct SecDbItem *)arg1 viewState:(id)arg2 keyCache:(id)arg3 error:(id *)arg4;	// IMP=0x00100000000b9cdd
- (_Bool)executeQuery:(id)arg1 readWrite:(_Bool)arg2 error:(id *)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x00100000000b99ea
- (id)queryPredicatesForViewMapping:(id)arg1;	// IMP=0x00100000000b8e16
- (id)initWithDependencies:(id)arg1 intending:(id)arg2 errorState:(id)arg3 ckoperationGroup:(id)arg4;	// IMP=0x00100000000b8ccd
- (id)init;	// IMP=0x00100000000b8cbf
