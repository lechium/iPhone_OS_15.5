...
- (void).cxx_destruct;	// IMP=0x002000000007e831
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x001000000007e46f
- (void)proceedWithPeerID:(id)arg1 refetchWasNeeded:(_Bool)arg2;	// IMP=0x001000000007e2b2
- (void)groupStart;	// IMP=0x001000000007db76
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 bottleID:(id)arg4 entropy:(id)arg5 bottleSalt:(id)arg6 saveVoucher:(_Bool)arg7;	// IMP=0x001000000007da28
