...
- (void).cxx_destruct;	// IMP=0x00200000000cc389
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x00100000000cc01a
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00100000000cbe5d
- (void)groupStart;	// IMP=0x00100000000cb82d
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 recoveryKey:(id)arg4 saveVoucher:(_Bool)arg5;	// IMP=0x00100000000cb728
