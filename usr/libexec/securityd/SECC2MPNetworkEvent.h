...
- (void).cxx_destruct;	// IMP=0x00200000001a6bf0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001a6343
- (unsigned long long)hash;	// IMP=0x00100000001a5cff
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001a5467
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001a4e92
- (void)copyTo:(id)arg1;	// IMP=0x00100000001a4985
- (void)writeTo:(id)arg1;	// IMP=0x00100000001a444a
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001a443d
- (id)dictionaryRepresentation;	// IMP=0x00100000001a37c7
- (id)description;	// IMP=0x00100000001a3718
