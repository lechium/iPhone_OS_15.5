...
- (void).cxx_destruct;	// IMP=0x00200000000b1eb9
...
- (_Bool)shouldHaveView:(id)arg1;	// IMP=0x00100000000b1dc5
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x00100000000b1cc6
@property(readonly) NSString *peerID;
@property(readonly) _SFECPublicKey *publicSigningKey;
@property(readonly) _SFECPublicKey *publicEncryptionKey;
- (id)initWithSOSPeerID:(id)arg1 encryptionKey:(id)arg2 signingKey:(id)arg3 viewList:(id)arg4;	// IMP=0x00100000000b1a76
