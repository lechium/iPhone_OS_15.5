...
- (void).cxx_destruct;	// IMP=0x002000000016722c
...
- (void)cancel;	// IMP=0x001000000016713a
- (void)groupStart;	// IMP=0x0010000000166bcf
- (id)initWithDependencies:(id)arg1 rollTLKIfPresent:(_Bool)arg2 preexistingPendingKeySets:(id)arg3 intendedState:(id)arg4 errorState:(id)arg5;	// IMP=0x001000000016689e
- (id)init;	// IMP=0x0010000000166890
