...
- (void).cxx_destruct;	// IMP=0x00200000001590c9
...
- (void)proceedWithKeys:(id)arg1;	// IMP=0x0010000000158bc5
- (void)groupStart;	// IMP=0x001000000015898b
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 deviceInfo:(id)arg4 peerID:(id)arg5 permanentInfo:(id)arg6 permanentInfoSig:(id)arg7 stableInfo:(id)arg8 stableInfoSig:(id)arg9;	// IMP=0x00100000001587f0
