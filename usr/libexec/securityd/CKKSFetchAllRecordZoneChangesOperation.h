...
- (void).cxx_destruct;	// IMP=0x00200000000c3828
...
- (void)cancel;	// IMP=0x00100000000c34ee
- (void)sendChangesToClient:(id)arg1 moreComing:(_Bool)arg2;	// IMP=0x00100000000c2f32
- (void)performFetch;	// IMP=0x00100000000c2385
- (void)groupStart;	// IMP=0x00100000000c217b
- (void)queryClientsForChangeTokens;	// IMP=0x00100000000c1bf4
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 clientMap:(id)arg3 fetchReasons:(id)arg4 apnsPushes:(id)arg5 forceResync:(_Bool)arg6 ckoperationGroup:(id)arg7;	// IMP=0x00100000000c19b4
- (id)init;	// IMP=0x00100000000c19a6
