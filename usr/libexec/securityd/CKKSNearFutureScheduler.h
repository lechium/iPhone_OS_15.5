...
- (void).cxx_destruct;	// IMP=0x00200000000aa974
...
- (void)cancel;	// IMP=0x00100000000aa73a
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x00100000000aa180
- (void)trigger;	// IMP=0x00100000000aa0bb
- (void)_onqueueTimerTick;	// IMP=0x00100000000a9d76
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x00100000000a9ca6
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x00100000000a9c2a
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x00100000000a9a55
- (id)makeOperationDependency;	// IMP=0x00100000000a9988
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x00100000000a9901
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 expontialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x00100000000a9725
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x00100000000a96ca
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x00100000000a96a6
