...
+ (id)loadAllFromKeychain:(id *)arg1;	// IMP=0x0020000000151aea
+ (id)loadFromKeychain:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001517d0
- (void).cxx_destruct;	// IMP=0x00200000001c7147
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001c6ef8
- (unsigned long long)hash;	// IMP=0x00100000001c6d9c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001c6b3e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001c69a0
- (void)copyTo:(id)arg1;	// IMP=0x00100000001c6849
- (void)writeTo:(id)arg1;	// IMP=0x00100000001c66e4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001c61a6
- (id)dictionaryRepresentation;	// IMP=0x00100000001c5ebb
- (id)description;	// IMP=0x00100000001c5e0c
...
- (_Bool)deleteFromKeychain:(id *)arg1;	// IMP=0x001000000015150b
- (_Bool)saveToKeychain:(id *)arg1;	// IMP=0x0010000000150eeb
- (_Bool)escrowAttemptedWithinLastSeconds:(double)arg1;	// IMP=0x0010000000151717
