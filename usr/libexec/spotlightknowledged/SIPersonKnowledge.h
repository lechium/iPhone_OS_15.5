...
- (void).cxx_destruct;	// IMP=0x00200000000129c5
...
- (id)normalizedPhoneNumbers;	// IMP=0x0010000000012237
...
- (id)initWithContactIdentifier:(id)arg1 displayName:(id)arg2 nameComponents:(id)arg3 values:(id)arg4;	// IMP=0x00100000000116d5
- (id)initWithValues:(id)arg1 firstNames:(id)arg2 lastNames:(id)arg3;	// IMP=0x0010000000010362
