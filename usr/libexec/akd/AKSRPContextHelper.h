...
- (void).cxx_destruct;	// IMP=0x002000000009131f
...
- (void)clearContinuationTokenIfSupported;	// IMP=0x0010000000090dcb
- (void)_addExperimentalFeaturesInfoToClientProvidedData:(id)arg1;	// IMP=0x0010000000090c3b
- (void)authenticationParametersWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000008f450
@property(readonly, nonatomic, getter=isContextSecretValidForSRP) _Bool contextSecretValidForSRP;
- (id)initWithContext:(id)arg1;	// IMP=0x001000000008f3a2
