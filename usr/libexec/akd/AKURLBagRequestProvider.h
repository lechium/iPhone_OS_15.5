...
- (void).cxx_destruct;	// IMP=0x0020000000024724
...
- (id)newBagURLRequest;	// IMP=0x00100000000244ec
- (id)_bagURLForAltDSID:(id)arg1 shouldFallBack:(_Bool)arg2;	// IMP=0x0010000000024445
- (id)initWithAltDSID:(id)arg1 urlSwitchData:(id)arg2 shouldFallBack:(_Bool)arg3;	// IMP=0x001000000002438f
