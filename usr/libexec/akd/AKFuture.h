...
- (void).cxx_destruct;	// IMP=0x00200000000548f2
...
- (id)value;	// IMP=0x001000000005472b
- (void)setValue:(id)arg1;	// IMP=0x00100000000546a7
- (id)initWithMaxWait:(double)arg1 description:(id)arg2;	// IMP=0x00100000000545b9
- (id)init;	// IMP=0x00100000000545a2
