...
- (void).cxx_destruct;	// IMP=0x002000000001467b
...
- (_Bool)appendRequestUrlQueryParameterNamed:(id)arg1 value:(id)arg2;	// IMP=0x0010000000014442
- (_Bool)signRequest:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000143fd
- (id)serverCompatibleRequestBodyWithPayload:(id)arg1;	// IMP=0x001000000001432b
@property(readonly, copy, nonatomic) NSDictionary *serverCompatibleRequestBody;
- (_Bool)_validateErrorCode:(id)arg1 withKey:(id)arg2;	// IMP=0x0010000000014228
- (_Bool)_validateResponseBodyFormat;	// IMP=0x00100000000141b9
- (_Bool)_validateDataExists:(id)arg1;	// IMP=0x0010000000014117
- (_Bool)_validateJSONResponseData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000013f3b
- (_Bool)validateResponseData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000013ae3
- (unsigned long long)requestBodyType;	// IMP=0x0010000000013adb
- (unsigned long long)expectedResponseType;	// IMP=0x0010000000013ad3
- (id)buildRequest:(id *)arg1;	// IMP=0x0010000000013742
- (void)_setRequestURL;	// IMP=0x00100000000136a8
- (id)initWithContext:(id)arg1 urlBagKey:(id)arg2 shouldCacheResource:(_Bool)arg3;	// IMP=0x0010000000013625
- (id)initWithContext:(id)arg1 urlBagKey:(id)arg2;	// IMP=0x0010000000013610
- (id)initWithContext:(id)arg1;	// IMP=0x001000000001357e
