...
- (void).cxx_destruct;	// IMP=0x002000000005b041
...
- (id)description;	// IMP=0x001000000005afbd
- (void)_processDictionary:(id)arg1 addedPrivateEmails:(id *)arg2 removedPrivateEmails:(id *)arg3;	// IMP=0x001000000005adb9
- (id)initWithResponseBody:(id)arg1;	// IMP=0x001000000005a841
