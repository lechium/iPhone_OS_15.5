...
- (void).cxx_destruct;	// IMP=0x002000000000d729
...
- (void)runReplyHandlerWithMessage:(id)arg1 error:(id)arg2;	// IMP=0x001000000000d58f
- (id)initWithTimeout:(double)arg1 queue:(id)arg2 logDescription:(id)arg3 sentID:(id)arg4 replyHandler:(CDUnknownBlockType)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x001000000000d24b
