...
- (void).cxx_destruct;	// IMP=0x0020000000018a77
...
- (void)trigger;	// IMP=0x00100000000188a0
- (void)setHoldTransaction:(_Bool)arg1;	// IMP=0x0010000000018816
- (void)run;	// IMP=0x0010000000018804
- (void)setAction:(CDUnknownBlockType)arg1;	// IMP=0x00100000000187d2
- (id)initWithDelay:(unsigned long long)arg1 operationQueue:(id)arg2;	// IMP=0x00100000000183f6
