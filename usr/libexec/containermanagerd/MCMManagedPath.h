...
- (void).cxx_destruct;	// IMP=0x00200000000546ef
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000054542
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000544d5
- (_Bool)isEqualToManagedPath:(id)arg1;	// IMP=0x00100000000544bb
@property(readonly) unsigned long long hash;
- (id)managedPathByAppendingPathComponent:(id)arg1 flags:(unsigned long long)arg2 ACLConfig:(unsigned long long)arg3 mode:(unsigned short)arg4 dpClass:(int)arg5 owner:(id)arg6;	// IMP=0x00100000000543a5
- (id)initWithURL:(id)arg1 flags:(unsigned long long)arg2 ACLConfig:(unsigned long long)arg3 mode:(unsigned short)arg4 dpClass:(int)arg5 owner:(id)arg6 parent:(id)arg7;	// IMP=0x00100000000542b1
