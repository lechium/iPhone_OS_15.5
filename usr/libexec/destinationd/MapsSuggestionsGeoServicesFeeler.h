...
+ (_Bool)isEnabled;	// IMP=0x0020000000005f01
- (void).cxx_destruct;	// IMP=0x0020000000006119
- (double)updateSignals;	// IMP=0x0010000000006020
- (id)initWithDelegate:(id)arg1 name:(id)arg2;	// IMP=0x0010000000005f25
- (_Bool)canProduceSignalType:(long long)arg1;	// IMP=0x0010000000005f18
