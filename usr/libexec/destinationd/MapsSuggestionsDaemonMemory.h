...
- (id).cxx_construct;	// IMP=0x002000000002e559
- (void).cxx_destruct;	// IMP=0x001000000002e4d1
...
- (void)clear;	// IMP=0x001000000002e451
- (id)mapsAppFeeler;	// IMP=0x001000000002e443
- (id)signalPack;	// IMP=0x001000000002e3de
- (_Bool)setSignalPack:(id)arg1;	// IMP=0x001000000002e32c
- (id)signalPipeline;	// IMP=0x001000000002e31e
- (void)clearETAs;	// IMP=0x001000000002e103
- (id)getETAForDestinationKey:(id)arg1;	// IMP=0x001000000002de9a
- (_Bool)setETA:(id)arg1 destinationKey:(id)arg2;	// IMP=0x001000000002d935
- (_Bool)removeEntries:(id)arg1 sourceName:(id)arg2;	// IMP=0x001000000002d522
- (_Bool)replaceEntries:(id)arg1 sourceName:(id)arg2;	// IMP=0x001000000002d268
- (id)entriesForSourceName:(id)arg1;	// IMP=0x001000000002d0c8
- (id)sourceNames;	// IMP=0x001000000002cf8f
...
- (id)init;	// IMP=0x001000000002c53b
