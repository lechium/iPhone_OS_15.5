...
- (id).cxx_construct;	// IMP=0x0020000000019737
- (void).cxx_destruct;	// IMP=0x00100000000196f2
@property(nonatomic) __weak MapsSuggestionsDaemonMemory *memory; // @synthesize memory=_memory;
- (void)_debugPrintOverviewOfConnections;	// IMP=0x00100000000196c5
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000185c3
- (id)initWithMemory:(id)arg1;	// IMP=0x001000000001836f
