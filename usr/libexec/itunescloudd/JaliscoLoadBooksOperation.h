...
- (void).cxx_destruct;	// IMP=0x00200000000a055d
...
- (id)metadataFilter;	// IMP=0x00100000000a04d3
- (id)queryFilter;	// IMP=0x00100000000a0466
- (id)_queryFilterEncodedStringForDAAPNameString:(id)arg1;	// IMP=0x00100000000a0443
- (void)main;	// IMP=0x001000000009fd75
