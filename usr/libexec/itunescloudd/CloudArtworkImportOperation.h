...
- (void).cxx_destruct;	// IMP=0x00200000000992c1
...
- (id)_resizedImageDataFromLocation:(id)arg1;	// IMP=0x0010000000098ea1
- (void)cancel;	// IMP=0x0010000000098e32
- (void)start;	// IMP=0x0010000000098777
- (id)description;	// IMP=0x00100000000986a7
- (void)callCompletionHandlers;	// IMP=0x001000000009851b
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000009847d
- (id)initWithURLSession:(id)arg1 configuration:(id)arg2 cloudID:(unsigned long long)arg3 artworkToken:(id)arg4 artworkType:(long long)arg5 sourceType:(long long)arg6 clientIdentity:(id)arg7;	// IMP=0x0010000000098353
