...
+ (Class)contentFeaturesType;	// IMP=0x00200000000ae484
- (void).cxx_destruct;	// IMP=0x00200000000adfbe
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000add4c
- (unsigned long long)hash;	// IMP=0x00100000000adc90
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000adb33
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ad8bd
- (void)copyTo:(id)arg1;	// IMP=0x00100000000ad76c
- (void)writeTo:(id)arg1;	// IMP=0x00100000000ad595
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000ad588
- (id)dictionaryRepresentation;	// IMP=0x00100000000ad13e
- (id)description;	// IMP=0x00100000000ad08f
- (id)contentFeaturesAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000ad072
- (unsigned long long)contentFeaturesCount;	// IMP=0x00100000000ad055
- (void)addContentFeatures:(id)arg1;	// IMP=0x00100000000acfeb
- (void)clearContentFeatures;	// IMP=0x00100000000acfce
...
- (int)StringAsContentType:(id)arg1;	// IMP=0x00100000000acddc
- (id)contentTypeAsString:(int)arg1;	// IMP=0x00100000000acd51
