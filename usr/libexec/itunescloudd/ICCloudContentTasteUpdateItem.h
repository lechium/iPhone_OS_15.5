...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000084ac2
- (void).cxx_destruct;	// IMP=0x0020000000084a84
...
- (unsigned long long)hash;	// IMP=0x00100000000817f6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000816f0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000008161a
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000008148e
- (id)description;	// IMP=0x001000000008139c
- (id)initWithGlobalPlaylistID:(id)arg1 contentTaste:(long long)arg2 configuration:(id)arg3;	// IMP=0x0010000000081251
- (id)initWithStoreItemID:(long long)arg1 mediaContentTasteItem:(long long)arg2 contentTaste:(long long)arg3 configuration:(id)arg4 timeStamp:(id)arg5;	// IMP=0x001000000008111e
