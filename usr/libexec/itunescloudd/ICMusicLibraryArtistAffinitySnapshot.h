...
- (void).cxx_destruct;	// IMP=0x0020000000059ece
...
- (id)debugDescription;	// IMP=0x0010000000059c86
- (float)legacyScore;	// IMP=0x0010000000059b74
...
- (id)initWithContentItemSnapshot:(id)arg1;	// IMP=0x0010000000059881
