...
- (void).cxx_destruct;	// IMP=0x0020000000051e66
...
- (id)initWithArtworkImporter:(id)arg1 clientIdentity:(id)arg2 operationQueue:(id)arg3 artistPersistentIDsToUpdate:(id)arg4 albumArtistPersistentIDsToUpdate:(id)arg5;	// IMP=0x0010000000051c0f
