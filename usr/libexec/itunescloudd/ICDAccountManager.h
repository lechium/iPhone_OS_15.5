...
- (void).cxx_destruct;	// IMP=0x00200000000e5059
...
- (void)_updateStateWithChange:(id)arg1;	// IMP=0x00100000000e4f61
- (id)_buildStateChange;	// IMP=0x00100000000e4d65
...
- (void)changeLibraryManagementPolicy:(long long)arg1;	// IMP=0x00100000000e486b
- (void)updateState;	// IMP=0x00100000000e4670
- (id)initWithLibraryManagementPolicy:(long long)arg1;	// IMP=0x00100000000e4418
