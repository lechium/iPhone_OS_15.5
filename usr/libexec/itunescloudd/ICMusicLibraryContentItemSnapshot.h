...
- (void).cxx_destruct;	// IMP=0x0020000000056eec
...
- (id)debugDescription;	// IMP=0x0010000000056d01
- (_Bool)isValid;	// IMP=0x0010000000056cf8
- (id)initWithSong:(id)arg1;	// IMP=0x0010000000056954
