...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000067ce0
- (void).cxx_destruct;	// IMP=0x0020000000067c49
...
- (id)description;	// IMP=0x0010000000067b1d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000067a85
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000679a9
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2;	// IMP=0x001000000006784f
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00100000000677ed
- (id)init;	// IMP=0x00100000000677ad
