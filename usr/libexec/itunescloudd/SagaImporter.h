...
- (void).cxx_destruct;	// IMP=0x00200000000874c3
...
- (_Bool)_updateGlobalPlaylistsFromContainersPayloadAtPath:(id)arg1 downloadPathForSubscribedContainersPayload:(id)arg2 clientIdentity:(id)arg3;	// IMP=0x0010000000087232
- (void)_importLyricsWithLyricsTokenMap:(id)arg1 clientIdentity:(id)arg2;	// IMP=0x00100000000870ed
- (void)_removeUnavailableSubscriptionAssetsInLibrary:(id)arg1;	// IMP=0x0010000000087066
- (void)importTracksFromRevision:(unsigned int)arg1 toRevision:(unsigned int)arg2 clientIdentity:(id)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000085643
- (void)cancel;	// IMP=0x0010000000085574
- (id)initWithConnection:(id)arg1;	// IMP=0x001000000008543c
