...
+ (id)defaultManager;	// IMP=0x0040000000057ffb
- (void).cxx_destruct;	// IMP=0x0020000000058623
...
- (void)waitForSystemAppMigrationToComplete:(CDUnknownBlockType)arg1;	// IMP=0x00100000000583ac
@property(nonatomic) _Bool systemAppMigrationComplete; // @synthesize systemAppMigrationComplete=_systemAppMigrationComplete;
- (id)init;	// IMP=0x0010000000057ebd
