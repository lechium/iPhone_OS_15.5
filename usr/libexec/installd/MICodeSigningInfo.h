...
- (void).cxx_destruct;	// IMP=0x00200000000080d7
...
- (id)initWithDictionaryRepresentation:(id)arg1 fromSource:(unsigned long long)arg2;	// IMP=0x00100000000074f6
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00100000000074e2
- (id)initWithSignerIdentity:(id)arg1 signerOrganization:(id)arg2 codeInfoIdentifier:(id)arg3 teamIdentifier:(id)arg4 signatureVersion:(id)arg5 entitlements:(id)arg6 signerType:(unsigned long long)arg7 profileType:(unsigned long long)arg8 signingInfoSource:(unsigned long long)arg9;	// IMP=0x00100000000073a7
