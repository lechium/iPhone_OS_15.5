...
- (void).cxx_destruct;	// IMP=0x0020000000007369
...
- (_Bool)createSnapshotWithError:(id *)arg1;	// IMP=0x00100000000070eb
- (void)dealloc;	// IMP=0x0010000000007079
- (id)initWithBundleID:(id)arg1 snapshotTo:(id)arg2 onlyV1AppIfPresent:(_Bool)arg3 placeholderOnly:(_Bool)arg4;	// IMP=0x0010000000006fc1
