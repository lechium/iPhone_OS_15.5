...
@class NSArray, NSDictionary, NSNumber, NSString, NSUUID, NSValue, XCAXAuditConfiguration, XCAccessibilityElement, XCDeviceEvent, XCSynthesizedEventRecord, XCTCapabilities, XCTScreenshotRequest, XCTSpindumpRequestSpecification, XCTTailspinRequest;
