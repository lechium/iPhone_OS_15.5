...
+ (id)sharedSystem;	// IMP=0x002000000001a7a2
- (void).cxx_destruct;	// IMP=0x002000000001bfa0
...
- (id)_queue_createAccessibilitySessionToken;	// IMP=0x001000000001bdc0
- (void)invalidateToken:(id)arg1;	// IMP=0x001000000001bbb7
- (void)_queue_setAccelerometerEnabled:(_Bool)arg1;	// IMP=0x001000000001ba33
- (void)_queue_setPassiveListeningModeEnabled:(_Bool)arg1;	// IMP=0x001000000001b7a8
- (void)_queue_unloadAccessibility;	// IMP=0x001000000001b57f
- (_Bool)_queue_setDisableOnTerminationWithError:(id *)arg1;	// IMP=0x001000000001b388
- (_Bool)_queue_loadAccessibilityIfNeeded:(_Bool)arg1 andWaitForNotificationWithTimeout:(double)arg2 error:(id *)arg3;	// IMP=0x001000000001afc7
- (id)_queue_loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000001ac5a
- (id)loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000001aa32
- (void)dealloc;	// IMP=0x001000000001a931
- (id)initWithAccessibilityFunctions:(CDStruct_f25c63ae)arg1;	// IMP=0x001000000001a84a
