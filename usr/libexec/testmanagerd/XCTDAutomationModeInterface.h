...
+ (id)sharedInterface;	// IMP=0x002000000003c1e8
+ (void)provideCapabilitiesToBuilder:(id)arg1;	// IMP=0x001000000003bfba
- (void).cxx_destruct;	// IMP=0x002000000003cbd4
...
- (void)unregisterAutomationModeChangeHandlerWithToken:(id)arg1;	// IMP=0x001000000003cafc
- (id)registerAutomationModeChangeHandlerOnQueue:(id)arg1 withBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000003ca75
- (void)disableAutomationModeForClient:(id)arg1;	// IMP=0x001000000003c769
- (_Bool)enableAutomationModeForClient:(id)arg1 error:(id *)arg2;	// IMP=0x001000000003c52e
@property(readonly) _Bool isAutomationModeEnabled;
- (void)dealloc;	// IMP=0x001000000003c484
- (id)initWithAutomationModeFunctions:(CDStruct_6bdebbfa)arg1;	// IMP=0x001000000003c286
