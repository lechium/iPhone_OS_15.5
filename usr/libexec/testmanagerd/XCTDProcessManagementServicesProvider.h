...
- (void).cxx_destruct;	// IMP=0x002000000001a771
...
- (void)applicationDidUpdateState:(id)arg1;	// IMP=0x001000000001a69c
- (id)init;	// IMP=0x001000000001a624
- (id)initWithProcessMonitor:(id)arg1 processAssertionManager:(id)arg2;	// IMP=0x001000000001a58e
- (void)invalidate;	// IMP=0x001000000001a44c
- (void)dealloc;	// IMP=0x001000000001a39a
