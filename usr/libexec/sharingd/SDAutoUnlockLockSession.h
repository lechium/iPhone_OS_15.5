...
- (void).cxx_destruct;	// IMP=0x002000000022b7e6
...
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2 suppressNotification:(_Bool)arg3;	// IMP=0x001000000022a73b
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2;	// IMP=0x001000000022a726
- (void)completeAttemptPostNotification:(_Bool)arg1;	// IMP=0x001000000022a67f
- (void)sendKeyExchangeResponseWithData:(id)arg1;	// IMP=0x001000000022a3cd
- (void)sendAuthPromptImageDataIfReady:(id)arg1;	// IMP=0x0010000000229b6f
- (void)sendAuthPromptRequestWithImageHash:(id)arg1 appName:(id)arg2;	// IMP=0x0010000000229768
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000022939d
- (void)consumeAuthTokenIfReady;	// IMP=0x0010000000228c75
- (void)startAWDL;	// IMP=0x0010000000228258
- (void)handleConfirmationACK;	// IMP=0x0010000000227fe3
- (void)handleSessionAuthToken:(id)arg1;	// IMP=0x0010000000227b1d
- (void)handleSessionKeyExchangeRequest:(id)arg1;	// IMP=0x0010000000227209
- (void)handleAuthPromptResponse:(id)arg1;	// IMP=0x0010000000226eb3
- (void)handleAWDLInfo:(id)arg1;	// IMP=0x00100000002267c0
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x001000000022636c
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0010000000226126
- (void)handleWiFiRequestInvalidated;	// IMP=0x00100000002260ca
- (void)handleRangingStarted;	// IMP=0x0010000000225fc6
- (void)handlePeerFound:(_Bool)arg1;	// IMP=0x0010000000225f07
- (void)handleAWDLUp;	// IMP=0x0010000000225d48
- (void)handlePeerOutOfRange;	// IMP=0x0010000000225a5e
- (void)handlePeerInRange;	// IMP=0x0010000000225776
- (_Bool)peerInRange:(id)arg1;	// IMP=0x00100000002255d8
- (void)handleRangingResults:(id)arg1 errorCode:(long long)arg2;	// IMP=0x00100000002250ab
- (void)invalidateConfirmationTimer;	// IMP=0x0010000000224fd5
- (void)restartConfirmationTimer:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x0010000000224d38
- (void)handleTimerFired;	// IMP=0x0010000000224866
- (void)invalidateTimerIfReady;	// IMP=0x001000000022481b
- (id)aksPeerAvailable;	// IMP=0x0010000000224637
- (void)deviceConnected:(id)arg1;	// IMP=0x001000000022426e
- (_Bool)handleFoundBLEDevice:(id)arg1 available:(_Bool)arg2 lockedOnWrist:(_Bool)arg3;	// IMP=0x0010000000223f95
- (_Bool)handleFoundBLEDevice:(id)arg1;	// IMP=0x0010000000223f34
- (void)connectionActivated;	// IMP=0x0010000000223d8c
- (void)updateImageData:(id)arg1 imageHash:(id)arg2;	// IMP=0x001000000022366f
- (id)getAppName;	// IMP=0x0010000000223667
@property(readonly, nonatomic) _Bool usingProxy;
- (id)hintToken;	// IMP=0x0010000000223539
- (_Bool)isAcceptor;	// IMP=0x0010000000223531
- (id)attemptResults;	// IMP=0x00100000002228d0
- (void)logResults;	// IMP=0x0010000000221a70
- (void)displayConfigChanged:(id)arg1;	// IMP=0x00100000002219d4
- (void)clamshellStateChanged:(id)arg1;	// IMP=0x0010000000221938
- (void)removeObservers;	// IMP=0x00100000002218e5
- (void)addObservers;	// IMP=0x00100000002217eb
- (void)handleDecryptionFailure:(long long)arg1;	// IMP=0x001000000022169a
- (void)_handleCanceledAfterSuccess;	// IMP=0x0010000000221593
- (void)handleCanceledAfterSuccess;	// IMP=0x001000000022150c
- (void)lockKeyBagIfNeeded;	// IMP=0x001000000022142f
- (void)cancelWiFiRequest;	// IMP=0x001000000022123d
- (void)_cancel;	// IMP=0x0010000000220ef7
- (void)cancel;	// IMP=0x0010000000220e70
- (void)tearDownAWDLIfNecessary;	// IMP=0x0010000000220c9c
- (void)completeAttemptIfNecessary;	// IMP=0x0010000000220ada
- (void)invalidateNoDisconnect;	// IMP=0x0010000000220aab
- (void)invalidate;	// IMP=0x0010000000220885
- (id)initWithAutoUnlockDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x0010000000220478
