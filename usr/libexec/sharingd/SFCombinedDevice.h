...
@interface SFCombinedDevice : NSObject
{
    ...
    MISSING_TYPE *_forcedID;	// 56 = 0x38
...
- (void).cxx_destruct;	// IMP=0x0020000000095e80
...
- (_Bool)stateIsNearby;	// IMP=0x0010000000095a97
- (_Bool)stateIsMedium;	// IMP=0x0010000000095a66
- (_Bool)stateIsClose;	// IMP=0x0010000000095a54
- (void)resetTicks;	// IMP=0x00100000000958bd
@property(readonly, copy, nonatomic) NSString *name;
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x00100000000950ae
- (_Bool)canTransition:(int)arg1;	// IMP=0x0010000000094fb8
- (id)description;	// IMP=0x0010000000094c14
