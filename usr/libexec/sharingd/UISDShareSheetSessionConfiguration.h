...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003cbfb
- (void).cxx_destruct;	// IMP=0x002000000003d363
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003d04e
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003cc03
