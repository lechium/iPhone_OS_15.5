...
@class MISSING_TYPE, NSData, NSMutableArray, NSUUID, SFSession;
...
@interface SDSession : NSObject
{
    ...
    MISSING_TYPE *_sendDataQueue;	// 80 = 0x50
}

- (void).cxx_destruct;	// IMP=0x0020000000215a47
...
- (id)description;	// IMP=0x00100000002157bb
