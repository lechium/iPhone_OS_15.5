...
- (void).cxx_destruct;	// IMP=0x0020000000219285
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000002190fd
- (unsigned long long)hash;	// IMP=0x0010000000218f38
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000218da2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000218c7c
- (void)copyTo:(id)arg1;	// IMP=0x0010000000218b95
- (void)writeTo:(id)arg1;	// IMP=0x0010000000218aad
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000218aa0
- (id)dictionaryRepresentation;	// IMP=0x0010000000218589
- (id)description;	// IMP=0x00100000002184da
