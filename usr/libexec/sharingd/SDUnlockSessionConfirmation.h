...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000010075
- (unsigned long long)hash;	// IMP=0x001000000000ffdb
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000fe93
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000fdcb
- (void)copyTo:(id)arg1;	// IMP=0x001000000000fd26
- (void)writeTo:(id)arg1;	// IMP=0x001000000000fc55
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000fc48
- (id)dictionaryRepresentation;	// IMP=0x001000000000f5e6
- (id)description;	// IMP=0x001000000000f537
