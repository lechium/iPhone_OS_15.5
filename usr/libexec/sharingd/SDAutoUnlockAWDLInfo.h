...
- (void).cxx_destruct;	// IMP=0x00200000000c8355
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000c80f7
- (unsigned long long)hash;	// IMP=0x00100000000c7e7a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000c7bc7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000c7a09
- (void)copyTo:(id)arg1;	// IMP=0x00100000000c789c
- (void)writeTo:(id)arg1;	// IMP=0x00100000000c7715
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000c7708
- (id)dictionaryRepresentation;	// IMP=0x00100000000c6d62
- (id)description;	// IMP=0x00100000000c6cb3
