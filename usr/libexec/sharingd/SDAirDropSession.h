...
- (void).cxx_destruct;	// IMP=0x002000000000ac5f
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000000a8d9
- (void)handleConversionProgress:(id)arg1;	// IMP=0x001000000000a801
- (void)startProgress;	// IMP=0x001000000000a561
- (void)postNotificationForTransferStatus:(long long)arg1 progress:(double)arg2;	// IMP=0x001000000000a334
- (void)airDropClient:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x0010000000009b50
- (void)removeClientAlerts;	// IMP=0x0010000000009a1f
- (void)dealloc;	// IMP=0x001000000000999e
- (void)stop;	// IMP=0x001000000000978d
- (void)addClientForNode:(struct __SFNode *)arg1 shouldPublishProgress:(_Bool)arg2;	// IMP=0x001000000000940a
- (void)serversChanged:(id)arg1;	// IMP=0x00100000000090ce
- (_Bool)send;	// IMP=0x0010000000008f8f
- (void)start;	// IMP=0x0010000000008c88
- (void)releaseSandboxExtensions;	// IMP=0x0010000000008b54
- (void)consumeSandboxExtensions;	// IMP=0x001000000000887e
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000008852
- (id)initWithPerson:(struct __SFNode *)arg1 items:(id)arg2 sandboxExtensions:(id)arg3;	// IMP=0x0010000000008624
