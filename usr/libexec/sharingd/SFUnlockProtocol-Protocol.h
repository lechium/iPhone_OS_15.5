...
@class MISSING_TYPE, NSData, NSString, NSUUID, SFAutoUnlockDevice;
...
- (MISSING_TYPE *)enableUnlockWithDevice:fromKey:withPasscode:completionHandler: /* Error: Ran out of types for this method. */;
