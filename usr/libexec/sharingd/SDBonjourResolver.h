...
- (void).cxx_destruct;	// IMP=0x002000000022028e
...
- (void)cancel;	// IMP=0x0010000000220139
- (void)resolve;	// IMP=0x001000000021fcac
- (void)parseResults:(const char *)arg1 port:(unsigned short)arg2 txtLen:(unsigned short)arg3 txtRecord:(const char *)arg4 interface:(unsigned int)arg5;	// IMP=0x001000000021f8fc
- (void)notifyClient:(int)arg1;	// IMP=0x001000000021f8a8
- (void)dealloc;	// IMP=0x001000000021f86a
- (id)initWithName:(id)arg1 type:(id)arg2 domain:(id)arg3 path:(id)arg4 timeout:(_Bool)arg5;	// IMP=0x001000000021f736
