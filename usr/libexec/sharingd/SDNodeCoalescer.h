...
- (void).cxx_destruct;	// IMP=0x0020000000112555
...
- (id)mappedContactIdentifierForContactIdentifier:(id)arg1;	// IMP=0x00100000001124d2
- (id)setMappedContactIdentifier:(id)arg1 relatedContactIdentifiers:(id)arg2;	// IMP=0x001000000011218b
- (id)coalescedNodesForNewAvailableNodes:(id)arg1;	// IMP=0x001000000011113e
- (id)init;	// IMP=0x00100000001110c9
