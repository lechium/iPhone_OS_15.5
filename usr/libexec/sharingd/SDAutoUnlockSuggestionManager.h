...
- (void).cxx_destruct;	// IMP=0x00200000001cf0a1
...
- (void)_systemHasPoweredOn;	// IMP=0x00100000001ceeb5
- (void)_systemWillSleep;	// IMP=0x00100000001cee51
- (_Bool)alwaysShowSetupRetry;	// IMP=0x00100000001cee38
- (id)testDeviceID;	// IMP=0x00100000001cee1f
- (_Bool)ignoreBackOff;	// IMP=0x00100000001cee06
- (_Bool)suggestionsEnabled;	// IMP=0x00100000001cedea
- (void)setRetriedSetup;	// IMP=0x00100000001ced9a
- (_Bool)retriedSetup;	// IMP=0x00100000001cecbd
- (void)loadSuggestedPeers;	// IMP=0x00100000001cebf8
- (void)setFeatureSuggestedForDeviceID:(id)arg1;	// IMP=0x00100000001cea62
- (_Bool)featureSuggestedForDeviceID:(id)arg1;	// IMP=0x00100000001ce9eb
- (void)updateDefaultsForDeviceID:(id)arg1;	// IMP=0x00100000001ce694
- (_Bool)canSuggestForDeviceID:(id)arg1;	// IMP=0x00100000001ce43d
- (_Bool)shouldSendRequestsForDeviceID:(id)arg1;	// IMP=0x00100000001ce313
- (void)watchAvailableForUnlockWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000001ce303
- (void)transport:(id)arg1 didReceivePayload:(id)arg2 type:(unsigned short)arg3 deviceID:(id)arg4;	// IMP=0x00100000001cdfa7
- (void)sendStartAdvertisingToDeviceID:(id)arg1;	// IMP=0x00100000001cddf2
- (void)invalidateScanTimer;	// IMP=0x00100000001cdd1c
- (void)restartScanTimer:(unsigned long long)arg1;	// IMP=0x00100000001cdb25
- (void)invalidateScanner;	// IMP=0x00100000001cd9f2
- (void)handleFoundPeer:(id)arg1;	// IMP=0x00100000001cd5c3
- (void)startScanningForIDSDeviceIDs:(id)arg1;	// IMP=0x00100000001ccd1a
- (void)invalidateServiceTimer;	// IMP=0x00100000001ccc44
- (void)restartServiceTimer:(unsigned long long)arg1;	// IMP=0x00100000001cca49
- (void)invalidateSuggestionService;	// IMP=0x00100000001cc9e3
- (void)updateSuggestionService;	// IMP=0x00100000001cc96d
- (void)invalidateSuggestedDeviceTimer;	// IMP=0x00100000001cc897
- (void)restartSuggestedDeviceTimer:(long long)arg1;	// IMP=0x00100000001cc67e
- (void)postSuggestionNotification;	// IMP=0x00100000001cc509
- (void)postNotificationIfNeeded;	// IMP=0x00100000001cc32b
- (void)invalidateSetupRetryDeviceTimer;	// IMP=0x00100000001cc255
- (void)restartSetupRetryDeviceTimer:(long long)arg1;	// IMP=0x00100000001cc03c
- (void)setupRetryNotificationDismissed;	// IMP=0x00100000001cbf61
- (void)setupRetryNotificationSetUpSelected;	// IMP=0x00100000001cbf5b
- (void)setupRetryIfNeeded;	// IMP=0x00100000001cbd3a
- (void)screenLockUnlocked:(id)arg1;	// IMP=0x00100000001cbc78
- (void)triggerDevicesIfNeeded;	// IMP=0x00100000001cbc72
- (void)handleTestSuggestion;	// IMP=0x00100000001cbb79
- (void)addObservers;	// IMP=0x00100000001cbaf0
- (id)init;	// IMP=0x00100000001cb9df
