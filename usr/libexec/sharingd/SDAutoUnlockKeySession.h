...
- (void).cxx_destruct;	// IMP=0x0020000000018f6e
...
- (void)logAutoUnlockEnd;	// IMP=0x0010000000018aac
- (void)logAutoUnlockStart;	// IMP=0x0010000000018aa6
- (void)invalidateAssertionTimer;	// IMP=0x00100000000189d0
- (void)restartAssertionTimer;	// IMP=0x00100000000187c1
- (void)releaseIdleSleepAssertion;	// IMP=0x0010000000018722
- (void)declareSystemActivityAssertion;	// IMP=0x000000000001848e
- (void)sendConfirmationACK;	// IMP=0x001000000001826c
- (void)sendSessionAuthToken:(id)arg1 error:(id)arg2;	// IMP=0x0010000000017e04
- (void)sendKeyExchangeRequestWithData:(id)arg1 error:(id)arg2;	// IMP=0x0010000000017b06
- (void)sendAuthPromptResponseWithData:(id)arg1 error:(id)arg2;	// IMP=0x001000000001780b
- (void)sendAWDLInfoWithKeyData:(id)arg1 error:(id)arg2;	// IMP=0x00100000000171fb
- (void)handleCleanUpAWDL;	// IMP=0x001000000001716d
- (void)handleUnlockConfirmation:(id)arg1;	// IMP=0x0010000000016d1f
- (void)createAuthTokenIfReady;	// IMP=0x001000000001652a
- (void)handleSessionKeyExchangeResponse:(id)arg1;	// IMP=0x0010000000016303
- (void)handleAuthPromptImageData:(id)arg1;	// IMP=0x0010000000016038
- (void)handleAuthPromptRequest:(id)arg1;	// IMP=0x0010000000015b61
- (_Bool)handleAWDLInfo:(id)arg1;	// IMP=0x00100000000155a4
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x0010000000014e24
- (void)nq_handleWiFiRequestInvalidated;	// IMP=0x0010000000014d87
- (void)nq_handleWiFiRequestStartedWithStartAWDLHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000014ccf
- (void)nq_awdlNetworkStarted;	// IMP=0x0010000000014aef
- (void)createWiFiRequest;	// IMP=0x001000000001434c
- (void)alertOfUnlock;	// IMP=0x0010000000014230
- (void)promptForApproval;	// IMP=0x001000000001422a
- (void)systemIsActive:(id)arg1;	// IMP=0x0010000000014076
- (void)deviceDisconnected:(id)arg1;	// IMP=0x0010000000013e24
- (void)removeObservers;	// IMP=0x0010000000013dd1
- (void)addObservers;	// IMP=0x0010000000013cd4
- (void)postBeganUnlockingNotification;	// IMP=0x0010000000013c41
- (void)beginAKSSession;	// IMP=0x0010000000013c3b
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0010000000013a77
- (void)keyCanUnlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000013a71
- (_Bool)keyInState;	// IMP=0x00100000000138d1
- (void)_invalidate;	// IMP=0x001000000001363e
- (void)invalidateOnQueue;	// IMP=0x00100000000135ff
- (void)invalidate;	// IMP=0x001000000001357e
- (id)initWithBLEDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x00100000000132d8
