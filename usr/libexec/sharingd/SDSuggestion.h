...
- (id)createPeopleSuggestion;	// IMP=0x0010000000012781
- (id)_caseSensitiveBundleIDFromBundleID:(id)arg1;	// IMP=0x00100000000126f7
- (void)_configure;	// IMP=0x001000000001184c
- (id)initWithSuggestion:(id)arg1;	// IMP=0x00100000000117d1
