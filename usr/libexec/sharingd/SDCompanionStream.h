...
- (void).cxx_destruct;	// IMP=0x00200000001ca74c
...
- (void)logClientReceived;	// IMP=0x00100000001ca4b8
- (void)logClientSent;	// IMP=0x00100000001ca458
- (void)writeNetworkStream;	// IMP=0x00100000001ca341
- (void)readClientStream;	// IMP=0x00100000001ca12e
- (void)writeClientStream;	// IMP=0x00100000001c9e23
- (void)handleOpenedStream;	// IMP=0x00100000001c9d90
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x00100000001c9baf
- (void)streamHandlerDidClose:(id)arg1 withError:(id)arg2;	// IMP=0x00100000001c991e
- (void)streamHandler:(id)arg1 didReceiveStreamData:(id)arg2;	// IMP=0x00100000001c98bb
- (void)streamHandler:(id)arg1 bufferSpaceChanged:(_Bool)arg2;	// IMP=0x00100000001c9849
- (void)handleStreamResponse:(id)arg1;	// IMP=0x00100000001c966d
- (void)handleStreamRequest:(id)arg1;	// IMP=0x00100000001c93d1
- (void)streamHandler:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x00100000001c918a
- (void)netServiceBrowser:(id)arg1 didFindService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x00100000001c90e5
- (int)setBufferSize:(int)arg1 socket:(int)arg2;	// IMP=0x00100000001c908e
@property(readonly) NSFileHandle *fileHandle; // @synthesize fileHandle=_fileHandle;
- (void)notifyStreamRequestWithError:(id)arg1;	// IMP=0x00100000001c8ada
- (void)switchToStreaming;	// IMP=0x00100000001c8a52
- (void)sendInitialResponse:(_Bool)arg1;	// IMP=0x00100000001c8791
- (void)sendInitialRequest;	// IMP=0x00100000001c846f
- (void)startBrowser;	// IMP=0x00100000001c839d
- (void)getStreamsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000001c8348
- (void)setBundleID:(id)arg1;	// IMP=0x00100000001c829c
- (void)stopIfReady;	// IMP=0x00100000001c825a
- (void)stop;	// IMP=0x00100000001c7eb9
- (void)start;	// IMP=0x00100000001c7e83
- (void)dealloc;	// IMP=0x00100000001c7e45
- (id)initWithAuthorData:(id)arg1 streamHandler:(id)arg2;	// IMP=0x00100000001c7d1f
- (id)initWithStreamHandler:(id)arg1;	// IMP=0x00100000001c7d08
