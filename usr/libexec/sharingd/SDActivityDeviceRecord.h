...
- (void).cxx_destruct;	// IMP=0x0020000000021762
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000020663
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000002064b
- (id)description;	// IMP=0x0010000000020569
- (id)initWithDevice:(id)arg1;	// IMP=0x00100000000204d7
