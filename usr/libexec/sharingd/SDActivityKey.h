...
- (void).cxx_destruct;	// IMP=0x0020000000163ade
...
- (unsigned long long)hash;	// IMP=0x00100000001638ee
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000163828
- (id)description;	// IMP=0x001000000016372b
- (void)dealloc;	// IMP=0x0010000000163674
- (id)initWithDictRepresentation:(id)arg1;	// IMP=0x001000000016348b
