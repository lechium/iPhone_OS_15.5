...
- (void).cxx_destruct;	// IMP=0x00200000001a932f
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x00100000001a8b33
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000001a8571
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001a8559
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x00100000001a7dfe
- (void)sendAWDLInfo;	// IMP=0x00100000001a7dea
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001a7d4d
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001a7c61
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001a7c4f
- (void)_start;	// IMP=0x00100000001a7c3d
- (void)start;	// IMP=0x00100000001a7bb6
- (id)getAppName;	// IMP=0x00100000001a7bae
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00100000001a7ba8
- (void)connectionActivated;	// IMP=0x00100000001a7ba2
- (void)invalidate;	// IMP=0x00100000001a7aa9
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00100000001a7a0d
