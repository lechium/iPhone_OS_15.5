...
- (void).cxx_destruct;	// IMP=0x00200000000f72ae
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000f7008
- (unsigned long long)hash;	// IMP=0x00100000000f6e8a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000f6bf0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f6a04
- (void)copyTo:(id)arg1;	// IMP=0x00100000000f688c
- (void)writeTo:(id)arg1;	// IMP=0x00100000000f6711
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000f6704
- (id)dictionaryRepresentation;	// IMP=0x00100000000f5f24
- (id)description;	// IMP=0x00100000000f5e75
