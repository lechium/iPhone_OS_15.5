...
- (void).cxx_destruct;	// IMP=0x00200000000049b7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000478b
- (unsigned long long)hash;	// IMP=0x0010000000003ef9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000003c9e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000003b0a
- (void)copyTo:(id)arg1;	// IMP=0x00100000000039a3
- (void)writeTo:(id)arg1;	// IMP=0x0010000000003821
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000003814
- (id)dictionaryRepresentation;	// IMP=0x0010000000002f5c
- (id)description;	// IMP=0x0010000000002ead
