...
- (void).cxx_destruct;	// IMP=0x0020000000006319
...
- (_Bool)sendFile:(id)arg1 onService:(id)arg2;	// IMP=0x0010000000006158
- (_Bool)sendProtobufData:(id)arg1 type:(unsigned long long)arg2 service:(id)arg3 fireAndForget:(_Bool)arg4 includeInactiveDevices:(_Bool)arg5;	// IMP=0x0010000000005c52
- (id)init;	// IMP=0x0010000000005ad3
