...
- (void).cxx_destruct;	// IMP=0x00200000000781a7
...
- (id)description;	// IMP=0x0010000000078083
- (id)initWithIdentifier:(id)arg1 delegateEndpoint:(id)arg2 isEntitledDelegate:(_Bool)arg3;	// IMP=0x0010000000077fc0
