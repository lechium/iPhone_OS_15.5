...
- (void).cxx_destruct;	// IMP=0x00200000000ce3b8
...
- (void)_addSearchOperations:(unsigned long long)arg1;	// IMP=0x00100000000cdf48
- (void)remoteSearchOperation:(id)arg1 didFindResults:(_Bool)arg2;	// IMP=0x00100000000cdc51
- (_Bool)remoteSearchOperationShouldStopEarly:(id)arg1;	// IMP=0x00100000000cdb70
- (void)cancel;	// IMP=0x00100000000cdb0a
- (void)performSearch;	// IMP=0x00100000000cd8a5
- (id)initWithAccount:(id)arg1 searchContext:(id)arg2 logIdentifier:(id)arg3 progress:(id)arg4;	// IMP=0x00100000000cd6ac
