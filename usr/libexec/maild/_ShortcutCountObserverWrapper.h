...
- (void)cancel;	// IMP=0x0010000000060958
- (void)countDidChange:(long long)arg1 acknowledgementToken:(id)arg2;	// IMP=0x0010000000060888
- (id)initWithFavoriteItem:(id)arg1 messagePersistence:(id)arg2 hookRegistry:(id)arg3 countDidChange:(CDUnknownBlockType)arg4;	// IMP=0x0010000000060344
