...
@class MFUserNotificationCenterObserver, NSArray, NSDate, NSDictionary, NSSet;
...
- (void)notificationCenterObserver:(MFUserNotificationCenterObserver *)arg1 messageAdded:(NSArray *)arg2 afterDate:(NSDate *)arg3;
@end
