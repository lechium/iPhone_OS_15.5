...
@interface MFNotificationMessage : NSObject
{
    ...
    id <MFFavoritesReader> _favoritesReader;	// 88 = 0x58
    id <EMVIPReader> _vipReader;	// 96 = 0x60
    MFMailboxUid *_mailbox;	// 104 = 0x68
    NSString *_subject;	// 112 = 0x70
    NSString *_senderCommentedAddress;	// 120 = 0x78
    CNContactStore *_contactStore;	// 128 = 0x80
    NSString *_senderFullAddress;	// 136 = 0x88
    NSString *_title;	// 144 = 0x90
}

+ (id)notificationIDForMessage:(id)arg1;	// IMP=0x00200000000afc23
- (void).cxx_destruct;	// IMP=0x00200000000b0e1b
...
- (_Bool)_isInFavoriteMailbox;	// IMP=0x00100000000b0611
- (id)initWithFavoritesReader:(id)arg1 vipReader:(id)arg2 libraryMessage:(id)arg3 contactStore:(id)arg4 suppressionContexts:(id)arg5 summary:(id)arg6;	// IMP=0x00100000000afcff
