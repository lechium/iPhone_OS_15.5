...
+ (id)log;	// IMP=0x0020000000065773
- (void).cxx_destruct;	// IMP=0x0020000000065bb1
@property(copy, nonatomic) NSString *autosaveIdentifier; // @synthesize autosaveIdentifier=_autosaveIdentifier;
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00100000000659b9
- (id)initWithAutosaveIdentifier:(id)arg1;	// IMP=0x0010000000065850
