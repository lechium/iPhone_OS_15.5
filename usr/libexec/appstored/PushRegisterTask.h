...
- (void).cxx_destruct;	// IMP=0x002000000014ac94
- (id)_request:(id *)arg1;	// IMP=0x001000000014a825
- (void)main;	// IMP=0x001000000014a2c7
- (id)initWithAccount:(id)arg1 isSandboxAccount:(_Bool)arg2 token:(id)arg3 environment:(id)arg4 logKey:(id)arg5;	// IMP=0x001000000014a16f
