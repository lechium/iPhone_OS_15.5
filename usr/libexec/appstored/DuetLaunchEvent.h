...
- (void).cxx_destruct;	// IMP=0x00200000001f345e
...
- (id)_formatTimeInternal:(long long)arg1;	// IMP=0x00100000001f30e3
- (id)_simpleTime:(id)arg1;	// IMP=0x00100000001f3037
- (id)_simpleDate:(id)arg1;	// IMP=0x00100000001f2f35
- (id)description;	// IMP=0x00100000001f2de8
- (id)dictionary;	// IMP=0x00100000001f295c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001f272e
