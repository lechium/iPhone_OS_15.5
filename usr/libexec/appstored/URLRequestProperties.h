...
- (void).cxx_destruct;	// IMP=0x00200000001c24d3
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001c21bd
- (void)setObject:(id)arg1 forKeyedSubscript:(id)arg2;	// IMP=0x00100000001c21ab
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x00100000001c206a
- (void)setValue:(id)arg1 forRequestParameter:(id)arg2;	// IMP=0x00100000001c1f17
- (void)setValue:(id)arg1 forRequestHeader:(id)arg2;	// IMP=0x00100000001c1dc3
...
- (id)init;	// IMP=0x00100000001c0d9a
