...
- (void).cxx_destruct;	// IMP=0x002000000025006f
...
- (void)main;	// IMP=0x001000000024ed1b
- (id)initWithLocalRevision:(id)arg1 reason:(long long)arg2 client:(id)arg3;	// IMP=0x001000000024ec22
