...
- (void).cxx_destruct;	// IMP=0x00200000000b5608
...
- (void)activateForTargetXPCConnection:(id)arg1 shouldDismissOnUILock:(_Bool)arg2 userInfo:(id)arg3;	// IMP=0x00100000000b52f1
- (id)initWithServiceName:(id)arg1 viewControllerClassName:(id)arg2;	// IMP=0x00100000000b5236
