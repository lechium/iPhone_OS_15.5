...
- (void).cxx_destruct;	// IMP=0x002000000017ccaa
...
- (id)_processPurchaseResult:(id)arg1 authorizationResult:(id)arg2;	// IMP=0x001000000017bb78
- (id)_urlTypeForURL:(id)arg1 bag:(id)arg2 error:(id *)arg3;	// IMP=0x001000000017ba73
- (void)purchase:(id)arg1 handleEngagementRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000017b379
- (void)purchase:(id)arg1 handleDialogRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000017b10f
- (void)purchase:(id)arg1 handleAuthenticateRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000017aea5
- (id)_authenticateWithClientInfo:(id)arg1 accountInfo:(id)arg2 error:(id *)arg3;	// IMP=0x001000000017a8ca
- (id)_buyParams;	// IMP=0x001000000017976a
- (void)main;	// IMP=0x00100000001779d9
- (id)initWithProductIdentifier:(id)arg1 quantity:(unsigned long long)arg2 client:(id)arg3 apiVersion:(long long)arg4 paymentDelegate:(id)arg5 siwaAuthorizationInfo:(id)arg6;	// IMP=0x0010000000177855
- (id)initWithBuyParams:(id)arg1 client:(id)arg2 apiVersion:(long long)arg3 paymentDelegate:(id)arg4 siwaAuthorizationInfo:(id)arg5;	// IMP=0x001000000017771d
