...
+ (id)taskInfoForTask:(id)arg1;	// IMP=0x004000000004e9d0
+ (void)removeTaskInfo:(id)arg1;	// IMP=0x001000000004e94c
+ (void)removeAllTaskInfo;	// IMP=0x001000000004e911
+ (void)recordTaskInfo:(id)arg1 forTask:(id)arg2;	// IMP=0x001000000004e7a9
+ (void)exchangeTaskForTaskInfo:(id)arg1 withTask:(id)arg2;	// IMP=0x001000000004e797
+ (id)newTaskInfoForTask:(id)arg1;	// IMP=0x001000000004e698
- (void).cxx_destruct;	// IMP=0x002000000004ec42
...
- (id)initWithTask:(id)arg1;	// IMP=0x001000000004e703
