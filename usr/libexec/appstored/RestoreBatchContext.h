...
- (void).cxx_destruct;	// IMP=0x00200000000d7abc
...
- (void)softFailItem:(id)arg1 withError:(id)arg2;	// IMP=0x00100000000d79d2
- (void)itemSucceeded:(id)arg1 storeItem:(id)arg2;	// IMP=0x00100000000d7727
- (void)hardFailItem:(id)arg1 withError:(id)arg2;	// IMP=0x00100000000d768b
- (id)initWithItems:(id)arg1 account:(id)arg2;	// IMP=0x00100000000d71e4
