...
- (void).cxx_destruct;	// IMP=0x0020000000207527
@property(readonly, nonatomic) NSString *artistName; // @synthesize artistName=_artistName;
@property(readonly, nonatomic) NSString *name; // @synthesize name=_name;
- (id)attributesForPlatform:(id)arg1;	// IMP=0x001000000020742d
- (id)_devicePlatform;	// IMP=0x0010000000207420
@property(readonly, nonatomic) MediaAppPlatformAttributes *platformAttributes;
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000002071d9
