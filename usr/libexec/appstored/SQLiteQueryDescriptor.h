...
- (void).cxx_destruct;	// IMP=0x002000000013ff8a
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x001000000013f820
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000013f72e
