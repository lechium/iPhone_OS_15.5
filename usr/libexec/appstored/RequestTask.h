...
- (void).cxx_destruct;	// IMP=0x002000000004e656
...
- (void)_setResponse:(id)arg1;	// IMP=0x001000000004e5aa
@property(readonly) ASDRequestResponse *response; // @synthesize response=_response;
- (id)initForClient:(id)arg1 withOptions:(id)arg2;	// IMP=0x001000000004e414
