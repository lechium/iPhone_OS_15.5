...
- (void).cxx_destruct;	// IMP=0x00200000000d4cd5
...
- (int)_encryptDatabase:(struct sqlite3 *)arg1;	// IMP=0x00100000000d4a3c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000d4997
- (void)setCacheSizeWithNumberOfKilobytes:(long long)arg1;	// IMP=0x00100000000d4982
- (void)setCacheSizeWithNumberOfDatabasePages:(long long)arg1;	// IMP=0x00100000000d4970
- (int);	// IMP=0x00100000000d48a1
- (id)initWithDatabasePath:(id)arg1;	// IMP=0x00100000000d4814
