...
+ (id)_titleForProtectionSpace:(id)arg1;	// IMP=0x00400000001bea11
+ (id)_messageForProtectionSpace:(id)arg1;	// IMP=0x00100000001be83d
- (void).cxx_destruct;	// IMP=0x00200000001bea86
...
- (id)initWithAuthenticationChallenge:(id)arg1;	// IMP=0x00100000001be709
