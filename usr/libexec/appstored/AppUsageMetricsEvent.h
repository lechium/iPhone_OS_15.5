...
- (void).cxx_destruct;	// IMP=0x002000000026844e
...
// Error: Property attributes should begin with the type ('T') attribute, property name: itemID
...
- (id)_typeForMetricsType:(unsigned char)arg1;	// IMP=0x0010000000268079
- (id)_metricsTypeForInstallationType:(unsigned char)arg1;	// IMP=0x0010000000268050
- (id)_eventForType:(unsigned char)arg1;	// IMP=0x0010000000267fce
- (_Bool)requiresDiagnosticSendingPermission;	// IMP=0x0010000000267fc6
- (id)metricsDictionary;	// IMP=0x0010000000267b42
...
- (_Bool);	// IMP=0x0010000000266ea8
- (id)externalMapping;	// IMP=0x00100000002669d8
- (id)description;	// IMP=0x001000000026696c
