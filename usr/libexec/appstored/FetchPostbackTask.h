...
- (void).cxx_destruct;	// IMP=0x0020000000137a2a
@property(retain, nonatomic) NSArray *params; // @synthesize params=_params;
@property(retain, nonatomic) NSArray *results; // @synthesize results=_results;
- (id)processStatusString:(id)arg1 withErrorString:(id)arg2;	// IMP=0x00100000001378c7
- (id)_requestWithParams:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001376d5
- (void)main;	// IMP=0x0010000000136fba
- (id)initWithAppAdamID:(id)arg1 urlString:(id)arg2;	// IMP=0x0010000000136dfe
