...
- (void).cxx_destruct;	// IMP=0x0020000000010e64
- (long long)writeBytes:(const char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0010000000010e47
- (void)close;	// IMP=0x0010000000010d9e
@property(readonly) _Bool hasSpaceAvailable;
- (void)dealloc;	// IMP=0x0010000000010cc8
- (id)_initWithBufferedStream:(id)arg1;	// IMP=0x0010000000010c5a
