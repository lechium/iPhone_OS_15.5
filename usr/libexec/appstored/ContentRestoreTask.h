...
- (void).cxx_destruct;	// IMP=0x00200000000730be
...
- (id)_newBodyDictionaryWithAccountID:(id)arg1;	// IMP=0x0010000000072675
- (void)main;	// IMP=0x0010000000071d73
- (id)initWithRestoreAppInstalls:(id)arg1 account:(id)arg2;	// IMP=0x0010000000071cd1
