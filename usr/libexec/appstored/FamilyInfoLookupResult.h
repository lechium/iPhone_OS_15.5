...
+ (id)_familyMembersFromDictionaryRepresentation:(id)arg1;	// IMP=0x00400000001ae18c
- (void).cxx_destruct;	// IMP=0x00200000001ae97d
...
- (id)description;	// IMP=0x00100000001ae10a
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1 cached:(_Bool)arg2;	// IMP=0x00100000001ade30
