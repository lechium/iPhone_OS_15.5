...
+ (id)newContextWithKnownApps:(id)arg1 revision:(id)arg2 forAccountID:(long long)arg3 requestingAccount:(id)arg4 client:(id)arg5 purchaseHistoryContext:(unsigned long long)arg6;	// IMP=0x004000000006e852
- (void).cxx_destruct;	// IMP=0x002000000006ea6b
...
- (id)_initWithKnownApps:(id)arg1 revision:(id)arg2 forAccountID:(long long)arg3 requestingAccount:(id)arg4 client:(id)arg5 purchaseHistoryContext:(unsigned long long)arg6;	// IMP=0x001000000006e90e
