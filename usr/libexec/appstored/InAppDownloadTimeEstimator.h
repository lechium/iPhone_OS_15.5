...
- (void).cxx_destruct;	// IMP=0x002000000001c824
- (void)_updateStatisticsFromSnapshots;	// IMP=0x001000000001c61f
- (void)setCurrentValue:(unsigned long long)arg1;	// IMP=0x001000000001c437
@property(readonly, nonatomic) double estimatedTimeRemaining;
- (id)initWithMaxValue:(unsigned long long)arg1;	// IMP=0x001000000001c2cc
