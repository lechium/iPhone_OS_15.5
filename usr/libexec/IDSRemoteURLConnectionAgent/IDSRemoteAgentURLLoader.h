...
+ (_Bool)shouldAssertWiFi;	// IMP=0x002000000000238c
- (void).cxx_destruct;	// IMP=0x0020000000002a03
...
- (void)cancel;	// IMP=0x00100000000027f1
- (void)load;	// IMP=0x00100000000025bf
- (void)dealloc;	// IMP=0x0010000000002590
- (id)initWithURLRequest:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000002394
