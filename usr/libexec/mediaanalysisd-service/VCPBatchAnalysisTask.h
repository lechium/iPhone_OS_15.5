...
+ (id)taskWithPhotoLibrary:(id)arg1;	// IMP=0x0040000000047bf3
- (void).cxx_destruct;	// IMP=0x0020000000048aea
...
- (int)mainInternal;	// IMP=0x00100000000482ef
- (_Bool)containsAsset:(id)arg1;	// IMP=0x0010000000048074
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3;	// IMP=0x0010000000047fd7
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3 allowStreaming:(_Bool)arg4;	// IMP=0x0010000000047c58
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0010000000047b24
