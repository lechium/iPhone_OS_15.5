...
+ (id)sharedMetricsWithPhotoLibrary:(id)arg1;	// IMP=0x0040000000045b8b
+ (id)analysisCompleteTimestampKeyForVCPTask:(unsigned long long)arg1;	// IMP=0x0010000000045020
+ (id)analysisVersionTimestampKeyForVCPTask:(unsigned long long)arg1;	// IMP=0x0010000000044fa0
+ (id)analysisVersionKeyForVCPTask:(unsigned long long)arg1;	// IMP=0x0010000000044f20
- (void).cxx_destruct;	// IMP=0x00200000000467c3
- (int)persist;	// IMP=0x0010000000046061
- (int)reportAnalyzedAsset:(id)arg1 withAnalysis:(id)arg2 andProcessingTime:(double)arg3;	// IMP=0x0010000000045dad
- (void)dealloc;	// IMP=0x0010000000045aff
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000450a0
