...
+ (id)entryWithID:(unsigned long long)arg1 qos:(unsigned int)arg2 background:(_Bool)arg3 andTask:(id)arg4;	// IMP=0x0040000000009f12
- (void).cxx_destruct;	// IMP=0x0020000000009fcb
...
- (id)initWithID:(unsigned long long)arg1 qos:(unsigned int)arg2 background:(_Bool)arg3 andTask:(id)arg4;	// IMP=0x0010000000009e60
