...
+ (id)assetWithLocalIdentifier:(id)arg1 version:(int)arg2 dateModified:(id)arg3 dateAnalyzed:(id)arg4 types:(unsigned long long)arg5 flags:(unsigned long long)arg6 statsFlags:(unsigned long long)arg7 masterFingerprint:(id)arg8 adjustedFingerprint:(id)arg9;	// IMP=0x0040000000017113
- (void).cxx_destruct;	// IMP=0x00200000000172e3
...
- (_Bool)isDegraded;	// IMP=0x001000000001725e
- (_Bool)isDeletePending;	// IMP=0x0010000000017250
- (void)updateLocalIdentifier:(id)arg1;	// IMP=0x001000000001723f
- (id)initWithLocalIdentifier:(id)arg1 version:(int)arg2 dateModified:(id)arg3 dateAnalyzed:(id)arg4 types:(unsigned long long)arg5 flags:(unsigned long long)arg6 statsFlags:(unsigned long long)arg7 masterFingerprint:(id)arg8 adjustedFingerprint:(id)arg9;	// IMP=0x0010000000016f90
