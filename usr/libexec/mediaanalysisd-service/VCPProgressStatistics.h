...
- (unsigned long long)analyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x00100000000260b1
- (void)addAnalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x00100000000260a3
- (unsigned long long)analyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000026095
- (void)addAnalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000026087
- (unsigned long long)unanalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000002607c
- (MISSING_TYPE *)addUnanalyzedWithoutResourcesCounter: /* Error: Ran out of types for this method. */;	// IMP=0x0010000000026071
- (unsigned long long)unanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000026066
- (void)addUnanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000002605b
- (id)init;	// IMP=0x0010000000025ffa
