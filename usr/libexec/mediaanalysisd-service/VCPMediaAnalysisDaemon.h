...
- (void).cxx_destruct;	// IMP=0x0020000000002f8e
- (int)run:(int)arg1 argv:(const char **)arg2;	// IMP=0x0010000000002d56
- (void)registerClient:(id)arg1 forPhotoLibraryURL:(id)arg2 withReply:(CDUnknownBlockType)arg3;	// IMP=0x0010000000002a09
- (void)storeAnalysis:(id)arg1 forAsset:(id)arg2 fromPhotoLibraryURL:(id)arg3 withReply:(CDUnknownBlockType)arg4;	// IMP=0x001000000000257c
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000002030
