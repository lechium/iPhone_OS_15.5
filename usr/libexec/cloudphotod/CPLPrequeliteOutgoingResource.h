...
- (void).cxx_destruct;	// IMP=0x002000000003ad09
...
- (id)resourceWithScopeIdentifier:(id)arg1;	// IMP=0x001000000003ab64
- (id)resourceWithOutgoingResources:(id)arg1;	// IMP=0x001000000003aa59
- (id)initWithResource:(id)arg1 uploadIdentifier:(id)arg2;	// IMP=0x001000000003a790
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x001000000003a63c
