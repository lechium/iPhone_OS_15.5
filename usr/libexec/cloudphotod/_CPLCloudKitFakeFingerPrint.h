...
- (void).cxx_destruct;	// IMP=0x0020000000096c78
...
- (id)initWithRealResourceType:(unsigned long long)arg1 realFingerPrint:(id)arg2 outputType:(id)arg3 dimensions:(struct CGSize)arg4;	// IMP=0x001000000009691f
- (id)initWithFakeFingerPrint:(id)arg1;	// IMP=0x00100000000965fb
- (id)initWithFakeIdentity:(id)arg1;	// IMP=0x00100000000965a5
