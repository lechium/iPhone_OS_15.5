...
+ (unsigned long long)resourceTypeForFieldName:(id)arg1;	// IMP=0x00400000000ca3d1
+ (id)resourceKeysForResourceType:(unsigned long long)arg1;	// IMP=0x00100000000ca37c
- (void).cxx_destruct;	// IMP=0x00200000000ca6ce
...
- (id)initWithPrefix:(id)arg1 resourceType:(unsigned long long)arg2;	// IMP=0x00100000000ca465
