...
- (void).cxx_destruct;	// IMP=0x0020000000004eed
...
- (void)getStatusDictionaryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000048b8
- (void)getStatusWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003ad7
- (void)_setPushRegistrationStatus:(id)arg1 error:(id)arg2;	// IMP=0x0010000000003a5e
- (void)connection:(id)arg1 didReceiveToken:(id)arg2 forTopic:(id)arg3 identifier:(id)arg4;	// IMP=0x001000000000392f
- (void)connection:(id)arg1 didReceiveIncomingMessage:(id)arg2;	// IMP=0x00100000000033b4
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;	// IMP=0x00100000000032ce
- (void)unregisterFromPushNotifications;	// IMP=0x0010000000003237
- (void)stopWaitingForPushNotifications;	// IMP=0x0010000000003151
- (void)startWaitingForPushNotificationsForContainer:(id)arg1;	// IMP=0x0010000000002abd
- (id)init;	// IMP=0x0010000000002890
