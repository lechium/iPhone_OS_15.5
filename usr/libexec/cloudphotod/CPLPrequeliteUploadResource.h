...
- (void).cxx_destruct;	// IMP=0x0020000000052abf
...
- (id)resource;	// IMP=0x00100000000528d9
- (id)initWithResource:(id)arg1;	// IMP=0x00100000000526f3
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000052578
