...
- (void).cxx_destruct;	// IMP=0x002000000002e642
...
- (void)unpublish;	// IMP=0x001000000002e5c6
- (void)publish;	// IMP=0x001000000002e59f
- (void)_publishRealProgressIfNecessary;	// IMP=0x001000000002e474
- (void)setUserInfoObject:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000002e3e3
- (id)initWithIdentifier:(id)arg1 firstSyncOfMainLibrary:(_Bool)arg2;	// IMP=0x001000000002e223
