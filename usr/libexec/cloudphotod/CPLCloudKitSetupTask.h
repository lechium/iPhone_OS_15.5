...
- (void).cxx_destruct;	// IMP=0x00200000000924d8
...
- (void)runOperations;	// IMP=0x00100000000924b6
- (void)fetchUserRecord;	// IMP=0x00100000000923f5
- (void)fetchDerivativesFilter;	// IMP=0x0010000000092117
- (void)fetchDisabledFeatures;	// IMP=0x0010000000091cd7
- (id)initWithController:(id)arg1 updateDisabledFeatures:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000091c41
