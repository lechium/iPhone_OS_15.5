...
+ (id)selfCrashResetReason;	// IMP=0x002000000008ad13
- (void).cxx_destruct;	// IMP=0x002000000008addf
- (void)commitChangeBatch:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000008983b
- (void)finalizeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000088f3f
- (void)beginSessionWithKnownLibraryVersion:(id)arg1 context:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000887df
- (id)clientWorkDescription;	// IMP=0x00100000000887d2
