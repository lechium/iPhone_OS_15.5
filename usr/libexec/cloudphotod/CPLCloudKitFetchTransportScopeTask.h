...
- (void).cxx_destruct;	// IMP=0x002000000008d2f4
...
- (void)runOperations;	// IMP=0x001000000008b956
- (void)createRecordZoneWithID:(id)arg1;	// IMP=0x001000000008b30e
- (void)_callCompletionWithZone:(id)arg1;	// IMP=0x001000000008b193
- (void)_updateCloudKitScopeWithZone:(id)arg1;	// IMP=0x001000000008b073
- (id)initWithController:(id)arg1 scope:(id)arg2 cloudKitScope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000008af60
