...
- (void).cxx_destruct;	// IMP=0x0020000000049e11
...
- (id)resourceWithDownloadQueue:(id)arg1;	// IMP=0x0010000000049c3d
- (id)initWithResource:(id)arg1;	// IMP=0x0010000000049a7a
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000498f4
