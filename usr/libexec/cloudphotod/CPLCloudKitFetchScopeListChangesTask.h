...
+ (id)descriptionForScopeListSyncAnchor:(id)arg1;	// IMP=0x00200000000efe42
- (void).cxx_destruct;	// IMP=0x00200000000f0908
- (void)_launchOperationForSharedDatabase:(_Bool)arg1;	// IMP=0x00100000000effb1
- (void)runOperations;	// IMP=0x00100000000eff9d
- (id)initWithController:(id)arg1 scopeListSyncAnchor:(id)arg2 progressHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000efe99
