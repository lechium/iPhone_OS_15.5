...
- (void).cxx_destruct;	// IMP=0x00200000000efda3
...
- (void)runOperations;	// IMP=0x00100000000ef774
- (void)_fetchLibraryInfoAndStateWithCurrentSyncAnchor:(id)arg1 currentUserID:(id)arg2;	// IMP=0x00100000000ef53d
- (void)_fetchLibraryInfoAndStateWithCurrentSyncAnchor:(id)arg1;	// IMP=0x00100000000ef46a
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000ef385
