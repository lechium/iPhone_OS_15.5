...
- (void).cxx_destruct;	// IMP=0x0020000000061581
...
- (void)resetVersionHasChanged;	// IMP=0x00100000000611e7
...
- (void)noteDatabaseWasUpgradedToVersion:(long long)arg1 fromVersion:(long long)arg2;	// IMP=0x0010000000060e96
- (id)_valueForKey:(id)arg1 class:(Class)arg2;	// IMP=0x0010000000060e3b
- (id)initWithLibraryIdentifier:(id)arg1;	// IMP=0x00100000000604dc
- (void)_save;	// IMP=0x00100000000603b8
- (id)_defaultsKey;	// IMP=0x001000000006039b
