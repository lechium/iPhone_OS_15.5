...
- (void).cxx_destruct;	// IMP=0x0020000000006bdc
...
- (void)cleanup;	// IMP=0x00100000000066ec
- (void)finishOperationID:(id)arg1;	// IMP=0x001000000000633f
- (void)queueOperationID:(id)arg1 options:(id)arg2 clientOperationCallbackProxy:(id)arg3 withBlock:(CDUnknownBlockType)arg4;	// IMP=0x001000000000561d
- (id)initWithDaemon:(id)arg1 connection:(id)arg2;	// IMP=0x00100000000051a3
- (id)initWithDaemon:(id)arg1 group:(id)arg2 bundleID:(id)arg3 isSpringBoardApp:(_Bool)arg4 requiresPastBuddy:(_Bool)arg5 scheduleSendBarrierBlock:(CDUnknownBlockType)arg6;	// IMP=0x0010000000005017
