...
- (void).cxx_destruct;	// IMP=0x0020000000004a5d
...
- (void)complete;	// IMP=0x001000000000471d
- (void)applicationNoLongerInForeground:(id)arg1;	// IMP=0x001000000000446c
- (void)applicationEnteredForeground:(id)arg1;	// IMP=0x00100000000041bb
- (id)_schedulerTaskIdentifier;	// IMP=0x00100000000040b9
- (void)dealloc;	// IMP=0x0010000000003da5
- (id)initWithConnection:(id)arg1 operationID:(id)arg2 group:(id)arg3 bundleID:(id)arg4 isSpringBoardApp:(_Bool)arg5 requiresPastBuddy:(_Bool)arg6 options:(id)arg7 schedulerClass:(Class)arg8 startHandler:(CDUnknownBlockType)arg9 suspendHandler:(CDUnknownBlockType)arg10;	// IMP=0x0010000000002d6b
