...
+ (id)workQueue;	// IMP=0x0020000000059285
- (void).cxx_destruct;	// IMP=0x0020000000058ba7
@property(copy, nonatomic) NSArray *statistics; // @synthesize statistics=_statistics;
- (id);	// IMP=0x0010000000058b8e
- (void)invalidate;	// IMP=0x0010000000058b43
- (void)updateStatistics:(CDUnknownBlockType)arg1;	// IMP=0x0010000000058ab8
- (id)beginTransactionForReason:(id)arg1;	// IMP=0x0010000000058aa2
- (void)dealloc;	// IMP=0x001000000005891b
- (id)initWithLabel:(id)arg1 logCategory:(id)arg2;	// IMP=0x001000000005874f
