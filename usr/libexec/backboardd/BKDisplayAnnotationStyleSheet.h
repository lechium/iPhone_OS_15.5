...
- (void).cxx_destruct;	// IMP=0x002000000001ee9d
...
- (id)newLayerForContent:(id)arg1 scale:(double)arg2;	// IMP=0x001000000001ecb7
- (void)sizeLayer:(id)arg1 toFitAtScale:(double)arg2;	// IMP=0x001000000001ec07
- (void)applyToLayer:(id)arg1 forContent:(id)arg2;	// IMP=0x001000000001eb89
