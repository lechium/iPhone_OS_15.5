...
- (void).cxx_destruct;	// IMP=0x0020000000028c91
- (void)_locked_setObjectWithinProximity:(_Bool)arg1 notify:(_Bool)arg2;	// IMP=0x0010000000028c03
- (void)_locked_updateTouchSuppressionAssertion;	// IMP=0x0010000000028ae6
- (void)_locked_postEventWithDetectionMask:(unsigned int)arg1 toDestinations:(id)arg2 dispatcher:(id)arg3;	// IMP=0x001000000002886b
- (long long)processEvent:(inout struct __IOHIDEvent **)arg1 sender:(id)arg2 dispatcher:(id)arg3;	// IMP=0x0010000000028259
...
- (void)dealloc;	// IMP=0x001000000002815d
- (id)initWithContext:(id)arg1;	// IMP=0x001000000002811e
