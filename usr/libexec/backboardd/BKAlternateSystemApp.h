...
+ (id)_bundleInfoOverrides;	// IMP=0x0020000000022ef1
- (void).cxx_destruct;	// IMP=0x0000000000022c83
...
- (void)_noteExitedWithContext:(id)arg1;	// IMP=0x0010000000022ad9
- (_Bool)terminate;	// IMP=0x00100000000228b1
- (_Bool)launchWithResultBlock:(CDUnknownBlockType)arg1 exitBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000002162a
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x0010000000021593
@property(readonly, copy) NSString *description;
- (id)initWithBundleId:(id)arg1 options:(id)arg2 queue:(id)arg3;	// IMP=0x00100000000214b0
