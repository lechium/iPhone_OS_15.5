...
+ (_Bool)isSmartCoverSupported;	// IMP=0x0020000000061770
- (void).cxx_destruct;	// IMP=0x002000000006150d
...
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x0010000000061260
- (id)addSmartCoverObserver:(id)arg1;	// IMP=0x00100000000611a0
- (long long)processEvent:(inout struct __IOHIDEvent **)arg1 sender:(id)arg2 dispatcher:(id)arg3;	// IMP=0x0010000000060a00
@property(readonly, nonatomic, getter=isSmartCoverClosed) _Bool smartCoverClosed;
- (int)_smartCoverSensorsDidDisengage:(unsigned long long)arg1;	// IMP=0x001000000006097c
- (int)_smartCoverSensorsDidEngage:(unsigned long long)arg1;	// IMP=0x0010000000060947
- (id)initWithContext:(id)arg1;	// IMP=0x0010000000060704
- (unsigned long long)_currentMaskForUsage:(unsigned int)arg1 HIDSystem:(id)arg2 mask:(unsigned long long *)arg3 maskIfEngaged:(unsigned long long *)arg4;	// IMP=0x00100000000605db
- (id)initWithSupportedHES:(unsigned long long)arg1 disengagedHES:(unsigned long long)arg2 attached:(_Bool)arg3 unknownState:(_Bool)arg4;	// IMP=0x00100000000602a9
