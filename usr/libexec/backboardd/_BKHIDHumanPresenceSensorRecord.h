...
- (void).cxx_destruct;	// IMP=0x0020000000074274
...
- (void)removeService:(id)arg1;	// IMP=0x00100000000741ff
- (void)addService:(id)arg1;	// IMP=0x001000000007418b
- (void)_resetServiceStatus;	// IMP=0x0010000000073fc4
- (id)description;	// IMP=0x0010000000073ed6
