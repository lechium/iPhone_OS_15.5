...
- (void).cxx_destruct;	// IMP=0x0020000000024537
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000244c0
- (id)description;	// IMP=0x001000000002447f
- (id)initWithPointSize:(struct CGSize)arg1 cornerRadius:(double)arg2 scale:(double)arg3 displayUUID:(id)arg4;	// IMP=0x00100000000243d0
