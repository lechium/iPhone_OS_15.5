...
- (void).cxx_destruct;	// IMP=0x002000000000f645
...
- (void)assetDownloadSession:(id)arg1 willDownloadVariants:(id)arg2;	// IMP=0x001000000000f4d7
- (void)assetDownloadSession:(id)arg1 didUpdateProgressWithExpectedBytes:(unsigned long long)arg2 bytesDownloaded:(unsigned long long)arg3;	// IMP=0x001000000000f484
- (void)assetDownloadSession:(id)arg1 didResolveMediaSelection:(id)arg2;	// IMP=0x001000000000f3f9
- (void)assetDownloadSession:(id)arg1 didFinishDownloadForMediaSelection:(id)arg2;	// IMP=0x001000000000f32f
- (void)assetDownloadSession:(id)arg1 didLoadTimeRange:(CDStruct_3c1748cc)arg2 totalTimeRangesLoaded:(id)arg3 timeRangeExpectedToLoad:(CDStruct_3c1748cc)arg4 forMediaSelection:(id)arg5;	// IMP=0x001000000000f23b
- (void)assetDownloadSession:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x001000000000f171
- (void)assetDownloadSessionDidFinishDownload:(id)arg1;	// IMP=0x001000000000f0e3
- (void)startLoadingMetadata;	// IMP=0x001000000000f092
- (void)cancelAndDeliverError:(id)arg1;	// IMP=0x001000000000f007
- (void)cancel;	// IMP=0x001000000000ef9a
- (void)suspend;	// IMP=0x001000000000ef2d
- (void)resume;	// IMP=0x001000000000ee82
- (void)releasePowerAssertion;	// IMP=0x001000000000ed98
- (void)takePowerAssertion;	// IMP=0x001000000000eafe
- (void)disavowSession;	// IMP=0x001000000000ea51
- (id)initWithURLAsset:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x001000000000dfc6
- (id)initWithURL:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x001000000000dddd
- (_Bool)doesAVAssetDownloadSessionSupportMultipleDownloads;	// IMP=0x001000000000ddc2
