...
- (void).cxx_destruct;	// IMP=0x002000000002025b
...
- (id)initWithActivity:(id)arg1 budgetID:(id)arg2 clientIdentifier:(id)arg3 extensionIdentifier:(id)arg4 intervalDidStart:(_Bool)arg5;	// IMP=0x00100000000200db
