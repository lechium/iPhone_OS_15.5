...
- (void).cxx_destruct;	// IMP=0x0020000000002d90
...
- (void)stopProducingData;	// IMP=0x0010000000002cb9
- (id)startProducingDataWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x0010000000002bfa
- (id)initWithConfiguration:(id)arg1 receiverQueue:(id)arg2;	// IMP=0x0010000000002b57
