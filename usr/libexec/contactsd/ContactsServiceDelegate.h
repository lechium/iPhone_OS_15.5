...
+ (id)os_log;	// IMP=0x002000000000c2b3
- (void).cxx_destruct;	// IMP=0x002000000000c871
...
- (_Bool)isClientAuthorizedAccessWithAuditToken:(CDStruct_6ad76789)arg1;	// IMP=0x001000000000c659
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000000c503
- (id)initWithServiceProvider:(CDUnknownBlockType)arg1 schedulerProvider:(id)arg2 tccServices:(id)arg3;	// IMP=0x001000000000c40d
- (id)init;	// IMP=0x001000000000c30f
