...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x0010000000034e36
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x0010000000034dea
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x0010000000034daf
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x0010000000034d63
- (unsigned long long)_mapInputOriginFromAssetToCSAudioRecordType:(id)arg1;	// IMP=0x001000000003238b
...
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x0010000000036f75
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x0010000000034170
- (id)_sha256:(id)arg1;	// IMP=0x001000000004ec1c
- (id)_sha1:(id)arg1;	// IMP=0x001000000004eb2b
- (id)localeMapWithName:(id)arg1;	// IMP=0x001000000004e982
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x001000000004e94e
- (id)remoraRTModelLocaleMap;	// IMP=0x001000000004e935
- (id)jarvisRTModelLocaleMap;	// IMP=0x001000000004e91c
- (id)hearstRTModelLocaleMap;	// IMP=0x001000000004e903
- (id)hearstRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x001000000004e8e6
- (id)remoraRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x001000000004e8c6
- (id)rtModelWithAccessoryRTModelType:(long long)arg1 majorVersion:(unsigned long long)arg2 minorVersion:(unsigned long long)arg3 locale:(id)arg4;	// IMP=0x001000000004e0a2
- (id)latestHearstRTModelForLocale:(id)arg1;	// IMP=0x001000000004dcd4
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x001000000004dc6e
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x001000000004dc3a
...
// Error: Property attributes should begin with the type ('T') attribute, property name: keywordDetectorNDAPIConfigFilePath
