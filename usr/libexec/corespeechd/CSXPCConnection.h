...
{
    id <CSXPCConnectionDelegate>;	// 8 = 0x8
...
- (void).cxx_destruct;	// IMP=0x00200000000c85a5
...
- (void)_handlePingPongMessage:(id)arg1 client:(id)arg2;	// IMP=0x00100000000c838d
- (void)_notifyXPCDisconnectionToProxy:(id)arg1;	// IMP=0x00100000000c8332
- (void)_notifyXPCDisconnectionToProxies;	// IMP=0x00100000000c8288
- (void)_handleClientError:(id)arg1 client:(id)arg2;	// IMP=0x00100000000c80ca
- (void)_handleSetXPCClientTypeMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00100000000c7f99
- (void)_handleAudioProvidingRequestTypeSwitchMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00100000000c7e54
- (void)_handleAudioProvidingMessage:(id)arg1 messageBody:(id)arg2 client:(id)arg3;	// IMP=0x00100000000c7cdc
- (void)_handleClientMessage:(id)arg1 client:(id)arg2;	// IMP=0x00100000000c7a5b
- (void)_handleClientEvent:(id)arg1;	// IMP=0x00100000000c7994
- (void)sendMessageToClient:(id)arg1;	// IMP=0x00100000000c77f5
- (void)activateConnection;	// IMP=0x00100000000c76ec
- (_Bool)_getAudioProvideWithContext:(id)arg1 streamClientType:(unsigned long long)arg2;	// IMP=0x00100000000c74a3
- (id)initWithConnection:(id)arg1;	// IMP=0x00100000000c7284
