...
+ (_Bool)supportAttentionLostAndGain;	// IMP=0x00200000000c6b77
- (void).cxx_destruct;	// IMP=0x00200000000c6bf8
...
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000c6ba5
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000c6b9f
- (void)stop;	// IMP=0x00100000000c6b99
- (void)pause;	// IMP=0x00100000000c6b93
- (void)start;	// IMP=0x00100000000c6b8d
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000c6b7f
