...
- (void).cxx_destruct;	// IMP=0x00200000000c8f2e
...
- (void)_setupSSRListener;	// IMP=0x00100000000c8cda
- (void)_setupAttSiriServiceListener;	// IMP=0x00100000000c8b88
- (void)_setupLocalSpeechRecognitionListener;	// IMP=0x00100000000c89da
- (void)_setupEndpointListener;	// IMP=0x00100000000c8831
- (void)start;	// IMP=0x00100000000c881b
- (void)setupListeners;	// IMP=0x00100000000c87be
- (id)init;	// IMP=0x00100000000c8759
- (id)initWithAttSiriController:(id)arg1 supportsAttentiveSiri:(_Bool)arg2 supportsSpeechRecognitionOnDevice:(_Bool)arg3 supportsSSR:(_Bool)arg4;	// IMP=0x00100000000c8623
