...
- (void).cxx_destruct;	// IMP=0x00200000000d0fae
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x00100000000d0e4a
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5;	// IMP=0x00100000000d07f9
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x00100000000d07f3
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x00100000000d07ed
- (void)stopAudioStream;	// IMP=0x00100000000d06cd
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00100000000d0543
- (_Bool)isRecording;	// IMP=0x00100000000d048f
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000d0460
- (_Bool)injectAudio:(id)arg1;	// IMP=0x00100000000d0431
- (void)stop;	// IMP=0x00100000000d036c
- (void)start;	// IMP=0x00100000000d0294
- (void)dealloc;	// IMP=0x00100000000d01da
- (void)attachDevice:(id)arg1;	// IMP=0x00100000000d00e8
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x00100000000d0034
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x00100000000cffc8
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x00100000000cffc0
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00100000000cfe58
