...
- (void).cxx_destruct;	// IMP=0x0020000000034148
...
- (void)_reportUEIUserSpeakingContext;	// IMP=0x0010000000034068
- (void)reportEndpointDelayIfNeed;	// IMP=0x0010000000034062
- (void)setSpeechRecognizedContext:(id)arg1 withEndpointerMetrics:(id)arg2;	// IMP=0x0010000000033dc6
- (unsigned long long)estimatedUserSpeakingEndedHostTime;	// IMP=0x0010000000033d82
- (unsigned long long)estimatedUserSpeakingStartedHostTime;	// IMP=0x0010000000033d4c
- (void)reset;	// IMP=0x0010000000033c8b
- (id)initWithRequestMHUUID:(id)arg1 turnIdentifier:(id)arg2;	// IMP=0x0010000000033b41
