...
- (void).cxx_destruct;	// IMP=0x00200000000a0cb3
...
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000a0c45
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000a0c3f
- (void)stop;	// IMP=0x00100000000a0c39
- (void)pause;	// IMP=0x00100000000a0c33
- (void)start;	// IMP=0x00100000000a0c2d
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000a0c1f
