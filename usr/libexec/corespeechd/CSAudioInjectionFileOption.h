...
- (void).cxx_destruct;	// IMP=0x00200000000183b3
...
- (id)description;	// IMP=0x0010000000018316
- (id)initWithAudioURL:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3;	// IMP=0x0010000000018278
