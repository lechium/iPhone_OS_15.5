...
- (void).cxx_destruct;	// IMP=0x00200000000b8a2b
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x00100000000b88c7
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5;	// IMP=0x00100000000b8271
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x00100000000b826b
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x00100000000b8265
- (void)stopAudioStream;	// IMP=0x00100000000b8145
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00100000000b7fbb
- (_Bool)isRecording;	// IMP=0x00100000000b7f07
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000b7ed8
- (_Bool)injectAudio:(id)arg1;	// IMP=0x00100000000b7ea9
- (void)stop;	// IMP=0x00100000000b7de4
- (void)start;	// IMP=0x00100000000b7d0c
- (void)dealloc;	// IMP=0x00100000000b7c52
- (void)attachDevice:(id)arg1;	// IMP=0x00100000000b7b60
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x00100000000b7aac
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x00100000000b7a40
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x00100000000b7a38
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00100000000b78ce
