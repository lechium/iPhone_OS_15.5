...
- (void).cxx_destruct;	// IMP=0x002000000006ab21
...
- (_Bool)_multimodalEndpointerEnabled;	// IMP=0x001000000006a538
- (_Bool)_shouldUsePhaticWithRecordContext;	// IMP=0x001000000006a49a
- (id)_getCSHybridEndpointerConfigForAsset:(id)arg1;	// IMP=0x001000000006a1c0
- (void)_updateAssetWithCurrentLanguage;	// IMP=0x001000000006a14a
- (void)_updateAssetWithLanguage:(id)arg1;	// IMP=0x0010000000069f77
- (void)CSFirstUnlockMonitor:(id)arg1 didReceiveFirstUnlock:(_Bool)arg2;	// IMP=0x0010000000069ead
- (void)CSAssetManagerDidDownloadNewAsset:(id)arg1;	// IMP=0x0010000000069e17
- (void)CSLanguageCodeUpdateMonitor:(id)arg1 didReceiveLanguageCodeChanged:(id)arg2;	// IMP=0x0010000000069d5a
...
- (void)reset;	// IMP=0x0010000000069d34
- (void)_readParametersFromHEPAsset:(id)arg1;	// IMP=0x0010000000069a53
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x0010000000068d9c
- (long long)fetchCurrentEndpointerOperationMode;	// IMP=0x0010000000068d94
- (void)setEndpointerOperationMode:(long long)arg1;	// IMP=0x0010000000068d8e
- (void)stopEndpointer;	// IMP=0x0010000000068cf8
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x0010000000068c50
- (void)terminateProcessing;	// IMP=0x0010000000068bdd
- (void)preheat;	// IMP=0x0010000000068bd7
- (void)handleVoiceTriggerWithActivationInfo:(id)arg1;	// IMP=0x00100000000688e1
- (void)logFeaturesWithEvent:(id)arg1 locale:(id)arg2;	// IMP=0x00100000000680b6
- (void)_emitEndpointDetectedEventWithEndpointTimeMs:(double)arg1 endpointBufferHostTime:(unsigned long long)arg2 endpointerFeatures:(id)arg3 endpointerDecisionLagInNs:(double)arg4 extraDelayMs:(unsigned long long)arg5 endpointScore:(double)arg6 asrFeatureLatencies:(id)arg7;	// IMP=0x00100000000680a5
- (void)osdAnalyzer:(id)arg1 didUpdateOSDFeatures:(id)arg2;	// IMP=0x00100000000660f3
- (void)shouldAcceptEagerResultForDuration:(double)arg1 resultsCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000659cc
- (void)processServerEndpointFeatures:(id)arg1;	// IMP=0x00100000000656fe
- (void)updateEndpointerDelayedTrigger:(_Bool)arg1;	// IMP=0x0010000000065655
- (void)updateEndpointerThreshold:(float)arg1;	// IMP=0x00100000000655a8
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x0010000000064e7e
- (void)_loadAndSetupEndpointerAssetIfNecessary;	// IMP=0x0010000000064b63
- (id)init;	// IMP=0x00100000000643aa
