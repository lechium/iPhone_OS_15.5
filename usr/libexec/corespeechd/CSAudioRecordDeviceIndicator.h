...
- (void).cxx_destruct;	// IMP=0x00200000000db326
...
- (void)updateDeviceId:(id)arg1;	// IMP=0x00100000000db2ee
- (void)updateWithLatestRecordContext:(id)arg1;	// IMP=0x00100000000db150
- (id)initWithRecordContext:(id)arg1 deviceId:(id)arg2 shouldUseRemoteRecorder:(_Bool)arg3 streamHandleId:(unsigned long long)arg4;	// IMP=0x00100000000db087
