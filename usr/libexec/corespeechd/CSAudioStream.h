...
- (void).cxx_destruct;	// IMP=0x0020000000090c09
...
- (void)audioStreamProvider:(id)arg1 didHardwareConfigurationChange:(long long)arg2;	// IMP=0x00100000000909a6
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x00100000000908e0
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2 lastForwardedSampleCount:(unsigned long long)arg3;	// IMP=0x00100000000908ca
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x0010000000090804
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x0010000000090537
- (void)updateAudioStreamStartTimeInSampleCount:(unsigned long long)arg1;	// IMP=0x0010000000090070
- (_Bool)isNarrowBand;	// IMP=0x001000000009002c
- (id)recordSettings;	// IMP=0x001000000008ffdc
- (_Bool)isStreaming;	// IMP=0x001000000008fec7
- (void)stopAudioStreamWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000008fa19
- (void)startAudioStreamWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000008f73c
- (void)prepareAudioStreamWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000008f6b3
- (_Bool)prepareAudioStreamSyncWithRequest:(id)arg1 error:(id *)arg2;	// IMP=0x001000000008f633
- (void)dealloc;	// IMP=0x001000000008f4d3
- (id)initWithAudioStreamProvider:(id)arg1 streamName:(id)arg2 streamRequest:(id)arg3;	// IMP=0x001000000008f2d7
