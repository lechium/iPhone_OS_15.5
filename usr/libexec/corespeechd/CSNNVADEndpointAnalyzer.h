...
- (void).cxx_destruct;	// IMP=0x002000000004cc45
...
- (double)trailingSilenceDurationAtEndpoint;	// IMP=0x001000000004cb34
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x001000000004cab5
- (void)stopEndpointer;	// IMP=0x001000000004ca36
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x001000000004c9b7
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x001000000004c938
- (void)reset;	// IMP=0x001000000004c8b9
- (void)preheat;	// IMP=0x001000000004c83a
- (id)init;	// IMP=0x001000000004c783
