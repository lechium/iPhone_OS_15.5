...
+ (id)requestForSpeexRecordSettingsWithContext:(id)arg1;	// IMP=0x00200000000ba91d
+ (id)requestForOpusRecordSettingsWithContext:(id)arg1;	// IMP=0x00100000000ba7af
+ (id)requestForLpcmRecordSettingsWithContext:(id)arg1;	// IMP=0x00100000000ba624
+ (id)defaultRequestWithContext:(id)arg1;	// IMP=0x00100000000ba37c
- (void).cxx_destruct;	// IMP=0x00200000000bb189
...
- (id)description;	// IMP=0x00100000000bafb9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000baed8
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x00100000000babeb
- (id)initTandemWithRequest:(id)arg1;	// IMP=0x00100000000baa7c
