...
- (void).cxx_destruct;	// IMP=0x002000000005b83c
...
- (void)spgEndpointAnalyzer:(id)arg1 hasSilenceScoreEstimate:(double)arg2 clientProcessedAudioTimeMS:(float)arg3;	// IMP=0x001000000005b2d3
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x001000000005b2cd
- (_Bool)_shouldReportBoron;	// IMP=0x001000000005b295
- (_Bool)_popRemoteVADSignal;	// IMP=0x001000000005b216
- (void)_addRemoteVADSignal:(_Bool)arg1;	// IMP=0x001000000005b188
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x001000000005add4
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x001000000005ad25
- (void)stopListenWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000005ad0e
- (void)stopListenWithStateReset:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000005a986
- (void)_startRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000005a39c
- (void)_resetAlignBuffer;	// IMP=0x001000000005a373
- (void)startListenWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000059e73
- (id)init;	// IMP=0x0010000000059d85
