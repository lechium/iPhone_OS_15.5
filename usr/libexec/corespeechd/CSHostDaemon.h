...
+ (id)sharedDaemon;	// IMP=0x00400000000c8f77
- (void).cxx_destruct;	// IMP=0x00200000000c982c
...
- (void)_daemonWillShutdown;	// IMP=0x00100000000c9651
- (void)_setupNotifyHandlers;	// IMP=0x00100000000c94c1
- (void)_daemonDidLaunch;	// IMP=0x00100000000c92b1
- (void)shutdown;	// IMP=0x00100000000c9299
- (void)didLaunch;	// IMP=0x00100000000c9287
- (id)init;	// IMP=0x00100000000c8fcc
