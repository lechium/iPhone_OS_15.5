...
- (void).cxx_destruct;	// IMP=0x0020000000091c63
...
- (void)beepCancellerDidCancelSamples:(id)arg1 buffer:(id)arg2 timestamp:(unsigned long long)arg3;	// IMP=0x0010000000091b25
- (void)zeroFilter:(id)arg1 zeroFilteredBufferAvailable:(id)arg2 atHostTime:(unsigned long long)arg3;	// IMP=0x0010000000091a4c
- (_Bool)_isNarrowBand:(float)arg1;	// IMP=0x0010000000091a18
- (id)_fetchCurrentMetrics;	// IMP=0x001000000009185e
- (void)_reportMetrics;	// IMP=0x00100000000917e3
- (void)reportMetricsForSiriRequestWithUUID:(id)arg1;	// IMP=0x00100000000917dd
- (void)willBeepWithRecordRoute:(id)arg1 playbackRoute:(id)arg2;	// IMP=0x001000000009177d
- (void)flush;	// IMP=0x001000000009166d
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2 arrivalTimestampToAudioRecorder:(unsigned long long)arg3;	// IMP=0x0010000000091439
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x0010000000091201
- (id)initWithSampleRate:(float)arg1 withNumberOfChannels:(int)arg2;	// IMP=0x00100000000910cb
