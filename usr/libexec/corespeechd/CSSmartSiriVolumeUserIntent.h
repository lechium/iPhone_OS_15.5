...
- (double)applyLowerAndUpperBoundsToVolumeOffset:(float)arg1;	// IMP=0x00100000000bba6d
- (void)storeASVStateInformation;	// IMP=0x00100000000bba1a
- (float)decreaseSiriVolumeBasedOnUserIntent;	// IMP=0x00100000000bb9f9
- (float)increaseSiriVolumeBasedOnUserIntent;	// IMP=0x00000000000bb9d8
- (void)initWithStoredInformationAndAsset:(id)arg1;	// IMP=0x00100000000bb88c
- (double)applyLowerAndUpperBoundsToVolume:(float)arg1;	// IMP=0x00100000000bb784
