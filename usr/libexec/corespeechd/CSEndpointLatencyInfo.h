...
- (void).cxx_destruct;	// IMP=0x00200000000c9f78
...
- (void)_emitMHEndpointLatencyInfo:(id)arg1 withRequestMHUUID:(id)arg2;	// IMP=0x00100000000c9eea
- (void)reportWithRequestMHUUID:(id)arg1;	// IMP=0x00100000000c9c35
- (void)addPktInfoWithTimestamp:(unsigned long long)arg1 arrivalTimestamp:(unsigned long long)arg2 currentMachTime:(unsigned long long)arg3;	// IMP=0x00100000000c9978
- (id)init;	// IMP=0x00100000000c98c2
