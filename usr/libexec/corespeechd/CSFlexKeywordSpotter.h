...
- (void).cxx_destruct;	// IMP=0x002000000001091d
...
- (void)speechRecognizer:(id)arg1 didRecognizePartialResult:(id)arg2;	// IMP=0x00100000000107dc
- (void)reset;	// IMP=0x001000000001071d
- (void)speechRecognizer:(id)arg1 didRecognizePartialResultNbest:(id)arg2;	// IMP=0x001000000000fd9c
- (void)speechRecognizer:(id)arg1 didRecognizeFinalResults:(id)arg2;	// IMP=0x001000000000fcf9
- (void)speechRecognizer:(id)arg1 didFinishRecognitionWithError:(id)arg2;	// IMP=0x001000000000fc56
- (void)processAudioChunk:(id)arg1;	// IMP=0x001000000000fa70
- (void)startKeywordSpottingWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000f367
- (id)init;	// IMP=0x001000000000f307
