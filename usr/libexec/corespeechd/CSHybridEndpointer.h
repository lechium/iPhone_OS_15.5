...
- (void).cxx_destruct;	// IMP=0x002000000009a92a
...
- (void)setSpeechEndpointDetected:(_Bool)arg1;	// IMP=0x001000000009a80d
- (_Bool)speechEndpointDetected;	// IMP=0x001000000009a804
...
- (_Bool)_multimodalEndpointerEnabled;	// IMP=0x001000000009a376
- (_Bool)_shouldUsePhaticWithRecordContext;	// IMP=0x001000000009a2d8
- (id)_getCSHybridEndpointerConfigForAsset:(id)arg1;	// IMP=0x0010000000099ffe
- (void)endpointerAssetManagerDidUpdateOSDAsset:(id)arg1;	// IMP=0x0010000000099ff8
- (void)endpointerAssetManagerDidUpdateAsset:(id)arg1;	// IMP=0x0010000000099e32
...
- (void)reset;	// IMP=0x0010000000099e0c
- (void)_readParametersFromHEPAsset:(id)arg1;	// IMP=0x00100000000999d9
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x0010000000098f39
- (void)stopEndpointer;	// IMP=0x0010000000098ea3
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x0010000000098dfb
- (void)terminateProcessing;	// IMP=0x0010000000098df1
- (void)preheat;	// IMP=0x0010000000098deb
- (void)handleVoiceTriggerWithActivationInfo:(id)arg1;	// IMP=0x0010000000098af5
- (void)logFeaturesWithEvent:(id)arg1 locale:(id)arg2;	// IMP=0x00100000000983a1
- (void)_emitEndpointDetectedEventWithEndpointTimeMs:(double)arg1 endpointBufferHostTime:(unsigned long long)arg2 endpointerFeatures:(id)arg3 endpointerDecisionLagInNs:(double)arg4 extraDelayMs:(unsigned long long)arg5 endpointScore:(double)arg6 asrFeatureLatencies:(id)arg7;	// IMP=0x0010000000098390
- (void)processOSDFeatures:(id)arg1 withFrameDurationMs:(double)arg2;	// IMP=0x0010000000096535
- (void)processFirstAudioPacketTimestamp:(id)arg1 firstAudioSampleSensorTimestamp:(unsigned long long)arg2;	// IMP=0x00100000000963bd
- (void)logAnchorMachAbsTime:(unsigned long long)arg1 numSamplesProcessedBeforeAnchorTime:(unsigned long long)arg2 isAnchorTimeBuffered:(_Bool)arg3;	// IMP=0x0010000000096335
- (void)shouldAcceptEagerResultForDuration:(double)arg1 resultsCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000095c0e
- (void)processServerEndpointFeatures:(id)arg1;	// IMP=0x0010000000095940
- (void)processTaskString:(id)arg1;	// IMP=0x0010000000095627
- (void)processASRFeatures:(id)arg1 fromServer:(_Bool)arg2;	// IMP=0x0010000000095580
- (long long)fetchCurrentEndpointerOperationMode;	// IMP=0x001000000009543e
- (void)updateEndpointerDelayedTrigger:(_Bool)arg1;	// IMP=0x00100000000952a0
- (void)_updateEndpointerDelayedTriggerByMhId:(id)arg1;	// IMP=0x0010000000095189
- (void)updateEndpointerThreshold:(float)arg1;	// IMP=0x00100000000950dc
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x00100000000950d6
- (id)init;	// IMP=0x00100000000949f3
