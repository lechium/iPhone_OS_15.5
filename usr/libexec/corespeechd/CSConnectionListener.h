...
+ (id)createSmartSiriVolumeListener;	// IMP=0x002000000005f41d
- (void).cxx_destruct;	// IMP=0x00200000000cd338
...
- (void)resumeConnection;	// IMP=0x00100000000cd1fe
- (void)notifyClientsWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000ccdd4
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000cc56d
- (void)dealloc;	// IMP=0x00100000000cc4af
- (id)initWithMachService:(id)arg1 withServiceInterface:(id)arg2 withServiceObject:(id)arg3 withDelegateInterface:(id)arg4;	// IMP=0x00100000000cc20e
