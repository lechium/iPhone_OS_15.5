...
- (void).cxx_destruct;	// IMP=0x00200000000d6f0c
...
- (id)delegate;	// IMP=0x00100000000d6d9b
...
- (struct AudioStreamBasicDescription)_defaultOutASBD;	// IMP=0x00100000000d6ce6
- (id)_compensateChannelDataIfNeeded:(id)arg1 receivedNumChannels:(unsigned int)arg2;	// IMP=0x00100000000d6b10
- (id)_deinterleaveBufferIfNeeded:(struct AudioBufferList *)arg1;	// IMP=0x00100000000d69b9
- (void)stopAudioStream;	// IMP=0x00100000000d6861
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00100000000d6772
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3 playbackStarted:(CDUnknownBlockType)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00100000000d6228
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000d6167
- (_Bool)injectAudio:(id)arg1;	// IMP=0x00100000000d6148
- (void)_readAudioBufferAndFeed;	// IMP=0x00100000000d54dd
- (void)_startAudioFeedingTimer;	// IMP=0x00100000000d53ba
- (void)stop;	// IMP=0x00100000000d5235
- (void)_createDeInterleaverIfNeeded;	// IMP=0x00100000000d5076
- (void)start;	// IMP=0x00100000000d4ff8
- (void)attachDevice:(id)arg1;	// IMP=0x00100000000d4ff2
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x00100000000d4fea
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x00100000000d4fe4
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x00100000000d4fdc
- (void)setDelegate:(id)arg1;	// IMP=0x00100000000d4fcb
- (void)dealloc;	// IMP=0x00100000000d4f8c
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00100000000d4e66
