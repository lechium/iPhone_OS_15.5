...
- (void).cxx_destruct;	// IMP=0x002000000000be4d
...
- (void)dispatchStateChangedFrom:(unsigned long long)arg1 to:(unsigned long long)arg2;	// IMP=0x001000000000b9bb
- (void)notifyObserver:(id)arg1 didChangeStateFrom:(unsigned long long)arg2 to:(unsigned long long)arg3;	// IMP=0x001000000000b8db
- (void)notifyObserver:(id)arg1 didReceiveNotificationWithToken:(int)arg2;	// IMP=0x001000000000b7d9
- (id)initWithDelegate:(id)arg1;	// IMP=0x001000000000b666
