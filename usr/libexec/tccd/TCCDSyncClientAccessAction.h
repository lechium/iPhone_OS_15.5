...
+ (_Bool)supportsSecureCoding;	// IMP=0x0040000000008237
...
- (id)syncId;	// IMP=0x0010000000008786
@property(readonly, copy) NSString *clientIdentifierForCurrentPlatform;
- (id)_description;	// IMP=0x001000000000868e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000853f
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000082f8
- (id)initWithServiceIdentifier:(id)arg1 mainClientIdentifier:(id)arg2 replicaClientIdentifier:(id)arg3 clientType:(int)arg4;	// IMP=0x001000000000823f
