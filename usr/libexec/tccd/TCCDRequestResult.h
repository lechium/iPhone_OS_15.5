...
+ (void)populateReplyMessageToDeny:(id)arg1 withError:(id)arg2;	// IMP=0x0040000000048b9f
- (void).cxx_destruct;	// IMP=0x0020000000049648
...
- (void)populateReplyMessage:(id)arg1;	// IMP=0x0010000000049175
- (id)description;	// IMP=0x0010000000049161
- (id)descriptionWithRespectToService:(id)arg1;	// IMP=0x0010000000048ea9
- (void)denyAuthorizationWithErrorCode:(long long)arg1 format:(id)arg2;	// IMP=0x0010000000048ce1
- (id)init;	// IMP=0x0010000000048c90
