...
- (void).cxx_destruct;	// IMP=0x0020000000046fba
...
- (id)initForSyncRequestForSubjectBundleIdentifier:(id)arg1 service:(id)arg2;	// IMP=0x0010000000046be4
- (id)init;	// IMP=0x0010000000046bcb
- (id)initWithRequestMessage:(id)arg1 forServer:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000046651
