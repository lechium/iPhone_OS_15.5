...
- (void).cxx_destruct;	// IMP=0x0020000000052d36
...
- (void)display;	// IMP=0x001000000005295c
- (_Bool)isDisplayableForCondition:(long long)arg1;	// IMP=0x0010000000052866
- (id)initWithCondition:(long long)arg1 platformName:(id)arg2 service:(id)arg3 displayPolicy:(long long)arg4 persistentStateType:(unsigned long long)arg5 displayCountlimit:(int)arg6 configuration:(id)arg7;	// IMP=0x0010000000052759
