...
- (void).cxx_destruct;	// IMP=0x0020000000009a2b
...
- (unsigned long long)performRequestAccessAction:(id)arg1;	// IMP=0x0010000000009434
- (id)initWithSyncController:(id)arg1;	// IMP=0x00100000000093d0
