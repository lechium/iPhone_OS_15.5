...
+ (id)telephony;	// IMP=0x002000000001cd66
- (void).cxx_destruct;	// IMP=0x002000000001ec3b
...
- (long long)dataIndicatorToConnectionType:(int)arg1;	// IMP=0x001000000001ea59
- (struct __SCNetworkReachability *)reachabilityWithHostName:(id)arg1;	// IMP=0x001000000001ea32
- (void)updateTelephonyProperties;	// IMP=0x001000000001e1fa
- (void)updateCellularSignalStrength;	// IMP=0x001000000001ddd1
- (void)updateNetworkInfo;	// IMP=0x001000000001d9f9
- (void)signalStrengthChanged:(id)arg1 info:(id)arg2;	// IMP=0x001000000001d650
- (void)monitoringReachability;	// IMP=0x001000000001d229
- (void)monitoringTelephony;	// IMP=0x001000000001d0b3
...
- (void)dealloc;	// IMP=0x001000000001ce95
- (id)init;	// IMP=0x001000000001cdbb
