...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000026f17
...
- (void)_performForceReconcile;	// IMP=0x0010000000027b4a
- (id)_fakeID;	// IMP=0x0010000000027aa1
- (id)initWithIDAccountsRecord:(id)arg1 storefront:(id)arg2 monthlyIDResetCount:(id)arg3;	// IMP=0x00100000000274b5
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000027212
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000026f1f
