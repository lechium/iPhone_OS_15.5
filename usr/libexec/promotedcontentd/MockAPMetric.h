...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000e387f
...
- (void)addInternalPropertyValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00100000000e3a05
- (id)duplicateMetricReplacingIdentifier:(id)arg1;	// IMP=0x00100000000e397f
- (void)_replaceIdentifierWithIdentifier:(id)arg1;	// IMP=0x00100000000e396e
@property(readonly, nonatomic) NSString *bundleIdentifier;
- (id)initWithRoute:(long long)arg1 metric:(long long)arg2 contentIdentifier:(id)arg3 contextIdentifier:(id)arg4 identifier:(id)arg5 properties:(id)arg6 internalProperties:(id)arg7 options:(long long)arg8;	// IMP=0x00100000000e38a8
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000e389a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000e3894
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000e3887
