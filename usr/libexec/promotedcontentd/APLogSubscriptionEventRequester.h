...
- (void).cxx_destruct;	// IMP=0x002000000007b67f
...
- (id)protoBuffer;	// IMP=0x001000000007b3a8
- (Class)responseClass;	// IMP=0x001000000007b397
- (void)addParameter:(id)arg1 value:(id)arg2 parameters:(id)arg3;	// IMP=0x001000000007b2c2
- (id)initWithMetric:(id)arg1 bundleID:(id)arg2;	// IMP=0x001000000007adfd
