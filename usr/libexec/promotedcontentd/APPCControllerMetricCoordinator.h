...
+ (void)stop;	// IMP=0x00400000000ea5b7
+ (void)start;	// IMP=0x00100000000ea078
- (void).cxx_destruct;	// IMP=0x00200000000eba89
...
- (void)_setRateLimit:(id)arg1;	// IMP=0x00100000000eb8b0
- (void)processMetric:(id)arg1;	// IMP=0x00100000000eb654
- (id)_provideEnvironmentForMetric:(id)arg1;	// IMP=0x00100000000eaf76
- (void)processInternalMetric:(id)arg1;	// IMP=0x00100000000eae6f
- (void)handleMetricForTesting:(id)arg1;	// IMP=0x00100000000eaa26
- (void)metricReceived:(id)arg1;	// IMP=0x00100000000ea94c
- (void)internalMetricReceived:(id)arg1;	// IMP=0x00100000000ea846
- (id)initWithTokens:(id)arg1;	// IMP=0x00100000000ea7c1
