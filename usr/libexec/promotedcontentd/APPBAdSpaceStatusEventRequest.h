...
+ (id)options;	// IMP=0x002000000006ef0c
- (void).cxx_destruct;	// IMP=0x0020000000071768
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000713a1
- (unsigned long long)hash;	// IMP=0x0010000000070fad
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000070c10
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007098c
- (void)copyTo:(id)arg1;	// IMP=0x0010000000070776
- (void)writeTo:(id)arg1;	// IMP=0x0010000000070561
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000070554
- (id)dictionaryRepresentation;	// IMP=0x001000000006f91f
- (id)description;	// IMP=0x001000000006f870
...
- (int)StringAsStatusCode:(id)arg1;	// IMP=0x001000000006f378
- (id)statusCodeAsString:(int)arg1;	// IMP=0x001000000006f157
