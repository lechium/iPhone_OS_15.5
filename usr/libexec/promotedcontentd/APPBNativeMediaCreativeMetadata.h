...
+ (id)options;	// IMP=0x002000000008fe70
- (void).cxx_destruct;	// IMP=0x0020000000090e5d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000090cb8
- (unsigned long long)hash;	// IMP=0x0010000000090bcc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000090a27
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000908ed
- (void)copyTo:(id)arg1;	// IMP=0x00100000000907f7
- (void)writeTo:(id)arg1;	// IMP=0x00100000000906f1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000906e4
- (id)dictionaryRepresentation;	// IMP=0x00100000000900d2
- (id)description;	// IMP=0x0010000000090023
