...
+ (id)sharedInstance;	// IMP=0x00400000000e4af0
- (void).cxx_destruct;	// IMP=0x00200000000e4edb
...
- (id)addIDAccount:(id)arg1;	// IMP=0x00100000000e4be4
- (id)init;	// IMP=0x00100000000e4b45
