...
+ (Class)invitedHandlesType;	// IMP=0x00200000000062a8
+ (id)linkWithTUConversationLink:(id)arg1 includeGroupUUID:(_Bool)arg2;	// IMP=0x0010000000005dc5
- (void).cxx_destruct;	// IMP=0x00100000000082d4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000007e96
- (unsigned long long)hash;	// IMP=0x0010000000007b22
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000783b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000749a
- (void)copyTo:(id)arg1;	// IMP=0x0010000000007274
- (void)writeTo:(id)arg1;	// IMP=0x0010000000006fe1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000006fd4
- (id)dictionaryRepresentation;	// IMP=0x00100000000065ba
- (id)description;	// IMP=0x001000000000650b
- (int)StringAsLinkLifetimeScope:(id)arg1;	// IMP=0x00100000000064a9
- (id)linkLifetimeScopeAsString:(int)arg1;	// IMP=0x0010000000006454
...
- (id)invitedHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x001000000000628b
- (unsigned long long)invitedHandlesCount;	// IMP=0x001000000000626e
- (void)addInvitedHandles:(id)arg1;	// IMP=0x0010000000006204
- (void)clearInvitedHandles;	// IMP=0x00100000000061e7
