...
+ (id)activityWithCSDConversationActivity:(id)arg1 handle:(id)arg2;	// IMP=0x0010000000092253
+ (id)activityWithCSDConversationActivity:(id)arg1 fromConversation:(id)arg2 forStorage:(_Bool)arg3;	// IMP=0x0010000000091cad
- (void).cxx_destruct;	// IMP=0x001000000011794b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000011757e
- (unsigned long long)hash;	// IMP=0x0010000000117219
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000116f12
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000116cce
- (void)copyTo:(id)arg1;	// IMP=0x0010000000116b03
- (void)writeTo:(id)arg1;	// IMP=0x001000000011694d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000116940
- (id)dictionaryRepresentation;	// IMP=0x00100000001160ee
- (id)description;	// IMP=0x001000000011603f
