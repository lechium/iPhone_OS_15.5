...
+ (id)mockCallFromBlock:(CDUnknownBlockType)arg1;	// IMP=0x004000000018766e
+ (id)mockCall;	// IMP=0x001000000018765a
- (void).cxx_destruct;	// IMP=0x00200000001886bb
...
- (void)disconnectWithReason:(int)arg1;	// IMP=0x0010000000187eed
- (void)dialWithRequest:(id)arg1 displayContext:(id)arg2;	// IMP=0x0010000000187d71
- (void)answerWithRequest:(id)arg1;	// IMP=0x0010000000187ca0
- (void)unhold;	// IMP=0x0010000000187c89
- (void)hold;	// IMP=0x0010000000187c72
- (void)setEndpointOnCurrentDevice:(_Bool)arg1;	// IMP=0x0010000000187c60
- (void)updateWithCall:(id)arg1;	// IMP=0x0010000000187783
- (id)initWithUniqueProxyIdentifier:(id)arg1;	// IMP=0x00100000001876b2
