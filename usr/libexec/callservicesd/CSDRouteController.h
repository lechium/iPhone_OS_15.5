...
+ (id)makePairedHostDeviceRouteController;	// IMP=0x0020000000290660
+ (id)makeLocalRouteController;	// IMP=0x0010000000290640
- (void).cxx_destruct;	// IMP=0x00400000002925a0
- (id)init;	// IMP=0x0010000000292540
- (void)handleUpdatedPairedHostDeviceRoutes:(id)arg1;	// IMP=0x0010000000292140
- (void)clearState;	// IMP=0x0010000000291c10
- (void)pickRouteWithUniqueIdentifier:(id)arg1 shouldWaitUntilAvailable:(_Bool)arg2;	// IMP=0x0010000000291890
