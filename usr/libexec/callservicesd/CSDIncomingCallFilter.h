...
@interface CSDIncomingCallFilter : NSObject
{
    ...
    _Bool _kettleFeatureComplete;	// 9 = 0x9
...
- (void).cxx_destruct;	// IMP=0x002000000011d118
...
- (void)callsChangedForCallCenterObserver:(id)arg1;	// IMP=0x001000000011cebd
@property(nonatomic, getter=isOnEmergencyCall) _Bool onEmergencyCall; // @synthesize onEmergencyCall=_onEmergencyCall;
- (id)_callDirectoryPhoneNumberVariantsForSourceAddress:(id)arg1 countryCode:(id)arg2;	// IMP=0x001000000011cbbb
- (_Bool)callDirectoryAllowsCallFromSourceAddress:(id)arg1 countryCode:(id)arg2;	// IMP=0x001000000011c933
- (_Bool)callDirectoryAllowsCallFromSourceAddress:(id)arg1;	// IMP=0x001000000011c89b
- (_Bool)_doNotDisturbAllowsCallFromSourceAddress:(id)arg1 providerIdentifier:(id)arg2;	// IMP=0x001000000011c593
- (id)_callFilterIdentifier;	// IMP=0x001000000011c540
- (CDUnknownBlockType)_callFilterBlock;	// IMP=0x001000000011c277
- (id)initWithDataSource:(id)arg1 deviceLockObserver:(id)arg2 callCenterObserver:(id)arg3 callDirectoryStoreBuilder:(CDUnknownBlockType)arg4 queue:(id)arg5;	// IMP=0x001000000011beb9
- (id)init;	// IMP=0x001000000011bbe8
