...
- (void).cxx_destruct;	// IMP=0x00200000001493aa
...
- (id)callsForDataSource:(id)arg1 identifier:(id)arg2;	// IMP=0x00100000001492a5
- (void)addCalls:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x0010000000148f78
@property(readonly, copy, nonatomic) NSArray *dataSources;
- (id)init;	// IMP=0x0010000000148ecb
