...
@class CSDConversationParticipant, NSData, NSNumber, NSString, TUCallScreenShareAttributes;
...
- (void)setScreenEnabled:(_Bool)arg1 attributes:(TUCallScreenShareAttributes *)arg2;
- (void)setScreenShareAttributes:(TUCallScreenShareAttributes *)arg1;
