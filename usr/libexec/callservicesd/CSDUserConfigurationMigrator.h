...
- (void).cxx_destruct;	// IMP=0x0020000000123715
@property(readonly, nonatomic) TUUserConfiguration *userConfiguration; // @synthesize userConfiguration=_userConfiguration;
- (void)migrateConversationLinkBaseURL;	// IMP=0x00100000001234c2
- (void)migrateAnnounceCalls;	// IMP=0x0010000000123277
- (void)perform;	// IMP=0x0010000000123249
- (id)init;	// IMP=0x00100000001231f3
