...
- (void).cxx_destruct;	// IMP=0x0020000000177add
...
- (id)description;	// IMP=0x00100000001776a6
- (void)invokeDidStopIfNecessary:(_Bool)arg1 error:(id)arg2;	// IMP=0x0010000000177602
- (void)invokeDidStartIfNecessary:(_Bool)arg1 error:(id)arg2;	// IMP=0x0010000000177549
- (void)invokeDidPrepareIfNecessary:(id)arg1;	// IMP=0x00100000001774ad
- (id)init;	// IMP=0x00100000001773cc
- (id)initWithCall:(id)arg1;	// IMP=0x0010000000177323
- (id)initWithIdentifier:(id)arg1;	// IMP=0x00100000001772b8
