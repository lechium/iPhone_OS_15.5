...
- (void).cxx_destruct;	// IMP=0x0020000000051f22
...
- (id)groupUUID;	// IMP=0x001000000005198f
- (id)UUID;	// IMP=0x001000000005197d
@property(readonly, nonatomic) long long state;
- (id)description;	// IMP=0x0010000000051711
- (id)initWithConversationLink:(id)arg1 localMember:(id)arg2 queue:(id)arg3;	// IMP=0x00100000000515eb
