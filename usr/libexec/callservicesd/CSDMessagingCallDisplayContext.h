...
+ (Class)contactIdentifiersType;	// IMP=0x002000000012074a
- (void).cxx_destruct;	// IMP=0x00100000001220fc
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000121be8
- (unsigned long long)hash;	// IMP=0x0010000000121a4f
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000012171b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000121347
- (void)copyTo:(id)arg1;	// IMP=0x00100000001210dd
- (void)writeTo:(id)arg1;	// IMP=0x0010000000120e35
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000120e28
- (id)dictionaryRepresentation;	// IMP=0x001000000012080a
- (id)description;	// IMP=0x001000000012075b
- (id)contactIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x001000000012072d
- (unsigned long long)contactIdentifiersCount;	// IMP=0x0010000000120710
- (void)addContactIdentifiers:(id)arg1;	// IMP=0x00100000001206a6
- (void)clearContactIdentifiers;	// IMP=0x0010000000120689
...
- (id)initWithCallDisplayContext:(id)arg1;	// IMP=0x00100000001406f4
