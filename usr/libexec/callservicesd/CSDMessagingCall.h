...
+ (Class)remoteParticipantHandlesType;	// IMP=0x00200000000983a1
- (void).cxx_destruct;	// IMP=0x001000000009c3cd
- (_Bool);	// IMP=0x001000000009c3bd
...
// Error: Property attributes should begin with the type ('T') attribute, property name: protoTTYType
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000009bbc5
- (unsigned long long)hash;	// IMP=0x001000000009b635
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000009af0c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000009a932
- (void)copyTo:(id)arg1;	// IMP=0x001000000009a4da
- (void)writeTo:(id)arg1;	// IMP=0x0010000000099fe1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000099fd4
- (id)dictionaryRepresentation;	// IMP=0x00100000000985ba
- (id)description;	// IMP=0x001000000009850b
...
- (id)remoteParticipantHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000098384
- (unsigned long long)remoteParticipantHandlesCount;	// IMP=0x0010000000098367
- (void)addRemoteParticipantHandles:(id)arg1;	// IMP=0x00100000000982fd
- (void)clearRemoteParticipantHandles;	// IMP=0x00100000000982e0
...
- (void)setTuProvider:(id)arg1 isVideo:(_Bool)arg2;	// IMP=0x001000000011a9bc
...
- (_Bool)isEqualToCall:(id)arg1;	// IMP=0x0010000000119b97
- (void)updateRelayCall:(id)arg1;	// IMP=0x00100000001196eb
...
- (void)setService:(int)arg1;	// IMP=0x0010000000119205
- (int)service;	// IMP=0x00100000001191f3
@property(nonatomic, getter=isConferenced) _Bool conferenced;
@property(nonatomic) int status;
- (id)initWithCall:(id)arg1;	// IMP=0x0010000000118d1c
