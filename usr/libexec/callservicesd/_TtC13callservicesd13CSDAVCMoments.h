...
- (void).cxx_destruct;	// IMP=0x00400000002e3630
- (id)init;	// IMP=0x00100000002e35d0
- (id)newRequestWithMediaType:(unsigned char)arg1 mode:(unsigned char)arg2 requesteeID:(id)arg3;	// IMP=0x00100000002e3550
...
- (id)initWithStreamToken:(long long)arg1 requesterID:(id)arg2 delegate:(id)arg3 dispatchQueue:(id)arg4;	// IMP=0x00100000002e3360
