...
- (void).cxx_destruct;	// IMP=0x00200000001406b6
...
- (void)performBlockAfterFirstUnlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000001403d6
- (void)_handleDeviceFirstUnlockNotification;	// IMP=0x0010000000140206
- (void)_refreshHasBeenUnlocked;	// IMP=0x00100000001400ba
- (id)initWithQueue:(id)arg1;	// IMP=0x00100000001400a3
- (id)initWithNotifyObserver:(id)arg1 queue:(id)arg2;	// IMP=0x001000000013fef4
