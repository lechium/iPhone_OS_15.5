...
@interface CSDMessagingRelayMessage : PBCodable
{
    ...
    MISSING_TYPE *_protoFailureExpected;	// 308 = 0x134
...
+ (Class)endpointIDSDestinationURIsType;	// IMP=0x002000000006ca98
+ (Class)routesType;	// IMP=0x001000000006c9b1
+ (Class)remoteParticipantHandlesType;	// IMP=0x001000000006be44
+ (Class)providersType;	// IMP=0x001000000006bbe4
+ (Class)otherUniqueProxyIdentifiersType;	// IMP=0x001000000006ba99
+ (Class)protoCallType;	// IMP=0x001000000006ac91
- (void).cxx_destruct;	// IMP=0x0010000000074e83
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000073c32
- (unsigned long long)hash;	// IMP=0x001000000007315b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000072578
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000716b4
- (void)copyTo:(id)arg1;	// IMP=0x0010000000070d1e
- (void)writeTo:(id)arg1;	// IMP=0x00100000000701b5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000701a8
- (id)dictionaryRepresentation;	// IMP=0x001000000006cc52
- (id)description;	// IMP=0x001000000006cba3
...
- (id)endpointIDSDestinationURIsAtIndex:(unsigned long long)arg1;	// IMP=0x001000000006ca7b
- (unsigned long long)endpointIDSDestinationURIsCount;	// IMP=0x001000000006ca5e
- (void)addEndpointIDSDestinationURIs:(id)arg1;	// IMP=0x001000000006c9f4
- (void)clearEndpointIDSDestinationURIs;	// IMP=0x001000000006c9d7
@property(readonly, nonatomic) _Bool hasRoute;
- (id)routesAtIndex:(unsigned long long)arg1;	// IMP=0x001000000006c994
- (unsigned long long)routesCount;	// IMP=0x001000000006c977
- (void)addRoutes:(id)arg1;	// IMP=0x001000000006c90d
- (void)clearRoutes;	// IMP=0x001000000006c8f0
- (int)StringAsRequestActionType:(id)arg1;	// IMP=0x001000000006c290
- (id)requestActionTypeAsString:(int)arg1;	// IMP=0x001000000006bf74
...
- (id)remoteParticipantHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x001000000006be27
- (unsigned long long)remoteParticipantHandlesCount;	// IMP=0x001000000006be0a
- (void)addRemoteParticipantHandles:(id)arg1;	// IMP=0x001000000006bda0
- (void)clearRemoteParticipantHandles;	// IMP=0x001000000006bd83
...
- (id)providersAtIndex:(unsigned long long)arg1;	// IMP=0x001000000006bbc7
- (unsigned long long)providersCount;	// IMP=0x001000000006bbaa
- (void)addProviders:(id)arg1;	// IMP=0x001000000006bb40
- (void)clearProviders;	// IMP=0x001000000006bb23
...
- (id);	// IMP=0x001000000006ba7c
- (unsigned long long)otherUniqueProxyIdentifiersCount;	// IMP=0x001000000006ba5f
- (void)addOtherUniqueProxyIdentifiers:(id)arg1;	// IMP=0x001000000006b9f5
- (void)clearOtherUniqueProxyIdentifiers;	// IMP=0x001000000006b9d8
...
- (int)StringAsReceivedMessageType:(id)arg1;	// IMP=0x001000000006b08c
- (id)receivedMessageTypeAsString:(int)arg1;	// IMP=0x001000000006ad6f
...
- (id)protoCallAtIndex:(unsigned long long)arg1;	// IMP=0x001000000006ac74
- (unsigned long long)protoCallsCount;	// IMP=0x001000000006ac57
- (void)addProtoCall:(id)arg1;	// IMP=0x001000000006abed
- (void)clearProtoCalls;	// IMP=0x001000000006abd0
...
- (int)StringAsType:(id)arg1;	// IMP=0x001000000006a35c
- (id)typeAsString:(int)arg1;	// IMP=0x001000000006a03f
...
- (void)setTuProvider:(id)arg1 isVideo:(_Bool)arg2;	// IMP=0x001000000004380b
...
- (void)addCall:(id)arg1;	// IMP=0x0010000000042fcd
...
- (void)customizeForProtocolVersion:(int)arg1;	// IMP=0x001000000004208d
- (void)addProtocolVersion;	// IMP=0x0010000000042076
...
- (void)setService:(int)arg1;	// IMP=0x0010000000041d9f
- (int)service;	// IMP=0x0010000000041d8d
...
- (id)initWithType:(int)arg1 uniqueProxyIdentifier:(id)arg2;	// IMP=0x00100000000412a5
- (id)initWithType:(int)arg1;	// IMP=0x00100000000411c6
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000040f14
