...
+ (id)temporaryFileURLWithNameComponent:(id)arg1 pathExtension:(id)arg2;	// IMP=0x0020000000018055
+ (_Bool)supportsDeduplication;	// IMP=0x001000000001804d
- (void).cxx_destruct;	// IMP=0x0020000000017f9d
...
- (_Bool)requiresPhotosAdjustmentRendering;	// IMP=0x0010000000017cf8
- (_Bool)isMetadataTrackExtractionConversion;	// IMP=0x0010000000017c83
- (_Bool)isPassthroughConversion;	// IMP=0x0010000000017c0e
- (void)startProgressUpdateTimerAndMarkStartTime;	// IMP=0x0010000000017c08
- (void)cancel;	// IMP=0x0010000000017c02
- (void)performConversion;	// IMP=0x0010000000017b85
- (void)didEnqueue;	// IMP=0x0010000000017b23
- (CDStruct_3c1748cc)trimTimeRange;	// IMP=0x0010000000017a57
- (_Bool)hasTrimTimeRange;	// IMP=0x00100000000179ed
- (_Bool)wantsResultAsData;	// IMP=0x0010000000017978
- (void)updateResultTracker;	// IMP=0x0010000000017825
- (void)callCompletionHandler;	// IMP=0x001000000001752a
- (void)loadAsset;	// IMP=0x001000000001739d
@property(readonly) NSURL *outputMainResourceURL;
@property(readonly) NSURL *sourceMainResourceURL;
- (void)resolveSourceBookmarkDictionary:(id)arg1;	// IMP=0x001000000001709d
- (id)initWithSourceBookmarkDictionary:(id)arg1 outputURLCollection:(id)arg2 options:(id)arg3 requestTracker:(id)arg4;	// IMP=0x0010000000016f4b
