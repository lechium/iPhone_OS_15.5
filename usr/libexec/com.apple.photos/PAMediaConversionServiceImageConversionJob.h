...
- (void).cxx_destruct;	// IMP=0x002000000000face
...
- (void)dealloc;	// IMP=0x001000000000f705
...
- (long long)requestedOrCalculatedMaximumLongSideLength;	// IMP=0x001000000000ea7c
- (_Bool)_validateOutputSize;	// IMP=0x001000000000e8ed
- (_Bool)_validateOrientation;	// IMP=0x001000000000e7c4
- (_Bool)_validateMetadata;	// IMP=0x001000000000e63c
- (_Bool)_validateSource;	// IMP=0x001000000000e40b
- (void)_validate;	// IMP=0x001000000000e2a3
- (_Bool)validateSourceAndOptions;	// IMP=0x001000000000e26a
- (id)initWithRequestIdentifier:(id)arg1 sourceResourceURLCollection:(id)arg2 outputFileType:(id)arg3;	// IMP=0x001000000000e10d
