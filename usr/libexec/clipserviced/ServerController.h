...
+ (id)sharedController;	// IMP=0x0020000000001a90
- (void).cxx_destruct;	// IMP=0x0020000000001f90
@property(retain, nonatomic) NSXPCListener *listener; // @synthesize listener=_listener;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000001d62
- (void)start;	// IMP=0x0010000000001cf6
- (id)init;	// IMP=0x0010000000001ae5
