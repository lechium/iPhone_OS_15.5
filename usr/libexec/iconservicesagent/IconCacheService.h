...
- (void).cxx_destruct;	// IMP=0x0010000000003b67
...
- (void)clearCache;	// IMP=0x0010000000003a47
- (void)scheduleCacheOperation:(unsigned long long)arg1;	// IMP=0x0010000000003927
- (void)start;	// IMP=0x0010000000003813
- (id)initWithServiceName:(id)arg1;	// IMP=0x00100000000034e1
- (id)generateStoreUnitWithRequest:(id)arg1 validationToken:(id *)arg2;	// IMP=0x00100000000047ab
- (void)clearCachedItemsForBundeID:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0010000000004750
- (void)generateImageWithRequest:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0010000000003fc5
- (void)fetchCacheConfigurationWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003d9b
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000003bdc
