...
+ (id)taskWithPhotoLibrary:(id)arg1;	// IMP=0x0040000000047bd3
- (void).cxx_destruct;	// IMP=0x0020000000048aca
...
- (int)mainInternal;	// IMP=0x00100000000482cf
- (_Bool)containsAsset:(id)arg1;	// IMP=0x0010000000048054
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3;	// IMP=0x0010000000047fb7
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3 allowStreaming:(_Bool)arg4;	// IMP=0x0010000000047c38
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0010000000047b04
