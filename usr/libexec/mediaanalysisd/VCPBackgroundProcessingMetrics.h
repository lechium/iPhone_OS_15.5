...
+ (id)sharedMetricsWithPhotoLibrary:(id)arg1;	// IMP=0x0040000000045b6b
+ (id)analysisCompleteTimestampKeyForVCPTask:(unsigned long long)arg1;	// IMP=0x0010000000045000
+ (id)analysisVersionTimestampKeyForVCPTask:(unsigned long long)arg1;	// IMP=0x0010000000044f80
+ (id)analysisVersionKeyForVCPTask:(unsigned long long)arg1;	// IMP=0x0010000000044f00
- (void).cxx_destruct;	// IMP=0x00200000000467a3
- (int)persist;	// IMP=0x0010000000046041
- (int)reportAnalyzedAsset:(id)arg1 withAnalysis:(id)arg2 andProcessingTime:(double)arg3;	// IMP=0x0010000000045d8d
- (void)dealloc;	// IMP=0x0010000000045adf
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0010000000045080
