...
- (unsigned long long)assetCountWithLivePhotoEffectsAnalyzed;	// IMP=0x0010000000025f15
- (unsigned long long)firstFailedSubClassifierCounter:(unsigned long long)arg1;	// IMP=0x0010000000025f07
- (unsigned long long)stablizeResultsCounter:(unsigned long long)arg1;	// IMP=0x0010000000025ef9
- (unsigned long long)activityDecisionCounter:(unsigned long long)arg1;	// IMP=0x0010000000025eeb
- (unsigned long long)gatingDecisionCounter:(unsigned long long)arg1;	// IMP=0x0010000000025ee0
- (void)addLivePhotoEffectsAnalyzedCount:(unsigned long long)arg1;	// IMP=0x0010000000025ed3
- (void)addCount:(unsigned long long)arg1 toFirstFailedSubClassifierCounter:(unsigned long long)arg2;	// IMP=0x0010000000025ec5
- (void)addCount:(unsigned long long)arg1 toStablizeResultsCounter:(unsigned long long)arg2;	// IMP=0x0010000000025eb7
- (void)addCount:(unsigned long long)arg1 toActivityDecisionCounter:(unsigned long long)arg2;	// IMP=0x0010000000025ea9
- (void)addCount:(unsigned long long)arg1 toGatingDecisionCounter:(unsigned long long)arg2;	// IMP=0x0010000000025e9e
- (id)init;	// IMP=0x0010000000025e3d
