...
- (unsigned long long)analyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000026091
- (void)addAnalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000026083
- (unsigned long long)analyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000026075
- (void)addAnalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000026067
- (unsigned long long)unanalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000002605c
- (MISSING_TYPE *)addUnanalyzedWithoutResourcesCounter: /* Error: Ran out of types for this method. */;	// IMP=0x0010000000026051
- (unsigned long long)unanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x0010000000026046
- (void)addUnanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000002603b
- (id)init;	// IMP=0x0010000000025fda
