...
- (void).cxx_destruct;	// IMP=0x0020000000002f6e
- (int)run:(int)arg1 argv:(const char **)arg2;	// IMP=0x0010000000002d36
- (void)registerClient:(id)arg1 forPhotoLibraryURL:(id)arg2 withReply:(CDUnknownBlockType)arg3;	// IMP=0x00100000000029e9
- (void)storeAnalysis:(id)arg1 forAsset:(id)arg2 fromPhotoLibraryURL:(id)arg3 withReply:(CDUnknownBlockType)arg4;	// IMP=0x001000000000255c
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000002010
- (id)init;	// IMP=0x0010000000001e90
