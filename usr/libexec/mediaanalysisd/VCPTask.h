...
- (void).cxx_destruct;	// IMP=0x00200000000a7f2d
...
- (void)main;	// IMP=0x00100000000a7e90
- (int)mainInternal;	// IMP=0x00100000000a7e85
- (_Bool)isCancelled;	// IMP=0x00100000000a7e35
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000a7d81
- (id)init;	// IMP=0x00100000000a7d73
