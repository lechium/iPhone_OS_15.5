...
+ (id)assetWithLocalIdentifier:(id)arg1 version:(int)arg2 dateModified:(id)arg3 dateAnalyzed:(id)arg4 types:(unsigned long long)arg5 flags:(unsigned long long)arg6 statsFlags:(unsigned long long)arg7 masterFingerprint:(id)arg8 adjustedFingerprint:(id)arg9;	// IMP=0x00400000000170f3
- (void).cxx_destruct;	// IMP=0x00200000000172c3
...
- (_Bool)isDegraded;	// IMP=0x001000000001723e
- (_Bool)isDeletePending;	// IMP=0x0010000000017230
- (void)updateLocalIdentifier:(id)arg1;	// IMP=0x001000000001721f
- (id)initWithLocalIdentifier:(id)arg1 version:(int)arg2 dateModified:(id)arg3 dateAnalyzed:(id)arg4 types:(unsigned long long)arg5 flags:(unsigned long long)arg6 statsFlags:(unsigned long long)arg7 masterFingerprint:(id)arg8 adjustedFingerprint:(id)arg9;	// IMP=0x0010000000016f70
