...
+ (id)resourceWithURL:(id)arg1 isBestResource:(_Bool)arg2 requestDownload:(_Bool)arg3 downloadStatus:(int)arg4;	// IMP=0x0040000000052e54
- (void).cxx_destruct;	// IMP=0x0020000000052efc
...
- (id)initWithURL:(id)arg1 isBestResource:(_Bool)arg2 requestDownload:(_Bool)arg3 downloadStatus:(int)arg4;	// IMP=0x0010000000052db0
