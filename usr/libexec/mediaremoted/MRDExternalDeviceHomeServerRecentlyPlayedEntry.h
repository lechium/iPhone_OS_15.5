...
- (void).cxx_destruct;	// IMP=0x002000000003ede1
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000003e630
- (id)description;	// IMP=0x001000000003e527
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x001000000003e33b
