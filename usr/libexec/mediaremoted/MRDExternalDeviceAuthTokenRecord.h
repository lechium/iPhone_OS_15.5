...
- (void).cxx_destruct;	// IMP=0x00200000000daf85
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x00100000000daed6
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000daea3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000dae77
