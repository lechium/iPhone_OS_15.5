...
- (void).cxx_destruct;	// IMP=0x0020000000094f70
...
- (void)handleCanBeNowPlayingPlayerDidChange:(id)arg1;	// IMP=0x0010000000094d18
- (void)_onQueue_popState;	// IMP=0x0010000000094260
- (void)_onQueue_pushState;	// IMP=0x00100000000941b5
- (id)notificationPlayerPathFromPlayer:(id)arg1;	// IMP=0x0010000000094121
@property(readonly, nonatomic) _Bool hasNowPlayingData;
- (void)_onQueue_removePlayerClientForPlayer:(id)arg1;	// IMP=0x0010000000093e75
- (void)removePlayerClientForPlayer:(id)arg1;	// IMP=0x0010000000093dcb
- (id)_onQueue_existingPlayerClientForPlayer:(id)arg1;	// IMP=0x0010000000093bf6
- (id)existingPlayerClientForPlayer:(id)arg1;	// IMP=0x0010000000093aa3
- (id)existingPlayerClientForPlayerPath:(id)arg1;	// IMP=0x0010000000093a41
- (id)_onQueue_addPlayer:(id)arg1;	// IMP=0x0010000000093832
- (id)_onQueue_playerClientForPlayer:(id)arg1;	// IMP=0x00100000000936e4
- (id)playerClientForPlayer:(id)arg1;	// IMP=0x0010000000093591
- (_Bool)canBeNowPlayingForPlayerClient:(id)arg1;	// IMP=0x001000000009348e
- (_Bool)_onQueue_anyPlayerIsPlaying;	// IMP=0x0010000000093349
@property(readonly, nonatomic) _Bool anyPlayerIsPlaying;
@property(nonatomic) _Bool canBeNowPlaying;
- (void)_reevaluateCanBeNowPlaying;	// IMP=0x0010000000092c87
- (id)_onQueue_activePlayerClient;	// IMP=0x0010000000092c66
@property(retain, nonatomic) MRDNowPlayingPlayerClient *activePlayerClient;
- (void)_onQueue_setActivePlayerClient:(id)arg1;	// IMP=0x0010000000092939
@property(retain, nonatomic) MRClient *client;
- (void)updateClient:(id)arg1;	// IMP=0x001000000009264f
...
- (void)initializeDisplayName;	// IMP=0x0010000000092106
- (void)initializeBundleIdentifier;	// IMP=0x0010000000091958
@property(readonly, nonatomic) NSArray *playerClients;
- (id)debugDescription;	// IMP=0x0010000000091375
- (id)description;	// IMP=0x00100000000912f8
- (void)dealloc;	// IMP=0x00100000000912b6
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x0010000000090e97
