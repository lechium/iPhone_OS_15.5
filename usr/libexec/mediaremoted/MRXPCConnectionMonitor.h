...
- (void).cxx_destruct;	// IMP=0x00200000000b7db3
...
- (void)_onCalloutQueue_notifyStatusDidChange:(unsigned long long)arg1;	// IMP=0x00100000000b7896
- (void)_checkConnectionStatus;	// IMP=0x00100000000b73c9
- (_Bool)_canSendMessage;	// IMP=0x00100000000b72e3
- (void)canSendMessage:(CDUnknownBlockType)arg1;	// IMP=0x00100000000b722b
@property(readonly, nonatomic) NSString *label;
- (id)debugDescription;	// IMP=0x00100000000b6f6e
- (id)description;	// IMP=0x00100000000b6ee3
- (id)_initWithLabel:(id)arg1;	// IMP=0x00100000000b6e5c
- (id)initWithXPCConnection:(id)arg1 label:(id)arg2;	// IMP=0x00100000000b6da2
- (id)initWithConnection:(id)arg1 label:(id)arg2;	// IMP=0x00100000000b6cd7
