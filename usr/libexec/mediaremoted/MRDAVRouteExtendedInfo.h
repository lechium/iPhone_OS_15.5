...
+ (id)extendedInfoWithRoute:(id)arg1;	// IMP=0x004000000003af97
- (void).cxx_destruct;	// IMP=0x002000000003b15c
...
- (id)_extendedInfo;	// IMP=0x001000000003b111
@property(readonly, nonatomic) NSString *deviceIdentifier;
@property(readonly, nonatomic) NSString *modelName;
@property(readonly, nonatomic) _Bool requiresPIN;
- (id)initWithRoute:(id)arg1;	// IMP=0x001000000003afe8
