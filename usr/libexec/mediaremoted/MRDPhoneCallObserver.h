...
- (void).cxx_destruct;	// IMP=0x00200000000a71d6
@property(nonatomic) __weak id <MRDPhoneCallObserverDelegate> delegate; // @synthesize delegate=_delegate;
- (void)numberOfActivePhoneCalls:(CDUnknownBlockType)arg1;	// IMP=0x00100000000a7035
- (void)_notifyDelegate:(id)arg1;	// IMP=0x00100000000a6fa7
- (void)callObserver:(id)arg1 callChanged:(id)arg2;	// IMP=0x00100000000a6f35
- (id)init;	// IMP=0x00100000000a6e9f
