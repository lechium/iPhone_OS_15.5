...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00400000000dab58
- (void).cxx_destruct;	// IMP=0x00200000000dad23
...
- (_Bool)isSpeakerRoute;	// IMP=0x00100000000dad06
...
- (unsigned long long)sampleRate;	// IMP=0x00100000000dacb1
- (_Bool)matchesUniqueIdentifier:(id)arg1;	// IMP=0x00100000000dac3a
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000daba8
