...
- (void).cxx_destruct;	// IMP=0x0020000000011988
...
- (void)clearRoutedCommands;	// IMP=0x001000000001190f
- (void)addRoutedCommand:(id)arg1;	// IMP=0x0010000000011721
@property(readonly, nonatomic) NSArray *routedCommands;
- (id)initWithContextID:(id)arg1 originatingAppDisplayID:(id)arg2;	// IMP=0x0010000000011520
