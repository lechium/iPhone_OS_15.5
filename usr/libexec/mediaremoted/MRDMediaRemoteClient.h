...
- (void).cxx_destruct;	// IMP=0x00200000000d47ea
...
- (void)_postNotification:(id)arg1;	// IMP=0x00100000000d452e
- (void)_resumeConnection;	// IMP=0x00100000000d4088
- (void)_wakeDevice:(_Bool)arg1 dismissScreenSaver:(_Bool)arg2 reason:(id)arg3;	// IMP=0x00100000000d4042
- (id)_runAssertionName;	// IMP=0x00100000000d4008
- (void)_invalidate;	// IMP=0x00100000000d3f62
- (void)_handleXPCMessage:(id)arg1;	// IMP=0x00100000000d3ef0
- (void)connectionDidResume:(id)arg1;	// IMP=0x00100000000d3ede
- (id)createNowPlayingClient;	// IMP=0x00100000000d3e63
- (_Bool)hasRegisteredCustomOrigin:(id)arg1;	// IMP=0x00100000000d3d06
- (void)removeRegisteredCustomOrigin:(id)arg1;	// IMP=0x00100000000d3b88
- (void)addRegisteredCustomOrigin:(id)arg1;	// IMP=0x00100000000d39ff
- (id)registeredCustomOrigins;	// IMP=0x00100000000d3904
- (void)_relayXPCMessage:(id)arg1 andReply:(_Bool)arg2 resultCallback:(CDUnknownBlockType)arg3;	// IMP=0x00100000000d3339
- (void)relayXPCMessage:(id)arg1 andReply:(_Bool)arg2 resultCallback:(CDUnknownBlockType)arg3;	// IMP=0x00100000000d30ad
- (void)relayXPCMessage:(id)arg1 andReply:(_Bool)arg2;	// IMP=0x00100000000d3098
- (void)sendRemoteControlCommandWithoutRedirection:(id)arg1 withCompletionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000000d1e2e
- (void)sendRemoteControlCommand:(id)arg1 withCompletionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000000d0ede
- (_Bool)takeAssertionAndBlessForReason:(id)arg1;	// IMP=0x00100000000d0e04
- (_Bool)takeAssertion:(long long)arg1 forReason:(id)arg2 duration:(double)arg3;	// IMP=0x00100000000d06d6
- (void)setWantsAssertionsForNotificationsWithPlayerPath:(id)arg1;	// IMP=0x00100000000d0617
- (_Bool)notificationRequiresTaskAssertionForPlayerPath:(id)arg1;	// IMP=0x00100000000d054a
- (void)postNotification:(id)arg1;	// IMP=0x00100000000d03fa
- (_Bool)isAllowedAccessToDataFromPlayerPath:(id)arg1;	// IMP=0x00100000000d03f2
- (void)flushPendingPlaybackSessionMigrateEvents:(CDUnknownBlockType)arg1;	// IMP=0x00100000000d010f
- (_Bool)removePendingPlaybackSessionMigrateEvent:(id)arg1;	// IMP=0x00100000000cff7b
- (void)addPendingPlaybackSessionMigrateEvent:(id)arg1 playerPath:(id)arg2;	// IMP=0x00100000000cfe0f
- (_Bool)isEntitledFor:(unsigned long long)arg1;	// IMP=0x00100000000cfded
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000cf76c
...
- (id)initWithConnection:(id)arg1;	// IMP=0x00100000000ce87f
