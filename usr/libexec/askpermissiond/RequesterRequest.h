...
- (void).cxx_destruct;	// IMP=0x0020000000020394
...
- (id);	// IMP=0x001000000002036c
@property(readonly, nonatomic) NSString *identifier; // @synthesize identifier=_identifier;
@property(readonly, nonatomic) NSDate *date; // @synthesize date=_date;
@property(readonly, copy) NSString *description;
- (id)compile;	// IMP=0x001000000002013b
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001fe19
- (id)initWithDate:(id)arg1 identifier:(id)arg2 itemIdentifier:(id)arg3 localizations:(id)arg4 offerName:(id)arg5 status:(long long)arg6;	// IMP=0x001000000001fd0d
