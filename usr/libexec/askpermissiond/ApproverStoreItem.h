...
- (void).cxx_destruct;	// IMP=0x002000000000433e
...
- (id)description;	// IMP=0x001000000000414e
- (id)compile;	// IMP=0x0010000000003d38
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000034ad
- (id)initWithItemIdentifier:(id)arg1 requestIdentifier:(id)arg2 date:(id)arg3;	// IMP=0x00100000000033f6
- (id)initWithRequest:(id)arg1 date:(id)arg2;	// IMP=0x001000000000317e
