...
- (void).cxx_destruct;	// IMP=0x002000000001e722
...
- (id)compile;	// IMP=0x001000000001e4c9
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001e1a7
- (id)initWithDate:(id)arg1 identifier:(id)arg2 itemIdentifier:(id)arg3 localizations:(id)arg4 offerName:(id)arg5 status:(long long)arg6;	// IMP=0x001000000001e09b
