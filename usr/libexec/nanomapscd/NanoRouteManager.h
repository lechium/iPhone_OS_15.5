...
+ (id)defaultRouteAttributesForNavigationOfType:(int)arg1;	// IMP=0x004000000001e6f0
- (void).cxx_destruct;	// IMP=0x002000000002033e
...
- (void)_handleDirectionsResponse:(id)arg1 forRequest:(id)arg2 error:(id)arg3 directionsError:(id)arg4;	// IMP=0x001000000001fb75
- (void)cancel;	// IMP=0x001000000001fadd
- (void)loadNewRouteSet;	// IMP=0x001000000001f52a
- (void)_addTimepointIfNeededToRouteAttributes:(id)arg1;	// IMP=0x001000000001f3c4
- (void)_createTicketWithWaypoints:(id)arg1 routeAttributes:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000001ec5a
- (void)_requestTicketWithWaypoints:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000001e8dd
- (void)_setupFeedbackIfNeeded;	// IMP=0x001000000001e7e5
- (id)initWithDirectionsFrom:(id)arg1 to:(id)arg2 type:(int)arg3 currentLocation:(id)arg4 fromCurrentLocation:(_Bool)arg5 withFeedback:(id)arg6;	// IMP=0x001000000001e612
- (id)init;	// IMP=0x001000000001e5d3
- (void)dealloc;	// IMP=0x001000000001e580
