...
+ (id)startNavigationMessageWithLoadDirectionsMessage:(id)arg1;	// IMP=0x004000000003dc10
- (void).cxx_destruct;	// IMP=0x002000000003e241
...
- (_Bool)matchesLoadDirectionsMessage:(id)arg1;	// IMP=0x001000000003e0c0
- (id)description;	// IMP=0x001000000003e011
- (id)dictionaryValue;	// IMP=0x001000000003de43
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000003dc62
