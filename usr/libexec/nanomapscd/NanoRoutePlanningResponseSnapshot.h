...
- (void).cxx_destruct;	// IMP=0x0020000000002c2f
...
- (id)deltaFromSnapshot:(id)arg1;	// IMP=0x00100000000026d8
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000257d
- (id)init;	// IMP=0x0010000000002517
