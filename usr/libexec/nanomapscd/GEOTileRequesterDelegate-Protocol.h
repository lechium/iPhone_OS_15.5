...
- (void)tileRequester:(GEOTileRequester *)arg1 receivedData:(GEOTileData *)arg2 tileEdition:(unsigned int)arg3 tileSetDB:(CDUnion_224fa6cf)arg4 tileSet:(GEOActiveTileSet *)arg5 etag:(NSString *)arg6 forKey:(struct _GEOTileKey)arg7 userInfo:(NSDictionary *)arg8;
@end
