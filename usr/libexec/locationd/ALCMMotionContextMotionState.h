...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000cfe55
- (unsigned long long)hash;	// IMP=0x00100000000cfd56
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000cfbc5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000cfaaf
- (void)copyTo:(id)arg1;	// IMP=0x00100000000cf9d7
- (void)writeTo:(id)arg1;	// IMP=0x00100000000cf8a1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000cf894
- (id)dictionaryRepresentation;	// IMP=0x00100000000ceba7
- (id)description;	// IMP=0x00100000000ceb30
@property(nonatomic) _Bool hasStartTime;
- (int)StringAsExitState:(id)arg1;	// IMP=0x00100000000cea83
- (id)exitStateAsString:(int)arg1;	// IMP=0x00100000000cea36
...
- (int)StringAsTurn:(id)arg1;	// IMP=0x00100000000ce8d1
- (id)turnAsString:(int)arg1;	// IMP=0x00100000000ce884
@property(nonatomic) _Bool hasTurn;
@property(nonatomic) int turn; // @synthesize turn=_turn;
- (int)StringAsMountedConfidence:(id)arg1;	// IMP=0x00100000000ce7b3
- (id)mountedConfidenceAsString:(int)arg1;	// IMP=0x00100000000ce766
...
- (int)StringAsMounted:(id)arg1;	// IMP=0x00100000000ce6b5
- (id)mountedAsString:(int)arg1;	// IMP=0x00100000000ce676
@property(nonatomic) _Bool hasMounted;
@property(nonatomic) int mounted; // @synthesize mounted=_mounted;
- (int)StringAsConfidence:(id)arg1;	// IMP=0x00100000000ce5a5
- (id)confidenceAsString:(int)arg1;	// IMP=0x00100000000ce558
- (int)StringAsType:(id)arg1;	// IMP=0x00100000000ce15c
- (id)typeAsString:(int)arg1;	// IMP=0x00100000000cde2c
