...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000007a9f22
- (unsigned long long)hash;	// IMP=0x00100000007a9ba1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000007a9a56
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000007a9969
- (void)copyTo:(id)arg1;	// IMP=0x00100000007a98ba
- (void)writeTo:(id)arg1;	// IMP=0x00100000007a97cd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000007a97c0
- (id)dictionaryRepresentation;	// IMP=0x00100000007a91e3
- (id)description;	// IMP=0x00100000007a916c
