...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000138e86
- (unsigned long long)hash;	// IMP=0x0010000000138c63
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000138a7f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000013890d
- (void)copyTo:(id)arg1;	// IMP=0x00100000001387df
- (void)writeTo:(id)arg1;	// IMP=0x001000000013869d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000138690
- (id)dictionaryRepresentation;	// IMP=0x0010000000137e34
- (id)description;	// IMP=0x0010000000137dbd
...
- (void)dealloc;	// IMP=0x0010000000137aec
