...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000002872fb
- (unsigned long long)hash;	// IMP=0x0010000000286470
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000285ff1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000285d29
- (void)copyTo:(id)arg1;	// IMP=0x0010000000285a9f
- (void)writeTo:(id)arg1;	// IMP=0x0010000000285791
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000285784
- (id)dictionaryRepresentation;	// IMP=0x001000000028422d
- (id)description;	// IMP=0x00100000002841b6
...
- (int)StringAsOnsetReason:(id)arg1;	// IMP=0x001000000028401c
- (id)onsetReasonAsString:(int)arg1;	// IMP=0x0010000000283fa0
...
- (_Bool)hasNSampleAndHoldCatherine;	// IMP=0x0010000000283c1e
- (void)setHasNSampleAndHoldCatherine:(_Bool)arg1;	// IMP=0x0010000000283c01
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00100000002834fc
- (id)activityTypeAsString:(int)arg1;	// IMP=0x0010000000283190
