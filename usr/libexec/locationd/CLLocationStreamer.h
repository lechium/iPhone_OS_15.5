...
+ (_Bool)isSupported;	// IMP=0x0020000000317f32
+ (id)getSilo;	// IMP=0x0010000000317ed6
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x0010000000317ebd
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0010000000317e60
- (id).cxx_construct;	// IMP=0x002000000031ac80
- (void).cxx_destruct;	// IMP=0x001000000031abef
...
- (void)pairedDeviceIsNearby:(_Bool)arg1;	// IMP=0x001000000031a978
- (void)successfullySentMessage:(id)arg1;	// IMP=0x001000000031a892
- (void)failedToSendMessage:(id)arg1 withError:(id)arg2 isFatal:(_Bool)arg3;	// IMP=0x001000000031a786
- (void)receivedMessageOfType:(id)arg1 withPayload:(id)arg2;	// IMP=0x001000000031a420
- (void)onMotionStateNotification:(const int *)arg1 withData:(const union NotificationData *)arg2;	// IMP=0x001000000031a1ca
- (void)sendMotionState;	// IMP=0x001000000031a01f
- (void)stopMotionAlarm;	// IMP=0x0010000000319ef2
- (void)startMotionAlarm;	// IMP=0x0010000000319dcd
- (void)reevaluateMotionSubscription;	// IMP=0x0010000000319bf0
- (void)onLocationNotification:(const int *)arg1 withData:(const void *)arg2;	// IMP=0x0010000000319735
- (void)startUpdatingLocationWithGranularity:(int)arg1 includeMotion:(_Bool)arg2 inFitnessSession:(_Bool)arg3 inAirborneSession:(_Bool)arg4 emergencyEnablementAssertionActive:(_Bool)arg5 hasMapMatching:(_Bool)arg6;	// IMP=0x0010000000319394
- (void)stopLocation;	// IMP=0x0010000000318da4
- (void)unregisterAllLocationNotifications;	// IMP=0x0010000000318d1e
- (void)sendAliveAgainMessage;	// IMP=0x0010000000318b8c
- (void)endService;	// IMP=0x0010000000318a67
- (void)beginService;	// IMP=0x0010000000317fd7
- (id)init;	// IMP=0x0010000000317f9a
