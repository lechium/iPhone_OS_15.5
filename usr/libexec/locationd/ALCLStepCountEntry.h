...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000d333f
- (unsigned long long)hash;	// IMP=0x00100000000d2f9f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000d2e7c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000d2d9b
- (void)copyTo:(id)arg1;	// IMP=0x00100000000d2cf8
- (void)writeTo:(id)arg1;	// IMP=0x00100000000d2c01
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000d2bf4
- (id)dictionaryRepresentation;	// IMP=0x00100000000d24c8
- (id)description;	// IMP=0x00100000000d2451
