...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000594c1f
- (unsigned long long)hash;	// IMP=0x00100000005942bd
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000593fba
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000593dd8
- (void)copyTo:(id)arg1;	// IMP=0x0010000000593c34
- (void)writeTo:(id)arg1;	// IMP=0x0010000000593a29
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000593a1c
- (id)dictionaryRepresentation;	// IMP=0x0010000000592e82
- (id)description;	// IMP=0x0010000000592e0b
