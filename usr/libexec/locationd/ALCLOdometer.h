...
- (float)accuracy;	// IMP=0x0010000000a115c6
@property(nonatomic) float distance; // @synthesize distance=_distance;
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000a114b3
- (unsigned long long)hash;	// IMP=0x0010000000a10cb8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000a10aec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000a109ad
- (void)copyTo:(id)arg1;	// IMP=0x0010000000a108ac
- (void)writeTo:(id)arg1;	// IMP=0x0010000000a10761
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000a10754
- (id)dictionaryRepresentation;	// IMP=0x0010000000a0ffad
- (id)description;	// IMP=0x0010000000a0ff36
- (int)StringAsQuality:(id)arg1;	// IMP=0x0010000000a0feb0
- (id)qualityAsString:(int)arg1;	// IMP=0x0010000000a0fe43
...
- (void)setAccuracy:(float)arg1;	// IMP=0x0010000000a0fc15
