...
- (void)_clearBuffers;	// IMP=0x001000000077b506
- (unsigned long long)_removeAdditionalInconsistentSpeedPedometerEntries;	// IMP=0x001000000077b2be
- (void)_closeCurrentTrack;	// IMP=0x001000000077a944
- (void)_closeTrackCheckPedometer;	// IMP=0x001000000077a100
- (void)_closeTrackCheckGpsOdometer;	// IMP=0x00100000007799dc
- (void)_closeTrackCheckGpsLocationFiltered;	// IMP=0x0010000000779647
- (void)_closeTrackCheckGpsLocation;	// IMP=0x001000000077946c
- (void)_calculateTimeStartEndDistanceGpsPed;	// IMP=0x0010000000778921
- (double)_extremaRemovedMean:(double [5])arg1;	// IMP=0x00100000007788bd
- (id)_filterGpsLocationBuffer;	// IMP=0x0010000000778359
- (void)updatePedometerBuffer:(struct CLExtendedStepCountEntry)arg1;	// IMP=0x0010000000778213
- (void)updateGpsOdometerBuffer:(struct CLOdometerEntry)arg1;	// IMP=0x0010000000777fa1
- (void)_updateGpsLocationBufferFiltered:(id)arg1;	// IMP=0x0010000000777ec8
- (void)updateGpsLocationBuffer:(id)arg1 gpsSource:(int)arg2;	// IMP=0x001000000077784f
- (void)stop;	// IMP=0x0010000000777783
- (void)dealloc;	// IMP=0x0010000000777708
- (id)init;	// IMP=0x0010000000777577
