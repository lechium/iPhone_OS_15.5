...
- (id)description;	// IMP=0x0010000000903bca
- (id)jsonObject;	// IMP=0x0010000000903b66
@property(readonly) NSURLRequest *URLRequest;
- (id)initWithPayload:(id)arg1;	// IMP=0x001000000090394c
- (id)initWithArchive:(id)arg1;	// IMP=0x00100000009038fc
- (id)initWithRequest:(id)arg1 endpoint:(id)arg2 headers:(id)arg3;	// IMP=0x0010000000903862
- (void)dealloc;	// IMP=0x001000000090380a
- (id)initWithPayload:(id)arg1 requestTypeCode:(unsigned int)arg2 endpoint:(id)arg3 headers:(id)arg4;	// IMP=0x0010000000903784
