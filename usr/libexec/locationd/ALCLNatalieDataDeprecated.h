...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000077d8d6
- (unsigned long long)hash;	// IMP=0x001000000077d40e
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000077d267
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000077d140
- (void)copyTo:(id)arg1;	// IMP=0x001000000077d04b
- (void)writeTo:(id)arg1;	// IMP=0x001000000077cf09
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000077cefc
- (id)dictionaryRepresentation;	// IMP=0x001000000077c2cf
- (id)description;	// IMP=0x001000000077c258
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x001000000077bc18
- (id)activityTypeAsString:(int)arg1;	// IMP=0x001000000077b8ab
