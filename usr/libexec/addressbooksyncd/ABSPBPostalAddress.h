...
- (void).cxx_destruct;	// IMP=0x0020000000030b1f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000003088f
- (unsigned long long)hash;	// IMP=0x0010000000030782
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000030552
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003039b
- (void)copyTo:(id)arg1;	// IMP=0x0010000000030258
- (void)writeTo:(id)arg1;	// IMP=0x0010000000030130
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000030123
- (id)dictionaryRepresentation;	// IMP=0x001000000002fe08
- (id)description;	// IMP=0x001000000002fd59
