...
- (void).cxx_destruct;	// IMP=0x002000000003c6d1
...
- (void)resume;	// IMP=0x001000000003c69a
- (void)pause;	// IMP=0x001000000003c694
- (void)doneForRealNotifyingPairedSync:(_Bool)arg1;	// IMP=0x001000000003c50f
- (id)initWithSession:(id)arg1;	// IMP=0x001000000003c49a
