...
- (void).cxx_destruct;	// IMP=0x002000000000358c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000003343
- (unsigned long long)hash;	// IMP=0x001000000000321f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000002ffb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000002e62
- (void)copyTo:(id)arg1;	// IMP=0x0010000000002d27
- (void)writeTo:(id)arg1;	// IMP=0x0010000000002be9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000002bdc
- (id)dictionaryRepresentation;	// IMP=0x00100000000025ca
- (id)description;	// IMP=0x001000000000251b
