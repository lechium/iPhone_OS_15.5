...
- (void).cxx_destruct;	// IMP=0x0020000000036e36
...
- (void)setAccountIdentifiers:(id)arg1;	// IMP=0x0010000000036daa
- (id)accountIdentifiers;	// IMP=0x0010000000036da0
...
- (void)terminate;	// IMP=0x0010000000036cff
- (void)syncSession:(id)arg1 didEndWithError:(id)arg2;	// IMP=0x0010000000036b57
- (void)syncSession:(id)arg1 applyChanges:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000003647a
- (void)resetDataStoreForSyncSession:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000003628b
- (_Bool)syncSession:(id)arg1 resetDataStoreWithError:(id *)arg2;	// IMP=0x0010000000036283
- (unsigned int)syncSession:(id)arg1 enqueueChanges:(CDUnknownBlockType)arg2 error:(id *)arg3;	// IMP=0x0010000000036261
- (void)lateSetupForSession:(id)arg1;	// IMP=0x0010000000035d9b
- (id)init;	// IMP=0x0010000000035d18
