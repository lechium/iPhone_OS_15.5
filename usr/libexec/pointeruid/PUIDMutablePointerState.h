...
- (id)description;	// IMP=0x001000000002777c
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002774c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000027715
