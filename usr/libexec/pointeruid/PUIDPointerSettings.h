...
@interface PUIDPointerSettings : PTSettings
{
    ...
    _Bool _allowPositionToPositionAnimations;	// 15 = 0xf
    _Bool _showDebugColors;	// 16 = 0x10
...
+ (id)settingsControllerModule;	// IMP=0x004000000001382c
- (void).cxx_destruct;	// IMP=0x002000000001653c
...
- (void)setDefaultValues;	// IMP=0x00100000000127f7
