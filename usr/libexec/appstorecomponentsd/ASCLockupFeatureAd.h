...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000076d3
- (void).cxx_destruct;	// IMP=0x00200000000081ea
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000007bf3
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000007a67
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000078d6
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000076db
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4 screenshots:(id)arg5 trailers:(id)arg6 developerName:(id)arg7;	// IMP=0x0010000000007582
