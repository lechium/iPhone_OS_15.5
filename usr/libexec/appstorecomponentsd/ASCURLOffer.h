...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001dba9
- (void).cxx_destruct;	// IMP=0x002000000001ea3d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001e365
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x001000000001e073
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001e068
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001dea0
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001dbb1
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 url:(id)arg7 isSensitive:(_Bool)arg8;	// IMP=0x001000000001da3c
