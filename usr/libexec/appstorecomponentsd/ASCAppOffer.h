...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000f40c
- (void).cxx_destruct;	// IMP=0x0020000000010d2a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000010104
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x001000000000fc4d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000fc42
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000f966
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000f414
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 baseBuyParams:(id)arg7 metricsBuyParams:(id)arg8 additionalHeaders:(id)arg9 preflightPackageURL:(id)arg10 bundleID:(id)arg11 itemName:(id)arg12 vendorName:(id)arg13;	// IMP=0x001000000000f1b0
