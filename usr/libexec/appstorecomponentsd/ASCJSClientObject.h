...
- (void).cxx_destruct;	// IMP=0x002000000001fa1a
@property(retain) ACAccount *activeiTunesAccount; // @synthesize activeiTunesAccount=_activeiTunesAccount;
@property(readonly, nonatomic) ACAccountStore *accountStore; // @synthesize accountStore=_accountStore;
- (_Bool)isAutomaticDownloadingEnabled;	// IMP=0x001000000001f973
- (_Bool)deletableSystemAppCanBeInstalledOnWatchWithBundleID:(id)arg1;	// IMP=0x001000000001f96b
- (id)isPairedSystemVersionAtLeast:(id)arg1;	// IMP=0x001000000001f5a1
- (_Bool)isActivePairedWatchSystemVersionAtLeastMajorVersion:(id)arg1 minorVersion:(id)arg2 patchVersion:(id)arg3;	// IMP=0x001000000001f304
- (_Bool)deviceHasCapabilities:(id)arg1;	// IMP=0x001000000001f2e2
...
- (void)accountStoreDidChange:(id)arg1;	// IMP=0x001000000001f06d
- (void)dealloc;	// IMP=0x001000000001eff8
- (id)initWithAccountStore:(id)arg1;	// IMP=0x001000000001ef0d
