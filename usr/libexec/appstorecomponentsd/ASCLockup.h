...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000005d52
- (void).cxx_destruct;	// IMP=0x00100000000074c8
...
- (id)lockupWithOffer:(id)arg1;	// IMP=0x00100000000072b3
- (id)lockupByAddingFeature:(id)arg1;	// IMP=0x0010000000006fde
- (id)featureWithClass:(Class)arg1;	// IMP=0x0010000000006e91
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000064b4
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000006273
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000006023
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000005d5a
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9;	// IMP=0x0010000000005d11
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9 features:(id)arg10;	// IMP=0x0010000000005b10
- (id)lockupWithSignpostTags:(id)arg1;	// IMP=0x0010000000003c5b
@property(readonly, copy, nonatomic) NSSet *signpostTags;
- (id)initWithID:(id)arg1 kind:(id)arg2 icon:(id)arg3 heading:(id)arg4 title:(id)arg5 subtitle:(id)arg6 ageRating:(id)arg7 offer:(id)arg8;	// IMP=0x0010000000007548
