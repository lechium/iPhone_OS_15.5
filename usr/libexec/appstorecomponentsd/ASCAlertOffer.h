...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000156d4
- (void).cxx_destruct;	// IMP=0x002000000001699c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000016009
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0010000000015c4c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000015c41
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000015a01
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000156dc
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 alertTitle:(id)arg7 alertMessage:(id)arg8 alertButtonOffer:(id)arg9 alertButtonTitle:(id)arg10;	// IMP=0x00100000000154fd
