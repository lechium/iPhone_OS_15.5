...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001c117
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001c9bc
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x001000000001c63f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001c634
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001c428
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001c11f
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 defaultOffer:(id)arg7 buyOffer:(id)arg8 openOffer:(id)arg9;	// IMP=0x001000000001bf57
