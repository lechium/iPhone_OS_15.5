...
- (void).cxx_destruct;	// IMP=0x0020000000003c0c
@property(nonatomic) _Bool moreComing; // @synthesize moreComing=_moreComing;
- (void)didAddAtomWithData:(id)arg1;	// IMP=0x0010000000003be4
- (_Bool)canAddAtomWithData:(id)arg1;	// IMP=0x0010000000003bce
- (id)initWithChunkerPolicy:(id)arg1;	// IMP=0x0010000000003b5b
