...
- (void).cxx_destruct;	// IMP=0x002000000006509d
...
- (void)xpcPrivateDiscoveryUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000064f1a
- (void)xpcPrivateDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000064e06
- (void)xpcPrivateAdvertiserUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000064d0c
- (void)xpcPrivateAdvertiserActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000064bf8
- (void)xpcConnectionInvalidated;	// IMP=0x0010000000064a75
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x0010000000064950
