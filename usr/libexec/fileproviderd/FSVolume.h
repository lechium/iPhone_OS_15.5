...
+ (id)eventStreamUUIDForDevice:(int)arg1;	// IMP=0x004000000000527f
...
- (id)description;	// IMP=0x001000000000520c
@property(readonly, nonatomic) NSString *mountPath;
- (_Bool)setupForPath:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000505b
