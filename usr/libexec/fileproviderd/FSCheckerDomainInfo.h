...
+ (id)domainInfoWithDomainID:(id)arg1 usingFPFS:(_Bool)arg2 andRootPaths:(id)arg3;	// IMP=0x00400000000024fa
...
- (id)initWithDomainID:(id)arg1 usingFPFS:(_Bool)arg2 andRootPaths:(id)arg3;	// IMP=0x0010000000002593
- (id)init;	// IMP=0x0010000000002575
