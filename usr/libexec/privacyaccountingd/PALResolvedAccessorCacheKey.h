...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000003399
- (unsigned long long)hash;	// IMP=0x0010000000003352
- (id)initWithAccessor:(id)arg1 clientProvidedIdentity:(id)arg2;	// IMP=0x00100000000032b9
