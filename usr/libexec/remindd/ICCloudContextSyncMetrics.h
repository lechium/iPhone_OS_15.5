...
- (void).cxx_destruct;	// IMP=0x002000000003b7ea
...
- (void)finishWithSuccess:(_Bool)arg1;	// IMP=0x001000000003b63c
- (id)dictionaryRepresentation;	// IMP=0x001000000003af45
- (id)initWithSyncReason:(id)arg1;	// IMP=0x001000000003aeb0
