...
+ (void)resetSavedPolicyState;	// IMP=0x004000000000578d
- (void).cxx_destruct;	// IMP=0x0020000000005bf3
...
- (void)savePolicyState;	// IMP=0x00100000000059e8
- (void)loadSavedPolicyState;	// IMP=0x0010000000005851
- (void)startPolicyResetTimer;	// IMP=0x00100000000055d7
- (void)resetPolicy;	// IMP=0x00100000000053c7
@property(readonly, nonatomic) ICCloudThrottlingLevel *currentLevel;
@property(readonly, nonatomic) double batchInterval;
- (void)changeLevelIfNecessary;	// IMP=0x001000000000500b
- (void)incrementBatchCount;	// IMP=0x0010000000004d39
- (void)dealloc;	// IMP=0x0010000000004c2f
- (id)initWithThrottlingLevels:(id)arg1 resetInterval:(double)arg2;	// IMP=0x0010000000004ab2
