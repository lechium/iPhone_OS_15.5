...
- (void).cxx_destruct;	// IMP=0x002000000005eb75
...
- (id)identifier;	// IMP=0x001000000005eb1b
- (void)markAsExpanded;	// IMP=0x001000000005eb04
- (id)childrenNodes;	// IMP=0x001000000005e6f8
