...
- (void).cxx_destruct;	// IMP=0x00200000000043a9
...
- (void)_cancelFireRequests;	// IMP=0x001000000000427b
- (void)cancelPreviousFireRequests;	// IMP=0x00100000000041f4
@property(readonly, nonatomic) _Bool isScheduledToFire;
- (void)callTargetSelector;	// IMP=0x0010000000003edf
- (void)fireImmediately;	// IMP=0x0010000000003dbd
- (void)requestFire;	// IMP=0x0010000000003a9b
- (void)dealloc;	// IMP=0x00100000000039e7
- (id)initWithTarget:(id)arg1 selector:(SEL)arg2 delay:(double)arg3 waitToFireUntilRequestsStop:(_Bool)arg4 callOnMainThread:(_Bool)arg5;	// IMP=0x00100000000038ca
