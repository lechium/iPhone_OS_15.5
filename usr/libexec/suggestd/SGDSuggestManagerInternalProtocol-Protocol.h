...
@class MISSING_TYPE, NSArray, NSData, NSDate, NSString, NSURL, SGRecordId, SGSimpleMailMessage;
...
- (MISSING_TYPE *)spotlightReimportFromIdentifier:forPersonHandle:startDate:endDate:completion: /* Error: Ran out of types for this method. */;
