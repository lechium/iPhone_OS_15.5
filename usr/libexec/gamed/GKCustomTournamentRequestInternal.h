...
+ (id)customTournamentRequestWithTournamentDefinition:(id)arg1 player:(id)arg2;	// IMP=0x0040000000125f31
+ (id)secureCodedPropertyKeys;	// IMP=0x0010000000125d3b
- (void).cxx_destruct;	// IMP=0x00200000001262af
