...
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000000b4ed6
+ (id)secureCodedPropertyKeys;	// IMP=0x00100000000b4d8b
- (void).cxx_destruct;	// IMP=0x00200000000b5006
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b4cc1
