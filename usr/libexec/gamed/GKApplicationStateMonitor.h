...
- (void).cxx_destruct;	// IMP=0x00200000000962c9
...
- (void)applicationsWillUninstall:(id)arg1;	// IMP=0x001000000009604f
- (void)applicationsDidUninstall:(id)arg1;	// IMP=0x0010000000095e3c
- (void)startObservingApplicationWorkspaceChanges;	// IMP=0x0010000000095c88
- (void)startObservingStateChangesForBundleID:(id)arg1;	// IMP=0x001000000009594b
- (_Bool)observingStateChangesForBundleID:(id)arg1;	// IMP=0x00100000000958d4
- (void)dealloc;	// IMP=0x0010000000095172
- (id)init;	// IMP=0x00100000000950b8
