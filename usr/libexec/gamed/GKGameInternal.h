...
+ (id)secureCodedPropertyKeys;	// IMP=0x002000000015bd19
+ (id)propertiesToFetch;	// IMP=0x0010000000170593
- (void).cxx_destruct;	// IMP=0x002000000015c6e0
...
- (id)description;	// IMP=0x001000000015c05c
- (id)serverRepresentation;	// IMP=0x001000000015c04a
- (unsigned long long)hash;	// IMP=0x001000000015bcd5
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015bc28
- (id)defaultCategory;	// IMP=0x001000000015c756
- (unsigned short)numberOfCategories;	// IMP=0x001000000015c744
- (void)updateWithProperties:(id)arg1;	// IMP=0x00100000001705e3
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x001000000016fdbf
