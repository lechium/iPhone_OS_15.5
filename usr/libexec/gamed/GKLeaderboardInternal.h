...
+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000164fe1
- (void).cxx_destruct;	// IMP=0x00200000001657b4
...
- (unsigned long long)hash;	// IMP=0x0010000000165480
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001653ac
