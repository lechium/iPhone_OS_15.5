...
+ (id)secureCodedPropertyKeys;	// IMP=0x002000000015d27e
+ (id)gameRecordForGame:(id)arg1;	// IMP=0x001000000015d03f
+ (id)_gameProperties;	// IMP=0x00100000001712c2
+ (id)propertiesToFetch;	// IMP=0x0010000000170f1a
- (void).cxx_destruct;	// IMP=0x002000000015d600
...
- (void)updateWithGame:(id)arg1;	// IMP=0x001000000015d0b1
- (void)updateWithProperties:(id)arg1;	// IMP=0x00100000001713bf
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0010000000170be6
