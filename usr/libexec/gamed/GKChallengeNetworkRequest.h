...
+ (id)bagKey;	// IMP=0x002000000023d73c
- (void).cxx_destruct;	// IMP=0x002000000023df63
...
- (id)requestIdentifier;	// IMP=0x001000000023ddce
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x001000000023dc5a
- (id)taskInfo;	// IMP=0x001000000023dadf
- (id)postBody;	// IMP=0x001000000023da51
- (id)initWithTask:(id)arg1;	// IMP=0x001000000023d9a5
- (void)mergeRequestData:(id)arg1;	// IMP=0x001000000023d919
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x001000000023d888
- (id)initWithChallenges:(id)arg1 bundleID:(id)arg2;	// IMP=0x001000000023d75c
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x001000000023d749
