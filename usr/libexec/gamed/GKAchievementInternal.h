...
+ (_Bool)supportsSecureCoding;	// IMP=0x0040000000164658
+ (id)secureCodedPropertyKeys;	// IMP=0x001000000016441f
- (void).cxx_destruct;	// IMP=0x0010000000164dac
...
- (id)descriptionSubstitutionMap;	// IMP=0x0010000000164c53
...
- (unsigned long long)hash;	// IMP=0x0010000000164b4d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000164a11
- (id)serverRepresentation;	// IMP=0x0010000000164837
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000164738
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000164660
- (void)mergePropertiesFromDescription:(id)arg1;	// IMP=0x0010000000164e43
