...
@class GKLeaderboardInternal, GKPlayerInternal, GKScoreInternal, GKTournamentDefinitionInternal, GKTournamentParticipantInternal, MISSING_TYPE, NSDate, NSString, NSURL;
...
@interface GKTournamentInternal
{
    ...
    MISSING_TYPE *_tournamentBeginDate;	// 96 = 0x60
...
+ (id)defaultCustomTournamentForTournamentDefinition:(id)arg1;	// IMP=0x004000000012719e
+ (id)secureCodedPropertyKeys;	// IMP=0x0010000000126def
- (void).cxx_destruct;	// IMP=0x0020000000127693
