...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000016a718
- (void).cxx_destruct;	// IMP=0x002000000016bd69
...
- (id)descriptionSubstitutionMap;	// IMP=0x001000000016ba1d
@property(nonatomic) unsigned int state; // @synthesize state=_state;
- (long long)activeExchangeCount;	// IMP=0x001000000016b0ac
- (long long)previousParticipantIndex;	// IMP=0x001000000016ae35
- (long long)localPlayerParticipantIndex;	// IMP=0x001000000016ada3
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016ac08
- (unsigned long long)hash;	// IMP=0x001000000016abc4
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0010000000174182
