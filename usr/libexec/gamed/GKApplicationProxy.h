...
+ (id)metadataForBundleURL:(id)arg1;	// IMP=0x00400000000aca98
- (void).cxx_destruct;	// IMP=0x00200000000ad0d4
...
- (id)bundleURL;	// IMP=0x00100000000acd4c
...
- (id)initWithBundleID:(id)arg1;	// IMP=0x00100000000aca3e
- (id)initWithProxy:(id)arg1;	// IMP=0x00100000000ac9d6
