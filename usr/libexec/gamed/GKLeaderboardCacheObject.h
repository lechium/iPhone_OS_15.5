...
+ (id)entityName;	// IMP=0x0020000000063c53
- (id)internalRepresentation;	// IMP=0x00200000000637ac
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000062eb6
