...
@class CKShareMetadata, GKGameInternal, GKPlayerInternal, MISSING_TYPE, NSDictionary, NSString, NSURL;
...
- (MISSING_TYPE *)loadRemoteImageDataForURL:reply: /* Error: Ran out of types for this method. */;
