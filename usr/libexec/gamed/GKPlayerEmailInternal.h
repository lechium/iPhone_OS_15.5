...
+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000163330
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000163328
- (void).cxx_destruct;	// IMP=0x002000000016365e
...
- (unsigned long long)hash;	// IMP=0x0010000000163529
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016340f
