...
@interface GKPlayerCredential
{
    ...
    MISSING_TYPE *_playerInternal;	// 24 = 0x18
...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000015e425
- (void).cxx_destruct;	// IMP=0x002000000015e702
...
- (id)description;	// IMP=0x001000000015e300
@property(readonly) NSString *scopeAsString;
- (unsigned long long)hash;	// IMP=0x001000000015e1ca
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015df5d
