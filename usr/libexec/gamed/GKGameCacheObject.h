...
+ (id)entityName;	// IMP=0x0020000000055af0
+ (id)_gamesForFullGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x0010000000053471
+ (id)gamesForGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x00100000000532b2
+ (id)gamesForBundleIDs:(id)arg1 context:(id)arg2;	// IMP=0x00100000000530f3
+ (id)gameForBundleID:(id)arg1 context:(id)arg2;	// IMP=0x0010000000052e92
+ (id)gameForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x0010000000052d93
+ (id)fetchSortDescriptors;	// IMP=0x0010000000052cb4
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x0010000000052ca7
+ (id)uniqueAttributeName;	// IMP=0x0010000000052c9a
- (id)gameDescriptor;	// IMP=0x00200000000556e0
- (id)leaderboardSetWithIdentifier:(id)arg1;	// IMP=0x0010000000055640
- (id)internalRepresentation;	// IMP=0x00100000000554a3
- (_Bool)storePiecesExpired;	// IMP=0x0010000000055456
- (_Bool)storePiecesValid;	// IMP=0x0010000000055423
- (void)updateStorePiecesWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0010000000054c3d
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00100000000542bc
- (void)updateWithGameDescriptor:(id)arg1;	// IMP=0x0010000000053a22
- (_Bool)isValid;	// IMP=0x0010000000053990
