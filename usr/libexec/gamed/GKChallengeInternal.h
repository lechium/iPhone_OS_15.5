...
+ (id)internalRepresentation;	// IMP=0x0040000000168d22
+ (id)secureCodedPropertyKeys;	// IMP=0x00100000001688c6
- (void).cxx_destruct;	// IMP=0x0020000000169444
...
- (id)descriptionSubstitutionMap;	// IMP=0x00100000001692c8
@property(readonly, nonatomic) NSString *subtitleText;
@property(readonly, nonatomic) NSString *titleText;
@property(readonly, nonatomic) unsigned long long type;
- (id)findLocalGameBundleID;	// IMP=0x0010000000168eaa
- (id)serverRepresentationForReceivingPlayer:(id)arg1;	// IMP=0x0010000000168d3c
- (id)serverRepresentation;	// IMP=0x0010000000168d2a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000168c75
- (unsigned long long)hash;	// IMP=0x0010000000168c31
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000168aff
