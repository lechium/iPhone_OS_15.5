...
+ (id)displayNameForEnvironment:(long long)arg1;	// IMP=0x0020000000092731
+ (id)hostNameForEnvironment:(long long)arg1;	// IMP=0x00100000000926fc
+ (id)shared;	// IMP=0x0010000000091036
- (void).cxx_destruct;	// IMP=0x0010000000093b9f
...
- (void)setMultiplayerShouldAlwaysReloadCollectionView:(_Bool)arg1;	// IMP=0x0010000000092cdd
...
- (void)setRecentNumberOfPlayers:(unsigned long long)arg1 forBundleID:(id)arg2;	// IMP=0x0010000000092327
- (unsigned long long)recentNumberOfPlayersForBundleID:(id)arg1;	// IMP=0x001000000009226b
...
- (void)removeOverrideForKey:(id)arg1;	// IMP=0x0010000000091695
- (void)setStringValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000091678
- (id)stringValueForKey:(id)arg1 defaultValue:(id)arg2;	// IMP=0x0010000000091604
- (void)setTimeInterval:(double)arg1 forKey:(id)arg2;	// IMP=0x001000000009156a
- (double)timeIntervalForKey:(id)arg1 defaultValue:(double)arg2;	// IMP=0x0010000000091518
- (void)setDictionaryValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00100000000914fb
- (id)dictionaryValueForKey:(id)arg1;	// IMP=0x0010000000091499
- (void)setUnsignedIntegerValue:(long long)arg1 forKey:(id)arg2;	// IMP=0x0010000000091401
- (long long)unsignedIntegerValueForKey:(id)arg1 defaultValue:(long long)arg2;	// IMP=0x00100000000913b6
- (void)setIntegerValue:(long long)arg1 forKey:(id)arg2;	// IMP=0x001000000009131e
- (long long)integerValueForKey:(id)arg1 defaultValue:(long long)arg2;	// IMP=0x00100000000912d3
- (void)setBooleanValue:(_Bool)arg1 forKey:(id)arg2;	// IMP=0x001000000009125a
- (_Bool)booleanValueForKey:(id)arg1;	// IMP=0x0010000000091246
- (_Bool)booleanValueForKey:(id)arg1 defaultValue:(_Bool)arg2;	// IMP=0x00100000000911fb
- (id)preferencesValueForKey:(id)arg1;	// IMP=0x0010000000091197
- (void)_didWriteKey:(id)arg1;	// IMP=0x0010000000091176
- (void)synchronize;	// IMP=0x0010000000091141
- (void)invalidate;	// IMP=0x001000000009112a
- (_Bool)isInternalBuild;	// IMP=0x00100000000910d3
- (id)init;	// IMP=0x0010000000091024
- (id)initWithoutUIKitNotifications;	// IMP=0x0010000000090f93
- (id)initWithUIKitNotifications;	// IMP=0x0010000000090f81
- (void)profileConnectionDidReceiveEffectiveSettingsChangedNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x0010000000115341
- (id)valueRestrictionForKey:(id)arg1;	// IMP=0x00100000001152ba
- (_Bool)restrictionEnabledForKey:(id)arg1;	// IMP=0x0010000000115237
...
- (void)getMultiplayerAllowedPlayerTypeWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000011503d
