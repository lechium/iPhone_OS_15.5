...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000016e693
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x001000000016e604
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x001000000016e44b
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x001000000016de7c
- (void).cxx_destruct;	// IMP=0x002000000016eda5
...
- (id)descriptionSubstitutionMap;	// IMP=0x001000000016eaf0
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016ea15
- (unsigned long long)hash;	// IMP=0x001000000016e9d1
- (id)init;	// IMP=0x001000000016e633
