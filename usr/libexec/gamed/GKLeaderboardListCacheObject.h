...
+ (id)entityName;	// IMP=0x004000000005a950
- (_Bool)isValid;	// IMP=0x002000000005aa5d
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000005a95d
