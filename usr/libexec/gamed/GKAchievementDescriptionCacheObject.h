...
+ (id)entityName;	// IMP=0x00200000000563c7
- (id)internalRepresentation;	// IMP=0x0020000000056082
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000055c9a
