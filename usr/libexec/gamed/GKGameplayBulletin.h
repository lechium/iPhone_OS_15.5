...
+ (_Bool)supportsSecureCoding;	// IMP=0x004000000012bdea
- (void).cxx_destruct;	// IMP=0x002000000013147d
...
- (void)loadOriginatorPlayerWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000130c49
- (void)loadStoreItemWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000012fb94
- (void)gamePlatformForBundleID:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x001000000012f770
- (void)gamePlatformWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000012f59f
- (void)determineGameLocationOnDeviceOrInStoreWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000012e9f1
- (void)determineGameLocationOnDeviceViaCompatibilityMatrixWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000012d84d
- (void)determineGameLocationOnDeviceOnly;	// IMP=0x001000000012d254
- (_Bool)isCompatibleWithGameDescriptor:(id)arg1;	// IMP=0x001000000012ce5e
- (_Bool)isPushFromLocalPlayers;	// IMP=0x001000000012ccb8
- (_Bool)isPushForLocalPlayers;	// IMP=0x001000000012cb12
- (_Bool)playerIsLocal:(id)arg1;	// IMP=0x001000000012c788
@property(readonly, retain) NSString *URLContext;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000012c336
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000012bdf2
