...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000016d740
- (void).cxx_destruct;	// IMP=0x002000000016ddf6
...
- (_Bool)hasGuestPlayers;	// IMP=0x001000000016dace
- (unsigned long long)hash;	// IMP=0x001000000016d6d1
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016cf6d
- (id)init;	// IMP=0x001000000016cef7
