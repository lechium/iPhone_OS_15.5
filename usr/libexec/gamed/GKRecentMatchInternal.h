...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000015d965
- (void).cxx_destruct;	// IMP=0x002000000015dd33
...
- (unsigned long long)hash;	// IMP=0x001000000015dc03
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015da5f
