...
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x00200000000ebab5
+ (id)entityName;	// IMP=0x00100000000eb3d4
- (void)bindTo:(id)arg1;	// IMP=0x00200000000eb729
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x00100000000eb3e1
