...
+ (id)identityColumnName;	// IMP=0x00200000000b73d0
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x00100000000b70c9
+ (long long)migrationOrder;	// IMP=0x00100000000b70be
+ (id)entityName;	// IMP=0x00100000000b691f
- (void).cxx_destruct;	// IMP=0x00200000000b7773
...
- (id)dictionaryRepresentation;	// IMP=0x00100000000b73ea
@property(readonly, nonatomic) NSObject<PDDatabaseValue> *identityValue;
- (void)bindTo:(id)arg1;	// IMP=0x00100000000b6ce8
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x00100000000b692c
