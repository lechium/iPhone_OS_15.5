...
+ (id)identityColumnName;	// IMP=0x002000000015a231
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x001000000015a199
+ (id)entityName;	// IMP=0x0010000000159f3e
- (void).cxx_destruct;	// IMP=0x002000000015a298
...
- (void)bindTo:(id)arg1;	// IMP=0x001000000015a09a
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x0010000000159f4b
