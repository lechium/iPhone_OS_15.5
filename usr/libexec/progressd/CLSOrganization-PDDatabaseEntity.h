...
+ (id)searchColumnName;	// IMP=0x0020000000053151
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x001000000005306e
+ (id)entityName;	// IMP=0x0010000000052ab0
- (id)tokensForSearchableColumn:(id)arg1 withValue:(id)arg2 tokenize:(_Bool)arg3;	// IMP=0x0020000000053239
...
- (void)bindTo:(id)arg1;	// IMP=0x0010000000052d41
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x0010000000052abd
