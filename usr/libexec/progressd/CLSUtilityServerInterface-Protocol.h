...
@class CLSAbstractAsset, CLSAdminRequestor, CLSAsset, CLSObject, CLSOrganization, MISSING_TYPE, NSArray, NSPredicate, NSString, NSURL;
...
- (MISSING_TYPE *)remote_authorizationStatusForHandoutAssignedItem:completion: /* Error: Ran out of types for this method. */;
