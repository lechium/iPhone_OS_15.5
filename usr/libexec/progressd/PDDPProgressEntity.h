...
- (void).cxx_destruct;	// IMP=0x002000000007887d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000078640
- (unsigned long long)hash;	// IMP=0x001000000007852d
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000007832d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000781a6
- (void)copyTo:(id)arg1;	// IMP=0x0010000000078083
- (void)writeTo:(id)arg1;	// IMP=0x0010000000077f71
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000077f64
- (id)dictionaryRepresentation;	// IMP=0x00100000000779bd
- (id)description;	// IMP=0x001000000007790e
...
- (int)StringAsType:(id)arg1;	// IMP=0x0010000000077764
- (id)typeAsString:(int)arg1;	// IMP=0x00100000000776c0
