...
- (void).cxx_destruct;	// IMP=0x002000000006552b
...
- (void)run;	// IMP=0x0010000000065173
- (void)clampToPredefinedTimePeriod:(unsigned long long)arg1;	// IMP=0x00100000000650fc
- (id)initWithIdentifier:(id)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0010000000064ff1
