...
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x00200000000accee
+ (id)entityName;	// IMP=0x00100000000ac832
- (void)bindTo:(id)arg1;	// IMP=0x00200000000aca87
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x00100000000ac83f
