...
- (void).cxx_destruct;	// IMP=0x002000000010c331
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000010c0ee
- (unsigned long long)hash;	// IMP=0x001000000010bfe4
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000010bdf9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000010bc7c
- (void)copyTo:(id)arg1;	// IMP=0x001000000010bb5c
- (void)writeTo:(id)arg1;	// IMP=0x001000000010ba3d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000010ba30
- (id)dictionaryRepresentation;	// IMP=0x001000000010b3db
- (id)description;	// IMP=0x001000000010b32c
@property(readonly, nonatomic) _Bool hasClassId;
@property(readonly, nonatomic) _Bool hasScheduleDate;
- (int)StringAsScheduleAction:(id)arg1;	// IMP=0x001000000010b2a0
- (id)scheduleActionAsString:(int)arg1;	// IMP=0x001000000010b24b
...
- (int)StringAsScheduledEntityType:(id)arg1;	// IMP=0x001000000010b185
- (id)scheduledEntityTypeAsString:(int)arg1;	// IMP=0x001000000010b130
