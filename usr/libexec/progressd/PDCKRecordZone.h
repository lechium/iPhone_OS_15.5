...
+ (id)identityColumnName;	// IMP=0x002000000007a9af
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x001000000007a917
+ (id)entityName;	// IMP=0x001000000007a74c
- (void).cxx_destruct;	// IMP=0x002000000007aa1b
...
- (void)bindTo:(id)arg1;	// IMP=0x001000000007a86f
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x001000000007a759
