...
- (void).cxx_destruct;	// IMP=0x0020000000126ffa
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000126eab
- (unsigned long long)hash;	// IMP=0x0010000000126dee
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000126c88
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000126b87
- (void)copyTo:(id)arg1;	// IMP=0x0010000000126ac7
- (void)writeTo:(id)arg1;	// IMP=0x00100000001269fd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001269f0
- (id)dictionaryRepresentation;	// IMP=0x0010000000126594
- (id)description;	// IMP=0x00100000001264e5
