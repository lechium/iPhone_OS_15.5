...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000a6a0
...
- (void)dealloc;	// IMP=0x001000000000a810
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000a720
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000a6b0
