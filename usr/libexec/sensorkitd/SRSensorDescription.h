...
+ (id)sensorDescriptionsForAuthorizationService:(id)arg1;	// IMP=0x0040000000031d80
+ (id)sensorDescriptionForDeletionRecordFromDescription:(id)arg1;	// IMP=0x00100000000319b0
+ (id)sensorDescriptionForSensor:(id)arg1;	// IMP=0x0010000000031650
+ (void)initialize;	// IMP=0x0010000000031600
...
- (id)description;	// IMP=0x0010000000031cd0
- (void)dealloc;	// IMP=0x0010000000031bf0
@property(readonly) _Bool supportsCurrentPlatform;
- (_Bool)supportsPlatform:(id)arg1;	// IMP=0x0010000000031b70
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000031680
