...
- (void).cxx_destruct;	// IMP=0x0020000000009ff9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000009ec0
- (unsigned long long)hash;	// IMP=0x0010000000009e3d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000009d19
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000009c5f
- (void)copyTo:(id)arg1;	// IMP=0x0010000000009bd2
- (void)writeTo:(id)arg1;	// IMP=0x0010000000009b25
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000009b18
- (id)dictionaryRepresentation;	// IMP=0x0010000000009549
- (id)description;	// IMP=0x001000000000949a
