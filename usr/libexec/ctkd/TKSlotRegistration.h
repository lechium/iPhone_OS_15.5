...
+ (_Bool)handleConnection:(id)arg1 server:(id)arg2;	// IMP=0x002000000000c142
- (void).cxx_destruct;	// IMP=0x002000000000c6ca
...
- (void)addSlotWithEndpoint:(id)arg1 name:(id)arg2 type:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x001000000000c20c
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x001000000000c0b0
