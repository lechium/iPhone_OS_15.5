...
- (void)run;	// IMP=0x0010000000002994
- (void)ensureSlotWatcherIsRunning;	// IMP=0x001000000000290f
- (id)initWithArgc:(int)arg1 argv:(const char **)arg2;	// IMP=0x00100000000026cd
...
- (void)initializeSandBox;	// IMP=0x00100000000025b3
