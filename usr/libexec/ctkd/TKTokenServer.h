...
- (void).cxx_destruct;	// IMP=0x002000000001047a
...
- (id)pairingNotification:(id *)arg1;	// IMP=0x0010000000010427
- (void)stop;	// IMP=0x00100000000102c7
- (void)start;	// IMP=0x00100000000101c2
- (void)dealloc;	// IMP=0x001000000001015d
- (id)initWithTokenServer:(id)arg1 tokenRegistry:(id)arg2;	// IMP=0x001000000000ffb3
- (void)hostTokenRegistry:(id)arg1 removedToken:(id)arg2;	// IMP=0x001000000000fca8
- (void)hostTokenRegistry:(id)arg1 addedToken:(id)arg2;	// IMP=0x001000000000f690
- (void)getEndpoint:(CDUnknownBlockType)arg1;	// IMP=0x001000000000f623
- (void)startWatchingWithReply:(CDUnknownBlockType)arg1;	// IMP=0x001000000000ef7c
