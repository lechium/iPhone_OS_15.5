...
+ (id)keychainItemClasses;	// IMP=0x00200000000020eb
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000017d6
- (void).cxx_destruct;	// IMP=0x002000000000254b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000235d
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000002221
- (id)connectionWithError:(id *)arg1;	// IMP=0x00100000000019f6
- (id)description;	// IMP=0x00100000000018ff
- (id)initWithTokenID:(id)arg1 persistent:(_Bool)arg2 automatic:(_Bool)arg3;	// IMP=0x00100000000017de
