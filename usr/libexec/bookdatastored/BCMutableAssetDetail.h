...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000243ea
- (void).cxx_destruct;	// IMP=0x0020000000024e52
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000247a3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000243f2
- (id)configuredRecordFromAttributes;	// IMP=0x0010000000023eac
- (id)zoneName;	// IMP=0x0010000000023d82
- (id)identifier;	// IMP=0x0010000000023d70
- (id)recordType;	// IMP=0x0010000000023d63
@property(readonly, copy) NSString *description;
- (id)initWithRecord:(id)arg1;	// IMP=0x0010000000023600
- (id)initWithCloudData:(id)arg1;	// IMP=0x00100000000231c0
- (id)initWithAssetID:(id)arg1;	// IMP=0x00100000000230fe
