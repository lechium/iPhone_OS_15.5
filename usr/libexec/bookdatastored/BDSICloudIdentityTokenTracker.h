...
- (void)acknowledgeiCloudIdentity;	// IMP=0x0010000000005cc8
- (_Bool)didUnacknowledgediCloudLogoutOccur;	// IMP=0x0010000000005988
- (void)forceUpdateTokenWithString:(id)arg1;	// IMP=0x0010000000005905
- (void)fetchCurrentToken;	// IMP=0x0010000000005894
- (id)initWithContainerURL:(id)arg1 trackingLiverpool:(_Bool)arg2;	// IMP=0x001000000000571e
