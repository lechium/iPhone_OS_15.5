...
- (void).cxx_destruct;	// IMP=0x0020000000055831
...
- (void)databaseController:(id)arg1 saltVersionIdentifierChanged:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000549d7
- (id)initWithZoneDataManager:(id)arg1 tokenController:(id)arg2 databaseController:(id)arg3;	// IMP=0x00100000000547f2
