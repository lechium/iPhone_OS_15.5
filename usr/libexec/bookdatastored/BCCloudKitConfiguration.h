...
+ (id)configuration;	// IMP=0x0020000000006b85
- (void).cxx_destruct;	// IMP=0x0020000000006e7c
...
// Error: Property attributes should begin with the type ('T') attribute, property name: dbArchiveFolderName
...
- (_Bool)shouldPerformDatabaseSubscriptionForServiceMode:(_Bool)arg1;	// IMP=0x0010000000006d6d
- (_Bool)shouldArchiveData:(id)arg1;	// IMP=0x0010000000006d65
