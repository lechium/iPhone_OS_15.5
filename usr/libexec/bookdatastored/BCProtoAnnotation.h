...
@interface BCProtoAnnotation : PBCodable
{
    ...
    MISSING_TYPE *_plLocationRangeEnd;	// 124 = 0x7c
...
- (void).cxx_destruct;	// IMP=0x0020000000050c83
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000005054e
- (unsigned long long)hash;	// IMP=0x001000000004fba3
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000004f522
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000004f086
- (void)copyTo:(id)arg1;	// IMP=0x001000000004ecd2
- (void)writeTo:(id)arg1;	// IMP=0x001000000004e8fd
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000004e8f0
- (id)dictionaryRepresentation;	// IMP=0x001000000004d72c
- (id)description;	// IMP=0x001000000004d67d
