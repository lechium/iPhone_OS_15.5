...
- (void).cxx_destruct;	// IMP=0x0020000000004f3f
@property(retain, nonatomic) NSObject<OS_os_transaction> *osTransaction; // @synthesize osTransaction=_osTransaction;
- (void)dealloc;	// IMP=0x0010000000004e4b
- (void)endTransaction;	// IMP=0x0010000000004d28
- (id)initWithTransactionName:(const char *)arg1;	// IMP=0x0010000000004c49
