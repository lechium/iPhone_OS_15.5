...
+ (id)configuration;	// IMP=0x0020000000024f0b
- (void).cxx_destruct;	// IMP=0x00200000000251aa
...
- (_Bool)shouldPerformDatabaseSubscriptionForServiceMode:(_Bool)arg1;	// IMP=0x001000000002509b
- (_Bool)shouldArchiveData:(id)arg1;	// IMP=0x0010000000025093
