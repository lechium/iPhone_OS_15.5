...
+ (_Bool)isWithinConnectionDateRange;	// IMP=0x0020000000041f82
- (void).cxx_destruct;	// IMP=0x0020000000042a19
...
- (void)connection:(id)arg1 didReceiveIncomingMessage:(id)arg2;	// IMP=0x00100000000426db
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;	// IMP=0x001000000004269a
- (void)didAcceptConnection:(id)arg1;	// IMP=0x0010000000042596
- (void)startListeningForNotifications;	// IMP=0x001000000004228e
- (id)init;	// IMP=0x0010000000042102
