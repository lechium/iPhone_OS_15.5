...
@class MISSING_TYPE, NSData, NSURLResponse, NSURLSession, NSURLSessionDataTask, NSURLSessionDownloadTask, NSURLSessionStreamTask;

@protocol NSURLSessionDataDelegate <NSURLSessionTaskDelegate>

@optional
- (MISSING_TYPE *)URLSession:dataTask:willCacheResponse:completionHandler: /* Error: Ran out of types for this method. */;
