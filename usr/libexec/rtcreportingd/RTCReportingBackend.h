...
+ (void)applyFilters:(id)arg1 dict:(id)arg2 type:(unsigned short)arg3 category:(unsigned short)arg4;	// IMP=0x00400000000052b0
+ (void)applyFilters:(id)arg1 dict:(id)arg2 type:(unsigned short)arg3 category:(unsigned short)arg4 actions:(id)arg5;	// IMP=0x0010000000004e95
+ (id)newBackendWithName:(id)arg1 profile:(id)arg2 productFamily:(id)arg3 clientType:(int)arg4;	// IMP=0x0010000000004393
...
- (_Bool)matchClientNameAndServiceID:(id)arg1 clientName:(id)arg2 serviceID:(id)arg3;	// IMP=0x0010000000005a81
- (_Bool)matchStringWithList:(id)arg1 wholeString:(id)arg2 whitelist:(_Bool)arg3;	// IMP=0x001000000000591b
- (_Bool)matchExactStringWithList:(id)arg1 wholeString:(id)arg2 whitelist:(_Bool)arg3;	// IMP=0x00100000000057c8
- (void)checkHashedClientName:(id)arg1 userInfoDict:(id)arg2;	// IMP=0x0010000000005407
- (id)hashString:(id)arg1;	// IMP=0x0010000000005345
- (unsigned long long)batchedEventsSize;	// IMP=0x001000000000533d
- (void)filterEvent:(id)arg1 type:(unsigned short)arg2 category:(unsigned short)arg3;	// IMP=0x0010000000005328
- (void)filterEvent:(id)arg1 type:(unsigned short)arg2 category:(unsigned short)arg3 actions:(id)arg4;	// IMP=0x00100000000052d3
- (void)createFiltersFromArray:(id)arg1;	// IMP=0x0010000000004c96
- (_Bool)isBlacklistedEvent:(unsigned short)arg1;	// IMP=0x0010000000004b4e
- (_Bool)isWhitelistedEvent:(unsigned short)arg1;	// IMP=0x0010000000004a1a
- (void)setCorrelatedSessionID:(id)arg1;	// IMP=0x00100000000049d6
- (_Bool)uploadLogData:(id)arg1;	// IMP=0x00100000000049ce
- (_Bool)uploadFileAtPath:(id)arg1 extensionToken:(char *)arg2;	// IMP=0x00100000000049c6
- (id)flushMessagesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000049af
- (id)sendMessage:(id)arg1 timestamp:(const struct timeval *)arg2 method:(unsigned short)arg3 respCode:(unsigned short)arg4 flag:(int)arg5;	// IMP=0x0010000000004984
- (void)setStartTimestamp:(const struct timeval *)arg1;	// IMP=0x0010000000004967
- (id)sendMessage:(id)arg1 timestamp:(const struct timeval *)arg2 method:(unsigned short)arg3 respCode:(unsigned short)arg4 eventID:(unsigned short)arg5 flag:(int)arg6;	// IMP=0x001000000000495f
- (int)updateState;	// IMP=0x0010000000004942
@property int state;
- (void)setSelfVersion:(id)arg1;	// IMP=0x001000000000475c
- (void)setReportingSessionActivitySchedulerDelegate:(id)arg1;	// IMP=0x0010000000004748
- (void)dealloc;	// IMP=0x0010000000004667
- (void)cleanup;	// IMP=0x0010000000004661
- (id)initWithName:(id)arg1 profile:(id)arg2 productFamily:(id)arg3;	// IMP=0x001000000000457e
