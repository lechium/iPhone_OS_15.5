...
+ (id)fromProto:(id)arg1;	// IMP=0x00400000000031a4
+ (id)toProto:(id)arg1;	// IMP=0x0010000000002f8d
- (void).cxx_destruct;	// IMP=0x0020000000003462
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000002c79
- (id)init;	// IMP=0x0010000000002c4a
