...
- (void).cxx_destruct;	// IMP=0x00200000000061de
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000005eeb
- (unsigned long long)hash;	// IMP=0x0010000000005b6c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000058c1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000056d7
- (void)copyTo:(id)arg1;	// IMP=0x0010000000005535
- (void)writeTo:(id)arg1;	// IMP=0x0010000000005379
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000536c
- (id)dictionaryRepresentation;	// IMP=0x001000000000488b
- (id)description;	// IMP=0x00100000000047dc
