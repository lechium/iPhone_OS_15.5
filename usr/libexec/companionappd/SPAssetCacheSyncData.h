...
+ (id)fromProto:(id)arg1;	// IMP=0x004000000000766f
+ (id)toProto:(id)arg1;	// IMP=0x0010000000007528
- (void).cxx_destruct;	// IMP=0x0020000000007807
...
- (id)init;	// IMP=0x00100000000074f9
