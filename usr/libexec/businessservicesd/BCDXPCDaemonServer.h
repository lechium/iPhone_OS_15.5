...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000001570
- (id)initWithServiceName:(id)arg1 queryController:(id)arg2;	// IMP=0x0010000000001414
