...
@interface NEKPBCalendarAttributes : PBCodable
{
    ...
    MISSING_TYPE *_externalID;	// 64 = 0x40
...
- (void).cxx_destruct;	// IMP=0x002000000000f6f8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000eb9c
- (unsigned long long)hash;	// IMP=0x001000000000e4dd
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000d9e8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000d293
- (void)copyTo:(id)arg1;	// IMP=0x001000000000cc82
- (void)writeTo:(id)arg1;	// IMP=0x001000000000c679
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000c66c
- (id)dictionaryRepresentation;	// IMP=0x001000000000a8d1
- (id)description;	// IMP=0x001000000000a822
