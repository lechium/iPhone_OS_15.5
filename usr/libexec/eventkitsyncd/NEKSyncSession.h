...
- (void).cxx_destruct;	// IMP=0x0020000000052a58
...
- (void)syncSession:(id)arg1 didEndWithError:(id)arg2;	// IMP=0x001000000005282d
- (_Bool)syncSession:(id)arg1 resetDataStoreWithError:(id *)arg2;	// IMP=0x0010000000052742
- (void)syncSession:(id)arg1 applyChanges:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000051a63
- (unsigned int)syncSession:(id)arg1 enqueueChanges:(CDUnknownBlockType)arg2 error:(id *)arg3;	// IMP=0x0010000000051487
- (void)dealloc;	// IMP=0x001000000005144d
- (id)init;	// IMP=0x001000000005135b
