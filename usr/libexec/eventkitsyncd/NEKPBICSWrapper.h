...
+ (Class)metadataValuesType;	// IMP=0x00200000000635b8
+ (Class)metadataKeysType;	// IMP=0x00100000000634e6
- (void).cxx_destruct;	// IMP=0x00200000000655c4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000650a2
- (unsigned long long)hash;	// IMP=0x0010000000064e1b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000064b4e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000646bb
- (void)copyTo:(id)arg1;	// IMP=0x0010000000064415
- (void)writeTo:(id)arg1;	// IMP=0x00100000000640c9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000640bc
- (id)dictionaryRepresentation;	// IMP=0x0010000000063772
- (id)description;	// IMP=0x00100000000636c3
...
- (id)metadataValuesAtIndex:(unsigned long long)arg1;	// IMP=0x001000000006359b
- (unsigned long long)metadataValuesCount;	// IMP=0x001000000006357e
- (void)addMetadataValues:(id)arg1;	// IMP=0x0010000000063514
- (void)clearMetadataValues;	// IMP=0x00100000000634f7
- (id)metadataKeysAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000634c9
- (unsigned long long)metadataKeysCount;	// IMP=0x00100000000634ac
- (void)addMetadataKeys:(id)arg1;	// IMP=0x0010000000063442
- (void)clearMetadataKeys;	// IMP=0x0010000000063425
