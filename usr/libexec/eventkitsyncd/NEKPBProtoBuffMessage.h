...
- (void).cxx_destruct;	// IMP=0x0020000000044c1d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000004488e
- (unsigned long long)hash;	// IMP=0x001000000004475c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000444fb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000044324
- (void)copyTo:(id)arg1;	// IMP=0x00100000000441c1
- (void)writeTo:(id)arg1;	// IMP=0x0010000000044075
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000044068
- (id)dictionaryRepresentation;	// IMP=0x001000000004382d
- (id)description;	// IMP=0x001000000004377e
