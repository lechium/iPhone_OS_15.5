...
+ (id)changeSetForReminder;	// IMP=0x0040000000047e9f
+ (id)changeSetForEvent;	// IMP=0x0010000000047e86
- (void).cxx_destruct;	// IMP=0x0020000000048144
...
- (void)enumerateForChangeType:(int)arg1 forEntitiesOfClass:(Class)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x001000000004807e
- (id)description;	// IMP=0x0010000000047f80
