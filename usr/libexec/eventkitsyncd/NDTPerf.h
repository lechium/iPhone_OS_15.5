...
+ (long long)cpuTime;	// IMP=0x0040000000052dcf
+ (long long)dirtyMemory;	// IMP=0x0010000000052d58
+ (long long)wallTime;	// IMP=0x0010000000052cf1
+ (id)nowMinusPrevious:(id)arg1;	// IMP=0x0010000000052c12
...
- (id)description;	// IMP=0x0010000000052e49
- (double)cpuTimeMs;	// IMP=0x0010000000052bc1
- (id)init;	// IMP=0x0010000000052ad8
