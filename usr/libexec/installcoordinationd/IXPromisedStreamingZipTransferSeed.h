...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000a524
- (void).cxx_destruct;	// IMP=0x002000000000a69f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000a52c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000a3b0
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000a237
