...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000033d37
- (void).cxx_destruct;	// IMP=0x0020000000033e8a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000033d3f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000033bf1
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000033a87
