...
- (void).cxx_destruct;	// IMP=0x0020000000031627
...
- (CDUnknownBlockType)actionForButtonAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000313aa
- (void)addButtonDefinition:(id)arg1 forAction:(CDUnknownBlockType)arg2;	// IMP=0x00100000000312dd
- (id)initWithTitle:(id)arg1 message:(id)arg2;	// IMP=0x00100000000311e4
