...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000052c4
...
- (id)description;	// IMP=0x0010000000005982
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000005537
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000545c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000005380
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000052cc
- (id)init;	// IMP=0x0010000000005232
