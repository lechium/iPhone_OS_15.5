...
- (void).cxx_destruct;	// IMP=0x0020000000062b51
...
- (id)description;	// IMP=0x00100000000628a8
- (id)_descriptionForBool:(_Bool)arg1;	// IMP=0x001000000006288a
- (id)_descriptionForCharacterSets:(unsigned long long)arg1;	// IMP=0x00100000000627cc
- (id)initWithAttributes:(id)arg1;	// IMP=0x00100000000624d8
