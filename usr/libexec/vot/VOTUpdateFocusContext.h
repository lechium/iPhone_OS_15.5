...
+ (id)context:(long long)arg1;	// IMP=0x00400000000127d6
- (void).cxx_destruct;	// IMP=0x0020000000012a5b
...
- (id)description;	// IMP=0x0010000000012849
- (id)init;	// IMP=0x001000000001280e
