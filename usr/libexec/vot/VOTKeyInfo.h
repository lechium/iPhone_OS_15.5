...
- (void).cxx_destruct;	// IMP=0x001000000010dfb6
...
- (id)description;	// IMP=0x001000000010dd4c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000010d7c2
- (id)initWithEventRepresentation:(id)arg1;	// IMP=0x001000000010d662
- (void);	// IMP=0x001000000010dfe9
