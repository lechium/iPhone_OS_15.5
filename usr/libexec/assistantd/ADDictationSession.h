...
- (void).cxx_destruct;	// IMP=0x00200000000d747d
...
- (void)_setAudioFileIOTransactionState:(long long)arg1;	// IMP=0x00100000000d712e
- (void)_setSpeechRecognitionTransactionState:(long long)arg1;	// IMP=0x00100000000d6e25
- (void)dealloc;	// IMP=0x00100000000d6b4d
- (id)initWithUUID:(id)arg1 timestamp:(unsigned long long)arg2 languageCode:(id)arg3 options:(id)arg4 speechRequestOptions:(id)arg5;	// IMP=0x00100000000d6a42
- (id)init;	// IMP=0x00100000000d6a34
