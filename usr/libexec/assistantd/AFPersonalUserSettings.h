...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000146228
- (void).cxx_destruct;	// IMP=0x00200000001464ad
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001462de
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000146230
