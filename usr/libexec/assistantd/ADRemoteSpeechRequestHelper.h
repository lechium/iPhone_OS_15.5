...
- (void).cxx_destruct;	// IMP=0x0020000000119c88
...
- (void)reset;	// IMP=0x0010000000119c26
- (id)setSpeechRequestOptions:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000119b6c
