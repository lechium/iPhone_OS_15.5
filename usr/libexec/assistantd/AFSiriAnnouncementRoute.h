...
- (void).cxx_destruct;	// IMP=0x002000000009631c
...
- (long long)_announcementPlatform;	// IMP=0x0010000000096298
- (unsigned long long)_getRouteCapabilities;	// IMP=0x0010000000096290
- (void)_initializeInternalState;	// IMP=0x001000000009628a
- (id)initWithRouteDescription:(id)arg1;	// IMP=0x001000000009625b
