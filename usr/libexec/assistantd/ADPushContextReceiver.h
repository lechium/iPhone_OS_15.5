...
- (void).cxx_destruct;	// IMP=0x0020000000244f6f
- (oneway void)sendContext:(id)arg1;	// IMP=0x0010000000244e5d
- (id)initWithCollector:(id)arg1 pid:(int)arg2 connection:(id)arg3;	// IMP=0x0010000000244dc0
