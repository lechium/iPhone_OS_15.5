...
+ (Class)notificationPreviewRestrictedAppsType;	// IMP=0x00200000000f1228
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00100000000a3f79
- (void).cxx_destruct;	// IMP=0x00100000000f42ba
...
- (void);	// IMP=0x00100000000f3a98
- (unsigned long long)hash;	// IMP=0x00100000000f3711
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000f30eb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f2b2a
- (void)copyTo:(id)arg1;	// IMP=0x00100000000f2739
- (void)writeTo:(id)arg1;	// IMP=0x00100000000f22e5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000f22d8
- (id)dictionaryRepresentation;	// IMP=0x00100000000f1405
- (id)description;	// IMP=0x00100000000f1356
...
- (id)notificationPreviewRestrictedAppsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000f120b
- (unsigned long long)notificationPreviewRestrictedAppsCount;	// IMP=0x00100000000f11ee
- (void)addNotificationPreviewRestrictedApps:(id)arg1;	// IMP=0x00100000000f1184
- (void)clearNotificationPreviewRestrictedApps;	// IMP=0x00100000000f1167
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000c0940
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000012c9b0
