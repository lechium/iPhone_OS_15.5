...
- (void).cxx_destruct;	// IMP=0x00200000001ab854
...
- (unsigned long long)_durationInMillisecondsForDuration:(id)arg1;	// IMP=0x00100000001abca7
- (id)metricValue;	// IMP=0x00100000001ab8be
