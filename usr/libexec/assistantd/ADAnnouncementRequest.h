...
- (void).cxx_destruct;	// IMP=0x00200000000aee06
...
- (void)dealloc;	// IMP=0x00100000000aed08
- (void)completeRequestWithSuccess:(_Bool)arg1 forReason:(long long)arg2;	// IMP=0x00100000000aecb7
- (id)initWithAnnouncementRequestType:(unsigned long long)arg1 platform:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000aebda
