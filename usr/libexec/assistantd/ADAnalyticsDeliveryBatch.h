...
- (void).cxx_destruct;	// IMP=0x00200000001d5c22
...
- (id)analyticsDictionary;	// IMP=0x00100000001d5933
- (void)markFailedWithType:(unsigned long long)arg1;	// IMP=0x00100000001d5925
- (void)markSucceeded;	// IMP=0x00100000001d591b
- (void)markEndTime;	// IMP=0x00100000001d58e2
- (void)markStartTime;	// IMP=0x00100000001d58a9
- (_Bool)hasFailureType;	// IMP=0x00100000001d589b
- (id)initWithDeliveryStream:(unsigned long long)arg1;	// IMP=0x00100000001d581c
