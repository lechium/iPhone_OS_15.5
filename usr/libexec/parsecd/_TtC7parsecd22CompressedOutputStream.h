...
- (void).cxx_destruct;	// IMP=0x004000000001a71c
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x001000000001a6b9
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x001000000001a68e
- (id)initToMemory;	// IMP=0x001000000001a663
- (void)close;	// IMP=0x001000000001a61c
- (void)open;	// IMP=0x001000000001a2ed
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x001000000001a178
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x0010000000019ca1
- (id)init;	// IMP=0x0010000000019a28
