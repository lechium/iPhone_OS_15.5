...
- (void).cxx_destruct;	// IMP=0x0020000000002842
...
- (void)_setupResultWithRAPInfos:(id)arg1;	// IMP=0x00100000000025c0
- (id)initWithRAPInfos:(id)arg1;	// IMP=0x0010000000002558
