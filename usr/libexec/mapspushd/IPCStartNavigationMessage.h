...
+ (id)startNavigationMessageWithLoadDirectionsMessage:(id)arg1;	// IMP=0x0040000000023351
- (void).cxx_destruct;	// IMP=0x0020000000023982
...
- (_Bool)matchesLoadDirectionsMessage:(id)arg1;	// IMP=0x0010000000023801
- (id)description;	// IMP=0x0010000000023752
- (id)dictionaryValue;	// IMP=0x0010000000023584
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000233a3
