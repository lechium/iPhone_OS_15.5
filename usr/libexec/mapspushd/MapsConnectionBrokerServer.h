...
- (void).cxx_destruct;	// IMP=0x002000000000a4cd
- (void)listenerEndpointDidChange:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x001000000000a153
- (void)listenerEndpointForIdentifer:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x001000000000a056
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000000987c
- (id)init;	// IMP=0x00100000000096e7
