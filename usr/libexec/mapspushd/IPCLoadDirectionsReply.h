...
- (void).cxx_destruct;	// IMP=0x002000000000b001
...
- (id)description;	// IMP=0x001000000000aeec
- (id)dictionaryValue;	// IMP=0x001000000000ad48
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000000abce
