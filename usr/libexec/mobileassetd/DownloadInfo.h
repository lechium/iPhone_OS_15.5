...
- (id)description;	// IMP=0x0010000000011c48
- (id)_taskState;	// IMP=0x0010000000011b86
- (void)clearCacheServerUrl;	// IMP=0x0010000000011b5e
- (void)addNewDownloadInfo:(id)arg1;	// IMP=0x0010000000011b41
- (double)currentEstimate;	// IMP=0x0010000000011951
- (void)updateDownloadData:(long long)arg1;	// IMP=0x001000000001189b
- (_Bool)addNewRateDataPoint:(double)arg1;	// IMP=0x0010000000011721
- (void)dealloc;	// IMP=0x001000000001168f
- (void)determineDownloadUrl:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x0010000000011429
- (id)initWithUrl:(id)arg1 options:(id)arg2;	// IMP=0x0010000000011360
