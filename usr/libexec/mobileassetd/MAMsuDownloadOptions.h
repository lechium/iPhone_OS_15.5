...
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000000076d3
...
- (id)description;	// IMP=0x0010000000007cdc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000007aa3
- (void)dealloc;	// IMP=0x0010000000007a05
- (id);	// IMP=0x0010000000007787
- (id)init;	// IMP=0x00100000000076db
