...
+ (id)senderForURL:(id)arg1 queue:(id)arg2 writingUsingBlock:(CDUnknownBlockType)arg3;	// IMP=0x004000000006493b
- (void).cxx_destruct;	// IMP=0x002000000006529b
...
- (void)cancelSending;	// IMP=0x00100000000651e2
- (void)beginSendingWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000649ce
- (id)initWithURL:(id)arg1 queue:(id)arg2 writerBlock:(CDUnknownBlockType)arg3;	// IMP=0x0010000000064879
