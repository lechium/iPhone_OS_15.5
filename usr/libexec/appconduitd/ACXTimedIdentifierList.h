...
- (void).cxx_destruct;	// IMP=0x002000000005aac2
...
- (_Bool)containsIdentifier:(id)arg1;	// IMP=0x001000000005a8f4
- (_Bool)removeIdentifier:(id)arg1;	// IMP=0x001000000005a6a3
- (void)updateTimeOnIdentifier:(id)arg1;	// IMP=0x001000000005a512
- (_Bool)addIdentifierIfNotPresent:(id)arg1;	// IMP=0x0010000000059dd3
- (id)initWithTimeout:(double)arg1;	// IMP=0x0010000000059d1c
