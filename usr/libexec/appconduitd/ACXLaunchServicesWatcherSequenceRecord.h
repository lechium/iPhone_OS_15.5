...
- (void).cxx_destruct;	// IMP=0x0020000000012167
...
- (id)dictionaryRepresentation;	// IMP=0x0010000000011f07
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000011c1a
- (id)initWithLSSequenceNumber:(unsigned long long)arg1 acxSequenceNumber:(unsigned long long)arg2 counterpartIdentifiers:(id)arg3;	// IMP=0x0010000000011b91
