...
- (void).cxx_destruct;	// IMP=0x002000000002a18e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000029cd9
- (unsigned long long)hash;	// IMP=0x0010000000029c5e
- (id)copy;	// IMP=0x0010000000029bff
- (id)initWithType:(int)arg1 usageString:(id)arg2 usageBool:(id)arg3 appId:(id)arg4 createTime:(id)arg5;	// IMP=0x0010000000029afc
