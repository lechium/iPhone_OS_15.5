...
@protocol SBHWidgetSheetViewControllerPresenter, SBHWidgetSheetViewControlling, SBIconDragPreview, SBLeafIconDataSource, UIDropSession, UIViewImplicitlyAnimating;
