...
@optional
- (void)iconManager:(SBHIconManager *)arg1 testRecipe_setupIntent:(INIntent *)arg2 forWidget:(SBHWidget *)arg3 iconWithIdentifier:(NSString *)arg4;
