...
@class BNBannerSourceLayoutDescription, BNBannerSourceListener, FBProcess, FBSMutableSceneParameters, FBScene, MISSING_TYPE, NSArray, NSDictionary, NSString, UIApplicationSceneSpecification;
...
- (MISSING_TYPE *)bannerSourceListener:presentationSize:containerSize:error: /* Error: Ran out of types for this method. */;
