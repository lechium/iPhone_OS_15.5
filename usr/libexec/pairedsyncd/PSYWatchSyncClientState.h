...
- (void).cxx_destruct;	// IMP=0x002000000000da1b
...
- (id)description;	// IMP=0x001000000000d890
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000d6c5
- (unsigned long long)hash;	// IMP=0x001000000000d606
- (id)plistRepresentation;	// IMP=0x001000000000d3a1
...
- (id)initWithPlistRepresentation:(id)arg1;	// IMP=0x001000000000d15f
- (id)initWithSyncSessionState:(unsigned long long)arg1 syncSessionType:(unsigned long long)arg2 migrationSync:(_Bool)arg3 activities:(id)arg4 completedActivities:(id)arg5;	// IMP=0x001000000000d09e
