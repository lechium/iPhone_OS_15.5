...
- (void).cxx_destruct;	// IMP=0x0020000000017ec0
...
- (id)description;	// IMP=0x0010000000017cfd
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000017b67
- (unsigned long long)hash;	// IMP=0x0010000000017af6
- (id)plistRepresentation;	// IMP=0x0010000000017964
- (id)initWithPlistRepresentation:(id)arg1;	// IMP=0x0010000000017821
- (id)initWithActivityLabel:(id)arg1 globalProgress:(long long)arg2 syncProgressState:(unsigned long long)arg3;	// IMP=0x0010000000017798
