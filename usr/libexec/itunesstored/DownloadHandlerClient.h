...
- (id)description;	// IMP=0x0020000000028493
...
- (id)resetDisavowedSessionProperties;	// IMP=0x0010000000028018
@property(readonly) NSSet *disavowedSessionProperties;
- (void)addDisavowedSessionProperties:(id)arg1;	// IMP=0x0010000000027c0c
- (void)dealloc;	// IMP=0x0010000000027bb4
- (id)initWithInputConnection:(id)arg1;	// IMP=0x0010000000027b6a
