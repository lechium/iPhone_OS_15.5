...
- (void).cxx_destruct;	// IMP=0x0020000000044684
...
- (void)setOriginatingStorefront:(id)arg1;	// IMP=0x0010000000044589
- (id)originatingStorefront;	// IMP=0x0010000000044573
- (id)_fullBuyParametersWithAppProxy:(id)arg1;	// IMP=0x0010000000043c91
- (id)_appProxy;	// IMP=0x00100000000438a0
- (void)run;	// IMP=0x0010000000042cbd
- (_Bool)purchaseOperation:(id)arg1 shouldContinueWithNewStorefront:(id)arg2;	// IMP=0x0010000000042bd9
