...
- (void)_setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000000fc98
...
- (void)dealloc;	// IMP=0x001000000000fb4f
- (id)initWithManifestItemDictionary:(id)arg1;	// IMP=0x001000000000faf8
- (id)init;	// IMP=0x001000000000faac
