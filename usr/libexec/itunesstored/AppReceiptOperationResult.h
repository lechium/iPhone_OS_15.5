...
- (void)addRefreshed:(id)arg1;	// IMP=0x00100000001224a3
- (void)addRevoked:(id)arg1;	// IMP=0x0010000000122447
- (void)addExpiring:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000012236c
- (void)dealloc;	// IMP=0x0010000000122306
