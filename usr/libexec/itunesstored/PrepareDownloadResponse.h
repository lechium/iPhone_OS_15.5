...
- (void).cxx_destruct;	// IMP=0x002000000017e091
...
- (id)_reuseExistingTaskInSession:(id)arg1;	// IMP=0x001000000017d470
- (id)_getExistingTaskInSession:(id)arg1;	// IMP=0x001000000017ce0e
@property(readonly, nonatomic) NSString *URLSessionIdentifier;
- (id)sessionTaskWithSession:(id)arg1 error:(id *)arg2;	// IMP=0x001000000017cab7
- (id)sessionConfiguration;	// IMP=0x001000000017c8df
