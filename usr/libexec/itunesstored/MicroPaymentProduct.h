...
+ (id)periodFromISO8601String:(id)arg1;	// IMP=0x004000000006503e
...
- (id)copyProduct;	// IMP=0x0010000000064c6d
- (void)dealloc;	// IMP=0x0010000000064beb
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000006453f
