...
- (void).cxx_destruct;	// IMP=0x00200000001e1006
...
- (void)_updateWithDictionary:(id)arg1;	// IMP=0x00100000001e0eda
- (id)description;	// IMP=0x00100000001e0dc3
- (id)initWithItemID:(id)arg1 bundleID:(id)arg2 clusterVersionID:(id)arg3 dictionary:(id)arg4;	// IMP=0x00100000001e0cba
