...
- (void).cxx_destruct;	// IMP=0x00200000000e617b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000e6088
- (void)addUploadIdentifier:(long long)arg1;	// IMP=0x00100000000e602e
- (void)addPostIdentifier:(long long)arg1;	// IMP=0x00100000000e5fd4
- (id)init;	// IMP=0x00100000000e5f5f
