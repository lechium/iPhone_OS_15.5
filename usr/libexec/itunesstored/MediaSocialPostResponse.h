...
+ (id)_unrecoverableErrors;	// IMP=0x0020000000154681
- (void).cxx_destruct;	// IMP=0x00200000001547cf
...
- (_Bool)_isUnrecoverable:(id)arg1 statusCode:(long long)arg2;	// IMP=0x00100000001545fe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000015454c
- (void)setValuesWithResponseDictionary:(id)arg1;	// IMP=0x001000000015411d
