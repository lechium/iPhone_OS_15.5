...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x0020000000013025
- (void).cxx_destruct;	// IMP=0x0020000000013557
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001338b
- (id)copyXPCEncoding;	// IMP=0x00100000000132ce
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00100000000130c3
