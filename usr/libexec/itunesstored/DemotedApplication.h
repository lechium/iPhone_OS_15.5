...
- (void).cxx_destruct;	// IMP=0x0020000000033626
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003348c
@property(readonly, nonatomic) RestoreDownloadItem *restoreDownloadItem;
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000032f03
- (id)initWithApplication:(id)arg1;	// IMP=0x0010000000032d72
