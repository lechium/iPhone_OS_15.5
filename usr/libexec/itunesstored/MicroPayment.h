...
+ (_Bool)responseIsValid:(id)arg1;	// IMP=0x0040000000040c43
+ (id)paymentEntityFromContext:(id)arg1;	// IMP=0x0010000000040bf6
@property(nonatomic, getter=isTransientFailed) _Bool transientFailed; // @synthesize transientFailed=_transientFailed;
- (void)_updateDownloadsFromResponse:(id)arg1;	// IMP=0x0010000000041ecb
- (id)_temporaryIdentifier;	// IMP=0x0010000000041e7c
- (long long)_serverStateForClientState:(long long)arg1;	// IMP=0x0010000000041e20
- (long long)_clientStateForServerState:(long long)arg1;	// IMP=0x0010000000041d9c
- (void)setValuesWithPaymentTransaction:(id)arg1;	// IMP=0x00100000000419ce
@property(retain, nonatomic) NSString *transactionIdentifier; // @dynamic transactionIdentifier;
- (void)awakeFromInsert;	// IMP=0x00100000000418e7
- (void)setFailedWithError:(id)arg1;	// IMP=0x0010000000041803
@property(readonly, nonatomic) NSString *matchingIdentifier;
@property(readonly, nonatomic, getter=isReady) _Bool ready;
- (void)mergeValuesFromResponse:(id)arg1;	// IMP=0x0010000000041424
- (_Bool)isEqualToResponse:(id)arg1 compareAllFields:(_Bool)arg2;	// IMP=0x0010000000041226
- (id)copyPaymentTransaction;	// IMP=0x0010000000040c8f
- (void)dealloc;	// IMP=0x0010000000040ba8
