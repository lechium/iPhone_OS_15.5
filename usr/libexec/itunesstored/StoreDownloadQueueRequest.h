...
+ (void)initialize;	// IMP=0x00200000000c3eae
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000c3e13
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000c3ce9
- (unsigned long long)hash;	// IMP=0x00100000000c3cd3
- (id)description;	// IMP=0x00100000000c3c73
@property(readonly, nonatomic) NSString *queueCountURLBagKey;
@property(readonly, nonatomic) NSString *queueContentsURLBagKey;
- (void)dealloc;	// IMP=0x00100000000c3bc0
