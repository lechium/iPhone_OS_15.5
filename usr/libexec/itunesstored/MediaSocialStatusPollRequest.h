...
- (void).cxx_destruct;	// IMP=0x00200000000289bb
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000002886f
- (unsigned long long)hash;	// IMP=0x0010000000028859
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000028792
