...
- (void).cxx_destruct;	// IMP=0x00200000001a3b30
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001a3704
- (id)description;	// IMP=0x00100000001a36b6
- (id)initWithAppAdamId:(id)arg1 transactionId:(id)arg2 campaignId:(id)arg3 adNetworkId:(id)arg4 attributionSignature:(id)arg5 pingbackUrl:(id)arg6 retryCount:(long long)arg7 localTimestamp:(id)arg8;	// IMP=0x00100000001a32f2
