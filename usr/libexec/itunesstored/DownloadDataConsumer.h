...
- (void)truncate;	// IMP=0x0010000000120726
- (void)suspend;	// IMP=0x0010000000120720
@property(readonly, nonatomic) unsigned long long resumptionOffset;
- (void)reset;	// IMP=0x0010000000120712
@property(readonly, nonatomic) double percentComplete;
- (_Bool)finish:(id *)arg1;	// IMP=0x0010000000120701
@property(readonly, nonatomic) _Bool hasConsumedData;
@property(readonly, nonatomic) unsigned long long diskUsage;
- (_Bool)consumeData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001206e9
