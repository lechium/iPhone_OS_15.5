...
- (_Bool)_loadPaymentsWithExpectedCount:(long long)arg1 error:(id *)arg2;	// IMP=0x00100000000954ee
- (_Bool)_getQueueCount:(long long *)arg1 error:(id *)arg2;	// IMP=0x00100000000953fd
- (void)run;	// IMP=0x001000000009531d
- (void)dealloc;	// IMP=0x001000000009529b
