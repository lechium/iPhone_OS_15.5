...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000028bd8
- (unsigned long long)hash;	// IMP=0x0010000000028bce
- (id)description;	// IMP=0x0010000000028b68
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000028aa8
- (void)dealloc;	// IMP=0x0010000000028a50
- (id)initWithClientIdentifier:(id)arg1 handlerIdentifier:(long long)arg2;	// IMP=0x00100000000289ee
