...
- (void)_writeCacheWithFamilyCircle:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x0010000000010e5e
- (id)_familyCircleForDictionary:(id)arg1;	// IMP=0x00100000000104f6
- (id)_cachePath;	// IMP=0x001000000001046a
- (id)_cachedFamilyCircleWithAccountIdentifier:(id)arg1;	// IMP=0x001000000001027c
- (void)run;	// IMP=0x001000000000fd34
- (void)dealloc;	// IMP=0x001000000000fcce
