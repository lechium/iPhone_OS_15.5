...
- (void)runWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000004e0a0
@property(readonly, nonatomic) _Bool blocksAppInstallation;
- (_Bool)applicationIsInstalled:(id)arg1;	// IMP=0x001000000004e01f
- (void)dealloc;	// IMP=0x001000000004dfe4
- (id)initWithApplicationHandle:(id)arg1;	// IMP=0x001000000004df8d
