...
+ (void)forceSandboxForBundleIdentifier:(id)arg1 untilDate:(id)arg2;	// IMP=0x00200000001ac621
+ (void)initialize;	// IMP=0x00100000001ac5f3
...
- (id)description;	// IMP=0x00100000001acd5d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001acc63
- (void)setValuesWithSoftwareApplicationProxy:(id)arg1;	// IMP=0x00100000001ac9f5
- (void)setValuesWithPaymentQueueClient:(id)arg1;	// IMP=0x00100000001ac84a
- (void)dealloc;	// IMP=0x00100000001ac7dd
