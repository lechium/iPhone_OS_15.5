...
- (void).cxx_destruct;	// IMP=0x00000000000adbeb
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ad9f0
- (id)copyXPCEncoding;	// IMP=0x00100000000ad8fb
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00100000000ad724
