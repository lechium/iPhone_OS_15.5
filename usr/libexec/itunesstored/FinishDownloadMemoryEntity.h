...
+ (id)defaultProperties;	// IMP=0x004000000008aa59
+ (Class)databaseEntityClass;	// IMP=0x001000000008aa48
- (void).cxx_destruct;	// IMP=0x002000000008ada6
// Error: Property attributes should begin with the type ('T') attribute, property name: secondaryAssets
...
- (id)secondaryAssetForType:(id)arg1;	// IMP=0x001000000008a716
@property(readonly, nonatomic) long long restoreState;
- (id)newITunesMetadataDictionary;	// IMP=0x0010000000089f5f
- (void)loadAssetsUsingSession:(id)arg1;	// IMP=0x0010000000089a82
...
- (id)destinationDirectoryPathForAsset:(id)arg1;	// IMP=0x00100000000894f7
