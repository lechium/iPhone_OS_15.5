...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001b3c2b
- (unsigned long long)hash;	// IMP=0x00100000001b3c21
- (id)valueForSessionProperty:(id)arg1;	// IMP=0x00100000001b3bfa
- (void)setValue:(id)arg1 forSessionProperty:(id)arg2;	// IMP=0x00100000001b3b8b
- (void)dealloc;	// IMP=0x00100000001b3b50
- (id)init;	// IMP=0x00100000001b3aea
