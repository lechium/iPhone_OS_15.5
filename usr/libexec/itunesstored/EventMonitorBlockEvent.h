...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000139b66
- (void)performAction;	// IMP=0x0010000000139b4c
- (_Bool)hasOccurred;	// IMP=0x0010000000139b30
- (void)dealloc;	// IMP=0x0010000000139ad8
