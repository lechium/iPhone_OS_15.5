...
- (void).cxx_destruct;	// IMP=0x00200000000c656d
- (id)_requestPropertiesWithAccount:(id)arg1 syncState:(id)arg2 fairPlaySubscriptionController:(id)arg3;	// IMP=0x00100000000c6565
- (id)_newMachineDataOperationWithAccount:(id)arg1 response:(id)arg2;	// IMP=0x00100000000c643c
- (void)run;	// IMP=0x00100000000c63d3
