...
+ (unsigned int)mediaTypeForStoreDownload:(id)arg1;	// IMP=0x002000000010abb1
- (id)_copyChapterVideoTracksForAsset:(id)arg1;	// IMP=0x002000000010c1f1
@property long long updateType;
- (void)setValue:(id)arg1 forAdditionalEntityProperty:(id)arg2;	// IMP=0x001000000010c089
...
- (void)loadPropertiesFromMediaPath:(id)arg1 includeTracks:(_Bool)arg2;	// IMP=0x001000000010b77f
@property(readonly) _Bool hasItemArtwork;
@property(readonly, getter=isDownloading) _Bool downloading;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000010a9fa
- (void)dealloc;	// IMP=0x001000000010a98b
- (id)init;	// IMP=0x001000000010a93d
