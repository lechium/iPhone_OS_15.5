...
- (void)_showErrorDialogForOutput:(id)arg1;	// IMP=0x001000000002bd07
- (void)_run;	// IMP=0x001000000002b71f
- (id)_primarySINF;	// IMP=0x001000000002b6da
- (_Bool)_performCheckout:(id *)arg1;	// IMP=0x001000000002b2de
- (_Bool)_haveValidRentalInformation;	// IMP=0x001000000002aced
- (_Bool)_handleResponse:(id)arg1 error:(id *)arg2;	// IMP=0x001000000002a711
- (id)_copyRentalIdentifier;	// IMP=0x001000000002a68b
- (id)_copyAccountIdentifier;	// IMP=0x001000000002a605
- (id)_bodyData;	// IMP=0x0010000000029c46
- (void)run;	// IMP=0x0010000000029c0c
...
- (void)dealloc;	// IMP=0x0010000000029965
- (id)initWithStoreDownloadSinfs:(id)arg1;	// IMP=0x0010000000029784
- (id)initWithAccountIdentifier:(id)arg1 rentalKeyIdentifier:(id)arg2;	// IMP=0x0010000000029679
- (id)initWithSinfs:(id)arg1;	// IMP=0x00100000000295a8
- (id)init;	// IMP=0x0010000000029594
