...
- (void).cxx_destruct;	// IMP=0x0020000000169690
...
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x0010000000169060
- (void)_didReceiveData:(id)arg1;	// IMP=0x0010000000168050
- (void)didReceiveData:(id)arg1;	// IMP=0x0010000000167f40
- (void)setHasSpaceAvailable:(_Bool)arg1;	// IMP=0x0010000000167b60
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x0010000000167ae0
- (unsigned long long)sendPacketBuffer:(CDStruct_727fadec *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x00100000001677b0
- (id)copyLinkStatsDict;	// IMP=0x0010000000167650
@property(readonly, getter=linkTypeString) NSString *linkTypeString;
@property(readonly) unsigned long long headerOverhead;
- (void)start;	// IMP=0x0010000000167590
- (void)triggerBTCorruptionRecovery;	// IMP=0x0010000000167560
- (void)_localDetectedCorruption;	// IMP=0x0010000000167550
- (void)dealloc;	// IMP=0x00100000001674f0
- (id)initWithWPLinkManager:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0010000000167370
