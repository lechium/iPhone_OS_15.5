...
- (void).cxx_destruct;	// IMP=0x00200000003f2590
...
- (void)setNegotiationTimer;	// IMP=0x00100000003f20c0
- (void)_handleNegotiationTimeout;	// IMP=0x00100000003f1780
- (void)removeNegotiationTimer;	// IMP=0x00100000003f1540
- (void)dealloc;	// IMP=0x00100000003f14d0
- (id)initWithToken:(id)arg1;	// IMP=0x00100000003f1410
