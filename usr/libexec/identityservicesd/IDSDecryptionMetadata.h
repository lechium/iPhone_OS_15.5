...
- (id)initWithUsedLastResortCache:(_Bool)arg1 usedCachedData:(_Bool)arg2;	// IMP=0x00100000001e3910
- (id)initWithEncryptionType:(long long)arg1;	// IMP=0x00100000001e38a0
- (id)init;	// IMP=0x00100000001e3830
- (id)initWithEncryptionType:(long long)arg1 usedLastResortCache:(_Bool)arg2 usedCachedData:(_Bool)arg3;	// IMP=0x00100000001e3770
