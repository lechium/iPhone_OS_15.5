...
- (void).cxx_destruct;	// IMP=0x0020000000533c20
...
// Error: Property attributes should begin with the type ('T') attribute, property name: inviteTimer
...
- (id)publicIdentityFromData:(id)arg1;	// IMP=0x0010000000532560
- (_Bool)destinationIsDefaultPairedDevice:(id)arg1;	// IMP=0x0010000000532490
- (_Bool)destinationIsGuestDevice:(id)arg1;	// IMP=0x0010000000532420
- (id)getQuickRelayAllocateOptions:(id)arg1;	// IMP=0x0010000000532040
- (_Bool)supportsReinitiate;	// IMP=0x0010000000531f40
- (void)_endSessionTimedOut;	// IMP=0x0010000000531de0
- (void)setEndSessionTimeoutTimer;	// IMP=0x0010000000531b60
- (void)_clearEndSessionTimeoutTimer;	// IMP=0x0010000000531970
- (void)_clearPacketLossTimer;	// IMP=0x00100000005317f0
- (void)_connectionTimedOut;	// IMP=0x00100000005316a0
- (void)setConnectionTimer;	// IMP=0x0010000000531230
- (void)_clearConnectionTimer;	// IMP=0x0010000000531040
- (void)_clearInvitationTimer;	// IMP=0x0010000000530e50
- (void)_inviteTimedOut;	// IMP=0x0010000000530c90
- (void)setInvitationTimer;	// IMP=0x0010000000530a00
- (void)clearAllTimers;	// IMP=0x00100000005309a0
@property(readonly, nonatomic) CDStruct_eff2b79e *encryptionState;
- (id)initWithDictionary:(id)arg1 serviceName:(id)arg2 isInitiator:(_Bool)arg3 uniqueID:(id)arg4 accountID:(id)arg5 destinations:(id)arg6;	// IMP=0x001000000052dc40
