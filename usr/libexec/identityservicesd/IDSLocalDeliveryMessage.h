...
- (id)socketPairMessage;	// IMP=0x001000000029ffd0
- (void)processAckForSocketPairMessage:(id)arg1;	// IMP=0x001000000029ff70
- (void)kickProgressBlock;	// IMP=0x001000000029fdc0
- (id)init;	// IMP=0x001000000029fb20
