...
- (void).cxx_destruct;	// IMP=0x002000000029e8c0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000029e3c0
- (_Bool)wantsHTTPGet;	// IMP=0x001000000029e3a0
- (id)additionalQueryStringParameters;	// IMP=0x001000000029e190
- (id)additionalMessageHeaders;	// IMP=0x001000000029df20
- (id)bagKey;	// IMP=0x001000000029df00
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000029dc40
