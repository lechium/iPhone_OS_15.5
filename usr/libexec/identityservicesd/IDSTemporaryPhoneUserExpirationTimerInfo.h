...
+ (long long)phaseForExpirationDate:(id)arg1;	// IMP=0x004000000014cdb0
- (void).cxx_destruct;	// IMP=0x002000000014ce90
...
- (id)initWithUser:(id)arg1 expirationPhase:(long long)arg2;	// IMP=0x001000000014cb40
- (id)initWithUser:(id)arg1;	// IMP=0x001000000014ca60
