...
- (void).cxx_destruct;	// IMP=0x00200000005460f0
...
- (void)purgeData;	// IMP=0x0010000000545d60
- (void)saveData:(id)arg1;	// IMP=0x0010000000545c60
- (id)data;	// IMP=0x0010000000545bc0
@property(readonly, nonatomic) _Bool isAvailable;
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, copy) NSString *description;
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2 userDefaults:(id)arg3;	// IMP=0x0010000000545860
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2;	// IMP=0x0010000000545770
