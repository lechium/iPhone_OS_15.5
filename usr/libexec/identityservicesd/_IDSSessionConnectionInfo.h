...
- (void).cxx_destruct;	// IMP=0x0020000000404e70
...
- (unsigned int)_numberOfOutagesSinceInterval:(double)arg1;	// IMP=0x0010000000404420
- (void)_addRemotePacketOutage;	// IMP=0x0010000000404370
- (id)description;	// IMP=0x0010000000404260
@property(readonly, nonatomic) _Bool isFinished;
- (id)init;	// IMP=0x0010000000404180
