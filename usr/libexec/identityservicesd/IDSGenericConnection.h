...
- (void).cxx_destruct;	// IMP=0x002000000056b170
...
- (void)setCompressionState:(long long)arg1;	// IMP=0x001000000056a610
- (long long)compressionState;	// IMP=0x001000000056a5f0
...
- (void)_createStallDetectorWithName:(id)arg1;	// IMP=0x00100000005696a0
- (void)_triggerStallDetectionLogsForDetector:(id)arg1 withEvent:(id)arg2;	// IMP=0x0010000000568f30
- (void)reportToAWD:(unsigned long long)arg1 connectionType:(int)arg2 error:(int)arg3;	// IMP=0x0010000000568d10
- (void)invalidate;	// IMP=0x0010000000568330
- (void)dealloc;	// IMP=0x0010000000568240
- (void)_closeSockets;	// IMP=0x0010000000567b30
@property(nonatomic) NSObject<OS_dispatch_queue> *completionQueue;
- (id)initWithAddressPair:(id)arg1 protocol:(int)arg2;	// IMP=0x00100000005676d0
- (id)flagsString;	// IMP=0x00100000005675d0
- (CDStruct_eff2b79e *)encryptionState;	// IMP=0x00100000005675b0
- (id)description;	// IMP=0x0010000000567040
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 keyMaterialLength:(int)arg3 isCloudEnabled:(_Bool)arg4;	// IMP=0x0010000000566c30
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 isCloudEnabled:(_Bool)arg3;	// IMP=0x0010000000566830
