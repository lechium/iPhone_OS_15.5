...
- (void).cxx_destruct;	// IMP=0x0020000000675c20
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000675710
- (id)bagKey;	// IMP=0x00100000006756f0
- (id)requiredKeys;	// IMP=0x0010000000675690
- (id)messageBody;	// IMP=0x00100000006752f0
- (id)additionalMessageHeaders;	// IMP=0x0010000000675010
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000674d00
