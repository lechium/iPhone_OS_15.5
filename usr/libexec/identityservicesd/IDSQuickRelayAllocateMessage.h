...
@interface IDSQuickRelayAllocateMessage : IDSMessage
{
    ...
    NSArray *_pluginAllocations;	// 560 = 0x230
    NSNumber *_errorCode;	// 568 = 0x238
    NSString *_errorMessage;	// 576 = 0x240
    NSNumber *_invitationRetryCount;	// 584 = 0x248
    NSNumber *_groupMemberCount;	// 592 = 0x250
    NSNumber *_selfAllocationCount;	// 600 = 0x258
    NSNumber *_infoAttribute;	// 608 = 0x260
    NSNumber *_isNewUPlusOneSession;	// 616 = 0x268
    NSNumber *_linkSuggestion;	// 624 = 0x270
    NSNumber *_linkScore;	// 632 = 0x278
    NSNumber *_isLightweightParticipant;	// 640 = 0x280
    NSData *_relayIPv6;	// 648 = 0x288
}

- (void).cxx_destruct;	// IMP=0x0020000000526260
...
- (id)description;	// IMP=0x00100000005247a0
- (unsigned long long)requestLength;	// IMP=0x0010000000524030
- (unsigned long long)_recipientDataSize;	// IMP=0x0010000000522bd0
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000522b90
- (_Bool)wantsAPSRetries;	// IMP=0x0010000000522b70
- (id)messageBody;	// IMP=0x0010000000521ea0
- (id)requiredKeys;	// IMP=0x0010000000521d90
- (long long)responseCommand;	// IMP=0x0010000000521d70
- (long long)command;	// IMP=0x0010000000521d50
- (_Bool)wantsIntegerUniqueIDs;	// IMP=0x0010000000521d30
- (_Bool)wantsBinaryPush;	// IMP=0x0010000000521d10
- (_Bool)wantsCompressedBody;	// IMP=0x0010000000521cf0
- (_Bool)wantsHTTPHeaders;	// IMP=0x0010000000521cd0
- (_Bool)wantsBagKey;	// IMP=0x0010000000521cb0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000520f20
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000005144b0
- (id)init:(id)arg1;	// IMP=0x0010000000514290
