...
@interface IDSUTunControlChannel : NSObject
{
    ...
    MISSING_TYPE *_isReadyForEncrypting;	// 97 = 0x61
...
- (void).cxx_destruct;	// IMP=0x00200000001d4680
...
- (void)resumeOTRNegotiation;	// IMP=0x00100000001d4260
- (void)suspendOTRNegotiation:(id)arg1;	// IMP=0x00100000001d4220
- (_Bool)processSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x00100000001d41d0
- (void)sendSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x00100000001d4190
- (_Bool)processOTRNegotiationMessage:(id)arg1;	// IMP=0x00100000001d35f0
- (void)sendOTRNegotiationMessage:(id)arg1 negotiationCount:(unsigned int)arg2 negotiationData:(id)arg3;	// IMP=0x00100000001d3580
- (void)_destroyFairplayDeviceSession;	// IMP=0x00100000001d3570
- (void)_destroyFairplayHostSession;	// IMP=0x00100000001d3560
- (void)_handleFairplayAuthenticationFailure;	// IMP=0x00100000001d3490
- (_Bool)processFairplayDeviceSessionInfo:(id)arg1;	// IMP=0x00100000001d3440
- (_Bool)processFairplayDeviceInfo:(id)arg1;	// IMP=0x00100000001d33f0
- (_Bool)processFairplayHostSessionInfo:(id)arg1;	// IMP=0x00100000001d33a0
- (id)_utunControlMessageFairplayDeviceSessionInfo:(char *)arg1 grappaDeviceSessionInfoSize:(unsigned int)arg2;	// IMP=0x00100000001d3380
- (id)_utunControlMessageFairplayHostSessionInfo:(unsigned char)arg1 deviceType:(unsigned char)arg2 protocolVersion:(unsigned int)arg3;	// IMP=0x00100000001d3360
- (id)_utunControlMessageFairplayDeviceInfo;	// IMP=0x00100000001d3350
- (void)dealloc;	// IMP=0x00100000001d3300
- (void)invalidate;	// IMP=0x00100000001d3290
- (void)sendPriorityMessage:(id)arg1;	// IMP=0x00100000001d31e0
- (void)sendMessage:(id)arg1;	// IMP=0x00100000001d3130
- (void)_checkSendNewMessage;	// IMP=0x00100000001d19c0
- (void)_clearChannel;	// IMP=0x00100000001d1800
@property(readonly, nonatomic) _Bool connected;
- (void)cancelConnection;	// IMP=0x00100000001d17a0
- (void)_cancelConnectionAndResetDataConnections:(_Bool)arg1 shouldObliterate:(_Bool)arg2 encryptionFailure:(_Bool)arg3 shouldTriggerCorruptionRecovery:(_Bool)arg4;	// IMP=0x00100000001d1520
- (void)_callHandlerWithMessage:(id)arg1 resetDataConnections:(_Bool)arg2 shouldObliterate:(_Bool)arg3 decryptionFailed:(_Bool)arg4 shouldTriggerCorruptionRecovery:(_Bool)arg5;	// IMP=0x00100000001d1450
- (void)useConnection:(id)arg1 withFirstMessage:(id)arg2;	// IMP=0x00100000001cfeb0
- (void)writeToConnection;	// IMP=0x00100000001cf2c0
- (void)readFromConnection;	// IMP=0x00100000001cd220
@property(readonly, nonatomic) _Bool isDefaultPairedDeviceStartingToEncrypt;
- (void)encryptControlChannelForStoredIdentities;	// IMP=0x00100000001cd1f0
- (void)simulateDecryptionFailure;	// IMP=0x00100000001cd120
- (void)_cleanupConnection;	// IMP=0x00100000001cd070
- (id)initWithDeviceUniqueID:(id)arg1 cbuuid:(id)arg2 receiveHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001ccd80
- (id)description;	// IMP=0x00100000001ccc70
