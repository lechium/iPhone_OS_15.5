...
- (void).cxx_destruct;	// IMP=0x0020000000057890
...
- (void)osChannelInfoLog;	// IMP=0x0010000000057500
- (void)invalidate;	// IMP=0x00100000000574f0
- (_Bool)writeBuffer:(char *)arg1 bufferSize:(unsigned int)arg2 metaData:(const void *)arg3 metadataSize:(unsigned int)arg4 moreComing:(_Bool)arg5;	// IMP=0x00100000000574c0
- (_Bool)writePacketBuffer:(CDStruct_727fadec *)arg1 metaData:(const void *)arg2 metadataSize:(unsigned int)arg3 moreComing:(_Bool)arg4;	// IMP=0x0010000000057490
- (_Bool)writeDatagram:(const void *)arg1 datagramSize:(unsigned int)arg2 metaData:(const void *)arg3 metadataSize:(unsigned int)arg4;	// IMP=0x0010000000057460
- (void)connectWithProtocoHandler;	// IMP=0x0010000000057450
- (_Bool)connectWithTransportThread;	// IMP=0x0010000000057430
- (id)initWithDestination:(id)arg1;	// IMP=0x0010000000057350
