...
- (void).cxx_destruct;	// IMP=0x00200000001d49c0
...
- (id)description;	// IMP=0x00100000001d4890
- (id)initWithLocalFullIdentity:(id)arg1 remotePublicIdentity:(id)arg2;	// IMP=0x00100000001d47a0
