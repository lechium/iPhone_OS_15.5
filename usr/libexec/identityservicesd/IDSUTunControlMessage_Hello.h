...
- (void).cxx_destruct;	// IMP=0x0020000000171c50
...
- (id)initWithBytes:(const void *)arg1 length:(unsigned long long)arg2 loggingPrefixString:(id)arg3;	// IMP=0x001000000016e6d0
- (id)data;	// IMP=0x001000000016d840
- (id)init;	// IMP=0x001000000016d7d0
- (_Bool)_isTinkerFlagSet;	// IMP=0x001000000016d750
- (_Bool)_isSupportIPsecLinkFlagSet;	// IMP=0x001000000016d6d0
- (id)description;	// IMP=0x001000000016d530
