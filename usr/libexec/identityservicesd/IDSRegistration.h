...
@interface IDSRegistration : NSObject
{
    ...
    MISSING_TYPE *_keyPairSignature;	// 216 = 0xd8
...
- (void).cxx_destruct;	// IMP=0x0010000000663bb0
...
- (id)debugDescription;	// IMP=0x001000000065f740
- (id)description;	// IMP=0x001000000065f210
- (id)_userStore;	// IMP=0x001000000065f170
- (id)_user;	// IMP=0x001000000065f0f0
- (void)voidPassword;	// IMP=0x001000000065ed80
- (void)voidAuthenticationTokenAllowingGracePeriod;	// IMP=0x001000000065eb40
@property(copy, nonatomic) NSString *authenticationToken;
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000065ccd0
...
- (id)_userID;	// IMP=0x001000000065b000
@property(readonly, nonatomic) NSArray *confirmedEmails;
- (void)removeCandidateEmail:(id)arg1;	// IMP=0x001000000065ae80
- (void)addCandidateEmail:(id)arg1;	// IMP=0x001000000065ad60
@property(readonly, nonatomic) NSArray *candidateEmails;
- (_Bool)saveToKeychain;	// IMP=0x001000000065ace0
- (_Bool)removeFromKeychain;	// IMP=0x001000000065ac80
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000654f10
- (id)init;	// IMP=0x0010000000654e80
- (id)initWithPasswordManager:(id)arg1;	// IMP=0x0010000000654d80
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000654d60
- (id)_keychain_comparisonValue;	// IMP=0x001000000033f580
- (_Bool)_keychain_isEqual:(id)arg1;	// IMP=0x001000000033f320
