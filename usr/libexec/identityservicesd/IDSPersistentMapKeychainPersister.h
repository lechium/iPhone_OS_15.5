...
- (void).cxx_destruct;	// IMP=0x0020000000542f80
...
- (void)purgeData;	// IMP=0x0010000000542d00
- (void)saveData:(id)arg1;	// IMP=0x0010000000542910
- (id)data;	// IMP=0x0010000000542570
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 keychainWrapper:(id)arg2 systemMonitor:(id)arg3;	// IMP=0x00100000005423e0
