...
- (void).cxx_destruct;	// IMP=0x002000000069c5b0
...
- (void)_sendDataViaNWConnection:(id)arg1 isLargeTransfer:(_Bool)arg2;	// IMP=0x001000000069ba30
@property(readonly, nonatomic) NSSet *inFlightMessages;
- (void)_dequeueNextMessageFromOutgoingQueue;	// IMP=0x001000000069b2f0
- (double)lastSocketActivityTime;	// IMP=0x001000000069b2d0
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x001000000069aaf0
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x001000000069aa80
- (void)_processIncomingRawMessage:(id)arg1;	// IMP=0x00100000006995a0
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x0010000000699540
- (void)_receiveFromNWConnection:(id)arg1;	// IMP=0x0010000000698590
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000006984d0
- (void)_notifyDelegateAboutClosedConnection;	// IMP=0x0010000000698430
- (void)endSession;	// IMP=0x0010000000698130
- (void)dealloc;	// IMP=0x0010000000698040
- (void)start;	// IMP=0x0010000000696e50
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 identifier:(id)arg5;	// IMP=0x0010000000696b70
