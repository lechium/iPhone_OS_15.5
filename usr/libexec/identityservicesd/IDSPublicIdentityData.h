...
- (void).cxx_destruct;	// IMP=0x0020000000422510
...
- (id)initWithPublicLegacyIdentityData:(id)arg1 publicNGMIdentityData:(id)arg2 publicNGMPrekeyData:(id)arg3 NGMVersion:(id)arg4;	// IMP=0x0010000000422330
