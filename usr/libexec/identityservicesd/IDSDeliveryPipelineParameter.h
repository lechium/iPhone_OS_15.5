...
- (void).cxx_destruct;	// IMP=0x0020000000548f90
...
- (id)description;	// IMP=0x0010000000548690
- (_Bool)overrideSendOnePerTokenForService:(id)arg1;	// IMP=0x0010000000548600
- (id)initWithInfo:(id)arg1 uris:(id)arg2 service:(id)arg3 maxSize:(unsigned long long)arg4;	// IMP=0x0010000000547f00
