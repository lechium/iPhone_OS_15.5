...
- (void).cxx_destruct;	// IMP=0x00200000004fcfb0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000004fcce0
- (id)bagKey;	// IMP=0x00100000004fccc0
- (id)messageBody;	// IMP=0x00100000004fcb10
- (id)additionalMessageHeaders;	// IMP=0x00100000004fc930
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004fc710
