...
- (void *)remoteContext;	// IMP=0x00100000002a37c0
- (void *)localContext;	// IMP=0x00100000002a37a0
- (void)setRemoteContext:(void *)arg1;	// IMP=0x00100000002a35a0
- (void)setLocalContext:(void *)arg1;	// IMP=0x00100000002a33a0
- (void)invalidate;	// IMP=0x00100000002a3110
