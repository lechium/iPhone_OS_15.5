...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000025b4e
+ (id)archiveBasePath;	// IMP=0x001000000002598a
+ (void)deleteArchives;	// IMP=0x0010000000025912
+ (id)archivePathForQuery:(id)arg1;	// IMP=0x0010000000025818
- (void).cxx_destruct;	// IMP=0x00200000000260b6
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000025d0a
- (struct _MDPlistContainer *)decodeMDPlistContainerWithCoder:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000025c69
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000025b56
- (id)initWithQuery:(id)arg1 withResults:(id)arg2 withSuggestions:(id)arg3 withCorrections:(id)arg4 suggestionsAreBlended:(_Bool)arg5 withStore:(id)arg6;	// IMP=0x00100000000259d8
