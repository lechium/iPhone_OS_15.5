...
- (void).cxx_destruct;	// IMP=0x0020000000071725
...
- (void)begin:(id)arg1;	// IMP=0x00100000000709db
- (void)cancel;	// IMP=0x00100000000709d1
- (id)initWithStore:(id)arg1;	// IMP=0x001000000007095e
