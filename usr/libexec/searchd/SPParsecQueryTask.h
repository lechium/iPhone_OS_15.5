...
- (void).cxx_destruct;	// IMP=0x002000000002bf68
...
- (void)setQuerySuggestionResults:(id)arg1;	// IMP=0x001000000002bde2
- (id)querySuggestionResults;	// IMP=0x001000000002bdd5
...
- (void)query:(id)arg1 didFinishWithResults:(id)arg2 withSuggestions:(id)arg3 withCorrections:(id)arg4 withAlternativeResults:(id)arg5 suggestionsAreBlended:(_Bool)arg6;	// IMP=0x001000000002ab47
- (id)findLocalCopies:(id)arg1 alternativeResults:(id)arg2 withQueryString:(id)arg3;	// IMP=0x0010000000027934
- (void)archiveWithQuery:(id)arg1 didFinishWithResults:(id)arg2 withSuggestions:(id)arg3 withCorrections:(id)arg4 suggestionsAreBlended:(_Bool)arg5;	// IMP=0x001000000002778b
- (void)geoUserSessionEntityString:(id)arg1;	// IMP=0x0010000000027719
- (void)_setScore:forResult: /* Error: Ran out of types for this method. */;	// IMP=0x0010000000027704
- (void)queryDidFinishLoading:(id)arg1;	// IMP=0x00100000000274d7
- (void)cancel;	// IMP=0x00100000000271ec
- (void)finished;	// IMP=0x0010000000026539
- (id)initWithStore:(id)arg1 resultPipe:(id)arg2 queue:(id)arg3 visibleApps:(id)arg4 hiddenApps:(id)arg5;	// IMP=0x00100000000263b0
- (void)dealloc;	// IMP=0x0010000000026376
- (void)resumeWithArchive:(id)arg1;	// IMP=0x0010000000026274
- (id)unarchiveWithQuery:(id)arg1;	// IMP=0x001000000002615c
- (void)resumeWithTimeout:(double)arg1;	// IMP=0x001000000002610a
