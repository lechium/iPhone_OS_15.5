...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x002000000001e6a3
- (id)reportDetails;	// IMP=0x002000000001eef0
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x001000000001e986
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x001000000001e713
