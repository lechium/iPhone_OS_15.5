...
@class MISSING_TYPE, NSError, NSURLAuthenticationChallenge, NSURLSession;

@protocol NSURLSessionDelegate <NSObject>

@optional
- (MISSING_TYPE *)URLSessionDidFinishEventsForBackgroundURLSession: /* Error: Ran out of types for this method. */;
