...
- (id)reportDetails;	// IMP=0x001000000000764f
@property(retain, nonatomic) RMPredicateDescription *predicateDescription;
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x001000000000826c
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000792f
