...
- (void).cxx_destruct;	// IMP=0x002000000000ff86
...
- (id)calendarForIdentifier:(id)arg1;	// IMP=0x001000000000fc95
- (void)reportActivationPredicateObserverDidTrigger;	// IMP=0x001000000000fbc3
- (id)metadata;	// IMP=0x001000000000faaa
- (void)invalidate;	// IMP=0x001000000000fa96
- (void)updateObserverRegistration;	// IMP=0x001000000000fa90
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x001000000000fa88
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 predicate:(id)arg3;	// IMP=0x001000000000f986
