...
- (void)networkDidChange;	// IMP=0x001000000003eff7
- (void)keybagLockStateDidChange;	// IMP=0x001000000003efbf
- (void)stopObservingChanges;	// IMP=0x001000000003ef87
- (void)startObservingChanges;	// IMP=0x001000000003edf0
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x001000000003ed10
