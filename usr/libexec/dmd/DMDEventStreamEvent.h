...
- (void).cxx_destruct;	// IMP=0x002000000004ecc2
...
- (id)eventStatusMessageWithPayloadIdentifier:(id)arg1;	// IMP=0x001000000004eb77
- (id)description;	// IMP=0x001000000004eada
- (id)initWithEventType:(id)arg1 details:(id)arg2;	// IMP=0x001000000004ea0a
