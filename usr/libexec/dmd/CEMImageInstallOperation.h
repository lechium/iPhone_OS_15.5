...
- (void).cxx_destruct;	// IMP=0x0020000000005f8b
...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x0010000000005ef7
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x0010000000005bec
...
- (void)main;	// IMP=0x0010000000005a27
- (_Bool)isAsynchronous;	// IMP=0x0010000000005a1f
- (id)initWithImageDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x001000000000597d
