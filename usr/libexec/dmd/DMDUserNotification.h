...
- (void).cxx_destruct;	// IMP=0x0020000000081879
...
- (void)setNotificationRef:(struct __CFUserNotification *)arg1;	// IMP=0x0010000000081790
- (struct __CFUserNotification *)notificationRef;	// IMP=0x0010000000081786
- (void)dealloc;	// IMP=0x0010000000081747
- (id)init;	// IMP=0x00100000000816e5
