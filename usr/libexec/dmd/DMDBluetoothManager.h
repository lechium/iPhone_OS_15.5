...
+ (id)sharedManager;	// IMP=0x00200000000279a1
- (void).cxx_destruct;	// IMP=0x0020000000027cf9
...
- (void)availabilityChanged:(id)arg1;	// IMP=0x0010000000027b7c
- (id)init;	// IMP=0x00100000000279f6
