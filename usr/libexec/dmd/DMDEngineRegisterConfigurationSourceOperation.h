...
- (void).cxx_destruct;	// IMP=0x002000000004b155
...
- (void)delegateUpdatedDeclarationSourceAndEndOperation:(id)arg1;	// IMP=0x001000000004afb1
- (void)main;	// IMP=0x001000000004a748
