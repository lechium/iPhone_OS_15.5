...
- (void).cxx_destruct;	// IMP=0x002000000000f973
...
- (id)metadata;	// IMP=0x001000000000f844
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x001000000000f678
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 subPredicateObserver:(id)arg3 predicate:(id)arg4;	// IMP=0x001000000000f5ee
