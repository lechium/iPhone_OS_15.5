...
- (id)description;	// IMP=0x0010000000017f8a
- (unsigned long long)hash;	// IMP=0x0010000000017f46
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000017e98
- (id)initWithPlugIns:(id)arg1 extensionPointName:(id)arg2 forClient:(id)arg3;	// IMP=0x0010000000017d12
