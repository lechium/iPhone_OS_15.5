...
- (void).cxx_destruct;	// IMP=0x00200000000208cb
...
- (id)description;	// IMP=0x001000000002068e
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x001000000002063a
- (id)entitlementValueForKey:(id)arg1;	// IMP=0x0010000000020583
@property(readonly) int pid;
- (void)dead;	// IMP=0x00100000000204aa
- (void)dying;	// IMP=0x001000000002045f
- (void)dealloc;	// IMP=0x0010000000020420
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x000000000001fa4b
