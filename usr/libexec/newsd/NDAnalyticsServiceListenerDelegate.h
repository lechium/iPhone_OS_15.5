...
- (void).cxx_destruct;	// IMP=0x0020000000002c51
@property(retain, nonatomic) id <NDAnalyticsService> service; // @synthesize service=_service;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000002b0d
- (id)initWithService:(id)arg1;	// IMP=0x0010000000002a7d
- (id)init;	// IMP=0x0010000000002938
