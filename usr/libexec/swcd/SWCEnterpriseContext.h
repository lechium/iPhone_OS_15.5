...
- (void).cxx_destruct;	// IMP=0x00100000000112db
@property(readonly, getter=isManaging) _Bool managing; // @synthesize managing=_managing;
@property(readonly) NSData *state;
- (id)isApplicationIdentifierEligibleForManagedMode:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000010efe
- (id)serviceSpecifiersForApplicationIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000010d16
- (id)init;	// IMP=0x0010000000010c55
- (void)_loadEnterpriseData;	// IMP=0x001000000001130e
