...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000014c78
- (void).cxx_destruct;	// IMP=0x0020000000015718
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000014d26
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000014c80
