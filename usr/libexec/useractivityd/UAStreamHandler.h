...
- (void).cxx_destruct;	// IMP=0x002000000003d58a
...
- (id)trimFirstBytes:(unsigned long long)arg1 ofData:(id)arg2;	// IMP=0x001000000003d285
- (long long)tryWriteMessage;	// IMP=0x001000000003cbe0
- (long long)tryWriteRawData;	// IMP=0x001000000003c8ca
- (long long)handleSpaceAvailable;	// IMP=0x001000000003c871
- (void)handleMessageRead;	// IMP=0x001000000003c736
- (_Bool)dataHasMessage:(id)arg1;	// IMP=0x001000000003c6c2
- (void)processHeader;	// IMP=0x001000000003c5b2
- (void)handleBytesAvailable;	// IMP=0x001000000003c1d9
- (void)handleOpenCompleted;	// IMP=0x001000000003c0dc
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000003be93
- (_Bool)writeMessage:(id)arg1 tag:(long long)arg2;	// IMP=0x001000000003bb71
- (_Bool)writeRawData:(id)arg1;	// IMP=0x001000000003b972
- (void)_stop;	// IMP=0x001000000003b742
- (void)tryStop;	// IMP=0x001000000003b5f8
- (void)stop;	// IMP=0x001000000003b4e0
- (void)start;	// IMP=0x001000000003b0ba
- (long long)queueCount;	// IMP=0x001000000003b03b
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 delegate:(id)arg3;	// IMP=0x001000000003ae44
