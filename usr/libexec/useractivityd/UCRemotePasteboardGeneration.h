...
- (void).cxx_destruct;	// IMP=0x002000000002ea22
...
- (void)requestRemotePasteboardData:(CDUnknownBlockType)arg1;	// IMP=0x001000000002e4b4
- (void)requestRemoteTypeInfo:(CDUnknownBlockType)arg1;	// IMP=0x001000000002d5ca
- (void)dealloc;	// IMP=0x001000000002d485
- (void)updateState:(unsigned long long)arg1;	// IMP=0x001000000002d318
- (id)stateAsString;	// IMP=0x001000000002d295
- (id)initWithRequester:(id)arg1;	// IMP=0x001000000002d0d8
