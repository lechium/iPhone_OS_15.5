...
- (void).cxx_destruct;	// IMP=0x002000000003ac8c
...
- (id)localPBStatus;	// IMP=0x001000000003a207
- (id)statusString;	// IMP=0x001000000003a1fa
- (void)hideProgressUI:(_Bool)arg1;	// IMP=0x0010000000039d63
- (void)showProgressUI:(id)arg1;	// IMP=0x00100000000391e2
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000384f8
- (void)advertiser:(id)arg1 didReceiveInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x0010000000037922
- (void)startServiceForPasteVersion:(long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000035b29
- (void)getLocalPasteboardInfoData:(CDUnknownBlockType)arg1;	// IMP=0x00100000000359ce
- (void)setLocalPasteboardReflection:(_Bool)arg1;	// IMP=0x00100000000359bc
- (void)receivePasteboardStreamData:(id)arg1 version:(long long)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000032fc5
- (void)fetchRemotePasteboardForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000030e94
- (void)fetchRemotePasteboardTypesForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000030b5e
- (void)removeLocalPasteboardFromAdvertisers:(id)arg1;	// IMP=0x0010000000030a6a
- (void)clearLocalPasteboardTypes:(id)arg1;	// IMP=0x00100000000307f7
- (void)clearLocalPasteboardInformation;	// IMP=0x001000000003072a
- (void)localPasteboardTypesDidChange:(id)arg1 forGeneration:(unsigned long long)arg2;	// IMP=0x0010000000030065
- (void)fetchRemoteDeviceName:(CDUnknownBlockType)arg1;	// IMP=0x001000000002ff97
- (void)fetchRemotePasteboardStatus:(CDUnknownBlockType)arg1;	// IMP=0x001000000002ff25
- (void)setReturnPasteboardDataEarlyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000002fe06
- (void)setRemotePasteboardAvalibility:(_Bool)arg1 withDataRequester:(id)arg2;	// IMP=0x001000000002fa5d
- (id)currentPasteboardActivityInfo;	// IMP=0x001000000002f740
- (id)eligibleAdvertiseableItemsInOrder;	// IMP=0x001000000002f5e9
- (id)items;	// IMP=0x001000000002f5d7
- (void)startConnection:(int)arg1;	// IMP=0x001000000002f542
...
- (id)uuid;	// IMP=0x001000000002f2c5
- (void)dealloc;	// IMP=0x001000000002f1fd
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x001000000002eb44
