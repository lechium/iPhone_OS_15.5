...
+ (_Bool)createConnection:(id)arg1 host:(id)arg2 port:(long long)arg3;	// IMP=0x002000000007b34e
- (void).cxx_destruct;	// IMP=0x002000000007b58f
...
- (_Bool)terminate;	// IMP=0x001000000007b143
- (id)statusString;	// IMP=0x001000000007aff7
- (_Bool)sendResponse:(id)arg1;	// IMP=0x001000000007ad07
- (_Bool)processCommand:(id)arg1;	// IMP=0x001000000007a0bf
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x0010000000078e69
- (id)initWithManager:(id)arg1 service:(id)arg2;	// IMP=0x0010000000078bd9
- (id)initWithManager:(id)arg1 inputStream:(id)arg2 outputStream:(id)arg3 name:(id)arg4;	// IMP=0x0010000000078976
