...
- (void).cxx_destruct;	// IMP=0x002000000001b757
...
- (id)fetchDataForType:(id)arg1;	// IMP=0x001000000001b2b8
- (id)unpackMessage:(id)arg1;	// IMP=0x001000000001b248
- (id)packMessage:(id)arg1;	// IMP=0x001000000001b223
- (void)filePackagerError:(id)arg1;	// IMP=0x001000000001b141
- (MISSING_TYPE *)packager:gotData:forPacket: /* Error: Ran out of types for this method. */;	// IMP=0x001000000001aca6
- (void)sendCompletedWithError:(id)arg1;	// IMP=0x001000000001aa4d
- (void)sendPasteboard:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000019585
- (void)calculateTimeRemaining;	// IMP=0x0010000000019367
- (void)processPasteboardInfo:(id)arg1;	// IMP=0x0010000000018cce
- (void)removeReceivedItems:(id)arg1;	// IMP=0x0010000000018a14
- (void)completedReceivingPasteboardWithError:(id)arg1;	// IMP=0x0010000000018764
- (void)receivedPasteboardInfo:(id)arg1 withError:(id)arg2;	// IMP=0x00100000000184c1
- (void)cancelReceive;	// IMP=0x0010000000018406
- (void)receivePasteboardToFile:(id)arg1 withProgress:(id)arg2 infoReceivedHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4 returnInfoEarly:(_Bool)arg5;	// IMP=0x0010000000018221
- (void)sendHeartbeat;	// IMP=0x001000000001811c
- (void)sendTotalSendSize;	// IMP=0x0010000000018002
- (void)sendPasteboardDataResponse;	// IMP=0x0010000000017e5a
- (void)sendFileArchiveRequest;	// IMP=0x0010000000017955
- (void)sendPasteboardDataRequest;	// IMP=0x001000000001786a
- (void)sendPasteboardInfoResponse;	// IMP=0x00100000000176c3
- (void)sendPasteboardInfoRequest;	// IMP=0x0010000000017635
- (void)handleHeartbeat:(id)arg1;	// IMP=0x001000000001758a
- (void)handlePasteboardAuxInfoReceived:(id)arg1;	// IMP=0x001000000001742a
- (void)handlePasteboardFileResponse:(id)arg1;	// IMP=0x0010000000016c95
- (void)handlePasteboardDataResponse:(id)arg1;	// IMP=0x001000000001684d
- (void)handlePasteboardInfoResponse:(id)arg1;	// IMP=0x001000000001652f
- (void)handlePasteboardFileRequest:(id)arg1;	// IMP=0x0010000000015e06
- (void)handlePasteboardDataRequest:(id)arg1;	// IMP=0x0010000000015d82
- (void)handlePasteboardInfoRequest:(id)arg1;	// IMP=0x0010000000015cfe
- (void)recvStop:(id)arg1;	// IMP=0x0010000000015b68
- (void)sendStopWithError:(long long)arg1;	// IMP=0x00100000000159e0
- (void)streams:(id)arg1 didWriteMessageWithTag:(long long)arg2;	// IMP=0x001000000001550c
- (void)streams:(id)arg1 didReadMessage:(id)arg2 withTag:(long long)arg3;	// IMP=0x00100000000152f7
- (void)streamsDidClose:(id)arg1 withError:(id)arg2;	// IMP=0x00100000000151e8
- (void)removeObject:(id)arg1;	// IMP=0x0010000000015136
- (void)storeObject:(id)arg1;	// IMP=0x0010000000015084
- (void)dealloc;	// IMP=0x0010000000014df9
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2;	// IMP=0x0010000000014988
