...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000006cb09
- (void).cxx_destruct;	// IMP=0x002000000006cf11
...
- (id)description;	// IMP=0x001000000006cd42
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000006cc18
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000006cb11
- (id)init;	// IMP=0x001000000006cada
