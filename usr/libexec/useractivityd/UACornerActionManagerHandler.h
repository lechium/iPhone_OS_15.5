...
- (void).cxx_destruct;	// IMP=0x00200000000146a7
...
- (id)statusString;	// IMP=0x0010000000014556
- (_Bool)terminate;	// IMP=0x00100000000143f3
- (_Bool)resume;	// IMP=0x00100000000142d4
- (_Bool)suspend;	// IMP=0x00100000000141af
@property _Bool suspended;
@property(readonly) _Bool active;
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x0010000000013f20
