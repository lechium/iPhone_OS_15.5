...
- (void).cxx_destruct;	// IMP=0x002000000006a916
...
- (void)shutdownStream;	// IMP=0x001000000006a658
- (void)shutdownTimerFired:(id)arg1;	// IMP=0x001000000006a595
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x0010000000069e23
- (id)headerForData:(id)arg1;	// IMP=0x0010000000069d5b
- (void)sendTypes:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000699d1
- (id)initWithOutputStream:(id)arg1 inputStream:(id)arg2 pasteboard:(id)arg3;	// IMP=0x001000000006983b
