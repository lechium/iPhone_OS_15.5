...
+ (unsigned long long)setup:(id)arg1 interval:(double)arg2;	// IMP=0x00400000000047ec
+ (id)idleTracker:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0010000000004415
- (void).cxx_destruct;	// IMP=0x0020000000005118
...
- (void)invalidate;	// IMP=0x0010000000004d3c
- (void)dealloc;	// IMP=0x0010000000004700
- (id)init:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x00100000000044b7
