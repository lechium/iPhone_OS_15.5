...
- (void).cxx_destruct;	// IMP=0x0020000000058c07
...
- (id)description;	// IMP=0x001000000005875c
- (id)encodeAsData;	// IMP=0x0010000000057eb2
- (id)initWithData:(id)arg1;	// IMP=0x00100000000574b1
- (void)addAdditionalItem:(id)arg1 forKey:(id)arg2;	// IMP=0x00100000000573a3
@property(readonly, copy) NSDictionary *additionalItems;
- (id)initWithNSError:(id)arg1;	// IMP=0x001000000005731d
- (id)init:(id)arg1 title:(id)arg2 date:(id)arg3 userInfoPayload:(id)arg4 teamID:(id)arg5 activityType:(id)arg6;	// IMP=0x001000000005719e
