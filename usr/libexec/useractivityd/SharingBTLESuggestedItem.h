...
@class MISSING_TYPE, NSData, NSDate, NSMutableSet, NSSet, SFActivityScanner, SharingBTLEAdvertisementPayload, UACornerActionManager, UASharingReceiver;

@interface SharingBTLESuggestedItem : UAUserActivityInfo
{
    MISSING_TYPE *_optionBits;	// 8 = 0x8
...
+ (id)statusString;	// IMP=0x0040000000069541
+ (id)cornerActionBTLEItemWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 scanner:(id)arg5 receiver:(id)arg6;	// IMP=0x0010000000063fdb
+ (id)cornerActionBTLEItemWithSFAdvertisement:(id)arg1 optionBits:(unsigned int)arg2 scanner:(id)arg3 receiver:(id)arg4;	// IMP=0x0010000000063eac
- (void).cxx_destruct;	// IMP=0x0020000000069737
...
- (id)description;	// IMP=0x0010000000069405
- (void)setWhen:(id)arg1;	// IMP=0x00100000000692ff
- (id)when;	// IMP=0x0010000000069228
- (id)statusString;	// IMP=0x0010000000068c9b
- (void)clearPayload;	// IMP=0x0010000000068a77
- (void)resignCurrent;	// IMP=0x0010000000068a07
- (_Bool)requestPayloadWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000668e6
- (_Bool)updateFromSFAdvertisement:(id)arg1;	// IMP=0x0010000000066356
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11;	// IMP=0x0010000000065733
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11 dynamicIdentifier:(id)arg12;	// IMP=0x001000000006568f
