...
- (void).cxx_destruct;	// IMP=0x004000000003f531
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x001000000003f4ce
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x001000000003f4a3
- (id)initToMemory;	// IMP=0x001000000003f478
- (void)close;	// IMP=0x001000000003f431
- (void)open;	// IMP=0x001000000003f102
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x001000000003ef8d
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x001000000003eab6
- (id)init;	// IMP=0x001000000003e83d
