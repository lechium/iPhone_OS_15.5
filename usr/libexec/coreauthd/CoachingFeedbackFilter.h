...
- (void).cxx_destruct;	// IMP=0x0020000000002aee
...
- (void)_dispatchPendingBlocks;	// IMP=0x00100000000028dd
- (void)dispatchNowOrWhenFeedbackDurationAchieved:(_Bool)arg1 finish:(_Bool)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00100000000026aa
- (void)_doneWaiting;	// IMP=0x00100000000025eb
- (void)_sendFeedback:(long long)arg1;	// IMP=0x0010000000002325
- (double)_timeoutForFeedback:(long long)arg1;	// IMP=0x00100000000022ff
- (void)scheduleFeedback:(long long)arg1;	// IMP=0x00100000000020f8
- (id)initWithDelegate:(id)arg1 feedbackSet:(id)arg2 feedbackDuration:(double)arg3 iconDuration:(double)arg4;	// IMP=0x001000000000202e
