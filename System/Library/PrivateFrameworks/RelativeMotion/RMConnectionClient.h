...
- (void).cxx_destruct;	// IMP=0x00000000000093ee
- (void)endpoint:(id)arg1 didReceiveMessage:(id)arg2 withData:(id)arg3 replyBlock:(CDUnknownBlockType)arg4;	// IMP=0x00000000000093c4
- (void)endpoint:(id)arg1 didReceiveStreamedData:(id)arg2;	// IMP=0x00000000000093b0
- (void)endpointWasInvalidated:(id)arg1;	// IMP=0x00000000000091cb
- (void)endpointWasInterrupted:(id)arg1;	// IMP=0x0000000000009167
