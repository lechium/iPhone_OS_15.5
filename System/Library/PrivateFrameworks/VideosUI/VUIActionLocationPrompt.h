...
- (void).cxx_destruct;	// IMP=0x000000000014ef9b
...
- (void)_locationAuthorizationStatusDidChange:(id)arg1;	// IMP=0x000000000014ee9f
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000014ecf3
- (id)initWithContextData:(id)arg1;	// IMP=0x000000000014eb18
