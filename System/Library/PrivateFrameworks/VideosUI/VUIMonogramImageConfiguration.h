...
- (void).cxx_destruct;	// IMP=0x0000000000173976
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000173780
- (id)initWithStyle:(long long)arg1;	// IMP=0x00000000001736a0
