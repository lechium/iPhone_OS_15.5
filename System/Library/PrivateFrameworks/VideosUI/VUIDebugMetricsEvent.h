...
- (void).cxx_destruct;	// IMP=0x0000000000225126
...
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x0000000000224ee5
...
- (id)_sortKeys:(id)arg1;	// IMP=0x0000000000224c2e
- (id)initWithEventDictionary:(id)arg1 termCollater:(id)arg2;	// IMP=0x0000000000223f99
