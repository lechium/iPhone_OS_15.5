...
- (void).cxx_destruct;	// IMP=0x0000000000244083
...
- (id)description;	// IMP=0x0000000000243f77
- (void)loadImage:(CDUnknownBlockType)arg1;	// IMP=0x0000000000243d91
@property(readonly, nonatomic) NSString *subHeader;
@property(readonly, nonatomic) NSString *title;
- (id)initWithElement:(id)arg1 prev:(id)arg2;	// IMP=0x0000000000243b72
