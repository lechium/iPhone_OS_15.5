...
- (void).cxx_destruct;	// IMP=0x0000000000194985
...
- (void)_updateVignetteImage;	// IMP=0x0000000000194844
- (void)installBannerOnView:(id)arg1 anchoredToScrollView:(id)arg2;	// IMP=0x00000000001947cd
- (void)_doAllSetup;	// IMP=0x00000000001941f8
- (void)_configureBanner;	// IMP=0x0000000000193f6a
- (id)initWithBannerElement:(id)arg1;	// IMP=0x0000000000193e90
