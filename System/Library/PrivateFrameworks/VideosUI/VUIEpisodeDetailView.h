...
+ (void)configureEpisodeDetailView:(id)arg1 withMedia:(id)arg2 viewSize:(struct CGSize)arg3;	// IMP=0x000000000022c89c
+ (struct CGSize)_episodeFrameImageSizeForDetailView:(id)arg1 withViewSize:(struct CGSize)arg2;	// IMP=0x000000000022c83b
- (void).cxx_destruct;	// IMP=0x000000000022ef47
...
- (double)_seasonMargin;	// IMP=0x000000000022edc3
- (void)_configureViewElementsForAX;	// IMP=0x000000000022ed3a
- (void)didTapButtonForEpisodeFrameView:(id)arg1;	// IMP=0x000000000022ed06
- (double)_descriptionBottomMarginWithBaselineMargin:(double)arg1;	// IMP=0x000000000022ec83
- (double)_descriptionTopMarginWithBaselineMargin:(double)arg1 otherFont:(id)arg2;	// IMP=0x000000000022ebc2
- (void)_configureDotSeparator;	// IMP=0x000000000022ea74
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000022e753
- (void)layoutSubviews;	// IMP=0x000000000022d90a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000022d31b
