...
+ (_Bool)shouldPlayWhenDoneForActionRef:(id)arg1;	// IMP=0x0000000000076df2
+ (long long)getPurchaseTypeFromActionRef:(id)arg1;	// IMP=0x0000000000076c50
- (void).cxx_destruct;	// IMP=0x00000000000771d8
...
- (void)_recordErrorLog:(id)arg1;	// IMP=0x0000000000076dfa
- (void)handleRequestCompletionWithResult:(id)arg1 andError:(id)arg2;	// IMP=0x0000000000076a09
- (void)enqueueWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000768d4
- (id)initWithBuyParams:(id)arg1 ofPurchaseType:(long long)arg2;	// IMP=0x000000000007669f
