...
- (void).cxx_destruct;	// IMP=0x00000000000abc05
...
- (id)_logNameForContentViewType:(unsigned long long)arg1;	// IMP=0x00000000000abacd
- (id)_createAlertViewWithTitle:(id)arg1 description:(id)arg2;	// IMP=0x00000000000ab940
- (void)configureCurrentViewFrameForBounds:(struct CGRect)arg1;	// IMP=0x00000000000ab3c1
- (void)setRootViewForViewController:(id)arg1;	// IMP=0x00000000000ab318
