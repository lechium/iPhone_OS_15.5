...
- (void).cxx_destruct;	// IMP=0x00000000003dc790
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003dc720
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000003dc6f0
...
- (void)vui_prepareForReuse;	// IMP=0x00000000003dc480
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000003dc320
