...
- (void).cxx_destruct;	// IMP=0x0000000000214cfe
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000214c57
- (id)initWithMainMenuItems:(id)arg1 genreMenuItems:(id)arg2;	// IMP=0x0000000000214bbe
