...
- (void).cxx_destruct;	// IMP=0x00000000001460ca
...
- (void)_errorInUpdatingState:(id)arg1;	// IMP=0x0000000000145e89
- (void)dealloc;	// IMP=0x0000000000145e07
- (void)updateButtonContentView;	// IMP=0x0000000000145da1
- (void)callAPIAndToggleUpNextState;	// IMP=0x0000000000145a40
- (void)_toggleUpNextState;	// IMP=0x0000000000145970
- (void)removeNotificationObserver;	// IMP=0x00000000001458eb
- (void)setupNotificationObserver;	// IMP=0x000000000014585f
- (id)init;	// IMP=0x00000000001457e6
