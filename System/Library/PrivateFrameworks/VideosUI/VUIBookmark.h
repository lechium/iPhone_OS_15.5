...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002376da
- (void).cxx_destruct;	// IMP=0x0000000000237b0d
...
- (_Bool)hasRemoteData;	// IMP=0x0000000000237a84
- (void)_setIsMarkedAsUnwatched:(_Bool)arg1;	// IMP=0x0000000000237a7b
- (void)_setHasBeenRented:(_Bool)arg1;	// IMP=0x0000000000237a72
- (void)_setHasBeenPlayed:(_Bool)arg1;	// IMP=0x0000000000237a69
- (void)_setPlayCount:(unsigned long long)arg1;	// IMP=0x0000000000237a5f
- (void)_setBookmarkTimestamp:(id)arg1;	// IMP=0x0000000000237a4e
- (void)_setBookmarkTimeWithoutUpdatingTimestamp:(double)arg1;	// IMP=0x0000000000237a43
- (id)description;	// IMP=0x0000000000237994
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000237966
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000237906
- (id)_copyWithResultClass:(Class)arg1;	// IMP=0x0000000000237899
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002376e2
- (id)init;	// IMP=0x00000000002376ca
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000237517
- (id)initWithKey:(id)arg1;	// IMP=0x0000000000237485
