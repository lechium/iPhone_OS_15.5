...
- (void)toggleDefaultBoolValue;	// IMP=0x0000000000107e33
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 domain:(id)arg3 defaultName:(id)arg4 boolType:(_Bool)arg5;	// IMP=0x0000000000107d1b
