...
- (void).cxx_destruct;	// IMP=0x000000000016fe8b
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000016fd3a
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x000000000016fc86
