...
- (void).cxx_destruct;	// IMP=0x0000000000144e32
...
- (void)_installAppWithChannel:(id)arg1 punchoutURL:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000001445b5
- (void)installAppWithPunchoutURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000001444d7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000144410
- (unsigned long long)hash;	// IMP=0x00000000001443a2
- (id)initWithChannelDetails:(id)arg1 contentTitle:(id)arg2;	// IMP=0x00000000001442e6
