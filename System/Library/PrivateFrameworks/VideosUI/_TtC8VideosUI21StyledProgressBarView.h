...
- (void).cxx_destruct;	// IMP=0x00000000005dbca0
@property(nonatomic, readonly) double accessibilityProgress;
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000005da940
- (void)vui_setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x00000000005da6e0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005da690
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000005da660
