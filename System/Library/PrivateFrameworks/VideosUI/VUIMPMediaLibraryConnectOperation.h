...
- (void).cxx_destruct;	// IMP=0x000000000027dceb
...
- (void)_notifyClientOfProgress:(float)arg1;	// IMP=0x000000000027dae8
- (void)_stopProgressTimer;	// IMP=0x000000000027da95
- (void)_startProgressTimer;	// IMP=0x000000000027d941
- (void)executionDidBegin;	// IMP=0x000000000027d612
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x000000000027d56d
- (id)init;	// IMP=0x000000000027d4fe
