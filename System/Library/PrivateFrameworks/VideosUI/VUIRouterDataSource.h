...
- (void).cxx_destruct;	// IMP=0x00000000000921bd
...
- (id)initWithRouterData:(id)arg1 prefetchedData:(id)arg2;	// IMP=0x0000000000092048
- (id)initWithRouterData:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000000091e98
