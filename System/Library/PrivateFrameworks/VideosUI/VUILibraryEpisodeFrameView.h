...
+ (void)configureEpisodeFrameView:(id)arg1 withMedia:(id)arg2 layout:(long long)arg3 imageSize:(struct CGSize)arg4;	// IMP=0x00000000001979cf
- (void).cxx_destruct;	// IMP=0x000000000019922c
...
- (void)_playButtonPressed;	// IMP=0x000000000019913c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001990d5
- (void)layoutSubviews;	// IMP=0x0000000000198d52
