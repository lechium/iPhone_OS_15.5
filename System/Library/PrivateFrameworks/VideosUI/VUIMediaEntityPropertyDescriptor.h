...
+ (id)_classNameFromPropertyType:(unsigned long long)arg1;	// IMP=0x00000000002086e0
- (void).cxx_destruct;	// IMP=0x00000000002088e4
...
- (void)_updateSourceSupportsFiltering;	// IMP=0x00000000002087a4
- (id)description;	// IMP=0x00000000002080ba
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000207fcb
- (id)init;	// IMP=0x0000000000207c88
