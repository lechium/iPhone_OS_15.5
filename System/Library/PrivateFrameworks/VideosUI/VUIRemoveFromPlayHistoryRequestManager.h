...
+ (id)sharedInstance;	// IMP=0x0000000000115b20
- (void).cxx_destruct;	// IMP=0x00000000001160be
...
- (void)sendRequestForDeleteID:(id)arg1 isContinueWatching:(_Bool)arg2;	// IMP=0x0000000000115c2c
- (id)init;	// IMP=0x0000000000115beb
- (id)_init;	// IMP=0x0000000000115b85
