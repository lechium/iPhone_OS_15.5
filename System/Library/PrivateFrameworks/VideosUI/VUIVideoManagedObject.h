...
+ (id)keyPathsForValuesAffectingExpirationDate;	// IMP=0x00000000002190a6
+ (id)keyPathsForValuesAffectingLocalPlaybackURL;	// IMP=0x0000000000219086
+ (id)fetchRequest;	// IMP=0x00000000002e2c45
