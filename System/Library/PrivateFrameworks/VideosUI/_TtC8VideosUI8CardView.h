...
- (void).cxx_destruct;	// IMP=0x00000000003b4eb0
...
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000003b8780
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000003b4f70
@property(nonatomic, readonly) _Bool vuiDebugUI;
- (void)dealloc;	// IMP=0x00000000003b4e10
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003b4d40
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000003b4d10
