...
+ (id)overlayViewFromMediaItem:(id)arg1 overlayType:(long long)arg2 existingView:(id)arg3;	// IMP=0x0000000000030966
- (void).cxx_destruct;	// IMP=0x000000000003253f
...
- (struct UIEdgeInsets)_overlayPadding;	// IMP=0x0000000000032430
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000031458
