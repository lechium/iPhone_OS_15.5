...
- (void).cxx_destruct;	// IMP=0x000000000007f8c1
...
- (void)_freeBuffers;	// IMP=0x000000000007f80d
- (void)_compute;	// IMP=0x000000000007ebde
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x000000000007eb40
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x000000000007eb05
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x000000000007eaca
- (void)dealloc;	// IMP=0x000000000007ea8c
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x000000000007ea18
