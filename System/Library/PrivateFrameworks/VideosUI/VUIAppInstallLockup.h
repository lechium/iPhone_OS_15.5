...
- (void).cxx_destruct;	// IMP=0x00000000001d591e
...
- (id)_textColorForDarkMode;	// IMP=0x00000000001d57ec
- (void)_configureLabels;	// IMP=0x00000000001d544f
- (void)_configureAgeRatingBadge;	// IMP=0x00000000001d525a
- (_Bool)canBecomeFocused;	// IMP=0x00000000001d5213
@property(readonly, nonatomic) VUIAppInstallView *installView;
- (void)_layoutForIos;	// IMP=0x00000000001d49ed
- (void)_layoutForTvos;	// IMP=0x00000000001d449f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001d422a
