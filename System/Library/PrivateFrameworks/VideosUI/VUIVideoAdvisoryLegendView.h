...
- (void).cxx_destruct;	// IMP=0x0000000000103173
...
- (void)layoutSubviews;	// IMP=0x00000000001026ed
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000010266a
- (struct CGSize)legendNameSizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001024eb
- (id)initWithLayout:(id)arg1;	// IMP=0x0000000000102466
