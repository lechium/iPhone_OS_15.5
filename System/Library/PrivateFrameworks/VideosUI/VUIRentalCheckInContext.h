...
- (void).cxx_destruct;	// IMP=0x000000000025801b
...
- (unsigned long long)hash;	// IMP=0x0000000000257f7a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000257e21
- (id)initWithRentalID:(id)arg1 dsid:(id)arg2;	// IMP=0x0000000000257d88
