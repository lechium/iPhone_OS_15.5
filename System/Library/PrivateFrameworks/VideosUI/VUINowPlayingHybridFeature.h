...
- (void).cxx_destruct;	// IMP=0x000000000002e38f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002e1f0
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1 startTime:(double)arg2 duration:(double)arg3;	// IMP=0x000000000002e01f
- (id)init;	// IMP=0x000000000002dffb
