...
- (struct CGRect)lastItemFrame;	// IMP=0x000000000007bbad
- (struct CGRect)firstItemFrame;	// IMP=0x000000000007bb82
- (void)setItemFrame:(struct CGRect)arg1 atIndex:(long long)arg2;	// IMP=0x000000000007bb63
- (struct CGRect)itemFrameAtIndex:(long long)arg1;	// IMP=0x000000000007bb42
- (void)dealloc;	// IMP=0x000000000007bab8
