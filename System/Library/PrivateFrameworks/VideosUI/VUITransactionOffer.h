...
- (void).cxx_destruct;	// IMP=0x00000000002b842b
...
- (id)getCanonicalID;	// IMP=0x00000000002b8349
@property(readonly, nonatomic) NSArray *videosPlayables;
- (id)notificationBody;	// IMP=0x00000000002b831e
- (id)notificationTitle;	// IMP=0x00000000002b8301
@property(readonly, nonatomic) NSString *title;
@property(readonly, nonatomic) NSString *buyParams;
@property(readonly, nonatomic) _Bool playWhenDone;
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000002b804a
