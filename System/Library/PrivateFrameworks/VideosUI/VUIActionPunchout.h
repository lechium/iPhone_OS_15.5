...
- (void).cxx_destruct;	// IMP=0x0000000000271683
...
- (_Bool)isAccountRequired;	// IMP=0x00000000002714d6
- (_Bool)_isValidAppInstalled;	// IMP=0x0000000000271204
- (void)_openPunchoutURL:(CDUnknownBlockType)arg1;	// IMP=0x00000000002708d6
- (void)_showErrorMessageAlert:(id)arg1;	// IMP=0x000000000027037d
- (void)_openAirplayPicker:(CDUnknownBlockType)arg1;	// IMP=0x000000000027009d
- (void)_startAppInstallFlow:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000026fc06
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000026f798
- (_Bool)canPerformNow;	// IMP=0x000000000026f761
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x000000000026f43a
