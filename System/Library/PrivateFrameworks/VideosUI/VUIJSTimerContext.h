...
- (void).cxx_destruct;	// IMP=0x00000000000d329a
...
- (void)dealloc;	// IMP=0x00000000000d3229
- (void)removeManagedReferences;	// IMP=0x00000000000d30f6
- (id)description;	// IMP=0x00000000000d3074
- (id)initWithCallback:(id)arg1 callbackArgs:(id)arg2 repeating:(_Bool)arg3 ownerObject:(id)arg4 timer:(id)arg5;	// IMP=0x00000000000d2ebd
