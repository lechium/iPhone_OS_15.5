...
- (void)vui_prepareForReuse;	// IMP=0x000000000006b711
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000006a3bd
- (void)vui_setHighlighted:(_Bool)arg1;	// IMP=0x000000000006a35b
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000006a310
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x000000000006a28a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000069f03
