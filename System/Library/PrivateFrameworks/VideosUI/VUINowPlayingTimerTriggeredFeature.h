...
- (void).cxx_destruct;	// IMP=0x000000000002e895
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002e731
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1 duration:(double)arg2 repeats:(_Bool)arg3;	// IMP=0x000000000002e5a4
