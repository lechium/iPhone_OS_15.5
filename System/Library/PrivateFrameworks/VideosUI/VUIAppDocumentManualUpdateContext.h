...
- (void).cxx_destruct;	// IMP=0x0000000000004a19
...
- (void)updateCurrentUpdateRequestWithAppContext:(id)arg1 documentRef:(id)arg2;	// IMP=0x000000000000485c
- (void)updateRequestCompletedWithViewElements:(id)arg1 documentRef:(id)arg2;	// IMP=0x0000000000004856
- (id)initWithContextDictionary:(id)arg1 viewElement:(id)arg2;	// IMP=0x00000000000047bd
- (id)init;	// IMP=0x000000000000474e
