...
- (void).cxx_destruct;	// IMP=0x0000000000100d38
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000100a58
- (id)initWithContextData:(id)arg1 sourceView:(id)arg2;	// IMP=0x00000000001007ec
