...
- (void).cxx_destruct;	// IMP=0x0000000000019c71
...
- (void)prepareForReuse;	// IMP=0x00000000000199b6
- (void)layoutSubviews;	// IMP=0x000000000001924c
@property(copy, nonatomic) UIImage *tabImage;
- (void)setSubhead3LabelColor:(id)arg1;	// IMP=0x000000000001918d
- (void)setSubhead2LabelColor:(id)arg1;	// IMP=0x0000000000019170
- (void)setSubhead1LabelColor:(id)arg1;	// IMP=0x0000000000019153
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000018866
