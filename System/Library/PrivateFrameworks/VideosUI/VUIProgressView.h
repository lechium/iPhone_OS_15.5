...
- (void).cxx_destruct;	// IMP=0x000000000027c739
...
- (void)_updateForStyleChange;	// IMP=0x000000000027c4ac
- (id)_maskImageForProgressBar;	// IMP=0x000000000027c2e1
- (void)_layoutMaterialView;	// IMP=0x000000000027c1d0
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000000027bd15
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000027b9b7
- (void)layoutSubviews;	// IMP=0x000000000027b685
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000027b3b0
