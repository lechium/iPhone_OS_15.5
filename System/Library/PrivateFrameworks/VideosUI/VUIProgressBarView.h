...
- (void).cxx_destruct;	// IMP=0x000000000027cfd3
...
- (void)setgradientEndColor:(id)arg1;	// IMP=0x000000000027cd9c
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000027c821
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000027c7bf
