...
- (void).cxx_destruct;	// IMP=0x0000000000107b1f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000107a17
...
- (id)initWithVideoManagedObject:(id)arg1 imageType:(unsigned long long)arg2;	// IMP=0x0000000000107498
