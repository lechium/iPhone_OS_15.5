...
- (void).cxx_destruct;	// IMP=0x0000000000173636
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000173304
- (id)initWithShadowImages:(_Bool)arg1;	// IMP=0x00000000001731cd
- (id)initWithStyle:(long long)arg1;	// IMP=0x0000000000172e85
