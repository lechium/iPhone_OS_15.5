...
- (void).cxx_destruct;	// IMP=0x00000000000fc51d
...
- (struct CGSize)_calculateMetricsOfScorecard;	// IMP=0x00000000000fb66d
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000000fadef
- (void)_calculateColumnSpacing;	// IMP=0x00000000000fab44
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000fab05
- (void)invalidateData;	// IMP=0x00000000000faa9d
