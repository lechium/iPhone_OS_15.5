...
- (void).cxx_destruct;	// IMP=0x0000000000024c42
...
- (void)layoutSubviews;	// IMP=0x00000000000249b8
- (void)configureHeaderViewWithTitle:(id)arg1;	// IMP=0x000000000002497d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000002478c
