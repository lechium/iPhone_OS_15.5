...
- (void).cxx_destruct;	// IMP=0x000000000008d4fb
...
- (unsigned long long)preferedMonogramType;	// IMP=0x000000000008d0ed
- (unsigned long long)hash;	// IMP=0x000000000008cfa3
- (struct CGPoint)specialOffsetForString:(id)arg1;	// IMP=0x000000000008cea6
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008c0bb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008bd19
- (id)copyWithType:(unsigned long long)arg1;	// IMP=0x000000000008bc6d
- (id)init;	// IMP=0x000000000008bc51
- (id)initWithFirstName:(id)arg1 lastName:(id)arg2 imageURL:(id)arg3 font:(id)arg4;	// IMP=0x000000000008bad7
