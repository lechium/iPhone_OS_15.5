...
+ (id)itnAlignmentWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000000f866
+ (id)itnAlignment;	// IMP=0x000000000000f854
...
- (id)encodedClassName;	// IMP=0x000000000000f847
- (id)groupIdentifier;	// IMP=0x000000000000f833
