...
+ (id)infoWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000013e4b
+ (id)info;	// IMP=0x0000000000013e39
...
- (id)encodedClassName;	// IMP=0x0000000000013e2c
- (id)groupIdentifier;	// IMP=0x0000000000013e18
