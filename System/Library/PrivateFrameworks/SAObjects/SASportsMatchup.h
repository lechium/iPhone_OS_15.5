...
+ (id)matchupWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000002126f
+ (id)matchup;	// IMP=0x000000000002125d
...
- (id)encodedClassName;	// IMP=0x0000000000021250
- (id)groupIdentifier;	// IMP=0x000000000002123c
