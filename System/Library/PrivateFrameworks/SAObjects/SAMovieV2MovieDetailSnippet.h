...
+ (id)movieDetailSnippetWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x000000000002cbec
+ (id)movieDetailSnippet;	// IMP=0x000000000002cbda
...
- (id)encodedClassName;	// IMP=0x000000000002cbcd
- (id)groupIdentifier;	// IMP=0x000000000002cbb9
