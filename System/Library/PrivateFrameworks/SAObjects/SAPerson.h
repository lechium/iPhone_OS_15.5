...
+ (id)personWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000036d95
+ (id)person;	// IMP=0x0000000000036d83
...
- (id)encodedClassName;	// IMP=0x0000000000036d76
- (id)groupIdentifier;	// IMP=0x0000000000036d62
