...
+ (id)airQualitySnippetWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000015d6a
+ (id)airQualitySnippet;	// IMP=0x0000000000015d58
...
- (id)encodedClassName;	// IMP=0x0000000000015d4b
- (id)groupIdentifier;	// IMP=0x0000000000015d37
