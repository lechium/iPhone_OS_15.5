...
+ (id)teamWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x00000000000220e6
+ (id)team;	// IMP=0x00000000000220d4
...
- (id)encodedClassName;	// IMP=0x00000000000220c7
- (id)groupIdentifier;	// IMP=0x00000000000220b3
