...
+ (id)setAssistantDataWithDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0000000000037d1e
+ (id)setAssistantData;	// IMP=0x0000000000037d0c
- (_Bool)requiresResponse;	// IMP=0x00000000000381c2
...
- (id)encodedClassName;	// IMP=0x0000000000037cff
- (id)groupIdentifier;	// IMP=0x0000000000037ceb
