...
- (void)setCapturedFromPhotoBooth:(_Bool)arg1;	// IMP=0x0000000000185381
...
- (void)setAspectRatio:(long long)arg1;	// IMP=0x0000000000184eca
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000053a88
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000053e7f
