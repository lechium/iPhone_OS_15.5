...
- (void).cxx_destruct;	// IMP=0x0000000000001589
...
- (void)dealloc;	// IMP=0x0000000000001458
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000000013fc
- (void)viewDidLoad;	// IMP=0x000000000000133b
- (id)initWithTitle:(id)arg1 message:(id)arg2;	// IMP=0x00000000000012aa
- (id)init;	// IMP=0x0000000000001209
