...
+ (_Bool)validateRequest:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000019e6
- (void).cxx_destruct;	// IMP=0x0000000000001b79
...
- (void)runWithRequest:(id)arg1;	// IMP=0x0000000000001a8b
- (id)initWithRequest:(id)arg1 enrollmentStateProvider:(id)arg2;	// IMP=0x000000000000196e
