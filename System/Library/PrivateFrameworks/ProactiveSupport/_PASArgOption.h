...
+ (id)optionWithName:(id)arg1 shortName:(id)arg2 argMetavar:(id)arg3 help:(id)arg4 required:(_Bool)arg5;	// IMP=0x00000000000299af
+ (id)optionWithName:(id)arg1 shortName:(id)arg2 argMetavar:(id)arg3 help:(id)arg4;	// IMP=0x000000000002998d
+ (id)optionWithName:(id)arg1 shortName:(id)arg2 help:(id)arg3;	// IMP=0x0000000000029975
- (void).cxx_destruct;	// IMP=0x0000000000029937
...
- (id)description;	// IMP=0x00000000000298c4
- (id)initWithName:(id)arg1 shortName:(id)arg2 argMetavar:(id)arg3 help:(id)arg4 required:(_Bool)arg5;	// IMP=0x0000000000029643
