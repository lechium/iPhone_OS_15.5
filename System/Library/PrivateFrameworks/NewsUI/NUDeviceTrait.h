...
{
    unsigned long long _deviceTraitSize;	// 8 = 0x8
}
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000016aed
- (id)initWithDeviceTraitSize:(unsigned long long)arg1;	// IMP=0x0000000000016ab0
