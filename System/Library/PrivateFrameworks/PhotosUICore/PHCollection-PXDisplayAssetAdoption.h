...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x00000000007c1eb5
@property(readonly, nonatomic) NSDictionary *px_debugDictionary;
- (_Bool)px_fetchContainsAnyAssets;	// IMP=0x00000000007c1d47
- (_Bool)px_fetchIsEmpty;	// IMP=0x00000000007c1d3f
- (id)px_fetchContainedAssetCollections;	// IMP=0x00000000007c1c82
- (id)px_fetchAncestryIncludingRoot:(_Bool)arg1;	// IMP=0x00000000007c1ada
