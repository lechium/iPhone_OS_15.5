...
+ (id)sharedToggledOffBadgeTheme;	// IMP=0x00000000009cf23e
+ (id)sharedToggledOnBadgeTheme;	// IMP=0x00000000009cf20e
- (void).cxx_destruct;	// IMP=0x00000000009cf180
...
- (id)init;	// IMP=0x00000000009cf05e
- (id)initWithIsToggledOn:(_Bool)arg1;	// IMP=0x00000000009cee16
