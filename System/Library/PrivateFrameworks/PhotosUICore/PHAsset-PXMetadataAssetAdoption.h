...
+ (id)addressWithoutUnitedStatesZipCode:(id)arg1;	// IMP=0x000000000037c3a3
+ (id)px_orderedAssetsFromAssets:(id)arg1 sortDescriptors:(id)arg2;	// IMP=0x000000000037c14c
+ (id)px_fetchPlacesAssetsInAssetCollection:(id)arg1 options:(id)arg2;	// IMP=0x000000000037be69
+ (id)px_fetchAssetsInArray:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x000000000037bdb7
@property(readonly, nonatomic) struct CGPoint positionOffset;
@property(readonly, nonatomic) struct CGAffineTransform transform;
- (float)px_playbackScore;	// IMP=0x000000000010a7a4
- (double)weightUsingWeightingScheme:(long long)arg1;	// IMP=0x000000000010a512
- (double)weightUsingCriterion:(long long)arg1;	// IMP=0x000000000010a4bb
@property(readonly, nonatomic) double weight;
@property(readonly, nonatomic) struct CGSize size;
- (_Bool)px_isRecommendationSeenForVariationType:(long long)arg1;	// IMP=0x00000000002be744
- (_Bool)px_isVariationTypeRecommended:(long long)arg1;	// IMP=0x00000000002be606
- (id)_userFeedbackScoreInfo;	// IMP=0x000000000037b184
- (id)_imageProcessingFlags;	// IMP=0x000000000037aee0
@property(readonly, nonatomic) _Bool px_shotWithNightMode;
- (id)_videoDeferredProcessingNeededString:(unsigned short)arg1;	// IMP=0x000000000037ae24
- (id)_deferredProcessingStringWithEnum:(unsigned short)arg1;	// IMP=0x000000000037ad9a
- (id)_junkClassificationStringWithClassifications:(id)arg1;	// IMP=0x000000000037a801
- (id)_sdClassificationStringWithClassifications:(id)arg1;	// IMP=0x000000000037a612
- (id)_sceneClassificationStringWithClassifications:(id)arg1;	// IMP=0x000000000037a036
- (id)_ocrStrings;	// IMP=0x000000000037a029
- (id)stringMinutesTimeRangeFromTimeRange:(CDStruct_e83c9415)arg1;	// IMP=0x0000000000379f32
@property(readonly, nonatomic) PXDebugValueList *px_curationDebugValues;
- (id)px_detailedDebugDescriptionInLibrary:(id)arg1;	// IMP=0x0000000000377fa8
@property(readonly, nonatomic) NSAttributedString *px_curationDebugString;
- (id)px_slHighlightWithError:(id *)arg1;	// IMP=0x000000000037746d
...
- (id)px_singleLineMailingAddress;	// IMP=0x0000000000376fbe
...
- (id)applyAdjustmentsToCompositionController:(id)arg1 renderer:(id)arg2;	// IMP=0x000000000059857a
...
- (struct CGRect)bestCropRectForAspectRatioV2:(double)arg1 verticalContentMode:(long long)arg2 cropMode:(long long)arg3;	// IMP=0x0000000000598295
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1 verticalContentMode:(long long)arg2 cropMode:(long long)arg3;	// IMP=0x0000000000597fcb
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1;	// IMP=0x0000000000597fa4
@property(readonly, nonatomic) unsigned long long thumbnailVersion;
- (long long)isContentEqualTo:(id)arg1;	// IMP=0x0000000000597eb8
@property(readonly, nonatomic) Class defaultImageProviderClass;
- (id)localizedDetailedGeoDescriptionForRTL:(_Bool)arg1;	// IMP=0x0000000000597cc8
@property(readonly, nonatomic) NSString *localizedGeoDescription;
@property(readonly, nonatomic) struct CGRect faceAreaRect;
@property(readonly, nonatomic) _Bool isInCloud;
- (id)_faceNamesStringForAsset;	// IMP=0x00000000006673d4
- (id)px_accessibilityLabelForStyles:(unsigned long long)arg1;	// IMP=0x0000000000666f4b
@property(readonly, nonatomic) _Bool requiresConfidentiality;
- (_Bool)px_isSupportedApp:(id)arg1;	// IMP=0x00000000007c65d9
...
- (id)_px_currentRAWResource;	// IMP=0x00000000007d969d
