...
+ (id)_globalCache;	// IMP=0x000000000053406c
+ (id)_locationFromImageProperties:(id)arg1;	// IMP=0x0000000000533e42
+ (id)_creationDateFromImageProperties:(id)arg1;	// IMP=0x0000000000533ccc
+ (id)_exifDateFormatter;	// IMP=0x0000000000533c9c
- (void).cxx_destruct;	// IMP=0x0000000000533c53
...
- (void)_loadFileMetadataIfNeeded;	// IMP=0x00000000005337d9
@property(readonly, nonatomic) CLLocation *location;
@property(readonly, nonatomic) NSDate *localCreationDate;
@property(readonly, nonatomic) NSDate *creationDate;
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1;	// IMP=0x0000000000533686
...
- (double)weightUsingCriterion:(long long)arg1;	// IMP=0x00000000005334c3
@property(readonly, nonatomic) double weight;
@property(readonly, nonatomic) NSString *uuid;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005333d5
- (_Bool)isEqualToFileBackedAsset:(id)arg1;	// IMP=0x0000000000533344
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000533339
- (long long)isContentEqualTo:(id)arg1;	// IMP=0x000000000053332e
...
- (id)initWithURL:(id)arg1;	// IMP=0x0000000000532ebb
- (id)initWithDescription:(id)arg1;	// IMP=0x0000000000532d8c
- (id)init;	// IMP=0x0000000000532d12
