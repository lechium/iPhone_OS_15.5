...
- (void)enumerateClipsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000010407e
- (id)clipAtIndex:(long long)arg1;	// IMP=0x0000000000104005
- (id)clipForDisplayAsset:(id)arg1;	// IMP=0x0000000000103ffd
- (id)initWithSong:(id)arg1;	// IMP=0x0000000000103ecb
- (id)init;	// IMP=0x0000000000103eb7
