...
+ (void)px_loadRepresentativeFacesForPersons:(id)arg1;	// IMP=0x0000000000014f0f
...
- (void)requestFaceTileImageWithTargetSize:(struct CGSize)arg1 cropFactor:(unsigned long long)arg2 style:(unsigned long long)arg3 cacheResult:(_Bool)arg4 boundFaceRect:(_Bool)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x0000000000014a23
