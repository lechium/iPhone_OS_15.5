...
- (id)description;	// IMP=0x0000000000980874
- (double)valueAtTime:(double)arg1;	// IMP=0x0000000000980759
- (id)initWithMass:(double)arg1 stiffness:(double)arg2 damping:(double)arg3 initialVelocity:(double)arg4;	// IMP=0x000000000097fa72
