...
- (void).cxx_destruct;	// IMP=0x00000000004ef6a9
...
- (void)animateAlongsideTransition:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000004ef431
@property(readonly, nonatomic) PXBasicTileAnimationOptions *animationOptions;
@property(readonly, nonatomic) UIView *view;
- (void)didApplyGeometry:(struct PXTileGeometry)arg1 withUserData:(id)arg2;	// IMP=0x00000000004ef2c1
- (void)_didCompleteTileAnimationWithContext:(id)arg1;	// IMP=0x00000000004ef246
- (void)_didAnimateTileWithContext:(id)arg1;	// IMP=0x00000000004ef232
- (id)_willAnimateTileToGeometry:(struct PXTileGeometry)arg1 withOptions:(id)arg2;	// IMP=0x00000000004ef0ae
- (void)_embedContentView;	// IMP=0x00000000004eef7f
- (id)initWithWidget:(id)arg1;	// IMP=0x00000000004eeefa
