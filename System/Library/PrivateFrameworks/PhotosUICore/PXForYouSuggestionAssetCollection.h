...
- (void).cxx_destruct;	// IMP=0x000000000087d666
...
- (id)localizedDateDescriptionWithOptions:(unsigned long long)arg1;	// IMP=0x000000000087d4e6
@property(readonly, nonatomic) NSString *uuid;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000087d467
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 startDate:(id)arg3 endDate:(id)arg4;	// IMP=0x000000000087d391
- (id)init;	// IMP=0x000000000087d317
