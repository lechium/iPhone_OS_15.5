...
+ (id)pointWithX:(double)arg1 y:(double)arg2;	// IMP=0x00000000005d1d1c
+ (id)pointWithCGPoint:(struct CGPoint)arg1;	// IMP=0x00000000005d1d0a
...
- (id)initWithX:(double)arg1 y:(double)arg2;	// IMP=0x00000000005d1b72
