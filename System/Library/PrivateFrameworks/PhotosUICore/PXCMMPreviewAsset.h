...
- (void).cxx_destruct;	// IMP=0x00000000006846ae
...
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1 verticalContentMode:(long long)arg2 cropMode:(long long)arg3;	// IMP=0x0000000000684402
@property(readonly, nonatomic) double aspectRatio;
- (struct CGSize)size;	// IMP=0x0000000000684309
- (struct CGRect)bestCropRectForAspectRatio:(double)arg1;	// IMP=0x00000000006842e2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006840aa
- (long long)isContentEqualTo:(id)arg1;	// IMP=0x0000000000683fc3
...
- (id)init;	// IMP=0x0000000000683e0a
- (id)initWithMomentShare:(id)arg1 underlyingAsset:(id)arg2;	// IMP=0x0000000000683d71
