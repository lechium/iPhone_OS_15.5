...
- (void).cxx_destruct;	// IMP=0x00000000000ef3bc
- (void)getVisibilityWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ef196
@property(readonly, copy, nonatomic) NSString *extensionIdentifier;
- (id)init;	// IMP=0x00000000000ef119
