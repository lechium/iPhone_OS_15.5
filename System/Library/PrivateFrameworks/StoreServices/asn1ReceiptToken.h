...
+ (id)readFromBuffer:(const char *)arg1;	// IMP=0x00000000001660c7
...
- (id)description;	// IMP=0x0000000000166291
- (void)dealloc;	// IMP=0x000000000016608c
- (id)_initWithType:(unsigned long long)arg1 typeVersion:(unsigned long long)arg2 contentToken:(id)arg3;	// IMP=0x0000000000166026
