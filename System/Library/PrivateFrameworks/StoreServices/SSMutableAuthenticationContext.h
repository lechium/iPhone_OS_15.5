...
- (void)setValuesWithAccount:(id)arg1;	// IMP=0x0000000000060c62
...
- (void)setValue:(id)arg1 forHTTPHeaderField:(id)arg2;	// IMP=0x00000000000609db
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000060444
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000603cd
