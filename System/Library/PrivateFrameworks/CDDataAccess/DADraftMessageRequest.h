...
- (void).cxx_destruct;	// IMP=0x0000000000013741
...
- (id)description;	// IMP=0x000000000001362b
- (id)initWithRequestType:(int)arg1 message:(id)arg2 send:(_Bool)arg3;	// IMP=0x000000000001358c
