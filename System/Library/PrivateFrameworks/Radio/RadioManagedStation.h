...
+ (id)defaultPropertiesToFetch;	// IMP=0x0000000000001b06
...
- (void)setStreamKeyURL:(id)arg1;	// IMP=0x00000000000044b5
- (void)setStreamCertificateURL:(id)arg1;	// IMP=0x00000000000043c7
...
- (id)additionalReferencedTrackDescriptors;	// IMP=0x0000000000001bf9
