...
- (void).cxx_destruct;	// IMP=0x0000000000061887
...
- (id)initWithContactLabeledValue:(id)arg1 type:(long long)arg2;	// IMP=0x0000000000061712
- (id)glyphName;	// IMP=0x00000000000616d4
