...
- (void).cxx_destruct;	// IMP=0x000000000008518f
...
- (int)analyticsModuleType;	// IMP=0x0000000000085134
- (id)analyticsModule;	// IMP=0x0000000000085117
- (id)infoCardChildUnactionableUIElements;	// IMP=0x00000000000850fa
- (id)infoCardChildPossibleActions;	// IMP=0x00000000000850dd
@property(nonatomic) __weak id <MUInfoCardAnalyticsDelegate> analyticsDelegate;
- (void)headerButtonsSectionControllerWillPresentMenu:(id)arg1;	// IMP=0x0000000000085087
- (void)headerButtonsSectionController:(id)arg1 didSelectPrimaryType:(unsigned long long)arg2 withPresentationOptions:(id)arg3;	// IMP=0x000000000008500c
- (void)headerButtonsSectionControllerDidUpdateContent:(id)arg1;	// IMP=0x0000000000084fc0
...
- (id)initWithPlaceItem:(id)arg1 configuration:(id)arg2;	// IMP=0x00000000000849d7
