...
+ (Class)eaProtocolStringsType;	// IMP=0x0000000000006494
- (void).cxx_destruct;	// IMP=0x000000000000641f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000005bbc
- (unsigned long long)hash;	// IMP=0x0000000000004fb5
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000486e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000041e8
- (void)copyTo:(id)arg1;	// IMP=0x0000000000003d5b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000003808
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000002823
- (id)dictionaryRepresentation;	// IMP=0x0000000000001d8a
- (id)description;	// IMP=0x0000000000001cdb
...
- (id)eaProtocolStringsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000001c1f
- (unsigned long long)eaProtocolStringsCount;	// IMP=0x0000000000001c02
- (void)addEaProtocolStrings:(id)arg1;	// IMP=0x0000000000001b98
- (void)clearEaProtocolStrings;	// IMP=0x0000000000001b7b
