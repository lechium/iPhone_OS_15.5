...
+ (id)wrapperWithURL:(id)arg1 delegate:(id)arg2 settingsID:(long long)arg3 connections:(id)arg4;	// IMP=0x000000000000307b
...
- (void)dealloc;	// IMP=0x0000000000003177
- (id)initWithURL:(id)arg1 delegate:(id)arg2 settingsID:(long long)arg3 connections:(id)arg4;	// IMP=0x00000000000030cb
