...
- (id)uniqueVideoPreviewLayers:(id)arg1;	// IMP=0x000000000007ad5e
- (id)uniqueConnections:(id)arg1;	// IMP=0x000000000007ace6
- (id)uniqueOutputs:(id)arg1;	// IMP=0x000000000007ac6e
- (id)uniqueInputs:(id)arg1;	// IMP=0x000000000007abf6
- (void)dealloc;	// IMP=0x000000000007ab9e
- (id)initWithConfigurationID:(long long)arg1 inputs:(id)arg2 outputs:(id)arg3 videoPreviewLayers:(id)arg4 connections:(id)arg5;	// IMP=0x000000000007aafa
