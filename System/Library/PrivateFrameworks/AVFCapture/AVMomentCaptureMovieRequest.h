...
+ (id)requestWithDelegate:(id)arg1 movieRecordingSettings:(id)arg2 momentSettings:(id)arg3;	// IMP=0x00000000000444c2
...
- (void)dealloc;	// IMP=0x00000000000445c6
- (id)_initWithDelegate:(id)arg1 movieRecordingSettings:(id)arg2 momentSettings:(id)arg3;	// IMP=0x000000000004450d
