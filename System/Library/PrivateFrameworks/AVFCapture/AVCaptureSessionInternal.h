...
@interface AVCaptureSessionInternal : NSObject
{
    ...
    struct OpaqueCMClock *synchronizationClock;	// 152 = 0x98
    _Bool notifiesOnMainThread;	// 160 = 0xa0
    NSMutableArray *devicesToResetVideoZoomFactorAndMinMaxFrameDurations;	// 168 = 0xa8
    _Bool authorizedToUseCameraInMultipleForegroundAppLayout;	// 176 = 0xb0
    _Bool xctestAuthorizedToStealDevice;	// 177 = 0xb1
    struct OpaqueFigReentrantMutex *figCaptureSourceConfigChangeCacheMutex;	// 184 = 0xb8
}
