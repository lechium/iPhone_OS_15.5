...
+ (id)prepareBracketRequestWithCompletionBlock:(CDUnknownBlockType)arg1 settings:(id)arg2;	// IMP=0x000000000003f21d
...
- (void)dealloc;	// IMP=0x000000000003f2c4
- (id)_initWithCompletionBlock:(CDUnknownBlockType)arg1 settings:(id)arg2;	// IMP=0x000000000003f259
