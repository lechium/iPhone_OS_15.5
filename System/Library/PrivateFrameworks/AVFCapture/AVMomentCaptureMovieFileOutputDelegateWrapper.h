...
+ (id)wrapperWithSettings:(id)arg1 delegate:(id)arg2 connections:(id)arg3;	// IMP=0x0000000000003268
...
- (void)dealloc;	// IMP=0x000000000000340e
- (id)initWithSettings:(id)arg1 delegate:(id)arg2 connections:(id)arg3;	// IMP=0x00000000000032b3
