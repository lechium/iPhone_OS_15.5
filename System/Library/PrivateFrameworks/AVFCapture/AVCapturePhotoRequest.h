...
+ (id)requestWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x00000000000368ae
+ (void)initialize;	// IMP=0x000000000003689d
...
- (void)_resolveExpectedPhotoManifest;	// IMP=0x0000000000036b16
...
- (void)dealloc;	// IMP=0x00000000000369f8
- (id)initWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x00000000000368f9
