...
+ (id)preparedPhotoSettingsArrayRequestWithArray:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000026254
...
- (void)_setRequestID:(unsigned long long)arg1;	// IMP=0x0000000000026384
@property(readonly) unsigned long long requestID;
- (void)dealloc;	// IMP=0x0000000000026330
- (id)_initWithArray:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000026290
