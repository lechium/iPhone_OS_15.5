...
+ (id)queryWithSearchString:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000c6dd
+ (void)invalidateCaches;	// IMP=0x000000000000c5db
+ (id)queryWithSearchCompletion:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000c565
+ (id)queryWithCoordinate:(struct CLLocationCoordinate2D)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000c4d9
+ (id)queryWithDictionaryRepresentation:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000c163
- (void).cxx_destruct;	// IMP=0x000000000000df43
...
- (void)_handleErrorResponse:(id)arg1;	// IMP=0x000000000000dc27
- (void)handleSearchResponseWithLocation:(id)arg1;	// IMP=0x000000000000da71
- (id)_reverseGeocoderLocation;	// IMP=0x000000000000d9ef
- (id)_mkLocalSearchRequest;	// IMP=0x000000000000d8ec
- (_Bool)isLocationValid:(id)arg1;	// IMP=0x000000000000d74b
- (void)_startCLGeocoderReverseGeo;	// IMP=0x000000000000d05a
- (void)_startMKLocalSearch;	// IMP=0x000000000000cae2
- (void)cancel;	// IMP=0x000000000000ca69
- (void)start;	// IMP=0x000000000000c99f
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000c88f
- (id)initWithSearchString:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000c753
- (id)initWithSearchCompletion:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000c5e1
