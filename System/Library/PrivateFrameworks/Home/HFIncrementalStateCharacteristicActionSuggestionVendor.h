...
- (void).cxx_destruct;	// IMP=0x00000000002012b9
@property(readonly, copy, nonatomic) NSString *characteristicType; // @synthesize characteristicType=_characteristicType;
- (id)suggestedActionForCharacteristic:(id)arg1 candidateActions:(id)arg2;	// IMP=0x0000000000200f66
- (id)initWithCharacteristicType:(id)arg1;	// IMP=0x0000000000200efb
