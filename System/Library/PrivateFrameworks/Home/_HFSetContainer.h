...
+ (id)containerWithObject:(id)arg1 atIndex:(unsigned long long)arg2 comparator:(CDUnknownBlockType)arg3 hashGenerator:(CDUnknownBlockType)arg4;	// IMP=0x000000000026a4cb
- (void).cxx_destruct;	// IMP=0x000000000026a7f0
...
- (unsigned long long)hash;	// IMP=0x000000000026a6ca
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000026a597
