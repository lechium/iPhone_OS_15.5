...
+ (unsigned long long)hf_cameraAccessModeSelectedOptionForCameraProfiles:(id)arg1 presenceType:(unsigned long long)arg2;	// IMP=0x000000000010c5ba
- (id)hf_faceCropImageForSignificantEvent:(id)arg1;	// IMP=0x000000000010cd0f
- (id)hf_significantEventWithIdentifier:(id)arg1;	// IMP=0x000000000010c928
- (void)hf_updateDoorbellChime:(_Bool)arg1;	// IMP=0x000000000010c369
...
- (id)hf_updateUserNotificationSettings:(id)arg1;	// IMP=0x00000000001e0952
@property(readonly, copy, nonatomic) HFUserNotificationServiceSettings *hf_userNotificationSettings;
- (id)hf_bulletinNotifications;	// IMP=0x00000000001e081b
- (id)_hf_smartDetectionBulletinNotification;	// IMP=0x00000000001e07cb
- (id)_hf_legacyMotionSensorBulletinNotification;	// IMP=0x00000000001e0747
- (id)_hf_doorbellBulletinNotification;	// IMP=0x00000000001e06c3
