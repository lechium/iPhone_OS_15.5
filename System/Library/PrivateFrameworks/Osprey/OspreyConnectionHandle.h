...
- (void).cxx_destruct;	// IMP=0x000000000000fd79
@property(readonly, nonatomic) id connectionKey; // @synthesize connectionKey=_connectionKey;
- (void)dealloc;	// IMP=0x000000000000fd2f
- (id)initWithConnectionKey:(id)arg1 willRelease:(CDUnknownBlockType)arg2;	// IMP=0x000000000000fc76
