...
- (void).cxx_destruct;	// IMP=0x0000000000003ca2
...
- (void)_skipTimerFired:(id)arg1;	// IMP=0x0000000000003a98
- (double)_nextTimeToAdvanceFromTime:(double)arg1;	// IMP=0x00000000000039b2
- (void)cancelScrub;	// IMP=0x0000000000003980
- (void)startScrubWithRate:(double)arg1;	// IMP=0x00000000000038a0
