...
- (void).cxx_destruct;	// IMP=0x00000000000150cb
...
- (double)_timeAfterRemovingInterstitials:(double)arg1;	// IMP=0x0000000000014ead
- (void)_updateImageIntervalWithRate:(double)arg1;	// IMP=0x0000000000014dd9
- (void)_cancelStaleImageLoadsForTime:(double)arg1;	// IMP=0x0000000000014ba8
- (void)_cancelAllImageLoads;	// IMP=0x0000000000014b14
- (void)_loadImagesIfNecessary;	// IMP=0x000000000001407e
- (void)_displayLinkTimerFired:(id)arg1;	// IMP=0x0000000000013c44
- (void)invalidate;	// IMP=0x0000000000013c2f
- (id)initWithMediaItem:(id)arg1 referenceTime:(CDStruct_1b6d18a9)arg2 forDate:(id)arg3;	// IMP=0x0000000000013842
