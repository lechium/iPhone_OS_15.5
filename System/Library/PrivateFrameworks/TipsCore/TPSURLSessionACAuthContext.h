...
+ (id)defaultContext;	// IMP=0x0000000000046dff
- (void).cxx_destruct;	// IMP=0x0000000000047098
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000046f30
- (id)initWithAppIdentifier:(id)arg1 enviromentIdentifier:(id)arg2 interactivity:(id)arg3;	// IMP=0x0000000000046e79
