...
+ (struct TPSURLSessionDelegateResponds)delegateRespondsWithDelegate:(id)arg1;	// IMP=0x000000000001d9c7
- (void).cxx_destruct;	// IMP=0x000000000001e0db
...
- (void)cancel;	// IMP=0x000000000001dea4
- (void)resume;	// IMP=0x000000000001de8e
- (void)unregisterDelegate:(id)arg1;	// IMP=0x000000000001dd88
- (void)registerDelegate:(id)arg1;	// IMP=0x000000000001dc89
- (void)didCompleteWithError:(id)arg1;	// IMP=0x000000000001da95
@property(nonatomic) float priority; // @dynamic priority;
@property(readonly, nonatomic) NSURL *URL;
- (id)initWithSessionTask:(id)arg1 identifier:(id)arg2;	// IMP=0x000000000001d743
- (void)dealloc;	// IMP=0x000000000001d705
