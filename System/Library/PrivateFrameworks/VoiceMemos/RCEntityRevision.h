...
- (void)setRecordingID:(long long)arg1;	// IMP=0x000000000004f925
@property(readonly, nonatomic) long long recordingID;
- (void)setRevisionID:(long long)arg1;	// IMP=0x000000000004f819
@property(readonly, nonatomic) long long revisionID;
- (void)setRevisionType:(long long)arg1;	// IMP=0x000000000004f70d
