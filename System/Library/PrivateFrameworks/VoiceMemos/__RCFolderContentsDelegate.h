...
- (void)controllerDidChangeContent:(id)arg1;	// IMP=0x00000000000142ae
- (void)controller:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x00000000000142a8
- (void)controllerWillChangeContent:(id)arg1;	// IMP=0x00000000000142a2
