...
- (void).cxx_destruct;	// IMP=0x0000000000038254
...
- (void)operationThrottler:(id)arg1 performAsyncOperationWithCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000038083
@property _Bool suspended;
- (void)tickleWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000037f81
- (void)tickle;	// IMP=0x0000000000037f44
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000037eb3
