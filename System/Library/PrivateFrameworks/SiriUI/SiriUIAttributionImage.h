...
+ (id)attributionImageFromKey:(id)arg1 pressedKey:(id)arg2 punchOut:(id)arg3;	// IMP=0x000000000002a58f
+ (id)attributionImageWithLocalResourceName:(id)arg1 pressedResourceName:(id)arg2 localPunchOut:(id)arg3 bundle:(id)arg4;	// IMP=0x000000000002a4a9
+ (id)attributionImageFromImageResource:(id)arg1;	// IMP=0x000000000002a384
+ (id)attributionImageFromAppPunchOut:(id)arg1;	// IMP=0x000000000002a32f
- (void).cxx_destruct;	// IMP=0x000000000002b1e6
...
- (void)_fetchRemoteResourcesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000002ac15
- (id)_imageInLocalResourceBundleNamed:(id)arg1;	// IMP=0x000000000002ab88
- (void)_fetchLocalResourcesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000002aa69
- (void)getLogoWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000002a852
