...
- (void).cxx_destruct;	// IMP=0x000000000003a814
- (void)waitForReady;	// IMP=0x000000000003a7ff
- (void)setListener:(id)arg1;	// IMP=0x000000000003a31d
- (void)stopListening;	// IMP=0x000000000003a28a
- (id)initWithLayer:(void *)arg1;	// IMP=0x000000000003a226
