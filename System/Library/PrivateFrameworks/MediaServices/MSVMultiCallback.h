...
- (void).cxx_destruct;	// IMP=0x0000000000044365
@property(readonly, nonatomic) unsigned long long count;
@property(readonly, nonatomic) NSArray *callbacks;
- (void)invokeWithObject:(id)arg1;	// IMP=0x0000000000044109
- (void)invoke;	// IMP=0x0000000000043fdc
- (_Bool)removeCallback:(id)arg1;	// IMP=0x0000000000043f0e
@property(retain, nonatomic) MSVCallback *lastCallback;
@property(retain, nonatomic) MSVCallback *firstCallback;
- (void)addCallback:(id)arg1;	// IMP=0x0000000000043bf5
- (id)init;	// IMP=0x0000000000043b73
