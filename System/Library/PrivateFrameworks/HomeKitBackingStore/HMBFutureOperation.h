...
+ (id)logCategory;	// IMP=0x00000000000593d4
- (void).cxx_destruct;	// IMP=0x0000000000059306
...
- (void)main;	// IMP=0x00000000000591f4
- (void)cancelWithError:(id)arg1;	// IMP=0x0000000000059160
- (id)initWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000590c5
