...
+ (id)logCategory;	// IMP=0x00000000000403f4
- (void).cxx_destruct;	// IMP=0x0000000000040167
...
- (id)logIdentifier;	// IMP=0x0000000000040074
@property(readonly, nonatomic, getter=isZoneRebuildInProgress) _Bool zoneRebuildInProgress;
- (void)handleZoneChanged;	// IMP=0x0000000000040066
- (void)handleIdentityLost;	// IMP=0x000000000003fd44
- (id)zoneStartUp;	// IMP=0x000000000003fd2b
- (void)rebuild;	// IMP=0x000000000003fc64
- (id)initWithCloudZone:(id)arg1;	// IMP=0x000000000003fb66
