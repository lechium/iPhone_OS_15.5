...
- (void).cxx_destruct;	// IMP=0x00000000000584c2
...
- (id)nextObject;	// IMP=0x00000000000581dc
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x0000000000058116
- (id)initWithLocalZone:(id)arg1 modelID:(id)arg2;	// IMP=0x0000000000057e26
