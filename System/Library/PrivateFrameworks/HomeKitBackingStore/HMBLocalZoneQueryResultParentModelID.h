...
- (void).cxx_destruct;	// IMP=0x0000000000057a47
...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x0000000000057960
- (id)initWithLocalZone:(id)arg1 parentModelID:(id)arg2;	// IMP=0x00000000000577ea
