...
- (void).cxx_destruct;	// IMP=0x0000000000057df5
...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x0000000000057c9d
- (id)initWithLocalZone:(id)arg1 parentModelID:(id)arg2 modelClassName:(id)arg3;	// IMP=0x0000000000057a5a
