...
+ (id)saveFailedWithError:(id)arg1;	// IMP=0x000000000006163b
+ (id)emptyResult;	// IMP=0x00000000000615cd
...
- (id)initWithSuccess:(_Bool)arg1 changeEvaluation:(id)arg2 error:(id)arg3 shouldNotify:(_Bool)arg4;	// IMP=0x00000000000616c1
