...
- (void)performRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000066e35
- (void)setupWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000066bdb
- (void)invalidate;	// IMP=0x0000000000066ba9
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000669be
