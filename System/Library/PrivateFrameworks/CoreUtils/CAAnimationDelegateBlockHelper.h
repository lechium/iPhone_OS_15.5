...
- (void).cxx_destruct;	// IMP=0x000000000000f5c5
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000000000f57a
- (void)animationDidStart:(id)arg1;	// IMP=0x000000000000f567
- (void)dealloc;	// IMP=0x000000000000f50e
