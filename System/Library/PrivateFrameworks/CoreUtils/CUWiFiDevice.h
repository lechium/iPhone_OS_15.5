...
- (void).cxx_destruct;	// IMP=0x00000000000ca465
...
- (unsigned int)_updateWithDeviceIE:(const char *)arg1 end:(const char *)arg2;	// IMP=0x00000000000c9893
- (id)description;	// IMP=0x00000000000c96fc
