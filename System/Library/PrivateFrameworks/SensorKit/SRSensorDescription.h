...
@interface SRSensorDescription : NSObject
{
    ...
    NSString *_writerAuthorizationService;	// 64 = 0x40
    long long _authorizationVersion;	// 72 = 0x48
    NSString *_onDemandWriterService;	// 80 = 0x50
    NSString *_authorizationStoreCohort;	// 88 = 0x58
    NSString *_legacyName;	// 96 = 0x60
    NSString *_sampleClass;	// 104 = 0x68
    NSString *_exportingSampleClass;	// 112 = 0x70
    NSSet *_additions;	// 120 = 0x78
    NSDictionary *_supportedPlatforms;	// 128 = 0x80
}

+ (id)sensorDescriptionsForAuthorizationService:(id)arg1;	// IMP=0x000000000000f6af
+ (id)sensorDescriptionForDeletionRecordFromDescription:(id)arg1;	// IMP=0x000000000000f32b
+ (id)sensorDescriptionForSensor:(id)arg1;	// IMP=0x000000000000efd8
+ (void)initialize;	// IMP=0x000000000000ef9d
...
- (id)description;	// IMP=0x000000000000f60e
- (void)dealloc;	// IMP=0x000000000000f54b
@property(readonly) _Bool supportsCurrentPlatform;
- (_Bool)supportsPlatform:(id)arg1;	// IMP=0x000000000000f4da
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000000effe
