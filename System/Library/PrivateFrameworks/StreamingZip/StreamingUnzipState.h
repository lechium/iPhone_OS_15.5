...
+ (id)unzipStateWithPath:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000022664
- (void).cxx_destruct;	// IMP=0x00000000000229fa
...
- (id)initWithPath:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001e8f4
- (_Bool)openCurrentOutputFDForPath:(id)arg1 withOpenFlags:(int)arg2 mode:(unsigned short)arg3 error:(id *)arg4;	// IMP=0x000000000001e524
- (id)finishStream;	// IMP=0x000000000001e3fb
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long long)arg3;	// IMP=0x000000000001e3e6
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long long)arg3 onlyFinishCurrentChunk:(_Bool)arg4;	// IMP=0x000000000001e13e
- (id)checkLastChunkPartialHash;	// IMP=0x000000000001de7b
- (id)_checkHashForOffset:(unsigned long long)arg1;	// IMP=0x000000000001d7de
- (id)serializeState;	// IMP=0x000000000001ca51
- (void)markResumptionPoint;	// IMP=0x000000000001ca4b
- (void)clearSavedState;	// IMP=0x000000000001c95c
- (void)_internalSetStreamState:(unsigned char)arg1;	// IMP=0x000000000001c542
@property(readonly, nonatomic) CDStruct_4686af4b *cmpState;
- (void)dealloc;	// IMP=0x000000000001c4d7
- (id)init;	// IMP=0x000000000001c4b4
