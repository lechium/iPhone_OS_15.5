...
- (void).cxx_destruct;	// IMP=0x0000000000058c7a
...
- (void)viewTapped:(id)arg1;	// IMP=0x0000000000058b12
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x0000000000058a8f
- (void)mediaPause;	// IMP=0x00000000000589b6
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000057d79
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000057c89
- (void)viewWillLayoutSubviews;	// IMP=0x0000000000057335
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x00000000000572b0
- (void)loadView;	// IMP=0x0000000000056e8f
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000056051
