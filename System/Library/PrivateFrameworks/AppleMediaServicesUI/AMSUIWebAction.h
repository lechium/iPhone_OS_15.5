...
- (void).cxx_destruct;	// IMP=0x000000000005a6d3
...
- (id)runAction;	// IMP=0x000000000005a5b9
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000005a434
- (id)initWithContext:(id)arg1;	// IMP=0x000000000005a3c9
