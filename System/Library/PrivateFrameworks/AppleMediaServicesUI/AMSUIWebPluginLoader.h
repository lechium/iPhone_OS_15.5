...
- (void).cxx_destruct;	// IMP=0x0000000000095d60
...
- (id)_loadInstalledPlugins;	// IMP=0x00000000000959d1
- (id)pluginForBundleIdentifier:(id)arg1;	// IMP=0x0000000000095118
@property(readonly, nonatomic) NSArray *loadedPlugins;
- (id)initWithContext:(id)arg1;	// IMP=0x000000000009501f
