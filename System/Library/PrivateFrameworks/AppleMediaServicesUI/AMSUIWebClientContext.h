...
+ (id)_createClientInfoFromAccount:(id)arg1 clientInfo:(id)arg2;	// IMP=0x000000000006976d
+ (_Bool)_boolForKey:(id)arg1 defaultValue:(_Bool)arg2 domain:(struct __CFString *)arg3;	// IMP=0x0000000000069703
- (void).cxx_destruct;	// IMP=0x0000000000069d9f
...
- (void)updateBackingBag:(id)arg1;	// IMP=0x00000000000696f1
- (void)replaceCurrentAccount:(id)arg1 clientInfo:(id)arg2;	// IMP=0x00000000000690eb
- (id)loadSnapshot;	// IMP=0x0000000000068dfb
- (id)JSAccountFromAccount:(id)arg1 store:(id)arg2;	// IMP=0x0000000000068820
- (id)iTunesAccountFromJSDSID:(id)arg1;	// IMP=0x0000000000068706
- (id)iTunesAccountFromJSAccount:(id)arg1;	// IMP=0x000000000006824b
...
- (id)initWithAccount:(id)arg1 clientInfo:(id)arg2 backingBag:(id)arg3;	// IMP=0x0000000000067ff3
