...
- (void).cxx_destruct;	// IMP=0x0000000000096047
@property(nonatomic) __weak id <AMSUIWebProtocolDelegate> delegate; // @synthesize delegate=_delegate;
- (void)reconfigureNewRequest:(id)arg1 originalTask:(id)arg2 redirect:(_Bool)arg3 error:(id *)arg4;	// IMP=0x0000000000095f37
