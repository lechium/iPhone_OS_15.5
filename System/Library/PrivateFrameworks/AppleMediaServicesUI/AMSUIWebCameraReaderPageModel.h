...
- (void).cxx_destruct;	// IMP=0x00000000000650fc
...
- (id)loadPage;	// IMP=0x0000000000064f87
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000064f16
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000649dc
