...
- (void).cxx_destruct;	// IMP=0x000000000003b281
...
- (void)switchToggled:(id)arg1;	// IMP=0x000000000003b0f5
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000003ae80
