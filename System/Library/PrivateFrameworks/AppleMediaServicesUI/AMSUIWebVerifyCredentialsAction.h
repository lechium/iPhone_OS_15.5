...
+ (id)_authenticationTypeFromStringedType:(id)arg1;	// IMP=0x000000000009f94b
+ (long long)_serviceTypeFromType:(long long)arg1;	// IMP=0x000000000009f7f0
- (void).cxx_destruct;	// IMP=0x000000000009fac0
...
- (id)runAction;	// IMP=0x000000000009f2f5
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000009eab5
