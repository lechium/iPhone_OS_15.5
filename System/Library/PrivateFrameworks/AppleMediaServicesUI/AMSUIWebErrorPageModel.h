...
+ (id)_messageFromError:(id)arg1;	// IMP=0x0000000000072006
- (void).cxx_destruct;	// IMP=0x00000000000722fb
...
- (id)loadPage;	// IMP=0x0000000000071fed
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000071f7c
@property(readonly, nonatomic) NSString *errorMessage; // @synthesize errorMessage=_errorMessage;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000071b83
- (id)initWithError:(id)arg1 context:(id)arg2 actionBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000071813
