...
+ (id)resultFromURL:(id)arg1 error:(id)arg2;	// IMP=0x000000000008e5de
- (void).cxx_destruct;	// IMP=0x000000000008f0ab
...
- (_Bool)_presentViewContoller:(id)arg1;	// IMP=0x000000000008ee3d
- (id)runAction;	// IMP=0x000000000008e72c
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000008e3e2
