...
+ (id)timeoutWithTimeout:(double)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000000007bfd3
- (void).cxx_destruct;	// IMP=0x000000000007c80e
...
- (void)reset;	// IMP=0x000000000007c64a
- (void)pause;	// IMP=0x000000000007c40e
- (void)start;	// IMP=0x000000000007c05b
- (id)initWithTimeout:(double)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000000007bf1c
