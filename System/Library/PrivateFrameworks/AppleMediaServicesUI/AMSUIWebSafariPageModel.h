...
- (void).cxx_destruct;	// IMP=0x0000000000097681
...
- (id)loadPage;	// IMP=0x0000000000097538
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000097378
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000096eb0
