...
- (void).cxx_destruct;	// IMP=0x0000000000064989
...
- (id)_createLabelWithLines:(long long)arg1 title:(_Bool)arg2;	// IMP=0x0000000000064818
- (id)_createButtonWithTarget:(id)arg1 selector:(SEL)arg2;	// IMP=0x000000000006465f
- (void)_bottomLinkSelected:(id)arg1;	// IMP=0x000000000006461a
- (void)layoutSubviews;	// IMP=0x0000000000064102
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000063f37
