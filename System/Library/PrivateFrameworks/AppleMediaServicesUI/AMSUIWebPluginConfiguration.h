...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000094fec
- (void).cxx_destruct;	// IMP=0x000000000009500f
@property(retain, nonatomic) NSString *logKey; // @synthesize logKey=_logKey;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000094f73
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000094ee2
