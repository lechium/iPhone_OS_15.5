...
- (void).cxx_destruct;	// IMP=0x000000000008bf47
...
- (id)_createSession;	// IMP=0x000000000008bc53
- (id)runAction;	// IMP=0x000000000008a940
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000008a2cd
