...
- (void).cxx_destruct;	// IMP=0x0000000000085065
...
- (id)loadPage;	// IMP=0x0000000000084fc4
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000084f37
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000084cc8
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000084c5d
