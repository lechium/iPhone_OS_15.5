...
- (_Bool)_isFamilyCircleFresh:(id)arg1;	// IMP=0x000000000000cedb
- (_Bool)isFamilyCircleFresh;	// IMP=0x000000000000ce81
- (id)familyCircleValidatingAgeWithDate:(id)arg1;	// IMP=0x000000000000ce3d
- (id)familyCircleIfFresh;	// IMP=0x000000000000cdd7
- (id)initWithFamilyCircle:(id)arg1 cacheDate:(id)arg2 maxAge:(double)arg3;	// IMP=0x000000000000cd2f
