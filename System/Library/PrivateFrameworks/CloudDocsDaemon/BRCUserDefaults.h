...
{
    BRCUserDefaults *_globalUserDefault;	// 8 = 0x8
    NSDictionary *_serverContainerConfigurationDict;	// 16 = 0x10
    NSMutableDictionary *_cache;	// 24 = 0x18
    NSString *_clientZoneIdentifier;	// 32 = 0x20
}

+ (int)rampNumberWithSession:(id)arg1;	// IMP=0x00000000002785d2
+ (void)reset;	// IMP=0x0000000000270844
+ (void)loadCachedServerConfiguration;	// IMP=0x0000000000270807
+ (id)cachedServerConfigurationPath;	// IMP=0x000000000027074e
+ (void)setServerConfigurationURL:(id)arg1 whenLoaded:(CDUnknownBlockType)arg2;	// IMP=0x00000000002706c8
+ (id)defaultsForSideCar;	// IMP=0x000000000027066e
+ (id)defaultsForSharedZone;	// IMP=0x0000000000270614
+ (id)defaultsForMetadataContainer;	// IMP=0x00000000002705bd
+ (id)defaultsForMangledID:(id)arg1;	// IMP=0x00000000002704eb
+ (id)_userDefaultsManager;	// IMP=0x000000000027039b
- (void).cxx_destruct;	// IMP=0x000000000027a9bf
...
@property(readonly, nonatomic) _Bool fetchParticipantDocumentToken;
...
- (id)_healthErrorSetForKey:(id)arg1 byDefault:(id)arg2;	// IMP=0x0000000000279ca9
...
- (_Bool)aggressivelyPCSChainWithSession:(id)arg1;	// IMP=0x0000000000278ac4
- (_Bool)optimisticallyPCSChainDuringResetWithSession:(id)arg1;	// IMP=0x0000000000278a82
- (_Bool)optimisticallyPCSChainWithSession:(id)arg1;	// IMP=0x0000000000278a40
- (_Bool)_shouldRampForKey:(id)arg1 session:(id)arg2;	// IMP=0x0000000000278682
...
- (float)_defaultSyncUpMinutelyBudget;	// IMP=0x0000000000276679
@property(readonly, nonatomic) float syncUpHourlyBudget;
- (float)_defaultSyncUpHourlyBudget;	// IMP=0x00000000002765a4
@property(readonly, nonatomic) float syncUpDailyBudget;
- (float)_defaultSyncUpDailyBudget;	// IMP=0x00000000002764fb
...
- (unsigned short)_umaskForKey:(id)arg1;	// IMP=0x0000000000273ebf
...
- (id)_UTISetFor:(id)arg1 startingWithExtensions:(id)arg2;	// IMP=0x0000000000273bca
- (id)_extensionSetForKey:(id)arg1 startingWithExtensions:(id)arg2;	// IMP=0x0000000000273801
...
- (id)xpcActivityDictionaryForKey:(id)arg1 byDefault:(id)arg2;	// IMP=0x0000000000272962
- (id)indexSetForKey:(id)arg1 inheritFromGlobal:(_Bool)arg2 byDefault:(id)arg3;	// IMP=0x000000000027283c
- (id)indexSetForKey:(id)arg1 byDefault:(id)arg2;	// IMP=0x0000000000272822
- (_Bool)boolForKey:(id)arg1 inheritFromGlobal:(_Bool)arg2 byDefault:(_Bool)arg3;	// IMP=0x00000000002725ad
- (_Bool)boolForKey:(id)arg1 byDefault:(_Bool)arg2;	// IMP=0x0000000000272593
- (double)doubleForKey:(id)arg1 min:(double)arg2 max:(double)arg3 byDefault:(double)arg4;	// IMP=0x000000000027219f
- (id)stringForKey:(id)arg1 byDefault:(id)arg2;	// IMP=0x0000000000272185
- (id)stringForKey:(id)arg1 inheritFromGlobal:(_Bool)arg2 byDefault:(id)arg3;	// IMP=0x0000000000272087
- (float)floatForKey:(id)arg1 min:(float)arg2 max:(float)arg3 byDefault:(float)arg4;	// IMP=0x000000000027206d
- (float)floatForKey:(id)arg1 inheritFromGlobal:(_Bool)arg2 min:(float)arg3 max:(float)arg4 byDefault:(float)arg5;	// IMP=0x0000000000271cab
- (unsigned long long)unsignedLongLongForKey:(id)arg1 min:(unsigned long long)arg2 max:(unsigned long long)arg3 byDefault:(unsigned long long)arg4;	// IMP=0x000000000027195b
- (unsigned int)unsignedIntForKey:(id)arg1 inheritFromGlobal:(_Bool)arg2 min:(unsigned int)arg3 max:(unsigned int)arg4 byDefault:(unsigned int)arg5;	// IMP=0x0000000000271609
- (unsigned int)unsignedIntForKey:(id)arg1 min:(unsigned int)arg2 max:(unsigned int)arg3 byDefault:(unsigned int)arg4;	// IMP=0x00000000002715dc
- (int)intForKey:(id)arg1 min:(int)arg2 max:(int)arg3 byDefault:(int)arg4;	// IMP=0x000000000027128e
- (id)objectForKey:(id)arg1 inheritFromGlobal:(_Bool)arg2 validateWithBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000002710fe
- (id)_serverDefaultForKey:(id)arg1;	// IMP=0x0000000000270be8
- (id)_loadObjectForKey:(id)arg1 inheritFromGlobal:(_Bool)arg2 validateWithBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000270989
- (_Bool)_isSharedDefaults;	// IMP=0x0000000000270969
- (id)initAsGlobalWithServerConfiguration:(id)arg1;	// IMP=0x0000000000270952
- (id)initWithServerConfiguration:(id)arg1 globalUserDefaults:(id)arg2 clientZoneIdentifier:(id)arg3;	// IMP=0x0000000000270881
