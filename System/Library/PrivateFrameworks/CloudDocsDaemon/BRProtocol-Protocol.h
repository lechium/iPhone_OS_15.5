...
@class BRFileObjectID, BRGetPausedFileListUpdater, BRMangledID, CKShareMetadata, NSArray, NSData, NSDictionary, NSFileHandle, NSObject, NSSet, NSString, NSURL;
...
- (void)startDownloadFileObject:(BRFileObjectID *)arg1 options:(unsigned long long)arg2 reply:(void (^)(FPSandboxingURLWrapper *, NSError *))arg3;
- (void)getQueryItemForBRFileObjectID:(BRFileObjectID *)arg1 reply:(void (^)(BRQueryItem *, NSError *))arg2;
- (void)addDomain:(NSString *)arg1 reply:(void (^)(NSError *))arg2;
- (void)removeDomain:(NSString *)arg1 reply:(void (^)(NSError *))arg2;
...
- (void)enumerateItemsInFolder:(BRFileObjectID *)arg1 sortOrder:(unsigned char)arg2 offset:(unsigned long long)arg3 limit:(unsigned long long)arg4 completion:(void (^)(NSArray *, unsigned long long, _Bool, NSError *))arg5;
