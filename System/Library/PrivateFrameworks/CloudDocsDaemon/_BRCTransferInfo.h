...
- (void).cxx_destruct;	// IMP=0x0000000000143833
...
- (void)verifyFutureProgressIsNotFinished;	// IMP=0x0000000000143742
- (void)copyProgressInfoToProgress:(id)arg1 options:(BOOL)arg2;	// IMP=0x0000000000143664
- (void)updateLocalizedDescriptionWithOptions:(BOOL)arg1;	// IMP=0x00000000002ee9f5
- (void)updateUnitCount;	// IMP=0x000000000014325f
- (id)description;	// IMP=0x0000000000142f13
- (id)init;	// IMP=0x0000000000142df8
