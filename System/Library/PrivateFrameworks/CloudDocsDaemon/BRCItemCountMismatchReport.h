...
+ (void)generateReportForSharedFolder:(id)arg1 qualityOfService:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000044f18
+ (void)_finishReport:(id)arg1 session:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000044ada
- (void).cxx_destruct;	// IMP=0x0000000000045829
...
- (id)telemetryEvent;	// IMP=0x000000000004571b
- (void)incrementErrorRetryCountWithSession:(id)arg1;	// IMP=0x0000000000044874
- (void)shareChangedDuringCheckWithSession:(id)arg1;	// IMP=0x0000000000044797
- (id)initWithURL:(id)arg1;	// IMP=0x000000000004472c
