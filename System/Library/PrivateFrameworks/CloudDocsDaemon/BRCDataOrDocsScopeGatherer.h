...
- (void).cxx_destruct;	// IMP=0x0000000000068d4f
...
- (void)invalidate;	// IMP=0x0000000000068bb0
- (void)done;	// IMP=0x00000000000689ea
- (CDUnknownBlockType)_popGatherReply;	// IMP=0x000000000006897d
- (void)gatherWithBatchSize:(long long)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000676ad
- (id)initWithNotificationPipe:(id)arg1 appLibraries:(id)arg2 startingRank:(unsigned long long)arg3 maxRank:(unsigned long long)arg4 withDeadItems:(_Bool)arg5 gatherReply:(CDUnknownBlockType)arg6;	// IMP=0x00000000000673a1
