...
- (void).cxx_destruct;	// IMP=0x00000000001f3650
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001f35ae
- (unsigned long long)hash;	// IMP=0x00000000001f3598
- (id)initWithShareID:(id)arg1 emptyRecord:(id)arg2;	// IMP=0x00000000001f34ff
