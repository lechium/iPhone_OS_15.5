...
- (void).cxx_destruct;	// IMP=0x000000000018a620
...
- (id)description;	// IMP=0x000000000018a507
- (id)initWithPQLResultSet:(id)arg1;	// IMP=0x000000000018a3fe
- (id)initWithRelativePath:(id)arg1 fileID:(id)arg2 docID:(id)arg3 genCount:(unsigned int)arg4 isDirectory:(_Bool)arg5;	// IMP=0x000000000018a335
