...
- (void).cxx_destruct;	// IMP=0x000000000003eb30
...
- (id)associatedAppTelemetryEvent;	// IMP=0x000000000003ea0b
- (id)subDescription;	// IMP=0x000000000003e953
- (id)additionalPayload;	// IMP=0x000000000003e80c
