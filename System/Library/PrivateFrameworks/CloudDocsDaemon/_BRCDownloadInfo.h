...
- (void).cxx_destruct;	// IMP=0x0000000000144363
...
- (void)copyProgressInfoToProgress:(id)arg1 options:(BOOL)arg2;	// IMP=0x000000000014423e
- (void)updateLocalizedDescriptionWithOptions:(BOOL)arg1;	// IMP=0x0000000000143f7e
- (id)init;	// IMP=0x0000000000143ecf
