...
- (void).cxx_destruct;	// IMP=0x000000000019923a
...
- (id)initWithItemID:(id)arg1 parentID:(id)arg2 structuralCKInfo:(id)arg3 contentCKInfo:(id)arg4 itemType:(BOOL)arg5 aliasTargetZoneIsShared:(_Bool)arg6 chainState:(unsigned int)arg7;	// IMP=0x0000000000199096
