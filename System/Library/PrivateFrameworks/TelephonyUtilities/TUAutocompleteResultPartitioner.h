...
+ (_Bool)sourceTypeIsFoundOnServers:(unsigned long long)arg1;	// IMP=0x00000000000b2a0a
+ (_Bool)sourceTypeIsFoundInMail:(unsigned long long)arg1;	// IMP=0x00000000000b29fb
- (void).cxx_destruct;	// IMP=0x00000000000b2a8f
...
- (void)addResult:(id)arg1;	// IMP=0x00000000000b28ff
- (id)init;	// IMP=0x00000000000b2861
- (id)searchResults;	// IMP=0x00000000000b2acb
