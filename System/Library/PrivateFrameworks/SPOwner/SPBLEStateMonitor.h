...
- (void)centralManagerDidUpdateState:(id)arg1;	// IMP=0x0000000000034293
- (void)notifyDelegate:(unsigned long long)arg1;	// IMP=0x0000000000034218
- (void)startMonitoring;	// IMP=0x0000000000034107
- (id)init;	// IMP=0x00000000000340cb
