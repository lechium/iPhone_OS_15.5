...
- (void).cxx_destruct;	// IMP=0x000000000000b945
...
- (void)resume;	// IMP=0x000000000000b823
- (void)pause;	// IMP=0x000000000000b7ab
- (void)stop;	// IMP=0x000000000000b744
- (void)start;	// IMP=0x000000000000b5c6
- (unsigned long long)powerState;	// IMP=0x000000000000b5be
- (_Bool)isNetworkUp;	// IMP=0x000000000000b57a
- (id)initWithBeaconManager:(id)arg1 delegateQueue:(id)arg2;	// IMP=0x000000000000b49f
