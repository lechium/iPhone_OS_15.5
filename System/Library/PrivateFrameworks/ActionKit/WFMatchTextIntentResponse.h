...
+ (id)invalidRegularExpressionIntentResponseWithErrorDescription:(id)arg1;	// IMP=0x00000000003b0fcd
@property(nonatomic) long long code; // @synthesize code=_code;
- (id)initWithCode:(long long)arg1 userActivity:(id)arg2;	// IMP=0x00000000003b0f31
