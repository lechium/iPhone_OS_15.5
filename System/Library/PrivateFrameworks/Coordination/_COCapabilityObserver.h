...
- (void).cxx_destruct;	// IMP=0x000000000001d1b1
...
- (void)notify:(_Bool)arg1;	// IMP=0x000000000001cf52
- (id)description;	// IMP=0x000000000001ce5f
- (id)initWithCapability:(id)arg1 cluster:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000000001cca7
