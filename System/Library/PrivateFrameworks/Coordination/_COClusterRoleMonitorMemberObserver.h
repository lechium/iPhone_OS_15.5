...
- (void).cxx_destruct;	// IMP=0x0000000000027b51
...
- (void)notify:(id)arg1;	// IMP=0x0000000000027905
- (id)description;	// IMP=0x000000000002783c
- (id)initWithMember:(id)arg1 inCluster:(id)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0000000000027725
