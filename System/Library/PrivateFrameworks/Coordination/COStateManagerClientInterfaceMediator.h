...
- (void).cxx_destruct;	// IMP=0x0000000000008a11
@property(readonly, nonatomic) __weak COStateManager *manager; // @synthesize manager=_manager;
- (void)mediaSystemLeaderDidChangeTo:(_Bool)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x0000000000008995
- (void)changesObserved:(id)arg1 forPredicate:(id)arg2;	// IMP=0x000000000000891e
- (id)initWithStateManager:(id)arg1;	// IMP=0x00000000000088ba
