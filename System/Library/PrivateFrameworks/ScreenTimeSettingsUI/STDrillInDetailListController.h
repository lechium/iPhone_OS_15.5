...
- (void).cxx_destruct;	// IMP=0x000000000005157d
...
- (void)tableView:(id)arg1 willDisplayFooterView:(id)arg2 forSection:(long long)arg3;	// IMP=0x0000000000051351
- (void)_didFetchAppInfo:(id)arg1;	// IMP=0x00000000000512e2
- (void)viewDidLoad;	// IMP=0x0000000000051193
- (_Bool)canBeShownFromSuspendedState;	// IMP=0x0000000000051150
- (id)initWithUsageItem:(id)arg1 coordinator:(id)arg2;	// IMP=0x0000000000050e04
