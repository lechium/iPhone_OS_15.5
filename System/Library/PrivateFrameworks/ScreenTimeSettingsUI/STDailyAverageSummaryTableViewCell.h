...
- (void).cxx_destruct;	// IMP=0x0000000000048ec0
...
- (void)_layoutDidChangeFrom:(_Bool)arg1 to:(_Bool)arg2;	// IMP=0x0000000000048dff
- (void)_numberOfLinesDidChangeFrom:(unsigned long long)arg1 to:(unsigned long long)arg2;	// IMP=0x0000000000048d95
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000048a99
- (void)dealloc;	// IMP=0x0000000000048a0b
- (id)initWithUsageReport:(id)arg1;	// IMP=0x0000000000048256
