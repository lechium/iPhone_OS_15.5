...
- (_Bool)shouldEnableRestriction:(id)arg1;	// IMP=0x000000000003b86c
- (id)defaultValueForRestriction:(id)arg1;	// IMP=0x000000000003b757
- (id)visibleRestrictionWithConfiguration:(id)arg1 key:(id)arg2;	// IMP=0x000000000003b5da
- (id)init;	// IMP=0x000000000003b55f
