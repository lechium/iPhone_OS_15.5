...
- (void).cxx_destruct;	// IMP=0x00000000000230ea
...
- (void)setUpSectionHeightConstraints;	// IMP=0x0000000000022b8e
- (void)setUpSections;	// IMP=0x00000000000222bc
@property(getter=isDarkened) _Bool darkened;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000021c83
- (id)initWithDataPoint:(id)arg1 useVibrancy:(_Bool)arg2;	// IMP=0x00000000000219fd
