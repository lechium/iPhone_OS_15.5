...
- (id)datePickerForSpecifier:(id)arg1;	// IMP=0x000000000004ef4f
- (void)datePickerChanged:(id)arg1;	// IMP=0x000000000004ebbb
- (void)tableView:(id)arg1 willDisplayCell:(id)arg2 forRowAtIndexPath:(id)arg3;	// IMP=0x000000000004e9c7
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x000000000004e444
- (id)atDowntimeFooterText;	// IMP=0x000000000004e1f1
- (id)askForMoreTime:(id)arg1;	// IMP=0x000000000004e181
- (void)setAskForMoreTime:(id)arg1 specifier:(id)arg2;	// IMP=0x000000000004dfdf
- (id)timeFooterText;	// IMP=0x000000000004ddf6
- (void)_showCustomizeDailyScheduleListController:(id)arg1;	// IMP=0x000000000004da68
- (id)_customScheduleTime:(id)arg1;	// IMP=0x000000000004d827
- (id)_simpleEndTime:(id)arg1;	// IMP=0x000000000004d6dc
- (id)_simpleStartTime:(id)arg1;	// IMP=0x000000000004d591
- (void)_showOrHidePickerSpecifierForSpecifier:(id)arg1;	// IMP=0x000000000004d0e4
- (void)_actuallyToggleDowntimeEnabled;	// IMP=0x000000000004cfa9
- (void)_toggleDowntimeEnabled;	// IMP=0x000000000004cd15
- (id)_createDefaultCustomScheduleFromSimpleSchedule:(id)arg1;	// IMP=0x000000000004ca5d
- (id)deviceBedtimeEnabled:(id)arg1;	// IMP=0x000000000004c9ed
- (void)setDeviceBedtimeEnabled:(id)arg1 specifier:(id)arg2;	// IMP=0x000000000004c7c8
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000004c4fc
- (void)dealloc;	// IMP=0x000000000004c3a7
- (void)_didEndEditingDailySchedule:(id)arg1;	// IMP=0x000000000004bde4
- (void)_renderDeviceBedtimeSpecifierWithBedtime:(id)arg1;	// IMP=0x000000000004babc
- (id)_deviceBedtimeSpecifierWithBedtime:(id)arg1 downtimeGroupSpecifier:(id)arg2;	// IMP=0x000000000004b695
- (id)specifiers;	// IMP=0x000000000004a436
- (void)_didFinishEditingBedtime;	// IMP=0x000000000004a328
- (void)willResignActive;	// IMP=0x000000000004a291
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000004a234
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000000004a1ec
- (_Bool)canBeShownFromSuspendedState;	// IMP=0x000000000004a1e4
- (void)scheduleDowntimeRefreshIfNeeded;	// IMP=0x0000000000049ffe
- (void)scheduleDowntimeRefreshAndReloadSpecifiers;	// IMP=0x0000000000049fd0
- (id)init;	// IMP=0x0000000000049c45
