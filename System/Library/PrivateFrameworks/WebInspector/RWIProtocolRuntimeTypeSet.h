...
- (id)initWithIsFunction:(_Bool)arg1 isUndefined:(_Bool)arg2 isNull:(_Bool)arg3 isBoolean:(_Bool)arg4 isInteger:(_Bool)arg5 isNumber:(_Bool)arg6 isString:(_Bool)arg7 isObject:(_Bool)arg8 isSymbol:(_Bool)arg9 isBigInt:(_Bool)arg10;	// IMP=0x000000000005850f
