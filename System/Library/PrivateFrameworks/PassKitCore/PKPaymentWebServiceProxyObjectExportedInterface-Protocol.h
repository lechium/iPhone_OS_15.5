...
@class NSArray, NSData, NSDictionary, NSMapTable, NSString, NSURL, PKAccount, PKApplePayTrustKeyRequest, PKPass, PKPaymentPass, PKPaymentWebServiceBackgroundContext, PKPaymentWebServiceContext;
