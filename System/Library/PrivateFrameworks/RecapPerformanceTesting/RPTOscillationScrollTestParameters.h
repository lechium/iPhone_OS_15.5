...
- (struct CGPoint)finalFingerPosition;	// IMP=0x0000000000007e9e
- (struct CGPoint)initialFingerPosition;	// IMP=0x0000000000007e09
- (void)scrollWithComposer:(id)arg1 fromPoint:(struct CGPoint)arg2 toPoint:(struct CGPoint)arg3 duration:(double)arg4;	// IMP=0x0000000000007bc4
- (CDUnknownBlockType)composerBlock;	// IMP=0x000000000000775a
- (id)initWithTestName:(id)arg1 iterations:(unsigned long long)arg2 scrollingBounds:(struct CGRect)arg3 useFlicks:(_Bool)arg4 preventDismissalGestures:(_Bool)arg5 initialAmplitude:(double)arg6 amplitudeVariationPerIteration:(double)arg7 initialDirection:(long long)arg8 iterationDuration:(double)arg9 finishWithHalfIteration:(_Bool)arg10 completionHandler:(CDUnknownBlockType)arg11;	// IMP=0x000000000000760f
- (id)initWithTestName:(id)arg1 iterations:(unsigned long long)arg2 scrollingBounds:(struct CGRect)arg3 useFlicks:(_Bool)arg4 preventDismissalGestures:(_Bool)arg5 initialAmplitude:(double)arg6 amplitudeVariationPerIteration:(double)arg7 initialDirection:(long long)arg8 iterationDuration:(double)arg9 finishWithHalfIteration:(_Bool)arg10;	// IMP=0x00000000000075c7
- (void)prepareWithComposer:(id)arg1;	// IMP=0x00000000000075c1
