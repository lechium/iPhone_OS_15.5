...
@interface RPPINEntryView : UIView <UIKeyInput, UITextInputTraits>
{
    ...
    UILabel *_label1;	// 32 = 0x20
    UILabel *_label2;	// 40 = 0x28
    UILabel *_label3;	// 48 = 0x30
    UILabel *_label4;	// 56 = 0x38
    UILabel *_label5;	// 64 = 0x40
    UILabel *_label6;	// 72 = 0x48
    UILabel *_label7;	// 80 = 0x50
    UILabel *_label8;	// 88 = 0x58
    CDUnknownBlockType _textChangedHandler;	// 96 = 0x60
    NSArray *_wells;	// 104 = 0x68
    UIView *_well1;	// 112 = 0x70
    UIView *_well2;	// 120 = 0x78
    UIView *_well3;	// 128 = 0x80
    UIView *_well4;	// 136 = 0x88
    UIView *_well5;	// 144 = 0x90
    UIView *_well6;	// 152 = 0x98
    UIView *_well7;	// 160 = 0xa0
    UIView *_well8;	// 168 = 0xa8
    UIColor *_wellFocusColor;	// 176 = 0xb0
}

- (void).cxx_destruct;	// IMP=0x0000000000003250
...
- (void)insertText:(id)arg1;	// IMP=0x0000000000002ce9
- (void)deleteBackward;	// IMP=0x0000000000002c2b
- (_Bool)canBecomeFirstResponder;	// IMP=0x0000000000002c23
@property(nonatomic) long long autocorrectionType;
@property(nonatomic) long long autocapitalizationType;
- (void)_updateFields;	// IMP=0x00000000000026ee
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000026a0
@property(copy, nonatomic) NSString *text;
- (void)awakeFromNib;	// IMP=0x0000000000002311
