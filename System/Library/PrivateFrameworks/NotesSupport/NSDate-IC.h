...
@interface NSDate (IC)
- (_Bool)ic_isLaterThanUnitsAgo:(unsigned long long)arg1 value:(unsigned long long)arg2;	// IMP=0x000000000002b6b0
- (_Bool)ic_isLaterThanDate:(id)arg1;	// IMP=0x000000000002b696
- (_Bool)ic_isEarlierThanDate:(id)arg1;	// IMP=0x000000000002b67c
@property(readonly, nonatomic) NSDate *ic_truncated;
- (id)ic_briefFormattedDate:(_Bool)arg1;	// IMP=0x000000000002b155
