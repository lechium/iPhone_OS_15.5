...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000289b0
- (void).cxx_destruct;	// IMP=0x00000000000289de
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000288bf
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000028764
@property(readonly, copy, nonatomic) NSString *extraPreviewText;
@property(readonly, nonatomic) long long type;
- (id)initWithSSID:(id)arg1 isWEP:(_Bool)arg2 password:(id)arg3 isHidden:(_Bool)arg4;	// IMP=0x000000000002867a
