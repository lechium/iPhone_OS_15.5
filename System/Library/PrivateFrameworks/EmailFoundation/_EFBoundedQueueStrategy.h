...
- (void).cxx_destruct;	// IMP=0x00000000000304dc
...
- (void)dequeueObject:(id)arg1 buffer:(id)arg2;	// IMP=0x00000000000304b2
- (void)enqueueObject:(id)arg1 replaceIfExists:(_Bool)arg2 buffer:(id)arg3;	// IMP=0x0000000000030389
@property(readonly, nonatomic) NSString *descriptionType;
- (id)initWithCapacity:(unsigned long long)arg1 overflowHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000302f2
