...
+ (id)textBadgeViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x000000000008a3ef
- (void).cxx_destruct;	// IMP=0x000000000008ab80
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000008a8b7
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000008a793
