...
- (void).cxx_destruct;	// IMP=0x000000000002b3d1
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002b08f
- (id)initWithShadowImages:(_Bool)arg1;	// IMP=0x000000000002af55
- (id)initWithStyle:(long long)arg1;	// IMP=0x000000000002abee
