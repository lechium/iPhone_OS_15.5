...
- (void).cxx_destruct;	// IMP=0x000000000001a67d
...
- (void)_showSpinner;	// IMP=0x000000000001a431
- (_Bool)canBecomeFocused;	// IMP=0x000000000001a429
- (void)layoutSubviews;	// IMP=0x000000000001a008
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000019ec3
