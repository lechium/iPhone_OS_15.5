...
+ (id)presentationTypeKeyMap;	// IMP=0x00000000000fb58e
- (void).cxx_destruct;	// IMP=0x00000000000fba42
...
- (void)_applyAlertActionsForController:(id)arg1;	// IMP=0x00000000000fb8e1
- (id)initWithOptions:(id)arg1;	// IMP=0x00000000000fb7d4
- (id)init;	// IMP=0x00000000000fb744
