...
- (void).cxx_destruct;	// IMP=0x0000000000062c34
...
- (void)_freeBuffers;	// IMP=0x0000000000062b80
- (void)_compute;	// IMP=0x0000000000061f09
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000061e6b
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x0000000000061e30
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x0000000000061df5
- (void)dealloc;	// IMP=0x0000000000061db7
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x0000000000061d43
