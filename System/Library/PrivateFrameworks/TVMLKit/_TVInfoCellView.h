...
+ (id)infoCellViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00000000000b070f
- (void).cxx_destruct;	// IMP=0x00000000000b2779
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000b2359
- (void)layoutSubviews;	// IMP=0x00000000000b1bf3
- (struct CGSize)sizeThatFits:(struct CGSize)arg1 withHeaderWidth:(double)arg2;	// IMP=0x00000000000b1638
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000b15eb
- (double)minimumHeaderWidth;	// IMP=0x00000000000b12a1
