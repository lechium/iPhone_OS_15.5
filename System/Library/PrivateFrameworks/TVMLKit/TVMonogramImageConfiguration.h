...
- (void).cxx_destruct;	// IMP=0x000000000002b72a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002b534
- (id)initWithStyle:(long long)arg1;	// IMP=0x000000000002b451
