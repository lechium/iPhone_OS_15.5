...
- (void).cxx_destruct;	// IMP=0x000000000003058f
...
- (void)_updateDeviceVisual:(id)arg1;	// IMP=0x0000000000030157
- (void)_updateForDeviceInfo;	// IMP=0x000000000002fed9
- (void)sessionProgressEvent:(int)arg1 info:(id)arg2;	// IMP=0x000000000002fdcd
- (void)eventCancel:(id)arg1;	// IMP=0x000000000002fd4a
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000000002fd01
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000000002fc63
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000002fb24
