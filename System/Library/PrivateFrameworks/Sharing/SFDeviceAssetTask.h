...
- (void).cxx_destruct;	// IMP=0x0000000000062d89
...
- (id)bundleAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000062874
- (id)bundleURLFromAssetURL:(id)arg1;	// IMP=0x00000000000625b5
- (void)completeWithBundle:(id)arg1 isFallback:(_Bool)arg2 isCached:(_Bool)arg3;	// IMP=0x0000000000061e2d
- (_Bool)completeIfPossible;	// IMP=0x00000000000618b0
- (void)cancelTimeout;	// IMP=0x0000000000061866
- (_Bool)updateTaskWithBundle:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000006166f
- (_Bool)updateTaskWithAssetBundleURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x00000000000615b9
- (_Bool)updateTaskWithAssetURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x0000000000061526
- (void)createQueryParameters;	// IMP=0x00000000000611fe
- (id)initWithDeviceQuery:(id)arg1 requestConfiguration:(id)arg2 dispatchQueue:(id)arg3 useProcessLocalCache:(_Bool)arg4;	// IMP=0x0000000000060eb9
