...
- (void)updateButtons;	// IMP=0x000000000003c779
- (void)updateFlipButton;	// IMP=0x000000000003c6c9
- (void)flashValueChanged;	// IMP=0x000000000003c619
- (void)cancelPressed;	// IMP=0x000000000003c511
- (void)flipPressed;	// IMP=0x000000000003c472
- (void)updatePhotosLabel;	// IMP=0x000000000003c1b2
- (void)shutterPressed;	// IMP=0x000000000003c0c0
- (void)layoutSubviews;	// IMP=0x000000000003bf22
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000003a8e2
