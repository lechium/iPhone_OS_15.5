...
- (void).cxx_destruct;	// IMP=0x00000000000482f3
...
- (void)presentationControllerDidDismiss:(id)arg1;	// IMP=0x000000000004829a
- (void)cancel;	// IMP=0x00000000000481ac
- (void)cancelPresentationWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000048109
- (void)showWithServiceName:(id)arg1 input:(id)arg2 managedLevel:(unsigned long long)arg3 options:(unsigned long long)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000047dd2
- (id)selectedStorageServiceForName:(id)arg1;	// IMP=0x0000000000047d4b
