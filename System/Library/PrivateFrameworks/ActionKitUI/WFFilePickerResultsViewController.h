...
- (void).cxx_destruct;	// IMP=0x00000000000593dd
...
- (void)viewWillLayoutSubviews;	// IMP=0x00000000000592c8
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000059287
- (void)updateContentInset;	// IMP=0x000000000005909c
- (void)loadView;	// IMP=0x0000000000058f33
- (void)dealloc;	// IMP=0x0000000000058eb1
- (id)initWithFileListDelegate:(id)arg1;	// IMP=0x0000000000058ddb
