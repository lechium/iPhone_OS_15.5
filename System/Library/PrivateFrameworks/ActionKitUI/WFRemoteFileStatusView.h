...
- (void).cxx_destruct;	// IMP=0x0000000000056479
...
- (void)setError:(id)arg1;	// IMP=0x0000000000056203
- (void)setLoading;	// IMP=0x000000000005608e
- (void)setEmptyWithLabel:(_Bool)arg1;	// IMP=0x0000000000055ecd
- (void)recoveryButtonTapped;	// IMP=0x0000000000055e81
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000055751
