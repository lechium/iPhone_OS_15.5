...
- (void).cxx_destruct;	// IMP=0x0000000000036d55
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000036a0a
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000003671b
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000000366ae
- (void)didMoveToWindow;	// IMP=0x000000000003663b
- (void)layoutSubviews;	// IMP=0x00000000000365ac
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000360ff
