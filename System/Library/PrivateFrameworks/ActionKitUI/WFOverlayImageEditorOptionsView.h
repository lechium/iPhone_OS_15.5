...
- (void)didTapNextButton;	// IMP=0x000000000003097f
- (void)didTapCancelButton;	// IMP=0x0000000000030942
- (void)didTapOpacityButton;	// IMP=0x000000000003085a
- (void)didTapRotationButton;	// IMP=0x0000000000030770
- (void)didTapResetButton;	// IMP=0x0000000000030733
- (id)init;	// IMP=0x000000000002f72f
