...
- (void).cxx_destruct;	// IMP=0x000000000002d9b8
...
- (void)audioRecorder:(id)arg1 didFinishWithDestinationURL:(id)arg2 error:(id)arg3;	// IMP=0x000000000002d839
- (void)audioRecorder:(id)arg1 didProgressToTime:(double)arg2;	// IMP=0x000000000002d750
- (void)inputButtonTapped;	// IMP=0x000000000002d324
- (void)finishRecording;	// IMP=0x000000000002d2e7
- (void)startRecording;	// IMP=0x000000000002d200
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000002d1ab
- (void)handleTap;	// IMP=0x000000000002d10a
- (void)viewDidLoad;	// IMP=0x000000000002cdac
- (id)initWithOutputFormat:(long long)arg1 destinationURL:(id)arg2;	// IMP=0x000000000002cced
