...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000047d82
- (void).cxx_destruct;	// IMP=0x00000000000484ea
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000481d5
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000047d8a
