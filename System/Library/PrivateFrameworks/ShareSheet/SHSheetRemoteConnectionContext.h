...
- (void).cxx_destruct;	// IMP=0x000000000007ab37
...
- (id)createContextDictionary;	// IMP=0x000000000007a7af
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000007a53f
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x000000000007a4cc
