...
+ (id)bodyShortFont;	// IMP=0x000000000000833a
- (void).cxx_destruct;	// IMP=0x0000000000008aee
...
- (void)_updateImageDarkening;	// IMP=0x0000000000008685
- (void)prepareForReuse;	// IMP=0x0000000000008505
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000000074c3
