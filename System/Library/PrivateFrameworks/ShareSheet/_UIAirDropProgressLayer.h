...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x0000000000002cb1
- (void).cxx_destruct;	// IMP=0x0000000000002fc3
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000000002d23
- (id)initWithLayer:(id)arg1;	// IMP=0x0000000000002afe
- (id)init;	// IMP=0x00000000000029e3
