...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000efd0
- (void).cxx_destruct;	// IMP=0x000000000000fbff
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000f595
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000efd8
