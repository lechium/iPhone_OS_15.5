...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000028915
- (void).cxx_destruct;	// IMP=0x0000000000028dca
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000028b41
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002891d
- (id)description;	// IMP=0x00000000000287f8
- (id)initFolderChangeWithChangeType:(unsigned long long)arg1 folderId:(id)arg2 parentFolderId:(id)arg3 displayName:(id)arg4 dataclass:(long long)arg5 consumer:(id)arg6;	// IMP=0x0000000000028375
