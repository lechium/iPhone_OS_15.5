...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002318f
- (void).cxx_destruct;	// IMP=0x0000000000024780
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002392f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000023197
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000023127
- (_Bool)isEqualToDAContactSearchResultElement:(id)arg1;	// IMP=0x0000000000021e89
- (id)description;	// IMP=0x0000000000021d8a
