...
+ (id)managedHandlesForHandles:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x000000000000ceb0
+ (id)managedHandleForHandle:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x000000000000cc47
+ (id)fetchRequest;	// IMP=0x000000000000ec87
- (id)copyWithContext:(id)arg1;	// IMP=0x000000000000d182
