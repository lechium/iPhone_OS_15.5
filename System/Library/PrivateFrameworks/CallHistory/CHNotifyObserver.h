...
- (void).cxx_destruct;	// IMP=0x0000000000039262
...
- (void)dealloc;	// IMP=0x00000000000391f2
- (id)initWithName:(id)arg1 queue:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x0000000000038ffc
