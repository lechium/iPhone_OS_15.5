...
- (SKADatabaseReceivedInvitation *)createReceivedInvitationForChannel:(SKADatabaseChannel *)arg1 senderHandle:(SKHandle *)arg2 invitedHandle:(SKHandle *)arg3 invitationIdentifier:(NSString *)arg4 dateInvitationCreated:(NSDate *)arg5 incomingRatchetState:(NSData *)arg6 invitationPayload:(NSData *)arg7 databaseContext:(NSManagedObjectContext *)arg8;
