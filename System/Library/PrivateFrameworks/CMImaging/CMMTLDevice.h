...
- (void).cxx_destruct;	// IMP=0x0000000000006398
@property(retain, nonatomic) InterceptConfig *interceptConfig; // @synthesize interceptConfig=_interceptConfig;
- (void)forwardInvocation:(id)arg1;	// IMP=0x00000000000062ec
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000000629c
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000006267
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x000000000000620f
- (id)newCommandQueueWithMaxCommandBufferCount:(unsigned long long)arg1;	// IMP=0x00000000000061dc
- (id)newCommandQueue;	// IMP=0x00000000000061ae
@property(retain, nonatomic) FigMetalExecutionStatus *executionStatus;
- (id)initWithLevel:(int)arg1;	// IMP=0x00000000000060ad
