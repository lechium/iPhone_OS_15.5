...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001906a4
- (void).cxx_destruct;	// IMP=0x0000000000190565
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000190519
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000190450
- (id)initWithState:(id)arg1 extensionResourceClasses:(id)arg2;	// IMP=0x000000000019039f
- (id)initWithState:(id)arg1;	// IMP=0x00000000001901a9
