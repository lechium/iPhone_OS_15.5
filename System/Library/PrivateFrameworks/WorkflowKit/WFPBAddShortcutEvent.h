...
- (void).cxx_destruct;	// IMP=0x000000000022dc56
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000022db00
- (unsigned long long)hash;	// IMP=0x000000000022da51
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000022d8ed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000022d7e0
- (void)copyTo:(id)arg1;	// IMP=0x000000000022d71d
- (void)writeTo:(id)arg1;	// IMP=0x000000000022d662
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000022d655
- (id)dictionaryRepresentation;	// IMP=0x000000000022d522
- (id)description;	// IMP=0x000000000022d473
