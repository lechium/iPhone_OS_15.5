...
- (void).cxx_destruct;	// IMP=0x0000000000110ae0
...
- (_Bool)isValidWithBallpark:(unsigned long long)arg1;	// IMP=0x0000000000110a23
- (id)initWithDonations:(id)arg1 ballpark:(unsigned long long)arg2;	// IMP=0x000000000011095e
