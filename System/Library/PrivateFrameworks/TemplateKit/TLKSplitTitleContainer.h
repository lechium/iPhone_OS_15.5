...
+ (double)widthForString:(id)arg1 font:(id)arg2;	// IMP=0x0000000000010900
- (void).cxx_destruct;	// IMP=0x0000000000010b15
...
- (id)titleFont;	// IMP=0x0000000000010a04
- (_Bool)titleLabelsFitInWidth:(double)arg1 pointSize:(double)arg2;	// IMP=0x000000000001074a
- (void)layoutSubviews;	// IMP=0x00000000000100e8
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000000010096
- (id)init;	// IMP=0x000000000000fe99
