...
+ (void)setRemoteServer:(id)arg1;	// IMP=0x0000000000041453
+ (id)remoteServer;	// IMP=0x00000000000413e2
+ (long long)beneficiaryDurationBeforeNotSetupCFU;	// IMP=0x0000000000042999
+ (long long)beneficiaryStaleInviteDuration;	// IMP=0x00000000000428ad
+ (void)reset;	// IMP=0x0000000000041d77
+ (id)_urlConfigurationWithError:(id *)arg1;	// IMP=0x0000000000041a81
+ (id)itemForKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000418d7
+ (id)urlConfiguration;	// IMP=0x00000000000418c3
- (void).cxx_destruct;	// IMP=0x00000000000418b3
- (id)description;	// IMP=0x000000000004183e
@property(readonly, copy, nonatomic) NSNumber *baaInterval;
@property(readonly, copy, nonatomic) NSNumber *absintheEnable;
- (id)urlForEndpoint:(id)arg1;	// IMP=0x000000000004161e
- (id)_initWithDictionary:(id)arg1;	// IMP=0x000000000004152e
- (id)init;	// IMP=0x0000000000041503
...
- (id)_urlStringForKey:(id)arg1;	// IMP=0x0000000000041f47
@property(readonly, nonatomic) NSString *apsEnvironment;
- (id)_envStringForKey:(id)arg1;	// IMP=0x0000000000041e0d
