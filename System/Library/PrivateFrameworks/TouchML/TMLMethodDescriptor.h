...
+ (id)decode:(const struct ProtobufCMessage *)arg1;	// IMP=0x0000000000007138
+ (id)methodSelectorForMethodName:(id)arg1 parameters:(id)arg2;	// IMP=0x0000000000006f87
...
- (void)encode:(struct ProtobufCMessage *)arg1;	// IMP=0x0000000000006ff4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000006d6a
- (id)initWithName:(id)arg1 returnType:(unsigned long long)arg2 parameters:(id)arg3 methodSelector:(id)arg4 attributes:(id)arg5;	// IMP=0x0000000000006c52
