...
- (void).cxx_destruct;	// IMP=0x000000000002f1c7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f086
- (unsigned long long)hash;	// IMP=0x000000000002f07c
- (void)notify:(id)arg1;	// IMP=0x000000000002f022
- (id)initWithObserver:(id)arg1 keyPath:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x000000000002ef4d
