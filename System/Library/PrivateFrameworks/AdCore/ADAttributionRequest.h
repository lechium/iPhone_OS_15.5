...
+ (id)options;	// IMP=0x00000000000014c0
- (void).cxx_destruct;	// IMP=0x000000000000395e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000035f3
- (unsigned long long)hash;	// IMP=0x0000000000002f21
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000002bae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000293f
- (void)copyTo:(id)arg1;	// IMP=0x0000000000002741
- (void)writeTo:(id)arg1;	// IMP=0x0000000000002541
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000002534
- (id)dictionaryRepresentation;	// IMP=0x0000000000001ad8
- (id)description;	// IMP=0x0000000000001a29
- (int)StringAsDownloadType:(id)arg1;	// IMP=0x0000000000001997
- (id)downloadTypeAsString:(int)arg1;	// IMP=0x0000000000001931
...
- (int)StringAsRunState:(id)arg1;	// IMP=0x0000000000001762
- (id)runStateAsString:(int)arg1;	// IMP=0x00000000000016fc
