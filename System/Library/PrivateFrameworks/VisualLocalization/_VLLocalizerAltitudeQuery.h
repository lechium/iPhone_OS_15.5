...
- (void).cxx_destruct;	// IMP=0x0000000000016bf0
...
- (id)initWithLocation:(id)arg1 callbackQueue:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x0000000000016aa0
- (id)init;	// IMP=0x0000000000016a70
