...
- (void).cxx_destruct;	// IMP=0x00000000000093dc
...
- (void)subscribe:(id)arg1;	// IMP=0x0000000000009295
- (id)initWithUpstream:(id)arg1 for:(double)arg2 getTimestamp:(CDUnknownBlockType)arg3;	// IMP=0x0000000000009152
