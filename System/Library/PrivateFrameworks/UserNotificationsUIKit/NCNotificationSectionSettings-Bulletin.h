...
+ (id)notificationSectionSettingsForBBSectionInfo:(id)arg1;	// IMP=0x000000000003a955
- (unsigned long long)_groupingSettingFromBBGroupingSetting:(long long)arg1;	// IMP=0x000000000003bced
- (unsigned long long)_contentPreviewSettingFromBBContentPreviewSetting:(long long)arg1;	// IMP=0x000000000003bc9b
...
- (unsigned long long)contentPreviewSettingForRequestWithSubSectionIdentifiers:(id)arg1;	// IMP=0x000000000003b7e4
- (id)_notificationSectionSettingsForSubSectionWithIdentifier:(id)arg1;	// IMP=0x000000000003b5ee
