...
- (void).cxx_destruct;	// IMP=0x00000000000b0ca0
- (_Bool)hasReferenceToPath:(id)arg1;	// IMP=0x00000000000b0ad2
- (id)initWithServerContext:(id)arg1;	// IMP=0x00000000000b0a67
