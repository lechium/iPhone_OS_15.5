...
- (void).cxx_destruct;	// IMP=0x0000000000047ebd
- (_Bool)hasReferenceToPath:(id)arg1;	// IMP=0x0000000000047bd2
- (id)initWithServerContext:(id)arg1;	// IMP=0x0000000000047b67
