...
- (void).cxx_destruct;	// IMP=0x00000000001fd4d0
...
- (void)layoutSubviews;	// IMP=0x00000000001fc910
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x00000000001fc6e0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001fc560
@property(nonatomic) struct UIEdgeInsets layoutMargins;
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001fc430
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001fc400
