...
- (void).cxx_destruct;	// IMP=0x00000000001ed1b0
- (void)textSizeUpdated:(id)arg1;	// IMP=0x00000000001ecdc0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001ecc40
- (void)layoutSubviews;	// IMP=0x00000000001ecc10
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001eca10
