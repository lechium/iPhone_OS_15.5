...
+ (long long)activityCategory;	// IMP=0x00000000001e0df0
- (void).cxx_destruct;	// IMP=0x00000000001e12f0
- (id)init;	// IMP=0x00000000001e1290
- (void)performActivity;	// IMP=0x00000000001e1260
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x00000000001e1090
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x00000000001e0f20
