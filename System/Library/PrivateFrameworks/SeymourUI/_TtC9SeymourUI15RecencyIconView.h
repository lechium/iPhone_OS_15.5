...
- (void).cxx_destruct;	// IMP=0x00000000000ba880
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ba830
- (void)didMoveToSuperview;	// IMP=0x00000000000ba800
- (void)layoutSubviews;	// IMP=0x00000000000ba630
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000ba4d0
