...
- (void).cxx_destruct;	// IMP=0x0000000000350c20
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000350b30
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000350b10
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000350ae0
