...
- (void).cxx_destruct;	// IMP=0x0000000000130fd0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000130f50
- (void)layoutSubviews;	// IMP=0x0000000000130b80
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000130a30
- (void)bookmarkButtonTapped;	// IMP=0x00000000001309d0
@property(nonatomic, readonly) struct CGSize intrinsicContentSize;
- (void)updateConstraints;	// IMP=0x0000000000130810
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000012f9f0
