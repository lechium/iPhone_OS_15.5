...
- (void).cxx_destruct;	// IMP=0x000000000000f036
...
- (id)initWithMask:(unsigned long long)arg1;	// IMP=0x000000000000eeee
- (void)setSmartCoverClosed:(_Bool)arg1;	// IMP=0x000000000000eee5
- (void)shouldSample:(_Bool)arg1 withDeadline:(unsigned long long)arg2;	// IMP=0x000000000000eedc
- (unsigned long long)minimumAttentionSamplerErrorRetryTime;	// IMP=0x000000000000eed3
- (unsigned long long)nextSampleTimeForSamplingInterval:(unsigned long long)arg1;	// IMP=0x000000000000eeca
- (void)finishDeadlineComputation;	// IMP=0x000000000000ee75
- (void)updateSamplingDeadline:(unsigned long long)arg1 forClient:(id)arg2;	// IMP=0x000000000000ee11
- (void)startDeadlineComputation;	// IMP=0x000000000000ede0
- (void)setUnitTestMode;	// IMP=0x000000000000edba
- (id)description;	// IMP=0x000000000000ed23
- (id)init;	// IMP=0x000000000000ec86
