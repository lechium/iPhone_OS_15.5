...
- (void)homeManagerDidUpdateDataSyncInProgress:(id)arg1;	// IMP=0x000000000002c460
- (void)homeManagerDidUpdateHomes:(id)arg1;	// IMP=0x000000000002c400
- (id)init;	// IMP=0x0000000000023a40
