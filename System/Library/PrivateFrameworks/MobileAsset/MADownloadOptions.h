...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001653b
...
- (void)logOptions;	// IMP=0x0000000000016c0f
- (id)description;	// IMP=0x0000000000016ae9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000168df
- (void)dealloc;	// IMP=0x0000000000016895
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001659b
- (id)init;	// IMP=0x0000000000016543
