...
- (_Bool)coalesceScrollForNode:(id)arg1 offset:(struct CGPoint)arg2 isUserScroll:(_Bool)arg3;	// IMP=0x00000000012f4bc0
- (void)dealloc;	// IMP=0x00000000012f4b85
- (id)initWithNode:(id)arg1 offset:(struct CGPoint)arg2 isUserScroll:(_Bool)arg3;	// IMP=0x00000000012f4b0c
