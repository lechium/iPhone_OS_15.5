...
- (void).cxx_destruct;	// IMP=0x000000000054d546
...
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x000000000054d2e7
@property(readonly, nonatomic) NSString *eventName;
- (void)clickDriver:(id)arg1 didPerformEvent:(unsigned long long)arg2;	// IMP=0x000000000054d151
- (void)clickDriver:(id)arg1 shouldBegin:(CDUnknownBlockType)arg2;	// IMP=0x000000000054d141
- (void)didMoveToView:(id)arg1;	// IMP=0x000000000054d0ad
- (void)willMoveToView:(id)arg1;	// IMP=0x000000000054d06e
@property(readonly, copy) NSString *description;
- (id)initWithTarget:(id)arg1 action:(SEL)arg2 useForce:(_Bool)arg3;	// IMP=0x000000000054ce38
