...
- (void).cxx_destruct;	// IMP=0x0000000000ef42f1
...
- (id)applyUpdate:(id)arg1 toDisplayItem:(id)arg2;	// IMP=0x0000000000ef4126
- (id)viewForIdentifier:(id)arg1;	// IMP=0x0000000000ef4114
- (void)_create_sensorActivityIndicator;	// IMP=0x0000000000ef40ba
- (id)dependentEntryKeys;	// IMP=0x0000000000ef4060
