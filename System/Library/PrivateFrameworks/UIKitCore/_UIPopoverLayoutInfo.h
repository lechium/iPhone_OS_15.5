...
+ (id)_observationKeys;	// IMP=0x000000000112444d
- (void).cxx_destruct;	// IMP=0x0000000001125e62
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000001125c68
- (void)_updateOutputs;	// IMP=0x0000000001124e48
- (struct CGSize)_popoverViewSizeForContentSize:(struct CGSize)arg1 arrowDirection:(unsigned long long)arg2;	// IMP=0x0000000001124cbc
- (id)candidates;	// IMP=0x0000000001124cab
- (void)updateProperties:(CDUnknownBlockType)arg1;	// IMP=0x0000000001124c44
- (id)description;	// IMP=0x0000000001124963
- (void)dealloc;	// IMP=0x0000000001124800
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000112467d
- (id)init;	// IMP=0x00000000011244d2
