...
- (void).cxx_destruct;	// IMP=0x0000000000eef318
...
- (id)cellForTargetContainerInTableView:(id)arg1;	// IMP=0x0000000000eef157
- (id)initWithDragItem:(id)arg1 target:(id)arg2;	// IMP=0x0000000000eef0df
