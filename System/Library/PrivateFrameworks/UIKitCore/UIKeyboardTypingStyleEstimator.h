...
- (void).cxx_destruct;	// IMP=0x0000000000b80e3f
@property(nonatomic) __weak id <UIKeyboardTypingStyleEstimatorDelegate> delegate; // @synthesize delegate=_delegate;
- (unsigned long long)currentTypingStyleEstimation;	// IMP=0x0000000000b80e0e
- (void)tapTypedKey;	// IMP=0x0000000000b80df7
- (void)cancelContinuousPath;	// IMP=0x0000000000b80d24
- (void)endedContinuousPath;	// IMP=0x0000000000b80bd4
- (void)beganContinuousPath;	// IMP=0x0000000000b80b73
- (void)_setTypingStyleEstimation:(unsigned long long)arg1;	// IMP=0x0000000000b809fc
