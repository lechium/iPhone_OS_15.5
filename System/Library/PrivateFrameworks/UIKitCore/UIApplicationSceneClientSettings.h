...
- (_Bool)isUISubclass;	// IMP=0x00000000007510e2
- (id)valueDescriptionForFlag:(long long)arg1 object:(id)arg2 ofSetting:(unsigned long long)arg3;	// IMP=0x00000000007510cf
- (id)keyDescriptionForSetting:(unsigned long long)arg1;	// IMP=0x00000000007510c2
- (_Bool)settings:(id)arg1 appendDescriptionToBuilder:(id)arg2 forFlag:(long long)arg3 object:(id)arg4 ofSetting:(unsigned long long)arg5;	// IMP=0x0000000000750e96
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000750e68
- (id)valueDescriptionForFlag:(long long)arg1 object:(id)arg2 ofOtherSetting:(unsigned long long)arg3;	// IMP=0x0000000000750b58
- (id)keyDescriptionForOtherSetting:(unsigned long long)arg1;	// IMP=0x0000000000750918
