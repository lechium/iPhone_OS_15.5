...
- (void).cxx_destruct;	// IMP=0x00000000006f9120
...
- (void)_setupAlternateTitlesFromBarButtonItem:(id)arg1;	// IMP=0x00000000006f88f4
- (id)_titleAlternativeForTitle:(id)arg1;	// IMP=0x00000000006f87c3
- (_Bool)supportsBackButtons;	// IMP=0x00000000006f87bb
- (void)updateButton:(id)arg1 forHighlightedState:(_Bool)arg2;	// IMP=0x00000000006f8790
- (void)updateButton:(id)arg1 forFocusedState:(_Bool)arg2;	// IMP=0x00000000006f8502
- (void)buttonLayoutSubviews:(id)arg1 baseImplementation:(CDUnknownBlockType)arg2;	// IMP=0x00000000006f81e5
- (void)configureButton:(id)arg1 fromBarButtonItem:(id)arg2;	// IMP=0x00000000006f6a49
- (void)_selectGestureChanged:(id)arg1;	// IMP=0x00000000006f69e3
- (void)configureButton:(id)arg1 withAppearanceDelegate:(id)arg2 fromBarItem:(id)arg3;	// IMP=0x00000000006f694c
- (id)contentView;	// IMP=0x00000000006f68b8
- (id)backIndicatorView;	// IMP=0x00000000006f68a6
