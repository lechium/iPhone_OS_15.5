...
- (void).cxx_destruct;	// IMP=0x00000000001e474a
...
- (void)applyLayout;	// IMP=0x00000000001e45ce
- (void)updateLayout;	// IMP=0x00000000001e428a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001e41ea
- (double)scopeControlHeight;	// IMP=0x00000000001e4185
