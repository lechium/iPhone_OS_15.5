...
+ (id)descriptionWithVelocity:(id)arg1 targetVelocity:(id)arg2;	// IMP=0x00000000011b9de3
- (void).cxx_destruct;	// IMP=0x00000000011b9e85
...
- (id)initWithVelocity:(id)arg1 targetVelocity:(id)arg2;	// IMP=0x00000000011b9d4a
