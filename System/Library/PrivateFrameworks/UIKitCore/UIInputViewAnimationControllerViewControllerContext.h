...
+ (id)contextWithHost:(id)arg1 startPlacement:(id)arg2 endPlacement:(id)arg3 transitionContext:(id)arg4;	// IMP=0x000000000055cd6b
...
- (void)dealloc;	// IMP=0x000000000055ccd2
- (id)initWithHost:(id)arg1 startPlacement:(id)arg2 endPlacement:(id)arg3 transitionContext:(id)arg4;	// IMP=0x000000000055c761
