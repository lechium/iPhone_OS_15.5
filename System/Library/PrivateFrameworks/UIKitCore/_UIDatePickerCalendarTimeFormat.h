...
+ (id)formatWithCalendar:(id)arg1 locale:(id)arg2;	// IMP=0x000000000073b9ed
- (void).cxx_destruct;	// IMP=0x000000000073df6d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000073dc66
- (id)withTimeZone:(id)arg1;	// IMP=0x000000000073dbba
- (id)withDisplaysTimeZone:(_Bool)arg1;	// IMP=0x000000000073db70
- (id)withForceDoubleDigitHours:(_Bool)arg1;	// IMP=0x000000000073da66
- (id)localizedTimeStringWithHours:(unsigned long long)arg1 minutes:(unsigned long long)arg2 isPM:(_Bool)arg3;	// IMP=0x000000000073da51
- (id)localizedTimeStringWithHours:(unsigned long long)arg1 minutes:(unsigned long long)arg2 isPM:(_Bool)arg3 ranges:(CDStruct_a33ff3ce *)arg4;	// IMP=0x000000000073ce43
- (id)initWithCalendar:(id)arg1 locale:(id)arg2 forceDoubleDigitHours:(_Bool)arg3 displaysTimeZone:(_Bool)arg4;	// IMP=0x000000000073ba69
