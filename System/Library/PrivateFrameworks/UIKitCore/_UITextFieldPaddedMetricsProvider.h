...
- (struct CGSize)intrinsicSizeForContentSize:(struct CGSize)arg1;	// IMP=0x000000000061527d
- (struct CGRect)contentFrameForBounds:(struct CGRect)arg1;	// IMP=0x00000000006151d0
- (id)initWithPerEdgePadding:(struct UIEdgeInsets)arg1;	// IMP=0x0000000000615189
- (id)initWithSymmetricalPadding:(struct CGSize)arg1;	// IMP=0x000000000061512d
- (id)init;	// IMP=0x00000000006150ee
