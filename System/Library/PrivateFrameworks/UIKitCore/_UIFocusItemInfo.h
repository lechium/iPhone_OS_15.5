...
+ (id)infoWithView:(id)arg1;	// IMP=0x000000000069075e
+ (id)infoWithItem:(id)arg1 useFallbackAncestorScroller:(_Bool)arg2;	// IMP=0x0000000000690704
+ (id)infoWithItem:(id)arg1;	// IMP=0x00000000006906b6
- (void).cxx_destruct;	// IMP=0x000000000069209b
...
- (id)description;	// IMP=0x0000000000691ff0
- (void)invalidateFocusedRegion;	// IMP=0x0000000000691fca
- (struct CGRect)focusedRectInCoordinateSpace:(id)arg1;	// IMP=0x0000000000691e7b
- (id)_focusedRegionInCoordinateSpace:(id)arg1;	// IMP=0x000000000069119e
@property(readonly, nonatomic) _UIFocusRegion *focusedRegion; // @synthesize focusedRegion=_focusedRegion;
- (id)_defaultCoordinateSpace;	// IMP=0x000000000069101e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000690918
- (id)_initWithItem:(id)arg1 containingView:(id)arg2 useFallbackAncestorScroller:(_Bool)arg3;	// IMP=0x0000000000690836
- (id)init;	// IMP=0x00000000006907ad
