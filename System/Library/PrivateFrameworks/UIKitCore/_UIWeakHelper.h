...
- (void).cxx_destruct;	// IMP=0x000000000112ed26
@property(copy, nonatomic) CDUnknownBlockType deallocationBlock; // @synthesize deallocationBlock=_deallocationBlock;
- (void)dealloc;	// IMP=0x000000000112ecaa
- (id)initWithDeallocationBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000112ec42
