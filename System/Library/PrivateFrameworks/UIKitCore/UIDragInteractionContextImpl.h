...
- (void).cxx_destruct;	// IMP=0x00000000005d4b9a
...
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000005d49c0
- (void)_api_addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000005d49ae
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x00000000005d48bf
