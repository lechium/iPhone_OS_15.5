...
- (void).cxx_destruct;	// IMP=0x00000000003fa57a
...
- (id)_descendantDescription;	// IMP=0x00000000003f9fa8
@property(readonly, copy) NSString *description;
- (void)_layout;	// IMP=0x00000000003f8d0d
...
- (void)_invalidateCurrentOffset;	// IMP=0x00000000003f284b
- (void)_invalidateDetents;	// IMP=0x00000000003f1d6b
@property(retain, nonatomic, setter=_setDetents:) NSArray *_detents;
- (void)_boundingPathMayHaveChangedForView:(id)arg1 relativeToBoundsOriginOnly:(_Bool)arg2;	// IMP=0x00000000003f1412
- (void)_invalidatePreferredSize;	// IMP=0x00000000003f13bf
- (id)init;	// IMP=0x00000000003f10e4
