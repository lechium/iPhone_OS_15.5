...
+ (_Bool)prefersCancelsTouchesInView;	// IMP=0x0000000000d51c36
+ (_Bool)requiresForceCapability;	// IMP=0x0000000000d51c2e
- (void).cxx_destruct;	// IMP=0x0000000000d52210
...
- (void)_handleGestureRecognizer:(id)arg1;	// IMP=0x0000000000d51f2e
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x0000000000d51f0a
- (_Bool)gestureRecognizer:(id)arg1 shouldBeRequiredToFailByGestureRecognizer:(id)arg2;	// IMP=0x0000000000d51e2b
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x0000000000d51e23
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x0000000000d51d71
- (void)cancelInteraction;	// IMP=0x0000000000d51d2f
...
- (id)init;	// IMP=0x0000000000d51ba5
