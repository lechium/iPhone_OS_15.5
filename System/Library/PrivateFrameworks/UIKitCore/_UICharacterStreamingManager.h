...
- (void).cxx_destruct;	// IMP=0x00000000010a84a8
...
- (void)setupToInsertResultForNewHypothesis:(id)arg1;	// IMP=0x00000000010a8359
- (void)_displayLinkFired:(id)arg1;	// IMP=0x00000000010a7a98
- (void)_startStreamingAnimations;	// IMP=0x00000000010a7980
- (void)_stopStreamingAnimation;	// IMP=0x00000000010a790a
- (void)setWords:(id)arg1;	// IMP=0x00000000010a7838
- (void)commitFinalResults;	// IMP=0x00000000010a77e8
- (id)initWithTextView:(id)arg1;	// IMP=0x00000000010a7778
