...
+ (id)requestWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x00000000006b1bb8
- (void).cxx_destruct;	// IMP=0x00000000006b2a46
...
- (id)takeSnapshot;	// IMP=0x00000000006b1e14
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006b1cf1
- (id)initWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x00000000006b1c24
