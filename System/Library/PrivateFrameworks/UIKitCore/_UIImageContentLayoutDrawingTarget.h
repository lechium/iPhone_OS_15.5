...
- (id)_symbolConfigurationForSource:(id)arg1;	// IMP=0x00000000008cb68e
- (long long)_effectiveRenderingModeForSource:(id)arg1 symbolConfiguration:(id)arg2;	// IMP=0x00000000008cb676
- (id)_renditionForSource:(id)arg1 size:(struct CGSize)arg2 symbolConfiguration:(id)arg3 withCGImageProvider:(CDUnknownBlockType)arg4 lazy:(_Bool)arg5;	// IMP=0x00000000008cb48f
- (id)_effectForRenderingSource:(id)arg1;	// IMP=0x00000000008cb486
