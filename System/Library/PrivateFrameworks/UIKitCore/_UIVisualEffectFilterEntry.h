...
- (void).cxx_destruct;	// IMP=0x00000000000febb5
...
- (void)forceUniqueName;	// IMP=0x00000000000fe22e
- (void)convertToIdentity;	// IMP=0x00000000000fe207
- (id)copyForTransitionOut;	// IMP=0x00000000000fe18f
- (id)copyForTransitionToEffect:(id)arg1;	// IMP=0x00000000000fe10c
- (_Bool)canTransitionToEffect:(id)arg1;	// IMP=0x00000000000fe104
- (_Bool)isSameTypeOfEffect:(id)arg1;	// IMP=0x00000000000fdff2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000fdf7f
- (double)scaleHintAsRequested:(_Bool)arg1;	// IMP=0x00000000000fdf6d
- (id)valueAsRequested:(_Bool)arg1;	// IMP=0x00000000000fdf58
@property(readonly, nonatomic) CAFilter *filter;
- (id)initWithFilterType:(id)arg1 configurationValues:(id)arg2 requestedValues:(id)arg3 identityValues:(id)arg4;	// IMP=0x00000000000fdd64
