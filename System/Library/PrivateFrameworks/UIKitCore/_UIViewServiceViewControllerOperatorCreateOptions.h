...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000115adfe
- (void).cxx_destruct;	// IMP=0x000000000115aedc
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000115a9f9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000115a711
