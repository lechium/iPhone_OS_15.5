...
- (void).cxx_destruct;	// IMP=0x0000000000c13c44
...
- (void)_handleGestureRecognizer:(id)arg1;	// IMP=0x0000000000c13b75
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x0000000000c13af9
- (void)cancelInteraction;	// IMP=0x0000000000c13ab7
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x0000000000c13a19
@property(readonly, nonatomic) double touchForce;
- (void)dealloc;	// IMP=0x0000000000c13990
- (id)initWithView:(id)arg1 configuration:(CDUnknownBlockType)arg2;	// IMP=0x0000000000c13861
- (id)initWithGestureRecognizer:(id)arg1;	// IMP=0x0000000000c136f0
