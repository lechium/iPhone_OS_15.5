...
- (void).cxx_destruct;	// IMP=0x0000000000795394
...
- (id)description;	// IMP=0x0000000000795248
@property(readonly, nonatomic, getter=isLoop) _Bool loop;
- (id)commonNode:(id)arg1;	// IMP=0x000000000079509e
- (id)oppositeNode:(id)arg1;	// IMP=0x0000000000795061
- (id)initWithLabel:(id)arg1 sourceNode:(id)arg2 targetNode:(id)arg3 directed:(_Bool)arg4;	// IMP=0x0000000000794ea7
