...
- (void).cxx_destruct;	// IMP=0x000000000105be26
...
- (void)setDefaultResult;	// IMP=0x000000000105b993
- (void)setNoResult;	// IMP=0x000000000105b978
- (void)setAttachmentResult:(id)arg1;	// IMP=0x000000000105b91f
- (void)setAttributedStringResult:(id)arg1;	// IMP=0x000000000105b906
- (void)setStringResult:(id)arg1;	// IMP=0x000000000105b85c
- (id)initWithTextPasteCoordinator:(id)arg1;	// IMP=0x000000000105b7f1
