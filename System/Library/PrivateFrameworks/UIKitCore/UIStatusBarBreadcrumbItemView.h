...
- (void).cxx_destruct;	// IMP=0x0000000000db44ab
...
- (double)extraRightPadding;	// IMP=0x0000000000db443e
- (id)shortenedTitleWithCompressionLevel:(int)arg1;	// IMP=0x0000000000db4398
- (void)userDidActivateButton:(id)arg1;	// IMP=0x0000000000db4301
- (long long)labelLineBreakMode;	// IMP=0x0000000000db42f6
- (_Bool)updateForNewData:(id)arg1 actions:(int)arg2;	// IMP=0x0000000000db40e9
