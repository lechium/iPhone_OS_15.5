...
+ (id)effectWithColor:(id)arg1 offset:(struct CGSize)arg2 insets:(struct UIEdgeInsets)arg3 weight:(double)arg4;	// IMP=0x000000000099852d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009988e2
- (struct CGColor *)CGColor;	// IMP=0x00000000009988c3
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009987be
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000998624
- (id)initWithColor:(id)arg1 offset:(struct CGSize)arg2 insets:(struct UIEdgeInsets)arg3 weight:(double)arg4;	// IMP=0x000000000099858e
