...
- (void).cxx_destruct;	// IMP=0x0000000000b8acf0
...
- (void)createDynamicColors;	// IMP=0x0000000000b8a1e2
- (id)vibrancyEffectForBlur:(id)arg1;	// IMP=0x0000000000b8a1c4
- (id)initWithKeyboardAppearance:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000b8a0f0
