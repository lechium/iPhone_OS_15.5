...
+ (double)defaultDuration;	// IMP=0x000000000049d385
+ (id)timingCurveProviderWithVelocity:(double)arg1;	// IMP=0x000000000049d347
+ (id)timingCurveProvider;	// IMP=0x000000000049d32e
- (void).cxx_destruct;	// IMP=0x000000000049d482
...
- (id)description;	// IMP=0x000000000049d294
