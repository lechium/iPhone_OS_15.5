...
- (void).cxx_destruct;	// IMP=0x00000000008f8646
...
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000008f8518
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000008f8462
- (_Bool)shouldTrack;	// IMP=0x00000000008f845a
@property(readonly, nonatomic) unsigned long long numberOfSegments;
- (void)updateSelectionWithPoint:(struct CGPoint)arg1;	// IMP=0x00000000008f833f
- (void)_populateSegmentViewsWithCount:(unsigned long long)arg1;	// IMP=0x00000000008f7d81
- (void)_removeAllSegmentViews;	// IMP=0x00000000008f7bb6
- (void)layoutSubviews;	// IMP=0x00000000008f7b41
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000008f7891
