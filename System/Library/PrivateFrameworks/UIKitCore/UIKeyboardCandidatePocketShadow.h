...
+ (id)leftShadowImage;	// IMP=0x00000000008af4dd
+ (double)widthWithShadow:(_Bool)arg1;	// IMP=0x00000000008af424
...
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x00000000008afd70
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000008af5dc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000008af554
