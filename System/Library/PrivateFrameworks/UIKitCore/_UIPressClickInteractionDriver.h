...
+ (_Bool)prefersCancelsTouchesInView;	// IMP=0x00000000005d3af7
+ (_Bool)requiresForceCapability;	// IMP=0x00000000005d3aef
- (void).cxx_destruct;	// IMP=0x00000000005d4351
...
- (void)_handlePressGesture:(id)arg1;	// IMP=0x00000000005d4079
- (void)_removeFromView;	// IMP=0x00000000005d3fe4
- (void)_addToView:(id)arg1;	// IMP=0x00000000005d3e44
@property(nonatomic) unsigned long long driverStyle;
- (void)cancelInteraction;	// IMP=0x00000000005d3d28
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x00000000005d3b4b
...
- (id)init;	// IMP=0x00000000005d38a3
