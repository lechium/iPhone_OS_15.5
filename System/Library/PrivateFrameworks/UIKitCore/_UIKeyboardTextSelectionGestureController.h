...
+ (id)sharedInstance;	// IMP=0x0000000000b37b3c
...
- (void)configureOneFingerForcePressRecognizer:(id)arg1;	// IMP=0x0000000000b38497
- (void)configureTwoFingerTapGestureRecognizer:(id)arg1;	// IMP=0x0000000000b38451
- (void)configureTwoFingerPanGestureRecognizer:(id)arg1;	// IMP=0x0000000000b3840b
- (id)addLongPressTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000b3837f
- (id)addTwoFingerTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000b3825f
- (id)addOneFingerTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000b381bc
- (_Bool)_longPressAllowedForView:(id)arg1;	// IMP=0x0000000000b381a0
- (_Bool)allowOneFingerDeepPress;	// IMP=0x0000000000b38198
- (double)oneFingerForcePressAllowableMovement;	// IMP=0x0000000000b3818a
- (_Bool)oneFingerForcePressShouldCancelTouchesInView;	// IMP=0x0000000000b38182
- (_Bool)oneFingerForcePressShouldFailWithoutForce;	// IMP=0x0000000000b3817a
- (double)oneFingerForcePressMinimumDuration;	// IMP=0x0000000000b3816c
- (void)redisableEnclosingScrollViewNestedPinching;	// IMP=0x0000000000b380b6
- (void)enableEnclosingScrollViewNestedPinching;	// IMP=0x0000000000b37ff6
- (void)didRemoveSelectionController;	// IMP=0x0000000000b37ff0
- (void)willRemoveSelectionController;	// IMP=0x0000000000b37f55
- (void)_cleanupDeadGesturesIfNecessary;	// IMP=0x0000000000b37ea2
- (id)selectionController;	// IMP=0x0000000000b37e77
- (void)dealloc;	// IMP=0x0000000000b37cd5
- (void)removeDeallocationHandler:(id)arg1;	// IMP=0x0000000000b37cb8
- (id)addDeallocationHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b37c42
- (id)init;	// IMP=0x0000000000b37bc4
- (_Bool)shouldAddForceGesture;	// IMP=0x0000000000b37b92
- (Class)textInteractionClass;	// IMP=0x0000000000b37b81
