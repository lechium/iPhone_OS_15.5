...
- (void).cxx_destruct;	// IMP=0x00000000003a7dba
...
- (_Bool)_hasDropActionTarget;	// IMP=0x00000000003a7cac
@property(readonly, nonatomic) NSIndexPath *effectiveIndexPath;
- (void)updateFromDropProposal:(id)arg1;	// IMP=0x00000000003a7c55
- (void)didPerformDrop;	// IMP=0x00000000003a7c35
- (id)description;	// IMP=0x00000000003a7afd
- (id)init;	// IMP=0x00000000003a7a78
