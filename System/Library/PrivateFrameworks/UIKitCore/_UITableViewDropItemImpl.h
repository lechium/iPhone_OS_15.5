...
- (void).cxx_destruct;	// IMP=0x0000000000efef58
...
- (void)_translateSourceIndexPath:(CDUnknownBlockType)arg1;	// IMP=0x0000000000efeedf
@property(readonly, nonatomic) struct CGSize previewSize;
- (id)initWithDragItem:(id)arg1 sourceIndexPath:(id)arg2;	// IMP=0x0000000000efedd2
