...
- (void).cxx_destruct;	// IMP=0x000000000111c63e
...
- (void)setPoint:(struct CGPoint)arg1 forContentOffset:(struct CGPoint)arg2;	// IMP=0x000000000111c513
- (void)_adjustPointToCurrentContentOffset;	// IMP=0x000000000111c486
- (void)_handleAutoScrollerWithContentOffset:(struct CGPoint)arg1 direction:(unsigned long long)arg2;	// IMP=0x000000000111c410
- (void)displayLinkFired:(id)arg1;	// IMP=0x000000000111c1ea
- (_Bool)_scrollContinuous;	// IMP=0x000000000111c183
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (void)stop;	// IMP=0x000000000111c0e7
- (void)autoScrollFromPoint:(struct CGPoint)arg1;	// IMP=0x000000000111beb9
- (id)initWithScrollView:(id)arg1;	// IMP=0x000000000111bd80
