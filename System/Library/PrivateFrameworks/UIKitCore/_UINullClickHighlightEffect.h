...
+ (id)effectWithPreview:(id)arg1 continuingFromPreview:(id)arg2;	// IMP=0x0000000000214cc8
- (void).cxx_destruct;	// IMP=0x0000000000214db3
...
- (void)interaction:(id)arg1 didChangeWithContext:(id)arg2;	// IMP=0x0000000000214d15
