...
- (void).cxx_destruct;	// IMP=0x00000000003ca1a9
...
- (_Bool)currentSateCanTransitionWithEvents:(id)arg1;	// IMP=0x00000000003ca065
@property(readonly, nonatomic) unsigned long long *currentStateRef;
- (void)_updateFromState:(unsigned long long)arg1;	// IMP=0x00000000003ca035
- (id)initWithUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000003c9f45
