...
- (void)startArbitrationWithExpectedState:(_UIKeyboardChangedInformation *)arg1 sceneIdentity:(FBSSceneIdentityToken *)arg2 hostingPIDs:(NSArray *)arg3 usingFence:(_Bool)arg4 withSuppression:(int)arg5 onConnected:(void (^)(_UIKeyboardChangedInformation *, long long, _Bool))arg6;
