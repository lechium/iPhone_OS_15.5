...
- (void)recalculateForDecelerationTarget:(struct CGPoint)arg1;	// IMP=0x000000000123d93e
- (void)calculateToReachDecelerationTarget;	// IMP=0x000000000123d938
- (void)calculateDecelerationTarget;	// IMP=0x000000000123d932
- (_Bool)isRubberBandingAfterDuration:(double)arg1;	// IMP=0x000000000123d92a
- (struct CGPoint)positionAfterDuration:(double)arg1;	// IMP=0x000000000123d914
- (struct CGVector)velocityAfterDuration:(double)arg1;	// IMP=0x000000000123d908
- (double)speedAfterDuration:(double)arg1;	// IMP=0x000000000123d8ff
@property(readonly, nonatomic) double durationUntilStop;
- (id)initWithInitialContentOffset:(struct CGPoint)arg1 velocity:(struct CGVector)arg2 contentFrame:(struct CGRect)arg3 viewSize:(struct CGSize)arg4 screenScale:(double)arg5;	// IMP=0x000000000123d7ea
- (id)init;	// IMP=0x000000000123d77f
