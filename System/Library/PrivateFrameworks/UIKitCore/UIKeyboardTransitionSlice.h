...
+ (id)sliceWithStart:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0000000000b482a7
...
- (id)description;	// IMP=0x0000000000b483ce
@property(readonly) _Bool hasGeometry;
- (void)addStartRect:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0000000000b48311
- (void)dealloc;	// IMP=0x0000000000b4825d
- (id)init;	// IMP=0x0000000000b481f9
