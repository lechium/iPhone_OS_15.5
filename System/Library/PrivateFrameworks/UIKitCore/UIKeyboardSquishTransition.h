...
- (id)meshTransformForKeyplane:(id)arg1 toKeyplane:(id)arg2;	// IMP=0x0000000000b518ed
- (id)symmetricMeshTransformForKeyplane:(id)arg1;	// IMP=0x0000000000b4fe07
- (_Bool)_allowFacesToAdjoinToAdjacentFaces;	// IMP=0x0000000000b4fdb8
- (id)geometriesForKeyplane:(id)arg1;	// IMP=0x0000000000b4fd94
- (id)sortedCommonVisibleKeys;	// IMP=0x0000000000b4fca0
- (void)updateOpacityAnimation:(id)arg1;	// IMP=0x0000000000b4fb17
- (void)updateWithProgress:(double)arg1;	// IMP=0x0000000000b4f9a0
- (void)removeAllAnimations;	// IMP=0x0000000000b4f8aa
- (void)_updateTransition;	// IMP=0x0000000000b4f766
- (id)_animationsForEnd;	// IMP=0x0000000000b4f2c2
- (id)_animationsForStart;	// IMP=0x0000000000b4ee10
- (void)commitTransitionRebuild;	// IMP=0x0000000000b4ed64
- (void)rebuildWithStartKeyplane:(id)arg1 startView:(id)arg2 endKeyplane:(id)arg3 endView:(id)arg4;	// IMP=0x0000000000b4ea06
- (void)dealloc;	// IMP=0x0000000000b4e981
