...
- (void).cxx_destruct;	// IMP=0x00000000011b1172
...
- (id)debugDescription;	// IMP=0x00000000011b0f84
- (id)transformer;	// IMP=0x00000000011b0f6f
- (void)setTransformer:(id)arg1;	// IMP=0x00000000011b0f5b
- (void)invalidateAndStopImmediately:(_Bool)arg1;	// IMP=0x00000000011b0deb
- (void)invalidate;	// IMP=0x00000000011b0dd4
- (_Bool)_performAnimation;	// IMP=0x00000000011b0a7b
- (id)velocityTarget:(_Bool)arg1;	// IMP=0x00000000011b05e9
@property(nonatomic) id velocity;
- (void)setVelocity:(id)arg1 target:(_Bool)arg2;	// IMP=0x00000000011b02a0
@property(retain, nonatomic) UIViewRunningAnimationEntry *animationEntry;
- (void)invalidateIfPossible;	// IMP=0x00000000011b006a
- (id)initWithInvalidationCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000011affb2
- (_Bool)animatePropertyWithCurrentValue:(id)arg1 targetValue:(id)arg2 preTickShouldRemoveCallback:(CDUnknownBlockType)arg3 newValueCallback:(CDUnknownBlockType)arg4 removedCallback:(CDUnknownBlockType)arg5;	// IMP=0x00000000011afecf
