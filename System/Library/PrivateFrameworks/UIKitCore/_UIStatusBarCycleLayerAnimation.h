...
+ (id)cycleAnimationWithLayer:(id)arg1 animation:(id)arg2 key:(id)arg3;	// IMP=0x0000000000e3e736
- (void).cxx_destruct;	// IMP=0x0000000000e3ea54
...
- (id)description;	// IMP=0x0000000000e3e8f3
