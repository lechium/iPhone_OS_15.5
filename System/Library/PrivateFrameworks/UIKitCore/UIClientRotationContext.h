...
- (void)finishFullRotateUsingOnePartAnimation:(_Bool)arg1;	// IMP=0x0000000000416f60
- (void)finishFirstHalfRotation;	// IMP=0x0000000000416ad6
- (void)rotateSnapshots;	// IMP=0x00000000004163f9
- (void)setupRotationOrderingKeyboardInAfterRotation:(_Bool)arg1;	// IMP=0x0000000000415772
- (_Bool)_isFooterTranslucent;	// IMP=0x000000000041572d
- (_Bool)_isHeaderTranslucent;	// IMP=0x00000000004156b0
- (void)_positionHeaderView:(id)arg1 andFooterView:(id)arg2 outsideContentViewForInterfaceOrientation:(long long)arg3;	// IMP=0x00000000004153fc
- (void)slideHeaderViewAndFooterViewOffScreen:(_Bool)arg1 forInterfaceOrientation:(long long)arg2;	// IMP=0x00000000004153dc
- (void)_slideHeaderView:(id)arg1 andFooterView:(id)arg2 offScreen:(_Bool)arg3 forInterfaceOrientation:(long long)arg4;	// IMP=0x00000000004150fd
- (void)dealloc;	// IMP=0x0000000000415094
- (id)initWithClient:(id)arg1 toOrientation:(long long)arg2 duration:(double)arg3 andWindow:(id)arg4;	// IMP=0x0000000000414e48
