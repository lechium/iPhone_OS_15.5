...
- (id)_timingFunctionForAnimationInView:(id)arg1 withKeyPath:(id)arg2;	// IMP=0x00000000003d53dc
- (id)_basicAnimationForView:(id)arg1 withKeyPath:(id)arg2;	// IMP=0x00000000003d53c0
- (id)initWithCurve:(unsigned long long)arg1;	// IMP=0x00000000003d5383
