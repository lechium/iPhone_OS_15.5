...
- (void).cxx_destruct;	// IMP=0x000000000078435a
@property(readonly, nonatomic) unsigned long long touchedEdges; // @synthesize touchedEdges=_touchedEdges;
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x00000000007842a7
- (id)debugDictionary;	// IMP=0x00000000007841f8
- (id)initWithSettings:(id)arg1;	// IMP=0x0000000000784170
