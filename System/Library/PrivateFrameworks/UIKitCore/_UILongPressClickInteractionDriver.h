...
+ (_Bool)prefersCancelsTouchesInView;	// IMP=0x00000000004112c8
+ (_Bool)requiresForceCapability;	// IMP=0x00000000004112c0
- (void).cxx_destruct;	// IMP=0x00000000004121d2
...
- (void)_gestureRecognizerFailed:(id)arg1;	// IMP=0x0000000000412125
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x000000000041211d
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x0000000000412024
- (_Bool)gestureRecognizer:(id)arg1 shouldBeRequiredToFailByGestureRecognizer:(id)arg2;	// IMP=0x0000000000411e87
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x0000000000411e03
- (void)_notifyDelegateOfUpdatedClickDownProgress:(double)arg1 forceAdjustedClickDownDuration:(double)arg2;	// IMP=0x0000000000411cb7
- (void)_updateForActiveGestureRecognizer;	// IMP=0x0000000000411a1e
- (void)_asyncGestureBegan;	// IMP=0x00000000004119c0
- (void)_handleGestureRecognizer:(id)arg1;	// IMP=0x00000000004117d9
...
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x000000000041155e
- (void)cancelInteraction;	// IMP=0x00000000004114d6
...
- (id)init;	// IMP=0x0000000000410d8f
