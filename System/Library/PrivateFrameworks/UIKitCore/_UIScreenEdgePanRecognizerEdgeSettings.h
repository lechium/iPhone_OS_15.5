...
+ (id)settingsControllerModule;	// IMP=0x00000000007ce8e0
+ (id)keyPathsForValuesAffectingEdgeAngleWindowDegreees;	// IMP=0x00000000007ce8c0
...
- (void)setDefaultValues;	// IMP=0x00000000007ce70b
