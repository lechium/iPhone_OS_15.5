...
- (void).cxx_destruct;	// IMP=0x0000000000c06821
...
- (void)dealloc;	// IMP=0x0000000000c066fe
- (void)finalizeEffect;	// IMP=0x0000000000c066e5
- (void)applyBackgroundEffectWithMagnitude:(double)arg1 interactive:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000c0666a
