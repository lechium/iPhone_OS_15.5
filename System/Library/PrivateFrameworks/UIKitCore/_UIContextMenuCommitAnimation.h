...
- (void)_prepareAnimationViews;	// IMP=0x000000000030b571
- (void)_prepareSnapshots;	// IMP=0x000000000030b218
- (void)animateWithAlongsideActions:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000030a59f
- (id)initWithSource:(id)arg1 container:(id)arg2;	// IMP=0x000000000030a479
