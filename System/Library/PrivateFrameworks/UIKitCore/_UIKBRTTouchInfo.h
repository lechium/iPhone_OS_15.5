...
+ (id)createTouchInfoForTouch:(id)arg1 withIdentifier:(id)arg2 canLogTouch:(_Bool)arg3;	// IMP=0x0000000000b1a1e7
+ (id)touchInfoForTouch:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0000000000b1a140
+ (void)setTouchInfo:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x0000000000b1a09e
+ (id)touchDict;	// IMP=0x0000000000b1a02c
- (void).cxx_destruct;	// IMP=0x0000000000b1aee8
...
- (_Bool)willChangeTouchInfo:(id)arg1 toState:(BOOL)arg2;	// IMP=0x0000000000b1accc
- (id)setOfTouchesToIgnoreWhenSettingTouchInfo:(id)arg1 toState:(BOOL)arg2;	// IMP=0x0000000000b1a858
- (void)cleanup;	// IMP=0x0000000000b1a7e8
- (void)invalidateTimer;	// IMP=0x0000000000b1a756
- (void)fireTimerNow;	// IMP=0x0000000000b1a6b0
- (void)setTimerWithTimeInterval:(double)arg1 onQueue:(id)arg2 do:(CDUnknownBlockType)arg3;	// IMP=0x0000000000b1a56f
- (void)updateTouch:(id)arg1;	// IMP=0x0000000000b1a47f
@property(readonly, nonatomic) _UIKBRTTouchInfo *nextTouch;
@property(readonly, nonatomic) _UIKBRTTouchInfo *previousTouch;
- (void)dealloc;	// IMP=0x0000000000b1a41d
- (id)initWithTouch:(id)arg1 withIdentifier:(id)arg2 canLogTouch:(_Bool)arg3;	// IMP=0x0000000000b1a282
