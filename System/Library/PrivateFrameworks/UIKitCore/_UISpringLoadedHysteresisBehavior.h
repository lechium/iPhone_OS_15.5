...
- (void).cxx_destruct;	// IMP=0x00000000005e6fad
...
- (void)_tick:(id)arg1;	// IMP=0x00000000005e6e64
- (void)setupDisplayLink;	// IMP=0x00000000005e6d04
- (void)interactionDidFinish:(id)arg1;	// IMP=0x00000000005e6cc7
- (_Bool)shouldAllowInteraction:(id)arg1 withContext:(id)arg2;	// IMP=0x00000000005e6c62
