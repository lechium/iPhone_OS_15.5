...
+ (id)transformerWithAxisTransitionZonePosition:(struct CGPoint)arg1 axisTransitionZoneSize:(struct CGSize)arg2;	// IMP=0x0000000000bf0a55
- (void).cxx_destruct;	// IMP=0x0000000000bf19e6
...
- (void)didEndPanningWithTouchPosition:(struct CGPoint)arg1 currentTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000bf16d4
- (void)didPanWithTouchPosition:(struct CGPoint)arg1 currentTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000bf0e8d
- (void)didBeginPanningWithTouchPosition:(struct CGPoint)arg1 currentTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000bf0ccc
@property(readonly, nonatomic) struct CGVector velocity;
@property(readonly, nonatomic) struct CGVector offset;
- (void)_enterYLockedState;	// IMP=0x0000000000bf0b70
- (void)lockIntoYAxis;	// IMP=0x0000000000bf0b59
- (double)timeIntervalSinceLastDirectionChange;	// IMP=0x0000000000bf0aa7
- (id)initWithAxisTransitionZonePosition:(struct CGPoint)arg1 axisTransitionZoneSize:(struct CGSize)arg2;	// IMP=0x0000000000bf095c
