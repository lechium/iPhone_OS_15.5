...
- (void).cxx_destruct;	// IMP=0x0000000000d82fbb
...
- (void)applyTransform:(struct CGAffineTransform)arg1;	// IMP=0x0000000000d82ed1
- (void)updateWithHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x0000000000d82ac8
- (id)init;	// IMP=0x0000000000d82a8c
