...
+ (id)actionWithTarget:(id)arg1 selector:(SEL)arg2 object:(id)arg3;	// IMP=0x000000000111647e
+ (id)_invocationForTarget:(id)arg1 selector:(SEL)arg2 object:(id)arg3;	// IMP=0x0000000001116328
- (void).cxx_destruct;	// IMP=0x0000000001116f40
...
- (void)dealloc;	// IMP=0x0000000001116e45
- (void)reset;	// IMP=0x0000000001116d18
- (void)invalidate;	// IMP=0x0000000001116ca0
- (void)schedule;	// IMP=0x0000000001116ace
- (void)_repeatedTimerFire;	// IMP=0x0000000001116a84
- (void)_invocationTimerFire;	// IMP=0x0000000001116a36
- (void)_preInvocationTimerFire;	// IMP=0x00000000011169e8
- (void)_adjustInvocationForPhase:(unsigned long long)arg1;	// IMP=0x0000000001116832
- (_Bool)invoke;	// IMP=0x0000000001116706
- (void)scheduleWithTarget:(id)arg1 selector:(SEL)arg2 object:(id)arg3;	// IMP=0x0000000001116649
- (id)initWithInvocation:(id)arg1;	// IMP=0x00000000011165c2
- (id)initWithTarget:(id)arg1 selector:(SEL)arg2 object:(id)arg3;	// IMP=0x00000000011164f9
