...
- (void).cxx_destruct;	// IMP=0x00000000000fee43
...
- (id)description;	// IMP=0x00000000000feced
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000fec46
- (id)initWithHost:(id)arg1;	// IMP=0x00000000000fec09
