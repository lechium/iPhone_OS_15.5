...
- (void).cxx_destruct;	// IMP=0x0000000000f68000
...
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f67db8
- (id)previewForContinuingToEffectWithPreview:(id)arg1;	// IMP=0x0000000000f67bee
- (void)setDescriptor:(id)arg1 andKey:(id)arg2;	// IMP=0x0000000000f67a84
@property(readonly, nonatomic) id <_UIContentEffectDescriptor> descriptor;
- (void)_monitoredView:(id)arg1 didMoveFromSuperview:(id)arg2 toSuperview:(id)arg3;	// IMP=0x0000000000f67a6c
- (void)_monitoredView:(id)arg1 willMoveFromSuperview:(id)arg2 toSuperview:(id)arg3;	// IMP=0x0000000000f6790c
- (_Bool)_monitorsView:(id)arg1;	// IMP=0x0000000000f67859
- (void)_ensureRelativeEffectViewOrderInContainer;	// IMP=0x0000000000f673f6
- (void)_modifyEffectContainerViewHierarchy:(CDUnknownBlockType)arg1 waitForCACommit:(_Bool)arg2;	// IMP=0x0000000000f67314
- (void)_cleanUpObservation;	// IMP=0x0000000000f671b5
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000f66e2d
- (void)_anchorPlatterView:(id)arg1 toPreview:(id)arg2 updateBounds:(_Bool)arg3;	// IMP=0x0000000000f66461
- (id)_positionReferenceViewForPreview:(id)arg1;	// IMP=0x0000000000f661f0
- (void)_tearDownPlatterView;	// IMP=0x0000000000f66189
- (void)_createAndInstallPlatterView;	// IMP=0x0000000000f65904
- (void)_commitPointerStyleToArbiterWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f6541d
- (void)_updateFromState:(long long)arg1 toState:(long long)arg2;	// IMP=0x0000000000f64634
- (void)setPressed:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000f64517
- (void)end:(_Bool)arg1;	// IMP=0x0000000000f644ad
- (void)begin;	// IMP=0x0000000000f64450
- (void)_updatePlatterView:(id)arg1 forStyle:(id)arg2;	// IMP=0x0000000000f642b9
- (void)_setStyle:(id)arg1 andRegion:(id)arg2;	// IMP=0x0000000000f64196
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000f640a5
- (void)dealloc;	// IMP=0x0000000000f64067
- (id)initWithStyle:(id)arg1 region:(id)arg2;	// IMP=0x0000000000f63f11
