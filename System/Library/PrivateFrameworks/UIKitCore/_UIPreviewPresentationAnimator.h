...
- (void).cxx_destruct;	// IMP=0x0000000000c1ab98
...
- (void)_advanceFromDisplayLink:(id)arg1;	// IMP=0x0000000000c1a9e7
- (void)stopAnimation;	// IMP=0x0000000000c1a97e
- (id)initWithDuration:(double)arg1 advanceBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000c1a805
- (id)init;	// IMP=0x0000000000c1a7f7
