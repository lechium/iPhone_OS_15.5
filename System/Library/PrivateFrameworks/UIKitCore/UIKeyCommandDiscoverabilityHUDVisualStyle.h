...
+ (id)visualStyleForTraitCollection:(id)arg1;	// IMP=0x0000000000cd314c
- (double)columnDividerHeightForHUDHeight:(double)arg1;	// IMP=0x0000000000cd3143
- (double)maxHUDHeightForHeight:(double)arg1;	// IMP=0x0000000000cd313a
- (double)maxHUDWidthForWidth:(double)arg1;	// IMP=0x0000000000cd3131
