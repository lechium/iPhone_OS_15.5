...
- (void).cxx_destruct;	// IMP=0x00000000007d1bcc
...
- (unsigned long long)_targetEdges;	// IMP=0x00000000007d1a23
- (void)_idleTimerElapsed:(id)arg1;	// IMP=0x00000000007d1898
- (void)_longPressTimerElapsed:(id)arg1;	// IMP=0x00000000007d175c
- (void)_incorporateIncrementalSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x00000000007d0730
- (void)_incorporateInitialTouchAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x00000000007cfdec
- (void)incorporateTouchSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x00000000007cfd61
- (unsigned long long)touchedEdgesForInterfaceOrientation:(long long)arg1;	// IMP=0x00000000007cfcd1
- (long long)_type;	// IMP=0x00000000007cfcc4
- (void)_setState:(long long)arg1;	// IMP=0x00000000007cfb33
@property(readonly, nonatomic) _Bool useGrapeFlags;
- (void)reset;	// IMP=0x00000000007cfa9e
- (void)dealloc;	// IMP=0x00000000007cfa62
- (id)initWithType:(long long)arg1;	// IMP=0x00000000007cfa03
- (id)initWithType:(long long)arg1 settings:(id)arg2;	// IMP=0x00000000007cf7eb
