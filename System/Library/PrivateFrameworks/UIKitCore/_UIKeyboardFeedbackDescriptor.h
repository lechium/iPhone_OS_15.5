...
+ (id)descriptorWithIntensity:(float)arg1 sharpness:(float)arg2 audio:(id)arg3 volume:(float)arg4;	// IMP=0x000000000064c8ed
- (void).cxx_destruct;	// IMP=0x000000000064c9ea
