...
- (void).cxx_destruct;	// IMP=0x00000000006d9405
...
- (id)_requestByRedirectingRequestToFocusSystem:(id)arg1;	// IMP=0x00000000006d90ec
- (id)initWithFocusSystem:(id)arg1 window:(id)arg2;	// IMP=0x00000000006d8fe3
- (id)init;	// IMP=0x00000000006d8f5c
