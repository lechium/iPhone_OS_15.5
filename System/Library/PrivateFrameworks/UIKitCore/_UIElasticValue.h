...
- (id)description;	// IMP=0x0000000000c0392e
@property(readonly, nonatomic, getter=isSteady) _Bool steady;
- (void)updateFromDisplayLink:(id)arg1;	// IMP=0x0000000000c03870
- (void)update:(double)arg1;	// IMP=0x0000000000c0382b
- (id)initWithValue:(double)arg1;	// IMP=0x0000000000c037ce
- (id)init;	// IMP=0x0000000000c0376e
