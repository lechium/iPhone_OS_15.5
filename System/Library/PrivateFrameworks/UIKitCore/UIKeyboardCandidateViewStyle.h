...
+ (_Bool)resolveInstanceMethod:(SEL)arg1;	// IMP=0x00000000008c622b
+ (id)tvStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x00000000008c5e58
+ (id)disambiguationStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x00000000008c5e26
+ (id)styleForDarkKeyboard:(_Bool)arg1;	// IMP=0x00000000008c5df4
+ (id)darkKeyboardStyleForDisambiguation;	// IMP=0x00000000008c5b82
+ (id)lightKeyboardStyleForDisambiguation;	// IMP=0x00000000008c595e
+ (id)darkKeyboardStyle;	// IMP=0x00000000008c554b
+ (id)lightKeyboardStyle;	// IMP=0x00000000008c5138
- (void).cxx_destruct;	// IMP=0x00000000008c6af3
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008c49aa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008c45da
