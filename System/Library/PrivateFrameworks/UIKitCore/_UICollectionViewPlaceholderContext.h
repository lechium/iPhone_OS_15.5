...
- (void).cxx_destruct;	// IMP=0x00000000003a1914
...
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000003a17db
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x00000000003a1769
@property(readonly, copy) NSString *description;
- (void)setNeedsCellUpdate;	// IMP=0x00000000003a1654
- (_Bool)commitInsertionWithDataSourceUpdates:(CDUnknownBlockType)arg1;	// IMP=0x00000000003a15da
- (_Bool)deletePlaceholder;	// IMP=0x00000000003a1573
- (id)initWithOriginalInsertionIndexPath:(id)arg1 dragItem:(id)arg2 reuseIdentifier:(id)arg3 delegate:(id)arg4 cellUpdateHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000003a1447
