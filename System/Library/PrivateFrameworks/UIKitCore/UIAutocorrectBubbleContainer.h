...
- (void).cxx_destruct;	// IMP=0x0000000000bbcd74
...
- (void)performReset;	// IMP=0x0000000000bbca65
- (_Bool)isViewAnimating;	// IMP=0x0000000000bbc9cc
- (void)reset;	// IMP=0x0000000000bbc995
- (void)animateAutocorrectionAccepted;	// IMP=0x0000000000bbc672
- (void)dismissAutocorrectBubble;	// IMP=0x0000000000bbc613
- (void)didTapAutocorrectionBubble;	// IMP=0x0000000000bbc601
- (id)createTypedTextViewWithTypedText:(id)arg1;	// IMP=0x0000000000bbc222
- (void)updateSelfWithRect:(struct CGRect)arg1;	// IMP=0x0000000000bbbbef
- (void)updateBubbleWithAutocorrectionText:(id)arg1 referenceRect:(struct CGRect)arg2;	// IMP=0x0000000000bbb814
- (void)updateFakeTextSelectionHighlightForRect:(struct CGRect)arg1;	// IMP=0x0000000000bbb265
- (void)updateWithAutocorrectionText:(id)arg1 typedText:(id)arg2 referenceTextView:(id)arg3 referenceRect:(struct CGRect)arg4;	// IMP=0x0000000000bbb1a5
- (id)init;	// IMP=0x0000000000bbb12b
