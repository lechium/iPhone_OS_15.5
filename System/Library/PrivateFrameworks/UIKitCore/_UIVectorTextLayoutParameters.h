...
+ (id)parametersSuitableForView:(id)arg1;	// IMP=0x00000000011f2f02
- (void).cxx_destruct;	// IMP=0x00000000011f330b
...
- (_Bool)isEqualToParameters:(id)arg1;	// IMP=0x00000000011f3157
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000011f3128
- (void)_copyFromParameters:(id)arg1;	// IMP=0x00000000011f3031
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000011f2fc9
