...
+ (void)setupRelationsBetweenDisplayItemStates:(id)arg1 visualProvider:(id)arg2;	// IMP=0x0000000000e4bc03
+ (id)stateForDisplayItemWithIdentifier:(id)arg1 statusBar:(id)arg2;	// IMP=0x0000000000e4b454
- (void).cxx_destruct;	// IMP=0x0000000000e4f304
...
- (id)description;	// IMP=0x0000000000e4ee60
@property(readonly, nonatomic) long long priority;
@property(readonly, copy, nonatomic) NSArray *potentialPlacementRegionIdentifiers;
- (_Bool)isCurrentPlacement:(id)arg1;	// IMP=0x0000000000e4eac8
- (_Bool)prepareAnimation:(id)arg1;	// IMP=0x0000000000e4e585
- (id)_animationWithUpdateAnimation:(id)arg1;	// IMP=0x0000000000e4e2f5
- (void)_cancelObsoleteAnimations;	// IMP=0x0000000000e4e0fe
@property(readonly, nonatomic, getter=_animationType) long long animationType;
- (id)_effectiveStyleAttributesFromStyleAttributes:(id)arg1 data:(id)arg2 styleAttributesChanged:(_Bool *)arg3;	// IMP=0x0000000000e4dbd3
- (id)_updateForUpdatedData:(id)arg1 updatedStyleAttributes:(id)arg2 updatedEnability:(id)arg3;	// IMP=0x0000000000e4d9b5
- (id)_updateForItem:(id)arg1 data:(id)arg2 styleAttributes:(id)arg3;	// IMP=0x0000000000e4d6fb
- (id)updateWithData:(id)arg1 styleAttributes:(id)arg2;	// IMP=0x0000000000e4cffd
- (_Bool)updatePlacement;	// IMP=0x0000000000e4cf20
- (void)resetToPreferredPlacement;	// IMP=0x0000000000e4cf0a
- (_Bool)_updatePlacementWithRecursionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000e4cd80
- (_Bool)_resolveDependentItemStatesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000e4cade
- (void)_updateStatuses;	// IMP=0x0000000000e4c9ff
- (void)prepareForDataUpdate;	// IMP=0x0000000000e4c9e8
- (id)placementStateForPlacement:(id)arg1;	// IMP=0x0000000000e4ba3e
- (void)addPlacement:(id)arg1 inRegion:(id)arg2;	// IMP=0x0000000000e4b85a
- (_Bool)_updateToNextPlacementStateIfNeeded;	// IMP=0x0000000000e4b7cd
- (void)updateToNextEnabledPlacement;	// IMP=0x0000000000e4b796
@property(readonly, nonatomic) _UIStatusBarDisplayItemPlacementState *currentPlacementState;
- (_Bool)hasRunningAnimations;	// IMP=0x0000000000e4b712
