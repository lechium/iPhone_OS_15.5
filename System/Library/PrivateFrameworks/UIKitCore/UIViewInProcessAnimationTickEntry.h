...
- (void).cxx_destruct;	// IMP=0x00000000011c91d9
...
- (id)initWithPreferredFrameRateRange:(struct CAFrameRateRange)arg1 updateReason:(unsigned int)arg2 velocityUsableForVFD:(_Bool)arg3 callback:(CDUnknownBlockType)arg4;	// IMP=0x00000000011c9111
