...
- (struct CGRect)boundingRectForGlyphsInRange:(struct _NSRange)arg1;	// IMP=0x0000000000b85738
- (void)placeGlyphs;	// IMP=0x0000000000b855c0
- (void)removeGlyphs;	// IMP=0x0000000000b854aa
- (void)buildGlyphViews;	// IMP=0x0000000000b843e4
- (void)dealloc;	// IMP=0x0000000000b84367
- (id)initWithLabel:(id)arg1 attributedString:(id)arg2;	// IMP=0x0000000000b841ef
