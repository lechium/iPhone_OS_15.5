...
+ (id)_darkStyleGlyphColor;	// IMP=0x0000000000a7535f
+ (id)_standardGlyphColor;	// IMP=0x0000000000a75326
- (void).cxx_destruct;	// IMP=0x0000000000a75987
...
- (id)imageWithRenderConfig:(id)arg1;	// IMP=0x0000000000a755cc
- (id)initWithImageName:(id)arg1 identifier:(id)arg2;	// IMP=0x0000000000a75378
