...
+ (id)componentsFromDateFormatString:(id)arg1 locale:(id)arg2 desiredUnits:(long long)arg3;	// IMP=0x0000000000c48685
+ (id)componentsFromDateFormatString:(id)arg1 locale:(id)arg2;	// IMP=0x0000000000c48669
- (void).cxx_destruct;	// IMP=0x0000000000c490da
...
- (id)description;	// IMP=0x0000000000c48e69
- (id)_initWithFormatString:(id)arg1 calendarUnit:(unsigned long long)arg2;	// IMP=0x0000000000c48dcc
