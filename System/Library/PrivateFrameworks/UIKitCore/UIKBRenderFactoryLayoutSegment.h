...
+ (id)segmentWithTraits:(id)arg1;	// IMP=0x000000000096a200
...
- (_Bool)containsPoint:(struct CGPoint)arg1 inRect:(struct CGRect)arg2 withKeyplane:(id)arg3;	// IMP=0x000000000096a45c
- (void)addRelativeLayoutRectFromEdge:(unsigned long long)arg1 ofCachedKey:(id)arg2;	// IMP=0x000000000096a3aa
- (void)addLayoutRect:(struct CGRect)arg1 asTriangle:(unsigned long long)arg2;	// IMP=0x000000000096a300
- (void)dealloc;	// IMP=0x000000000096a28d
- (id)initWithTraits:(id)arg1;	// IMP=0x000000000096a22f
