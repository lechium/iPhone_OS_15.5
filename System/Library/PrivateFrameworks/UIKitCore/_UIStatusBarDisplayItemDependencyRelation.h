...
- (void).cxx_destruct;	// IMP=0x0000000000e4fe00
...
- (id)_ui_descriptionBuilder;	// IMP=0x0000000000e4fc74
- (id)type;	// IMP=0x0000000000e4fc4d
- (id)itemStates;	// IMP=0x0000000000e4fbc2
- (_Bool)isFulfilled;	// IMP=0x0000000000e4fb5f
