...
- (void).cxx_destruct;	// IMP=0x00000000003d5319
...
- (void)setEnabled:(_Bool)arg1;	// IMP=0x00000000003d4cea
- (id)pointerInteraction:(id)arg1 styleForRegion:(id)arg2;	// IMP=0x00000000003d4b14
- (void)controlEventsGestureRecognizer:(id)arg1 recognizedControlEvent:(unsigned long long)arg2 withEvent:(id)arg3;	// IMP=0x00000000003d492f
- (void)_didTapTextLabel;	// IMP=0x00000000003d45dd
- (void)activateLabel;	// IMP=0x00000000003d45cb
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000003d3de9
