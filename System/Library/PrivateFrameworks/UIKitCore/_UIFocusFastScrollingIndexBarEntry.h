...
+ (id)placeholderEntryWithEntryBefore:(id)arg1 after:(id)arg2;	// IMP=0x00000000006eeb49
+ (id)entryWithTitle:(id)arg1 generator:(CDUnknownBlockType)arg2;	// IMP=0x00000000006eea24
+ (id)entryWithTitle:(id)arg1 contentOffset:(struct CGPoint)arg2;	// IMP=0x00000000006ee92a
- (void).cxx_destruct;	// IMP=0x00000000006eee45
...
- (id)description;	// IMP=0x00000000006eecf0
...
- (id)initWithTitle:(id)arg1 generator:(CDUnknownBlockType)arg2;	// IMP=0x00000000006eea90
- (id)initWithTitle:(id)arg1 contentOffset:(struct CGPoint)arg2;	// IMP=0x00000000006ee98f
