...
+ (id)groupWithHighPriority:(long long)arg1 lowPriority:(long long)arg2 bluetoothPaddingInset:(double)arg3;	// IMP=0x0000000000def376
+ (id)activityItemDisplayIdentifier;	// IMP=0x0000000000def35d
- (void).cxx_destruct;	// IMP=0x0000000000defb26
