...
- (void).cxx_destruct;	// IMP=0x0000000000027621
...
- (id)_newMotionEffectsGroupForHighlightedAction;	// IMP=0x00000000000273f7
- (void)_removeMotionEffects;	// IMP=0x0000000000027302
- (void)_insertMotionEffects;	// IMP=0x00000000000271fd
- (struct CATransform3D)_enlargedTransformForSize:(struct CGSize)arg1 pressed:(_Bool)arg2;	// IMP=0x000000000002712f
- (void)_applyHighlightTransform;	// IMP=0x0000000000026cfa
- (id)initWithHighlightTransformTargetView:(id)arg1;	// IMP=0x0000000000026c5e
