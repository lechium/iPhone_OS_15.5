...
- (void).cxx_destruct;	// IMP=0x0000000000797421
...
- (void)_pickerDidSelectColor:(id)arg1 colorspace:(id)arg2 isVolatile:(_Bool)arg3;	// IMP=0x00000000007972f3
- (void)_forwardToDelegate:(id)arg1;	// IMP=0x0000000000797226
- (void)_displayLinkFired;	// IMP=0x00000000007971d6
- (id)init;	// IMP=0x0000000000797093
