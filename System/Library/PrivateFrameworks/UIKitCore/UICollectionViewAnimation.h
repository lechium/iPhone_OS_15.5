...
- (void).cxx_destruct;	// IMP=0x000000000038ad15
...
- (void)addStartupHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000038ac89
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000038ac31
- (void)startWithAnimator:(id)arg1;	// IMP=0x0000000000389f0e
- (void)start;	// IMP=0x0000000000389efa
...
- (id)description;	// IMP=0x0000000000389e16
- (id)initWithView:(id)arg1 viewType:(long long)arg2 finalLayoutAttributes:(id)arg3 startFraction:(double)arg4 endFraction:(double)arg5 animateFromCurrentPostion:(_Bool)arg6 deleteAfterAnimation:(_Bool)arg7 customAnimations:(CDUnknownBlockType)arg8;	// IMP=0x0000000000389b84
