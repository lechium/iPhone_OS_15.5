...
- (void).cxx_destruct;	// IMP=0x00000000008ff51c
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000008fe775
- (void)layoutSubviews;	// IMP=0x00000000008fe5f3
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000008fe4fc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000008fe240
