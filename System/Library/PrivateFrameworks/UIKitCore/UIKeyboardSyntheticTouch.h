...
+ (id)syntheticTouchWithPoint:(struct CGPoint)arg1 timestamp:(double)arg2 window:(id)arg3;	// IMP=0x00000000009b2098
...
- (void)_setLocationInWindow:(struct CGPoint)arg1 resetPrevious:(_Bool)arg2;	// IMP=0x00000000009b224d
- (struct CGPoint)getLocationInWindow;	// IMP=0x00000000009b222d
- (struct CGPoint)previousLocationInView:(id)arg1;	// IMP=0x00000000009b21e6
- (struct CGPoint)locationInView:(id)arg1;	// IMP=0x00000000009b219f
- (void)dealloc;	// IMP=0x00000000009b2164
- (id)initWithPoint:(struct CGPoint)arg1 timestamp:(double)arg2 window:(id)arg3;	// IMP=0x00000000009b20ef
