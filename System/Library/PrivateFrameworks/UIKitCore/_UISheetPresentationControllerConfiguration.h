...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000fd1781
+ (id)_fullScreenConfiguration;	// IMP=0x0000000000fd0dee
- (void).cxx_destruct;	// IMP=0x0000000000fd18a6
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000fd1522
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000fd12db
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000fd0e26
- (id)init;	// IMP=0x0000000000fd0d12
