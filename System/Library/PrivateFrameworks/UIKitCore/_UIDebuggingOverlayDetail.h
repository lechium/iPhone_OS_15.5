...
+ (id)detailWithTitle:(id)arg1 detail:(id)arg2;	// IMP=0x00000000010f350f
- (void).cxx_destruct;	// IMP=0x00000000010f35fb
...
- (void)_updateForInspectedView:(id)arg1;	// IMP=0x00000000010f35ab
