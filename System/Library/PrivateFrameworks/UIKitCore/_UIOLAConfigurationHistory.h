...
- (void).cxx_destruct;	// IMP=0x000000000117e03c
...
- (double)customSpacingAfterItem:(id)arg1;	// IMP=0x000000000117debf
- (void)setCustomSpacing:(double)arg1 afterItem:(id)arg2;	// IMP=0x000000000117ddf8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000117dcc2
