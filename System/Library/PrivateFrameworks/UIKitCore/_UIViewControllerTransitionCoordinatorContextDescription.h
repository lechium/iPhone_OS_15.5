...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000117470f
+ (id)descriptionForTransitionCoordinatorContext:(id)arg1;	// IMP=0x0000000001174596
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000011748e9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000001174717
