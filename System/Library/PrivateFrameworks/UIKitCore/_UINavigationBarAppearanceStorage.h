...
+ (long long)typicalBarPosition;	// IMP=0x00000000001503a3
- (void).cxx_destruct;	// IMP=0x000000000015082d
...
- (id)representativeImageForIdiom:(long long)arg1;	// IMP=0x000000000015065c
...
- (double)titleVerticalAdjustmentForBarMetrics:(long long)arg1;	// IMP=0x0000000000150521
- (void)setTitleVerticalAdjustment:(double)arg1 forBarMetrics:(long long)arg2;	// IMP=0x000000000015040f
