...
+ (id)settingsControllerModule;	// IMP=0x0000000000b263a4
+ (_Bool)pointerSlipMatchesContentSlip;	// IMP=0x0000000000b2639c
...
- (void)setDefaultValues;	// IMP=0x0000000000b2628e
