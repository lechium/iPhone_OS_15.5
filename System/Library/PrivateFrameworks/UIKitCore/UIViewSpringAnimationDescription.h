...
+ (id)descriptionWithTension:(double)arg1 friction:(double)arg2;	// IMP=0x00000000011b7d97
+ (id)descriptionWithSpringAnimationParameters:(CDStruct_6c8af1d9)arg1;	// IMP=0x00000000011b7d1b
