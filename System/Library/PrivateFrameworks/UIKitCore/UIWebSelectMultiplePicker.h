...
- (void)pickerView:(id)arg1 row:(int)arg2 column:(int)arg3 checked:(_Bool)arg4;	// IMP=0x000000000070d709
- (int)_itemIndexForRowIndex:(int)arg1;	// IMP=0x000000000070d697
- (long long)pickerView:(id)arg1 numberOfRowsInComponent:(long long)arg2;	// IMP=0x000000000070d67a
- (long long)numberOfComponentsInPickerView:(id)arg1;	// IMP=0x000000000070d66f
- (id)pickerView:(id)arg1 viewForRow:(long long)arg2 forComponent:(long long)arg3 reusingView:(id)arg4;	// IMP=0x000000000070d27a
- (void)layoutSubviews;	// IMP=0x000000000070d191
- (void)controlEndEditing;	// IMP=0x000000000070d18b
- (void)controlBeginEditing;	// IMP=0x000000000070d185
- (id)controlView;	// IMP=0x000000000070d17c
- (void)dealloc;	// IMP=0x000000000070d0f8
- (id)initWithDOMHTMLSelectElement:(id)arg1 cachedItems:(id)arg2 singleSelectionItem:(id)arg3 singleSelectionIndex:(unsigned long long)arg4 multipleSelection:(_Bool)arg5;	// IMP=0x000000000070cf34
