...
- (void).cxx_destruct;	// IMP=0x0000000000d82a4e
...
- (void)dispatchUpdateWithPressure:(double)arg1 stillEstimated:(_Bool)arg2;	// IMP=0x0000000000d827f5
- (void)removeTouchable:(id)arg1;	// IMP=0x0000000000d827df
- (void)addTouchable:(id)arg1;	// IMP=0x0000000000d82785
- (id)initWithLiveTouch:(id)arg1 freezeTouch:(id)arg2 contextID:(id)arg3;	// IMP=0x0000000000d826ce
