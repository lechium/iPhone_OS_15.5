...
- (void).cxx_destruct;	// IMP=0x0000000000a2e227
...
- (id)debugDescription;	// IMP=0x0000000000a2e0cd
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000000a2dbdf
@property(nonatomic) long long emojiFontSize;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000a2cd41
