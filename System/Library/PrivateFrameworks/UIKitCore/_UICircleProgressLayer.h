...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x0000000000553993
- (void).cxx_destruct;	// IMP=0x0000000000553cfd
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000000553a05
- (id)initWithLayer:(id)arg1;	// IMP=0x00000000005537c3
- (id)init;	// IMP=0x0000000000553689
