...
+ (id)combinedVisualRepresentationForSnapshots:(id)arg1 scaleFactor:(double)arg2;	// IMP=0x00000000006b7849
- (void).cxx_destruct;	// IMP=0x00000000006b875f
...
- (id)debugQuickLookObject;	// IMP=0x00000000006b8579
- (id)visualRepresentationWithMinimumArea:(struct CGRect)arg1;	// IMP=0x00000000006b654d
...
- (void)_didChooseFocusCandidateRegion:(id)arg1;	// IMP=0x00000000006b5cbb
- (id)_snapshotByFulfillingPromiseFocusRegionEntry:(id)arg1;	// IMP=0x00000000006b509b
- (id)focusableRegionMapEntriesLimitedByFocusContainerGuide:(id)arg1;	// IMP=0x00000000006b4d2b
@property(readonly, copy, nonatomic) NSArray *allFocusableRegionMapEntries;
- (void)_commit;	// IMP=0x00000000006b4cd9
- (void)_updateSortedFocusContainerGuideMapEntries;	// IMP=0x00000000006b4c68
- (void)_updateFinalFocusableRegionMapEntries;	// IMP=0x00000000006b4bce
- (id)_sortedEligibleFocusContainerGuidesInArray:(id)arg1;	// IMP=0x00000000006b4258
- (id)_finalFocusableRegionMapEntriesFromViewMapEntries:(id)arg1 guideMapEntries:(id)arg2;	// IMP=0x00000000006b3f63
- (id)_finalFocusableRegionMapEntriesFromMapEntries:(id)arg1;	// IMP=0x00000000006b3949
- (void)_punchHoleInMap:(id)arg1 atFrame:(struct CGRect)arg2;	// IMP=0x00000000006b36b4
- (void)_occludeFocusInFrame:(struct CGRect)arg1;	// IMP=0x00000000006b35cd
- (void)_addFocusContainerGuide:(id)arg1 withFrame:(struct CGRect)arg2;	// IMP=0x00000000006b3462
- (void)_addFocusableRegion:(id)arg1 isFocusGuide:(_Bool)arg2 withFrame:(struct CGRect)arg3;	// IMP=0x00000000006b319d
- (struct CGRect)_clippedRegionFrame:(struct CGRect)arg1 isFocusGuide:(_Bool)arg2;	// IMP=0x00000000006b2f85
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006b2d50
- (id)_initWithRequest:(id)arg1;	// IMP=0x00000000006b2a75
