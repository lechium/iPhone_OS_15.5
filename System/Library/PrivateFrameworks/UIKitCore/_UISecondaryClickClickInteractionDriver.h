...
+ (_Bool)prefersCancelsTouchesInView;	// IMP=0x0000000000e59582
+ (_Bool)requiresForceCapability;	// IMP=0x0000000000e5957a
- (void).cxx_destruct;	// IMP=0x0000000000e59ec8
...
- (void)_attemptSecondaryClick;	// IMP=0x0000000000e59c7e
- (void)_handleGestureRecognizer:(id)arg1;	// IMP=0x0000000000e59be5
- (_Bool)gestureRecognizer:(id)arg1 shouldBeRequiredToFailByGestureRecognizer:(id)arg2;	// IMP=0x0000000000e59ae4
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x0000000000e59adc
- (void)_gestureRecognizerFailed:(id)arg1;	// IMP=0x0000000000e59abb
@property(nonatomic) unsigned long long driverStyle;
@property(readonly, nonatomic) unsigned long long inputPrecision;
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x0000000000e59752
- (void)cancelInteraction;	// IMP=0x0000000000e596ca
...
- (id)init;	// IMP=0x0000000000e594e0
