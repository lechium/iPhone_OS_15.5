...
- (void).cxx_destruct;	// IMP=0x0000000000a7326a
...
- (void)complete;	// IMP=0x0000000000a7320f
@property(readonly, retain, nonatomic) UIView *animatingView;
- (id)initWithHost:(id)arg1 startPlacement:(id)arg2 endPlacement:(id)arg3;	// IMP=0x0000000000a73031
