...
+ (void)sendDelayedPressWithType:(long long)arg1 timestamp:(double)arg2 sender:(id)arg3;	// IMP=0x00000000006a700e
- (void).cxx_destruct;	// IMP=0x00000000006a7475
...
- (void)_sendPressEvent;	// IMP=0x00000000006a7100
- (id)_initWithPressType:(long long)arg1 timestamp:(double)arg2 sender:(id)arg3;	// IMP=0x00000000006a6f15
