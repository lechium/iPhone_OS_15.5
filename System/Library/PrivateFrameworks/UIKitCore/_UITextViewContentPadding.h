...
- (void).cxx_destruct;	// IMP=0x00000000010bb81c
...
- (void)_checkNewCurrentValue;	// IMP=0x00000000010bb74b
- (void)resetCurrentValue;	// IMP=0x00000000010bb6d1
- (void)increaseToValue:(double)arg1;	// IMP=0x00000000010bb65f
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000010bb5b3
