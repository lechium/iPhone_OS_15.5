...
- (void).cxx_destruct;	// IMP=0x00000000001a7ef1
...
- (void)finalizeStateFromTransition:(id)arg1;	// IMP=0x00000000001a7c81
- (void)ensureBackButtonTruncationOccursWithContext:(id)arg1;	// IMP=0x00000000001a7c6b
- (void)recordToStateForTransition:(id)arg1;	// IMP=0x00000000001a7c08
- (void)prepareToRecordToState:(id)arg1;	// IMP=0x00000000001a7ba5
- (void)recordFromStateForTransition:(id)arg1;	// IMP=0x00000000001a7b42
@property(readonly, copy) NSString *description;
- (_Bool)isBackgroundForScrollEdge;	// IMP=0x00000000001a7817
...
- (id)layoutForMeasuringWidth:(double)arg1;	// IMP=0x00000000001a76a9
- (void)removeViewsNotInLayout:(id)arg1;	// IMP=0x00000000001a7485
- (void)removeAllViews;	// IMP=0x00000000001a73b4
- (void)interleaveViewsWithLayout:(id)arg1 inNavigationBar:(id)arg2;	// IMP=0x00000000001a7199
- (void)installViewsInNavigationBar:(id)arg1;	// IMP=0x00000000001a700b
- (void)layoutViews;	// IMP=0x00000000001a67df
@property(readonly, nonatomic) struct CGRect weeTitleLabelLayoutFrame;
- (struct CGRect)backgroundViewLayoutFrameForcingExpandedHeight:(_Bool)arg1;	// IMP=0x00000000001a6350
@property(readonly, nonatomic) struct CGRect backgroundViewLayoutFrame;
- (struct CGRect)_backgroundViewLayoutFrameWithRelevantMaxY:(double)arg1;	// IMP=0x00000000001a62d8
@property(readonly, nonatomic) struct CGRect bottomPaletteLayoutFrame;
- (struct CGRect)_bottomPaletteLayoutFrameWithSearchBarMaxY:(double)arg1;	// IMP=0x00000000001a620f
@property(readonly, nonatomic) struct CGRect searchBarLayoutFrame;
- (struct CGRect)_searchBarLayoutFrameWithLargeTitleMaxY:(double)arg1;	// IMP=0x00000000001a6119
@property(readonly, nonatomic) struct CGRect largeTitleViewLayoutFrame;
- (struct CGRect)_largeTitleViewLayoutFrameWithContentOrCanvasOrRefreshControlMaxY:(double)arg1;	// IMP=0x00000000001a6058
@property(readonly, nonatomic) struct CGRect refreshControlLayoutFrame;
- (struct CGRect)_refreshControlLayoutFrameWithContentOrCanvasMaxY:(double)arg1;	// IMP=0x00000000001a5f85
@property(readonly, nonatomic) struct CGRect canvasViewLayoutFrame;
- (struct CGRect)_canvasViewLayoutFrameWithPromptMaxY:(double)arg1;	// IMP=0x00000000001a5ebc
@property(readonly, nonatomic) struct CGRect contentViewLayoutFrame;
- (struct CGRect)_contentViewLayoutFrameWithPromptMaxY:(double)arg1;	// IMP=0x00000000001a5df6
@property(readonly, nonatomic) struct CGRect promptViewLayoutFrame;
- (void)updateLayout;	// IMP=0x00000000001a5d01
- (void)_updateLayoutOutputs;	// IMP=0x00000000001a5609
- (void)_updateLayoutParametersForWidth:(double)arg1;	// IMP=0x00000000001a52d0
- (void)_updateRefreshControlLayoutData;	// IMP=0x00000000001a4db4
- (void)_updateLargeTitleViewLayoutItem;	// IMP=0x00000000001a49f7
- (void)_resolveContentAndCanvasLayouts;	// IMP=0x00000000001a4596
- (void)_reprioritizeLayoutItem:(id)arg1 toPriority:(long long)arg2;	// IMP=0x00000000001a4452
- (void)_removeLayoutItem:(id)arg1;	// IMP=0x00000000001a43d7
- (void)_addLayoutItem:(id)arg1;	// IMP=0x00000000001a420a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a41db
- (id)init;	// IMP=0x00000000001a413e
- (id)initWithLayout:(id)arg1;	// IMP=0x00000000001a3d2f
