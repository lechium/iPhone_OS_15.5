...
- (void).cxx_destruct;	// IMP=0x0000000000041051
...
- (void)_gestureChanged:(id)arg1;	// IMP=0x0000000000040f04
- (void)reset;	// IMP=0x0000000000040ec1
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000040dbc
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000040d25
- (id)initWithFocusedInterfaceActionPressDelegate:(id)arg1;	// IMP=0x0000000000040c81
