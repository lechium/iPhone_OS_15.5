...
+ (id)overlay;	// IMP=0x00000000010e090b
+ (void)prepareDebuggingOverlay;	// IMP=0x00000000010e081a
- (void).cxx_destruct;	// IMP=0x00000000010e14d3
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000010e1287
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000010e0e30
- (void)toggleFullscreen;	// IMP=0x00000000010e0df3
- (void)toggleVisibility;	// IMP=0x00000000010e0d53
- (void)_setHidden:(_Bool)arg1;	// IMP=0x00000000010e09bd
@property(readonly, nonatomic) UIDebuggingInformationOverlayViewController *overlayViewController;
- (id)init;	// IMP=0x00000000010e0702
