...
- (void).cxx_destruct;	// IMP=0x0000000001002d3d
...
- (void)displayLinkTicked:(id)arg1;	// IMP=0x0000000001001a78
- (void)didScrubPageControl:(id)arg1;	// IMP=0x00000000010012ae
- (void)didTapPageControl:(id)arg1;	// IMP=0x0000000001000b23
- (void)resetSuccessiveTapInfo;	// IMP=0x0000000001000ae8
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x0000000001000a5a
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x0000000001000976
- (void)controlEventsGestureRecognizer:(id)arg1 recognizedControlEvent:(unsigned long long)arg2 withEvent:(id)arg3;	// IMP=0x000000000100095a
- (id)preferredIndicatorImage;	// IMP=0x000000000100017b
- (void)setPreferredIndicatorImage:(id)arg1;	// IMP=0x0000000001000098
- (void)setCustomIndicatorImage:(id)arg1 forPage:(long long)arg2;	// IMP=0x0000000000ffff11
- (id)customIndicatorImageForPage:(long long)arg1;	// IMP=0x0000000000fffeb2
- (void)configureIndicator:(id)arg1 atPage:(long long)arg2;	// IMP=0x0000000000fffdaa
- (id)indicatorImageForPage:(long long)arg1;	// IMP=0x0000000000fffd4b
- (unsigned long long)maxVisibleIndicators;	// IMP=0x0000000000fffd29
- (struct CGSize)indicatorSizeForImage:(id)arg1;	// IMP=0x0000000000fffca1
- (struct CGSize)sizeForNumberOfPages:(long long)arg1;	// IMP=0x0000000000fffa28
- (void)invalidateIndicators;	// IMP=0x0000000000fff89e
- (void)layoutSubviews;	// IMP=0x0000000000ffd4af
- (void)updateDisplayedPageToCurrentPage;	// IMP=0x0000000000ffd036
- (void)didUpdateCurrentPageIndicatorTintColor;	// IMP=0x0000000000ffd006
- (void)didUpdatePageIndicatorTintColor;	// IMP=0x0000000000ffcc2d
- (void)didUpdateInteractionTypeAvailability;	// IMP=0x0000000000ffcb4a
- (void)didUpdateCustomLayoutValues;	// IMP=0x0000000000ffcad1
- (void)didUpdateBackgroundEffect;	// IMP=0x0000000000ffc99a
- (void)didUpdateBackgroundStyle;	// IMP=0x0000000000ffc8fa
- (void)didUpdateNumberOfPages;	// IMP=0x0000000000ffc6fa
- (void)traitCollectionDidChangeOnSubtree:(id)arg1;	// IMP=0x0000000000ffc4b7
- (void)didUpdateLayoutDirection;	// IMP=0x0000000000ffc3ae
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000ffc064
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000ffc00f
- (_Bool)shouldDisableTouchTracking;	// IMP=0x0000000000ffbbd1
- (void)pruneArchivedSubviews:(id)arg1;	// IMP=0x0000000000ffbb5f
- (void)prepare;	// IMP=0x0000000000ffb14e
