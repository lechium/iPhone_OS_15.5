...
- (void).cxx_destruct;	// IMP=0x0000000000674fe7
...
- (void)_performDelayedFocusingAnimationIfNecessary;	// IMP=0x0000000000674efa
- (void)_scheduleDelayedFocusingAnimationWithDelay:(double)arg1;	// IMP=0x0000000000674e36
- (void)didUpdateFocusInContext:(id)arg1 fromItem:(id)arg2;	// IMP=0x00000000006748bf
- (id)willUpdateFocusInContext:(id)arg1;	// IMP=0x0000000000674724
- (id)init;	// IMP=0x00000000006746b9
