...
+ (id)stateWithGeometry:(struct UIPeripheralAnimationGeometry)arg1 inPositionIsDestination:(_Bool)arg2;	// IMP=0x0000000000acb2b8
...
- (void)dealloc;	// IMP=0x0000000000acb357
