...
- (void).cxx_destruct;	// IMP=0x0000000000dad24a
...
- (void)addTapHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000dad0d6
- (void)addDismissalCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000dad05a
- (void)addDismissalAnimations:(CDUnknownBlockType)arg1;	// IMP=0x0000000000dacfde
- (void)dismiss;	// IMP=0x0000000000dacdf0
- (void)handleLongPressGesture:(id)arg1;	// IMP=0x0000000000dacb6a
- (void)present;	// IMP=0x0000000000dac9cf
