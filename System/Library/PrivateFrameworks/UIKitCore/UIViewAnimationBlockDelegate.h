...
+ (void)setAnimationBlockDelegateWithDuration:(double)arg1 options:(unsigned long long)arg2 start:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000129a801
+ (id)animationBlockDelegateWithDuration:(double)arg1 options:(unsigned long long)arg2 start:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000129a728
- (void).cxx_destruct;	// IMP=0x000000000129ad82
...
- (_Bool)_allowsHitTesting;	// IMP=0x000000000129ad37
- (_Bool)_allowsUserInteractionToCutOffEndOfAnimation;	// IMP=0x000000000129ad2e
- (void)_sendDeferredCompletion:(id)arg1;	// IMP=0x000000000129acb9
- (void)_didEndBlockAnimation:(id)arg1 finished:(id)arg2 context:(void *)arg3;	// IMP=0x000000000129a946
- (void)_willBeginBlockAnimation:(id)arg1 context:(id)arg2;	// IMP=0x000000000129a91e
