...
- (void).cxx_destruct;	// IMP=0x0000000000063d49
...
- (void)_animateTransition:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000639f2
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000063410
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000063380
- (id)_alertControllerForContext:(id)arg1;	// IMP=0x00000000000632b3
- (id)initWithInteractionProgress:(id)arg1;	// IMP=0x0000000000063245
