...
- (void).cxx_destruct;	// IMP=0x000000000078cdcf
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x000000000078cb29
- (id)initWithSettings:(id)arg1 touchedEdgesProvider:(id)arg2;	// IMP=0x000000000078ca60
