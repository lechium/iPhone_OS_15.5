...
- (double)_currentTouchForceMultiplier;	// IMP=0x0000000000c0e5f8
- (double)_normalizedTouchForceValue:(double)arg1;	// IMP=0x0000000000c0e5cb
- (double)_denormalizedTouchForceValue:(double)arg1;	// IMP=0x0000000000c0e596
- (double)_thresholdForForceLevel:(long long)arg1;	// IMP=0x0000000000c0e52d
- (void)_accessibilityForceSensitivityChanged:(id)arg1;	// IMP=0x0000000000c0e51b
- (void)reset;	// IMP=0x0000000000c0e32f
- (void)evaluateWithTouchForce:(double)arg1 atTimestamp:(double)arg2 withCentroidAtLocation:(struct CGPoint)arg3;	// IMP=0x0000000000c0df6c
@property(readonly, nonatomic) double velocity; // @dynamic velocity;
- (double)currentProgressToState:(long long)arg1;	// IMP=0x0000000000c0de46
- (id)description;	// IMP=0x0000000000c0dd5e
- (void)dealloc;	// IMP=0x0000000000c0dcdc
- (id)init;	// IMP=0x0000000000c0dbca
