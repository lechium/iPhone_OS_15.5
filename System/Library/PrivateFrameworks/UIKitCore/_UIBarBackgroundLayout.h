...
- (void).cxx_destruct;	// IMP=0x0000000000792d8f
...
- (id)description;	// IMP=0x0000000000792c51
- (void)describeInto:(id)arg1;	// IMP=0x0000000000792b82
...
- (_Bool)bg2HasHeight;	// IMP=0x0000000000792b19
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000792a05
- (id)initWithLayout:(id)arg1;	// IMP=0x0000000000792942
- (id)init;	// IMP=0x000000000079292e
