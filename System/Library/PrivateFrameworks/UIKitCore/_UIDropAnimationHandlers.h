...
- (void).cxx_destruct;	// IMP=0x00000000003a141f
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000003a13bb
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x00000000003a1357
@property(readonly, nonatomic) NSArray *completionHandlers;
@property(readonly, nonatomic) NSArray *alongsideAnimationHandlers;
- (void)resetAllAnimationHandlers;	// IMP=0x00000000003a1300
- (void)invokeAllCompletionHandlers;	// IMP=0x00000000003a11f3
- (id)init;	// IMP=0x00000000003a117e
