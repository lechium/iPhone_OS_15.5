...
- (void).cxx_destruct;	// IMP=0x00000000002abff6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002abf44
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002abd91
- (id)init;	// IMP=0x00000000002ab81a
