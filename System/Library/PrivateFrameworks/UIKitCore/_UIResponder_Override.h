...
+ (id)overrideForResponder:(id)arg1 withTarget:(id)arg2 forType:(long long)arg3;	// IMP=0x0000000000d39bc4
- (void).cxx_destruct;	// IMP=0x0000000000d3a01b
...
- (id)description;	// IMP=0x0000000000d39dff
- (void)dealloc;	// IMP=0x0000000000d39d58
