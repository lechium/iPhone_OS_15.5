...
+ (id)mainBundleInfoParser;	// IMP=0x000000000072575e
- (void).cxx_destruct;	// IMP=0x000000000072675a
...
- (_Bool)_isLinkedOnOrAfterYukon;	// IMP=0x0000000000726626
- (void)_computeSupportedUserInterfaceStyleFromInfo:(id)arg1;	// IMP=0x0000000000726559
- (void)_computeSupportedInterfaceOrientationsWithInfo:(id)arg1;	// IMP=0x0000000000726256
- (id)_initWithApplicationPlistData:(id)arg1;	// IMP=0x0000000000725ae6
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x000000000072585a
- (id)_initWithBundle:(id)arg1;	// IMP=0x0000000000725804
