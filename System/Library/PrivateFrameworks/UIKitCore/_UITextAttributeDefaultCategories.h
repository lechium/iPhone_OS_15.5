...
- (void).cxx_destruct;	// IMP=0x0000000000258ddd
...
- (id)_textFieldDefaults:(long long)arg1;	// IMP=0x0000000000258963
- (id)_labelDefaults:(long long)arg1;	// IMP=0x0000000000258854
- (id)_genericDefaults:(long long)arg1;	// IMP=0x00000000002586e5
- (id)initWithUserInterfaceIdiom:(long long)arg1;	// IMP=0x00000000002584dd
