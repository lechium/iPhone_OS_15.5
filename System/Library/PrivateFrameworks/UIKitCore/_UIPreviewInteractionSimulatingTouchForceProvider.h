...
- (void).cxx_destruct;	// IMP=0x0000000000c13ea2
@property(nonatomic, getter=isActive) _Bool active; // @synthesize active=_active;
- (void)cancelInteraction;	// IMP=0x0000000000c13e7c
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x0000000000c13e04
@property(readonly, nonatomic) double touchForce;
- (id)initWithTouchForce:(double)arg1 location:(struct CGPoint)arg2 coordinateSpace:(id)arg3;	// IMP=0x0000000000c13d4d
