...
- (void).cxx_destruct;	// IMP=0x000000000028e930
...
- (id)initWithContainer:(id)arg1 traitCollection:(id)arg2 dataSourceSnapshot:(id)arg3 sectionIndex:(long long)arg4 wantsCollapsedTopSpacing:(_Bool)arg5;	// IMP=0x000000000028e7ef
- (id)initWithContainer:(id)arg1 traitCollection:(id)arg2 dataSourceSnapshot:(id)arg3;	// IMP=0x000000000028e7c3
