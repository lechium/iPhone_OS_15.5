...
+ (id)transitionFromPlacement:(id)arg1 toPlacement:(id)arg2 withAnimationStyle:(id)arg3;	// IMP=0x0000000000a4b491
...
- (void)dealloc;	// IMP=0x0000000000a4b5b6
- (_Bool)didAdvanceAnimationToState:(int)arg1;	// IMP=0x0000000000a4b505
