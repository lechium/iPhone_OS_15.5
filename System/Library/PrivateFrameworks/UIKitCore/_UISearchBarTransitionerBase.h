...
- (void).cxx_destruct;	// IMP=0x00000000001e8d65
...
- (void)cancel;	// IMP=0x00000000001e8cf4
- (void)complete;	// IMP=0x00000000001e8cee
- (void)animate;	// IMP=0x00000000001e8cb8
- (void)prepare;	// IMP=0x00000000001e8c82
- (id)initWithNewTransitionContextForSearchBar:(id)arg1;	// IMP=0x00000000001e8c1e
- (id)init;	// IMP=0x00000000001e8b18
- (id)initWithTransitionContext:(id)arg1 forSearchBar:(id)arg2;	// IMP=0x00000000001e8997
