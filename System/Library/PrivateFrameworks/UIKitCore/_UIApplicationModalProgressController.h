...
+ (id)instanceForScene:(id)arg1;	// IMP=0x000000000054d6c6
+ (id)sharedInstance;	// IMP=0x000000000054d639
- (void).cxx_destruct;	// IMP=0x000000000054ff50
...
- (void)displayForDownloadingURL:(id)arg1 copyToURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000054ea4a
- (void)displayForCopyingFileAtURL:(id)arg1 toURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000054ea38
- (void)displayForDownloadingURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000054ea21
- (void)displayWithTitle:(id)arg1 message:(id)arg2 progress:(id)arg3 buttonTitle:(id)arg4 preDisplayTestBlock:(CDUnknownBlockType)arg5 dismissalHandler:(CDUnknownBlockType)arg6;	// IMP=0x000000000054e60e
@property(copy, nonatomic) NSString *message;
@property(copy, nonatomic) NSString *title;
- (void)reconfigureWithTitle:(id)arg1 message:(id)arg2 progress:(id)arg3 buttonTitle:(id)arg4 dismissalHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000000054df77
- (void)hideAfterDelay:(double)arg1 forceCompletion:(_Bool)arg2 afterMinimumUptimeDismissalHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000054de2c
- (void)hideAfterMinimumUptimeWithDismissalHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000054dcf0
- (void)_dismissButtonAction:(id)arg1;	// IMP=0x000000000054dcd1
- (void)_hideTimerAction:(id)arg1;	// IMP=0x000000000054dc94
- (void)_showTimerAction:(id)arg1;	// IMP=0x000000000054dbc4
- (void)_hideImmediatelyWasDismissedByUser:(_Bool)arg1;	// IMP=0x000000000054db74
- (void)_reset;	// IMP=0x000000000054daf0
- (void)_callAndClearDismissalHandlerWasDismissedByUser:(_Bool)arg1;	// IMP=0x000000000054daa0
- (id)init;	// IMP=0x000000000054d98e
