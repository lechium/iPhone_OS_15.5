...
- (void)resetTimer;	// IMP=0x0000000000ac9bad
- (void)invalidate;	// IMP=0x0000000000ac9b20
- (_Bool)isValid;	// IMP=0x0000000000ac9ab0
- (void)handleDeferredTimerFiredEvent;	// IMP=0x0000000000ac98f1
- (void)timerFired:(id)arg1;	// IMP=0x0000000000ac9867
@property(readonly, nonatomic) _Bool repeats;
- (id)initWithTaskQueue:(id)arg1 timeInterval:(double)arg2 repeats:(_Bool)arg3 task:(CDUnknownBlockType)arg4;	// IMP=0x0000000000ac9773
- (void)dealloc;	// IMP=0x0000000000ac96ea
