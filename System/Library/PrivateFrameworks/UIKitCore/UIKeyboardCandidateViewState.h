...
+ (_Bool)resolveInstanceMethod:(SEL)arg1;	// IMP=0x00000000008c438e
- (void).cxx_destruct;	// IMP=0x00000000008c45b2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008c41f6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008c4117
