...
- (void).cxx_destruct;	// IMP=0x000000000001fa23
...
- (void)_fetchDemographicInformation;	// IMP=0x000000000001f7ca
- (id)initWithSample:(id)arg1 healthStore:(id)arg2 activeAlgorithmVersion:(long long)arg3;	// IMP=0x000000000001f6fa
