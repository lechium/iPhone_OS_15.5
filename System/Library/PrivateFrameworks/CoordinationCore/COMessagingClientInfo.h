...
- (void).cxx_destruct;	// IMP=0x000000000001d309
...
- (id)initWithTopic:(id)arg1 cluster:(id)arg2 handledClasses:(id)arg3 client:(id)arg4 activateCompletionHanlder:(CDUnknownBlockType)arg5;	// IMP=0x000000000001d171
