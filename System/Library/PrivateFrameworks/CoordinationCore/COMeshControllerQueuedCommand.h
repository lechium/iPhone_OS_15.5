...
- (void).cxx_destruct;	// IMP=0x000000000004b3ba
...
- (void)invokeCallbackWithError:(id)arg1;	// IMP=0x000000000004b2ff
- (id)initWithCommand:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000004b254
