...
- (void).cxx_destruct;	// IMP=0x000000000002bafd
...
- (void)invokeCallbackWithError:(id)arg1;	// IMP=0x000000000002bad0
- (id)destination;	// IMP=0x000000000002bac8
- (id)command;	// IMP=0x000000000002bab6
- (id)initWithRequest:(id)arg1 includeSelf:(_Bool)arg2 recipientBlock:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000002b9dc
