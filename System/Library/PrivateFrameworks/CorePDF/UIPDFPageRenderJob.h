...
- (void)sendImageTo:(id)arg1 callback:(SEL)arg2 userData:(id)arg3;	// IMP=0x000000000007cb1d
- (void)sendImage;	// IMP=0x000000000007c9e1
- (void)renderImage;	// IMP=0x000000000007c34e
@property(readonly, retain) UIImage *image; // @dynamic image;
- (void)releaseOperation;	// IMP=0x000000000007c2f0
@property UIPDFPageRenderOperation *operation; // @dynamic operation;
- (void)setTarget:(id)arg1 callback:(SEL)arg2 userData:(id)arg3;	// IMP=0x000000000007c138
- (void)cancelOperationForTarget:(id)arg1;	// IMP=0x000000000007bfb2
- (void)cancelOperation;	// IMP=0x000000000007be4a
- (void)cancel;	// IMP=0x000000000007bcc8
- (void)dealloc;	// IMP=0x000000000007bc70
- (id)initWithPage:(id)arg1 maxSize:(struct CGSize)arg2 queuePriority:(long long)arg3;	// IMP=0x000000000007bb91
- (_Bool)hasPage;	// IMP=0x000000000007bb64
