...
+ (_Bool)reconstructHighlightFor:(id)arg1;	// IMP=0x00000000000551cd
...
- (void)highlight;	// IMP=0x0000000000054ee9
- (id)initWithTextLine:(id)arg1 inZone:(id)arg2 ofColor:(struct CGColor *)arg3;	// IMP=0x0000000000054e96
