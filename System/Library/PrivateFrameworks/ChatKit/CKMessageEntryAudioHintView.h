...
- (void).cxx_destruct;	// IMP=0x00000000001ba8d1
...
- (void)setHidden:(_Bool)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000001ba2db
- (void)layoutSubviews;	// IMP=0x00000000001ba056
- (id)initWithReferenceButton:(id)arg1 coverInsets:(struct UIEdgeInsets)arg2;	// IMP=0x00000000001b9bb8
