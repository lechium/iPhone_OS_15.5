...
- (void).cxx_destruct;	// IMP=0x000000000014300f
...
- (void)updateBackgroundVisualEffect;	// IMP=0x0000000000142ed0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000142d9a
