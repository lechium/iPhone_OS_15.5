...
- (void).cxx_destruct;	// IMP=0x0000000000413ecc
...
- (void)deleteAttachmentItems:(id)arg1;	// IMP=0x00000000004137dc
- (void)updateCollections;	// IMP=0x0000000000412ebe
- (id)guidFromChatItem:(id)arg1;	// IMP=0x0000000000412e5b
- (void)chatItemsChanged:(id)arg1;	// IMP=0x0000000000412565
- (void)dealloc;	// IMP=0x00000000004124f0
- (id)initWithChat:(id)arg1;	// IMP=0x00000000004124dc
- (id)initWithChat:(id)arg1 photoTransferGUIDs:(id)arg2;	// IMP=0x000000000041238a
