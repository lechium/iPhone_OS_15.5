...
- (void).cxx_destruct;	// IMP=0x000000000049f580
...
- (id)initWithRequestID:(long long)arg1 transferGUID:(id)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000049f4b6
