...
- (void).cxx_destruct;	// IMP=0x000000000041ccfa
...
- (void)videoDidReachEnd:(id)arg1;	// IMP=0x000000000041cb8c
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000041ca95
- (void)pause;	// IMP=0x000000000041ca1a
- (void)play;	// IMP=0x000000000041c8ca
- (_Bool)togglePlayPause;	// IMP=0x000000000041c87d
@property(readonly, nonatomic, getter=isPlaying) _Bool playing; // @dynamic playing;
- (void)dealloc;	// IMP=0x000000000041c7a7
- (void)setVideoFileURL:(id)arg1;	// IMP=0x000000000041c4b6
- (_Bool)prefersStatusBarHidden;	// IMP=0x000000000041c4ae
- (void)loadView;	// IMP=0x000000000041c362
- (id)init;	// IMP=0x000000000041c2a5
