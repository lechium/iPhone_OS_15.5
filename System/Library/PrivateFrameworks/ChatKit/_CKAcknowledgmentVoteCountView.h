...
- (void).cxx_destruct;	// IMP=0x0000000000104ecf
...
- (void)layoutSubviews;	// IMP=0x0000000000104b43
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000104aa6
- (void)configureWithAcknowledgmentTally:(id)arg1;	// IMP=0x00000000001047f9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000104553
