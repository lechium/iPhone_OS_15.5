...
@interface CKSpotlightSearchResult : NSObject
{
    ...
    NSDate *_messageDate;	// 32 = 0x20
}

- (void).cxx_destruct;	// IMP=0x0000000000384d7a
...
- (long long)compare:(id)arg1;	// IMP=0x0000000000384c26
- (id)initWithMessageGUID:(id)arg1 chatGUID:(id)arg2 messageTime:(id)arg3 summery:(id)arg4;	// IMP=0x0000000000384b35
