...
- (void).cxx_destruct;	// IMP=0x000000000043d69a
...
- (void)_loadCachedPayloadIntoBrowser;	// IMP=0x000000000043d488
- (void)_doInitialization;	// IMP=0x000000000043cf3b
- (void)_flushHandwritingWindowCacheIfNeeded;	// IMP=0x000000000043ce25
- (void)_updateVisibilityState;	// IMP=0x000000000043bebc
- (void)_handleApplicationDidEnterBackground:(id)arg1;	// IMP=0x000000000043be8c
- (void)_handleApplicationWillEnterForeground:(id)arg1;	// IMP=0x000000000043be75
- (_Bool)isHandwritingLandscape;	// IMP=0x000000000043bdf9
@property(readonly) NSString *pluginBundleID;
- (void)setVisible:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000000043bd54
...
- (void)dealloc;	// IMP=0x000000000043bac0
- (id)init;	// IMP=0x000000000043b97b
