...
@class CKAssociatedMessageChatItem, CKAttachmentMessagePartChatItem, CKBalloonTextView, CKBalloonView, CKChatItem, CKConversation, CKFullScreenEffectManager, CKImpactEffectManager, CKMessagePartChatItem, CKRaiseGesture, CKTranscriptCollectionView, IMChat, NSArray, NSIndexPath, NSIndexSet, NSObject, NSString, UICollectionViewCell, UITapGestureRecognizer, UITraitCollection, UIView;
