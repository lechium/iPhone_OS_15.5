...
- (void).cxx_destruct;	// IMP=0x000000000000921a
...
- (void)layoutSubviews;	// IMP=0x000000000000872e
@property(retain, nonatomic) NSString *subheadingText;
@property(retain, nonatomic) NSString *mainText;
- (void)prepareForReuse;	// IMP=0x00000000000084aa
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000000810e
