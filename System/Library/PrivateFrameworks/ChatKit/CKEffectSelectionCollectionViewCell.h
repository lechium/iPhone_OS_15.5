...
- (void).cxx_destruct;	// IMP=0x000000000033085c
...
- (void)configureForEffectIsDark:(_Bool)arg1;	// IMP=0x00000000003306f2
- (void)setTitle:(id)arg1;	// IMP=0x0000000000330589
- (void)setImage:(id)arg1;	// IMP=0x0000000000330517
- (void)layoutSubviews;	// IMP=0x00000000003302c1
- (_Bool)canBecomeFirstResponder;	// IMP=0x00000000003302b9
- (void)setSelected:(_Bool)arg1;	// IMP=0x00000000003301a0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000032f0af
