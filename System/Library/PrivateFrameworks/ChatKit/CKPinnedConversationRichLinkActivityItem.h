...
- (void).cxx_destruct;	// IMP=0x000000000051be85
...
- (id)activityItemView;	// IMP=0x000000000051be18
...
- (id)initWithLinkView:(id)arg1;	// IMP=0x000000000051bd87
- (id)initWithMessage:(id)arg1 chatContext:(id)arg2 contentScale:(double)arg3 attachedContactItemIdentifier:(id)arg4;	// IMP=0x000000000051bcae
