...
- (void).cxx_destruct;	// IMP=0x000000000040f923
...
- (void)layoutSubviews;	// IMP=0x000000000040f6ad
- (id)initWithFrame:(struct CGRect)arg1 conversation:(id)arg2;	// IMP=0x000000000040f2ec
- (void)dealloc;	// IMP=0x000000000040f11b
