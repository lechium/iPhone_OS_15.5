...
- (void).cxx_destruct;	// IMP=0x00000000004236db
...
- (struct CGPoint)attachmentOffsetWithReferenceFrame:(struct CGRect)arg1;	// IMP=0x00000000004233d6
- (void)setVisible:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000423346
- (id)initWithChatItem:(id)arg1 layoutBounds:(struct CGRect)arg2;	// IMP=0x0000000000423101
