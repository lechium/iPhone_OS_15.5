...
- (void).cxx_destruct;	// IMP=0x0000000000406c1a
...
- (id)_glyphLayerForButtonAnimationWithImage:(id)arg1;	// IMP=0x0000000000406ab9
- (id)_invertedCircularFillGlyph:(id)arg1;	// IMP=0x00000000004067d5
- (id)initWithFrame:(struct CGRect)arg1 hasDarkVibrancy:(_Bool)arg2 isInDarkMode:(_Bool)arg3 color:(id)arg4 sendColor:(BOOL)arg5;	// IMP=0x0000000000406141
- (_Bool)__im_ff_systemImageAdoptionEnabled;	// IMP=0x00000000004060f6
