...
- (void).cxx_destruct;	// IMP=0x00000000003607fa
...
- (id)initWithSourceView:(id)arg1 permittedArrowDirections:(unsigned long long)arg2 shouldDisableSnapshotView:(_Bool)arg3;	// IMP=0x0000000000360757
