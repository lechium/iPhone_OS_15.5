...
- (void).cxx_destruct;	// IMP=0x000000000046c00d
...
- (double)valueByRounding:(double)arg1 usingMagneticGuidelines:(_Bool)arg2;	// IMP=0x000000000046bd45
- (void)parsedFrame:(struct CGRect)arg1 type:(long long)arg2 forTileAtIndex:(long long)arg3;	// IMP=0x000000000046bc8a
- (struct CGSize)captionSizeForTileAtIndex:(long long)arg1 proposedSize:(struct CGSize)arg2;	// IMP=0x000000000046bbee
- (_Bool)scanTile:(CDStruct_1417b155 *)arg1 ofType:(long long)arg2;	// IMP=0x000000000046bb4c
- (_Bool)scanTile:(CDStruct_1417b155 *)arg1 type:(long long *)arg2;	// IMP=0x000000000046ba43
- (_Bool)scanTileWithSquareImage:(CDStruct_1417b155 *)arg1;	// IMP=0x000000000046ba2f
- (_Bool)scanTileWithHorizontalPanorama:(CDStruct_1417b155 *)arg1;	// IMP=0x000000000046ba18
- (_Bool)scanTileWithLandscapeImage:(CDStruct_1417b155 *)arg1;	// IMP=0x000000000046ba01
- (_Bool)scanTileWithPortraitImage:(CDStruct_1417b155 *)arg1;	// IMP=0x000000000046b9ea
- (_Bool)scanAnyTile:(CDStruct_1417b155 *)arg1;	// IMP=0x000000000046b9c9
- (_Bool)scanTile:(CDStruct_1417b155 *)arg1 passingTest:(CDUnknownBlockType)arg2;	// IMP=0x000000000046b5ec
@property(readonly, nonatomic) _Bool isAtEnd;
@property(nonatomic) CKTiledLayoutGeneratorScanState *scanState;
- (void)didParseTiles;	// IMP=0x000000000046b41f
- (_Bool)parseNextTiles;	// IMP=0x000000000046b407
- (void)willParseTiles;	// IMP=0x000000000046b3bf
- (void)parseTiles;	// IMP=0x000000000046b35c
- (void)enumerateFramesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000046b2fd
- (id)init;	// IMP=0x000000000046b269
