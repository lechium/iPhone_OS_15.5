...
- (void).cxx_destruct;	// IMP=0x00000000002b67be
...
- (void)_checkForCover:(id)arg1;	// IMP=0x00000000002b65ae
- (void)recordTouchAtPoint:(struct CGPoint)arg1;	// IMP=0x00000000002b6287
- (void)reset;	// IMP=0x00000000002b61e3
- (void)dealloc;	// IMP=0x00000000002b6059
- (id)initWithSize:(struct CGSize)arg1 touchLifetime:(double)arg2;	// IMP=0x00000000002b5fea
