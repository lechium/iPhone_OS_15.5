...
+ (double)preferredHeight;	// IMP=0x000000000009aa84
- (void).cxx_destruct;	// IMP=0x000000000009bb56
...
- (void)commitGroupName;	// IMP=0x000000000009ba13
@property(copy, nonatomic) NSString *groupName;
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x000000000009b56b
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x000000000009b553
- (void)layoutMarginsDidChange;	// IMP=0x000000000009b541
- (void)layoutSubviews;	// IMP=0x000000000009b099
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000009aad4
- (void)dealloc;	// IMP=0x000000000009aa92
