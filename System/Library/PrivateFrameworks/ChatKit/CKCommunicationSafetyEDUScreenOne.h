...
- (void).cxx_destruct;	// IMP=0x00000000004aa6fc
...
- (void)_notNowButtonPressed;	// IMP=0x00000000004aa5ef
- (void)_acceptButtonPressed;	// IMP=0x00000000004aa4e6
- (void)_messageButtonPressed;	// IMP=0x00000000004aa46a
- (void)addButtonsToTray;	// IMP=0x00000000004aa29a
- (void)configureFirstReceiveScreen;	// IMP=0x00000000004a9f7c
- (void)configureFirstSendScreen;	// IMP=0x00000000004a9c5e
- (id)initFirstSendingEDUScreenWithComposition:(id)arg1 withSensitiveMediaObjects:(id)arg2 withIdentifiersOfShelvedImages:(id)arg3;	// IMP=0x00000000004a9a9f
- (id)initFirstReceivingEDUScreenWithItemIndexPath:(id)arg1;	// IMP=0x00000000004a996a
