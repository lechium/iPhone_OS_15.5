...
- (void).cxx_destruct;	// IMP=0x00000000000765af
- (id)flatbuffData;	// IMP=0x0000000000076437
- (Offset_53990046)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000075fb0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000075a55
- (id)initWithFlatbuffData:(id)arg1 root:(const struct FinalSpeechRecognitionResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000075887
- (id)initWithFlatbuffData:(id)arg1 root:(const struct FinalSpeechRecognitionResponse *)arg2;	// IMP=0x0000000000075871
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000075856
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000007583e
