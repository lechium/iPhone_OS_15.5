...
- (void).cxx_destruct;	// IMP=0x0000000000034017
...
- (void)callCompletionHandlersWithError:(id)arg1;	// IMP=0x0000000000033b14
- (void)streamFailVerifyBatchTranslationStreamingResponse:(id)arg1;	// IMP=0x00000000000339f2
- (void)streamDidReceiveBatchTranslationStreamingResponse:(id)arg1;	// IMP=0x0000000000032b53
