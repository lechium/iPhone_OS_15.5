...
+ (id)sharedInstance;	// IMP=0x000000000003e150
- (void).cxx_destruct;	// IMP=0x000000000003e1e9
...
- (void)logTranslateRequestEvent:(id)arg1 requestType:(id)arg2 routeType:(long long)arg3;	// IMP=0x000000000003e1a5
- (id)init;	// IMP=0x000000000003e05f
