...
- (id)flatbuffData;	// IMP=0x000000000007875e
- (Offset_b7f57b05)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000077c84
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000772aa
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartSpeechRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000770dc
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartSpeechRequest *)arg2;	// IMP=0x00000000000770c6
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000770ab
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000077093
