...
- (void).cxx_destruct;	// IMP=0x000000000002cf09
...
- (void)shrinkThumbAfterDelay:(double)arg1;	// IMP=0x000000000002cb9c
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x000000000002cb09
- (void)handleLongPress:(id)arg1;	// IMP=0x000000000002ca4a
- (void)cancelTrackingWithEvent:(id)arg1;	// IMP=0x000000000002c9ec
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000002c981
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000002c6bf
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000002c58d
- (id)createThumbView;	// IMP=0x000000000002c205
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000002c179
- (void)layoutSubviews;	// IMP=0x000000000002bf2d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000002bd18
