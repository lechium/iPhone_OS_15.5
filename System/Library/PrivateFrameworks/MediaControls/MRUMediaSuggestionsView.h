...
- (void).cxx_destruct;	// IMP=0x0000000000084583
...
- (long long)numberOfColumns;	// IMP=0x00000000000844c7
- (long long)numberOfRows;	// IMP=0x000000000008447f
- (double)itemHeightForItemWidth:(double)arg1;	// IMP=0x0000000000084388
- (double)itemWidthForWidth:(double)arg1;	// IMP=0x00000000000841e7
- (void)updateCollectionViewLayout;	// IMP=0x0000000000083bb8
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000000083a75
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000083a04
- (void)layoutSubviews;	// IMP=0x0000000000083983
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000083857
