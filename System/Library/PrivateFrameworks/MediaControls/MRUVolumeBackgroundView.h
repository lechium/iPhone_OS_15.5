...
- (void).cxx_destruct;	// IMP=0x0000000000087e97
...
- (void)updateVisibility;	// IMP=0x000000000008790b
- (void)collapseExpandableButtons;	// IMP=0x000000000008784e
- (void)expandButton:(id)arg1;	// IMP=0x0000000000087793
@property(readonly, nonatomic) _Bool hasExpandedButtons;
- (void)layoutSubviewsHorizontal;	// IMP=0x0000000000086953
- (void)layoutSubviewsVertical;	// IMP=0x0000000000085e30
- (void)layoutSubviews;	// IMP=0x0000000000085dd7
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000085b5b
