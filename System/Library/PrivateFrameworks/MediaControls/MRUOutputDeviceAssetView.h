...
- (void)updateVisibility;	// IMP=0x0000000000003494
- (void)updateContentSizeCategory;	// IMP=0x0000000000003439
- (void)updateVisualStyling;	// IMP=0x00000000000033de
- (void)visualStylingProviderDidChange:(id)arg1;	// IMP=0x00000000000033cc
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000030c6
- (void)layoutSubviews;	// IMP=0x0000000000002e08
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000002b69
