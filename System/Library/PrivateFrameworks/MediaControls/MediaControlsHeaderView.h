...
- (void).cxx_destruct;	// IMP=0x000000000009ecc5
...
- (id)cursorInteraction:(id)arg1 styleForRegion:(id)arg2 modifiers:(long long)arg3;	// IMP=0x000000000009e8c2
- (id)cursorInteraction:(id)arg1 regionForLocation:(struct CGPoint)arg2 defaultRegion:(id)arg3;	// IMP=0x000000000009e75b
- (void)launchNowPlayingAppButtonPressed;	// IMP=0x000000000009e73e
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000009e72c
- (void)_handleContentSizeCategoryDidChangeNotification:(id)arg1;	// IMP=0x000000000009e71a
- (void)_updateRTL;	// IMP=0x000000000009e570
- (void)clearOverrideSize;	// IMP=0x000000000009e23f
- (void)tintColorDidChange;	// IMP=0x000000000009dc52
- (void)didMoveToWindow;	// IMP=0x000000000009dbcf
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000009db74
- (void)updateArtworkStyle;	// IMP=0x000000000009d474
- (void)_updateStyle;	// IMP=0x000000000009cf85
- (struct CGSize)layoutTextInAvailableBounds:(struct CGRect)arg1 setFrames:(_Bool)arg2;	// IMP=0x000000000009bbfd
- (void)layoutSubviews;	// IMP=0x000000000009af90
- (void)dealloc;	// IMP=0x000000000009af0e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000009a08b
