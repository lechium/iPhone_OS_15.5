...
- (double)transitionDuration:(id)arg1;	// IMP=0x000000000002d52a
- (void)animateTransition:(id)arg1;	// IMP=0x000000000002d213
- (id)initForPresenting:(_Bool)arg1;	// IMP=0x000000000002d1d8
