...
+ (_Bool)_cursorInteractionEnabled;	// IMP=0x00000000000a1db3
- (void).cxx_destruct;	// IMP=0x00000000000a1c73
...
- (id)cursorInteraction:(id)arg1 styleForRegion:(id)arg2 modifiers:(long long)arg3;	// IMP=0x00000000000a19b1
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000a1906
