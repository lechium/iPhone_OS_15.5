...
- (void).cxx_destruct;	// IMP=0x000000000001ca88
...
- (_Bool)screentimeAllowedToShowConversationWithHandleIDs:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001c824
- (_Bool)screentimeAllowedToShowChat:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001c683
@property(readonly, nonatomic) _Bool isInternationalSpamFilteringEnabled;
- (void)registerForContactStoreChangeNotificationsIfNecessary;	// IMP=0x000000000001c5f8
- (void)contactStoreDidChange:(id)arg1;	// IMP=0x000000000001c526
