...
- (void).cxx_destruct;	// IMP=0x000000000000f5db
...
- (void)stopWithResult:(id)arg1;	// IMP=0x000000000000f4c6
- (void)cancelWithError:(id)arg1;	// IMP=0x000000000000f468
- (void)continueWithResult:(id)arg1;	// IMP=0x000000000000f40a
