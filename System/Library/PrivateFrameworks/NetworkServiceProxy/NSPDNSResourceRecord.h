...
+ (id)typeToString:(long long)arg1;	// IMP=0x000000000002b552
- (void).cxx_destruct;	// IMP=0x000000000002b678
...
- (id)copyStateDictionary;	// IMP=0x000000000002b3ec
- (id)initFromByteParser:(id)arg1;	// IMP=0x000000000002abdc
