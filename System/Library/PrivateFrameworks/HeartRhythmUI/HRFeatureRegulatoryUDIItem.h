...
- (void).cxx_destruct;	// IMP=0x000000000002bc87
- (void)handleUserInteractionWithItemWithHostViewController:(id)arg1;	// IMP=0x000000000002bb6c
@property(readonly, nonatomic) long long cellAccessoryType;
@property(readonly, nonatomic) _Bool isInteractive;
- (id)udiString;	// IMP=0x000000000002b912
...
- (id)initWithProductName:(id)arg1 deviceType:(long long)arg2;	// IMP=0x000000000002b75d
