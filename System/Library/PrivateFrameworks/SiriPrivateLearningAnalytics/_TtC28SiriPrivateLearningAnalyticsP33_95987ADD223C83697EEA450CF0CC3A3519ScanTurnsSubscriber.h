...
- (id)init;	// IMP=0x0000000000028990
- (void)cancel;	// IMP=0x0000000000028960
- (void)receiveCompletion:(id)arg1;	// IMP=0x00000000000288a0
- (long long)receiveInput:(id)arg1;	// IMP=0x0000000000028380
- (void)receiveSubscription:(id)arg1;	// IMP=0x0000000000027d10
