...
{
    unsigned int _externalFlashLayerContextID;	// 8 = 0x8
    UIImage *_preparedImage;	// 16 = 0x10
    unsigned long long _externalFlashLayerRenderID;	// 24 = 0x18
}

- (void).cxx_destruct;	// IMP=0x0000000000001dbf
