...
- (void).cxx_destruct;	// IMP=0x000000000016c3e2
...
- (id)fileWrapper;	// IMP=0x000000000016c25a
- (id)preferredCharacterSet;	// IMP=0x000000000016c1c2
- (id)attachmentsInDocument;	// IMP=0x000000000016bf25
- (id)attachmentForURL:(id)arg1;	// IMP=0x000000000016bdc4
- (id)mimePartForURL:(id)arg1;	// IMP=0x000000000016b85f
- (id)initWithMimePart:(id)arg1 htmlData:(id)arg2 encoding:(unsigned int)arg3;	// IMP=0x000000000016b7b1
- (id)initWithMimePart:(id)arg1;	// IMP=0x000000000016b720
- (id)_initWithMimePart:(id)arg1 htmlData:(id)arg2;	// IMP=0x000000000016b5fa
- (id)initWithMimeBody:(id)arg1;	// IMP=0x000000000016b532
- (id)init;	// IMP=0x000000000016b3b2
