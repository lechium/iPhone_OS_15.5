...
@interface MFConnectionSettings : NSObject <NSCopying>
{
    ...
    _Bool _isNonAppInitiated;	// 60 = 0x3c
...
- (void).cxx_destruct;	// IMP=0x00000000000162ef
...
- (id)description;	// IMP=0x000000000001611e
- (void)setConnectionServiceType:(struct __CFString *)arg1;	// IMP=0x00000000000160e4
- (struct __CFString *)connectionServiceType;	// IMP=0x00000000000160da
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000015e45
- (void)dealloc;	// IMP=0x0000000000015dd4
