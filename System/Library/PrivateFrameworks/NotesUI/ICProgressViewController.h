...
@interface ICProgressViewController : UIViewController
{
    ...
    id <ICProgressViewControllerDelegate> _progressDelegate;	// 24 = 0x18
    UILabel *_label;	// 32 = 0x20
    UIActivityIndicatorView *_activityIndicator;	// 40 = 0x28
    ICCircularProgressView *_circularProgressView;	// 48 = 0x30
}

- (void).cxx_destruct;	// IMP=0x00000000000cd4a9
...
- (_Bool)_canShowWhileLocked;	// IMP=0x00000000000cd3d4
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000000cd1f1
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000cd187
- (void)viewDidLoad;	// IMP=0x00000000000ccfff
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000ccf4b
