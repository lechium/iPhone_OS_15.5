...
@class NPKPassSyncEngine, NPKPassSyncState, NSData, NSDictionary, NSString;

@protocol NPKPassSyncEngineDataSource <NSObject>
- (NPKPassSyncState *)passSyncEngineNeedsUpdatedPassLibraryState:(NPKPassSyncEngine *)arg1;
