...
- (void).cxx_destruct;	// IMP=0x0000000000004fd2
...
- (id)operationsForPlayerRequest:(id)arg1;	// IMP=0x0000000000004ee0
- (id)operationsForRequest:(id)arg1;	// IMP=0x0000000000004e73
- (id)playerModelObject:(id)arg1 propertySet:(id)arg2 atIndexPath:(id)arg3 chain:(id)arg4;	// IMP=0x0000000000004ffa
