...
- (void).cxx_destruct;	// IMP=0x00000000001586f6
...
- (void)_onQueue_flush;	// IMP=0x0000000000157fee
- (void)subscribeToEventType:(id)arg1 options:(unsigned long long)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000157c50
- (void)subscribeToEventType:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000157c39
- (void)flushEventsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000157ab3
- (void)cancelSubscription;	// IMP=0x000000000015798e
@property(readonly, copy) NSString *debugDescription;
- (id)initWithConsumer:(id)arg1 eventStream:(id)arg2;	// IMP=0x00000000001576cd
