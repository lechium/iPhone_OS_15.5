...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000d1c7d
- (void).cxx_destruct;	// IMP=0x00000000000d126e
...
- (void)_updateRadioStationPlaybackAuthorizationTokenIfNeeded;	// IMP=0x00000000000d1054
- (void)_inLock_buildPlaceholder;	// IMP=0x00000000000d0f93
- (void)_buildPlaceholder;	// IMP=0x00000000000d0f61
- (_Bool)section:(id)arg1 shouldShuffleExcludeItem:(id)arg2;	// IMP=0x00000000000d0f41
- (_Bool)section:(id)arg1 supportsShuffleType:(long long)arg2;	// IMP=0x00000000000d0f1c
- (void)reloadSection:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000d0c98
- (void)updatePlaybackContext;	// IMP=0x00000000000d0b75
@property(readonly, nonatomic) MPPlaceholderAVItem *tailPlaceholderItem; // @synthesize tailPlaceholderItem=_tailPlaceholderItem;
- (void)loadAdditionalItemsIfNeededWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000d0893
- (_Bool)shouldUsePlaceholderForItem:(id)arg1 inSection:(id)arg2;	// IMP=0x00000000000d0873
- (_Bool)shouldShowPlaceholderAtTail;	// IMP=0x00000000000d07f5
- (long long)prefetchThreshold;	// IMP=0x00000000000d07ce
- (_Bool)shouldRequestAdditionalItemsAtTail;	// IMP=0x00000000000d07a1
@property(readonly, nonatomic) _Bool shouldAddOriginalPlaybackContextAfterReplacement;
- (id)itemForItem:(id)arg1 inSection:(id)arg2;	// IMP=0x00000000000d0773
- (void)itemDidBeginPlayback:(id)arg1;	// IMP=0x00000000000d0755
- (id)firstItemIntersectingIdentifierSet:(id)arg1;	// IMP=0x00000000000d0725
@property(readonly, nonatomic) _Bool containsLiveStream;
- (_Bool)canSkipItem:(id)arg1;	// IMP=0x00000000000d06ef
- (_Bool)canJumpToItem:(id)arg1;	// IMP=0x00000000000d06cf
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d02f0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d007d
@property(readonly, copy) NSString *description;
- (void)updatePlaybackCoordinator:(id)arg1;	// IMP=0x00000000000cff58
- (id)initWithPlaybackContext:(id)arg1;	// IMP=0x00000000000cfc24
