...
- (void).cxx_destruct;	// IMP=0x0000000000181d25
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000181a90
- (id)description;	// IMP=0x000000000018199c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000181719
- (unsigned long long)hash;	// IMP=0x00000000001816be
- (id)initWithDelegatedUserIdentity:(id)arg1;	// IMP=0x000000000018164b
- (id)initWithUserIdentity:(id)arg1 subscriptionStatus:(id)arg2;	// IMP=0x00000000001815b2
