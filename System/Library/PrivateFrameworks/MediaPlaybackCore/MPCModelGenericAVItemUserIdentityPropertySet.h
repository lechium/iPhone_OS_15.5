...
+ (void)identityPropertySetFromRequestContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000038872
...
- (id)initWithIdentityProperties:(id)arg1 delegatedIdentityProperties:(id)arg2;	// IMP=0x000000000003875f
