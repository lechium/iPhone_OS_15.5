...
- (void).cxx_destruct;	// IMP=0x000000000018db9d
...
- (void)relinquishLeaseForItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000018d888
- (void)requestLeaseForItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000018d579
- (id)initWithTranslator:(id)arg1 leaseManager:(id)arg2;	// IMP=0x000000000018d4e0
