...
- (void)_personalizationResponseDidInvalidateNotification:(id)arg1;	// IMP=0x000000000005f1b6
- (void)dealloc;	// IMP=0x000000000005f121
- (id)initWithRequest:(id)arg1 personalizationResponse:(id)arg2 firstResponse:(_Bool)arg3 finalResponse:(_Bool)arg4;	// IMP=0x000000000005efcd
