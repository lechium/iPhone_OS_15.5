...
- (void).cxx_destruct;	// IMP=0x00000000000846ff
@property(readonly, copy, nonatomic) MPPropertySet *requestedProperties; // @synthesize requestedProperties=_requestedProperties;
- (id)genericObjectForRadioStationTrack:(id)arg1 containerUniqueID:(id)arg2 userIdentity:(id)arg3;	// IMP=0x0000000000084119
- (id)initWithRequestedProperties:(id)arg1;	// IMP=0x00000000000840a6
