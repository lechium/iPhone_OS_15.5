...
+ (id)playMetricsWithErrorSignature:(id)arg1 event:(id)arg2 cursor:(id)arg3;	// IMP=0x00000000001b2962
+ (id)playMetricsWithFirstFrameEvent:(id)arg1 cursor:(id)arg2;	// IMP=0x00000000001b0d9a
- (void).cxx_destruct;	// IMP=0x00000000001b0ca9
@property(retain, nonatomic) NSMutableDictionary *data; // @synthesize data=_data;
- (void)addEnvironmentInfoWithCursor:(id)arg1;	// IMP=0x00000000001b0be2
- (void)addAssetLoadInfoWithCursor:(id)arg1 itemIDPayload:(id)arg2;	// IMP=0x00000000001aff21
- (void)addSharePlayWithCursor:(id)arg1;	// IMP=0x00000000001afe97
- (void)addPlaybackBehaviorWithCursor:(id)arg1;	// IMP=0x00000000001afcad
- (void)addQueueMetadata:(id)arg1;	// IMP=0x00000000001afbff
- (id)humanDescription;	// IMP=0x00000000001aeeaf
- (id)description;	// IMP=0x00000000001aedcb
...
- (id)init;	// IMP=0x00000000001ae3f6
