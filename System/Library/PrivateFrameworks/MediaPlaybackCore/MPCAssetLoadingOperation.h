...
- (void).cxx_destruct;	// IMP=0x000000000009558c
...
- (_Bool)_configureItem:(id)arg1 error:(id *)arg2;	// IMP=0x000000000009503c
- (void)main;	// IMP=0x00000000000948eb
- (_Bool)isFinished;	// IMP=0x00000000000948db
- (_Bool)isExecuting;	// IMP=0x00000000000948cb
- (void)start;	// IMP=0x00000000000946b1
- (id)initWithPlayerItem:(id)arg1 configurator:(id)arg2 delegate:(id)arg3 token:(long long)arg4 callbackQueue:(id)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x0000000000094582
