...
- (void).cxx_destruct;	// IMP=0x0000000000095b8f
...
- (void)cancelLoading;	// IMP=0x0000000000095b06
- (void)loadAssetFor:(id)arg1 token:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000095865
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000957a1
