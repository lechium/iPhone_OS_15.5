...
- (void).cxx_destruct;	// IMP=0x0000000000003ee2
...
- (void)_transitionToLiveLinkState:(long long)arg1 error:(id)arg2;	// IMP=0x00000000000035a8
- (void)_transitionToLiveLinkState:(long long)arg1;	// IMP=0x0000000000003594
- (void)_transitionToSourceState:(long long)arg1 error:(id)arg2;	// IMP=0x0000000000002e34
- (void)_transitionToSourceState:(long long)arg1;	// IMP=0x0000000000002e20
- (void)_transitionToBuildState:(long long)arg1 intent:(id)arg2 error:(id)arg3;	// IMP=0x000000000000238c
- (void)_transitionToBuildState:(long long)arg1;	// IMP=0x0000000000002375
- (void)liveLink:(id)arg1 didUpdateQueue:(id)arg2;	// IMP=0x00000000000021b3
- (void)liveLink:(id)arg1 didEncounterError:(id)arg2 willRetry:(_Bool)arg3;	// IMP=0x0000000000002130
- (void)didStartLiveLink:(id)arg1;	// IMP=0x0000000000002001
- (void)getPlaybackContextForIntent:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000001f16
- (void)buildSharedSessionIntentWithIntent:(id)arg1 identity:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000001cc4
