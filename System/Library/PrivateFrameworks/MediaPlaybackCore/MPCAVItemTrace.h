...
+ (id)traceIntervalWithName:(id)arg1 item:(id)arg2 beginEvent:(unsigned int)arg3 endEvent:(unsigned int)arg4;	// IMP=0x0000000000192250
+ (void)traceWithName:(id)arg1 item:(id)arg2 event:(unsigned int)arg3;	// IMP=0x0000000000192172
- (void).cxx_destruct;	// IMP=0x000000000019214c
...
- (void)cancel;	// IMP=0x0000000000191f42
- (void)endInterval;	// IMP=0x0000000000191db8
- (void)dealloc;	// IMP=0x0000000000191d7a
