...
@class MPAVItem, MPPlaybackContext, NSArray, NSString;
...
- (_Bool)canJumpToContentItemID:(NSString *)arg1;
- (void)jumpToFirstContentItem;
- (void)clearUpNext;
- (void)reshuffle;
- (void)currentItemDidChangeFromItem:(MPAVItem *)arg1 toItem:(MPAVItem *)arg2;
...
- (_Bool)canPreviousTrackForItem:(MPAVItem *)arg1;
- (_Bool)canNextTrackForItem:(MPAVItem *)arg1;
