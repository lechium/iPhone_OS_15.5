...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000edc30
- (void).cxx_destruct;	// IMP=0x00000000000edda1
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000edd01
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000edc38
