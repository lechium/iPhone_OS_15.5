...
+ (id)enumeratorWithQueueController:(id)arg1 mode:(long long)arg2 options:(unsigned long long)arg3 startPosition:(id)arg4 endPosition:(id)arg5;	// IMP=0x000000000011f739
- (void).cxx_destruct;	// IMP=0x000000000011f61e
...
- (void)_buildEnumerator;	// IMP=0x000000000011f081
- (id)_init;	// IMP=0x000000000011f052
- (id)nextObject;	// IMP=0x000000000011ef99
