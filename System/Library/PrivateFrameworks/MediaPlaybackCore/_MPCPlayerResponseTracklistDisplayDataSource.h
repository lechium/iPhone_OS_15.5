...
- (void).cxx_destruct;	// IMP=0x0000000000105222
...
- (id)itemAtIndexPath:(id)arg1;	// IMP=0x0000000000105128
- (unsigned long long)numberOfItemsInSection:(unsigned long long)arg1;	// IMP=0x0000000000105033
- (id)sectionAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000104fa8
- (unsigned long long)numberOfSections;	// IMP=0x0000000000104f2d
- (id)displayIndexPathForStructuredIndexPath:(id)arg1;	// IMP=0x0000000000104beb
- (id)structuredIndexPathForDisplayIndexPath:(id)arg1;	// IMP=0x00000000001048d3
- (id)initWithTracklistItems:(id)arg1 playingItemIndexPath:(id)arg2;	// IMP=0x0000000000103fb0
