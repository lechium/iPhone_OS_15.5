...
- (void).cxx_destruct;	// IMP=0x00000000000fe919
...
- (id)replaceWithPlaybackIntent:(id)arg1 replaceIntent:(long long)arg2;	// IMP=0x00000000000fe37c
- (id)replaceWithPlaybackIntent:(id)arg1;	// IMP=0x00000000000fe365
- (id)clearUpNextItems;	// IMP=0x00000000000fe20f
- (id)clear;	// IMP=0x00000000000fe02d
