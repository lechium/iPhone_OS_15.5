...
- (void).cxx_destruct;	// IMP=0x00000000000057b5
...
- (void)tearDownObservations;	// IMP=0x0000000000005654
- (void)setupObservations;	// IMP=0x0000000000005434
- (void)restoreSessionSettingsFromSnapshot;	// IMP=0x00000000000053c6
- (void)snapshotSessionSettings;	// IMP=0x00000000000052d9
- (void)updateAudioSession:(id)arg1 options:(unsigned long long)arg2 routeSharingPolicy:(unsigned long long)arg3;	// IMP=0x000000000000524a
- (void)dealloc;	// IMP=0x000000000000520c
- (id)init;	// IMP=0x000000000000517f
