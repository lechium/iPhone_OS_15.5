...
- (void).cxx_destruct;	// IMP=0x00000000000cfa06
@property(copy, nonatomic) MPSectionedCollection *radioStationTracks; // @synthesize radioStationTracks=_radioStationTracks;
- (void)dealloc;	// IMP=0x00000000000cf94f
- (id)initWithRequest:(id)arg1 personalizationResponse:(id)arg2;	// IMP=0x00000000000cf7ee
