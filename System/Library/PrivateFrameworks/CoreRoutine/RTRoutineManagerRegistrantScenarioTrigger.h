...
- (void).cxx_destruct;	// IMP=0x000000000001c057
...
- (void)onScenarioTriggers:(id)arg1 error:(id)arg2;	// IMP=0x000000000001bbfa
- (id)stopMonitoringForScenarioTriggerTypes:(unsigned long long)arg1;	// IMP=0x000000000001bb31
- (id)startMonitoringForScenarioTriggerTypes:(unsigned long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000000001b96c
- (id)init;	// IMP=0x000000000001b90f
