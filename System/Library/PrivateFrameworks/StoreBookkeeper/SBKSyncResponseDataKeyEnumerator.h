...
- (void).cxx_destruct;	// IMP=0x000000000001fe68
...
- (void)_processNextKey;	// IMP=0x000000000001fcae
- (void)_processDeletedKey:(id)arg1 isDirty:(_Bool *)arg2;	// IMP=0x000000000001fc32
- (void)_processUpdatedKey:(id)arg1 isConflict:(_Bool)arg2 isDirty:(_Bool *)arg3;	// IMP=0x000000000001fb7a
- (void)enumerateKeysInResponseForTransaction:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000001fa33
- (id)initWithResponseData:(id)arg1;	// IMP=0x000000000001f9c8
