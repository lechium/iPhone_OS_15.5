...
+ (id)deserializedResponseBodyWithTransaction:(id)arg1 responseDictionary:(id)arg2 response:(id)arg3;	// IMP=0x000000000000b21c
- (void).cxx_destruct;	// IMP=0x000000000000aa36
...
- (void)_deserializeResponseDictionary:(id)arg1 response:(id)arg2;	// IMP=0x000000000000a78c
- (id)payloadDataForUpdateResponseKey:(id)arg1;	// IMP=0x000000000000a6f7
- (id)description;	// IMP=0x000000000000a4cb
- (id)initWithTransaction:(id)arg1 responseDictionary:(id)arg2 response:(id)arg3;	// IMP=0x000000000000a337
