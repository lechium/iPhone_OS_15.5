...
- (void).cxx_destruct;	// IMP=0x000000000002801c
...
- (id)description;	// IMP=0x0000000000027e80
@property(readonly, nonatomic) NSDictionary *dictionary;
- (void)insertValue:(double)arg1;	// IMP=0x0000000000027938
- (id)initWithCapacity:(unsigned long long)arg1 dictionary:(id)arg2;	// IMP=0x0000000000027558
- (id)initWithCapacity:(unsigned long long)arg1;	// IMP=0x00000000000274e1
