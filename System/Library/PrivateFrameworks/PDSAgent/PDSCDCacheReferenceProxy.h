...
- (void).cxx_destruct;	// IMP=0x00000000000135a2
...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000013546
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x00000000000134cf
- (id)initWithCacheContainer:(id)arg1 persistentContainer:(id)arg2;	// IMP=0x0000000000013451
