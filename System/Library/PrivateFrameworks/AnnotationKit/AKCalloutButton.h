...
- (void).cxx_destruct;	// IMP=0x0000000000002f76
...
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000002eae
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000002e2a
