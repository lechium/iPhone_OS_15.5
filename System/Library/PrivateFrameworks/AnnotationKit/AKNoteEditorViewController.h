...
- (void).cxx_destruct;	// IMP=0x000000000006586c
...
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000000006577b
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000000656d7
- (void)viewDidLoad;	// IMP=0x000000000006559d
