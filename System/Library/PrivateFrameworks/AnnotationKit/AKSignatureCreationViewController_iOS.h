...
- (void).cxx_destruct;	// IMP=0x00000000000529b6
...
- (void)_updateSignatureDescriptionWithStringValue:(id)arg1;	// IMP=0x0000000000052705
- (void)_removeSignatureDescription;	// IMP=0x0000000000052638
- (void)showEditCustomDescriptionAlert;	// IMP=0x0000000000052050
- (void)_showSignatureDescriptionSelectionAlert;	// IMP=0x00000000000517b2
- (long long)positionForBar:(id)arg1;	// IMP=0x00000000000517a7
- (void)_applicationDidBecomeActive:(id)arg1;	// IMP=0x0000000000051701
- (void)_notifyDidDismiss;	// IMP=0x00000000000516a4
- (void)_done:(id)arg1;	// IMP=0x000000000005136e
- (void)_clear:(id)arg1;	// IMP=0x0000000000051331
- (void)_cancel:(id)arg1;	// IMP=0x00000000000511fb
- (_Bool)_canShowWhileLocked;	// IMP=0x00000000000511f3
- (void)_validateButtons;	// IMP=0x0000000000050fc1
- (_Bool)prefersStatusBarHidden;	// IMP=0x0000000000050fb9
- (void)willTransitionToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x0000000000050d0c
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000050bba
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x0000000000050984
- (void)didReceiveMemoryWarning;	// IMP=0x0000000000050955
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00000000000508bc
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0000000000050867
- (_Bool)becomeFirstResponder;	// IMP=0x000000000005079e
- (_Bool)canBecomeFirstResponder;	// IMP=0x0000000000050796
- (void)viewDidLoad;	// IMP=0x000000000004ef54
- (void)loadView;	// IMP=0x000000000004eee7
- (void)dealloc;	// IMP=0x000000000004ee72
- (id)initWithController:(id)arg1;	// IMP=0x000000000004ed1b
