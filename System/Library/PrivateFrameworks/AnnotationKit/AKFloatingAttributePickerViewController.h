...
- (void).cxx_destruct;	// IMP=0x0000000000067c75
...
- (void)syncTextAttributesToUI:(id)arg1;	// IMP=0x0000000000067b31
- (id)convertTextAttributes:(id)arg1;	// IMP=0x00000000000679eb
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000067868
- (void)setRightButtonItems:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000006773c
- (void)valueChanged:(id)arg1;	// IMP=0x000000000006753b
- (void)viewDidLoad;	// IMP=0x0000000000066ef5
- (id)initWithController:(id)arg1;	// IMP=0x0000000000066e89
