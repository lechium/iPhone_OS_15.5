...
+ (id)animationWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x000000000000db9c
- (void).cxx_destruct;	// IMP=0x000000000000df1d
...
- (void)completeAnimation;	// IMP=0x000000000000de4a
- (_Bool)isAnimating;	// IMP=0x000000000000de33
- (void)update:(double)arg1;	// IMP=0x000000000000dd71
- (void)dealloc;	// IMP=0x000000000000dd13
- (id)initWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x000000000000dc32
