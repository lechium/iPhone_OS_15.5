...
- (void).cxx_destruct;	// IMP=0x00000000001c1eec
...
- (id)description;	// IMP=0x00000000001c1eb8
- (id)initWithPlayerPath:(id)arg1 queue:(id)arg2 invalidationCallback:(CDUnknownBlockType)arg3;	// IMP=0x00000000001c1d99
