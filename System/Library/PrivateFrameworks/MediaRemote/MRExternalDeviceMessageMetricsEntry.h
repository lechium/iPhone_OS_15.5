...
- (void).cxx_destruct;	// IMP=0x00000000000fa8e3
...
- (id)description;	// IMP=0x00000000000fa836
- (void)updateWithValue:(unsigned long long)arg1;	// IMP=0x00000000000fa797
- (id)init;	// IMP=0x00000000000fa739
