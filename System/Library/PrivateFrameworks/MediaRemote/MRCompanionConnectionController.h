...
- (void).cxx_destruct;	// IMP=0x0000000000119aee
...
- (id)debugDescription;	// IMP=0x00000000001198be
- (void)_maybeAttemptToDiscoverAndConnectToCompanionWithReason:(id)arg1;	// IMP=0x00000000001191eb
- (_Bool)_shouldAttemptToDiscoverAndConnectToCompanion;	// IMP=0x0000000000119105
- (void)_handleExternalDeviceConnectionStateDidChangeNotification:(id)arg1;	// IMP=0x0000000000118f07
- (void)_handleCompanionDeviceConnectedNotification:(id)arg1;	// IMP=0x0000000000118eee
- (id)init;	// IMP=0x0000000000118937
