...
- (unsigned long long)type;	// IMP=0x00000000000fbaae
@property(readonly, nonatomic) unsigned long long virtualDeviceID;
@property(readonly, nonatomic) struct _MRHIDTouchEvent event;
- (id)initWithTouchEvent:(struct _MRHIDTouchEvent)arg1 virtualDeviceID:(unsigned long long)arg2;	// IMP=0x00000000000fb89d
