...
- (void).cxx_destruct;	// IMP=0x00000000001ba178
...
- (_Bool)removePlaybackQueueDataSourceCallback:(id)arg1;	// IMP=0x00000000001b9ee2
- (void)registerNowPlayingInfoArtworkAssetCallback:(id)arg1;	// IMP=0x00000000001b9af5
- (void)registerNowPlayingInfoAssetCallbacks:(id)arg1;	// IMP=0x00000000001b975a
- (void)registerNowPlayingInfoCallbacks:(id)arg1;	// IMP=0x00000000001b92c2
- (void)registerNowPlayingInfoBackedPlaybackQueueDataSourceCallbacks;	// IMP=0x00000000001b925a
@property(readonly, copy, nonatomic) NSArray *commandHandlerBlocks;
- (void)removeCommandHandlerBlockForKey:(id)arg1;	// IMP=0x00000000001b9061
- (void)addCommandHandlerBlock:(CDUnknownBlockType)arg1 forKey:(id)arg2;	// IMP=0x00000000001b8f52
- (unsigned long long)_onQueue_capabilities;	// IMP=0x00000000001b8e7f
...
- (id)initWithPlayerPath:(id)arg1 queue:(id)arg2;	// IMP=0x00000000001b79c6
