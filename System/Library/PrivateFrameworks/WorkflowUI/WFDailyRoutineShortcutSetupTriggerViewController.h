...
{
    id <WFDailyRoutineShortcutSetupTriggerViewControllerDelegate> _delegate;	// 8 = 0x8
    WFDailyRoutineShortcutSetupTriggerBuilder *_trigger;	// 16 = 0x10
}

- (void).cxx_destruct;	// IMP=0x00000000001b87fc
...
- (void)didSelectSkipButton;	// IMP=0x00000000001b8772
- (void)didSelectAddTriggerButton;	// IMP=0x00000000001b8726
- (id)initWithTrigger:(id)arg1;	// IMP=0x00000000001b8502
