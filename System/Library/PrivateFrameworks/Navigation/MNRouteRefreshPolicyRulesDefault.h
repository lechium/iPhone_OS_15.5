...
- (double)maxTimeIntervalFromNowForDestinationRefresh:(id)arg1 fromDate:(id)arg2;	// IMP=0x00000000000255c5
- (double)timeIntervalForDestinationRefresh:(id)arg1 lastUpdate:(id)arg2;	// IMP=0x00000000000255b7
@property(readonly, nonatomic) _Bool canWakeDeviceForUpdates;
@property(readonly, nonatomic) _Bool canWakeClientForUpdates;
- (_Bool)canMakeNetworkRequestsForDestination:(id)arg1 atDate:(id)arg2;	// IMP=0x000000000002559f
- (id)init;	// IMP=0x0000000000025563
