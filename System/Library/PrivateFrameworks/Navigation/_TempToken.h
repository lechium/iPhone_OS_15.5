...
- (void).cxx_destruct;	// IMP=0x0000000000017413
...
- (id)initWithToken:(id)arg1;	// IMP=0x00000000000170a2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000016f1f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000016b61
