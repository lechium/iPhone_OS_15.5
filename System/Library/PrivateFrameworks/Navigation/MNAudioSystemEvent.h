...
- (void).cxx_destruct;	// IMP=0x0000000000007421
...
- (id)description;	// IMP=0x0000000000007229
- (_Bool)isEqualToEvent:(id)arg1;	// IMP=0x00000000000070d6
@property(readonly, nonatomic) _Bool hasSoundEffect;
- (id)initWithUtterance:(id)arg1 andShortPrompt:(unsigned long long)arg2 andVoiceGuidanceLevel:(unsigned long long)arg3 andCompletion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000006faf
