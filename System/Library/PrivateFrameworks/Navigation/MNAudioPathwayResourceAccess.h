...
- (void).cxx_destruct;	// IMP=0x00000000000e9ece
...
- (void)removeObserver:(id)arg1;	// IMP=0x00000000000e9e9a
- (void)addObserver:(id)arg1;	// IMP=0x00000000000e9e94
- (id)initWithHFPEnabled:(_Bool)arg1;	// IMP=0x00000000000e9e46
