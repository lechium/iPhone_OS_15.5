...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x000000000000b638
+ (void)registerFeature;	// IMP=0x000000000000b606
...
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x000000000000b6cf
