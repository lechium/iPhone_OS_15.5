...
- (void).cxx_destruct;	// IMP=0x000000000003bdba
...
- (void)buttonAtIndexWasPressed:(unsigned long long)arg1;	// IMP=0x000000000003bca0
- (void)configureWithRequest:(id)arg1;	// IMP=0x000000000003bad5
