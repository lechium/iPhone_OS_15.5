...
- (void).cxx_destruct;	// IMP=0x000000000001516e
...
- (void)cancel;	// IMP=0x0000000000014f00
- (void)executionDidBegin;	// IMP=0x0000000000014eee
- (void)_promptForPrivacyWithDisplayNameIfRequired:(id)arg1 providerID:(id)arg2 providerIsSupported:(_Bool)arg3 allowUI:(_Bool)arg4;	// IMP=0x0000000000014b7a
- (void)_determineProviderDisplayNameWithUI:(_Bool)arg1;	// IMP=0x0000000000014548
- (void)_checkSupportedProviders;	// IMP=0x0000000000013e68
- (void)_finishWithSupportedProviders:(id)arg1;	// IMP=0x00000000000135ca
- (void)_checkAvailability;	// IMP=0x0000000000013447
- (void)_continueCheckPrivacyWithAccessStatus:(unsigned long long)arg1;	// IMP=0x00000000000132a8
- (void)_checkPrivacy;	// IMP=0x0000000000012ac8
- (void)_checkEntitlement;	// IMP=0x0000000000012980
- (void)_finishWithError:(id)arg1;	// IMP=0x000000000001286a
- (id)_privacyServiceWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000127e7
- (void)dealloc;	// IMP=0x000000000001279e
- (id)init;	// IMP=0x000000000001254b
