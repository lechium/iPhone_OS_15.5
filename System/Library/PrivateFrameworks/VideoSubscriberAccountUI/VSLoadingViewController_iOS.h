...
- (void).cxx_destruct;	// IMP=0x0000000000052fa2
...
- (void)_cancelButtonPressed:(id)arg1;	// IMP=0x0000000000052e4e
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0000000000052d38
- (void)viewDidLoad;	// IMP=0x0000000000052a4a
