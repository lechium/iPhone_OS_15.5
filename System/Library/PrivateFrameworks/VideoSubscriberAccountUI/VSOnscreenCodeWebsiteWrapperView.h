...
- (void).cxx_destruct;	// IMP=0x0000000000055dbb
...
- (void)buttonLockupPressed;	// IMP=0x0000000000055bbf
- (void)setupLocalizedStrings;	// IMP=0x0000000000055996
- (void)setupLayout;	// IMP=0x0000000000053e57
- (void)setupDetailsView;	// IMP=0x0000000000053ad5
- (void)setupInfoView;	// IMP=0x00000000000539e8
- (void)updateUIWithViewModel:(id)arg1;	// IMP=0x000000000005389f
- (id)initWithButtonLockup:(_Bool)arg1;	// IMP=0x0000000000053816
