...
- (void).cxx_destruct;	// IMP=0x0000000000048fdb
...
- (void)configureWithRequest:(id)arg1;	// IMP=0x0000000000048e50
- (void)didSelectManualSignInButton;	// IMP=0x0000000000048e04
- (id)init;	// IMP=0x0000000000048d40
