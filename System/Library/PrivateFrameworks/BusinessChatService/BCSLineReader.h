...
- (void).cxx_destruct;	// IMP=0x0000000000048dd2
...
- (void)dealloc;	// IMP=0x0000000000048cee
- (_Bool)hasValidURL;	// IMP=0x0000000000048caa
- (void)refillReadBuffer;	// IMP=0x0000000000048b48
- (id)readLine;	// IMP=0x00000000000485e1
- (id)initWithFileURL:(id)arg1 bufferSize:(unsigned long long)arg2 maxLineSize:(unsigned long long)arg3;	// IMP=0x00000000000484d2
- (id)initWithFileURL:(id)arg1;	// IMP=0x00000000000484b5
