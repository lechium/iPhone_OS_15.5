...
- (void).cxx_destruct;	// IMP=0x0000000000061b30
- (id)computeCaptionForImageWithInputs:(id)arg1 genderOption:(int)arg2;	// IMP=0x0000000000060c60
- (void)extractBeamID:(id *)arg1 tokenID:(id *)arg2 lstmAttnState:(CDStruct_0a65202a *)arg3 lstmLangState:(CDStruct_0a65202a *)arg4 fromFollowup:(id)arg5;	// IMP=0x0000000000060a30
- (id)packBeamID:(id)arg1 tokenID:(id)arg2 lstmAttnState:(CDStruct_0a65202a *)arg3 lstmLangState:(CDStruct_0a65202a *)arg4 softmax:(CDStruct_0a65202a *)arg5;	// IMP=0x0000000000060740
- (void)dealloc;	// IMP=0x00000000000606a0
- (id)initWithOptions:(id)arg1 runTimeParams:(id)arg2;	// IMP=0x000000000005f9a0
