...
- (void)consumeStream:(struct __FSEventStream *)arg1 forVolume:(id)arg2;	// IMP=0x000000000001e9ab
- (void)callback:(id)arg1;	// IMP=0x000000000001dc41
- (void)dealloc;	// IMP=0x000000000001dbdb
- (id)initWithConsumer:(CDUnknownBlockType)arg1 identifier:(id)arg2;	// IMP=0x000000000001daee
