...
@interface CRNBlockScrollTestParameters : NSObject <CRNScrollTestParameters, CRNBlockBasedScrollTestParameters>
{
    ...
    CDUnknownBlockType _composerBlock;	// 24 = 0x18
}

- (void).cxx_destruct;	// IMP=0x0000000000005301
...
- (id)initWithTestName:(id)arg1 withComposerBlock:(CDUnknownBlockType)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000050c6
- (id)initWithTestName:(id)arg1 withComposerBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000050b1
