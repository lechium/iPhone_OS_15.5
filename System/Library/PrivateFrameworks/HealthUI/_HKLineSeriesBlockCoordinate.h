...
- (void).cxx_destruct;	// IMP=0x000000000007b2b8
...
- (double)maxYValue;	// IMP=0x000000000007b1c5
- (double)minYValue;	// IMP=0x000000000007b1ba
- (id)copyWithTransform:(struct CGAffineTransform)arg1 roundToViewScale:(_Bool)arg2;	// IMP=0x000000000007b12c
- (id)initWithCoordinate:(struct CGPoint)arg1 userInfo:(id)arg2;	// IMP=0x000000000007b0a3
