...
- (void).cxx_destruct;	// IMP=0x00000000002509b1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000025066e
- (unsigned long long)hash;	// IMP=0x0000000000250441
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000250103
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000024feb7
- (void)copyTo:(id)arg1;	// IMP=0x000000000024fcac
- (void)writeTo:(id)arg1;	// IMP=0x000000000024fa65
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000024fa58
- (id)dictionaryRepresentation;	// IMP=0x000000000024eb8e
- (id)description;	// IMP=0x000000000024eadf
