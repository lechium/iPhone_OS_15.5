...
- (void).cxx_destruct;	// IMP=0x00000000001b3c76
...
- (id)_statItemForTimeScope:(long long)arg1;	// IMP=0x00000000001b3bde
- (id)formatterForTimescope:(long long)arg1;	// IMP=0x00000000001b3ad8
@property(readonly, nonatomic) HKLineSeries *alternateLineSeries;
- (id)initWithCustomDataSource:(id)arg1 primaryDisplayType:(id)arg2;	// IMP=0x00000000001b3a37
