...
- (unsigned int)maxBandwidthWithOperatingMode:(int)arg1 connectionType:(int)arg2;	// IMP=0x00000000002980da
- (void)addBandwidthConfigurations:(id)arg1;	// IMP=0x00000000002980a5
- (void)dealloc;	// IMP=0x0000000000298031
- (id)init;	// IMP=0x0000000000297fb1
