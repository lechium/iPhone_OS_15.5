...
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x000000000016098c
- (void)addBDCDListWithNotificationArrivalTime:(double)arg1 bdcd:(double)arg2 queuingDelay:(double)arg3;	// IMP=0x0000000000160880
- (void)resetBBNoteHistoryList;	// IMP=0x0000000000160865
- (void)resetBDCDList;	// IMP=0x000000000016084a
- (void)normalizeBDCD:(double)arg1;	// IMP=0x00000000001605e9
- (double)updateTotalQueueDepth:(unsigned int)arg1;	// IMP=0x000000000016057a
- (void)calculateBitratesAndDelaysWithTotalQueueDepth:(unsigned int)arg1;	// IMP=0x00000000001602c5
- (void)addInfoListWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x0000000000160202
- (CDStruct_87b99198)getBasebandMetricsWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x000000000015ffa3
- (void)dealloc;	// IMP=0x000000000015ff45
- (id)init;	// IMP=0x000000000015fe9e
