...
- (void)flushRealTimeReportingStats;	// IMP=0x00000000002cf6fe
- (void)deregisterPeriodicTask;	// IMP=0x00000000002cf6df
- (void)periodicTask:(void *)arg1;	// IMP=0x00000000002cf4a9
- (void)registerPeriodicTask;	// IMP=0x00000000002cf459
@property(readonly) id reportingAgent;
- (void)resetHealthPrintCounters;	// IMP=0x00000000002cf421
- (void)healthPrintForServerStats;	// IMP=0x00000000002cf208
- (void)calculateInterCallbackDurationWithTime:(double)arg1;	// IMP=0x00000000002cf1ca
- (void)handleRemoteSessionStats:(CDStruct_6eb6ca1b *)arg1;	// IMP=0x00000000002ced96
- (void)statsReceiveStatsPayload;	// IMP=0x00000000002cec26
- (void)triggerRateControlWithLocalSessionStats:(CDStruct_b5e1e8f2)arg1 time:(double)arg2 forUplink:(_Bool)arg3 forDownlink:(_Bool)arg4 fromVCRCExternalThread:(_Bool)arg5;	// IMP=0x00000000002ce9b7
- (unsigned short)translateTimestampFromMicro:(double)arg1;	// IMP=0x00000000002ce99e
- (_Bool)isRemoteSessionStatsTooLateWithStatsId:(unsigned short)arg1;	// IMP=0x00000000002ce87d
- (void)updateRemoteSessionStats:(CDStruct_2756d7ac)arg1;	// IMP=0x00000000002ce17d
- (void)stopLocalSessionStatsUpdate;	// IMP=0x00000000002ce04d
- (void)startLocalSessionStatsSend;	// IMP=0x00000000002cddc0
- (void)startLocalSessionStatsReceive;	// IMP=0x00000000002cdb7e
- (void)startLocalSessionStatsUpdate;	// IMP=0x00000000002cdb50
- (void)sendLocalStats;	// IMP=0x00000000002cdab3
- (void)reset;	// IMP=0x00000000002cd9d8
- (void)dealloc;	// IMP=0x00000000002cd84d
- (id)initWithDelegate:(id)arg1 connectionManager:(id)arg2 uplinkStatsCollector:(id)arg3 downlinkStatsCollector:(id)arg4 reportingAgent:(struct opaqueRTCReporting *)arg5 transportSessionID:(unsigned int)arg6 streamID:(unsigned short)arg7 mediaQueue:(struct tagVCMediaQueue *)arg8;	// IMP=0x00000000002cd5d2
