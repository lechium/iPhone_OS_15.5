...
- (void)cleanupNwActivity;	// IMP=0x000000000003e193
- (_Bool)applyConfigurationUsingClientDict:(id)arg1;	// IMP=0x000000000003dfc2
- (_Bool)updateWithClientDictionary:(id)arg1;	// IMP=0x000000000003de1c
@property(nonatomic) long long sessionMode; // @synthesize sessionMode=_sessionMode;
- (void)dealloc;	// IMP=0x000000000003dc76
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x000000000003dc37
- (id)init;	// IMP=0x000000000003dbd8
