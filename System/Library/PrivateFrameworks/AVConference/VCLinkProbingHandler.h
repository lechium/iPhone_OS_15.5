...
- (void)resetAggregatedProbingResults;	// IMP=0x00000000003382bc
- (void)probingLockdownEnded;	// IMP=0x000000000033819b
- (void)updateLinkPreferenceOrder;	// IMP=0x0000000000337e09
- (void)queryProbingResults;	// IMP=0x0000000000337b26
- (void)setLinkProbingResultConfig;	// IMP=0x0000000000337ae8
- (void)loadStorebagValues;	// IMP=0x0000000000337653
- (id)getProbingResultsForLinkID:(id)arg1;	// IMP=0x00000000003375fe
- (void)removeProbingResultsForLinks:(id)arg1;	// IMP=0x00000000003374a9
- (_Bool)isValidProbingResult:(id)arg1;	// IMP=0x000000000033743e
- (void)flushProbingResults:(id)arg1;	// IMP=0x0000000000337382
- (void)dispatchedUpdateProbingResults:(id)arg1;	// IMP=0x0000000000336df4
- (void)updateProbingResults:(id)arg1;	// IMP=0x0000000000336d65
- (void)stopActiveProbingOnLinks:(id)arg1 resetStats:(_Bool)arg2;	// IMP=0x00000000003369da
- (void)startActiveProbingOnLinks:(id)arg1;	// IMP=0x0000000000336737
@property(readonly) _Bool isLinkProbingActive;
@property id <VCLinkProbingHandlerDelegate> linkProbingHandlerDelegate;
- (void)dealloc;	// IMP=0x000000000033662e
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000033641d
