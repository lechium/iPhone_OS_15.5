...
- (unsigned int)updateRedundancyPercentageWithPLRThresholds:(unsigned int *)arg1;	// IMP=0x000000000022976b
- (void)computeRedundancyInfo;	// IMP=0x00000000002296f8
- (void)processRCNetworkStatistics:(CDStruct_87b99198)arg1;	// IMP=0x00000000002295c7
- (void)processNWConnectionStatistics:(CDStruct_87b99198)arg1;	// IMP=0x000000000022952d
- (void)updateRedundancyStrategyWithNetworkStatistics:(CDStruct_87b99198)arg1;	// IMP=0x0000000000229500
- (id)init;	// IMP=0x0000000000229490
