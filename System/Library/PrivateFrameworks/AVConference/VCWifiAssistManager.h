...
+ (id)sharedInstance;	// IMP=0x00000000000d493c
@property(readonly) unsigned char wifiAssistState; // @synthesize wifiAssistState=_wifiAssistState;
- (void)removeDelegate:(id)arg1;	// IMP=0x00000000000d494a
- (void)addDelegate:(id)arg1;	// IMP=0x00000000000d4944
@property(readonly) _Bool isAvailable;
- (id)init;	// IMP=0x00000000000d4926
