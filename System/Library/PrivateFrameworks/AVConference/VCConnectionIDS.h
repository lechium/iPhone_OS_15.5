...
+ (unsigned int)worstCaseNetworkOverheadInBytesWithNumOfStreamId:(int)arg1 isPriorityIncluded:(_Bool)arg2;	// IMP=0x00000000001f52b7
...
- (int)cellTechForSoMask:(unsigned int)arg1 fallbackTo:(int)arg2;	// IMP=0x00000000001f5d44
- (_Bool)matchesChannelTokenWithSourceDestinationInfo:(struct tagVCSourceDestinationInfo *)arg1;	// IMP=0x00000000001f5d14
- (_Bool)matchesSourceDestinationInfo:(struct tagVCSourceDestinationInfo *)arg1;	// IMP=0x00000000001f5ccd
@property(readonly) unsigned char linkID;
- (_Bool)isOnSameInterfacesAndQRSessionWithConnection:(id)arg1;	// IMP=0x00000000001f5aa9
- (_Bool)isOnSameQRSessionWithConnection:(id)arg1;	// IMP=0x00000000001f59f8
- (_Bool)isOnSameInterfacesWithConnection:(id)arg1;	// IMP=0x00000000001f57db
- (unsigned short)updateMaxConnectionMTU:(unsigned short)arg1;	// IMP=0x00000000001f5624
- (_Bool)isSameAsConnection:(id)arg1;	// IMP=0x00000000001f55ae
@property int remoteCellTech;
@property int localCellTech;
- (void)setCellularMTU:(int)arg1;	// IMP=0x00000000001f5524
- (void)getSourceDestinationInfo:(struct tagVCSourceDestinationInfo *)arg1;	// IMP=0x00000000001f546d
...
- (int)networkOverheadInBytesWithNumOfStreamId:(int)arg1 isPriorityIncluded:(_Bool)arg2;	// IMP=0x00000000001f5274
@property int connectionMTU;
- (id)connectionQRSessionID;	// IMP=0x00000000001f5237
...
- (void)dealloc;	// IMP=0x00000000001f4a35
- (id)initWithLinkContext:(id)arg1 dataChannelToken:(unsigned int)arg2;	// IMP=0x00000000001f463c
