...
- (id)streamIds;	// IMP=0x000000000028d9eb
- (void)addSubStreamConfig:(id)arg1;	// IMP=0x000000000028d9ce
- (void)addPayload:(int)arg1;	// IMP=0x000000000028d98e
- (void)dealloc;	// IMP=0x000000000028d913
- (id)init;	// IMP=0x000000000028d886
