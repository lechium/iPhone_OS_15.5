...
- (unsigned int)computeRedundancyWithBurstyLoss;	// IMP=0x000000000004e830
- (unsigned int)computeRedundancyWithLossPercentage;	// IMP=0x000000000004e806
- (void)updateBurstyLoss:(unsigned int)arg1;	// IMP=0x000000000004e7ba
- (void)updateRedundancyStrategyWithNetworkStatistics:(CDStruct_87b99198)arg1;	// IMP=0x000000000004e70c
