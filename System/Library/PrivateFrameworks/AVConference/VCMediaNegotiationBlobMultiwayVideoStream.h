...
+ (int)payloadForVideoPayload:(int)arg1;	// IMP=0x00000000002f363e
+ (int)videoPayloadForPayload:(int)arg1;	// IMP=0x00000000002f3620
+ (_Bool)convertVideoFormat:(int)arg1 width:(int *)arg2 height:(int *)arg3;	// IMP=0x00000000002f3490
+ (int)videoFormatForWidth:(int)arg1 height:(int)arg2;	// IMP=0x00000000002f3334
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000008fb3
- (unsigned long long)hash;	// IMP=0x0000000000008e67
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000008cbc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000008b84
- (void)copyTo:(id)arg1;	// IMP=0x0000000000008a8a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000008905
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000088f8
- (id)dictionaryRepresentation;	// IMP=0x0000000000007e1c
- (id)description;	// IMP=0x0000000000007d82
...
- (void)printWithLogFile:(void *)arg1;	// IMP=0x00000000002f30d2
@property(readonly, nonatomic) _Bool isSubStream;
- (id)newMultiwayVideoStream;	// IMP=0x00000000002f2e63
- (id)initWithStreamConfig:(id)arg1;	// IMP=0x00000000002f2c61
