...
- (void)readStoreBagValues;	// IMP=0x0000000000219d7e
- (unsigned int)bitrateForStoreBagKey:(id)arg1 connectionType:(int)arg2 currentBitrate:(unsigned int)arg3 isExpensive:(_Bool)arg4;	// IMP=0x0000000000219b70
- (void)readHardwareValues;	// IMP=0x0000000000219b46
- (_Bool)rangeCheck:(unsigned int)arg1;	// IMP=0x0000000000219acd
- (void)dealloc;	// IMP=0x0000000000219a6f
- (id)init;	// IMP=0x00000000002199eb
