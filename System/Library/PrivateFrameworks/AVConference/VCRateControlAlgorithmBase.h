...
@interface VCRateControlAlgorithmBase : NSObject <VCRateControlAlgorithm>
{
    ...
    double _packetLossRateAvgLongAtLBAStart;	// 4656 = 0x1230
    double _packetLossRateAvgLongAtLBAExit;	// 4664 = 0x1238
    double _packetLossRateAudio;	// 4672 = 0x1240
    double _packetLossRateVideo;	// 4680 = 0x1248
    double _roundTripTime;	// 4688 = 0x1250
    double _worstRecentRoundTripTime;	// 4696 = 0x1258
    unsigned int _worstRecentBurstLoss;	// 4704 = 0x1260
    unsigned int _totalPacketReceived;	// 4708 = 0x1264
    _Bool _shouldConsiderVideoInLossEvent;	// 4712 = 0x1268
    void *_logDump;	// 4720 = 0x1270
    void *_logBasebandDump;	// 4728 = 0x1278
    _Bool _isPeriodicLoggingEnabled;	// 4736 = 0x1280
    _Bool _didMBLRampDown;	// 4737 = 0x1281
}
...
- (void)updateCongestionStatusWhenRampDown:(double)arg1;	// IMP=0x00000000001a9b4d
- (void)updateCongestionStatusWhenRampUp;	// IMP=0x00000000001a9acd
- (_Bool)shouldRampDownDueToLossThreshold;	// IMP=0x00000000001a985c
- (_Bool)shouldRampDownDueToConsecutiveLoss;	// IMP=0x00000000001a980c
- (_Bool)shouldRampDownDueToLossEvent;	// IMP=0x00000000001a97b0
- (_Bool)shouldBlockRampUpDueToLossEventThreshold;	// IMP=0x00000000001a968c
- (_Bool)allowRampUpWithContinuousTargetBitrate;	// IMP=0x00000000001a95c1
- (double)rampUpTargetBitrateContinuousWithBandwidthDiff:(int)arg1;	// IMP=0x00000000001a9575
- (void)resetLossEventBandwidthLimit;	// IMP=0x00000000001a9564
- (void)updateLossEventBandwidthLimit:(unsigned int)arg1;	// IMP=0x00000000001a9474
- (void)resetLossEventBuffer;	// IMP=0x00000000001a9447
- (double)lossEventOverThresholdRatio;	// IMP=0x00000000001a938d
- (int)lossEventIncreasingCount;	// IMP=0x00000000001a934d
- (void)updateLossEvent;	// IMP=0x00000000001a9242
@property(readonly, nonatomic) _Bool isLossBasedAdaptationOn;
- (_Bool)recentlyGoAboveRampUpBandwidth;	// IMP=0x00000000001a91b6
- (_Bool)keepOvershootingRampDownBandwidth;	// IMP=0x00000000001a917f
- (void)checkBandwidthOvershootWithRemoteBandwidthEstimation:(unsigned int)arg1;	// IMP=0x00000000001a907f
- (void)stateEnter;	// IMP=0x00000000001a9060
- (void)stateExit;	// IMP=0x00000000001a903c
- (void)stateChangeTo:(int)arg1;	// IMP=0x00000000001a8fe8
- (void)calculateCongestionMetricsFromOWRD:(double)arg1 time:(double)arg2;	// IMP=0x00000000001a8f0e
- (unsigned short)getTimestampFromMicroTime:(double)arg1;	// IMP=0x00000000001a8ef5
- (double)getDoubleTimeFromTimestamp:(unsigned int)arg1 timestampTick:(unsigned int)arg2 wrapAroundCounter:(unsigned int)arg3;	// IMP=0x00000000001a8ec9
- (void)logToDumpFilesWithString:(id)arg1;	// IMP=0x00000000001a8e09
- (void)enableBasebandDump:(void *)arg1;	// IMP=0x00000000001a8df7
- (void)enableLogDump:(void *)arg1 enablePeriodicLogging:(_Bool)arg2;	// IMP=0x00000000001a8ddf
- (_Bool)doRateControlWithStatistics:(CDStruct_87b99198)arg1;	// IMP=0x00000000001a8d7e
- (void)configure:(struct VCRateControlAlgorithmConfig)arg1 restartRequired:(_Bool)arg2;	// IMP=0x00000000001a8d1d
- (void)checkPaused;	// IMP=0x00000000001a8ad0
@property(nonatomic, getter=isPaused) _Bool paused;
- (void)dealloc;	// IMP=0x00000000001a8a55
- (id)init;	// IMP=0x00000000001a89e9
