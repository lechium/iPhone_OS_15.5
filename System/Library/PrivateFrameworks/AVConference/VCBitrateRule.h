...
- (void)dealloc;	// IMP=0x0000000000356471
- (id)description;	// IMP=0x000000000035643d
- (long long)compare:(id)arg1;	// IMP=0x00000000003563f9
- (id)initWithBitrate:(unsigned int)arg1 connectionType:(int)arg2 limitingRule:(id)arg3;	// IMP=0x0000000000356370
