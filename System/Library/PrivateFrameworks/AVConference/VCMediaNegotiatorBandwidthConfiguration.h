...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001df06
- (id)initWithMode:(int)arg1 connectionType:(int)arg2 maxBandwidth:(unsigned int)arg3;	// IMP=0x000000000001de92
- (id)initWithConnectionType:(int)arg1 maxBandwidth:(unsigned int)arg2;	// IMP=0x000000000001de1e
