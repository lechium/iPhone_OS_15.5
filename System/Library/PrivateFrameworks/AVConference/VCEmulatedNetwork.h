...
- (void)runUntilTime:(double)arg1;	// IMP=0x000000000006d65f
- (id)copyPacketFromPop;	// IMP=0x000000000006d60f
- (void)push:(id)arg1;	// IMP=0x000000000006d5d6
- (void)dealloc;	// IMP=0x000000000006d552
- (id)initWithPolicies:(id)arg1;	// IMP=0x000000000006d463
