...
- (void)dealloc;	// IMP=0x000000000004ffa6
@property struct tagCONNRESULT *result;
- (id)initWithCallID:(unsigned int)arg1;	// IMP=0x000000000004feeb
- (id)initWithResult:(struct tagCONNRESULT *)arg1;	// IMP=0x000000000004fe58
