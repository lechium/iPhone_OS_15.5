...
- (id)className;	// IMP=0x000000000029dd68
- (void)releaseLogDumpFile;	// IMP=0x000000000029dc9f
- (void)createLogDumpFile:(unsigned int)arg1;	// IMP=0x000000000029dbf8
- (void)updateAverageTargetBitrate:(unsigned int)arg1 interval:(double)arg2;	// IMP=0x000000000029db54
- (void)setOperatingTierIndexWithBitrate:(unsigned int)arg1;	// IMP=0x000000000029d94a
- (unsigned short)maxTierIndex:(unsigned int)arg1;	// IMP=0x000000000029d8c8
- (unsigned short)minTierIndex:(unsigned int)arg1;	// IMP=0x000000000029d841
...
- (void)updateVideoStall:(_Bool)arg1 withStallDuration:(unsigned int)arg2;	// IMP=0x000000000029d747
- (void)updateRTPReceiveWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x000000000029d661
- (void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingBitrate:(unsigned int)arg4 averageReceivedBitrate:(unsigned int)arg5;	// IMP=0x000000000029d3c6
- (void)setRateControlInterval:(double)arg1;	// IMP=0x000000000029d334
- (void)setMaxTargetBitrate:(unsigned int)arg1 minTargetBitrate:(unsigned int)arg2;	// IMP=0x000000000029d23a
- (void)dealloc;	// IMP=0x000000000029d1c6
- (id)initWithDumpID:(unsigned int)arg1;	// IMP=0x000000000029d023
