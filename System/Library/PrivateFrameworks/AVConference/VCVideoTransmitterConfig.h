...
@interface VCVideoTransmitterConfig : NSObject
{
    ...
    unsigned long long _maxPerStreamScreenPixels;	// 264 = 0x108
}
...
- (void)addCustomFeatureListString:(id)arg1 payload:(int)arg2;	// IMP=0x0000000000235ba9
- (void)dealloc;	// IMP=0x0000000000235b02
- (id)description;	// IMP=0x00000000002359c9
- (id)init;	// IMP=0x00000000002358f0
