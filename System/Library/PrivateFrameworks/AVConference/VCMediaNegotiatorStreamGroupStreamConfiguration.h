...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bdee1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bd912
- (_Bool)isEqualPayloads:(id)arg1;	// IMP=0x00000000000bd7d0
- (_Bool)applyCipherSuiteOnMediaStreamConfig:(id)arg1 codecConfigs:(id)arg2;	// IMP=0x00000000000bd5ac
- (_Bool)areCodecsEqualTo:(id)arg1;	// IMP=0x00000000000bd54f
- (void)resetCodecs;	// IMP=0x00000000000bd539
- (void)removeCodec:(unsigned int)arg1;	// IMP=0x00000000000bd500
- (void)addCodec:(unsigned int)arg1;	// IMP=0x00000000000bd4c7
- (void)resetPayloads;	// IMP=0x00000000000bd4b1
- (void)addPayload:(int)arg1;	// IMP=0x00000000000bd478
- (void)dealloc;	// IMP=0x00000000000bd40b
- (id)init;	// IMP=0x00000000000bd38c
