...
+ (id)schedulerStreamWithKeyFrameInterval:(unsigned int)arg1 framerate:(unsigned int)arg2 weightFactor:(unsigned int)arg3;	// IMP=0x0000000000260d33
...
- (id)description;	// IMP=0x0000000000260e46
- (long long)compareWeightFactor:(id)arg1;	// IMP=0x0000000000260def
- (id)initWithKeyFrameInterval:(unsigned int)arg1 framerate:(unsigned int)arg2 weightFactor:(unsigned int)arg3;	// IMP=0x0000000000260d7b
