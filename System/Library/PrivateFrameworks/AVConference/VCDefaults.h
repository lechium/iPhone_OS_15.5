...
+ (id)copyStringValueForKey:(struct __CFString *)arg1;	// IMP=0x0000000000384f90
+ (_Bool)booleanValueForKey:(struct __CFString *)arg1 defaultValue:(_Bool)arg2;	// IMP=0x0000000000384f6d
+ (_Bool)booleanValueForKey:(struct __CFString *)arg1;	// IMP=0x0000000000384f52
+ (long long)integerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x0000000000384e05
+ (long long)integerValueForKey:(struct __CFString *)arg1;	// IMP=0x0000000000384dea
+ (double)getDoubleValueForKey:(struct __CFString *)arg1 defaultValue:(double)arg2;	// IMP=0x0000000000384c95
+ (id)sharedInstance;	// IMP=0x0000000000384bb6
...
- (_Bool)forceUseInternalRTPThreadingWithDefaultValue:(_Bool)arg1;	// IMP=0x0000000000386d8f
...
- (_Bool)shouldOverrideEffectsFramerate:(unsigned int *)arg1;	// IMP=0x0000000000386a78
...
- (_Bool)enableAudioDumpParticipantLocal:(_Bool)arg1;	// IMP=0x000000000038674f
- (_Bool)enableAudioDumpParticipantRemote:(_Bool)arg1;	// IMP=0x000000000038672d
...
- (_Bool)forceWifiAssistOutOfBudget;	// IMP=0x0000000000386462
- (_Bool)forceWifiAssist;	// IMP=0x0000000000386442
...
- (unsigned int)forceThermalLevelFramerate:(unsigned int)arg1;	// IMP=0x0000000000385566
...
- (void)seperateString:(id)arg1;	// IMP=0x0000000000385259
...
- (id)autorelease;	// IMP=0x0000000000385052
- (oneway void)release;	// IMP=0x000000000038504c
- (unsigned long long)retainCount;	// IMP=0x000000000038503f
- (id)retain;	// IMP=0x0000000000385036
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000038502d
- (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000385020
- (id)init;	// IMP=0x0000000000384fce
