...
- (id)initWithPacketID:(unsigned int)arg1 datagram:(char *)arg2 datagramSize:(unsigned int)arg3;	// IMP=0x00000000000c04dc
- (id)initWithPacketID:(unsigned int)arg1;	// IMP=0x00000000000c047e
