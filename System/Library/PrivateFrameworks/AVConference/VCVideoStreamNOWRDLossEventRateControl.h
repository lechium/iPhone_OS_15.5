...
- (id)className;	// IMP=0x0000000000048aea
- (void)calculateNOWRD:(double)arg1 time:(double)arg2;	// IMP=0x00000000000486a8
- (void)calculateOWRDWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x000000000004826f
- (void)resetLossEventBuffer;	// IMP=0x000000000004825e
- (int)lossEventCountThresholdForBitrate:(unsigned int)arg1;	// IMP=0x0000000000048236
- (int)lossEventCount;	// IMP=0x000000000004820e
- (void)updatePacketLossRate:(double)arg1 time:(double)arg2;	// IMP=0x00000000000481b9
- (_Bool)shouldRampUp;	// IMP=0x00000000000480f3
- (_Bool)shouldRampDown;	// IMP=0x000000000004803f
- (unsigned short)rampDownTier;	// IMP=0x0000000000048015
- (unsigned short)rampUpTier;	// IMP=0x0000000000047ff6
- (void)stateEnter;	// IMP=0x0000000000047fd7
- (void)stateExit;	// IMP=0x0000000000047fd1
- (void)stateChange:(int)arg1;	// IMP=0x0000000000047e78
- (void)printRateControlFullInfoWithLogDump:(void *)arg1 time:(double)arg2 videoStall:(_Bool)arg3 videoFrozenDuration:(double)arg4 averageTargetBitrate:(unsigned int)arg5;	// IMP=0x0000000000047d58
- (void)updateRTPReceiveWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x0000000000047d46
- (void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingTierIndex:(unsigned short)arg4 averageReceivedBitrate:(unsigned int)arg5;	// IMP=0x0000000000047b49
@property(readonly, copy) NSString *description;
- (void)setMaxTierIndex:(unsigned short)arg1 minTierIndex:(unsigned short)arg2;	// IMP=0x0000000000047a93
- (id)init;	// IMP=0x0000000000047883
