...
- (unsigned int)getBitrateKbpsSinceTime:(double)arg1;	// IMP=0x0000000000138c7a
- (double)getFramerateSinceTime:(double)arg1;	// IMP=0x0000000000138c01
- (void)updateMinMaxSinceTime:(double)arg1;	// IMP=0x0000000000138b9e
@property(readonly, nonatomic) unsigned int bitrateKbps;
@property(readonly, nonatomic) double framerate;
- (void)recordDataWithSize:(double)arg1 atTime:(double)arg2;	// IMP=0x0000000000138ae7
- (void)dealloc;	// IMP=0x0000000000138a80
- (id)init;	// IMP=0x00000000001389a9
