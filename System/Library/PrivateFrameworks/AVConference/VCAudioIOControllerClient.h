...
- (void)setClientFormat:(const struct tagVCAudioFrameFormat *)arg1;	// IMP=0x0000000000226d6e
- (void)setRemoteCodecType:(unsigned int)arg1 sampleRate:(double)arg2;	// IMP=0x0000000000226d56
- (void)setFarEndVersionInfo:(struct VoiceIOFarEndVersionInfo)arg1;	// IMP=0x0000000000226d2a
