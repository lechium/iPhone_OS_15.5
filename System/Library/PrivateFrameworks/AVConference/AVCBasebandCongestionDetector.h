...
- (void)printFlushAckToBasebandDump:(unsigned char)arg1 transactionID:(unsigned short)arg2 packetDropped:(unsigned short)arg3 sequenceNumberArray:(unsigned short *)arg4;	// IMP=0x00000000001610ab
- (void)processBasebandAck:(CDStruct_b203c80d *)arg1;	// IMP=0x0000000000160f62
- (_Bool)isRadioAccessTechnologyOnCellular:(unsigned int)arg1;	// IMP=0x0000000000160f53
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x0000000000160f39
- (_Bool)processBasebandNotification:(CDStruct_b203c80d *)arg1 arrivalTime:(double)arg2 error:(id *)arg3;	// IMP=0x0000000000160cea
- (_Bool)processBasebandNotification:(id)arg1 metaData:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000160be7
- (void)dealloc;	// IMP=0x0000000000160a45
- (id)init;	// IMP=0x00000000001609d6
