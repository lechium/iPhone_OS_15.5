...
- (void)distributeVideoFrame:(struct opaqueCMSampleBuffer *)arg1 frameTime:(CDStruct_1b6d18a9)arg2 preview:(_Bool)arg3 orientation:(int)arg4 fromCamera:(_Bool)arg5 camera:(int)arg6 switching:(_Bool)arg7 videoMirrored:(_Bool)arg8;	// IMP=0x0000000000301a3a
- (unsigned int)removeSink:(id)arg1;	// IMP=0x000000000030184c
- (unsigned int)addSink:(id)arg1;	// IMP=0x000000000030165a
@property(readonly) unsigned int sinkCount;
@property(readonly) NSObject<VCVideoCaptureServer> *captureServer;
- (void)dealloc;	// IMP=0x0000000000301571
- (id)initWithCaptureServer:(id)arg1;	// IMP=0x000000000030149b
