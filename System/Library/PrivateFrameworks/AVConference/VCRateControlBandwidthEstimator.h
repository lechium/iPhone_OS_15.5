...
- (void)updateBandwidthDivergeCountAtArrivalTime:(double)arg1 suddenChangeAbove:(_Bool)arg2 suddenChangeBelow:(_Bool)arg3;	// IMP=0x00000000002df686
- (_Bool)isSuddenChangeDurationMetAtArrivalTime:(double)arg1;	// IMP=0x00000000002df625
- (void)compensateSuddenChangeBandwidths;	// IMP=0x00000000002df5d5
- (void)recordSuddenChangeBandwidth:(double)arg1;	// IMP=0x00000000002df5ba
- (void)detectSuddenChangeWithBandwidth:(double)arg1 suddenChangeAbove:(_Bool *)arg2 suddenChangeBelow:(_Bool *)arg3;	// IMP=0x00000000002df2f8
- (void)updateInitialBandwidthEstimationForCellularAtTime:(double)arg1 bandwidth:(double)arg2;	// IMP=0x00000000002df28b
- (void)initializeBandwidthEstimationAtTime:(double)arg1 mediaTimestamp:(unsigned int)arg2 probingSequence:(_Bool)arg3 probingSequenceID:(unsigned int)arg4;	// IMP=0x00000000002df265
- (double)updateBandwidthEstimation:(double)arg1 arrivalTime:(double)arg2;	// IMP=0x00000000002defab
- (double)resetBandwidthWithParameters:(double)arg1 probingSequenceDuration:(double)arg2 probingSequenceSize:(unsigned int)arg3 packetsInProbingSequence:(unsigned int)arg4;	// IMP=0x00000000002def47
- (_Bool)isPacketProcessedLateWithArrivalTime:(double)arg1;	// IMP=0x00000000002def28
- (void)updateQualificationParameters;	// IMP=0x00000000002ded5e
- (void)enableBWELogDump:(void *)arg1;	// IMP=0x00000000002ded51
- (void)calculateBandwidthEstimationForBandwidthSample:(double)arg1 arrivalTime:(double)arg2;	// IMP=0x00000000002dec06
- (void)calculateBandwidthEstimationAtTime:(double)arg1 mediaTimestamp:(unsigned int)arg2 mediaDataSize:(unsigned int)arg3 probingSequence:(_Bool)arg4 probingSequenceID:(unsigned int)arg5;	// IMP=0x00000000002de902
- (void)dealloc;	// IMP=0x00000000002de580
- (id)init;	// IMP=0x00000000002de4ce
