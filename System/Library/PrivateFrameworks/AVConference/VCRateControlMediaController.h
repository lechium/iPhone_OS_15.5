...
- (void)updateLargeFrameSizeWithBandwidth:(unsigned int)arg1;	// IMP=0x00000000000e58ba
- (void)updateProbingLargeFrameSizeCap;	// IMP=0x00000000000e5804
- (_Bool)isProbingLargeFrameRequiredAtTime:(double)arg1;	// IMP=0x00000000000e5538
- (void)printLargeFrameStatsAtTime:(double)arg1 timestamp:(unsigned int)arg2 timeSinceLastProbingSequence:(double)arg3 frameSize:(unsigned int)arg4 wastedBytes:(unsigned int)arg5 fecRatio:(double)arg6 isFrameRequested:(_Bool)arg7;	// IMP=0x00000000000e536d
- (void)scheduleProbingSequenceAtTime:(double)arg1;	// IMP=0x00000000000e5269
- (void)increaseBasebandFlushCountInternallyWithSuggestion:(struct VCRateControlMediaSuggestion *)arg1;	// IMP=0x00000000000e51c1
- (_Bool)increaseFlushCountForVideoRefresh:(int)arg1 transactionID:(unsigned short)arg2;	// IMP=0x00000000000e5150
- (void)recordVideoRefreshFrameWithTimestamp:(unsigned int)arg1 payloadType:(unsigned char)arg2 packetCount:(unsigned int)arg3 isKeyFrame:(_Bool)arg4;	// IMP=0x00000000000e50bd
- (void)scheduleProbingSequenceWithFrameSize:(unsigned int)arg1 paddingBytes:(unsigned int)arg2 timestamp:(unsigned int)arg3 fecRatio:(double)arg4 isProbingSequenceScheduled:(_Bool *)arg5;	// IMP=0x00000000000e4f00
...
- (_Bool)rampUpAudioFraction;	// IMP=0x00000000000e4c54
- (_Bool)rampDownAudioFraction;	// IMP=0x00000000000e4bb7
- (_Bool)didMediaGetFlushedWithPayloadType:(unsigned char)arg1 transactionID:(unsigned short)arg2 packetDropped:(unsigned short)arg3 sequenceNumberArray:(unsigned short *)arg4;	// IMP=0x00000000000e49e1
- (void)decreaseFlushCount:(int)arg1;	// IMP=0x00000000000e48af
@property(readonly, nonatomic) _Bool isVideoStopped;
- (void)resumeVideoByVCRateControl;	// IMP=0x00000000000e45f0
- (void)stopVideoByVCRateControl;	// IMP=0x00000000000e44a4
- (void)pauseVideoByUser:(_Bool)arg1;	// IMP=0x00000000000e42eb
- (void)updateAudioStallInMediaSuggestion:(struct VCRateControlMediaSuggestion *)arg1 isSuggestionNeeded:(_Bool *)arg2 atTime:(double)arg3;	// IMP=0x00000000000e41fd
- (void)updateBasebandSuggestionWithStatistics:(CDStruct_87b99198)arg1;	// IMP=0x00000000000e3aa8
- (void)computePacketLossWithRemoteInfo:(struct VCRCMediaPLPFromRemoteInfo *)arg1;	// IMP=0x00000000000e3a30
- (void)getMediaQueueRateChangeCounter:(unsigned int *)arg1 rateChangeTime:(double *)arg2;	// IMP=0x00000000000e3a13
- (void)getMediaQueueInVideoBitrate:(double *)arg1 outVideoBitrate:(double *)arg2 inAudioBitrate:(double *)arg3 outAudioBitrate:(double *)arg4;	// IMP=0x00000000000e39c6
- (void)enableBWELogDump:(void *)arg1;	// IMP=0x00000000000e35db
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x00000000000e35ce
- (void)dealloc;	// IMP=0x00000000000e354c
- (id)initWithMediaQueue:(struct tagHANDLE *)arg1 delegate:(id)arg2;	// IMP=0x00000000000e340e
