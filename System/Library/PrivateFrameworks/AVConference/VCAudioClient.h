...
- (void)didResumeAudioIO:(id)arg1;	// IMP=0x000000000014dd2e
- (void)didSuspendAudioIO:(id)arg1;	// IMP=0x000000000014dd28
@property(retain, nonatomic) AVAudioDevice *outputDevice;
@property(retain, nonatomic) AVAudioDevice *inputDevice;
- (_Bool)setCurrentAudioDevice:(id)arg1 type:(_Bool)arg2;	// IMP=0x000000000014dd04
- (id)getCurrentAudioDeviceWithType:(_Bool)arg1;	// IMP=0x000000000014dcfc
- (void)stopAudioIOWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000014dcf6
- (void)startAudioIOWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000014dcf0
- (_Bool)stopAudioSessionWithError:(id *)arg1;	// IMP=0x000000000014dce8
- (_Bool)startAudioSessionWithError:(id *)arg1;	// IMP=0x000000000014dce0
- (_Bool)stopWithError:(id *)arg1;	// IMP=0x000000000014d872
- (_Bool)startWithError:(id *)arg1;	// IMP=0x000000000014d3e8
- (void)setAudioSessionProperties:(id)arg1;	// IMP=0x000000000014d3e2
- (_Bool)resetAudioSessionOutputPortOverride:(id *)arg1;	// IMP=0x000000000014d3da
- (_Bool)unmuteWithError:(id *)arg1;	// IMP=0x000000000014d381
- (_Bool)muteWithError:(id *)arg1;	// IMP=0x000000000014d35c
- (void)unlock;	// IMP=0x000000000014d34e
- (void)lock;	// IMP=0x000000000014d340
- (void)dealloc;	// IMP=0x000000000014d2d9
- (id)initWithProcessId:(int)arg1;	// IMP=0x000000000014d23f
