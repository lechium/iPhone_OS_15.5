...
- (void)setConfig:(id)arg1 pid:(id)arg2;	// IMP=0x00000000003582fb
- (void)updateScreenShareWith:(id)arg1 pid:(id)arg2;	// IMP=0x00000000003582e9
- (void)dealloc;	// IMP=0x000000000035826f
- (id)initWithConfig:(id)arg1 pid:(id)arg2;	// IMP=0x00000000003581ec
