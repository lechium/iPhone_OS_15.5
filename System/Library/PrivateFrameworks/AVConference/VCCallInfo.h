...
+ (unsigned char)getVCCurrentVersion;	// IMP=0x0000000000338bf9
...
- (_Bool)supportSDPCompression;	// IMP=0x0000000000338bec
- (void)setUserAgent:(id)arg1;	// IMP=0x0000000000338ab5
- (struct VoiceIOFarEndVersionInfo)audioVersionInfo:(_Bool)arg1;	// IMP=0x0000000000338a54
@property(readonly) _Bool supportsDynamicContentsRectWithAspectPreservation;
- (_Bool)updateWithLastDecodedFrameTime:(double)arg1 time:(double)arg2;	// IMP=0x000000000033886c
@property(readonly, nonatomic) _Bool requiresImplicitFeatureString;
- (void)dealloc;	// IMP=0x00000000003387ad
- (id)init;	// IMP=0x00000000003385e3
