...
+ (void)updateMaxAllowedBitratePerConnection:(unsigned int *)arg1 connectionType:(int)arg2 negotiatedSettings:(id)arg3;	// IMP=0x0000000000357211
...
- (void)updateNegotiatedSettings:(id)arg1;	// IMP=0x000000000035723c
- (unsigned int)maxAllowedBitrateForConnectionType:(int)arg1 operatingMode:(int)arg2;	// IMP=0x00000000003571e5
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2 operatingMode:(int)arg3 encodeRule:(id)arg4;	// IMP=0x0000000000357144
- (id)maxAllowedBitrateRuleForConnection:(int)arg1;	// IMP=0x0000000000356f82
- (unsigned int)maxAllowedAudioOnlyBitrateForConnection:(int)arg1;	// IMP=0x0000000000356e89
- (unsigned int)maxAllowedScreenShareBitrateForConnection:(int)arg1;	// IMP=0x0000000000356d90
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2 encodeRule:(id)arg3;	// IMP=0x0000000000356b01
- (unsigned int)maxAllowedBitrateForVCConnection:(id)arg1 forLocalInterface:(_Bool)arg2;	// IMP=0x0000000000356aec
- (unsigned int)maxAllowedBitrateForConnectionType:(int)arg1;	// IMP=0x00000000003569bd
- (unsigned int)maxAllowedScreenShareCellularBitrate;	// IMP=0x00000000003569a4
- (unsigned int)maxAllowedCellularBitrate;	// IMP=0x0000000000356983
- (void)readCarrierBundleValues;	// IMP=0x000000000035697d
- (void)updateMaxAllowedBitrate:(unsigned int *)arg1 key:(struct __CFString *)arg2 type:(id)arg3 isAudio:(_Bool)arg4 carrierBundleBitrates:(struct __CFDictionary *)arg5;	// IMP=0x0000000000356977
- (void)readStoreBagValues:(void *)arg1;	// IMP=0x0000000000356838
- (int)storeBagBitrateForKey:(id)arg1;	// IMP=0x000000000035679b
- (void)readHardwareValues;	// IMP=0x0000000000356795
- (void)addRuleForBitrate:(unsigned int)arg1 connectionType:(int)arg2 limitingRule:(id)arg3;	// IMP=0x0000000000356728
- (void)createSupportedBitrateRuleSets;	// IMP=0x00000000003566f2
- (void)dealloc;	// IMP=0x0000000000356694
- (id)initWithDeviceRole:(int)arg1 callLogFile:(void *)arg2;	// IMP=0x00000000003564fd
