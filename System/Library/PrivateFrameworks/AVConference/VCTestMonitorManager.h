...
+ (id)sharedManager;	// IMP=0x000000000034b9c6
...
- (void)registerBlocksForService;	// IMP=0x000000000034bcd3
- (void)reportMemoryUsage:(id)arg1;	// IMP=0x000000000034ba15
- (void)dealloc;	// IMP=0x000000000034b956
- (id)init;	// IMP=0x000000000034b8b4
