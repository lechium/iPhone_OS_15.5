...
+ (long long)compareAudioEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x0000000000161ce0
+ (long long)compareVideoEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x00000000001618db
+ (long long)compareAudioEntry:(id)arg1 audioEntry:(id)arg2;	// IMP=0x000000000016173a
+ (unsigned char)entryTypeForMediaType:(unsigned int)arg1;	// IMP=0x00000000001614f8
...
- (long long)compare:(id)arg1;	// IMP=0x0000000000161584
- (id)description;	// IMP=0x00000000001613da
- (void)dealloc;	// IMP=0x000000000016137c
...
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 networkBitrate:(unsigned int)arg4 mediaBitrate:(unsigned int)arg5 qualityIndex:(unsigned int)arg6 streamID:(unsigned int)arg7 streamGroupID:(unsigned int)arg8;	// IMP=0x0000000000161247
