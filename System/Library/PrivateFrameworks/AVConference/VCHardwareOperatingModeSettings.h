...
+ (unsigned int)encoderUsageTypeWithOperatingMode:(int)arg1;	// IMP=0x00000000003a0237
...
- (void)featureListString;	// IMP=0x00000000003a045f
- (unsigned int)numTilesPerVideoFrameForHDRMode:(unsigned long long)arg1;	// IMP=0x00000000003a036b
- (void)dealloc;	// IMP=0x00000000003a02fe
- (id)initWithMode:(int)arg1;	// IMP=0x00000000003a0253
