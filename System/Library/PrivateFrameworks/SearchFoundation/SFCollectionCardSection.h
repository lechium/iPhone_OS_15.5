...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000190ea4
- (void).cxx_destruct;	// IMP=0x0000000000190dfc
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000190810
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000190657
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000190508
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000190456
- (_Bool)hasSeparatorStyle;	// IMP=0x0000000000190441
- (_Bool)hasHasBottomPadding;	// IMP=0x0000000000190411
- (_Bool)hasHasTopPadding;	// IMP=0x00000000001903e2
- (_Bool)hasCanBeHidden;	// IMP=0x00000000001903b5
- (id)initWithProtobuf:(id)arg1;	// IMP=0x0000000000020f24
- (id)sectionsWithCards;	// IMP=0x0000000000023527
- (void)addCardsFromButtonsTo:(id)arg1;	// IMP=0x000000000002342e
