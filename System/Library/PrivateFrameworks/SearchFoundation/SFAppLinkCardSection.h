...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000054b63
- (void).cxx_destruct;	// IMP=0x0000000000054acc
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000547e0
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000054691
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000545df
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000000545ca
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000005459a
- (_Bool)hasHasTopPadding;	// IMP=0x000000000005456b
- (_Bool)hasCanBeHidden;	// IMP=0x000000000005453e
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001abc2a
