...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001e8b7f
- (void).cxx_destruct;	// IMP=0x00000000001e8ae8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001e8577
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001e83de
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001e828f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e81dd
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000001e81c8
- (_Bool)hasHasBottomPadding;	// IMP=0x00000000001e8198
- (_Bool)hasHasTopPadding;	// IMP=0x00000000001e8169
- (_Bool)hasCanBeHidden;	// IMP=0x00000000001e813c
- (id)initWithProtobuf:(id)arg1;	// IMP=0x0000000000014634
