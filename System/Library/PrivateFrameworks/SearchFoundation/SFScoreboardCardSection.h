...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000018d5dc
- (void).cxx_destruct;	// IMP=0x000000000018d512
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018d167
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000018d018
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000018cf66
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000018cf51
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000018cf21
- (_Bool)hasHasTopPadding;	// IMP=0x000000000018cef2
- (_Bool)hasCanBeHidden;	// IMP=0x000000000018cec5
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001dd00a
