...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001eb830
- (void).cxx_destruct;	// IMP=0x00000000001eb788
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001eb19c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001eafe3
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001eae94
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001eade2
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000001eadcd
- (_Bool)hasHasBottomPadding;	// IMP=0x00000000001ead9d
- (_Bool)hasHasTopPadding;	// IMP=0x00000000001ead6e
- (_Bool)hasCanBeHidden;	// IMP=0x00000000001ead41
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001b4d5d
