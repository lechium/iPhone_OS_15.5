...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001f1c3
- (void).cxx_destruct;	// IMP=0x000000000001f12c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001ebc4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001ea2b
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001e8dc
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001e82a
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000001e815
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000001e7e5
- (_Bool)hasHasTopPadding;	// IMP=0x000000000001e7b6
- (_Bool)hasCanBeHidden;	// IMP=0x000000000001e789
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000018c778
