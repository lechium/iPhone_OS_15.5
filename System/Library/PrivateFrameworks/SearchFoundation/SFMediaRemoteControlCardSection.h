...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000194009
- (void).cxx_destruct;	// IMP=0x0000000000193f83
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000193a6a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001938f0
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001937a1
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001936ef
- (_Bool)hasPlaybackRouteUniqueIdentifierIsEncrypted;	// IMP=0x00000000001936da
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000001936aa
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000019367a
- (_Bool)hasHasTopPadding;	// IMP=0x000000000019364b
- (_Bool)hasCanBeHidden;	// IMP=0x000000000019361e
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000019674a
