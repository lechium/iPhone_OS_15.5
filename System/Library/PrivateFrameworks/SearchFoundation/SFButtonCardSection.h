...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002de75
- (void).cxx_destruct;	// IMP=0x000000000002ddef
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002d902
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002d788
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002d639
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002d587
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000002d572
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000002d542
- (_Bool)hasHasTopPadding;	// IMP=0x000000000002d513
- (_Bool)hasCanBeHidden;	// IMP=0x000000000002d4e6
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001a7d29
