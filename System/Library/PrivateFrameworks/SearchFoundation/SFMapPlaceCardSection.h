...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000189dbd
- (void).cxx_destruct;	// IMP=0x0000000000189d48
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001898a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018973d
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001895ee
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000018953c
- (_Bool)hasShouldSearchDirectionsAlongCurrentRoute;	// IMP=0x0000000000189527
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000001894f7
- (_Bool)hasHasBottomPadding;	// IMP=0x00000000001894c7
- (_Bool)hasHasTopPadding;	// IMP=0x0000000000189498
- (_Bool)hasCanBeHidden;	// IMP=0x000000000018946b
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001c0f2b
