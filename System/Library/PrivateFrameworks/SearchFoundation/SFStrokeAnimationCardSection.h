...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000002351
- (void).cxx_destruct;	// IMP=0x00000000000022a9
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000001cc6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000001b0d
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000019be
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000190c
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000000018f7
- (_Bool)hasHasBottomPadding;	// IMP=0x00000000000018c7
- (_Bool)hasHasTopPadding;	// IMP=0x0000000000001898
- (_Bool)hasCanBeHidden;	// IMP=0x000000000000186b
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000000051c0
