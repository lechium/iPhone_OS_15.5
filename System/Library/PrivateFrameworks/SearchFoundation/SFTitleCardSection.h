...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001bf80
- (void).cxx_destruct;	// IMP=0x000000000001befa
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001b9dd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001b855
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001b706
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001b654
- (_Bool)hasIsCentered;	// IMP=0x000000000001b63f
- (_Bool)hasSeparatorStyle;	// IMP=0x000000000001b60f
- (_Bool)hasHasBottomPadding;	// IMP=0x000000000001b5df
- (_Bool)hasHasTopPadding;	// IMP=0x000000000001b5b0
- (_Bool)hasCanBeHidden;	// IMP=0x000000000001b583
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001a3e92
