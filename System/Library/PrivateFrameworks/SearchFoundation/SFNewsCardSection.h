...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001be19a
- (void).cxx_destruct;	// IMP=0x00000000001be0e1
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001bda74
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001bd8a8
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001bd759
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001bd6a7
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000001bd692
- (_Bool)hasHasBottomPadding;	// IMP=0x00000000001bd662
- (_Bool)hasHasTopPadding;	// IMP=0x00000000001bd633
- (_Bool)hasCanBeHidden;	// IMP=0x00000000001bd606
- (id)initWithProtobuf:(id)arg1;	// IMP=0x000000000002ee37
