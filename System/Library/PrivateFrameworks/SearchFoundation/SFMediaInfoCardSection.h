...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000011514
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000010b9c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000010942
@property(readonly, nonatomic) NSData *jsonData;
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000107f3
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000010741
- (_Bool)hasIsMediaContainer;	// IMP=0x000000000001072c
- (_Bool)hasSeparatorStyle;	// IMP=0x00000000000106fc
- (_Bool)hasHasBottomPadding;	// IMP=0x00000000000106cc
- (_Bool)hasHasTopPadding;	// IMP=0x000000000001069d
- (_Bool)hasCanBeHidden;	// IMP=0x0000000000010670
- (id)initWithProtobuf:(id)arg1;	// IMP=0x00000000001b6538
