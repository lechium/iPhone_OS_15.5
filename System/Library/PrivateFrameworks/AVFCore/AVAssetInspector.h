...
- (id)makePropertyListForProxyWithOptions:(id)arg1;	// IMP=0x00000000000d9c82
...
- (_Bool)isCompatibleWithPhotosTranscodingServiceWithOptions:(id)arg1;	// IMP=0x00000000000d9be3
@property(readonly, nonatomic, getter=isPlayable) _Bool playable;
- (_Bool)hasProtectedContent;	// IMP=0x00000000000d9bd3
...
- (id)metadataForFormat:(id)arg1;	// IMP=0x00000000000d9ba2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d9a22
