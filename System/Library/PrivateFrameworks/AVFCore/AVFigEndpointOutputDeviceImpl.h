...
- (void).cxx_destruct;	// IMP=0x00000000000d0372
@property __weak id <AVOutputDeviceImplSupport> implEventListener; // @synthesize implEventListener=_implSupportEventListener;
- (void)configureUsingBlock:(CDUnknownBlockType)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000d02b2
...
- (void)setVolume:(float)arg1;	// IMP=0x00000000000d00c4
- (void)_canSetEndpointVolumeDidChangeForEndpointWithID:(struct __CFString *)arg1;	// IMP=0x00000000000d003f
@property(readonly) long long volumeControlType;
@property(readonly) _Bool canSetVolume;
- (void)_volumeDidChangeForEndpointWithID:(struct __CFString *)arg1;	// IMP=0x00000000000cffb7
@property(readonly) float volume;
- (void)setSecondDisplayMode:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000cfdcf
- (void)setSecondDisplayEnabled:(_Bool)arg1;	// IMP=0x00000000000cfb55
- (_Bool)setCurrentBluetoothListeningMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000cf9cd
- (void)setCurrentBluetoothListeningMode:(id)arg1;	// IMP=0x00000000000cf892
...
- (_Bool)setHeadTrackedSpatialAudioMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000cf5b0
@property(readonly, nonatomic) NSString *headTrackedSpatialAudioMode;
- (_Bool)setAllowsHeadTrackedSpatialAudio:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00000000000cf397
...
- (struct OpaqueFigEndpoint *)figEndpoint;	// IMP=0x00000000000cefbd
...
- (id)_figEndpointPropertyValueForKey:(struct __CFString *)arg1;	// IMP=0x00000000000cebda
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000ceb4a
- (void)dealloc;	// IMP=0x00000000000ceb01
- (id)initWithFigEndpoint:(struct OpaqueFigEndpoint *)arg1;	// IMP=0x00000000000cea0c
- (id)init;	// IMP=0x00000000000ce9f8
