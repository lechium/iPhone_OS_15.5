...
+ (void)initialize;	// IMP=0x00000000000e0958
- (id)_createAVErrorForError:(id)arg1 andFigErrorCode:(int)arg2;	// IMP=0x00000000000e0c01
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 keysForCollectionKeys:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000e0bec
- (void)_ensureAllDependenciesOfKeyAreLoaded:(id)arg1;	// IMP=0x00000000000e0be6
- (void)_setIsAssociatedWithFragmentMinder:(_Bool)arg1;	// IMP=0x00000000000e0be0
...
- (void)cancelLoading;	// IMP=0x00000000000e0acf
- (id)assetInspector;	// IMP=0x00000000000e0ac7
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000e0a9c
- (long long)statusOfValueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000e0a6e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e0a63
- (void)dealloc;	// IMP=0x00000000000e0a28
@property(readonly, nonatomic, getter=_weakReference) AVWeakReference *weakReference;
- (id)init;	// IMP=0x00000000000e09bf
