...
+ (id)descriptionStringForTracksOfPlayerItem:(id)arg1;	// IMP=0x0000000000050ce4
+ (id)descriptionStringForVideoRangeOfFormatDescription:(struct opaqueCMFormatDescription *)arg1;	// IMP=0x0000000000050c75
+ (id)descriptionStringForBitRate:(double)arg1;	// IMP=0x0000000000050c0a
+ (id)descriptionStringForFormatOfTrack:(id)arg1;	// IMP=0x00000000000508f8
- (void).cxx_destruct;	// IMP=0x0000000000052a03
...
- (void)update;	// IMP=0x00000000000521c8
- (void)updateFromPlayerItem;	// IMP=0x000000000005150b
- (void)updateFromPlayer;	// IMP=0x0000000000050ff2
- (void)dealloc;	// IMP=0x00000000000507c4
