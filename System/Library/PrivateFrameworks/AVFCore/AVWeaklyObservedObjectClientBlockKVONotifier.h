...
- (void)cancelCallbacks;	// IMP=0x0000000000130e9b
- (void)callbackDidFireWithChangeDictionary:(id)arg1;	// IMP=0x0000000000130e4a
- (void)start;	// IMP=0x0000000000130dd8
- (void)dealloc;	// IMP=0x0000000000130d23
- (id)initWithCallbackContextRegistry:(id)arg1 observer:(id)arg2 object:(id)arg3 keyPath:(id)arg4 options:(unsigned long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x0000000000130b24
