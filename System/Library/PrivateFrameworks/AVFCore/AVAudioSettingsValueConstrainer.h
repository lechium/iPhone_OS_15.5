...
- (float)_getAvailableOutputSampleRateFor:(float)arg1 rounding:(long long)arg2;	// IMP=0x000000000010dbeb
- (unsigned int)availableOutputChannelCountForDesiredChannelCount:(unsigned int)arg1 rounding:(long long)arg2;	// IMP=0x000000000010da92
- (float)applicableOutputSampleRateForDesiredSampleRate:(float)arg1 rounding:(long long)arg2;	// IMP=0x000000000010d74f
...
- (void)setInputPropertiesFromASBD:(struct AudioStreamBasicDescription)arg1;	// IMP=0x000000000010d684
- (void)_bringUpToDate;	// IMP=0x000000000010d5cc
- (id)_fetchApplicableOutputDataRates;	// IMP=0x000000000010d52d
- (void)_buildApplicableDataRatesForSampleRates;	// IMP=0x000000000010cf6e
- (void)_buildAvailableSampleRates;	// IMP=0x000000000010ce2f
- (void)_buildAudioConverter;	// IMP=0x000000000010cd67
- (void)dealloc;	// IMP=0x000000000010ccfe
- (id)init;	// IMP=0x000000000010cca3
