...
- (void).cxx_destruct;	// IMP=0x00000000000c4ae3
@property __weak id <AVOutputDeviceImplSupport> implEventListener; // @synthesize implEventListener=_implSupportEventListener;
- (void)configureUsingBlock:(CDUnknownBlockType)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000c4a87
- (_Bool)setCurrentBluetoothListeningMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000c4a61
...
- (_Bool)setHeadTrackedSpatialAudioMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000c4a1e
@property(readonly, nonatomic) NSString *headTrackedSpatialAudioMode;
- (_Bool)setAllowsHeadTrackedSpatialAudio:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00000000000c49eb
...
- (void)setVolume:(float)arg1;	// IMP=0x00000000000c4955
@property(readonly) long long volumeControlType;
@property(readonly) _Bool canSetVolume;
@property(readonly) float volume;
- (void)setSecondDisplayMode:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000c4907
- (void)setSecondDisplayEnabled:(_Bool)arg1;	// IMP=0x00000000000c4901
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c47c0
