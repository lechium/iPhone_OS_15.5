...
+ (id)assetTrackInspectorWithAsset:(id)arg1 trackID:(int)arg2 trackIndex:(long long)arg3;	// IMP=0x00000000000e71be
- (struct OpaqueFigSampleCursorService *)_getFigSampleCursorServiceReportingTimeAccuracy:(_Bool *)arg1;	// IMP=0x00000000000e7c5d
- (id)makeSampleCursorAtLastSampleInDecodeOrder;	// IMP=0x00000000000e7bd4
- (id)makeSampleCursorAtFirstSampleInDecodeOrder;	// IMP=0x00000000000e7b4b
- (id)makeSampleCursorWithPresentationTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000e7a38
...
- (id)metadataForFormat:(id)arg1;	// IMP=0x00000000000e78f4
...
- (CDStruct_1b6d18a9)samplePresentationTimeForTrackTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000e76b2
- (id)segmentForTrackTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000e76aa
...
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000e7377
- (long long)statusOfValueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000e7360
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e7355
- (void)dealloc;	// IMP=0x00000000000e72ef
- (id)_weakReference;	// IMP=0x00000000000e72de
- (id)init;	// IMP=0x00000000000e72c1
- (id)_initWithAsset:(id)arg1 trackIndex:(long long)arg2;	// IMP=0x00000000000e72aa
- (id)_initWithAsset:(id)arg1 trackID:(int)arg2;	// IMP=0x00000000000e7291
- (id)_initWithAsset:(id)arg1 trackID:(int)arg2 trackIndex:(long long)arg3;	// IMP=0x00000000000e7214
