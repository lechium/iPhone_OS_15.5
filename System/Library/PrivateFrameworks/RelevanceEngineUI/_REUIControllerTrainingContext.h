...
{
    double _maximumNegativeDwellTime;	// 8 = 0x8
    double _minimumPositiveDwellTime;	// 16 = 0x10
    unsigned long long _onScreenElementCount;	// 24 = 0x18
    id <_REUIControllerTrainingContextDelegate> _delegate;	// 32 = 0x20
}

- (void).cxx_destruct;	// IMP=0x0000000000008a81
...
- (id)interactionTypeForElement:(id)arg1;	// IMP=0x000000000000897d
- (_Bool)elementIsAvailable:(id)arg1;	// IMP=0x000000000000891c
- (id)elementsOrdered:(unsigned long long)arg1 relativeToElement:(id)arg2;	// IMP=0x0000000000008887
