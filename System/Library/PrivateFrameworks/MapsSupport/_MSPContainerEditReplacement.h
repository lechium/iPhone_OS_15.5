...
- (void).cxx_destruct;	// IMP=0x00000000000ad5b7
...
- (void)useImmutableObjectsFromMap:(id)arg1 intermediateMutableObjectTransferBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000acf61
@property(readonly, copy) NSString *description;
- (id)initWithOriginalObjects:(id)arg1 replacementObjects:(id)arg2 indexes:(id)arg3;	// IMP=0x00000000000acd66
