...
- (void).cxx_destruct;	// IMP=0x00000000000ad8ba
...
- (void)useImmutableObjectsFromMap:(id)arg1 intermediateMutableObjectTransferBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000ad7a6
@property(readonly, copy) NSString *description;
- (id)initWithUpdatedImmutableObject:(id)arg1;	// IMP=0x00000000000ad689
- (id)initWithUpdatedObject:(id)arg1;	// IMP=0x00000000000ad61b
