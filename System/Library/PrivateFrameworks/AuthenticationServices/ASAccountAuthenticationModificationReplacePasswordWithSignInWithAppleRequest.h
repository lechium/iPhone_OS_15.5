...
- (void).cxx_destruct;	// IMP=0x0000000000032141
...
- (id)initWithUser:(id)arg1 password:(id)arg2 extension:(id)arg3 serviceIdentifier:(id)arg4 userInfo:(id)arg5;	// IMP=0x0000000000031f83
- (id)initWithUser:(id)arg1 serviceIdentifier:(id)arg2 userInfo:(id)arg3;	// IMP=0x0000000000031e8b
