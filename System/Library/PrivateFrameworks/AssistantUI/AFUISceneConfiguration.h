...
+ (id)defaultSiriSceneConfigurationWithInitialBounds:(struct CGRect)arg1 onDisplay:(id)arg2;	// IMP=0x000000000001d6c9
+ (id)stringForInvalidationReason:(unsigned long long)arg1;	// IMP=0x000000000001d51a
- (void).cxx_destruct;	// IMP=0x000000000001da8a
...
- (id)description;	// IMP=0x000000000001d84e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001d733
- (void)_setupPlatformSpecificDefaultSettings;	// IMP=0x000000000001d5b8
- (void)configureMutableSceneSettings:(id)arg1;	// IMP=0x000000000001d330
- (id)_initWithInitialBounds:(struct CGRect)arg1 displayConfiguration:(id)arg2;	// IMP=0x000000000001cf5a
