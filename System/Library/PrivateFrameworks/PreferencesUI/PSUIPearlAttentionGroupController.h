...
- (void).cxx_destruct;	// IMP=0x0000000000002f02
...
- (_Bool)isPeriocularEnabled;	// IMP=0x0000000000002e91
- (_Bool)useAlternateFooterTextForAttention;	// IMP=0x0000000000002e89
- (id)specifiers;	// IMP=0x0000000000002e4b
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x0000000000002db9
