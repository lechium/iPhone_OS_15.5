...
- (void).cxx_destruct;	// IMP=0x0000000000031fce
...
- (void)layoutSubviews;	// IMP=0x0000000000031a9e
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000000319d6
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x00000000000319b9
- (double)_continuousCornerRadius;	// IMP=0x000000000003199c
- (struct CGRect)_mainBodyBounds;	// IMP=0x000000000003191f
@property(readonly, nonatomic) struct CGRect tabViewBounds;
- (void)setTabHidden:(_Bool)arg1 left:(_Bool)arg2;	// IMP=0x0000000000031383
- (id)initWithFrame:(struct CGRect)arg1 minimumStashTabSize:(struct CGSize)arg2;	// IMP=0x0000000000030c4a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000030c28
