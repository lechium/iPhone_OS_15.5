...
- (void)_linkFired:(id)arg1;	// IMP=0x000000000000a2b7
- (void)invalidate;	// IMP=0x000000000000a281
- (id)initWithOwner:(id)arg1 linkFired:(CDUnknownBlockType)arg2;	// IMP=0x000000000000a0c3
