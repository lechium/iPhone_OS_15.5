...
- (void).cxx_destruct;	// IMP=0x0000000000042c12
...
- (void)resetChevronState;	// IMP=0x0000000000042bc3
- (void)setChevronHidden:(_Bool)arg1 left:(_Bool)arg2;	// IMP=0x0000000000042b8d
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x0000000000042932
- (void)layoutStashChevrons;	// IMP=0x0000000000042578
- (void)layoutSubviews;	// IMP=0x000000000004237e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000041d44
