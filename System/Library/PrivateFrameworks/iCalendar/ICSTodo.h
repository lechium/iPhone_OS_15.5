...
+ (id)name;	// IMP=0x0000000000013c0f
- (id)propertiesToIncludeForChecksumVersion:(int)arg1;	// IMP=0x0000000000014176
...
- (_Bool)validate:(id *)arg1;	// IMP=0x0000000000013c1c
- (void)fixComponent;	// IMP=0x00000000000123ca
