...
- (void).cxx_destruct;	// IMP=0x000000000001e6ce
...
- (void)getDataWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001dfb1
- (id)initWithType:(id)arg1 fileHandle:(id)arg2 offsetInFile:(id)arg3 size:(long long)arg4;	// IMP=0x000000000001dea0
