...
- (void).cxx_destruct;	// IMP=0x00000000000614af
@property(readonly) EFPair *queryIdentifier; // @synthesize queryIdentifier=_queryIdentifier;
- (void)countDidChange:(long long)arg1 acknowledgementToken:(id)arg2;	// IMP=0x0000000000061209
- (void)_performQueryWithRemoteConnection:(id)arg1 forRecovery:(_Bool)arg2;	// IMP=0x00000000000610c2
- (void)recoverQueryWithRemoteConnection:(id)arg1;	// IMP=0x00000000000610aa
- (void)performQueryWithRemoteConnection:(id)arg1;	// IMP=0x0000000000061095
- (void)cancel;	// IMP=0x000000000006107f
- (void)dealloc;	// IMP=0x000000000006100b
- (id)initWithRepository:(id)arg1 queryIdentifier:(id)arg2 includingServerCountsForMailboxScope:(id)arg3 observer:(id)arg4;	// IMP=0x0000000000060edf
