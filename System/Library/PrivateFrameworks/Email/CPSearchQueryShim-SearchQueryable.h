...
@property(copy) CDUnknownBlockType changedAttributesHandler; // @dynamic changedAttributesHandler;
...
@property(copy) CDUnknownBlockType foundAttributesHandler; // @dynamic foundAttributesHandler;
