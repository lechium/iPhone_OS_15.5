...
- (id)newAccessoryDisclosureIndicatorViewForVibrationPickerCell;	// IMP=0x0000000000006705
- (id)newBackgroundViewForSelectedVibrationPickerCell:(_Bool)arg1;	// IMP=0x000000000000669a
...
- (id)newAccessoryDisclosureIndicatorViewForTonePickerCell;	// IMP=0x000000000000656b
- (id)newBackgroundViewForSelectedTonePickerCell:(_Bool)arg1;	// IMP=0x0000000000006500
