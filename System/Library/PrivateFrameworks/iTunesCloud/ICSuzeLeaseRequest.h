...
- (void).cxx_destruct;	// IMP=0x000000000011fc7c
...
- (void)performWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000011fb0b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000011fa41
- (id)initWithRequestContext:(id)arg1 requestType:(long long)arg2 leaseID:(id)arg3 mediaType:(long long)arg4 clientData:(id)arg5;	// IMP=0x000000000011f93a
