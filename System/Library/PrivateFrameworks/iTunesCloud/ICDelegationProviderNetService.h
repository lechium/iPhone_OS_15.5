...
- (void).cxx_destruct;	// IMP=0x00000000001aead6
@property(readonly, nonatomic) NSNetService *netService; // @synthesize netService=_netService;
- (void)_updateTXTRecordProperties;	// IMP=0x00000000001ae958
- (void)_setState:(long long)arg1;	// IMP=0x00000000001ae80f
- (void)_resolveWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001ae72e
...
- (void)getResolvedStreamsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001ae400
- (void)netService:(id)arg1 didNotResolve:(id)arg2;	// IMP=0x00000000001ae30f
- (void)netServiceDidResolveAddress:(id)arg1;	// IMP=0x00000000001ae247
- (void)netService:(id)arg1 didUpdateTXTRecordData:(id)arg2;	// IMP=0x00000000001ae17f
- (void)dealloc;	// IMP=0x00000000001ae13b
- (id)initWithNetService:(id)arg1;	// IMP=0x00000000001ae00d
