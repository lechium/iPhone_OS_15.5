...
- (void).cxx_destruct;	// IMP=0x0000000000019655
...
- (id)_xpcConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x0000000000019379
@property(readonly, nonatomic) NSXPCConnection *xpcConnection; // @synthesize xpcConnection=_xpcConnection;
- (id)initWithListenerEndpointProvider:(id)arg1;	// IMP=0x0000000000019202
