...
- (void).cxx_destruct;	// IMP=0x0000000000127143
- (unsigned long long)hash;	// IMP=0x0000000000126298
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001254d3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001249a2
- (void)writeTo:(id)arg1;	// IMP=0x000000000012408c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000122680
- (id)dictionaryRepresentation;	// IMP=0x0000000000121493
- (id)description;	// IMP=0x00000000001213e4
