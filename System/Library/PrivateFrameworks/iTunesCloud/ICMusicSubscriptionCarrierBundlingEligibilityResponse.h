...
- (void).cxx_destruct;	// IMP=0x000000000001ff3f
...
- (id)initWithEligibilityDictionary:(id)arg1 cellularProviderName:(id)arg2 phoneNumber:(id)arg3;	// IMP=0x000000000001f6fc
