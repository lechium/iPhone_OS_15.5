...
- (void).cxx_destruct;	// IMP=0x000000000014b3d0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014b2d3
@property(readonly, copy, nonatomic) NSMutableDictionary *propertyListRepresentation;
- (id)initWithDSID:(id)arg1 SICData:(id)arg2;	// IMP=0x000000000014b185
