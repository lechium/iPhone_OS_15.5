...
- (void).cxx_destruct;	// IMP=0x000000000008033d
- (unsigned long long)hash;	// IMP=0x00000000000801bb
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007feeb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007fcb8
- (void)writeTo:(id)arg1;	// IMP=0x000000000007fb56
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000007fb49
- (id)dictionaryRepresentation;	// IMP=0x000000000007f76c
- (id)description;	// IMP=0x000000000007f6bd
