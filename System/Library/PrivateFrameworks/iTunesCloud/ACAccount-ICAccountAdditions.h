...
- (_Bool)_updateAutomaticDownloadKindsByAddingMediaKindMusic:(_Bool)arg1 error:(id *)arg2;	// IMP=0x0000000000180dfc
...
- (void)ic_updateAutomaticDownloadKindsByAddingMediaKindMusic:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001809f2
- (_Bool)ic_updateAutomaticDownloadKindsByAddingMediaKindMusic:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00000000001809de
- (_Bool)ic_isAutomaticDownloadsEnabledForMediaKindMusic;	// IMP=0x000000000018096b
