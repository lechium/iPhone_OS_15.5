...
- (void).cxx_destruct;	// IMP=0x0000000000089bde
...
- (void)_reloadTransportControlStateForItemWithIdentifier:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000089980
- (void)_broadcastTransportControlStateDictionary:(id)arg1 forItemWithIdentifier:(id)arg2;	// IMP=0x00000000000898b0
- (void)_broadcastLocalParticipantStateDictionary:(id)arg1;	// IMP=0x00000000000897e0
- (void)clearCoordinationMediumDelegate;	// IMP=0x00000000000896d0
- (void)synchronizePlaybackStateForReason:(id)arg1;	// IMP=0x00000000000895fc
- (void)handleNewTransportControlStateDictionary:(id)arg1;	// IMP=0x00000000000894ec
- (void)handleNewParticipantStateDictionary:(id)arg1;	// IMP=0x00000000000893dc
- (void)removeParticipant:(id)arg1;	// IMP=0x00000000000892cc
- (void)handlePlaybackSyncPayload:(id)arg1;	// IMP=0x00000000000890c6
- (_Bool)isCoordinatorSuspended;	// IMP=0x00000000000890be
- (id)initWithLiveLink:(id)arg1;	// IMP=0x0000000000088f20
