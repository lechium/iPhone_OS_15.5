...
- (void).cxx_destruct;	// IMP=0x00000000000490db
...
- (id)timeRefForTTLClass:(unsigned char)arg1;	// IMP=0x00000000000490a7
- (id)initWithCollection:(id)arg1 localStorePlist:(id)arg2 liveDataDescriptor:(int)arg3;	// IMP=0x0000000000048dd8
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000004880a
