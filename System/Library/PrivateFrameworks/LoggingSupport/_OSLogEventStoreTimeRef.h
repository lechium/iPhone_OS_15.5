...
+ (id)timeRef;	// IMP=0x00000000000485ed
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000486a2
- (id)initWithUUID:(unsigned char [16])arg1 continuous:(unsigned long long)arg2;	// IMP=0x0000000000048673
