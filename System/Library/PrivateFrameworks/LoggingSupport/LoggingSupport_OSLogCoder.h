...
- (void)appendBytes:(const void *)arg1 length:(unsigned long long)arg2;	// IMP=0x000000000002c843
- (void)setTruncated;	// IMP=0x000000000002c83b
- (void)setPublic;	// IMP=0x000000000002c81a
- (void)_initBlob;	// IMP=0x000000000002c76c
