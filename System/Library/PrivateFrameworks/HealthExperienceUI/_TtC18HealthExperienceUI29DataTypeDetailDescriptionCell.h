...
- (void).cxx_destruct;	// IMP=0x00000000000fae30
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000fadc0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000fad00
- (void)awakeFromNib;	// IMP=0x00000000000fa460
