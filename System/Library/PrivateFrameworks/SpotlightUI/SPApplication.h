...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000004849
- (void).cxx_destruct;	// IMP=0x00000000000050b5
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004cdc
- (id)description;	// IMP=0x0000000000004c2f
@property(readonly) _Bool isAppClip;
@property(readonly) _Bool isWebClip;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000004971
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000004851
