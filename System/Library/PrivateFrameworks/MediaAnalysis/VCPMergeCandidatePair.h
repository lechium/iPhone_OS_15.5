...
+ (id)mergeCandidatePairWithPerson:(id)arg1 andPerson:(id)arg2 reason:(id)arg3;	// IMP=0x000000000008a6b4
- (void).cxx_destruct;	// IMP=0x000000000008abbf
...
- (id)description;	// IMP=0x000000000008aac8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008a882
- (unsigned long long)hash;	// IMP=0x000000000008a878
- (id)initWithPerson:(id)arg1 andPerson:(id)arg2 reason:(id)arg3;	// IMP=0x000000000008a75f
