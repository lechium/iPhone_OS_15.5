...
+ (id)requestWithFaceClusterIds:(id)arg1 clusterFlags:(id)arg2 updateHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001e87f3
- (void).cxx_destruct;	// IMP=0x00000000001e8934
...
- (id)initWithFaceClusterIds:(id)arg1 clusterFlags:(id)arg2 updateHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001e84b5
