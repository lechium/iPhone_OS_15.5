...
+ (id)dependencies;	// IMP=0x000000000011dc43
+ (id)taskWithRequest:(id)arg1 imageAsset:(id)arg2 andSignpostPayload:(id)arg3;	// IMP=0x000000000011da5a
- (void).cxx_destruct;	// IMP=0x000000000011f8e3
- (int)run;	// IMP=0x000000000011ea3e
- (void)storeResults:(id)arg1;	// IMP=0x000000000011e28e
- (id)createQueryContextWithError:(id *)arg1;	// IMP=0x000000000011dcfe
- (void)cancel;	// IMP=0x000000000011dc77
- (_Bool)autoCancellable;	// IMP=0x000000000011dc6f
- (float)resourceRequirement;	// IMP=0x000000000011dc61
- (void)setPreferredMetalDevice:(id)arg1;	// IMP=0x000000000011dc50
- (id)initWithRequest:(id)arg1 imageAsset:(id)arg2 andSignpostPayload:(id)arg3;	// IMP=0x000000000011d960
