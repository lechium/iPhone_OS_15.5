...
+ (id)entryWithLocalIdentifier:(id)arg1 andTaskID:(unsigned long long)arg2 andStatus:(unsigned long long)arg3 andAttempts:(unsigned long long)arg4 andLastRetryDate:(id)arg5;	// IMP=0x0000000000185175
- (void).cxx_destruct;	// IMP=0x0000000000185241
...
- (id)initWithLocalIdentifier:(id)arg1 andTaskID:(unsigned long long)arg2 andStatus:(unsigned long long)arg3 andAttempts:(unsigned long long)arg4 andLastRetryDate:(id)arg5;	// IMP=0x00000000001850b4
