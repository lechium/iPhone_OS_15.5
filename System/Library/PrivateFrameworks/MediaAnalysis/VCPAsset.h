...
+ (void)unimplementedExceptionForMethodName:(id)arg1;	// IMP=0x000000000017cfdb
- (id)typeDescription;	// IMP=0x000000000017d15e
...
- (struct __CVBuffer *)imageWithPreferredDimension:(unsigned long long)arg1;	// IMP=0x000000000017d31e
...
- (struct CGSize)originalMovieSize;	// IMP=0x000000000017d530
- (id)originalMovie;	// IMP=0x000000000017d50c
- (id)streamedMovie;	// IMP=0x000000000017d504
- (id)movie;	// IMP=0x000000000017d4e0
