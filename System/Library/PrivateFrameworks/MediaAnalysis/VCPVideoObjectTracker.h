...
- (void).cxx_destruct;	// IMP=0x000000000025b993
...
- (int)trackObjectInFrame:(struct __CVBuffer *)arg1;	// IMP=0x000000000025b507
- (id)initWithObjectBounds:(struct CGRect)arg1 inFrame:(struct __CVBuffer *)arg2 timestamp:(CDStruct_1b6d18a9)arg3;	// IMP=0x000000000025b1a0
