...
+ (id)vcp_sharedModelWithModelName:(id)arg1;	// IMP=0x00000000000ce99b
- (void).cxx_destruct;	// IMP=0x00000000000ceaf8
...
- (id)initWithModelName:(id)arg1;	// IMP=0x00000000000cdfc0
- (id)init;	// IMP=0x00000000000cdfb2
