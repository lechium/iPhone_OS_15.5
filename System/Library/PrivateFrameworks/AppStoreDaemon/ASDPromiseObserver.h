...
- (void).cxx_destruct;	// IMP=0x0000000000042606
...
- (void)notifyRejectedWithError:(id)arg1;	// IMP=0x00000000000424ce
- (void)notifyResolvedWithValue:(id)arg1;	// IMP=0x00000000000423d2
- (id)initWithValueBlock:(CDUnknownBlockType)arg1 errorBlock:(CDUnknownBlockType)arg2 scheduler:(id)arg3;	// IMP=0x00000000000422f3
