...
{
    id <REMXPCDaemonControllerCloudKitNetworkActivityDelegate> _cloudKitNetworkActivityDelegate;	// 8 = 0x8
}

- (void).cxx_destruct;	// IMP=0x000000000007d223
...
- (void)cloudKitNetworkActivityDidUpdate:(id)arg1;	// IMP=0x000000000007d18a
