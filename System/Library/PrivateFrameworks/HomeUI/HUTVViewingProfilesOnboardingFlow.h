...
+ (id)needsOnboardingForHome:(id)arg1 options:(id)arg2;	// IMP=0x0000000000461bdd
- (void).cxx_destruct;	// IMP=0x00000000004620d6
...
- (id)processUserInput:(id)arg1;	// IMP=0x0000000000461629
@property(readonly, copy) NSString *description;
- (id)initWithUsageOptions:(id)arg1 home:(id)arg2;	// IMP=0x0000000000461301
