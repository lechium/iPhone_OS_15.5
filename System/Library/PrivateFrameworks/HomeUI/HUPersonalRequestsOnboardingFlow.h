...
+ (id)needsOnboardingForHome:(id)arg1 options:(id)arg2;	// IMP=0x00000000002c224e
- (void).cxx_destruct;	// IMP=0x00000000002c2c06
...
- (id)processUserInput:(id)arg1;	// IMP=0x00000000002c2035
@property(readonly, copy) NSString *description;
- (id)initWithUsageOptions:(id)arg1 home:(id)arg2;	// IMP=0x00000000002c1d0d
