...
- (void).cxx_destruct;	// IMP=0x000000000020a233
...
- (void)beginUserInteractionWithFirstTouchGestureRecognizer:(id)arg1;	// IMP=0x000000000020a198
- (id)intrinsicSizeDescriptorForControlSize:(unsigned long long)arg1;	// IMP=0x000000000020a17f
- (id)initWithProfile:(id)arg1;	// IMP=0x000000000020a063
