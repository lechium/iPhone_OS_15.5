...
- (void).cxx_destruct;	// IMP=0x00000000003ca66d
...
- (void)_updateContentViewInsetConstraints;	// IMP=0x00000000003ca396
- (void)_updateContentViewContainerConstraints;	// IMP=0x00000000003ca00f
- (_Bool)_limitToNonScrollingContentHeight;	// IMP=0x00000000003ca007
- (void)_viewDidUpdateContent;	// IMP=0x00000000003c9fd9
- (double)_contentAspectRatio;	// IMP=0x00000000003c9fcb
- (void)viewWillLayoutSubviews;	// IMP=0x00000000003c9f8a
- (void)viewDidLoad;	// IMP=0x00000000003c9f34
- (id)initWithTitle:(id)arg1 detailText:(id)arg2 icon:(id)arg3;	// IMP=0x00000000003c9d85
- (id)initWithTitle:(id)arg1 detailText:(id)arg2 icon:(id)arg3 contentLayout:(long long)arg4;	// IMP=0x00000000003c9cd0
- (id)initWithTitle:(id)arg1 detailText:(id)arg2 icon:(id)arg3 contentView:(id)arg4;	// IMP=0x00000000003c9913
