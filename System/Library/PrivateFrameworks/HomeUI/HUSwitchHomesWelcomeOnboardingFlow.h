...
+ (id)needsOnboardingForHome:(id)arg1 options:(id)arg2;	// IMP=0x00000000003b454d
- (void).cxx_destruct;	// IMP=0x00000000003b45db
...
- (id)processUserInput:(id)arg1;	// IMP=0x00000000003b42ac
@property(readonly, copy) NSString *description;
- (id)initWithHome:(id)arg1;	// IMP=0x00000000003b3f9d
