...
+ (id)needsOnboardingForHome:(id)arg1 options:(id)arg2;	// IMP=0x000000000042a6fa
- (void).cxx_destruct;	// IMP=0x000000000042a78f
...
- (id)processUserInput:(id)arg1;	// IMP=0x000000000042a5dc
@property(readonly, copy) NSString *description;
- (id)initWithUpgradeRequirements:(unsigned long long)arg1 home:(id)arg2;	// IMP=0x000000000042a2b0
