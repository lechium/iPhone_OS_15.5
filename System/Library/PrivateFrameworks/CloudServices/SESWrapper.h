...
- (void).cxx_destruct;	// IMP=0x00000000000233ad
...
- (void)dealloc;	// IMP=0x0000000000023233
- (id)recoveryResponseForBlob:(id)arg1;	// IMP=0x00000000000229a0
- (id)srpResponseForEscrowBlob:(id)arg1 withKey:(struct __SecKey *)arg2 withFullCCKey:(struct ccrsa_full_ctx *)arg3;	// IMP=0x0000000000021df2
- (id)decodedEscrowRecordFromData:(id)arg1 stingray:(_Bool)arg2 env:(id)arg3 duplicate:(_Bool)arg4;	// IMP=0x0000000000020f7b
- (id)encodedEscrowRecordWithPublicKey:(struct __SecKey *)arg1 error:(id *)arg2;	// IMP=0x000000000001f014
- (id)srpRecoveryBlobFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001e06a
- (void)srpRecoveryUpdateDSID:(id)arg1 recoveryPassphrase:(id)arg2;	// IMP=0x000000000001dfec
- (unsigned long long)srpPublicKeySize;	// IMP=0x000000000001df92
- (unsigned long long)srpKeySize;	// IMP=0x000000000001df19
- (id)srpInitBlob;	// IMP=0x000000000001dd91
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5 ckvrFlag:(_Bool)arg6 reqVersion:(int)arg7;	// IMP=0x000000000001db1f
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5;	// IMP=0x000000000001da3a
- (id)initWithRequest:(id)arg1 ckvrFlag:(_Bool)arg2 reqVersion:(int)arg3;	// IMP=0x000000000001d87d
- (id)initWithRequest:(id)arg1 reqVersion:(int)arg2;	// IMP=0x000000000001d81c
- (id)initWithRequest:(id)arg1;	// IMP=0x000000000001d808
