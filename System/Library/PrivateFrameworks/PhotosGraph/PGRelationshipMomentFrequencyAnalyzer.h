...
- (void).cxx_destruct;	// IMP=0x0000000000198f66
- (void)runAnalysisWithProgressBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000198356
- (id)initWithRelationshipProcessor:(id)arg1;	// IMP=0x00000000001982f2
