...
- (void).cxx_destruct;	// IMP=0x0000000000599e5d
- (void)runAnalysisWithProgressBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000005995ed
- (id)initWithRelationshipProcessor:(id)arg1;	// IMP=0x0000000000599589
