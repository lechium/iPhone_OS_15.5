...
- (void).cxx_destruct;	// IMP=0x00000000004e31c6
- (void)runAnalysisWithProgressBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000004e2a26
- (id)initWithRelationshipProcessor:(id)arg1;	// IMP=0x00000000004e29c2
