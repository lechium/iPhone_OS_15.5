...
+ (id)sceneFeatureNodesForSceneNames:(id)arg1 inGraph:(id)arg2;	// IMP=0x000000000021cad3
+ (id)sceneFeatureNodesForSceneName:(id)arg1 inGraph:(id)arg2;	// IMP=0x000000000021ca41
+ (Class)nodeClass;	// IMP=0x000000000021ca30
