...
- (void).cxx_destruct;	// IMP=0x000000000030fc86
- (void)runAnalysisWithProgressBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000030f64f
- (id)initWithRelationshipProcessor:(id)arg1;	// IMP=0x000000000030f5eb
