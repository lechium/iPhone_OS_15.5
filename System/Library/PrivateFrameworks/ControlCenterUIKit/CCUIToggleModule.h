...
{
    NSHashTable *_contentViewControllers;	// 8 = 0x8
    CCUIContentModuleContext *_contentModuleContext;	// 16 = 0x10
    CCUICAPackageDescription *_glyphPackageDescription;	// 24 = 0x18
}

- (void).cxx_destruct;	// IMP=0x000000000001a492
...
- (id)contentViewControllerForContext:(id)arg1;	// IMP=0x000000000001a3e6
- (void)reconfigureView;	// IMP=0x000000000001a371
- (void)refreshState;	// IMP=0x000000000001a2fc
@property(readonly, nonatomic) double glyphScale;
@property(readonly, copy, nonatomic) NSString *glyphState;
- (id)glyphPackage;	// IMP=0x000000000001a2de
