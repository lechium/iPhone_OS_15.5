...
+ (id)accessibilityHIDServices;	// IMP=0x000000000000194d
- (void).cxx_destruct;	// IMP=0x0000000000001925
...
- (id)initWithSenderID:(unsigned long long)arg1;	// IMP=0x0000000000001814
