...
- (void)updateContentSize;	// IMP=0x0000000000008590
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000000000853e
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000000834c
- (void)adjustedContentInsetDidChange;	// IMP=0x00000000000082f6
- (void)layoutSubviews;	// IMP=0x0000000000007b6b
- (id)initWithFeatures:(id)arg1;	// IMP=0x0000000000007873
