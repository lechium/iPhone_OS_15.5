...
- (void).cxx_destruct;	// IMP=0x0000000000005ab2
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000000515b
- (void)mediaPause;	// IMP=0x0000000000004fce
- (void)imageViewTapped:(id)arg1;	// IMP=0x0000000000004f91
- (void)viewWillLayoutSubviews;	// IMP=0x000000000000477c
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000000468c
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x00000000000042ec
- (void)loadView;	// IMP=0x0000000000003f20
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000003131
