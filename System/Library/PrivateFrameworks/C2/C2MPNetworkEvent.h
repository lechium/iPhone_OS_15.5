...
+ (Class)networkPathInfoType;	// IMP=0x0000000000007412
- (void).cxx_destruct;	// IMP=0x000000000000d478
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000c831
- (unsigned long long)hash;	// IMP=0x000000000000c0dd
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000b6d1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000aeaa
- (void)copyTo:(id)arg1;	// IMP=0x000000000000a863
- (void)writeTo:(id)arg1;	// IMP=0x000000000000a171
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000a164
- (id)dictionaryRepresentation;	// IMP=0x0000000000007ba9
- (id)description;	// IMP=0x0000000000007afa
...
- (id)networkPathInfoAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000073f5
- (unsigned long long)networkPathInfosCount;	// IMP=0x00000000000073d8
- (void)addNetworkPathInfo:(id)arg1;	// IMP=0x000000000000736e
- (void)clearNetworkPathInfos;	// IMP=0x0000000000007351
