...
+ (Class)clientOperationType;	// IMP=0x0000000000011693
+ (Class)operationGroupType;	// IMP=0x0000000000011529
- (void).cxx_destruct;	// IMP=0x0000000000013d33
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000013745
- (unsigned long long)hash;	// IMP=0x0000000000013542
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000131b6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000012cb6
- (void)copyTo:(id)arg1;	// IMP=0x0000000000012995
- (void)writeTo:(id)arg1;	// IMP=0x00000000000125c1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000125b4
- (id)dictionaryRepresentation;	// IMP=0x00000000000117e3
- (id)description;	// IMP=0x0000000000011734
@property(nonatomic) _Bool hasReportClientOperationFrequencyBase;
@property(nonatomic) _Bool hasReportClientOperationFrequency;
- (id)clientOperationAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000011676
- (unsigned long long)clientOperationsCount;	// IMP=0x0000000000011659
- (void)addClientOperation:(id)arg1;	// IMP=0x00000000000115ef
- (void)clearClientOperations;	// IMP=0x00000000000115d2
@property(nonatomic) _Bool hasReportOperationGroupFrequencyBase;
@property(nonatomic) _Bool hasReportOperationGroupFrequency;
- (id)operationGroupAtIndex:(unsigned long long)arg1;	// IMP=0x000000000001150c
- (unsigned long long)operationGroupsCount;	// IMP=0x00000000000114ef
- (void)addOperationGroup:(id)arg1;	// IMP=0x0000000000011485
- (void)clearOperationGroups;	// IMP=0x0000000000011468
