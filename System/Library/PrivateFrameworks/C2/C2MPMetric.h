...
- (void).cxx_destruct;	// IMP=0x00000000000294b5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000029135
- (unsigned long long)hash;	// IMP=0x0000000000028f93
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000028c98
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000028a6c
- (void)copyTo:(id)arg1;	// IMP=0x00000000000288b5
- (void)writeTo:(id)arg1;	// IMP=0x00000000000286f9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000286ec
- (id)dictionaryRepresentation;	// IMP=0x0000000000027b7f
- (id)description;	// IMP=0x0000000000027ad0
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x0000000000027832
- (id)metricTypeAsString:(int)arg1;	// IMP=0x00000000000277c6
