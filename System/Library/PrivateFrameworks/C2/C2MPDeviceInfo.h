...
+ (Class)internalTestConfigType;	// IMP=0x000000000002caea
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002de58
- (unsigned long long)hash;	// IMP=0x000000000002dd17
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002daa1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002d785
- (void)copyTo:(id)arg1;	// IMP=0x000000000002d59b
- (void)writeTo:(id)arg1;	// IMP=0x000000000002d35d
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000002d350
- (id)dictionaryRepresentation;	// IMP=0x000000000002cbaa
- (id)description;	// IMP=0x000000000002cafb
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x000000000002cacd
- (unsigned long long)internalTestConfigsCount;	// IMP=0x000000000002cab0
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x000000000002ca46
- (void)clearInternalTestConfigs;	// IMP=0x000000000002ca29
