...
@class NSNumber, NSString, SASActivationRequest, SASButtonIdentifierTransport, SASLockStateTransport, SASRequestOptions, SASTimeIntervalTransport, SiriDismissalOptions, SiriLongPressButtonContext, SiriPresentationActivationCancelReasonTransport, SiriPresentationOptions;
