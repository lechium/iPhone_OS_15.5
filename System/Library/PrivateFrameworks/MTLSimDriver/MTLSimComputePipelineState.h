...
- (unsigned int)pipelineRef;	// IMP=0x000000000000e88c
- (void)dealloc;	// IMP=0x000000000000e7b2
- (unsigned long long)uniqueIdentifier;	// IMP=0x000000000000e625
- (id)initWithDevice:(id)arg1 pipelineRef:(unsigned int)arg2 descriptor:(id)arg3;	// IMP=0x000000000000e5b9
