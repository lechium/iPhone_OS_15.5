...
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x0000000000009020
- (id)newArgumentEncoderWithBufferIndex:(unsigned long long)arg1 reflection:(id *)arg2;	// IMP=0x0000000000009018
- (id)newArgumentEncoderWithBufferIndex:(unsigned long long)arg1;	// IMP=0x0000000000009010
@property(readonly) unsigned int functionRef;
- (void)dealloc;	// IMP=0x0000000000008f32
- (id)initWithDevice:(id)arg1 functionType:(unsigned long long)arg2 functionRef:(unsigned int)arg3;	// IMP=0x0000000000008ecc
