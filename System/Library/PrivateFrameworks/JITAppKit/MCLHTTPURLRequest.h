...
- (void).cxx_destruct;	// IMP=0x000000000001bd30
...
- (void)handleCompletion:(id)arg1;	// IMP=0x000000000001b8d0
- (void)loadRequest:(id)arg1;	// IMP=0x000000000001b6b0
- (void)cancel;	// IMP=0x000000000001b630
- (void)sendText:(id)arg1;	// IMP=0x000000000001b5a0
- (void)sendData:(id)arg1;	// IMP=0x000000000001b410
- (void)send;	// IMP=0x000000000001b3e0
