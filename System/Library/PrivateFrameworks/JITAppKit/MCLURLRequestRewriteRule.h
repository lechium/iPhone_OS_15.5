...
+ (id)urlRequestRewriteRuleWithMatchPattern:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x000000000001beb0
- (void).cxx_destruct;	// IMP=0x000000000001c100
...
- (void)rewriteURLRequest:(id)arg1;	// IMP=0x000000000001bfe0
- (id)initWithMatchExpression:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x000000000001bdb0
