...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000000247f0
- (void)updateConstraints;	// IMP=0x00000000000246d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000242b0
