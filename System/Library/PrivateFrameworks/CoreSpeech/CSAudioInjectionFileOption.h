...
- (void).cxx_destruct;	// IMP=0x0000000000008b96
...
- (id)description;	// IMP=0x0000000000008af9
- (id)initWithAudioURL:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3;	// IMP=0x0000000000008a5b
