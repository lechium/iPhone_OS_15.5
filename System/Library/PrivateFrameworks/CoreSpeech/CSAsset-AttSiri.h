...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x000000000000eb3f
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x000000000000eaf3
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x000000000000eab8
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x000000000000ea6c
...
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x0000000000010c7e
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x000000000000de79
@property(readonly, nonatomic) NSString *flexKwdThresholdFile;
@property(readonly, nonatomic) NSString *flexKwdConfigFile;
- (id)_sha256:(id)arg1;	// IMP=0x0000000000051b96
- (id)_sha1:(id)arg1;	// IMP=0x0000000000051aa5
- (id)localeMapWithName:(id)arg1;	// IMP=0x00000000000518fc
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x00000000000518c8
- (id)remoraRTModelLocaleMap;	// IMP=0x00000000000518af
- (id)jarvisRTModelLocaleMap;	// IMP=0x0000000000051896
- (id)hearstRTModelLocaleMap;	// IMP=0x000000000005187d
- (id)hearstRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x0000000000051860
- (id)remoraRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x0000000000051840
- (id)rtModelWithAccessoryRTModelType:(long long)arg1 majorVersion:(unsigned long long)arg2 minorVersion:(unsigned long long)arg3 locale:(id)arg4;	// IMP=0x000000000005101c
- (id)latestHearstRTModelForLocale:(id)arg1;	// IMP=0x0000000000050c4e
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x0000000000050be8
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x0000000000050bb4
...
- (unsigned long long)_mapInputOriginFromAssetToCSAudioRecordType:(id)arg1;	// IMP=0x00000000000acee2
