...
- (void).cxx_destruct;	// IMP=0x000000000000dd5b
- (void)stopReportZeroStatistics;	// IMP=0x000000000000dcbd
- (void)getZeroStatisticsFromBuffer:(id)arg1 entireSamples:(unsigned int)arg2;	// IMP=0x000000000000db1a
- (void)resetWithSampleRate:(float)arg1;	// IMP=0x000000000000da51
- (id)initWithToken:(id)arg1 sampleRate:(float)arg2 numChannels:(unsigned int)arg3;	// IMP=0x000000000000d8f6
