...
- (void)secondPassDidStartForClient:(unsigned long long)arg1 deviceId:(id)arg2 withFirstPassEstimate:(double)arg3;	// IMP=0x000000000000c09d
- (void)secondPassDidStopForClient:(unsigned long long)arg1 deviceId:(id)arg2;	// IMP=0x000000000000bea5
- (void)voiceTriggerDidRejected:(id)arg1 deviceId:(id)arg2;	// IMP=0x000000000000bddd
- (void)raiseToSpeakDetected:(id)arg1;	// IMP=0x000000000000bd83
- (void)voiceTriggerGotSuperVector:(id)arg1;	// IMP=0x000000000000bd29
- (void)keywordDetectorDidDetectKeyword;	// IMP=0x000000000000bcf8
- (void)voiceTriggerDidDetectSpeakerReject:(id)arg1;	// IMP=0x000000000000bc9e
- (void)voiceTriggerDidDetectNearMiss:(id)arg1 deviceId:(id)arg2;	// IMP=0x000000000000bbd6
- (void)voiceTriggerDidDetectKeyword:(id)arg1 deviceId:(id)arg2;	// IMP=0x000000000000ba90
- (void)voiceTriggerDidDetectKeyword:(id)arg1 deviceId:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000000b9e9
- (_Bool)_isRemoraSecondPassRunning;	// IMP=0x000000000000b910
- (void)_getHighestRemoraFirstPassGoodnessScore:(CDUnknownBlockType)arg1;	// IMP=0x000000000000b6d9
- (_Bool)handlePendingBuiltInVoiceTriggerIfNeeded;	// IMP=0x000000000000b36c
- (void)_clearPendingBuiltInVoiceTrigger;	// IMP=0x000000000000b26f
- (_Bool)handlePendingRemoraVoiceTriggerIfNeeded;	// IMP=0x000000000000ae21
- (void)_clearPendingRemoraVoiceTrigger;	// IMP=0x000000000000acf6
- (_Bool)isRemoraVoiceTriggerEvent:(id)arg1;	// IMP=0x000000000000abe8
- (_Bool)isBultInVoiceTriggerEvent:(id)arg1;	// IMP=0x000000000000aada
- (id)initWithTargetQueue:(id)arg1;	// IMP=0x000000000000aa17
