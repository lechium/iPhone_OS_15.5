...
- (void).cxx_destruct;	// IMP=0x000000000002679c
...
- (void)spgEndpointAnalyzer:(id)arg1 hasSilenceScoreEstimate:(double)arg2 clientProcessedAudioTimeMS:(float)arg3;	// IMP=0x0000000000026233
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x000000000002622d
- (_Bool)_shouldReportBoron;	// IMP=0x00000000000261f5
- (_Bool)_popRemoteVADSignal;	// IMP=0x0000000000026176
- (void)_addRemoteVADSignal:(_Bool)arg1;	// IMP=0x00000000000260e8
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x0000000000025d34
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x0000000000025c85
- (void)stopListenWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000025c6e
- (void)stopListenWithStateReset:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000258e6
- (void)_startRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000252fc
- (void)_resetAlignBuffer;	// IMP=0x00000000000252d3
- (void)startListenWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000024dd3
- (id)init;	// IMP=0x0000000000024ce5
