...
- (void).cxx_destruct;	// IMP=0x00000000000ad7e9
...
- (void)updateDeviceId:(id)arg1;	// IMP=0x00000000000ad7b1
- (void)updateWithLatestRecordContext:(id)arg1;	// IMP=0x00000000000ad613
- (id)initWithRecordContext:(id)arg1 deviceId:(id)arg2 shouldUseRemoteRecorder:(_Bool)arg3 streamHandleId:(unsigned long long)arg4;	// IMP=0x00000000000ad54a
