...
- (double)applyLowerAndUpperBoundsToVolumeOffset:(float)arg1;	// IMP=0x0000000000064aa6
- (void)storeASVStateInformation;	// IMP=0x0000000000064a53
- (float)decreaseSiriVolumeBasedOnUserIntent;	// IMP=0x0000000000064a32
- (float)increaseSiriVolumeBasedOnUserIntent;	// IMP=0x0000000000064a11
- (void)initWithStoredInformationAndAsset:(id)arg1;	// IMP=0x00000000000648c5
- (double)applyLowerAndUpperBoundsToVolume:(float)arg1;	// IMP=0x00000000000647bd
