...
- (void).cxx_destruct;	// IMP=0x00000000000a50b9
...
- (_Bool)_multimodalEndpointerEnabled;	// IMP=0x00000000000a4b05
- (_Bool)_shouldUsePhaticWithRecordContext;	// IMP=0x00000000000a4a67
- (id)_getCSHybridEndpointerConfigForAsset:(id)arg1;	// IMP=0x00000000000a478d
- (void)endpointerAssetManagerDidUpdateOSDAsset:(id)arg1;	// IMP=0x00000000000a4787
- (void)endpointerAssetManagerDidUpdateAsset:(id)arg1;	// IMP=0x00000000000a45c1
...
- (void)reset;	// IMP=0x00000000000a4527
- (void)_readParametersFromHEPAsset:(id)arg1;	// IMP=0x00000000000a40f4
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x00000000000a3654
- (void)stopEndpointer;	// IMP=0x00000000000a35be
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x00000000000a3516
- (void)terminateProcessing;	// IMP=0x00000000000a350c
- (void)preheat;	// IMP=0x00000000000a3506
- (void)handleVoiceTriggerWithActivationInfo:(id)arg1;	// IMP=0x00000000000a3210
- (void)logFeaturesWithEvent:(id)arg1 locale:(id)arg2;	// IMP=0x00000000000a29e5
- (void)_emitEndpointDetectedEventWithEndpointTimeMs:(double)arg1 endpointBufferHostTime:(unsigned long long)arg2 endpointerFeatures:(id)arg3 endpointerDecisionLagInNs:(double)arg4 extraDelayMs:(unsigned long long)arg5 endpointScore:(double)arg6 asrFeatureLatencies:(id)arg7;	// IMP=0x00000000000a29d4
- (void)processOSDFeatures:(id)arg1 withFrameDurationMs:(double)arg2;	// IMP=0x00000000000a0ac2
- (void)processFirstAudioPacketTimestamp:(id)arg1 firstAudioSampleSensorTimestamp:(unsigned long long)arg2;	// IMP=0x00000000000a094a
- (void)logAnchorMachAbsTime:(unsigned long long)arg1 numSamplesProcessedBeforeAnchorTime:(unsigned long long)arg2 isAnchorTimeBuffered:(_Bool)arg3;	// IMP=0x00000000000a08c2
- (void)shouldAcceptEagerResultForDuration:(double)arg1 resultsCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000a019b
- (void)processServerEndpointFeatures:(id)arg1;	// IMP=0x000000000009fecd
- (void)processTaskString:(id)arg1;	// IMP=0x000000000009fbb4
- (void)processASRFeatures:(id)arg1 fromServer:(_Bool)arg2;	// IMP=0x000000000009fb0d
- (long long)fetchCurrentEndpointerOperationMode;	// IMP=0x000000000009f9cb
- (void)updateEndpointerDelayedTrigger:(_Bool)arg1;	// IMP=0x000000000009f82d
- (void)_updateEndpointerDelayedTriggerByMhId:(id)arg1;	// IMP=0x000000000009f716
- (void)updateEndpointerThreshold:(float)arg1;	// IMP=0x000000000009f669
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x000000000009f663
- (id)init;	// IMP=0x000000000009ef80
