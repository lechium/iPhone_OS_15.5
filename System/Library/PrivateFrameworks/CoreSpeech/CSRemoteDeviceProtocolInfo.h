...
+ (id)localDeviceProtocolInfo;	// IMP=0x00000000000cbf08
+ (id)defaultProtocolInfo;	// IMP=0x00000000000cbebd
- (void).cxx_destruct;	// IMP=0x00000000000cc399
...
- (id)initWithXPCObject:(id)arg1;	// IMP=0x00000000000cc04d
- (id)initWithProtocolVersion:(unsigned long long)arg1 buildVersion:(id)arg2 deviceProductVersion:(id)arg3 deviceProductType:(id)arg4 deviceCategory:(unsigned long long)arg5;	// IMP=0x00000000000cbdf2
