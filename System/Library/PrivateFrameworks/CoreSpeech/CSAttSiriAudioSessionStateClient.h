...
- (void).cxx_destruct;	// IMP=0x00000000000ac780
...
- (void)dispatchStateChangedFrom:(unsigned long long)arg1 to:(unsigned long long)arg2;	// IMP=0x00000000000ac2ee
- (void)notifyObserver:(id)arg1 didChangeStateFrom:(unsigned long long)arg2 to:(unsigned long long)arg3;	// IMP=0x00000000000ac20e
- (void)notifyObserver:(id)arg1 didReceiveNotificationWithToken:(int)arg2;	// IMP=0x00000000000ac10c
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000abf99
