...
- (void)beepCancellerDidCancelSamples:(id)arg1 buffer:(id)arg2 timestamp:(unsigned long long)arg3;	// IMP=0x0000000000015429
- (void)zeroFilter:(id)arg1 zeroFilteredBufferAvailable:(id)arg2 atHostTime:(unsigned long long)arg3;	// IMP=0x0000000000015350
- (_Bool)_isNarrowBand:(float)arg1;	// IMP=0x000000000001531c
- (id)_fetchCurrentMetrics;	// IMP=0x0000000000015162
- (void)_reportMetrics;	// IMP=0x00000000000150e7
- (void)reportMetricsForSiriRequestWithUUID:(id)arg1;	// IMP=0x00000000000150e1
- (void)willBeepWithRecordRoute:(id)arg1 playbackRoute:(id)arg2;	// IMP=0x0000000000015081
- (void)flush;	// IMP=0x0000000000014f71
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2 arrivalTimestampToAudioRecorder:(unsigned long long)arg3;	// IMP=0x0000000000014d3d
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x0000000000014b05
- (id)initWithSampleRate:(float)arg1 withNumberOfChannels:(int)arg2;	// IMP=0x00000000000149cf
