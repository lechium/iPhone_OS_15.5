...
- (void).cxx_destruct;	// IMP=0x000000000009300b
...
- (void)updateIconLabelWithSettings:(id)arg1 imageParameters:(id)arg2;	// IMP=0x0000000000092d02
- (id)initWithSettings:(id)arg1;	// IMP=0x0000000000092cf0
