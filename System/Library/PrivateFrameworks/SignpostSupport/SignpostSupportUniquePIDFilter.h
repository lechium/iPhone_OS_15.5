...
- (void).cxx_destruct;	// IMP=0x00000000000077ef
@property(readonly, nonatomic) NSSet *uniquePidSet; // @synthesize uniquePidSet=_uniquePidSet;
- (void)addUniquePIDNumberSet:(id)arg1;	// IMP=0x0000000000007773
- (void)addUniquePIDNumber:(id)arg1;	// IMP=0x0000000000007701
- (_Bool)passesUniquePIDNumber:(id)arg1;	// IMP=0x00000000000076f9
- (id)init;	// IMP=0x0000000000007693
