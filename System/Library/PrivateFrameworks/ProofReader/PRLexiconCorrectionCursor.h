...
- (id)description;	// IMP=0x000000000006033c
- (void)dealloc;	// IMP=0x0000000000060302
- (id)initWithCursor:(struct _LXCursor *)arg1 replacementsCount:(unsigned long long)arg2 insertionsCount:(unsigned long long)arg3 deletionsCount:(unsigned long long)arg4 transpositionsCount:(unsigned long long)arg5 advancementLength:(unsigned long long)arg6;	// IMP=0x0000000000060282
