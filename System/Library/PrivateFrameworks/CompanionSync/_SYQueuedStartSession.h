...
{
    SYStartSyncSession *_request;	// 8 = 0x8
    CDUnknownBlockType _completion;	// 16 = 0x10
}

- (void).cxx_destruct;	// IMP=0x0000000000033997
...
- (id)initWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000338c9
