...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006526d
- (void)writeTo:(id)arg1;	// IMP=0x00000000000651f2
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000651e5
- (id)init;	// IMP=0x000000000006515e
