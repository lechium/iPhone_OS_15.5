...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000005308
- (void).cxx_destruct;	// IMP=0x00000000000053ab
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000517c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000050b8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004c3f
- (id)description;	// IMP=0x0000000000004a7b
- (id)init;	// IMP=0x00000000000049f2
