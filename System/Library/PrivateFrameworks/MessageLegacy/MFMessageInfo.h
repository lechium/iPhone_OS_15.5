...
+ (long long)newGenerationNumber;	// IMP=0x0000000000055811
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000055cde
- (id)_flagDescription;	// IMP=0x0000000000055b01
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000055932
- (long long)generationCompare:(id)arg1;	// IMP=0x0000000000055914
- (id)initWithUid:(unsigned int)arg1 mailboxID:(unsigned int)arg2 messageID:(long long)arg3 dateReceivedInterval:(unsigned int)arg4 dateSentInterval:(unsigned int)arg5 conversationHash:(long long)arg6 read:(_Bool)arg7 knownToHaveAttachments:(_Bool)arg8 flagged:(_Bool)arg9 isVIP:(_Bool)arg10;	// IMP=0x0000000000055871
- (id)init;	// IMP=0x0000000000055828
...
- (id)copyMessageInfo;	// IMP=0x0000000000055e37
