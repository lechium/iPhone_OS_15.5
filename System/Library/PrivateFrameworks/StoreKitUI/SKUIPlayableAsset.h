...
- (void).cxx_destruct;	// IMP=0x000000000001353b
...
- (id)initWithVideo:(id)arg1;	// IMP=0x0000000000013449
- (id)initWithVideoViewElement:(id)arg1 assetViewElement:(id)arg2;	// IMP=0x00000000000132c6
- (id)initWithContentURL:(id)arg1;	// IMP=0x000000000001326c
- (id)init;	// IMP=0x0000000000013226
