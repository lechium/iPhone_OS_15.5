...
- (void).cxx_destruct;	// IMP=0x0000000000304c2f
...
- (void)_positionBadge;	// IMP=0x00000000003049df
- (void)_setBadgeValue:(id)arg1;	// IMP=0x0000000000304824
- (void)tintColorDidChange;	// IMP=0x0000000000304420
- (void)layoutSubviews;	// IMP=0x0000000000304095
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000303d66
