...
- (void).cxx_destruct;	// IMP=0x000000000005a7ca
...
- (void)_reloadItemState;	// IMP=0x000000000005a2a5
- (id)_newDefaultLabel;	// IMP=0x000000000005a1d4
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000005a167
- (void)layoutSubviews;	// IMP=0x0000000000058cb3
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000058b88
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000057c41
