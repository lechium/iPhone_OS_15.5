...
- (void).cxx_destruct;	// IMP=0x00000000002947ad
...
- (id)description;	// IMP=0x00000000002946ea
- (void)_setLinkItem:(id)arg1;	// IMP=0x00000000002946d4
- (id)artworkForSize:(struct CGSize)arg1;	// IMP=0x000000000029462e
- (id)initWithComponentContext:(id)arg1;	// IMP=0x0000000000294357
