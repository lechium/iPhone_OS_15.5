...
- (void).cxx_destruct;	// IMP=0x00000000002a6f8a
...
- (void)_requestItems:(id)arg1 withReason:(long long)arg2;	// IMP=0x00000000002a6e12
- (id)_existingRequestIDForItemID:(id)arg1;	// IMP=0x00000000002a6c68
- (void)itemRequest:(id)arg1 didFinishWithItems:(id)arg2 invalidItemIdentifiers:(id)arg3;	// IMP=0x00000000002a6b75
- (void)loadItemsWithIdentifiers:(id)arg1 reason:(long long)arg2;	// IMP=0x00000000002a6859
- (void)loadItemsForPageComponent:(id)arg1 startIndex:(long long)arg2 reason:(long long)arg3;	// IMP=0x00000000002a6723
- (id)initWithResourceLoader:(id)arg1;	// IMP=0x00000000002a6683
- (id)init;	// IMP=0x00000000002a666f
