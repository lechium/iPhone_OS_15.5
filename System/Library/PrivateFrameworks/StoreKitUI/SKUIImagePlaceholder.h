...
- (void).cxx_destruct;	// IMP=0x00000000002fb91b
...
- (id)initWithBackgroundColor:(id)arg1 borderColor:(id)arg2 borderWidth:(double)arg3 cornerPathBlock:(CDUnknownBlockType)arg4;	// IMP=0x00000000002fb819
- (id)initWithBackgroundColor:(id)arg1 borderColor:(id)arg2 borderWidth:(double)arg3 cornerRadius:(double)arg4;	// IMP=0x00000000002fb72a
