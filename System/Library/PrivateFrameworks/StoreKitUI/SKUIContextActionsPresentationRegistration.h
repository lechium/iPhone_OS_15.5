...
- (void).cxx_destruct;	// IMP=0x00000000000dd90b
...
- (void)_presentFromGestureRecognizer:(id)arg1;	// IMP=0x00000000000dd629
- (void)longPressGestureRecognizerTriggered:(id)arg1;	// IMP=0x00000000000dd4ee
- (void)cleanupPreviewInteraction:(id)arg1;	// IMP=0x00000000000dd3c2
- (void)previewInteractionDidCancel:(id)arg1;	// IMP=0x00000000000dd320
- (void)previewInteraction:(id)arg1 didUpdatePreviewTransition:(double)arg2 ended:(_Bool)arg3;	// IMP=0x00000000000dd09b
- (_Bool)previewInteractionShouldBegin:(id)arg1;	// IMP=0x00000000000dbb1d
- (void)dealloc;	// IMP=0x00000000000dba94
- (id)initWithViewController:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000db9ed
