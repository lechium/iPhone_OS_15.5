...
- (void).cxx_destruct;	// IMP=0x00000000000b9128
...
- (void)_finishImageLoadWithImage:(id)arg1 error:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000000b904b
- (void)loadItemArtworkWithArtworkContext:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b8c9c
@property(readonly, nonatomic) SKUIGift *gift; // @synthesize gift=_gift;
- (void)finishGiftingWithResult:(_Bool)arg1;	// IMP=0x00000000000b8b81
- (id)initWithGift:(id)arg1 configuration:(id)arg2;	// IMP=0x00000000000b8ad3
