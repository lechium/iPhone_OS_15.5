...
- (void).cxx_destruct;	// IMP=0x000000000022a254
...
- (_Bool)isLoaded;	// IMP=0x000000000022a0cb
- (void)updateWithDictionary:(id)arg1;	// IMP=0x0000000000229ea0
- (id)initWithCountdownDictionary:(id)arg1;	// IMP=0x00000000002295d4
