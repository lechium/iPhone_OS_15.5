...
+ (id)_attributedStringForLabel:(id)arg1 context:(id)arg2;	// IMP=0x000000000037d061
+ (id)_attributedStringForButton:(id)arg1 context:(id)arg2;	// IMP=0x000000000037ceaa
+ (struct CGSize)sizeThatFitsWidth:(double)arg1 viewElement:(id)arg2 context:(id)arg3;	// IMP=0x000000000037877c
+ (void)requestLayoutForViewElement:(id)arg1 width:(double)arg2 context:(id)arg3;	// IMP=0x0000000000378429
+ (struct CGSize)preferredSizeForViewElement:(id)arg1 context:(id)arg2;	// IMP=0x0000000000378398
+ (_Bool)prefetchResourcesForViewElement:(id)arg1 reason:(long long)arg2 context:(id)arg3;	// IMP=0x000000000037825c
- (void).cxx_destruct;	// IMP=0x000000000037d5f5
...
- (_Bool)_shouldHideNoticesWithBuyButtonDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x000000000037d33d
- (void)_sendWillAnimate;	// IMP=0x000000000037d2e0
- (void)_showConfirmationAction:(id)arg1;	// IMP=0x000000000037cd2b
- (void)_cancelConfirmationAction:(id)arg1;	// IMP=0x000000000037ccb6
- (void)_buttonAction:(id)arg1;	// IMP=0x000000000037c723
- (void)itemOfferButtonWillAnimateTransition:(id)arg1;	// IMP=0x000000000037bf88
- (void)itemOfferButtonDidAnimateTransition:(id)arg1;	// IMP=0x000000000037bed8
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x000000000037bd23
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000037b663
- (void)layoutSubviews;	// IMP=0x000000000037a669
- (id)viewForElementIdentifier:(id)arg1;	// IMP=0x000000000037a661
- (void)setContentInset:(struct UIEdgeInsets)arg1;	// IMP=0x000000000037a64f
- (_Bool)updateWithItemState:(id)arg1 context:(id)arg2 animated:(_Bool)arg3;	// IMP=0x000000000037a29d
- (_Bool)setImage:(id)arg1 forArtworkRequest:(id)arg2 context:(id)arg3;	// IMP=0x000000000037a295
- (void)reloadWithViewElement:(id)arg1 width:(double)arg2 context:(id)arg3;	// IMP=0x00000000003791d2
@property(readonly, nonatomic) NSString *offerViewStateDescription;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000378066
