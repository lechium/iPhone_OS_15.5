...
- (void).cxx_destruct;	// IMP=0x000000000020e76a
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000020e350
- (void)layoutSubviews;	// IMP=0x000000000020e072
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000020df7a
