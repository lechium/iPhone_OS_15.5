...
- (void).cxx_destruct;	// IMP=0x00000000002eff57
...
- (void)_setLogoImage:(id)arg1 forCharity:(id)arg2;	// IMP=0x00000000002efc97
- (void)_setHeaderImage:(id)arg1 forTheme:(id)arg2;	// IMP=0x00000000002efa90
- (void)_loadThemeImages;	// IMP=0x00000000002ef637
- (void)_finishLoadAccountInfoWithResponse:(id)arg1 error:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000002ef475
- (void)_finishLoadWithResponse:(id)arg1 error:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000002ee394
- (void)removeObserver:(id)arg1;	// IMP=0x00000000002ee35c
- (id)logoImageForCharity:(id)arg1;	// IMP=0x00000000002ee2f9
- (void)loadLogoForCharity:(id)arg1;	// IMP=0x00000000002edfd4
- (void)loadConfigurationWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002edb4c
- (_Bool)loadCachedConfiguration;	// IMP=0x00000000002edb44
- (id)charityForIdentifier:(id)arg1;	// IMP=0x00000000002ed97f
- (void)addObserver:(id)arg1;	// IMP=0x00000000002ed8d8
- (id)initWithOperationQueue:(id)arg1 clientContext:(id)arg2;	// IMP=0x00000000002ed83f
