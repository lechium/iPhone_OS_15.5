...
- (void).cxx_destruct;	// IMP=0x00000000001ed1d1
...
- (void)layoutSubviews;	// IMP=0x00000000001ecf08
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000001ece00
- (id)description;	// IMP=0x00000000001ecd49
@property(readonly, nonatomic) UILabel *titleLabel;
- (void)setBackgroundImageAlpha:(double)arg1;	// IMP=0x00000000001ecad4
- (void)setBackgroundImage:(id)arg1;	// IMP=0x00000000001eca33
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001ec94f
