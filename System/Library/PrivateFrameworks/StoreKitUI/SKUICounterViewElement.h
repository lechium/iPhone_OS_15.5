...
- (void).cxx_destruct;	// IMP=0x0000000000155a38
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000155836
- (long long)currentNumberValue;	// IMP=0x000000000015571a
@property(readonly, nonatomic) SKUIImageViewElement *backgroundImageElement;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000001553e4
