...
+ (id)configurationWithTemplateElement:(id)arg1;	// IMP=0x00000000002c56e5
- (void).cxx_destruct;	// IMP=0x00000000002c5dcd
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002c5bb1
