...
- (void).cxx_destruct;	// IMP=0x00000000002b6284
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000002b6199
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000002b5efa
