...
- (void).cxx_destruct;	// IMP=0x000000000032ebd7
@property(nonatomic) struct UIEdgeInsets contentInsets; // @synthesize contentInsets=_contentInsets;
@property(copy, nonatomic) NSString *accessibilityLabel; // @synthesize accessibilityLabel=_accessibilityLabel;
- (void)setBackgroundColor:(id)arg1;	// IMP=0x000000000032eb04
- (void)layoutSubviews;	// IMP=0x000000000032e92f
- (void)setColoringWithColorScheme:(id)arg1;	// IMP=0x000000000032e8a8
@property(retain, nonatomic) UIImage *brickImage;
- (void)applyEditorialLayout:(id)arg1 orientation:(long long)arg2;	// IMP=0x000000000032e4bf
