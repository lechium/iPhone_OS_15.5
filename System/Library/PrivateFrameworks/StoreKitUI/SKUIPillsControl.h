...
- (void).cxx_destruct;	// IMP=0x000000000020df27
...
- (void)_segmentedControlAction:(id)arg1;	// IMP=0x000000000020de5b
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000020de3e
- (void)layoutSubviews;	// IMP=0x000000000020dd28
@property(nonatomic) long long selectedIndex;
@property(readonly, nonatomic) struct CGRect selectedPillFrame;
- (void)reloadPills;	// IMP=0x000000000020da11
- (void)dealloc;	// IMP=0x000000000020d9bd
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000020d872
