...
- (void).cxx_destruct;	// IMP=0x0000000000334824
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000033472c
- (id)HTTPBodyDictionary;	// IMP=0x0000000000334616
- (id)initWithAmountDictionary:(id)arg1;	// IMP=0x000000000033446b
