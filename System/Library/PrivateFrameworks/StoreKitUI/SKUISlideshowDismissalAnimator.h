...
- (void).cxx_destruct;	// IMP=0x00000000002d83eb
@property(nonatomic) struct CGRect imageRect; // @synthesize imageRect=_imageRect;
@property(retain, nonatomic) UIImageView *imageView; // @synthesize imageView=_imageView;
- (void)animationEnded:(_Bool)arg1;	// IMP=0x00000000002d839c
- (void)animateTransition:(id)arg1;	// IMP=0x00000000002d7eba
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000002d7eac
