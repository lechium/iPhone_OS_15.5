...
- (void).cxx_destruct;	// IMP=0x00000000002079c4
...
- (void)load;	// IMP=0x000000000020770d
- (void)_operationDidFinish:(id)arg1;	// IMP=0x00000000002074f5
- (void)_operation:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x000000000020745f
- (void)_operation:(id)arg1 didCompleteWithOutput:(id)arg2;	// IMP=0x0000000000207223
- (id)_operationWithURL:(id)arg1;	// IMP=0x0000000000206ede
- (id)initWithURLs:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000206d89
