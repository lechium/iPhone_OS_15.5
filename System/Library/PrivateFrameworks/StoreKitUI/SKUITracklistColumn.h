...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000af252
- (id)description;	// IMP=0x00000000000af1c7
- (void)setPreferredWidthForAttributedStrings:(id)arg1;	// IMP=0x00000000000aefca
