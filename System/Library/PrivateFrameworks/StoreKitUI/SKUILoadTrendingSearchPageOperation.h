...
- (void).cxx_destruct;	// IMP=0x000000000027f0cf
...
- (void)main;	// IMP=0x000000000027ebad
- (id)initWithClientContext:(id)arg1 pageURL:(id)arg2 outputBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000027ead3
