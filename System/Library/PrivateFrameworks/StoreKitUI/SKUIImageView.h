...
+ (Class)layerClass;	// IMP=0x0000000000129d57
- (void).cxx_destruct;	// IMP=0x000000000012a621
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000012a4d4
- (void)layoutSubviews;	// IMP=0x000000000012a32d
- (void)setContents:(id)arg1;	// IMP=0x000000000012a291
