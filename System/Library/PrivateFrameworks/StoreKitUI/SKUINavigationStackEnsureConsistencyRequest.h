...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001b9ac
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001b946
- (unsigned long long)hash;	// IMP=0x000000000001b92e
- (id)initWithNavigationControllerOperation:(long long)arg1 operationDidComplete:(_Bool)arg2;	// IMP=0x000000000001b8e6
