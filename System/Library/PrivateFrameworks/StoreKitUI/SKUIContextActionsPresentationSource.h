...
- (void).cxx_destruct;	// IMP=0x0000000000371923
...
- (void)presentViewController:(id)arg1 permittedArrowDirections:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x00000000003714b0
- (id)initWithViewController:(id)arg1;	// IMP=0x0000000000371445
