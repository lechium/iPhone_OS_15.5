...
+ (double)maximumHeightWithVisibleFields:(unsigned long long)arg1;	// IMP=0x000000000004cfa1
- (void).cxx_destruct;	// IMP=0x000000000004f437
...
- (void)_reloadUserRatingViews;	// IMP=0x000000000004efd3
- (id)_newDefaultLabel;	// IMP=0x000000000004eec9
- (id)_decimalNumberFormatter;	// IMP=0x000000000004ee5b
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000004eb5a
- (void)setBackgroundColor:(id)arg1;	// IMP=0x000000000004ea0f
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000004dd54
...
- (void)setColoringWithColorScheme:(id)arg1;	// IMP=0x000000000004d4d8
@property(copy, nonatomic) NSString *categoryString;
@property(copy, nonatomic) NSString *editorialBadgeString;
@property(copy, nonatomic) NSString *artistName;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004cf3f
