...
- (void).cxx_destruct;	// IMP=0x00000000001a6182
...
- (void)_updateTopHairlineColor;	// IMP=0x00000000001a60ac
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000001a5be6
- (void)layoutSubviews;	// IMP=0x00000000001a5970
