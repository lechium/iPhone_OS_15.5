...
- (void).cxx_destruct;	// IMP=0x000000000028691d
...
- (id)_resourceImageForImageElement:(id)arg1;	// IMP=0x00000000002867a1
- (id)contextActions;	// IMP=0x00000000002863f8
- (id)initWithDialogTemplate:(id)arg1;	// IMP=0x000000000028638d
