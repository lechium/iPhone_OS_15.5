...
- (void).cxx_destruct;	// IMP=0x000000000005f799
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000005f5e4
- (void)setBackgroundColor:(id)arg1;	// IMP=0x000000000005f44f
- (void)layoutSubviews;	// IMP=0x000000000005f0ef
- (id)initWithDeveloperInfo:(id)arg1 clientContext:(id)arg2;	// IMP=0x000000000005e6a3
