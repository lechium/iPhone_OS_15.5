...
- (void).cxx_destruct;	// IMP=0x00000000000e1162
...
- (void)_buttonAction:(id)arg1;	// IMP=0x00000000000e1020
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000e0ff3
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000000e0f81
@property(nonatomic) struct UIEdgeInsets contentInset;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000e0bb8
