...
- (void).cxx_destruct;	// IMP=0x00000000003113fb
...
- (_Bool)canPerformLocalActionWithItemState:(id)arg1;	// IMP=0x00000000003112df
- (_Bool)canPersonalizeUsingItemState:(id)arg1;	// IMP=0x00000000003111a5
