...
+ (id)_fixCropRect:(id)arg1 forOriginalImage:(id)arg2;	// IMP=0x000000000022cef6
- (void).cxx_destruct;	// IMP=0x000000000022d862
@property(nonatomic) __weak id <SKUIProfileImagePickerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_showImageSourcePicker;	// IMP=0x000000000022d4ca
- (void)_showImagePicker;	// IMP=0x000000000022d39a
- (void)_presentImagePickerWithSourceType:(long long)arg1;	// IMP=0x000000000022d15b
- (void)_didCancel;	// IMP=0x000000000022d0d1
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000022cea4
- (void)loadView;	// IMP=0x000000000022ce1e
- (void)imagePickerController:(id)arg1 didFinishPickingMediaWithInfo:(id)arg2;	// IMP=0x000000000022ccce
- (void)imagePickerControllerDidCancel:(id)arg1;	// IMP=0x000000000022cc99
- (id)initWithClientContext:(id)arg1;	// IMP=0x000000000022cc0b
