...
+ (id)supportedFeatures;	// IMP=0x0000000000292213
+ (_Bool)isTextInputType:(id)arg1;	// IMP=0x0000000000292168
- (void).cxx_destruct;	// IMP=0x0000000000292370
...
- (unsigned long long)elementType;	// IMP=0x0000000000292322
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x000000000029227a
@property(readonly, nonatomic) SKUIAnimatorDOMFeature *animationInterface;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000291f6b
