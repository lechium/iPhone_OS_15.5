...
- (void).cxx_destruct;	// IMP=0x00000000002b4180
...
- (void)_addSelectedViewController;	// IMP=0x00000000002b3f90
- (void)layoutSubviews;	// IMP=0x00000000002b3ed0
- (void)setSelectedViewControllerIndex:(long long)arg1;	// IMP=0x00000000002b3e17
