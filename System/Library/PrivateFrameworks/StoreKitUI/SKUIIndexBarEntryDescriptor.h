...
+ (id)placeholderEntryDescriptorWithSize:(struct CGSize)arg1;	// IMP=0x000000000006f549
+ (id)entryDescriptorWithImage:(id)arg1;	// IMP=0x000000000006f4dd
+ (id)entryDescriptorWithAttributedString:(id)arg1;	// IMP=0x000000000006f471
+ (id)entryDescriptorWithArtwork:(id)arg1;	// IMP=0x000000000006f405
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006f322
- (unsigned long long)hash;	// IMP=0x000000000006f265
