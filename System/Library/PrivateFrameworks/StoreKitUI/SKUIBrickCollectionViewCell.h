...
- (void).cxx_destruct;	// IMP=0x000000000013a2d8
...
- (void)_removeOverlay;	// IMP=0x000000000013a207
- (void)_reloadHighlight;	// IMP=0x0000000000139f93
- (void)layoutSubviews;	// IMP=0x0000000000139e26
- (void)setBackgroundColor:(id)arg1;	// IMP=0x0000000000139d98
@property(copy, nonatomic) NSString *title;
@property(retain, nonatomic) UIImage *itemImage;
- (void)setSelected:(_Bool)arg1;	// IMP=0x00000000001398e3
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000001398a2
@property(retain, nonatomic) SKUICountdown *countdown;
- (void)setColoringWithColorScheme:(id)arg1;	// IMP=0x00000000001396e5
