...
- (void).cxx_destruct;	// IMP=0x00000000001ea3cc
...
- (id)tableViewCellForTableView:(id)arg1 indexPath:(id)arg2;	// IMP=0x00000000001ea0bf
- (id)selectionActionForTableView:(id)arg1 indexPath:(id)arg2;	// IMP=0x00000000001ea01d
- (long long)numberOfRowsInSection;	// IMP=0x00000000001ea012
- (double)heightForCellInTableView:(id)arg1 indexPath:(id)arg2;	// IMP=0x00000000001e9f9a
- (id)initWithClientContext:(id)arg1;	// IMP=0x00000000001e9f2c
