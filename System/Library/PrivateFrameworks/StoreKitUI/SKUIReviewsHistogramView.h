...
- (void).cxx_destruct;	// IMP=0x00000000001fde38
...
- (id)_countLabelString;	// IMP=0x00000000001fdb0c
- (id)_histogramImageForValues:(id)arg1;	// IMP=0x00000000001fd12a
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001fcfc9
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001fcf13
- (void)layoutSubviews;	// IMP=0x00000000001fc556
...
- (id)initWithClientContext:(id)arg1;	// IMP=0x00000000001fae3f
