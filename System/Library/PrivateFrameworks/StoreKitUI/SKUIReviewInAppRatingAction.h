...
+ (id)actionWithCustomContentViewController:(id)arg1;	// IMP=0x00000000002d4fbf
- (void).cxx_destruct;	// IMP=0x00000000002d5193
...
- (void)setCustomEnabledState:(_Bool)arg1;	// IMP=0x00000000002d5075
- (void)setEnabled:(_Bool)arg1;	// IMP=0x00000000002d502a
