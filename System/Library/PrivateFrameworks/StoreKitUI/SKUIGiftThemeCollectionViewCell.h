...
- (void).cxx_destruct;	// IMP=0x000000000009f147
...
- (void)_setSenderName:(id)arg1;	// IMP=0x000000000009ec1b
- (void)_setPrice:(id)arg1;	// IMP=0x000000000009e9ea
- (void)_setMessage:(id)arg1;	// IMP=0x000000000009e7ba
- (void)_setHeaderImage:(id)arg1;	// IMP=0x000000000009e680
- (void)_reloadItemView;	// IMP=0x000000000009e47e
- (id)_itemView;	// IMP=0x000000000009e396
- (void)setBackgroundColor:(id)arg1;	// IMP=0x000000000009e2f8
- (void)layoutSubviews;	// IMP=0x000000000009dbc7
@property(retain, nonatomic) UIImage *itemImage;
- (void)reloadThemeHeaderImage;	// IMP=0x000000000009d5f0
