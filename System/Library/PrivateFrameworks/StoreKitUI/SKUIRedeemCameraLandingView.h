...
- (void).cxx_destruct;	// IMP=0x00000000002e2757
@property(nonatomic) long long spacingStyle; // @synthesize spacingStyle=_spacingStyle;
@property(readonly, nonatomic) UIButton *button; // @synthesize button=_button;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002e245c
- (void)layoutSubviews;	// IMP=0x00000000002e1e1e
@property(retain, nonatomic) UIImage *image;
- (id)initWithClientContext:(id)arg1;	// IMP=0x00000000002e169f
