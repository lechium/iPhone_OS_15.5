...
- (void).cxx_destruct;	// IMP=0x0000000000073c3a
...
- (void)artworkRequest:(id)arg1 didLoadImage:(id)arg2;	// IMP=0x00000000000739aa
- (id)loadDataRepresentationForTypeIdentifier:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000007388f
- (id)initWithURL:(id)arg1 usingResourceLoader:(id)arg2;	// IMP=0x00000000000736be
