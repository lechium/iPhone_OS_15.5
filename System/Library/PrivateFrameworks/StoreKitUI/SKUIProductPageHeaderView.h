...
- (void).cxx_destruct;	// IMP=0x00000000001b8f3d
...
- (void)_getBottomLayoutProperties:(struct **)arg1 origins:(double **)arg2 height:(double *)arg3 forWidth:(double)arg4;	// IMP=0x00000000001b8d2a
- (void)_getTopLayoutProperties:(struct **)arg1 origins:(double **)arg2 height:(double *)arg3 forWidth:(double)arg4;	// IMP=0x00000000001b8af1
- (void)_reloadItemOfferButton:(_Bool)arg1;	// IMP=0x00000000001b88d7
- (void)_finishButtonAnimation;	// IMP=0x00000000001b8883
- (void)_showConfirmationAction:(id)arg1;	// IMP=0x00000000001b8836
- (void)_cancelConfirmationAction:(id)arg1;	// IMP=0x00000000001b87ec
- (void)contentRatingArtworkLoader:(id)arg1 didLoadImage:(id)arg2 forContentRating:(id)arg3;	// IMP=0x00000000001b8729
- (void)itemOfferButtonWillAnimateTransition:(id)arg1;	// IMP=0x00000000001b8484
- (void)itemOfferButtonDidAnimateTransition:(id)arg1;	// IMP=0x00000000001b8472
- (void)sizeToFit;	// IMP=0x00000000001b803e
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001b7dbb
- (void)layoutSubviews;	// IMP=0x00000000001b6f42
@property(copy, nonatomic) NSString *title;
- (void)setItemState:(id)arg1 animated:(_Bool)arg2;	// IMP=0x00000000001b65f5
...
- (id)contentRatingName;	// IMP=0x00000000001b4df7
- (void)dealloc;	// IMP=0x00000000001b4d2b
- (id)initWithClientContext:(id)arg1;	// IMP=0x00000000001b4b69
