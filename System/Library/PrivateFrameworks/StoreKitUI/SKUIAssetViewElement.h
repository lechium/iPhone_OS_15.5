...
- (void).cxx_destruct;	// IMP=0x00000000003546a3
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000354474
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000003540f9
