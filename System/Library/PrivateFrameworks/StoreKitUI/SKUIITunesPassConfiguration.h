...
- (void).cxx_destruct;	// IMP=0x00000000001c2c71
...
- (id)learnMoreAlertView;	// IMP=0x00000000001c2bd4
- (id)initWithITunesPassDictionary:(id)arg1 clientContext:(id)arg2;	// IMP=0x00000000001c20be
