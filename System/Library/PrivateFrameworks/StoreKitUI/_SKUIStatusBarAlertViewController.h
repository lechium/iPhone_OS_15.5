...
- (void).cxx_destruct;	// IMP=0x00000000002b0422
...
- (void)handleLabelTap:(id)arg1;	// IMP=0x00000000002b0134
- (void)endAllAnimations;	// IMP=0x00000000002b00ec
- (void)updateLabelFrame;	// IMP=0x00000000002aff49
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x00000000002afe6a
- (void)viewDidLoad;	// IMP=0x00000000002afc1a
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000002afbb6
