...
- (void).cxx_destruct;	// IMP=0x00000000000a8ebe
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a8d27
- (id)description;	// IMP=0x00000000000a8c95
- (id)initWithThemeDictionary:(id)arg1;	// IMP=0x00000000000a89a2
