...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000fe3ab
- (void).cxx_destruct;	// IMP=0x00000000000fe9f2
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000fe6de
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000fe3b3
- (id)init;	// IMP=0x00000000000fe357
