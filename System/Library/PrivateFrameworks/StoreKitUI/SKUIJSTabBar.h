...
- (void).cxx_destruct;	// IMP=0x00000000003061d2
...
- (id)_selectedTabBarItemForIndex:(long long)arg1;	// IMP=0x000000000030612a
- (void)_reloadTabBarItemsWithPreludeMainThreadWork:(CDUnknownBlockType)arg1;	// IMP=0x0000000000305a63
@property(retain, nonatomic) SKUIJSTabBarItem *selectedTab;
- (void)sendOnUpdateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000030557b
- (void)sendOnUpdate;	// IMP=0x00000000003054b6
- (void)sendOnNeedsContentForTabBarItem:(id)arg1;	// IMP=0x000000000030513e
- (id)initWithAppContext:(id)arg1 controller:(id)arg2;	// IMP=0x000000000030507d
