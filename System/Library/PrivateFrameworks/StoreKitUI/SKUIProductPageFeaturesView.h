...
- (void).cxx_destruct;	// IMP=0x00000000001b3eb4
...
- (id)_gameCenterStringWithFeatures:(unsigned long long)arg1;	// IMP=0x00000000001b375d
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001b352a
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001b338c
- (void)layoutSubviews;	// IMP=0x00000000001b2f03
@property(copy, nonatomic) NSString *title;
- (void)setFeatures:(long long)arg1 gameCenterFeatures:(unsigned long long)arg2;	// IMP=0x00000000001b25d6
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001b2490
