...
+ (id)featureName;	// IMP=0x00000000000cd4a6
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x00000000000cd40f
- (void).cxx_destruct;	// IMP=0x00000000000cd634
...
- (void)setEditing:(_Bool)arg1 options:(id)arg2;	// IMP=0x00000000000cd4b3
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x00000000000cd33f
