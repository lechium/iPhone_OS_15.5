...
- (void).cxx_destruct;	// IMP=0x0000000000338b24
...
- (void)updateBackgroundImage;	// IMP=0x0000000000338a3c
- (void)_setIsContainedInPopover:(_Bool)arg1;	// IMP=0x0000000000338a36
- (void)_setFrame:(struct CGRect)arg1 forceUpdateBackgroundImage:(_Bool)arg2;	// IMP=0x0000000000338a24
- (id)_currentCustomBackgroundRespectOversize_legacy:(_Bool *)arg1;	// IMP=0x0000000000338a1c
- (id)_currentCustomBackground;	// IMP=0x0000000000338a14
- (void)layoutSubviews;	// IMP=0x00000000003388fb
@property(copy, nonatomic) NSString *backdropGroupName;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000338680
