...
- (void).cxx_destruct;	// IMP=0x00000000001b4b16
@property(retain, nonatomic) SKUIColorScheme *colorScheme; // @synthesize colorScheme=_colorScheme;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001b4a04
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001b4962
- (void)layoutSubviews;	// IMP=0x00000000001b474b
