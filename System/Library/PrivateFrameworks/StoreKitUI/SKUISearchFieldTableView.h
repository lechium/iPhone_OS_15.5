...
- (void).cxx_destruct;	// IMP=0x0000000000209ea1
...
- (void)_reloadView;	// IMP=0x0000000000209cc0
- (void)_setTrendingResponse:(id)arg1 error:(id)arg2;	// IMP=0x0000000000209c6a
- (void)_reloadData;	// IMP=0x0000000000209a92
- (void)layoutSubviews;	// IMP=0x0000000000209a02
