...
- (void).cxx_destruct;	// IMP=0x00000000002fec7b
...
- (void)layoutSubviews;	// IMP=0x00000000002fe66e
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000002fe5ba
@property(nonatomic) double progress;
@property(retain, nonatomic) UIImage *image;
- (id)init;	// IMP=0x00000000002fdd53
