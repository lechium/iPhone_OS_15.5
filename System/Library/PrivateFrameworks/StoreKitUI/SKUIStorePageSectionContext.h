...
- (void)_setTextLayoutCache:(id)arg1;	// IMP=0x00000000000e3fd7
- (void)_setResourceLoader:(id)arg1;	// IMP=0x00000000000e3f8c
- (void)_setPortraitPageWidth:(double)arg1;	// IMP=0x00000000000e3f81
- (void)_setParentViewController:(id)arg1;	// IMP=0x00000000000e3f4e
- (void)_setMetricsController:(id)arg1;	// IMP=0x00000000000e3f03
- (void)_setLayoutStyle:(long long)arg1;	// IMP=0x00000000000e3ef9
- (void)_setLandscapePageWidth:(double)arg1;	// IMP=0x00000000000e3eee
- (void)_setDefaultPinningTransitionStyle:(long long)arg1;	// IMP=0x00000000000e3ee4
- (void)_setColorScheme:(id)arg1;	// IMP=0x00000000000e3e87
- (void)_setCollectionView:(id)arg1;	// IMP=0x00000000000e3e2a
- (void)_setActivePageWidth:(double)arg1;	// IMP=0x00000000000e3e0d
- (void)_setActiveMetricsImpressionSession:(id)arg1;	// IMP=0x00000000000e3dfc
...
- (id)init;	// IMP=0x00000000000e3aa0
