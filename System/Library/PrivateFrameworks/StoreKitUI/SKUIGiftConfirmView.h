...
- (void).cxx_destruct;	// IMP=0x00000000000ad60f
- (id)_termsButton;	// IMP=0x00000000000ad36b
- (id)_newLightLabelWithSize:(double)arg1 alpha:(double)arg2;	// IMP=0x00000000000ad251
- (id)_newBoldLabelWithSize:(double)arg1;	// IMP=0x00000000000ad163
- (void)layoutSubviews;	// IMP=0x00000000000ab8f3
@property(readonly, nonatomic) UIButton *termsButton;
- (id)initWithGift:(id)arg1 configuration:(id)arg2;	// IMP=0x00000000000aa521
