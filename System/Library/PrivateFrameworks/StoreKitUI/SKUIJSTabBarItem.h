...
- (void).cxx_destruct;	// IMP=0x00000000002e2eb5
...
- (void)dealloc;	// IMP=0x00000000002e29da
- (id)initWithAppContext:(id)arg1 navigationController:(id)arg2 tabBarItem:(id)arg3 owner:(id)arg4;	// IMP=0x00000000002e27aa
