...
- (void).cxx_destruct;	// IMP=0x000000000002955d
...
- (long long)pageComponentType;	// IMP=0x00000000000294fd
- (unsigned long long)elementType;	// IMP=0x00000000000294f2
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000029398
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000029237
