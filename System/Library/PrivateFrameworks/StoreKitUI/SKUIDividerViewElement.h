...
- (void).cxx_destruct;	// IMP=0x0000000000226efa
...
- (long long)pageComponentType;	// IMP=0x0000000000226dcd
- (_Bool)isEnabled;	// IMP=0x0000000000226db8
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000226ccf
