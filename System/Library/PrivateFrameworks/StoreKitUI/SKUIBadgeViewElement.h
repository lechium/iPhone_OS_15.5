...
- (void).cxx_destruct;	// IMP=0x000000000008220e
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000081d22
- (id)accessibilityText;	// IMP=0x0000000000081ca6
@property(readonly, nonatomic) long long badgeType;
@property(readonly, nonatomic) NSAttributedString *attributedString;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x000000000008177a
