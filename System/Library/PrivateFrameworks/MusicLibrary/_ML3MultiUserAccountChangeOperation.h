...
- (void).cxx_destruct;	// IMP=0x00000000000b625a
...
- (void)execute;	// IMP=0x00000000000b60fa
- (id)initWithDatabasePath:(id)arg1 accountChangeObserver:(id)arg2;	// IMP=0x00000000000b604c
