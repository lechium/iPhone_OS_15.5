...
- (void).cxx_destruct;	// IMP=0x00000000001a19aa
...
- (_Bool)_onQueueFlushAndWait:(_Bool)arg1;	// IMP=0x00000000001a1619
- (_Bool)flushAndWait:(_Bool)arg1;	// IMP=0x00000000001a1588
- (_Bool)enqueueStatement:(id)arg1;	// IMP=0x00000000001a13e7
- (void)dealloc;	// IMP=0x00000000001a13a4
- (id)init;	// IMP=0x00000000001a1362
- (id)initWithConnection:(id)arg1;	// IMP=0x00000000001a1228
