...
- (void).cxx_destruct;	// IMP=0x000000000008e477
- (id)nextObject;	// IMP=0x000000000008e278
- (id)initWithDirtyInsertsEnumerator:(id)arg1 connection:(id)arg2;	// IMP=0x000000000008e1d6
