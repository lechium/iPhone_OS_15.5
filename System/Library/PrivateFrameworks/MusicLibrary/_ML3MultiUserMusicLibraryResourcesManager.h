...
- (void).cxx_destruct;	// IMP=0x00000000001a594e
...
- (void)terminateForFailureToPerformDatabasePathChange;	// IMP=0x00000000001a58fe
- (void)emergencyDisconnectWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000001a57fd
- (void)performDatabasePathChange:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000001a5705
...
- (id)libraryContainerPath;	// IMP=0x00000000001a51a0
- (id)initWithLibraryResourcesService:(id)arg1;	// IMP=0x00000000001a50ce
