...
{
    _HKMedicalIDData *_cloudMedicalIDData;	// 8 = 0x8
    _HKMedicalIDData *_medicalIDDataToPush;	// 16 = 0x10
    HDCloudSyncMedicalIDRecord *_medicalIDRecord;	// 24 = 0x18
}

- (void).cxx_destruct;	// IMP=0x0000000000347aca
...
- (void)main;	// IMP=0x0000000000346ddc
