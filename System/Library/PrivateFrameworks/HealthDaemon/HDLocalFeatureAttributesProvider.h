...
{
    HKFeatureAttributes *_localFeatureAttributes;	// 8 = 0x8
}

- (void).cxx_destruct;	// IMP=0x000000000029292b
@property(readonly, copy, nonatomic) HKPairedFeatureAttributes *currentPairedFeatureAttributes;
- (id)initWithLocalFeatureAttributes:(id)arg1;	// IMP=0x000000000029287f
