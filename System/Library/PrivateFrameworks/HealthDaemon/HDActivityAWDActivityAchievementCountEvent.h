...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000037f599
- (unsigned long long)hash;	// IMP=0x000000000037f4fe
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000037f3ce
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000037f304
- (void)copyTo:(id)arg1;	// IMP=0x000000000037f25d
- (void)writeTo:(id)arg1;	// IMP=0x000000000037f18d
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000037f180
- (id)dictionaryRepresentation;	// IMP=0x000000000037ea32
- (id)description;	// IMP=0x000000000037e983
- (int)StringAsTotalOTAAchievementViewedCount:(id)arg1;	// IMP=0x000000000037e8d4
- (id)totalOTAAchievementViewedCountAsString:(int)arg1;	// IMP=0x000000000037e855
...
- (int)StringAsTotalOTAAchievementCount:(id)arg1;	// IMP=0x000000000037e73c
- (id)totalOTAAchievementCountAsString:(int)arg1;	// IMP=0x000000000037e6bc
...
- (int)StringAsTotalAchievementCount:(id)arg1;	// IMP=0x000000000037e558
- (id)totalAchievementCountAsString:(int)arg1;	// IMP=0x000000000037e4da
