...
@interface AVTPresetResourcesLoadingTask : NSObject <AVTPreloadingTask>
{
    ...
    NSArray *_presetResources;	// 24 = 0x18
}

- (void).cxx_destruct;	// IMP=0x000000000006c7cd
...
- (void)cancel;	// IMP=0x000000000006c78e
- (id)initWithPresetResources:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000006c6e3
