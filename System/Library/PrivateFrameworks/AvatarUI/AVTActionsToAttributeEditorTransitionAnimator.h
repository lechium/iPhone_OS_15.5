...
+ (struct UIEdgeInsets)adjustedSafeAreaInsetsForView:(id)arg1;	// IMP=0x0000000000036874
- (void).cxx_destruct;	// IMP=0x0000000000037754
...
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000000376cd
- (void)animateTransition:(id)arg1;	// IMP=0x000000000003698c
- (id)initWithAVTViewLayoutInfo:(id)arg1 userInfoViewHeight:(double)arg2 RTL:(_Bool)arg3 environment:(id)arg4;	// IMP=0x00000000000368d9
