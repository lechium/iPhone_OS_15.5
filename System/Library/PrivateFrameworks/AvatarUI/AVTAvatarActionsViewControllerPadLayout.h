...
+ (double)heightForButtonsViewWithButtonCount:(long long)arg1;	// IMP=0x00000000000845de
+ (double)buttonHeight;	// IMP=0x000000000008455c
- (void).cxx_destruct;	// IMP=0x0000000000084b86
...
- (struct CGRect)actionButtonsViewFrameForButtonCount:(long long)arg1;	// IMP=0x00000000000846d3
@property(readonly, nonatomic) double actionButtonsViewAlpha;
- (id)initWithContainerSize:(struct CGSize)arg1 insets:(struct UIEdgeInsets)arg2 buttonCount:(long long)arg3 avtViewLayoutInfo:(id)arg4;	// IMP=0x000000000008461e
