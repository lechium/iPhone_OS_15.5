...
- (void).cxx_destruct;	// IMP=0x0000000000004333
...
- (id)_gzipCompressData:(id)arg1;	// IMP=0x000000000000412c
@property(readonly, nonatomic) NSData *gzipContent;
@property(readonly, nonatomic) NSString *mimeType;
- (id)initWithContent:(id)arg1 filename:(id)arg2 bucket:(id)arg3 gzip:(_Bool)arg4;	// IMP=0x0000000000003fa9
