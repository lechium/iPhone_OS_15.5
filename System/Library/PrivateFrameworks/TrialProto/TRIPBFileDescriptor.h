...
- (void)dealloc;	// IMP=0x0000000000019be8
- (id)initWithPackage:(id)arg1 syntax:(unsigned char)arg2;	// IMP=0x0000000000019b86
- (id)initWithPackage:(id)arg1 objcPrefix:(id)arg2 syntax:(unsigned char)arg3;	// IMP=0x0000000000019b05
