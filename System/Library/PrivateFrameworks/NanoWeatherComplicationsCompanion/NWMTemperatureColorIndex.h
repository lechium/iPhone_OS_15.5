...
+ (id)allIndices;	// IMP=0x000000000001218b
+ (id)indexWithTemperature:(id)arg1 color:(id)arg2;	// IMP=0x0000000000012079
...
- (id)initWithTemperature:(id)arg1 color:(id)arg2;	// IMP=0x00000000000120e9
