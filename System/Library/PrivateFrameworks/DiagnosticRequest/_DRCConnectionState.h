...
+ (id)sharedConnectionState;	// IMP=0x000000000000a494
...
- (id)sendMessageWithReplySync:(id)arg1;	// IMP=0x000000000000abbb
- (_Bool)sendMessage:(id)arg1;	// IMP=0x000000000000aa4e
- (id)init;	// IMP=0x000000000000a561
- (void)cleanupState;	// IMP=0x000000000000a4e9
