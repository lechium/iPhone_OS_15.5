...
+ (id)sharedConnectionState;	// IMP=0x0000000000000d10
- (void).cxx_destruct;	// IMP=0x0000000000001587
...
- (id)sendMessageWithReplySync:(id)arg1;	// IMP=0x00000000000013b4
- (_Bool)sendMessage:(id)arg1;	// IMP=0x0000000000001247
- (id)init;	// IMP=0x0000000000000ddd
- (void)cleanupState;	// IMP=0x0000000000000d65
