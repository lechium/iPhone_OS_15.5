...
@interface ContinuousReadingPreviewView : UIView
{
    ...
    SFBannerTheme *_bannerTheme;	// 24 = 0x18
...
- (void).cxx_destruct;	// IMP=0x00000000001cc5aa
...
- (void)_layOutContentView;	// IMP=0x00000000001cc254
- (void)_layOutHeader;	// IMP=0x00000000001cc02e
- (void)layoutSubviews;	// IMP=0x00000000001cbf54
- (void)setBannerTheme:(id)arg1 animated:(_Bool)arg2;	// IMP=0x00000000001cbcd0
- (void)replaceContentViewWithItsSnapshot;	// IMP=0x00000000001cbbdf
@property(readonly, nonatomic) _Bool canShowContentView;
@property(readonly, nonatomic) double rubberBandingHeight;
@property(readonly, nonatomic) double headerHeight;
- (id)initWithContinuousReadingItem:(id)arg1 previewingNextDocument:(_Bool)arg2;	// IMP=0x00000000001cb13a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001cb12c
