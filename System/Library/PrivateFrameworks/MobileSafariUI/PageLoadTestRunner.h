...
+ (CDStruct_81cc75c8)heapStatistics;	// IMP=0x00000000000b15fe
+ (id)worldLeaksString;	// IMP=0x00000000000b1384
+ (_Bool)closingBrowserWindowsForWorldLeakTest;	// IMP=0x00000000000b1376
+ (void)addLeakToArray:(id)arg1 count:(int)arg2 name:(id)arg3;	// IMP=0x00000000000b12cc
- (void).cxx_destruct;	// IMP=0x00000000000b1853
...
- (_Bool)checkForWorldLeaksNow;	// IMP=0x00000000000b15c3
- (void)checkForWorldLeaksSoon;	// IMP=0x00000000000b159d
- (void)closeBrowserWindowsAndFinishCheckingForWorldLeaks;	// IMP=0x00000000000b1553
- (_Bool)finishCheckingForWorldLeaks;	// IMP=0x00000000000b1518
- (void)closeBrowserWindows;	// IMP=0x00000000000b137e
- (void)clearCacheWithURL:(id)arg1;	// IMP=0x00000000000b1275
- (void)log:(id)arg1;	// IMP=0x00000000000b10ef
- (void)finishedTestPage:(id)arg1;	// IMP=0x00000000000b1056
- (void)startingTestPage:(id)arg1;	// IMP=0x00000000000b1015
- (void)finishedTestRunner;	// IMP=0x00000000000b0fb7
- (void)finishedTestRunnerIteration;	// IMP=0x00000000000b0f93
- (void)startingTestRunner;	// IMP=0x00000000000b0f78
- (void)_handleActionTimer:(id)arg1;	// IMP=0x00000000000b0eac
- (_Bool)performActionForPage:(id)arg1;	// IMP=0x00000000000b0ea4
- (_Bool)startPageAction:(id)arg1;	// IMP=0x00000000000b0d5a
- (void)finishPage:(id)arg1 stats:(id)arg2 error:(id)arg3;	// IMP=0x00000000000b0aa9
- (void)_updatePageLoad:(id)arg1 stats:(id)arg2;	// IMP=0x00000000000b084f
- (void)_checkRedirect:(id)arg1;	// IMP=0x00000000000b0758
- (void)_pageRestExpired:(id)arg1;	// IMP=0x00000000000b06e3
- (void)_pageTimeoutExpired:(id)arg1;	// IMP=0x00000000000b0591
- (id)_pageLoadForTabDocument:(id)arg1;	// IMP=0x00000000000b0409
- (void)finish;	// IMP=0x00000000000b017a
- (void)_startNextPageNow;	// IMP=0x00000000000af9b4
- (void)startNextPage;	// IMP=0x00000000000af93f
- (void)start;	// IMP=0x00000000000af034
- (_Bool)loadTestSuiteFile:(id)arg1;	// IMP=0x00000000000ae375
- (void)removeURLsInRange:(struct _NSRange)arg1;	// IMP=0x00000000000ae297
- (void)addPageURL:(id)arg1 withProcessSwap:(_Bool)arg2;	// IMP=0x00000000000ae1ae
- (void)setTestOptions:(id)arg1;	// IMP=0x00000000000addce
- (void)setExistingProperty:(id)arg1 to:(id)arg2;	// IMP=0x00000000000adcc0
- (void)_closeLogStream;	// IMP=0x00000000000adc82
- (void)dealloc;	// IMP=0x00000000000adc44
- (id)initWithTestName:(id)arg1 browserController:(id)arg2;	// IMP=0x00000000000adaf8
