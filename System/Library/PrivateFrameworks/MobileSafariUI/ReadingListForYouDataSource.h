...
- (void).cxx_destruct;	// IMP=0x000000000009a1b3
- (void)_readingListContentsDidChange:(id)arg1;	// IMP=0x000000000009a19c
- (void)retrieveRecommendationsMatchingTopic:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000099907
- (void)dealloc;	// IMP=0x0000000000099892
- (id)initWithBookmarkProvider:(id)arg1 accessQueue:(id)arg2 imageCache:(id)arg3;	// IMP=0x000000000009970c
