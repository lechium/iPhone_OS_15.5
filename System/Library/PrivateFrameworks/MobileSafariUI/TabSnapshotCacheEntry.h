...
- (void).cxx_destruct;	// IMP=0x00000000001d857e
...
- (id)debugDescription;	// IMP=0x00000000001d83a4
- (id)initWithIdentifier:(id)arg1 isGroup:(_Bool)arg2;	// IMP=0x00000000001d82e4
