...
- (void).cxx_destruct;	// IMP=0x00000000000e243a
...
- (id)description;	// IMP=0x00000000000e2369
- (id)init;	// IMP=0x00000000000e235b
- (id)initWithDescription:(id)arg1 dateAfterWhichDataShouldBeClearedBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000e2293
