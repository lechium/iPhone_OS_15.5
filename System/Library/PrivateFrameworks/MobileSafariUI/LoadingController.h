...
- (void).cxx_destruct;	// IMP=0x00000000000a9783
@property(nonatomic) __weak id <LoadingControllerDelegate> delegate; // @synthesize delegate=_delegate;
@property(retain, nonatomic) WKWebView *webView; // @synthesize webView=_webView;
- (void)stopLoading;	// IMP=0x00000000000a972b
- (void)reloadFromOrigin:(_Bool)arg1;	// IMP=0x00000000000a96be
- (void)goForward;	// IMP=0x00000000000a9664
- (void)goBack;	// IMP=0x00000000000a960a
- (id)loadRequest:(id)arg1 userDriven:(_Bool)arg2 shouldOpenExternalURLs:(_Bool)arg3 eventAttribution:(id)arg4;	// IMP=0x00000000000a93bb
- (id)loadRequest:(id)arg1 userDriven:(_Bool)arg2 shouldOpenExternalURLs:(_Bool)arg3;	// IMP=0x00000000000a93a6
- (id)loadRequest:(id)arg1 userDriven:(_Bool)arg2;	// IMP=0x00000000000a9391
