...
- (void).cxx_destruct;	// IMP=0x00000000000b3ac5
...
- (double)framesPerSecond;	// IMP=0x00000000000b384f
- (double)renderDuration;	// IMP=0x00000000000b382b
- (void)finishRenderTime:(id)arg1;	// IMP=0x00000000000b381a
- (void)startRenderTime:(id)arg1;	// IMP=0x00000000000b37d4
- (void)finishRenderFps:(id)arg1;	// IMP=0x00000000000b37ab
- (void)startRenderFps:(id)arg1;	// IMP=0x00000000000b3758
- (void)setTimer:(id)arg1;	// IMP=0x00000000000b371a
- (id)timer;	// IMP=0x00000000000b370c
- (id)statusString;	// IMP=0x00000000000b3690
- (int)status;	// IMP=0x00000000000b3687
- (void)setStatus:(int)arg1;	// IMP=0x00000000000b367e
- (id)description;	// IMP=0x00000000000b3391
- (void)dealloc;	// IMP=0x00000000000b334f
- (id)initWithURL:(id)arg1 withProcessSwap:(_Bool)arg2;	// IMP=0x00000000000b32cf
