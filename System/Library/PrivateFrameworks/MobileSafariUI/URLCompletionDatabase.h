...
- (void).cxx_destruct;	// IMP=0x000000000017950c
@property(nonatomic) int searchableCollectionsMask; // @synthesize searchableCollectionsMask=_searchableCollectionsMask;
- (id)fakeBookmarkMatchDataWithURLString:(id)arg1 title:(id)arg2 shouldPreload:(_Bool)arg3;	// IMP=0x000000000017941e
- (void)enumerateMatchDataForTypedStringHint:(id)arg1 options:(unsigned long long)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000017822b
- (void)_updateCloudDevices:(id)arg1;	// IMP=0x0000000000178152
- (void)clearBookmarksCache;	// IMP=0x0000000000178135
- (void)dealloc;	// IMP=0x0000000000178082
- (id)initWithCloudTabStore:(id)arg1 searchableCollectionsMask:(int)arg2 bookmarkProvider:(id)arg3;	// IMP=0x0000000000177ebd
