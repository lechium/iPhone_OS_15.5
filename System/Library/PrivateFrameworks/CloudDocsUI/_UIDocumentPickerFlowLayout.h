...
- (_Bool)shouldInvalidateLayoutForBoundsChange:(struct CGRect)arg1;	// IMP=0x000000000002af7b
- (_Bool)canBeEdited;	// IMP=0x000000000002af73
- (struct CGSize)collectionViewContentSize;	// IMP=0x000000000002ae8d
