...
- (void)accommodatePresentedItemDeletionWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000020335
- (void)presentedItemDidMoveToURL:(id)arg1;	// IMP=0x00000000000202e8
- (void)presentedItemUbiquityDidChange;	// IMP=0x00000000000202ab
- (void)presentedItemDidChange;	// IMP=0x000000000002026e
