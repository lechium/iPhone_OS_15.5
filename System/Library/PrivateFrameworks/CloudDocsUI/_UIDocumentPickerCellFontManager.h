...
+ (id)sharedFontManager;	// IMP=0x0000000000001c24
- (void).cxx_destruct;	// IMP=0x0000000000001e1d
...
- (void)cacheFonts;	// IMP=0x0000000000001cad
- (id)init;	// IMP=0x0000000000001c61
