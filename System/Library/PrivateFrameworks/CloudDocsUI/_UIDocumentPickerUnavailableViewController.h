...
- (void).cxx_destruct;	// IMP=0x0000000000011436
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000108c6
- (void)_fontSizeDidChange:(id)arg1;	// IMP=0x00000000000108b2
- (id)_buttonBackgroundImageForState:(unsigned long long)arg1 traits:(id)arg2;	// IMP=0x00000000000106c1
- (void)_buttonPressed:(id)arg1;	// IMP=0x0000000000010649
- (void)dealloc;	// IMP=0x00000000000105c7
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000000ed67
