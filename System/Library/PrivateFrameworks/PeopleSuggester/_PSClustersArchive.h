...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000051881
- (void).cxx_destruct;	// IMP=0x0000000000051b31
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005196f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000051889
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000517ec
- (id)initWithClustersDictionary:(id)arg1 archiveDate:(id)arg2;	// IMP=0x0000000000051753
