...
{
    id <CALNCalendarResourceChangedNotificationDataSource> _dataSource;	// 8 = 0x8
    ...
    id <CalDateProvider> _dateProvider;	// 40 = 0x28
}

- (void).cxx_destruct;	// IMP=0x0000000000052c61
...
- (void)didReceiveResponse:(id)arg1;	// IMP=0x0000000000052a84
- (id)contentForNotificationWithInfo:(id)arg1;	// IMP=0x00000000000522dd
- (id)contentForNotificationWithSourceClientIdentifier:(id)arg1;	// IMP=0x00000000000521f1
- (void)refreshNotifications:(id)arg1;	// IMP=0x0000000000051d9e
@property(readonly, nonatomic) NSArray *categories;
@property(readonly, nonatomic) NSString *sourceIdentifier;
- (id)initWithDataSource:(id)arg1 notificationManager:(id)arg2 iconIdentifierProvider:(id)arg3 sourceEventRepresentationProvider:(id)arg4 dateProvider:(id)arg5;	// IMP=0x0000000000051b54
