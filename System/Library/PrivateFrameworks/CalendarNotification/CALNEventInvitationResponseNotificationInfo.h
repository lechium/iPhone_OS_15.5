...
- (void).cxx_destruct;	// IMP=0x00000000000044be
...
- (id)description;	// IMP=0x00000000000042be
- (id)initWithSourceClientIdentifier:(id)arg1 launchURL:(id)arg2 expirationDate:(id)arg3 eventInvitationNotification:(id)arg4 eventRepresentationDictionary:(id)arg5 isDelegate:(_Bool)arg6 sourceTitle:(id)arg7 sourceIdentifier:(id)arg8;	// IMP=0x000000000000412d
