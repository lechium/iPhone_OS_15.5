...
+ (id)sharedInstance;	// IMP=0x0000000000009725
- (_Bool)travelStateIndicatesTravelingTowardDestination:(long long)arg1;	// IMP=0x0000000000009845
- (_Bool)doesHypothesisSatisfyMinimumAllowableTravelTime:(id)arg1;	// IMP=0x00000000000097dc
