...
{
    id <CALNEventInvitationResponseNotificationDataSource> _dataSource;	// 8 = 0x8
...
- (void).cxx_destruct;	// IMP=0x0000000000062306
...
- (id)_notificationBodyForNotificationInfo:(id)arg1 contactIdentifier:(id *)arg2 summaryArgument:(id *)arg3;	// IMP=0x00000000000620cb
- (void)didReceiveResponse:(id)arg1;	// IMP=0x0000000000061f2c
- (id)contentForNotificationWithInfo:(id)arg1;	// IMP=0x00000000000618ee
- (id)contentForNotificationWithSourceClientIdentifier:(id)arg1;	// IMP=0x0000000000061802
- (void)refreshNotifications:(id)arg1;	// IMP=0x00000000000613af
@property(readonly, nonatomic) NSArray *categories;
- (id)_categoryIdentifier;	// IMP=0x000000000006120d
@property(readonly, nonatomic) NSString *sourceIdentifier;
- (id)initWithDataSource:(id)arg1 notificationManager:(id)arg2 iconIdentifierProvider:(id)arg3 dateProvider:(id)arg4;	// IMP=0x0000000000061123
