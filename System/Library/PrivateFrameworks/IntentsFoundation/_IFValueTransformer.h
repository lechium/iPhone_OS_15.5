...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0000000000001ec3
- (void).cxx_destruct;	// IMP=0x0000000000001e92
...
- (id)reverseTransformedValue:(id)arg1;	// IMP=0x0000000000001dfe
- (id)transformedValue:(id)arg1;	// IMP=0x0000000000001d8c
- (id)initWithForwardTransformation:(CDUnknownBlockType)arg1 reverseTransformation:(CDUnknownBlockType)arg2;	// IMP=0x0000000000001cc5
