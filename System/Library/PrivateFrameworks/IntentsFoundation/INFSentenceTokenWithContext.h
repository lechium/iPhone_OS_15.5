...
+ (id)sentenceResolvedTokenWithOriginalToken:(id)arg1 placeholderName:(id)arg2;	// IMP=0x0000000000002b21
...
- (id)initWithToken:(id)arg1 variableName:(id)arg2;	// IMP=0x00000000000029f4
