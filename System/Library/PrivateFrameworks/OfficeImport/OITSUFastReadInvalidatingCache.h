...
- (void)invalidate;	// IMP=0x000000000028cf0e
- (id)value;	// IMP=0x000000000028cd5e
- (void)p_setValue:(id)arg1;	// IMP=0x000000000028cc8f
- (void)dealloc;	// IMP=0x000000000028cc30
- (id)initForReentrant:(_Bool)arg1 withGenerator:(CDUnknownBlockType)arg2;	// IMP=0x000000000028cbb0
