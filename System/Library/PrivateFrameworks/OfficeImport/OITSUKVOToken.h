...
- (unsigned long long)hash;	// IMP=0x000000000027177c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002716d1
- (void)dealloc;	// IMP=0x0000000000271696
- (id)initWithObserver:(id)arg1 target:(id)arg2 keyPath:(id)arg3 context:(void *)arg4;	// IMP=0x000000000027161e
- (id)init;	// IMP=0x0000000000271544
