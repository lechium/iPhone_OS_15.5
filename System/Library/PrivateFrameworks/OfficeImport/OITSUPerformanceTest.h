...
+ (id)csvHeader;	// IMP=0x000000000026ab73
...
- (id)csvString;	// IMP=0x000000000026ab80
- (void)report;	// IMP=0x000000000026a8e8
- (void)run;	// IMP=0x000000000026a47f
- (void)dealloc;	// IMP=0x000000000026a435
- (id)initWithName:(id)arg1 selector:(SEL)arg2 target:(id)arg3 goalTime:(double)arg4;	// IMP=0x000000000026a380
