...
- (_Bool)chartAutoStrokeIsHollow;	// IMP=0x00000000003bc77d
- (_Bool)chartAutoFillIsHollow;	// IMP=0x00000000003bc76d
- (void)readClientDataFromNode:(struct _xmlNode *)arg1 toDrawable:(id)arg2 state:(id)arg3;	// IMP=0x000000000021fe18
