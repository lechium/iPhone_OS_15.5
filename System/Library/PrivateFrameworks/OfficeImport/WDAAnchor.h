...
+ (id)stringForTextWrappingModeType:(int)arg1;	// IMP=0x00000000003eb520
- (void).cxx_destruct;	// IMP=0x00000000003eb631
...
- (id)description;	// IMP=0x00000000003eb574
- (id)init;	// IMP=0x000000000015b290
