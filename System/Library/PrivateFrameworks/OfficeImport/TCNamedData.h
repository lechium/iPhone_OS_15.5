...
+ (id)namedDataWithData:(id)arg1 named:(id)arg2;	// IMP=0x00000000002e4ceb
- (void).cxx_destruct;	// IMP=0x00000000002e4e43
...
- (id)initWithData:(id)arg1 named:(id)arg2;	// IMP=0x00000000002e4d78
