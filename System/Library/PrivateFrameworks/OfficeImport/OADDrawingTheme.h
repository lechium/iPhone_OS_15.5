...
- (void).cxx_destruct;	// IMP=0x000000000034d28d
...
- (id)description;	// IMP=0x000000000034d11d
...
- (unsigned long long)hash;	// IMP=0x000000000034d06e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000034cfb5
- (void)applyThemeOverrides:(id)arg1 colorMapOverride:(id)arg2;	// IMP=0x000000000034ce93
- (id)initWithTheme:(id)arg1 colorMap:(id)arg2 colorPalette:(id)arg3;	// IMP=0x000000000034cc94
- (id)initWithStyleMatrix:(id)arg1 fontScheme:(id)arg2 colorScheme:(id)arg3 colorMap:(id)arg4 colorPalette:(id)arg5;	// IMP=0x000000000034cb4f
