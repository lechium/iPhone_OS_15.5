...
- (unsigned long long)hash;	// IMP=0x00000000000af09a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000103094
- (id)initWithFillCategory:(int)arg1 mFillIndex:(unsigned long long)arg2 strokeIndex:(unsigned long long)arg3 shadowIndex:(unsigned long long)arg4 reflectionOpacity:(unsigned char)arg5 textStyleIndex:(unsigned long long)arg6;	// IMP=0x00000000000aefa9
