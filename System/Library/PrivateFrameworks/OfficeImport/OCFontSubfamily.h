...
+ (id)fontSubfamilyWithName:(id)arg1 metadata:(id)arg2;	// IMP=0x00000000003769de
- (void).cxx_destruct;	// IMP=0x0000000000376a7f
@property(readonly, nonatomic) OCFontMetadata *metadata; // @synthesize metadata=_metadata;
@property(readonly, nonatomic) NSString *name; // @synthesize name=_name;
- (id)initWithName:(id)arg1 metadata:(id)arg2;	// IMP=0x000000000037690f
