...
- (void).cxx_destruct;	// IMP=0x00000000002b50fe
...
- (void)defragmentData;	// IMP=0x00000000002b4fb0
- (void)append:(id)arg1;	// IMP=0x00000000002b4f0a
- (id)initWithData:(id)arg1;	// IMP=0x00000000002b4e4a
- (id)init;	// IMP=0x00000000002b4e31
