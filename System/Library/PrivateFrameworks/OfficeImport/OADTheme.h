...
- (void).cxx_destruct;	// IMP=0x0000000000330c54
...
- (id)description;	// IMP=0x0000000000330be2
- (void)validateTheme;	// IMP=0x0000000000330b55
- (_Bool)isEmpty;	// IMP=0x0000000000330b17
- (id)init;	// IMP=0x000000000001ebb0
