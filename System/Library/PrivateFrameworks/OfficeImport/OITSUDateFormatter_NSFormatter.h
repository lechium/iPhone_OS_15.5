...
- (void).cxx_destruct;	// IMP=0x0000000000254e5a
...
- (id)stringForObjectValue:(id)arg1;	// IMP=0x0000000000254b7c
- (_Bool)getObjectValue:(out id *)arg1 forString:(id)arg2 errorDescription:(out id *)arg3;	// IMP=0x0000000000254a35
- (id)init;	// IMP=0x0000000000254901
