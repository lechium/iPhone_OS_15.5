...
+ (id)localeSpecificStorageForLocale:(id)arg1;	// IMP=0x00000000002c19c8
- (void).cxx_destruct;	// IMP=0x00000000002c1cd6
...
- (id)initWithLocale:(id)arg1;	// IMP=0x00000000002c1498
