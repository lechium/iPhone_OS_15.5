...
- (void).cxx_destruct;	// IMP=0x00000000003802ee
...
- (void)setStartErrorMessageFromException:(id)arg1;	// IMP=0x0000000000380254
- (id)initWithCancelDelegate:(id)arg1;	// IMP=0x00000000003801c0
- (_Bool)verifyFileFormat;	// IMP=0x000000000038034d
- (id)read;	// IMP=0x0000000000380345
- (_Bool)start;	// IMP=0x000000000038033d
- (_Bool)isBinaryReader;	// IMP=0x0000000000380335
