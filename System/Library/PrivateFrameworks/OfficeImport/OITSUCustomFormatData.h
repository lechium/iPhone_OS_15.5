...
+ (id)customFormatData;	// IMP=0x00000000002bb3e0
- (void).cxx_destruct;	// IMP=0x00000000002bbe28
...
- (unsigned long long)hash;	// IMP=0x00000000002bbc6c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002bb7ac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002bb7a1
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002bb74e
- (void)p_copySelfTo:(id)arg1;	// IMP=0x00000000002bb4b4
- (id)init;	// IMP=0x00000000002bb461
- (id)initWithCustomFormatData:(id)arg1;	// IMP=0x00000000002bb3f9
