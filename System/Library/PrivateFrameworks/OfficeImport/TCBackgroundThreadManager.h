...
- (void).cxx_destruct;	// IMP=0x00000000002ebf20
...
- (void)waitUntilComplete;	// IMP=0x00000000002ebe66
- (void)addASyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002ebc85
- (void)dealloc;	// IMP=0x00000000002ebc0f
- (id)initWithCancelDelegate:(id)arg1;	// IMP=0x00000000002eba41
