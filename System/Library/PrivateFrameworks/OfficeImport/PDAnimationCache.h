...
+ (id)createAnimationInfoDataForCacheItem:(id)arg1 order:(unsigned int)arg2;	// IMP=0x0000000000453a66
+ (void)loadAnimationCache:(id)arg1 pdAnimation:(id)arg2 state:(id)arg3;	// IMP=0x000000000045370c
+ (void)mapAnimationInfo:(id)arg1 cacheData:(id)arg2 state:(id)arg3;	// IMP=0x00000000004542b9
+ (void)mapCommonData:(id)arg1 cacheData:(id)arg2 state:(id)arg3;	// IMP=0x0000000000453e42
- (void).cxx_destruct;	// IMP=0x0000000000453e01
...
- (id)initWithAnimationInfo:(id)arg1;	// IMP=0x0000000000453393
