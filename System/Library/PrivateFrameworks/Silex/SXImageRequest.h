...
{
    _Bool _preserveColorspace;	// 8 = 0x8
    NSString *_imageIdentifier;	// 16 = 0x10
    NSURL *_URL;	// 24 = 0x18
    unsigned long long _qualities;	// 32 = 0x20
    CDUnknownBlockType _loadingBlock;	// 40 = 0x28
    struct CGSize _size;	// 48 = 0x30
}

- (void).cxx_destruct;	// IMP=0x00000000000abe16
...
- (id)initWithImageIdentifier:(id)arg1 imageQualities:(unsigned long long)arg2 url:(id)arg3 size:(struct CGSize)arg4 preserveColorspace:(_Bool)arg5 loadingBlock:(CDUnknownBlockType)arg6;	// IMP=0x00000000000abcb9
