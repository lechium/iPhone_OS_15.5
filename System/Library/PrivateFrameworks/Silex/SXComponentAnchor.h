...
{
    NSString *_targetComponentIdentifier;	// 8 = 0x8
    long long _targetAnchorPosition;	// 16 = 0x10
    long long _originAnchorPosition;	// 24 = 0x18
    struct _NSRange _range;	// 32 = 0x20
}

- (void).cxx_destruct;	// IMP=0x00000000000577eb
...
- (id)initWithTargetComponentIdentifier:(id)arg1;	// IMP=0x0000000000057651
