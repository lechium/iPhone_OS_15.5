...
- (void).cxx_destruct;	// IMP=0x00000000000d4c04
...
- (id)textSourceWithFormattedText:(id)arg1 indexPath:(CDStruct_2fea82da)arg2 dataSource:(id)arg3;	// IMP=0x00000000000d4ae4
- (id)initWithSmartFieldFactory:(id)arg1 documentLanguageProvider:(id)arg2 fontAttributesConstructor:(id)arg3;	// IMP=0x00000000000d4a2d
