...
+ (id)jsonPropertyNameForObjCPropertyName:(id)arg1;	// IMP=0x000000000013ef28
- (id)contentSizeCategoryFromJSONContentSizeCategory:(id)arg1;	// IMP=0x000000000013f5eb
- (long long)interfaceSizeClassFromJSONSizeClass:(id)arg1;	// IMP=0x000000000013f582
@property(readonly, nonatomic) NSSet *types;
- (long long)offerUpsellScenarioWithValue:(id)arg1 withType:(int)arg2;	// IMP=0x000000000013f352
- (unsigned long long)newsletterSubscriptionStatusWithValue:(id)arg1 withType:(int)arg2;	// IMP=0x000000000013f267
- (unsigned long long)preferredColorSchemeWithValue:(id)arg1 withType:(int)arg2;	// IMP=0x000000000013f1a6
- (unsigned long long)testingWithValue:(id)arg1 withType:(int)arg2;	// IMP=0x000000000013f180
- (id)maxContentSizeCategoryWithValue:(id)arg1 withType:(int)arg2;	// IMP=0x000000000013f119
- (id)minContentSizeCategoryWithValue:(id)arg1 withType:(int)arg2;	// IMP=0x000000000013f0b2
- (long long)verticalSizeClassWithValue:(id)arg1 withType:(int)arg2;	// IMP=0x000000000013f097
- (long long)horizontalSizeClassWithValue:(id)arg1 withType:(int)arg2;	// IMP=0x000000000013f07c
- (double)maxViewportAspectRatioWithValue:(id)arg1 withType:(int)arg2;	// IMP=0x000000000013f058
- (double)minViewportAspectRatioWithValue:(id)arg1 withType:(int)arg2;	// IMP=0x000000000013f039
- (double)maxViewportWidthWithValue:(id)arg1 withType:(int)arg2;	// IMP=0x000000000013f015
- (double)minViewportWidthWithValue:(id)arg1 withType:(int)arg2;	// IMP=0x000000000013eff6
