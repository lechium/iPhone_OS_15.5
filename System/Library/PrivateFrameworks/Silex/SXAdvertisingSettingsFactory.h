...
@interface SXAdvertisingSettingsFactory : NSObject <SXAdvertisingSettingsFactory>
{
    ...
    id <SXDebugAdvertisementSettingsProvider> _debugSettingsProvider;	// 16 = 0x10
}

- (void).cxx_destruct;	// IMP=0x00000000000c51c3
...
- (id)createAdvertisingSettingsWithDOMObjectProvider:(id)arg1;	// IMP=0x00000000000c4fd2
- (id)initWithDocumentProvider:(id)arg1 debugSettingsProvider:(id)arg2;	// IMP=0x00000000000c4f39
