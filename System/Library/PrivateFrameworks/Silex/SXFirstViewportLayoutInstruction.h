...
{
    _Bool _fullfilled;	// 8 = 0x8
}

@property(nonatomic) _Bool fullfilled; // @synthesize fullfilled=_fullfilled;
- (void)didLayoutComponentBlueprint:(id)arg1 blueprint:(id)arg2;	// IMP=0x0000000000079784
- (_Bool)isFulfilledForBlueprint:(id)arg1;	// IMP=0x0000000000079765
