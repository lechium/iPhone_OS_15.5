...
- (void).cxx_destruct;	// IMP=0x0000000000012ee1
...
- (_Bool)isWarning;	// IMP=0x0000000000012dcd
- (id)description;	// IMP=0x0000000000012d04
- (id)prettyMethodName;	// IMP=0x0000000000012bf7
