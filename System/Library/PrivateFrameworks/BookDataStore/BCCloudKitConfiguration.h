...
+ (id)configuration;	// IMP=0x000000000001d0f7
...
- (_Bool)shouldPerformDatabaseSubscriptionForServiceMode:(_Bool)arg1;	// IMP=0x000000000001d2df
- (_Bool)shouldArchiveData:(id)arg1;	// IMP=0x000000000001d2d7
