...
- (void).cxx_destruct;	// IMP=0x0000000000022b9b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000022466
- (unsigned long long)hash;	// IMP=0x0000000000021abb
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002143a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000020f9e
- (void)copyTo:(id)arg1;	// IMP=0x0000000000020bea
- (void)writeTo:(id)arg1;	// IMP=0x0000000000020815
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000020808
- (id)dictionaryRepresentation;	// IMP=0x000000000001f644
- (id)description;	// IMP=0x000000000001f595
