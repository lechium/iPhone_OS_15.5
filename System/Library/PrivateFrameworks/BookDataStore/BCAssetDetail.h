...
+ (id)propertyIDKey;	// IMP=0x000000000004f95c
@property(readonly, copy) NSString *debugDescription;
@property(readonly, nonatomic) _Bool isAudiobook;
- (id)zoneName;	// IMP=0x000000000004f969
- (id)identifier;	// IMP=0x000000000004f94a
- (id)recordType;	// IMP=0x000000000004f93d
- (void)resolveConflictsFromRecord:(id)arg1 withResolvers:(id)arg2;	// IMP=0x000000000004e3a2
- (_Bool)isEqualExceptForDate:(id)arg1;	// IMP=0x000000000004d9d3
- (_Bool)setDifferentBookmarkTime:(double)arg1;	// IMP=0x000000000004d970
- (void)_configureFromAssetDetail:(id)arg1 withMergers:(id)arg2;	// IMP=0x000000000004d061
- (void)configureFromCloudData:(id)arg1 withMergers:(id)arg2;	// IMP=0x000000000004cfbc
- (id)mutableCopy;	// IMP=0x000000000004cf8e
