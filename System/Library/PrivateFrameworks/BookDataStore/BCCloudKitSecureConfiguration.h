...
+ (id)configuration;	// IMP=0x000000000004349e
- (void).cxx_destruct;	// IMP=0x000000000004373d
...
- (_Bool)shouldPerformDatabaseSubscriptionForServiceMode:(_Bool)arg1;	// IMP=0x000000000004362e
- (_Bool)shouldArchiveData:(id)arg1;	// IMP=0x0000000000043626
