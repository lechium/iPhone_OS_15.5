...
- (void).cxx_destruct;	// IMP=0x0000000000148467
- (void)sessionDidEnd:(id)arg1 aligned:(id)arg2;	// IMP=0x0000000000148180
- (id)initWithReportingDelegate:(id)arg1;	// IMP=0x0000000000148126
