...
- (void).cxx_destruct;	// IMP=0x000000000000fce3
...
- (id)initWithXPCDictionary:(id)arg1;	// IMP=0x000000000000fba2
- (void)encodeWithXPCDictionary:(id)arg1;	// IMP=0x000000000000fac3
- (id)initWithText:(id)arg1 simLabel:(id)arg2;	// IMP=0x000000000000fa71
