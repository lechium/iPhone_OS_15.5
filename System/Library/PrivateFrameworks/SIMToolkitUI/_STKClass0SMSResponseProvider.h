...
- (void)sendResponse:(long long)arg1 withStringResult:(id)arg2;	// IMP=0x000000000000683d
- (void)sendResponse:(long long)arg1;	// IMP=0x0000000000006837
@property(readonly, nonatomic) NSObject<OS_os_log> *logger;
@property(readonly, nonatomic) _Bool hasSentResponse;
- (id)initWithLogger:(id)arg1;	// IMP=0x00000000000067b6
