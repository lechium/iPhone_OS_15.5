...
- (void).cxx_destruct;	// IMP=0x00000000000107e5
...
- (void)_finishPullToDismiss;	// IMP=0x000000000001071b
- (void)scrollViewDidEndDecelerating:(id)arg1;	// IMP=0x0000000000010709
- (void)scrollViewDidEndDragging:(id)arg1 willDecelerate:(_Bool)arg2;	// IMP=0x00000000000106f1
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x0000000000010693
- (void)scrollViewWillBeginDragging:(id)arg1;	// IMP=0x00000000000105ce
...
- (id)initWithPresentedViewController:(id)arg1 scrollView:(id)arg2;	// IMP=0x00000000000104ed
