...
#import <ProxCardKit/PRXCardBottomTrayDelegate-Protocol.h>
...
- (void).cxx_destruct;	// IMP=0x000000000000980b
...
- (void)didChangeContentsOfBottomTray:(id)arg1;	// IMP=0x00000000000095fb
@property(copy, nonatomic) NSArray *actionButtons;
@property(readonly, copy, nonatomic) NSArray *auxiliaryViews;
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x0000000000009130
- (void)removeBottomTray;	// IMP=0x00000000000090f3
- (void)scrollToBottom;	// IMP=0x0000000000008c9e
- (void)setContentOffset:(struct CGPoint)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000008c3b
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000008b1e
- (struct CGSize)systemLayoutSizeFittingSize:(struct CGSize)arg1 withHorizontalFittingPriority:(float)arg2 verticalFittingPriority:(float)arg3;	// IMP=0x0000000000008a9b
- (void)layoutSubviews;	// IMP=0x0000000000008663
- (id)initWithContentView:(id)arg1;	// IMP=0x0000000000006aed
