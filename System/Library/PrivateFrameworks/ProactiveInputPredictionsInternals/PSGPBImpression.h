...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000009dc2
- (unsigned long long)hash;	// IMP=0x0000000000009a53
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000950d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000914a
- (void)copyTo:(id)arg1;	// IMP=0x0000000000008e3e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000008b25
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000008b18
- (id)dictionaryRepresentation;	// IMP=0x00000000000083ac
- (id)description;	// IMP=0x00000000000082fd
...
- (int)StringAsTriggerSourceType:(id)arg1;	// IMP=0x000000000000814c
- (id)triggerSourceTypeAsString:(int)arg1;	// IMP=0x00000000000080a6
...
- (int)StringAsDataSourceType:(id)arg1;	// IMP=0x0000000000007ea0
- (id)dataSourceTypeAsString:(int)arg1;	// IMP=0x0000000000007dc6
