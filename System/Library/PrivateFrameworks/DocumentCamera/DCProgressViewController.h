...
- (void).cxx_destruct;	// IMP=0x00000000000a92c4
...
- (_Bool)_canShowWhileLocked;	// IMP=0x00000000000a91ef
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000000a900c
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000a8fa2
- (void)viewDidLoad;	// IMP=0x00000000000a8ea1
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000a8ded
