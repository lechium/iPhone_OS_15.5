...
- (void).cxx_destruct;	// IMP=0x00000000000a0e1d
...
- (void)didFinishWithDocumentInfoCollection:(id)arg1;	// IMP=0x00000000000a0ca6
- (void)didCancel:(id)arg1;	// IMP=0x00000000000a0c09
- (void)dismiss;	// IMP=0x00000000000a0b89
- (void)viewServicePreferredSizeDidChange:(struct CGSize)arg1;	// IMP=0x00000000000a0b77
...
- (id)castedChildViewController;	// IMP=0x00000000000a0a73
- (void)viewDidLoad;	// IMP=0x00000000000a0519
- (void)accelerometer:(id)arg1 didChangeDeviceOrientation:(long long)arg2;	// IMP=0x00000000000a04c8
- (void)accelerometer:(id)arg1 didAccelerateWithTimeStamp:(double)arg2 x:(float)arg3 y:(float)arg4 z:(float)arg5 eventType:(int)arg6;	// IMP=0x00000000000a04c2
- (void)dealloc;	// IMP=0x00000000000a03f1
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000a03c0
