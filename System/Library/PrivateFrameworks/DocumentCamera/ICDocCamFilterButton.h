...
+ (id)filterButtonWithType:(short)arg1;	// IMP=0x00000000000479c4
- (void).cxx_destruct;	// IMP=0x0000000000047ed4
...
- (void)updateForAccessibilityDarkerSystemColors:(id)arg1;	// IMP=0x0000000000047d53
- (unsigned long long)accessibilityTraits;	// IMP=0x0000000000047cf6
- (struct CGRect)accessibilityFrame;	// IMP=0x0000000000047c98
- (id)accessibilityLabel;	// IMP=0x0000000000047c48
- (_Bool)isAccessibilityElement;	// IMP=0x0000000000047c40
- (id)imageForFilterType:(short)arg1;	// IMP=0x00000000000478ae
...
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000004775e
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000000476fb
- (void)setSelected:(_Bool)arg1;	// IMP=0x00000000000475b5
@property(nonatomic) double iconSize; // @dynamic iconSize;
- (void)awakeFromNib;	// IMP=0x00000000000472d9
- (void)dealloc;	// IMP=0x0000000000047264
