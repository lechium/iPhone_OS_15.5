...
+ (double)leadingTrailingOffset:(long long)arg1;	// IMP=0x000000000002688a
- (void).cxx_destruct;	// IMP=0x0000000000026acb
...
- (_Bool)_canShowWhileLocked;	// IMP=0x0000000000026a22
- (void)didReceiveMemoryWarning;	// IMP=0x00000000000269f3
- (void)handleSingleTap:(id)arg1;	// IMP=0x000000000002699a
- (void)viewDidLoad;	// IMP=0x0000000000026893
