...
- (void).cxx_destruct;	// IMP=0x000000000001bbb4
...
- (void)_cancelFireRequests;	// IMP=0x000000000001ba86
- (void)cancelPreviousFireRequests;	// IMP=0x000000000001b9ff
@property(readonly, nonatomic) _Bool isScheduledToFire;
- (void)callTargetSelector;	// IMP=0x000000000001b7b6
- (void)fireImmediately;	// IMP=0x000000000001b6bb
- (void)requestFire;	// IMP=0x000000000001b399
- (void)dealloc;	// IMP=0x000000000001b2f4
- (id)initWithTarget:(id)arg1 selector:(SEL)arg2 delay:(double)arg3 waitToFireUntilRequestsStop:(_Bool)arg4 callOnMainThread:(_Bool)arg5;	// IMP=0x000000000001b1d7
