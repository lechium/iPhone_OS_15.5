...
@interface DCLongRunningTaskController : NSObject <DCProgressViewControllerDelegate>
{
    ...
    NSString *_progressFormatString;	// 16 = 0x10
...
+ (void)setMainWindow:(id)arg1;	// IMP=0x000000000003693a
- (void).cxx_destruct;	// IMP=0x0000000000037aad
...
- (void)willDismissProgressViewController:(id)arg1;	// IMP=0x00000000000378f8
- (void)closeProgressDialog;	// IMP=0x00000000000377dd
- (void)openProgressDialog;	// IMP=0x0000000000037272
- (void)updateProgress;	// IMP=0x0000000000036eea
- (void)completeTaskIfNecessary;	// IMP=0x0000000000036cf1
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000036c53
- (void)startTask:(CDUnknownBlockType)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000003694e
- (id)initWithWindow:(id)arg1 intervalBeforeOpeningProgressDialog:(double)arg2;	// IMP=0x00000000000368b3
- (id)init;	// IMP=0x0000000000036892
