...
- (void).cxx_destruct;	// IMP=0x00000000000a2aff
...
- (_Bool)_shouldCrossFadeNavigationBar;	// IMP=0x00000000000a2a80
- (void)animateTransition:(id)arg1;	// IMP=0x00000000000a0f31
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000000a0f1f
- (id)initWithImage:(id)arg1 indexPath:(id)arg2 duration:(double)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000000a0e4e
