...
- (void)handleReturnedURL:(id)arg1;	// IMP=0x000000000002c199
- (void)presentMarkupViewControllerFromView:(id)arg1;	// IMP=0x000000000002bdba
- (void)dismissMarkupViewController;	// IMP=0x000000000002bcec
- (void)markupDoneAction:(id)arg1;	// IMP=0x000000000002babf
- (void)markupCancelAction:(id)arg1;	// IMP=0x000000000002baad
- (void)presentMarkupFromView:(id)arg1;	// IMP=0x000000000002ba9b
