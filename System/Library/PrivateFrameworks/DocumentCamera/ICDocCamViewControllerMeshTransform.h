...
- (void).cxx_destruct;	// IMP=0x0000000000054107
...
- (id)imageMeshTransformWithImageQuad:(id)arg1 imageViewFrame:(struct CGRect)arg2 previewBounds:(struct CGRect)arg3 finalTransform:(_Bool)arg4;	// IMP=0x0000000000053902
- (void)startWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000005326f
- (struct CGRect)frameForImageInImageViewFrame:(struct CGRect)arg1;	// IMP=0x00000000000531c5
- (void)hide;	// IMP=0x0000000000053107
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000000052e20
- (id)initWithImage:(id)arg1 backgroundImage:(id)arg2 imageViewFrame:(struct CGRect)arg3 view:(id)arg4 imageQuad:(id)arg5 previewView:(id)arg6 previewBounds:(struct CGRect)arg7 scrimView:(id)arg8;	// IMP=0x0000000000052a72
