...
- (void).cxx_destruct;	// IMP=0x00000000000a5d88
...
- (void)animateTransition:(id)arg1;	// IMP=0x00000000000a3cac
- (id)makeUIImageFromCIImage:(id)arg1;	// IMP=0x00000000000a3bd4
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000000a3bc2
- (id)initWithImage:(id)arg1 indexPath:(id)arg2 duration:(double)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000000a3af1
