...
- (void).cxx_destruct;	// IMP=0x000000000009fdd2
...
- (_Bool)accessibilityIgnoresInvertColors;	// IMP=0x000000000009faca
- (id)accessibilityElements;	// IMP=0x000000000009fab8
- (struct CGRect)rectFromApplyingOrientation:(long long)arg1 toContentsRect:(struct CGRect)arg2;	// IMP=0x000000000009fa0c
@property(readonly, nonatomic) UIBezierPath *outlinePath;
- (void)updateOutlineLayer;	// IMP=0x000000000009f758
- (void)updateSelectedKnobContents;	// IMP=0x000000000009f201
- (void)unselectAllKnobs;	// IMP=0x000000000009e971
- (id)closestKnobToPoint:(struct CGPoint)arg1;	// IMP=0x000000000009e765
- (void)didPan:(id)arg1;	// IMP=0x000000000009de43
- (void)touchesBeganOnQuadEditPanGestureRecognizerDelegate:(id)arg1;	// IMP=0x000000000009de31
- (void)updateKnobLocationsToRect:(id)arg1;	// IMP=0x000000000009dc19
...
- (void)setupLoupeLayerIfNeeded;	// IMP=0x000000000009d24b
- (void)setImage:(id)arg1 orientation:(long long)arg2;	// IMP=0x000000000009d1c6
- (void)setTempOverlayMagnification:(double)arg1 animationDuration:(double)arg2;	// IMP=0x000000000009ca1c
- (void)updateOutlineAndKnobColorForIsValid:(_Bool)arg1;	// IMP=0x000000000009c7b7
- (void)updateOutlineAndKnobColorForCurrentValidityIfNecessary;	// IMP=0x000000000009c73f
- (void)setUpKnobs;	// IMP=0x000000000009c21b
- (void)layoutSubviews;	// IMP=0x000000000009c0b2
- (void)commonInit;	// IMP=0x000000000009bfee
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000009bf91
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009bf45
