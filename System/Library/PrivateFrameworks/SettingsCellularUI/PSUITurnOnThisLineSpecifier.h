...
- (void)callObserver:(id)arg1 callChanged:(id)arg2;	// IMP=0x000000000003fa4a
- (void)setPlanEnabled:(id)arg1 specifier:(id)arg2;	// IMP=0x000000000003f821
- (id)isPlanEnabled:(id)arg1;	// IMP=0x000000000003f798
- (void)setSwitchEnabled;	// IMP=0x000000000003f6dc
- (id)initWithPlanUniversalReference:(id)arg1 cellularPlanManager:(id)arg2 planManagerCache:(id)arg3 callCache:(id)arg4 hostController:(id)arg5;	// IMP=0x000000000003f4de
