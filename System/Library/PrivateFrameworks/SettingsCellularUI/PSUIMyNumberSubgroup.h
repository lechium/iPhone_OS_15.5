...
- (id)specifiers;	// IMP=0x000000000001e38d
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x000000000001e337
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 parentSpecifier:(id)arg3;	// IMP=0x000000000001e2a5
