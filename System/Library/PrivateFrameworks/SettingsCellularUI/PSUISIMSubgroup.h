...
- (void).cxx_destruct;	// IMP=0x000000000001e276
...
- (id)specifiers;	// IMP=0x000000000001de53
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x000000000001ddfd
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 parentSpecifier:(id)arg3;	// IMP=0x000000000001dd6b
