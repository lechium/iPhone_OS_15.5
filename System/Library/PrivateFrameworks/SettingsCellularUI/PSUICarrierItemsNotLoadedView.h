...
- (double)preferredHeightForWidth:(double)arg1 inTableView:(id)arg2;	// IMP=0x000000000001985e
- (_Bool)textView:(id)arg1 shouldInteractWithURL:(id)arg2 inRange:(struct _NSRange)arg3 interaction:(long long)arg4;	// IMP=0x0000000000019718
- (void)setLinkText:(id)arg1 url:(id)arg2;	// IMP=0x00000000000194cf
- (id)initWithSpecifier:(id)arg1;	// IMP=0x0000000000018014
