...
- (void).cxx_destruct;	// IMP=0x0000000000063f18
...
- (id)totalRoamingDataUsageForSpecifier:(id)arg1;	// IMP=0x0000000000063d93
- (id)totalDataUsageForSpecifier:(id)arg1;	// IMP=0x0000000000063c86
- (id)totalRoamingBytesUsed;	// IMP=0x0000000000063a25
- (id)totalBytesUsed;	// IMP=0x00000000000637c4
- (id)specifiers;	// IMP=0x0000000000063758
- (id)initWithStatisticsCache:(id)arg1 andBillingPeriodSource:(id)arg2;	// IMP=0x00000000000633a0
