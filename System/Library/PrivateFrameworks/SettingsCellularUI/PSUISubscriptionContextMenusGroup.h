...
@interface PSUISubscriptionContextMenusGroup : NSObject <PSSpecifierGroup>
{
    ...
    PSUICellularDataOptionsController *_roamingSpecifiersSubgroup;	// 144 = 0x90
    PSUIDevicePasscodeState *_passcodeStatusCache;	// 152 = 0x98
}

- (void).cxx_destruct;	// IMP=0x000000000002433c
...
- (_Bool)planManagerCacheHasMoreThanOnePlanItem;	// IMP=0x0000000000024044
- (id)specifiers;	// IMP=0x0000000000023673
- (void)viewWillAppear;	// IMP=0x000000000002365d
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x0000000000023607
- (id)initWithFactory:(id)arg1;	// IMP=0x00000000000232e9
