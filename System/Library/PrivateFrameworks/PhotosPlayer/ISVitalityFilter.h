...
- (void).cxx_destruct;	// IMP=0x00000000000251e4
...
- (void)inputDidChange;	// IMP=0x0000000000025007
- (void)_invalidateOutput;	// IMP=0x0000000000024ff0
- (void)performOutputChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000024f18
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000024e88
- (id)initWithSettings:(id)arg1;	// IMP=0x0000000000024e1d
- (id)init;	// IMP=0x0000000000024e09
