...
- (void)_stopObservingPlayer;	// IMP=0x000000000000292d
- (void)dealloc;	// IMP=0x00000000000028ef
- (void)cancel;	// IMP=0x00000000000028d9
- (void)_didReachTargetTime;	// IMP=0x0000000000002745
- (void)_stepDownRate;	// IMP=0x0000000000002494
- (void)start;	// IMP=0x00000000000021a1
- (id)initWithTargetTime:(CDStruct_1b6d18a9)arg1 duration:(double)arg2 initialRate:(float)arg3 avPlayer:(id)arg4 progressHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000000020cc
