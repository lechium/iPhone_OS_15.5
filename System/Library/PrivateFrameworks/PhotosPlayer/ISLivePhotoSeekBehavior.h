...
- (void).cxx_destruct;	// IMP=0x0000000000010c90
...
- (long long)behaviorType;	// IMP=0x0000000000010c43
- (void)_handleDidSeekToSeekTime:(_Bool)arg1;	// IMP=0x0000000000010b5e
- (void)_callSeekCompletionHandler:(_Bool)arg1;	// IMP=0x0000000000010ac5
- (void)_seekIfNeeded;	// IMP=0x0000000000010a00
- (void)activeDidChange;	// IMP=0x00000000000108fd
- (id)initWithInitialLayoutInfo:(id)arg1 seekTime:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000000010853
