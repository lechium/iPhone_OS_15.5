...
+ (id)deferredFacesWithAssetCloudGUID:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x00000000005ac3da
+ (id)entityName;	// IMP=0x00000000005ac3cd
...
- (id)additionalDescription;	// IMP=0x00000000004da685
- (id)payloadIDsByPayloadClassIDToDeleteOnInsert;	// IMP=0x00000000004e445b
- (id)payloadIDForTombstone:(id)arg1;	// IMP=0x00000000004e43ee
- (id)payloadForChangedKeys:(id)arg1;	// IMP=0x00000000004e4367
- (id)payloadID;	// IMP=0x00000000004e4304
