...
- (void).cxx_destruct;	// IMP=0x0000000000021c6a
...
- (void)_queue_submitAnalyticsWithActivityCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000218b1
- (void)performPeriodicActivity:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000002119a
- (_Bool)periodicActivityRequiresProtectedData:(id)arg1;	// IMP=0x0000000000021192
- (void)periodicActivity:(id)arg1 configureXPCActivityCriteria:(id)arg2;	// IMP=0x0000000000021125
- (void)daemonReady:(id)arg1;	// IMP=0x0000000000021097
- (void)dealloc;	// IMP=0x0000000000021055
- (id)initWithProfile:(id)arg1;	// IMP=0x0000000000020ec4
