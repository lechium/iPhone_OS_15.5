...
- (void).cxx_destruct;	// IMP=0x0000000000007b45
- (id)takeAssertionWithError:(id *)arg1;	// IMP=0x0000000000007ab6
- (id)initWithProfile:(id)arg1 identifier:(id)arg2;	// IMP=0x0000000000007a12
