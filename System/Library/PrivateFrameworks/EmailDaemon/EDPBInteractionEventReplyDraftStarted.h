...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000b94ec
- (unsigned long long)hash;	// IMP=0x00000000000b9454
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b9316
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b9246
- (void)copyTo:(id)arg1;	// IMP=0x00000000000b9199
- (void)writeTo:(id)arg1;	// IMP=0x00000000000b90ae
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000b90a0
- (id)dictionaryRepresentation;	// IMP=0x00000000000b8957
- (id)description;	// IMP=0x00000000000b8887
@property(nonatomic) _Bool hasMessageId;
@property(nonatomic) _Bool hasConversationId;
- (int)StringAsMailboxType:(id)arg1;	// IMP=0x00000000000b8680
- (id)mailboxTypeAsString:(int)arg1;	// IMP=0x00000000000b85c0
...
- (void)withHasher:(id)arg1 setMessage:(id)arg2 data:(id)arg3;	// IMP=0x00000000000a28d2
