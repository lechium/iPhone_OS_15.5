...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000afad8
- (unsigned long long)hash;	// IMP=0x00000000000afa40
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000af902
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000af832
- (void)copyTo:(id)arg1;	// IMP=0x00000000000af785
- (void)writeTo:(id)arg1;	// IMP=0x00000000000af69a
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000af68c
- (id)dictionaryRepresentation;	// IMP=0x00000000000aef43
- (id)description;	// IMP=0x00000000000aee73
@property(nonatomic) _Bool hasMessageId;
@property(nonatomic) _Bool hasConversationId;
- (int)StringAsMailboxType:(id)arg1;	// IMP=0x00000000000aec6c
- (id)mailboxTypeAsString:(int)arg1;	// IMP=0x00000000000aebac
...
- (void)withHasher:(id)arg1 setMessage:(id)arg2 data:(id)arg3;	// IMP=0x00000000000a2239
