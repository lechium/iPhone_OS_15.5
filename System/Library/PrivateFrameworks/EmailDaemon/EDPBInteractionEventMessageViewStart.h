...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000b70a8
- (unsigned long long)hash;	// IMP=0x00000000000b7010
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b6ed2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b6e02
- (void)copyTo:(id)arg1;	// IMP=0x00000000000b6d55
- (void)writeTo:(id)arg1;	// IMP=0x00000000000b6c6a
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000b6c5c
- (id)dictionaryRepresentation;	// IMP=0x00000000000b6513
- (id)description;	// IMP=0x00000000000b6443
@property(nonatomic) _Bool hasMessageId;
@property(nonatomic) _Bool hasConversationId;
- (int)StringAsMailboxType:(id)arg1;	// IMP=0x00000000000b623c
- (id)mailboxTypeAsString:(int)arg1;	// IMP=0x00000000000b617c
...
- (void)withHasher:(id)arg1 setMessage:(id)arg2 data:(id)arg3;	// IMP=0x00000000000a1e51
