...
- (CDStruct_ba838cea)heapBufferSizeAndAlignWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;
- (CDStruct_ba838cea)heapTextureSizeAndAlignWithDescriptor:(MTLTextureDescriptor *)arg1;
