...
- (id).cxx_construct;	// IMP=0x000000000235d7b0
- (void).cxx_destruct;	// IMP=0x000000000235d790
@property(readonly, copy) NSArray *transactionMetrics; // @dynamic transactionMetrics;
- (void)dealloc;	// IMP=0x000000000235d670
- (id)_initWithMetrics:(void *)arg1;	// IMP=0x000000000235d5f0
