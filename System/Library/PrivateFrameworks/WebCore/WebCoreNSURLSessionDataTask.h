...
- (id).cxx_construct;	// IMP=0x0000000002361c20
- (void).cxx_destruct;	// IMP=0x0000000002361b00
...
- (void)resourceFinished:(void *)arg1 metrics:(const void *)arg2;	// IMP=0x0000000002361a00
- (void)resource:(void *)arg1 loadFailedWithError:(const void *)arg2;	// IMP=0x0000000002361960
- (void)resource:(void *)arg1 accessControlCheckFailedWithError:(const void *)arg2;	// IMP=0x00000000023618c0
- (void)_resource:(void *)arg1 loadFinishedWithError:(id)arg2 metrics:(const void *)arg3;	// IMP=0x00000000023615c0
- (void)resource:(void *)arg1 receivedRedirect:(const void *)arg2 request:(void *)arg3 completionHandler:(void *)arg4;	// IMP=0x0000000002361100
- (void)resource:(void *)arg1 receivedData:(void *)arg2;	// IMP=0x0000000002360ff0
- (_Bool)resource:(void *)arg1 shouldCacheResponse:(const void *)arg2;	// IMP=0x0000000002360fa0
- (void)resource:(void *)arg1 receivedResponse:(const void *)arg2 completionHandler:(void *)arg3;	// IMP=0x0000000002360be0
- (void)resource:(void *)arg1 sentBytes:(unsigned long long)arg2 totalBytesToBeSent:(unsigned long long)arg3;	// IMP=0x0000000002360bd0
- (id)_timingData;	// IMP=0x0000000002360bc0
- (void)dealloc;	// IMP=0x0000000002360a40
- (void)resume;	// IMP=0x00000000023609a0
- (void)suspend;	// IMP=0x0000000002360900
- (void)cancel;	// IMP=0x0000000002360830
...
- (void)_cancel;	// IMP=0x0000000002360580
- (void)_restart;	// IMP=0x0000000002360000
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000235fff0
- (id)initWithSession:(id)arg1 identifier:(unsigned long long)arg2 request:(id)arg3;	// IMP=0x000000000235fec0
