...
- (void).cxx_destruct;	// IMP=0x00000000000d322c
@property(retain, nonatomic) CKXSchema *schema; // @synthesize schema=_schema;
- (Class)mutableProxyClassForStructToken:(unsigned long long)arg1;	// IMP=0x00000000000d30fd
- (Class)proxyClassForStructToken:(unsigned long long)arg1;	// IMP=0x00000000000d2fef
- (unsigned long long)structTokenForClass:(Class)arg1;	// IMP=0x00000000000d2e04
- (unsigned long long)topLevelStructToken;	// IMP=0x00000000000d2dfa
- (id)init;	// IMP=0x00000000000d2d80
