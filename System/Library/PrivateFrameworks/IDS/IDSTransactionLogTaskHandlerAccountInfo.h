...
- (void).cxx_destruct;	// IMP=0x00000000001057e2
...
- (id)accountForAlias:(id)arg1;	// IMP=0x0000000000105741
- (id)initWithAccountIdentity:(id)arg1 aliasToAccountsMap:(id)arg2 serviceName:(id)arg3;	// IMP=0x000000000010568a
