...
- (void).cxx_destruct;	// IMP=0x000000000000bda3
...
- (id)allImages;	// IMP=0x000000000000bb67
- (id)debugDescription;	// IMP=0x000000000000b926
- (void)setImage:(id)arg1 forDescriptor:(id)arg2;	// IMP=0x000000000000b808
- (id)imageForDescriptor:(id)arg1;	// IMP=0x000000000000b70e
- (id)init;	// IMP=0x000000000000b6b1
