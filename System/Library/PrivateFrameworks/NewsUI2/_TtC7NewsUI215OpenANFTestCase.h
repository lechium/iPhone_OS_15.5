...
- (void).cxx_destruct;	// IMP=0x00000000007a69c0
- (id)init;	// IMP=0x00000000007a68c0
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000007a6830
