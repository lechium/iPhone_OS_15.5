...
- (void).cxx_destruct;	// IMP=0x00000000008b06a0
- (id)init;	// IMP=0x00000000008b05a0
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000008b0400
