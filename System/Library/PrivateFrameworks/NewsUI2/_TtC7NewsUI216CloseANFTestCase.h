...
- (void).cxx_destruct;	// IMP=0x00000000005ce2c0
- (id)init;	// IMP=0x00000000005ce1c0
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000005ce130
