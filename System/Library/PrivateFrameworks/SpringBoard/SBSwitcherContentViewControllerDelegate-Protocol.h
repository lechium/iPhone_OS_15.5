...
@class NSArray, NSString, SBAppLayout, SBBestAppSuggestion, SBDisplayItem, SBLayoutStateTransitionContext, SBSwitcherTransitionRequest, SBWorkspaceApplicationSceneTransitionContext;
