...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007f03e
- (unsigned long long)hash;	// IMP=0x000000000007f030
- (unsigned long long)intersectsTexture:(id)arg1;	// IMP=0x000000000007eeff
- (id)initWithDesc:(const struct MTLRenderPassAttachmentDescriptorPrivate *)arg1 renderTargetArrayLength:(unsigned long long)arg2;	// IMP=0x000000000007ed90
