...
+ (id)typeForOffer:(id)arg1;	// IMP=0x000000000004a218
+ (id)previewURLForOffer:(id)arg1;	// IMP=0x0000000000049e2a
+ (_Bool)hasVideoForOffer:(id)arg1;	// IMP=0x0000000000049e16
+ (_Bool)hasAudioForOffer:(id)arg1;	// IMP=0x0000000000049b9b
- (void).cxx_destruct;	// IMP=0x000000000004a2ad
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000049a8c
