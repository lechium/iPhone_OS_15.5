...
- (void).cxx_destruct;	// IMP=0x0000000000008bae
...
- (void)requestController:(id)arg1 didReceiveResponse:(id)arg2;	// IMP=0x00000000000089b4
- (void)requestStateChange:(long long)arg1;	// IMP=0x0000000000008867
- (id)initWithSubscriptionContext:(id)arg1;	// IMP=0x0000000000008768
- (id)init;	// IMP=0x000000000000873d
