...
- (id).cxx_construct;	// IMP=0x00000000000475fa
- (void).cxx_destruct;	// IMP=0x00000000000475c0
- (unsigned long long)drawNoise;	// IMP=0x00000000000474c8
- (id)initWithUnigram:(float *)arg1 ofSize:(unsigned long long)arg2;	// IMP=0x0000000000046c72
- (id)initWithZipfOfSize:(unsigned long long)arg1;	// IMP=0x0000000000046afc
- (id)init;	// IMP=0x0000000000046aee
