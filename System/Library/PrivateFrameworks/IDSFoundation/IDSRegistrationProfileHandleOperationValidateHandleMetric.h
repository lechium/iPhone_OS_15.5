...
- (void).cxx_destruct;	// IMP=0x000000000002001b
...
- (id)initWithGuid:(id)arg1 success:(_Bool)arg2 connectionType:(unsigned int)arg3 resultCode:(unsigned int)arg4 registrationError:(unsigned int)arg5 vettingStatus:(unsigned int)arg6 genericError:(id)arg7 URLError:(id)arg8 POSIXError:(id)arg9;	// IMP=0x000000000001fec4
