...
- (void).cxx_destruct;	// IMP=0x000000000001e54a
...
- (id)initWithGuid:(id)arg1 success:(_Bool)arg2 connectionType:(unsigned int)arg3 resultCode:(unsigned int)arg4 registrationType:(unsigned int)arg5 genericError:(id)arg6 URLError:(id)arg7 POSIXError:(id)arg8;	// IMP=0x000000000001e403
