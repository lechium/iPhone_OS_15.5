...
- (void).cxx_destruct;	// IMP=0x00000000000f0a2f
...
- (id)initWithGuid:(id)arg1 success:(_Bool)arg2 connectionType:(unsigned int)arg3 resultCode:(unsigned int)arg4 registrationError:(unsigned int)arg5 genericError:(id)arg6 URLError:(id)arg7 POSIXError:(id)arg8;	// IMP=0x00000000000f08e8
