...
- (void).cxx_destruct;	// IMP=0x000000000002ba65
- (id)chunkDataIntoMessageContent:(id)arg1;	// IMP=0x000000000002b86a
- (id)initWithWorkQueue:(id)arg1 maxDataLength:(long long)arg2;	// IMP=0x000000000002b7f4
