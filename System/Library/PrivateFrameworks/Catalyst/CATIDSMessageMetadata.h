...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0000000000001f10
- (void).cxx_destruct;	// IMP=0x00000000000020c6
...
- (id)initWithMessageType:(long long)arg1;	// IMP=0x0000000000001d2e
- (id)initWithMessageIdentifier:(id)arg1 messageType:(long long)arg2 messagingVersion:(long long)arg3;	// IMP=0x0000000000001cad
