...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0000000000041aa2
- (void).cxx_destruct;	// IMP=0x0000000000041b18
...
- (id)initWithConnectionIdentifier:(id)arg1;	// IMP=0x0000000000041965
