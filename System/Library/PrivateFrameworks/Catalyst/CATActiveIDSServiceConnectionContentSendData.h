...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x000000000000d4b9
- (void).cxx_destruct;	// IMP=0x000000000000d7bf
...
- (id)initWithSequenceNumber:(id)arg1 dataNumber:(unsigned long long)arg2 dataSegment:(id)arg3 segmentRange:(struct _NSRange)arg4 segmentNumber:(unsigned long long)arg5 totalSegments:(unsigned long long)arg6;	// IMP=0x000000000000d1d5
