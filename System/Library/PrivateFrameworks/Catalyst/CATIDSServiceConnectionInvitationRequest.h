...
- (void).cxx_destruct;	// IMP=0x0000000000022315
...
- (id)initWithInvitationIdentifier:(id)arg1 appleID:(id)arg2 networkPowerAssertion:(id)arg3 userInfo:(id)arg4;	// IMP=0x00000000000221e5
