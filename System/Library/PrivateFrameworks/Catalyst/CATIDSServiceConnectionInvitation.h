...
- (id)initWithConnectionIdentifier:(id)arg1 senderAppleID:(id)arg2 senderAddress:(id)arg3 networkPowerAssertion:(id)arg4 messagingVersion:(unsigned long long)arg5 userInfo:(id)arg6;	// IMP=0x00000000000421cd
- (id)initWithSenderAppleID:(id)arg1 senderAddress:(id)arg2 networkPowerAssertion:(id)arg3 messagingVersion:(unsigned long long)arg4 userInfo:(id)arg5;	// IMP=0x00000000000420e5
