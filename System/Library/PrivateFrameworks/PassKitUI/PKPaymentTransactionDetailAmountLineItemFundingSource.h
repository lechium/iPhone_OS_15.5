...
- (void).cxx_destruct;	// IMP=0x0000000000475f2f
...
- (id)initWithAmount:(id)arg1 credentialType:(long long)arg2 dpanSuffix:(id)arg3 cardDescription:(id)arg4;	// IMP=0x0000000000475c78
- (id)initWithAmount:(id)arg1 transactionSourceCollection:(id)arg2;	// IMP=0x0000000000475b26
