...
- (void)_finishProcessingAndNotify;	// IMP=0x000000000000de84
- (void)_showOrHideBacklinkIndicatorForDomainIdentifiers:(id)arg1 linkedIdentifiers:(id)arg2;	// IMP=0x000000000000dbba
- (void)_searchBacklinksForInputUserActivity;	// IMP=0x000000000000d6f3
- (void)beginProcessing;	// IMP=0x000000000000d626
@property(readonly, nonatomic) long long type;
- (id)description;	// IMP=0x000000000000d4ce
- (id)initWithDelegate:(id)arg1 processingQueue:(id)arg2 inputUserActivityInfo:(id)arg3 processIdentifier:(int)arg4;	// IMP=0x000000000000d3f0
