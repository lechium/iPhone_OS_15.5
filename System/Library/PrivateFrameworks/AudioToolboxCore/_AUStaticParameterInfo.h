...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000107b00
- (void).cxx_destruct;	// IMP=0x0000000000107ad8
...
- (void)dealloc;	// IMP=0x00000000001079e9
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000010772f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001075f9
