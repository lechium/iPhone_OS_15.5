...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002056cc
- (void)setPatternPropertiesFromStroke:(id)arg1;	// IMP=0x00000000002056b9
- (void)setPropertiesFromStroke:(id)arg1;	// IMP=0x00000000002056a6
