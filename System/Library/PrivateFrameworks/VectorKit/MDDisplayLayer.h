...
- (id).cxx_construct;	// IMP=0x00000000006a910e
- (void).cxx_destruct;	// IMP=0x00000000006a8e77
...
- (struct __IOSurface *)flipImage;	// IMP=0x00000000006a8e37
- (void *)debugConsoleForId:(int)arg1;	// IMP=0x00000000006a8d7c
- (struct CGPoint)convertPoint:(struct CGPoint)arg1 toLayer:(id)arg2;	// IMP=0x00000000006a8d66
@property(readonly, nonatomic) float averageFPS;
- (void)renderWithTimestamp:(double)arg1 completion:(function_2e574590)arg2;	// IMP=0x00000000006a86b1
- (_Bool)hasRenderTarget;	// IMP=0x00000000006a86a3
- (void)destroyRenderTarget;	// IMP=0x00000000006a8604
- (void)createRenderTarget;	// IMP=0x00000000006a855e
...
- (void)didEnterBackground;	// IMP=0x00000000006a836d
- (void)didReceiveMemoryWarning;	// IMP=0x00000000006a8367
- (shared_ptr_fa6aa836)bitmapData;	// IMP=0x00000000006a82e7
- (void)_didReadPixels:(void *)arg1;	// IMP=0x00000000006a81bc
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x00000000006a7b07
- (void)setBackgroundColor:(struct CGColor *)arg1;	// IMP=0x00000000006a7af1
- (void)setContentsGravity:(id)arg1;	// IMP=0x00000000006a7adb
- (void)setOpaque:(_Bool)arg1;	// IMP=0x00000000006a7ac5
- (void)setNeedsDisplayOnBoundsChange:(_Bool)arg1;	// IMP=0x00000000006a7aaf
- (void)expandedPerformanceHUD:(id)arg1;	// IMP=0x00000000006a7a72
- (void)disablePerformanceHUD:(id)arg1;	// IMP=0x00000000006a7a5b
- (void)enablePerformanceHUD:(id)arg1;	// IMP=0x00000000006a7a41
@property(readonly, nonatomic) void *renderer;
- (void)didPresent;	// IMP=0x00000000006a7843
- (void)willPresent;	// IMP=0x00000000006a77b4
- (void)didUpdateFrameTexture;	// IMP=0x00000000006a7725
- (void)willUpdateFrameTexture;	// IMP=0x00000000006a7696
- (void)drawToTexture:(void *)arg1 withRenderQueue:(void *)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006a73d8
- (void)drawToTexture:(void *)arg1 withRenderQueue:(void *)arg2;	// IMP=0x00000000006a73c3
- (void *)_renderQueueForTimestamp:(double)arg1 prepareHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000006a738f
- (void *)renderQueueForTimestamp:(double)arg1;	// IMP=0x00000000006a7363
- (_Bool)isDelayedRenderQueueConsumptionSupported;	// IMP=0x00000000006a734d
- (void)prepareTargetsForPlatormsWithoutFramebufferFetch:(const void *)arg1 isDrawable:(_Bool)arg2;	// IMP=0x00000000006a65f8
- (void)prepareTargetsForPlatormsWithFramebufferFetch:(const void *)arg1;	// IMP=0x00000000006a61e1
- (void)_prepareTexture:(const void *)arg1 isDrawable:(_Bool)arg2;	// IMP=0x00000000006a612b
- (void)prepareTexture:(const void *)arg1;	// IMP=0x00000000006a6114
- (void)dealloc;	// IMP=0x00000000006a5f83
- (id)initWithContentScale:(double)arg1 useMultisampling:(_Bool)arg2 extraColorFormats:(const void *)arg3 shouldRasterize:(_Bool)arg4 allowBlitToDrawable:(_Bool)arg5 taskContext:(const void *)arg6 device:(void *)arg7 sharedResources:(id)arg8 signpostId:(unsigned long long)arg9;	// IMP=0x00000000006a5826
