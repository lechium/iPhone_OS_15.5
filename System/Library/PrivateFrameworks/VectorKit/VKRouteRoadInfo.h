...
- (id).cxx_construct;	// IMP=0x0000000000594427
...
- (void)dealloc;	// IMP=0x00000000005943bf
- (id)initWithName:(id)arg1 shieldGroup:(id)arg2 offset:(struct PolylineCoordinate)arg3;	// IMP=0x000000000059434f
