...
- (void)_rotateToHeadingAnimated:(_Bool)arg1 duration:(double)arg2;	// IMP=0x0000000000755b7c
- (void)_goToAnnotationAnimated:(_Bool)arg1 duration:(double)arg2 timingFunction:(CDUnknownBlockType)arg3 isInitial:(_Bool)arg4;	// IMP=0x0000000000754838
- (Matrix_443f5d51)_centerCursor;	// IMP=0x0000000000754717
- (void)setEdgeInsets:(struct VKEdgeInsets)arg1;	// IMP=0x00000000007546cc
- (struct VKEdgeInsets)_effectiveEdgeInsets;	// IMP=0x00000000007545f9
- (Matrix_443f5d51)_nonOffsetCenterCursor;	// IMP=0x0000000000754540
- (void)dealloc;	// IMP=0x00000000007544c3
- (id)init;	// IMP=0x000000000075447c
