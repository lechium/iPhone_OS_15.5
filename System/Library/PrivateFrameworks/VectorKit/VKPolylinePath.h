...
- (id).cxx_construct;	// IMP=0x00000000002f49db
- (void).cxx_destruct;	// IMP=0x00000000002f49a1
...
- (id)description;	// IMP=0x00000000002f48ed
- (Matrix_811b2232)convertCoordinateToTile:(const CDStruct_071ac149 *)arg1;	// IMP=0x00000000002f481e
@property(readonly) _Bool isMapMatched;
@property(readonly) _Bool hasCompletedMapMatching;
- (float)laneHalfWidthAtIndex:(unsigned int)arg1;	// IMP=0x00000000002f47f4
...
- (const struct GradientTraffic *)gradientTrafficAtIndex:(unsigned int)arg1;	// IMP=0x00000000002f47bb
- (void)dealloc;	// IMP=0x00000000002f4780
- (id)initWithOverlay:(id)arg1 section:(id)arg2 routeStartIndex:(unsigned int)arg3 routeEndIndex:(unsigned int)arg4 matchedPathSegments:(id)arg5;	// IMP=0x00000000002f3e2f
- (id)initWithOverlay:(id)arg1 section:(id)arg2 matchedPathSegments:(id)arg3;	// IMP=0x00000000002f3da8
