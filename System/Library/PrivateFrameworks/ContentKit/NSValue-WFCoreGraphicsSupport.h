...
+ (id)wf_valueWithCGAffineTransform:(struct CGAffineTransform)arg1;	// IMP=0x0000000000053ddb
+ (id)wf_valueWithCGRect:(struct CGRect)arg1;	// IMP=0x0000000000053dc9
+ (id)wf_valueWithCGSize:(struct CGSize)arg1;	// IMP=0x0000000000053db7
+ (id)wf_valueWithCGVector:(struct CGVector)arg1;	// IMP=0x0000000000053da5
+ (id)wf_valueWithCGPoint:(struct CGPoint)arg1;	// IMP=0x0000000000053d93
