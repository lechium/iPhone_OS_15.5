...
- (void)setHeaderValue:(id)arg1 forHeaderKey:(id)arg2;	// IMP=0x0000000000021c82
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000021b77
- (id)initWithStatusCode:(long long)arg1 headerFields:(id)arg2 body:(id)arg3;	// IMP=0x0000000000021aa2
- (id)init;	// IMP=0x00000000000219fa
