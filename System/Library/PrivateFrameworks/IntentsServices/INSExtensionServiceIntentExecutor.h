...
- (void).cxx_destruct;	// IMP=0x0000000000005c08
...
- (void)sendAceCommand:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000056f1
- (id)initWithIntent:(id)arg1 extensionProxy:(id)arg2 queue:(id)arg3;	// IMP=0x0000000000005641
- (id)initWithVoiceShortcutClient:(id)arg1 intent:(id)arg2;	// IMP=0x00000000000055a8
