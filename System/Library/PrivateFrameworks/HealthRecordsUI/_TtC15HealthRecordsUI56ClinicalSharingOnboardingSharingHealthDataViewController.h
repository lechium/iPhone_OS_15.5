...
- (void).cxx_destruct;	// IMP=0x00000000001cb6a0
- (id)initWithTitle:(id)arg1 detailText:(id)arg2 icon:(id)arg3 contentLayout:(long long)arg4;	// IMP=0x00000000001cb630
- (void)cancelButtonTapped:(id)arg1;	// IMP=0x00000000001cc890
- (void)doneButtonTapped:(id)arg1;	// IMP=0x00000000001cb5c0
- (void)viewDidLoad;	// IMP=0x00000000001c6090
