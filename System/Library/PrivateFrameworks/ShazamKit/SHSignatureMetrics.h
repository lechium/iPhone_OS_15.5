...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000875d
- (void).cxx_destruct;	// IMP=0x0000000000008b2d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000008a21
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000008973
@property(readonly, nonatomic) double sessionDuration;
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000087e5
- (id)initWithSessionStartDate:(id)arg1;	// IMP=0x0000000000008765
