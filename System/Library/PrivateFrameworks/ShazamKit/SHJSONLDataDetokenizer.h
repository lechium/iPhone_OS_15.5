...
- (void).cxx_destruct;	// IMP=0x000000000001755b
...
- (_Bool)closeWithError:(id *)arg1;	// IMP=0x0000000000017422
- (_Bool)processData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001719b
- (_Bool)writeDataToDelegate:(id)arg1 withError:(id *)arg2;	// IMP=0x0000000000016f65
