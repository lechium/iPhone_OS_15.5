...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000009ea10
- (id).cxx_construct;	// IMP=0x000000000009eaa0
- (void).cxx_destruct;	// IMP=0x000000000009ea40
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009dfa0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009daf0
- (struct CGPath *)newEstimatedBaselineForSubStrokes:(id)arg1 tokens:(id)arg2 tokenSubStrokeIndexes:(id)arg3 estimatedDescenderLocations:(id)arg4;	// IMP=0x000000000009ba50
- (const struct CGPath *)newEstimatedBaselineForStrokesWithTokens:(id)arg1 tokenStrokeIdentifiers:(id)arg2;	// IMP=0x000000000009b140
- (id)coalescedLastSubstrokes;	// IMP=0x000000000009b120
- (long long)lastSubstrokeIndexBeforeMerge;	// IMP=0x000000000009b100
- (struct CGVector)averageStrokeDeviation;	// IMP=0x000000000009b0e0
- (struct CGVector)averageWritingOrientation;	// IMP=0x000000000009b0c0
- (struct CGVector)localWritingOrientationAtStrokeIndex:(long long)arg1;	// IMP=0x000000000009b0a0
- (void *)localStrokeWritingOrientations;	// IMP=0x000000000009b090
- (id)writingDirectionSortedSubstrokes;	// IMP=0x000000000009b070
- (id)groupByAddingStrokeIdentifiers:(id)arg1 removingStrokeIdentifiers:(id)arg2 firstStrokeIdentifier:(id)arg3 lastStrokeIdentifier:(id)arg4 bounds:(struct CGRect)arg5 writingDirectionSortedSubstrokes:(id)arg6 averageWritingOrientation:(struct CGVector)arg7 averageStrokeDeviation:(struct CGVector)arg8 writingDirectionSortedStrokeIdentifiers:(id)arg9 localStrokeWritingOrientations:(const void *)arg10 coalescedLastSubstrokes:(id)arg11 groupingConfidence:(double)arg12 lastSubstrokeIndexBeforeMerge:(long long)arg13 firstStrokeOrigin:(struct CGPoint)arg14;	// IMP=0x000000000009ae60
