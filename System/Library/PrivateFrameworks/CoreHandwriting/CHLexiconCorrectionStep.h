...
- (void).cxx_destruct;	// IMP=0x000000000017ce10
...
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x000000000017b160
- (id)createPseudoTokensFromToken:(id)arg1;	// IMP=0x000000000017a6e0
- (id)applyCorrectionsAcrossToken:(id)arg1 isFirstToken:(_Bool)arg2 contextBeforeToken:(id)arg3 shouldCapitalizeGivenHistory:(_Bool)arg4 textReplacements:(id)arg5 isSingleIsolatedCharacter:(_Bool)arg6;	// IMP=0x0000000000179d10
- (id)applyCorrectionsOnSingleToken:(id)arg1 isFirstToken:(_Bool)arg2 contextBeforeToken:(id)arg3 shouldCapitalizeGivenHistory:(_Bool)arg4 textReplacements:(id)arg5 isSingleIsolatedCharacter:(_Bool)arg6 allowSpellChecker:(_Bool)arg7;	// IMP=0x0000000000178a10
- (id)applyLexiconCorrections:(id)arg1 shouldCapitalizeWord:(_Bool)arg2 shouldSkipEntryCorrection:(_Bool)arg3 outBestTokenIndex:(long long *)arg4 bestLexiconTokenScore:(double *)arg5 textReplacements:(id)arg6 contextBeforeToken:(id)arg7 allowSpellChecker:(_Bool)arg8;	// IMP=0x0000000000177a10
- (id)getSpellCorrectedToken:(id)arg1 contextBeforeToken:(id)arg2;	// IMP=0x0000000000177530
- (void)dealloc;	// IMP=0x0000000000177450
- (id)initWithAutoCapitalizationMode:(int)arg1 shouldAutoCorrect:(_Bool)arg2 shouldAutoCapitalize:(_Bool)arg3 locale:(id)arg4 staticLexicon:(struct _LXLexicon *)arg5 customLexicon:(struct _LXLexicon *)arg6 phraseLexicon:(struct _LXLexicon *)arg7 customPhraseLexicon:(struct _LXLexicon *)arg8 spellChecker:(id)arg9 lmVocabulary:(void *)arg10 ovsStringChecker:(id)arg11 textReplacements:(id)arg12;	// IMP=0x00000000001771d0
