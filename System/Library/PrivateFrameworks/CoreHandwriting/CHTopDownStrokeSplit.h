...
+ (id)writingDirectionOrderedStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2;	// IMP=0x00000000000d8020
- (void).cxx_destruct;	// IMP=0x00000000000d8450
...
- (long long)_substrokeCountForStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2;	// IMP=0x00000000000d7da0
- (id)initWithStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2 splitIndex:(long long)arg3;	// IMP=0x00000000000d7860
