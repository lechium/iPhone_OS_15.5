...
+ (unsigned long long)characterTypeFromString:(id)arg1;	// IMP=0x00000000001430e0
+ (unsigned long long)characterType:(unsigned int)arg1;	// IMP=0x0000000000142f90
+ (unsigned long long)expectedMaxDotCount:(unsigned int)arg1;	// IMP=0x0000000000142e40
+ (unsigned long long)expectedMinStrokeCount:(unsigned int)arg1;	// IMP=0x0000000000142cf0
+ (unsigned long long)expectedMaxStrokeCount:(unsigned int)arg1;	// IMP=0x0000000000142ba0
+ (id)sharedCharacterSetRules;	// IMP=0x0000000000142b30
- (id).cxx_construct;	// IMP=0x0000000000145690
- (void).cxx_destruct;	// IMP=0x00000000001454b0
...
- (unsigned long long)_expectedMaxDotCount:(unsigned int)arg1;	// IMP=0x0000000000144d90
- (unsigned long long)_characterType:(unsigned int)arg1;	// IMP=0x00000000001446b0
- (unsigned long long)_expectedMinStrokeCount:(unsigned int)arg1;	// IMP=0x0000000000144110
- (unsigned long long)_expectedMaxStrokeCount:(unsigned int)arg1;	// IMP=0x0000000000143920
- (id)init;	// IMP=0x0000000000143200
