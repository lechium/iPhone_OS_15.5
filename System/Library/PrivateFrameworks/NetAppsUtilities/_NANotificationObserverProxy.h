...
- (void).cxx_destruct;	// IMP=0x0000000000017fb8
...
- (void)invalidate;	// IMP=0x0000000000017eea
- (void)performObserverBlock;	// IMP=0x0000000000017e91
- (id)initWithWeakObserver:(id)arg1 notificationName:(id)arg2 observerQueue:(id)arg3 observerBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000017c49
