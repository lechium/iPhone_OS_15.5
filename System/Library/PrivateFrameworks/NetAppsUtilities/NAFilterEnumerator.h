...
- (void).cxx_destruct;	// IMP=0x0000000000003ba4
...
- (id)allObjects;	// IMP=0x0000000000003adb
- (id)nextObject;	// IMP=0x0000000000003a08
- (id)initWithEnumerator:(id)arg1 filter:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003953
