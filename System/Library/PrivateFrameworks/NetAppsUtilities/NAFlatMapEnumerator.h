...
- (id)allObjects;	// IMP=0x0000000000003d2d
- (id)nextObject;	// IMP=0x0000000000003c8a
- (id)initWithEnumerator:(id)arg1 map:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003bd5
