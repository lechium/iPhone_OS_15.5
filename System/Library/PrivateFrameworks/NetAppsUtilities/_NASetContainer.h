...
+ (id)containerWithObject:(id)arg1 atIndex:(unsigned long long)arg2 comparator:(CDUnknownBlockType)arg3 hashGenerator:(CDUnknownBlockType)arg4;	// IMP=0x0000000000004925
- (void).cxx_destruct;	// IMP=0x0000000000004c4a
...
- (unsigned long long)hash;	// IMP=0x0000000000004b24
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000049f1
