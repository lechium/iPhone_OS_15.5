...
- (void).cxx_destruct;	// IMP=0x0000000000061090
@property(readonly) NSObject<OS_nw_path_flow> *internalPathFlow; // @synthesize internalPathFlow=_internalPathFlow;
- (id)privateDescription;	// IMP=0x0000000000061040
- (id)description;	// IMP=0x0000000000061020
- (id)descriptionWithIndent:(int)arg1 showFullContent:(_Bool)arg2;	// IMP=0x0000000000060c30
...
- (id)initWithPathFlow:(id)arg1;	// IMP=0x0000000000060210
