...
- (double)scaleValue:(long long)arg1;	// IMP=0x00000000000054fe
- (unsigned int)cookie;	// IMP=0x00000000000054f4
- (void)setValueRef:(struct __IOHIDValue *)arg1;	// IMP=0x00000000000054e7
- (struct __IOHIDValue *)valueRef;	// IMP=0x00000000000054dd
- (id)description;	// IMP=0x000000000000541e
@end
