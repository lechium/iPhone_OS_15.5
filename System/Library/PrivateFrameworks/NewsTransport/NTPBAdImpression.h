...
@interface NTPBAdImpression : PBCodable <NSCopying>
{
    ...
    int _adCreativeType;	// 16 = 0x10
    NSString *_adImpressionId;	// 24 = 0x18
    int _adImpressionTimeThreshold;	// 32 = 0x20
    int _adLocation;	// 36 = 0x24
    int _adType;	// 40 = 0x28
    ...
    NSString *_iadAd;	// 104 = 0x68
    NSString *_iadCampaign;	// 112 = 0x70
    NSString *_iadLine;	// 120 = 0x78
    int _newsProductType;	// 128 = 0x80
...
- (void).cxx_destruct;	// IMP=0x0000000000249eda
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000249a64
- (unsigned long long)hash;	// IMP=0x0000000000249772
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002492fc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000248fb4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000248d01
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000248cf4
- (id)dictionaryRepresentation;	// IMP=0x0000000000247a01
- (id)description;	// IMP=0x0000000000247952
@property(readonly, nonatomic) _Bool hasPreviousArticleId;
@property(readonly, nonatomic) _Bool hasGroupViewExposureId;
- (int)StringAsGroupType:(id)arg1;	// IMP=0x00000000002473d0
- (id)groupTypeAsString:(int)arg1;	// IMP=0x0000000000247131
...
- (int)StringAsFeedType:(id)arg1;	// IMP=0x0000000000246c64
- (id)feedTypeAsString:(int)arg1;	// IMP=0x0000000000246ae8
@property(nonatomic) _Bool hasFeedType;
@property(nonatomic) int feedType; // @synthesize feedType=_feedType;
- (int)StringAsVideoAdType:(id)arg1;	// IMP=0x00000000002469eb
- (id)videoAdTypeAsString:(int)arg1;	// IMP=0x0000000000246985
@property(nonatomic) _Bool hasVideoAdType;
@property(nonatomic) int videoAdType; // @synthesize videoAdType=_videoAdType;
- (int)StringAsNewsProductType:(id)arg1;	// IMP=0x0000000000246884
- (id)newsProductTypeAsString:(int)arg1;	// IMP=0x000000000024681e
...
- (int)StringAsAdLocation:(id)arg1;	// IMP=0x00000000002466c4
- (id)adLocationAsString:(int)arg1;	// IMP=0x000000000024662c
@property(nonatomic) _Bool hasAdLocation;
@property(nonatomic) int adLocation; // @synthesize adLocation=_adLocation;
- (int)StringAsAdCreativeType:(id)arg1;	// IMP=0x0000000000246514
- (id)adCreativeTypeAsString:(int)arg1;	// IMP=0x0000000000246495
...
- (int)StringAsAdType:(id)arg1;	// IMP=0x00000000002463cb
- (id)adTypeAsString:(int)arg1;	// IMP=0x0000000000246376
