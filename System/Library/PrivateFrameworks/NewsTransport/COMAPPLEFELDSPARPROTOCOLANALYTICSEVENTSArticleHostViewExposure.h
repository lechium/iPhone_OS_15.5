...
@interface COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSArticleHostViewExposure : PBCodable <NSCopying>
{
    ...
    COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSAlternateHeadline *_alternateHeadline;	// 136 = 0x88
    ...
    COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSChannelData *_channelData;	// 232 = 0xe8
    ...
    COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueData *_issueData;	// 424 = 0x1a8
    COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueExposureData *_issueExposureData;	// 432 = 0x1b0
    COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueViewContextData *_issueViewContextData;	// 440 = 0x1b8
    COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueViewData *_issueViewData;	// 448 = 0x1c0
    ...
    COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSWidgetEngagement *_widgetEngagement;	// 768 = 0x300
...
+ (Class)purchaseOffersItemType;	// IMP=0x00000000001d79aa
+ (Class)topicIdsType;	// IMP=0x00000000001d78d8
+ (Class)surfacedByTagIdsType;	// IMP=0x00000000001d6c78
+ (Class)fractionalCohortMembershipType;	// IMP=0x00000000001d547c
+ (Class)namedEntitiesType;	// IMP=0x00000000001d3412
- (void).cxx_destruct;	// IMP=0x00000000001ea6f9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001e7fb5
- (unsigned long long)hash;	// IMP=0x00000000001e5f30
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001e3f7f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001e2251
- (void)copyTo:(id)arg1;	// IMP=0x00000000001e0c20
- (void)writeTo:(id)arg1;	// IMP=0x00000000001df4a9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001df49c
- (id)dictionaryRepresentation;	// IMP=0x00000000001d7a6a
- (id)description;	// IMP=0x00000000001d79bb
- (id)purchaseOffersItemAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001d798d
- (unsigned long long)purchaseOffersItemsCount;	// IMP=0x00000000001d7970
- (void)addPurchaseOffersItem:(id)arg1;	// IMP=0x00000000001d7906
- (void)clearPurchaseOffersItems;	// IMP=0x00000000001d78e9
- (id)topicIdsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001d78bb
- (unsigned long long)topicIdsCount;	// IMP=0x00000000001d789e
- (void)addTopicIds:(id)arg1;	// IMP=0x00000000001d7834
- (void)clearTopicIds;	// IMP=0x00000000001d7817
...
- (int)StringAsHeroArticleType:(id)arg1;	// IMP=0x00000000001d767c
- (id)heroArticleTypeAsString:(int)arg1;	// IMP=0x00000000001d75fc
...
- (int)StringAsRole:(id)arg1;	// IMP=0x00000000001d7404
- (id)roleAsString:(int)arg1;	// IMP=0x00000000001d7346
...
- (int)StringAsArticleSuggestionOrigin:(id)arg1;	// IMP=0x00000000001d70d3
- (id)articleSuggestionOriginAsString:(int)arg1;	// IMP=0x00000000001d706d
...
- (int)StringAsGroupLocation:(id)arg1;	// IMP=0x00000000001d6f08
- (id)groupLocationAsString:(int)arg1;	// IMP=0x00000000001d6e88
@property(nonatomic) _Bool hasGroupLocation;
@property(nonatomic) int groupLocation; // @synthesize groupLocation=_groupLocation;
- (int)StringAsCuratedContentType:(id)arg1;	// IMP=0x00000000001d6d7b
- (id)curatedContentTypeAsString:(int)arg1;	// IMP=0x00000000001d6d15
...
- (id)surfacedByTagIdsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001d6c5b
- (unsigned long long)surfacedByTagIdsCount;	// IMP=0x00000000001d6c3e
- (void)addSurfacedByTagIds:(id)arg1;	// IMP=0x00000000001d6bd4
- (void)clearSurfacedByTagIds;	// IMP=0x00000000001d6bb7
- (int)StringAsPreviousWebEmbedLocation:(id)arg1;	// IMP=0x00000000001d6b25
- (id)previousWebEmbedLocationAsString:(int)arg1;	// IMP=0x00000000001d6abf
...
- (int)StringAsModuleLocation:(id)arg1;	// IMP=0x00000000001d68d4
- (id)moduleLocationAsString:(int)arg1;	// IMP=0x00000000001d686e
...
- (int)StringAsModuleEventType:(id)arg1;	// IMP=0x00000000001d6761
- (id)moduleEventTypeAsString:(int)arg1;	// IMP=0x00000000001d66fb
...
- (int)StringAsFeedAutoSubscribeType:(id)arg1;	// IMP=0x00000000001d62f8
- (id)feedAutoSubscribeTypeAsString:(int)arg1;	// IMP=0x00000000001d6292
...
- (int)StringAsGroupFormationReason:(id)arg1;	// IMP=0x00000000001d616c
- (id)groupFormationReasonAsString:(int)arg1;	// IMP=0x00000000001d60ed
...
- (int)StringAsFeedSubscriptionOrigin:(id)arg1;	// IMP=0x00000000001d5e68
- (id)feedSubscriptionOriginAsString:(int)arg1;	// IMP=0x00000000001d5d9d
...
- (int)StringAsGroupPresentationReason:(id)arg1;	// IMP=0x00000000001d5914
- (id)groupPresentationReasonAsString:(int)arg1;	// IMP=0x00000000001d583c
...
- (int)StringAsTopStoryType:(id)arg1;	// IMP=0x00000000001d567e
- (id)topStoryTypeAsString:(int)arg1;	// IMP=0x00000000001d5618
...
- (id)fractionalCohortMembershipAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001d545f
- (unsigned long long)fractionalCohortMembershipsCount;	// IMP=0x00000000001d5442
- (void)addFractionalCohortMembership:(id)arg1;	// IMP=0x00000000001d53d8
- (void)clearFractionalCohortMemberships;	// IMP=0x00000000001d53bb
@property(nonatomic) _Bool hasWidgetArticleRank;
@property(nonatomic) _Bool hasWidgetSectionArticleRank;
- (int)StringAsWidgetSection:(id)arg1;	// IMP=0x00000000001d523c
- (id)widgetSectionAsString:(int)arg1;	// IMP=0x00000000001d51af
...
- (int)StringAsLoadFailureReason:(id)arg1;	// IMP=0x00000000001d5070
- (id)loadFailureReasonAsString:(int)arg1;	// IMP=0x00000000001d4ff2
...
- (int)StringAsNextArticleAffordanceType:(id)arg1;	// IMP=0x00000000001d4c14
- (id)nextArticleAffordanceTypeAsString:(int)arg1;	// IMP=0x00000000001d4af5
...
- (int)StringAsPaidSubscriberToFeedType:(id)arg1;	// IMP=0x00000000001d4850
- (id)paidSubscriberToFeedTypeAsString:(int)arg1;	// IMP=0x00000000001d47d3
...
- (int)StringAsCoverArticleFeatureType:(id)arg1;	// IMP=0x00000000001d46ac
- (id)coverArticleFeatureTypeAsString:(int)arg1;	// IMP=0x00000000001d462d
...
- (int)StringAsGroupType:(id)arg1;	// IMP=0x00000000001d3d58
- (id)groupTypeAsString:(int)arg1;	// IMP=0x00000000001d3aba
...
- (int)StringAsPreviousArticleHostViewTypeIfSwipe:(id)arg1;	// IMP=0x00000000001d37e5
- (id)previousArticleHostViewTypeIfSwipeAsString:(int)arg1;	// IMP=0x00000000001d377f
...
- (int)StringAsArticleType:(id)arg1;	// IMP=0x00000000001d3534
- (id)articleTypeAsString:(int)arg1;	// IMP=0x00000000001d349a
@property(nonatomic) _Bool hasArticleType;
@property(nonatomic) int articleType; // @synthesize articleType=_articleType;
- (id)namedEntitiesAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001d33f5
- (unsigned long long)namedEntitiesCount;	// IMP=0x00000000001d33d8
- (void)addNamedEntities:(id)arg1;	// IMP=0x00000000001d336e
- (void)clearNamedEntities;	// IMP=0x00000000001d3351
...
- (int)StringAsParentFeedType:(id)arg1;	// IMP=0x00000000001d2c98
- (id)parentFeedTypeAsString:(int)arg1;	// IMP=0x00000000001d2b1a
...
- (int)StringAsFeedCellHostType:(id)arg1;	// IMP=0x00000000001d2844
- (id)feedCellHostTypeAsString:(int)arg1;	// IMP=0x00000000001d2718
...
- (int)StringAsFeedPresentationReason:(id)arg1;	// IMP=0x00000000001d20b0
- (id)feedPresentationReasonAsString:(int)arg1;	// IMP=0x00000000001d1dc1
...
- (int)StringAsArticleViewPresentationReason:(id)arg1;	// IMP=0x00000000001d1928
- (id)articleViewPresentationReasonAsString:(int)arg1;	// IMP=0x00000000001d172a
...
- (int)StringAsArticleHostViewType:(id)arg1;	// IMP=0x00000000001d1404
- (id)articleHostViewTypeAsString:(int)arg1;	// IMP=0x00000000001d1343
