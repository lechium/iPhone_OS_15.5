...
- (void).cxx_destruct;	// IMP=0x000000000002c2af
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002c186
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002c042
...
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002bcd0
- (id)initWithModel:(id)arg1;	// IMP=0x000000000002bc51
- (id)initWithContentsOfURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002ba9e
