...
- (void).cxx_destruct;	// IMP=0x000000000006f6f8
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000006f49f
- (id)initWithFrame:(struct CGRect)arg1 shadowImage:(id)arg2;	// IMP=0x000000000006f40f
