...
{
    SOAuthorizationParametersCore *_authorizationParametersCore;	// 8 = 0x8
    NSString *_impersonationBundleIdentifier;	// 16 = 0x10
}

- (void).cxx_destruct;	// IMP=0x00000000000094e8
...
- (id)init;	// IMP=0x0000000000008e4a
