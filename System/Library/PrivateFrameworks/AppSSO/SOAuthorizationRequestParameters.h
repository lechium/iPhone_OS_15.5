...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000b1b7
- (void).cxx_destruct;	// IMP=0x000000000000c4be
...
- (id)description;	// IMP=0x000000000000c101
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000bc57
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000b3ff
- (id)initWithAuthorizationRequestParametersCore:(id)arg1;	// IMP=0x000000000000b1bf
