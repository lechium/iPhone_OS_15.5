...
+ (id)defaultConfiguration;	// IMP=0x000000000001bc95
- (void).cxx_destruct;	// IMP=0x000000000001c045
...
- (id)initWithSubsystem:(id)arg1 category:(id)arg2;	// IMP=0x000000000001bbc8
