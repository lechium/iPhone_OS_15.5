...
{
    WBSParsecLegacySearchResult *_legacySearchResult;	// 8 = 0x8
}

+ (long long)typeForSFSearchResult:(id)arg1 isOneLine:(_Bool)arg2;	// IMP=0x0000000000116fce
+ (long long)typeForSFSearchResult:(id)arg1;	// IMP=0x0000000000116fb3
- (void).cxx_destruct;	// IMP=0x00000000001181a4
...
- (id)_resultPresentedInCard;	// IMP=0x0000000000118159
- (id)_sportsResult;	// IMP=0x000000000011814b
- (id)_simpleResult;	// IMP=0x000000000011813d
- (id)_mapsResult;	// IMP=0x000000000011812f
- (id)_genericResult;	// IMP=0x0000000000118121
- (id)_result;	// IMP=0x0000000000118113
...
- (id)titleGlyphWithSession:(id)arg1;	// IMP=0x0000000000117f50
...
- (id)thumbnailWithSession:(id)arg1;	// IMP=0x0000000000117bd1
...
- (id)completionIconWithSession:(id)arg1;	// IMP=0x00000000001178f2
- (id)iconWithSession:(id)arg1;	// IMP=0x000000000011786f
...
- (_Bool)canBecomeTopHitForQuery:(id)arg1;	// IMP=0x00000000001176e4
...
- (id)initWithLegacySearchResult:(id)arg1;	// IMP=0x0000000000116e61
- (id)init;	// IMP=0x0000000000116e53
