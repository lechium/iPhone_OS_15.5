...
- (void).cxx_destruct;	// IMP=0x00000000008d5779
...
- (_Bool)matchesAccessoryServer:(id)arg1;	// IMP=0x00000000008d540e
- (_Bool)matchesUnpairedAccessory:(id)arg1;	// IMP=0x00000000008d533f
- (id)description;	// IMP=0x00000000008d5185
- (id)initWithAccessoryDescription:(id)arg1 linkType:(long long)arg2 needsUserConsent:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4 progressHandler:(CDUnknownBlockType)arg5 wiFiPSK:(id)arg6 country:(id)arg7;	// IMP=0x00000000008d4ebe
- (id)initWithAccessoryUUID:(id)arg1 accessoryName:(id)arg2 linkType:(long long)arg3 setupCode:(id)arg4 completionHandler:(CDUnknownBlockType)arg5 setupCodeProvider:(CDUnknownBlockType)arg6 wiFiPSK:(id)arg7 country:(id)arg8;	// IMP=0x00000000008d4cf4
