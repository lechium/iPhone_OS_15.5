...
+ (id)logCategory;	// IMP=0x0000000000aaca1f
- (void).cxx_destruct;	// IMP=0x0000000000aac9bb
...
- (id)logIdentifier;	// IMP=0x0000000000aac8da
- (id)negotiatedParameters;	// IMP=0x0000000000aac787
- (id)initWithSessionID:(id)arg1 streamingTierType:(unsigned long long)arg2 remoteCapabilities:(id)arg3 streamPreference:(id)arg4;	// IMP=0x0000000000aac400
