...
- (void).cxx_destruct;	// IMP=0x000000000083e700
...
- (void)__cleanupMirroredZones:(id)arg1 cloudZones:(id)arg2 result:(id)arg3 error:(id)arg4;	// IMP=0x000000000083e0c3
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000083dcba
- (void)markZonesDeleted;	// IMP=0x000000000083dca9
- (void)markZonesChanged;	// IMP=0x000000000083dc98
- (id)initWithActivity:(id)arg1 options:(id)arg2 databaseChangeToken:(id)arg3 promise:(id)arg4 xpcActivity:(id)arg5 database:(id)arg6 useAnonymousRequests:(_Bool)arg7 recordIDs:(id)arg8 lastSynchronizedRecordIDs:(id)arg9;	// IMP=0x000000000083d5dc
