...
+ (id)logCategory;	// IMP=0x0000000000b8d3a8
- (void).cxx_destruct;	// IMP=0x0000000000b8d160
...
- (void)handleServicesUpdated:(id)arg1;	// IMP=0x0000000000b8d02a
- (void)handleCharacteristicsUpdated:(id)arg1;	// IMP=0x0000000000b8cfb9
- (void)_notifyDelegate;	// IMP=0x0000000000b8cde3
- (id)_accessoryCharacteristicsToObserve;	// IMP=0x0000000000b8ca1b
- (void)_registerForNotifications;	// IMP=0x0000000000b8c933
- (void)start;	// IMP=0x0000000000b8c8d3
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 interestedCharacteristicTypesByServiceType:(id)arg3;	// IMP=0x0000000000b8c6f1
