...
+ (id)logCategory;	// IMP=0x00000000005ff131
- (void).cxx_destruct;	// IMP=0x00000000005ff0e2
...
- (id)callerVersionForMessage:(id)arg1;	// IMP=0x00000000005feee0
- (unsigned long long)dataSourceCallerPrivilegeWithMessage:(id)arg1 error:(id *)arg2;	// IMP=0x00000000005fecf7
- (void)handleAccessorySettingsUpdateRequestMessage:(id)arg1;	// IMP=0x00000000005fe63e
- (id)siriAvailableLanguagesSetting;	// IMP=0x00000000005fe5b1
- (void)handleAccessorySettingsFetchRequestMessage:(id)arg1;	// IMP=0x00000000005fddcf
- (id)initWithHomeUUID:(id)arg1 languageValuesDataProvider:(id)arg2;	// IMP=0x00000000005fdd2d
