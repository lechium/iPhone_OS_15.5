...
+ (id)logCategory;	// IMP=0x00000000005fa348
- (void).cxx_destruct;	// IMP=0x00000000005fa2f5
...
- (void)dealloc;	// IMP=0x00000000005fa17f
- (id)logIdentifier;	// IMP=0x00000000005fa12f
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2;	// IMP=0x00000000005f9f8f
