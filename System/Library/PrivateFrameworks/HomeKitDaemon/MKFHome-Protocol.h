...
@class CLLocation, HMDHomeNFCReaderKey, HMDNaturalLightingContext, HMFSoftwareVersion, MKFHomeDatabaseID, NSArray, NSData, NSDate, NSNumber, NSString, NSUUID, Protocol;
@protocol MKFAccessory, MKFAccessoryNetworkProtectionGroup, MKFActionSet, MKFAirPlayAccessory, MKFAppleMediaAccessory, MKFAppleMediaAccessoryResident, MKFApplicationData, MKFDevice, MKFEventTrigger, MKFHAPAccessory, MKFHomeMediaSetting, MKFHomeNetworkRouterManagingDeviceSetting, MKFHomeNetworkRouterSetting, MKFHomePersonManagerSetting, MKFHomeSoftwareUpdateSetting, MKFHomeThreadNetwork, MKFMediaGroup, MKFOutgoingInvitation, MKFResident, MKFRoom, MKFServiceGroup, MKFTimerTrigger, MKFTrigger, MKFUser, MKFZone;
...
- (id <MKFAppleMediaAccessoryResident>)findResidentsRelationOfTypeAppleMediaAccessoryResidentWithModelID:(NSUUID *)arg1;
- (id <MKFAppleMediaAccessoryResident>)materializeOrCreateResidentsRelationOfTypeAppleMediaAccessoryResidentWithModelID:(NSUUID *)arg1 createdNew:(_Bool *)arg2;
- (id <MKFResident>)materializeOrCreateResidentsRelationOfType:(Protocol *)arg1 modelID:(NSUUID *)arg2 createdNew:(_Bool *)arg3;
- (id <MKFAccessoryNetworkProtectionGroup>)materializeOrCreateNetworkProtectionGroupRelation:(_Bool *)arg1;
- (void)synchronizeMediaGroupsRelationWith:(NSArray *)arg1;
- (id <MKFMediaGroup>)findMediaGroupsRelationWithModelID:(NSUUID *)arg1;
- (id <MKFMediaGroup>)materializeOrCreateMediaGroupsRelationWithModelID:(NSUUID *)arg1 createdNew:(_Bool *)arg2;
