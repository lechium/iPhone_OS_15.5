...
- (void).cxx_destruct;	// IMP=0x00000000001eb93e
...
- (id)description;	// IMP=0x00000000001eb744
- (id)initWithGroup:(id)arg1 record:(id)arg2 data:(id)arg3 encoding:(unsigned long long)arg4 uuid:(id)arg5;	// IMP=0x00000000001eb632
