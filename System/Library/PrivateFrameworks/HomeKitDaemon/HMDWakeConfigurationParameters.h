...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000b3c2fa
- (void).cxx_destruct;	// IMP=0x0000000000b3c2c7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b3becb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b3be13
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000b3b853
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000b3b369
- (id)initWithDelimiter:(id)arg1 primaryIdentifier:(id)arg2 secondaryIdentifier:(id)arg3;	// IMP=0x0000000000b3b29f
- (id)init;	// IMP=0x0000000000b3b270
