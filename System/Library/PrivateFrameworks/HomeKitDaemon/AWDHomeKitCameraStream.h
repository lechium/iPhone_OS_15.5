...
+ (Class)resolutionCountType;	// IMP=0x00000000004478dd
+ (Class)reconfigurationsType;	// IMP=0x00000000004478cc
- (void).cxx_destruct;	// IMP=0x0000000000446ddd
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000446629
- (unsigned long long)hash;	// IMP=0x000000000044633b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000445e89
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000044587e
- (void)copyTo:(id)arg1;	// IMP=0x00000000004454ac
- (void)writeTo:(id)arg1;	// IMP=0x0000000000445019
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000044500c
- (id)dictionaryRepresentation;	// IMP=0x000000000044450d
- (id)description;	// IMP=0x000000000044445e
- (id)resolutionCountAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000444441
- (unsigned long long)resolutionCountsCount;	// IMP=0x0000000000444424
- (void)addResolutionCount:(id)arg1;	// IMP=0x00000000004443ba
- (void)clearResolutionCounts;	// IMP=0x000000000044439d
- (int)StringAsResolutionOnClose:(id)arg1;	// IMP=0x00000000004441fc
- (id)resolutionOnCloseAsString:(int)arg1;	// IMP=0x0000000000444122
...
- (id)reconfigurationsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000443ed3
- (unsigned long long)reconfigurationsCount;	// IMP=0x0000000000443eb6
- (void)addReconfigurations:(id)arg1;	// IMP=0x0000000000443e4c
- (void)clearReconfigurations;	// IMP=0x0000000000443e2f
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x0000000000443c48
- (id)certifiedAsString:(int)arg1;	// IMP=0x0000000000443be2
