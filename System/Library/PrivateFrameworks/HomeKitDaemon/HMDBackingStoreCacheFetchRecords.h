...
- (void).cxx_destruct;	// IMP=0x00000000001ec6d2
...
- (id)mainReturningError;	// IMP=0x00000000001ec04b
- (id)initWithGroup:(id)arg1 records:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x00000000001ebf6a
- (id)initWithGroup:(id)arg1 parentUuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x00000000001ebe89
- (id)initWithGroup:(id)arg1 uuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x00000000001ebda8
