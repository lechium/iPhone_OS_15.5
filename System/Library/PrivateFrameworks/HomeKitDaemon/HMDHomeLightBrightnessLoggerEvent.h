...
+ (id)eventWithData:(id)arg1 dataVersion:(unsigned int)arg2;	// IMP=0x000000000046f32a
- (void).cxx_destruct;	// IMP=0x000000000046f2d7
...
- (id)proto;	// IMP=0x000000000046f1fe
- (id)initWithProtoData:(id)arg1;	// IMP=0x000000000046f162
- (id)initWithProto:(id)arg1;	// IMP=0x000000000046f01e
- (id)encodeAsProto;	// IMP=0x000000000046efce
- (id)serialize;	// IMP=0x000000000046efbc
@property(readonly, nonatomic) unsigned int dataVersion;
- (id)initWithHomeUUID:(id)arg1 accessoryUUID:(id)arg2 characteristicUUID:(id)arg3 brightness:(id)arg4;	// IMP=0x000000000046eeba
