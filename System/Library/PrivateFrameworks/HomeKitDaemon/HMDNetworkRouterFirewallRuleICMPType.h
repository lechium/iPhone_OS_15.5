...
+ (id)createListWithJSONDictionary:(id)arg1 key:(id)arg2;	// IMP=0x000000000082f4e9
+ (id)createWithJSONDictionary:(id)arg1;	// IMP=0x000000000082f2ed
- (void).cxx_destruct;	// IMP=0x000000000082f2c5
...
- (id)description;	// IMP=0x000000000082f152
@property(readonly, nonatomic) NSDictionary *prettyJSONDictionary;
- (id)initWithJSONDictionary:(id)arg1 protocol:(unsigned char)arg2 typeValue:(id)arg3;	// IMP=0x000000000082efa5
