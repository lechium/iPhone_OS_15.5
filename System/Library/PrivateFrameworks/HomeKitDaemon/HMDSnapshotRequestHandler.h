...
+ (id)logCategory;	// IMP=0x0000000000b83e40
- (void).cxx_destruct;	// IMP=0x0000000000b81544
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000b81395
- (void)streamSnapshotHandler:(id)arg1 didGetLastSnapshot:(id)arg2;	// IMP=0x0000000000b8129e
- (void)streamSnapshotHandler:(id)arg1 didGetNewSnapshot:(id)arg2;	// IMP=0x0000000000b811a7
- (void)requestSnapshot:(id)arg1 streamingTierType:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000b81001
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 streamSnapshotHandler:(id)arg3 imageCacheDirectory:(id)arg4 logID:(id)arg5;	// IMP=0x0000000000b80e9f
