...
+ (id)logCategory;	// IMP=0x000000000024b20b
+ (void)_clearAllPendingRequests:(id)arg1 error:(id)arg2;	// IMP=0x000000000024b0f7
+ (void)_clearAllGeneratedRequests:(id)arg1 error:(id)arg2;	// IMP=0x000000000024aea8
+ (id)createResponseSubset:(id)arg1 overallError:(id)arg2 readRequest:(id)arg3 error:(id *)arg4;	// IMP=0x000000000024a586
+ (void)_processResponseForMultireadRequest:(id)arg1 overallError:(id)arg2 response:(id)arg3;	// IMP=0x000000000024a04b
- (void).cxx_destruct;	// IMP=0x000000000024944e
...
- (id)logIdentifier;	// IMP=0x0000000000249327
- (void)_processResponse:(id)arg1 overallError:(id)arg2 messageIdentifier:(id)arg3;	// IMP=0x0000000000248e29
- (void)_sendMultipleCharacteristicRead;	// IMP=0x0000000000247fb9
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000247f08
- (void)redispatchMessage:(id)arg1 target:(id)arg2 responseQueue:(id)arg3;	// IMP=0x0000000000247dad
- (long long)preferredDeviceType;	// IMP=0x0000000000247cad
@property(readonly, nonatomic) HMDDevice *preferredDevice;
- (id)deviceForType:(long long)arg1;	// IMP=0x0000000000247bf5
- (_Bool)containsDevice:(id)arg1;	// IMP=0x0000000000247a08
- (void)removeDeviceForType:(long long)arg1;	// IMP=0x0000000000247863
- (void)setDevice:(id)arg1 forType:(long long)arg2;	// IMP=0x0000000000247778
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000247531
- (id)initWithHome:(id)arg1 remoteDispatcher:(id)arg2;	// IMP=0x000000000024739e
