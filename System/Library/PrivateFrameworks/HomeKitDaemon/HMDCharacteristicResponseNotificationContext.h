...
+ (id)updateMultipleCharacteristicReadWriteResponsePayload:(id)arg1 withUnhandledRequests:(id)arg2;	// IMP=0x0000000000b13a97
+ (id)notificationUpdateMessagePayloadForHome:(id)arg1 notificationEnabled:(_Bool)arg2 characteristics:(id)arg3 characteristicsErrorsMap:(id)arg4;	// IMP=0x0000000000b13315
+ (id)responsePayloadForHome:(id)arg1 changedAccessories:(id)arg2 moreMessagesInMultipart:(id)arg3;	// IMP=0x0000000000b131bc
- (void).cxx_destruct;	// IMP=0x0000000000b13169
...
- (id)notificationWithHome:(id)arg1;	// IMP=0x0000000000b12f84
- (id)initWithRequestIdentifier:(id)arg1 responses:(id)arg2 pendingMultiPartResponses:(_Bool)arg3;	// IMP=0x0000000000b12075
