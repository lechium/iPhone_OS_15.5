...
- (void).cxx_destruct;	// IMP=0x000000000052958d
...
- (double)getTimeDurationForLongestProgressState;	// IMP=0x000000000052946a
- (void)updateWithProgressState:(id)arg1 date:(id)arg2;	// IMP=0x0000000000528e29
- (id)initWithDate:(id)arg1;	// IMP=0x0000000000528da4
