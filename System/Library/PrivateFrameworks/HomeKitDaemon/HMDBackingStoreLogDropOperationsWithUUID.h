...
- (void).cxx_destruct;	// IMP=0x0000000000831fe2
...
- (id)mainReturningError;	// IMP=0x00000000008319e7
- (id)initWithUUID:(id)arg1 pushingTo:(unsigned long long)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000083193f
