...
- (id)hm_decodeSetOfConditionalObjects:(Class)arg1 forKey:(id)arg2;	// IMP=0x000000000066d26b
- (void)hm_encodeSetOfConditionalObjects:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000066cfdf
- (id)hm_decodeArrayOfConditionalObjects:(Class)arg1 forKey:(id)arg2;	// IMP=0x000000000066ce88
- (void)hm_encodeArrayOfConditionalObjects:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000066cbfc
- (_Bool)hmd_isHH2MigrationInProgress;	// IMP=0x000000000095889e
