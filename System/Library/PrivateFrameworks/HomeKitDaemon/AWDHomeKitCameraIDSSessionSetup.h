...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000032d6a1
- (unsigned long long)hash;	// IMP=0x000000000032d626
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000032d52f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000032d480
- (void)copyTo:(id)arg1;	// IMP=0x000000000032d3f4
- (void)writeTo:(id)arg1;	// IMP=0x000000000032d345
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000032d338
- (id)dictionaryRepresentation;	// IMP=0x000000000032d193
- (id)description;	// IMP=0x000000000032d0e4
