...
- (void).cxx_destruct;	// IMP=0x00000000001ea5dd
...
- (id)mainReturningError;	// IMP=0x00000000001ea2c4
- (id)initWithGroup:(id)arg1 serverChangeToken:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000001ea20b
