...
- (void).cxx_destruct;	// IMP=0x0000000000b371ba
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)_handleFetchSleepWakeStateMessage:(id)arg1;	// IMP=0x0000000000b36e04
- (void)fetchSleepWakeStateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b36917
- (void)configureWithHome:(id)arg1 messageDispatcher:(id)arg2 workQueue:(id)arg3;	// IMP=0x0000000000b366d6
- (id)initWithAccessoryUUID:(id)arg1 dataSource:(id)arg2;	// IMP=0x0000000000b3661a
