...
- (void).cxx_destruct;	// IMP=0x000000000022eee1
...
- (id)description;	// IMP=0x000000000022ee42
- (void)dealloc;	// IMP=0x000000000022ed52
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000022ec80
