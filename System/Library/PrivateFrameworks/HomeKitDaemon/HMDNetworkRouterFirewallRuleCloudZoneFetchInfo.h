...
+ (id)logCategory;	// IMP=0x000000000089d790
- (void).cxx_destruct;	// IMP=0x000000000089d73d
...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000089d63f
- (id)initWithOptions:(id)arg1 changeToken:(id)arg2 promise:(id)arg3 database:(id)arg4 useAnonymousRequests:(_Bool)arg5 interestedRecordIDs:(id)arg6 mirrorInput:(id)arg7;	// IMP=0x000000000089d482
