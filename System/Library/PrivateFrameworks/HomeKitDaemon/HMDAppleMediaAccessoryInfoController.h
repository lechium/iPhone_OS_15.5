...
- (void).cxx_destruct;	// IMP=0x00000000005b88b7
...
- (void)_postUpdateWifiNetworkInfoIfDifferent:(id)arg1;	// IMP=0x00000000005b86be
- (id)currentWifiNetworkInfo;	// IMP=0x00000000005b85ef
- (void)handleCurrentNetworkChangedNotification:(id)arg1;	// IMP=0x00000000005b83c6
- (void)configure;	// IMP=0x00000000005b82c1
- (id)initWithQueue:(id)arg1 dataSource:(id)arg2 notificationCenter:(id)arg3 wifiManager:(id)arg4;	// IMP=0x00000000005b81e4
