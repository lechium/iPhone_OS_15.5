...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x0000000000643e4f
- (void).cxx_destruct;	// IMP=0x00000000003be618
...
- (id)initWithRole:(long long)arg1 setupStartTime:(id)arg2 setupEndTime:(id)arg3 configurationEndTime:(id)arg4 setupSessionError:(id)arg5 category:(id)arg6 retryCount:(unsigned long long)arg7 firstSettingTime:(id)arg8 languageSettingTime:(id)arg9;	// IMP=0x00000000003be345
