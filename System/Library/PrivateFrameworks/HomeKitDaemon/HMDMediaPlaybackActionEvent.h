...
- (void).cxx_destruct;	// IMP=0x00000000006afacd
...
- (id)initWithIsPlaybackArchivePresent:(_Bool)arg1 playbackStateNumber:(id)arg2 volumeNumber:(id)arg3 sourceNumber:(id)arg4 sourceClientName:(id)arg5 accessories:(id)arg6;	// IMP=0x00000000006af595
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x000000000001e6b6
- (unsigned long long)microLocationScanTriggerTypeForLogEventObserver:(id)arg1;	// IMP=0x0000000000051c90
- (_Bool)shouldTriggerMicroLocationRecordingScanForLogEventObserver:(id)arg1;	// IMP=0x0000000000051bfc
- (_Bool)shouldTriggerMicroLocationLocalizationScanForLogEventObserver:(id)arg1;	// IMP=0x0000000000051b68
- (id)microLocationMetadataForLogEventObserver:(id)arg1;	// IMP=0x00000000000518ef
