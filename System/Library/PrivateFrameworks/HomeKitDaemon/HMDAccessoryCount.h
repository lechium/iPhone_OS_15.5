...
- (void).cxx_destruct;	// IMP=0x00000000004af53f
@property __weak HMDHome *home; // @synthesize home=_home;
- (unsigned long long)numHAPAccessoriesWithAnyServiceWithTypes:(id)arg1;	// IMP=0x00000000004af37e
...
- (id)initWithHome:(id)arg1;	// IMP=0x00000000004aef72
