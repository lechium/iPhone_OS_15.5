...
- (void).cxx_destruct;	// IMP=0x0000000000b2b0e8
...
- (void)rejectBulkSendSessionWithStatus:(unsigned short)arg1;	// IMP=0x0000000000b2b037
- (void)acceptBulkSendSessionOnQueue:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x0000000000b2afae
- (id)initWithProtocol:(id)arg1 requestHeader:(id)arg2 metadata:(id)arg3;	// IMP=0x0000000000b2aecf
