...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000007afdb5
- (void).cxx_destruct;	// IMP=0x00000000007afd73
...
- (id)attributeDescriptions;	// IMP=0x00000000007afa87
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000007af9ab
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000007af891
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007af6a8
@property(readonly, nonatomic, getter=isNotAtHome) _Bool notAtHome;
@property(readonly, nonatomic, getter=isAtHome) _Bool atHome;
- (id)initWithUser:(id)arg1 presenceRegionStatus:(id)arg2 timeStamp:(id)arg3;	// IMP=0x00000000007af3a1
- (id)initWithUser:(id)arg1 presenceRegionStatus:(id)arg2;	// IMP=0x00000000007af305
