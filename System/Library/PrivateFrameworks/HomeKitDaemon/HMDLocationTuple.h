...
- (void).cxx_destruct;	// IMP=0x00000000002fe7e6
...
- (id)attributeDescriptions;	// IMP=0x00000000002fe566
- (id)initWithLocation:(id)arg1 reachableIPAccessoryCount:(unsigned long long)arg2 reachableBTLEAccessoryCount:(unsigned long long)arg3 reachableMediaAccessoryCount:(unsigned long long)arg4;	// IMP=0x00000000002fe4a4
