...
+ (id)logCategory;	// IMP=0x00000000003b6c20
- (void).cxx_destruct;	// IMP=0x00000000003b6bcf
...
- (id)description;	// IMP=0x00000000003b6aaa
- (id)logIdentifier;	// IMP=0x00000000003b6a9d
@property(readonly, nonatomic) NSMutableDictionary *userInfo; // @synthesize userInfo=_userInfo;
- (void)invokePostApplyActions;	// IMP=0x00000000003b68dd
- (_Bool)addPostApplyActionIfNotPresent:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000003b6806
- (void)addPostApplyActionUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000003b6751
- (void)markSaveToSharedUserAccount;	// IMP=0x00000000003b6740
- (void)markSaveToAssistant;	// IMP=0x00000000003b672f
- (void)markChanged;	// IMP=0x00000000003b671e
- (void)markLocalChanged;	// IMP=0x00000000003b670d
- (id)initWithBackingStore:(id)arg1 options:(id)arg2;	// IMP=0x00000000003b65e9
