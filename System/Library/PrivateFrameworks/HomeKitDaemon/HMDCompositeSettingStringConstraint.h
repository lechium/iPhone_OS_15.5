...
- (void).cxx_destruct;	// IMP=0x000000000068720a
@property(copy) NSSet *validValues; // @synthesize validValues=_validValues;
- (id)initWithValidValues:(id)arg1;	// IMP=0x0000000000687169
- (_Bool)isValidValue:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000687161
