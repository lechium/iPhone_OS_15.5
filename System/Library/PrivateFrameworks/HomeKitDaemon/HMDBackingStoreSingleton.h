...
+ (id)logCategory;	// IMP=0x00000000009c4ab9
+ (void)resetSchemaHash;	// IMP=0x00000000009c49a1
+ (void)resetClassMappings;	// IMP=0x00000000009c4889
+ (void)setClass:(Class)arg1 forClassName:(id)arg2;	// IMP=0x00000000009c4771
+ (id)sharedInstance;	// IMP=0x00000000009c4657
+ (void)start;	// IMP=0x00000000009c453f
+ (id)dataVersion;	// IMP=0x00000000009c4526
- (void).cxx_destruct;	// IMP=0x00000000009c44a2
...
- (id)logIdentifier;	// IMP=0x00000000009c4402
- (void)setHomeManager:(id)arg1;	// IMP=0x00000000009c42d5
- (id)resetBackingStore;	// IMP=0x00000000009c41bb
- (id)flushBackingStore;	// IMP=0x00000000009c40a1
- (id)schemaHashForObject:(id)arg1;	// IMP=0x00000000009c3f52
- (id)init;	// IMP=0x00000000009c3d08
