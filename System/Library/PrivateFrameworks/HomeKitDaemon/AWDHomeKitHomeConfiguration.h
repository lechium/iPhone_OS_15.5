...
+ (Class)primaryHAPServicesListCertifiedType;	// IMP=0x000000000062ff99
+ (Class)hapServicesListCertifiedType;	// IMP=0x000000000062ff88
+ (Class)primaryHAPServicesListType;	// IMP=0x000000000062ff77
+ (Class)hapServicesListType;	// IMP=0x000000000062ff66
+ (Class)homeKitMultiUserSettingsType;	// IMP=0x000000000062ff55
+ (Class)eventTriggersType;	// IMP=0x000000000062ff44
- (void).cxx_destruct;	// IMP=0x000000000062c95b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000062aea7
- (unsigned long long)hash;	// IMP=0x000000000062a086
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000628d8c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000627725
- (void)copyTo:(id)arg1;	// IMP=0x0000000000626442
- (void)writeTo:(id)arg1;	// IMP=0x0000000000624f42
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000624f35
- (id)dictionaryRepresentation;	// IMP=0x0000000000622105
- (id)description;	// IMP=0x0000000000622056
...
- (int)StringAsCurrentMediaAccessoryFallbackMediaUserType:(id)arg1;	// IMP=0x0000000000621b29
- (id)currentMediaAccessoryFallbackMediaUserTypeAsString:(int)arg1;	// IMP=0x0000000000621ac2
...
- (id)primaryHAPServicesListCertifiedAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000621186
- (unsigned long long)primaryHAPServicesListCertifiedsCount;	// IMP=0x0000000000621169
- (void)addPrimaryHAPServicesListCertified:(id)arg1;	// IMP=0x00000000006210ff
- (void)clearPrimaryHAPServicesListCertifieds;	// IMP=0x00000000006210e2
- (id)hapServicesListCertifiedAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006210c5
- (unsigned long long)hapServicesListCertifiedsCount;	// IMP=0x00000000006210a8
- (void)addHapServicesListCertified:(id)arg1;	// IMP=0x000000000062103e
- (void)clearHapServicesListCertifieds;	// IMP=0x0000000000621021
- (id)primaryHAPServicesListAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000621004
- (unsigned long long)primaryHAPServicesListsCount;	// IMP=0x0000000000620fe7
- (void)addPrimaryHAPServicesList:(id)arg1;	// IMP=0x0000000000620f7d
- (void)clearPrimaryHAPServicesLists;	// IMP=0x0000000000620f60
- (id)hapServicesListAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000620f43
- (unsigned long long)hapServicesListsCount;	// IMP=0x0000000000620f26
- (void)addHapServicesList:(id)arg1;	// IMP=0x0000000000620ebc
- (void)clearHapServicesLists;	// IMP=0x0000000000620e9f
...
- (id)homeKitMultiUserSettingsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000620c77
- (unsigned long long)homeKitMultiUserSettingsCount;	// IMP=0x0000000000620c5a
- (void)addHomeKitMultiUserSettings:(id)arg1;	// IMP=0x0000000000620bf0
- (void)clearHomeKitMultiUserSettings;	// IMP=0x0000000000620bd3
...
- (int)StringAsNetworkProtectionStatus:(id)arg1;	// IMP=0x000000000062087f
- (id)networkProtectionStatusAsString:(int)arg1;	// IMP=0x0000000000620819
...
- (id)eventTriggersAtIndex:(unsigned long long)arg1;	// IMP=0x00000000006201ba
- (unsigned long long)eventTriggersCount;	// IMP=0x000000000062019d
- (void)addEventTriggers:(id)arg1;	// IMP=0x0000000000620133
- (void)clearEventTriggers;	// IMP=0x0000000000620116
