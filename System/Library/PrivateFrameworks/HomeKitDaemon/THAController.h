...
+ (id)selectButtonConfiguration:(id)arg1 supportsSiri:(_Bool)arg2;	// IMP=0x00000000007554f8
- (void).cxx_destruct;	// IMP=0x00000000007554d0
...
- (_Bool)dispatchButtonEvent:(id)arg1;	// IMP=0x000000000075540c
- (void)updateSelectedButtons:(id)arg1;	// IMP=0x00000000007553fa
- (id)initWithName:(id)arg1 identifier:(unsigned int)arg2 ticksPerSecond:(unsigned long long)arg3 supportedButtons:(id)arg4 supportsSiri:(_Bool)arg5;	// IMP=0x000000000075530e
