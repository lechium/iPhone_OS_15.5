...
- (void).cxx_destruct;	// IMP=0x0000000000989d93
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000989cca
- (id)initWithTimeoutTimer:(id)arg1 workQueue:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000989bac
