...
- (void).cxx_destruct;	// IMP=0x00000000009f5f74
...
- (id)initWithCameraSessionID:(id)arg1 changedCharacteristics:(id)arg2 timeInterval:(double)arg3;	// IMP=0x00000000009f5e7f
