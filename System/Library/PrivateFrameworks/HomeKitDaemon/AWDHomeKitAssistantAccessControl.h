...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000995a4e
- (unsigned long long)hash;	// IMP=0x00000000009959b6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000995886
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009957b6
- (void)copyTo:(id)arg1;	// IMP=0x0000000000995709
- (void)writeTo:(id)arg1;	// IMP=0x0000000000995636
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000995629
- (id)dictionaryRepresentation;	// IMP=0x000000000099542d
- (id)description;	// IMP=0x000000000099537e
