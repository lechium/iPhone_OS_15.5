...
- (void).cxx_destruct;	// IMP=0x00000000005d1623
...
- (id)initWithActionSet:(id)arg1 source:(unsigned long long)arg2 numAccessories:(unsigned int)arg3 bundleId:(id)arg4 transactionId:(id)arg5;	// IMP=0x00000000005d10bd
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x0000000000021980
- (unsigned long long)microLocationScanTriggerTypeForLogEventObserver:(id)arg1;	// IMP=0x0000000000052e50
- (_Bool)shouldTriggerMicroLocationRecordingScanForLogEventObserver:(id)arg1;	// IMP=0x0000000000052de2
- (_Bool)shouldTriggerMicroLocationLocalizationScanForLogEventObserver:(id)arg1;	// IMP=0x0000000000052d74
- (id)microLocationMetadataForLogEventObserver:(id)arg1;	// IMP=0x0000000000052b79
- (id)metricForAWD;	// IMP=0x0000000000865957
- (unsigned int)AWDMessageType;	// IMP=0x000000000086594c
