...
- (void).cxx_destruct;	// IMP=0x00000000000678ad
...
- (id)attributeDescriptions;	// IMP=0x0000000000067755
@property(readonly, nonatomic) NSDictionary *serializedEvent;
@property(readonly, nonatomic) NSString *eventName;
- (id)initWithMatchingIdentifiersCount:(long long)arg1;	// IMP=0x00000000000675ae
