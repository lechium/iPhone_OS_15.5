...
- (void).cxx_destruct;	// IMP=0x000000000020142b
...
- (id)description;	// IMP=0x000000000020122d
- (id)initWithName:(id)arg1 readHAPCharacteristic:(id)arg2 writeHAPCharacteristic:(id)arg3 format:(id)arg4;	// IMP=0x000000000020107c
- (id)init;	// IMP=0x0000000000200fd4
