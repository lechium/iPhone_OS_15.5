...
- (void).cxx_destruct;	// IMP=0x0000000000b8ee92
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000b8ed21
- (unsigned long long)hash;	// IMP=0x0000000000b8ec3b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b8eac6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b8e9ab
- (void)copyTo:(id)arg1;	// IMP=0x0000000000b8e8c8
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b8e7db
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b8e7ce
- (id)dictionaryRepresentation;	// IMP=0x0000000000b8e5db
- (id)description;	// IMP=0x0000000000b8e52c
