...
+ (void)load;	// IMP=0x0000000000252dd1
- (void).cxx_destruct;	// IMP=0x0000000000252da0
...
- (id)stringValue;	// IMP=0x0000000000252d24
- (id)numberValue;	// IMP=0x0000000000252c26
- (_Bool)boolValue;	// IMP=0x0000000000252be2
@property(readonly, copy) NSString *propertyDescription;
- (id)initWithKey:(id)arg1 options:(unsigned long long)arg2 defaultValue:(id)arg3;	// IMP=0x00000000002529f0
