...
- (void).cxx_destruct;	// IMP=0x000000000046fcd3
...
- (id)description;	// IMP=0x000000000046fc45
- (void)dealloc;	// IMP=0x000000000046fb55
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3 home:(id)arg4;	// IMP=0x000000000046f957
