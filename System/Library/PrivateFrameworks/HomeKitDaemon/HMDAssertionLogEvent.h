...
- (void).cxx_destruct;	// IMP=0x0000000000245c72
@property(readonly, copy) NSString *reason; // @synthesize reason=_reason;
- (id)description;	// IMP=0x0000000000245c46
- (id)initWithReason:(id)arg1;	// IMP=0x0000000000245ae4
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000b7418d
