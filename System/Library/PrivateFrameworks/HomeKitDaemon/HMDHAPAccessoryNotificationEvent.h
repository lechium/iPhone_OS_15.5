...
- (void).cxx_destruct;	// IMP=0x00000000009cea43
...
- (_Bool)isThreadAccessory:(id)arg1;	// IMP=0x00000000009ce11b
@property(readonly, nonatomic) NSString *eventName;
- (id)initWithAccessory:(id)arg1 characteristic:(id)arg2;	// IMP=0x00000000009ce070
