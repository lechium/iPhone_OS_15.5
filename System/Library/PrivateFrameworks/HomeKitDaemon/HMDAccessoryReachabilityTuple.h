...
+ (id)tupleWithAccessoryUUID:(id)arg1 reachable:(_Bool)arg2;	// IMP=0x00000000000a2d4a
- (void).cxx_destruct;	// IMP=0x00000000000a2d37
...
- (id)description;	// IMP=0x00000000000a2b36
- (unsigned long long)hash;	// IMP=0x00000000000a2af2
