...
- (void).cxx_destruct;	// IMP=0x00000000001edc43
...
- (id)initWithGroup:(id)arg1 recordName:(id)arg2 uuid:(id)arg3 parentUuid:(id)arg4 type:(id)arg5;	// IMP=0x00000000001ed8f4
