...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000007762b
- (void).cxx_destruct;	// IMP=0x00000000000775a5
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000077355
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000076e86
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000076c47
- (_Bool)_parseFromTLVData;	// IMP=0x00000000000768d2
- (id)tlvData;	// IMP=0x00000000000766bb
- (id)initWithPayloadType:(id)arg1 maximumBitrate:(id)arg2 minimumBitrate:(id)arg3 rtcpInterval:(id)arg4 maxMTU:(id)arg5 comfortNoisePayloadType:(id)arg6;	// IMP=0x0000000000076577
