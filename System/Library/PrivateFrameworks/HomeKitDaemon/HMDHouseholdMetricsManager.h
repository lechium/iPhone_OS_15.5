...
+ (id)logCategory;	// IMP=0x0000000000570ce5
- (void).cxx_destruct;	// IMP=0x0000000000570c13
...
- (id)initWithCountersManager:(id)arg1 dataSource:(id)arg2 dailyScheduler:(id)arg3 logEventSubmitter:(id)arg4;	// IMP=0x00000000005708da
