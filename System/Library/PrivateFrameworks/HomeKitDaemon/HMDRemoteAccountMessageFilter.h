...
+ (id)logCategory;	// IMP=0x00000000005e9ff8
- (void).cxx_destruct;	// IMP=0x00000000005e9fa5
...
- (id)logIdentifier;	// IMP=0x00000000005e9eb6
- (_Bool)acceptMessage:(id)arg1 target:(id)arg2 errorReason:(id *)arg3;	// IMP=0x00000000005e9266
- (id)initWithTarget:(id)arg1 whitelistedMessages:(id)arg2 appleAccountManager:(id)arg3 systemKeychainStore:(id)arg4;	// IMP=0x00000000005e9139
- (id)initWithTarget:(id)arg1 whitelistedMessages:(id)arg2;	// IMP=0x00000000005e9079
- (id)initWithTarget:(id)arg1;	// IMP=0x00000000005e9065
- (id)initWithName:(id)arg1;	// IMP=0x00000000005e8faf
