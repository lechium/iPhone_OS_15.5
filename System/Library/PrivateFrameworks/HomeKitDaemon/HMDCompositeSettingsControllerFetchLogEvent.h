...
- (void).cxx_destruct;	// IMP=0x000000000020fa8e
@property(readonly, copy) NSString *keyPath; // @synthesize keyPath=_keyPath;
- (id)dictionaryRepresentation;	// IMP=0x000000000020f8f9
- (id)initWithKeyPath:(id)arg1 date:(id)arg2;	// IMP=0x000000000020f856
