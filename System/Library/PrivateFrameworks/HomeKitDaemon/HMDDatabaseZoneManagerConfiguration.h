...
- (void).cxx_destruct;	// IMP=0x0000000000471564
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000471340
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000471335
- (unsigned long long)hash;	// IMP=0x0000000000471210
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000470f99
- (id)attributeDescriptions;	// IMP=0x0000000000470c8f
- (id)init;	// IMP=0x0000000000470b85
