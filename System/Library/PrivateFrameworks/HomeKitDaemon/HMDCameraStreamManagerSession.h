...
+ (id)logCategory;	// IMP=0x0000000000082509
- (void).cxx_destruct;	// IMP=0x0000000000082494
...
- (id)logIdentifier;	// IMP=0x000000000008239e
- (_Bool)canStartWithError:(id *)arg1;	// IMP=0x00000000000821c9
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 streamSetupTimer:(id)arg5;	// IMP=0x0000000000082034
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 setupWaitPeriod:(double)arg5;	// IMP=0x0000000000081f06
