...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000006edca
- (void).cxx_destruct;	// IMP=0x000000000006ec4d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000006eb37
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006e8c5
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000006e6e9
- (id)tlvData;	// IMP=0x000000000006e52d
- (_Bool)_parseFromTLVData;	// IMP=0x000000000006e2ef
- (id)initWithCodec:(id)arg1 codecParameters:(id)arg2 attributes:(id)arg3;	// IMP=0x000000000006e229
