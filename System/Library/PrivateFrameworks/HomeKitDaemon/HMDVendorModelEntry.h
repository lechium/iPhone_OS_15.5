...
- (void).cxx_destruct;	// IMP=0x0000000000ac2fd2
...
- (unsigned long long)hash;	// IMP=0x0000000000ac2cf2
- (long long)compare:(id)arg1;	// IMP=0x0000000000ac2bfa
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ac285c
- (id)attributeDescriptions;	// IMP=0x0000000000ac2572
- (id)initWithManufacturer:(id)arg1 model:(id)arg2 appBundleID:(id)arg3 appStoreID:(id)arg4 firmwareVersion:(id)arg5 productData:(id)arg6 productDataAlternates:(id)arg7;	// IMP=0x0000000000ac2370
