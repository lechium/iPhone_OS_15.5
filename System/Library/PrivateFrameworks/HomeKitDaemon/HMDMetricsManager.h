...
#import <HomeKitDaemon/HMDHouseholdMetricsDataSource-Protocol.h>
...
+ (id)coreAnalyticsLogEventClasses;	// IMP=0x00000000005a2525
+ (id)namespaceUUID;	// IMP=0x00000000005a24f5
- (void).cxx_destruct;	// IMP=0x00000000005a1cab
...
- (id)homes;	// IMP=0x00000000005a1b4a
- (id)devicesOnCurrentAccount;	// IMP=0x00000000005a1aa9
- (id)currentDeviceProductInfo;	// IMP=0x00000000005a1a08
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
- (id)messageDestination;	// IMP=0x00000000005a194f
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)_handleLogEventDailySchedulerSubmitRequest:(id)arg1;	// IMP=0x00000000005a18b9
- (void)_handleLogEventDailySchedulerStatusRequest:(id)arg1;	// IMP=0x00000000005a1829
- (void)_handleResetEventCounters:(id)arg1;	// IMP=0x00000000005a17ad
- (void)_handleFetchEventCounters:(id)arg1;	// IMP=0x00000000005a161b
- (void)presentRadarDialog:(id)arg1 withPostIntervalLimit:(double)arg2;	// IMP=0x00000000005a1615
- (void)addRateTrigger:(id)arg1 forEventName:(id)arg2 requestGroup:(id)arg3 atThreshold:(unsigned long long)arg4 windowSize:(unsigned long long)arg5;	// IMP=0x00000000005a152e
- (void)addThresholdTrigger:(id)arg1 forEventName:(id)arg2 requestGroup:(id)arg3 atThreshold:(unsigned long long)arg4;	// IMP=0x00000000005a1453
- (void)registerTriggers;	// IMP=0x00000000005a0fac
- (void)startAnalyzers;	// IMP=0x00000000005a07bf
- (void)startCoreAnalyticsObserver:(id)arg1;	// IMP=0x00000000005a072d
- (void)logHomeConfiguration;	// IMP=0x00000000005a06b3
...
- (void)homeKitConfigurationChanged;	// IMP=0x00000000005a04e1
- (id)logHomeKitErrorAggregationSummary;	// IMP=0x00000000005a0491
- (id)logHomeKitAggregationAnalysisSummary;	// IMP=0x00000000005a0441
- (void)resetHomeKitAggregationAnalysisContext;	// IMP=0x00000000005a0314
- (void)populateHomeKitAggregationAnalysisLogEvent:(id)arg1;	// IMP=0x00000000005a01c3
- (id)homeKitAggregationAnalysisLogEvent;	// IMP=0x00000000005a00ef
- (id)currentDataSyncStateDescription;	// IMP=0x00000000005a0058
- (void)submitDailyAggregationAnalysisEvents;	// IMP=0x000000000059ffbf
@property(readonly, nonatomic) NSArray *logEventProviderDailySubmissionBlocks;
- (void)startMetricsCollectionWithDailyScheduler:(id)arg1;	// IMP=0x000000000059fc39
- (void)startMetricsCollection;	// IMP=0x000000000059fbd1
- (void)configureHAPMetricsDispatcher:(id)arg1;	// IMP=0x000000000059fb5f
- (void)_registerForMessages;	// IMP=0x000000000059f865
- (void)addAnalyzer:(id)arg1 toListOfAggregationAnalysisEventContributing:(id)arg2;	// IMP=0x000000000059f7f2
- (id)initWithMessageDispatcher:(id)arg1 logEventDispatcher:(id)arg2 dailyScheduler:(id)arg3 eventCounters:(id)arg4 eventFlags:(id)arg5;	// IMP=0x000000000059f2b3
- (id)init;	// IMP=0x000000000059f1a7
