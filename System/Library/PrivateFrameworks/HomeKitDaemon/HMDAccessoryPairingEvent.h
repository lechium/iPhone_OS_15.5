...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x000000000052d41c
+ (id)removingAccessory:(id)arg1 hapAccessory:(id)arg2;	// IMP=0x000000000052d370
+ (id)pairingAccessory:(id)arg1 home:(id)arg2;	// IMP=0x000000000052d2ea
+ (id)pairingAccessoryWithDescription:(id)arg1 home:(id)arg2;	// IMP=0x000000000052d27a
- (void).cxx_destruct;	// IMP=0x000000000052d17d
...
- (void)submitAtDate:(id)arg1;	// IMP=0x000000000052b5b6
- (void)_updateThreadPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x000000000052b512
- (void)updateEventPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x000000000052b455
- (void)pairedToServer:(id)arg1 certificationStatus:(long long)arg2 addedViaWAC:(_Bool)arg3 legacyWAC:(_Bool)arg4;	// IMP=0x000000000052b1e5
- (void)setAuthenticationMethod:(unsigned long long)arg1;	// IMP=0x000000000052b1d3
- (void)setAddedViaWAC:(_Bool)arg1;	// IMP=0x000000000052b1c1
- (id)initWithAccessoryDescription:(id)arg1 home:(id)arg2;	// IMP=0x000000000052aced
- (id)initWithUnpairedAccessory:(id)arg1 pairedAccessory:(id)arg2 hapAccessory:(id)arg3 home:(id)arg4 isAddOperation:(_Bool)arg5;	// IMP=0x000000000052a538
- (id)metricForAWD;	// IMP=0x0000000000865c19
- (unsigned int)AWDMessageType;	// IMP=0x0000000000865c0e
