...
+ (Class)characteristicsType;	// IMP=0x00000000001fc788
- (void).cxx_destruct;	// IMP=0x00000000001fb9cb
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001fb2c4
- (unsigned long long)hash;	// IMP=0x00000000001faef9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001fa914
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001fa3e6
- (void)copyTo:(id)arg1;	// IMP=0x00000000001fa03a
- (void)writeTo:(id)arg1;	// IMP=0x00000000001f9bd9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001f9bcc
- (id)dictionaryRepresentation;	// IMP=0x00000000001f90c0
- (id)description;	// IMP=0x00000000001f9011
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000001f8c74
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000001f8c0e
@property(nonatomic) _Bool hasCertified;
@property(nonatomic) int certified; // @synthesize certified=_certified;
- (int)StringAsSource:(id)arg1;	// IMP=0x00000000001f8a54
- (id)sourceAsString:(int)arg1;	// IMP=0x00000000001f8995
...
- (int)StringAsTransportType:(id)arg1;	// IMP=0x00000000001f8768
- (id)transportTypeAsString:(int)arg1;	// IMP=0x00000000001f86b7
@property(nonatomic) _Bool hasTransportType;
@property(nonatomic) int transportType; // @synthesize transportType=_transportType;
- (id)characteristicsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001f8630
- (unsigned long long)characteristicsCount;	// IMP=0x00000000001f8613
- (void)addCharacteristics:(id)arg1;	// IMP=0x00000000001f85a9
- (void)clearCharacteristics;	// IMP=0x00000000001f858c
