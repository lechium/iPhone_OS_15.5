...
- (void).cxx_destruct;	// IMP=0x00000000000a309a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000a2fa6
- (id)initWithDevice:(id)arg1 accessoryList:(id)arg2;	// IMP=0x00000000000a2f04
