...
- (void).cxx_destruct;	// IMP=0x000000000090b08f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000090ae80
- (unsigned long long)hash;	// IMP=0x000000000090ad0d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000090aad3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000090a94e
- (void)copyTo:(id)arg1;	// IMP=0x000000000090a7ff
- (void)writeTo:(id)arg1;	// IMP=0x000000000090a695
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000090a688
- (id)dictionaryRepresentation;	// IMP=0x000000000090a2d8
- (id)description;	// IMP=0x000000000090a229
@property(nonatomic) _Bool hasOperationStartTime;
@property(readonly, nonatomic) _Bool hasErrorDomain;
- (int)StringAsOperationType:(id)arg1;	// IMP=0x000000000090a0f8
- (id)operationTypeAsString:(int)arg1;	// IMP=0x000000000090a06c
