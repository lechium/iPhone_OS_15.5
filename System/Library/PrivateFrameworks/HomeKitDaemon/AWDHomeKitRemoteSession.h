...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000006693
- (unsigned long long)hash;	// IMP=0x00000000000065de
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000006491
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000063ac
- (void)copyTo:(id)arg1;	// IMP=0x00000000000062ea
- (void)writeTo:(id)arg1;	// IMP=0x00000000000061fb
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000061ee
- (id)dictionaryRepresentation;	// IMP=0x0000000000005f9d
- (id)description;	// IMP=0x0000000000005eee
