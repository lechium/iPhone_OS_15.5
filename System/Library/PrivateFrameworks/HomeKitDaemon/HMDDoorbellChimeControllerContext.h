...
- (void).cxx_destruct;	// IMP=0x000000000069d92d
...
- (_Bool)accessorySupportsCoordinationDoorbellChime:(id)arg1;	// IMP=0x000000000069d8b3
@property(readonly, copy) NSUUID *currentAccessoryUUID;
- (id)fetchDoorbellDelay;	// IMP=0x000000000069d7cb
- (id)clearCoordinationStateForKeyPaths:(id)arg1;	// IMP=0x000000000069d7b2
- (id)keyPathFromComponents:(id)arg1;	// IMP=0x000000000069d7aa
- (id)postCoordinationState:(id)arg1;	// IMP=0x000000000069d791
...
- (id)postCULiveAction:(id)arg1;	// IMP=0x000000000069d545
...
- (id)initWithWorkQueue:(id)arg1 accessory:(id)arg2;	// IMP=0x000000000069d2d9
