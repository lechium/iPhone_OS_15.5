...
+ (id)__decodeRuleConfigurationWithVersionString:(id)arg1 ruleConfigurationValue:(id)arg2 baseAccessoryIdentifier:(id)arg3;	// IMP=0x00000000009cc0b7
+ (id)__decodeRuleConfigurationsFromJSONDictionary:(id)arg1 baseAccessoryIdentifier:(id)arg2 allowUnzippedData:(_Bool)arg3;	// IMP=0x00000000009cba4e
+ (id)logCategory;	// IMP=0x00000000009cba1e
- (void).cxx_destruct;	// IMP=0x00000000009cb9cb
...
- (id)attributeDescriptions;	// IMP=0x00000000009cb44a
- (id)initWithBaseAccessoryIdentifier:(id)arg1 data:(id)arg2 allowUnzippedData:(_Bool)arg3;	// IMP=0x00000000009cb0d4
- (id)initWithBaseAccessoryIdentifier:(id)arg1 data:(id)arg2;	// IMP=0x00000000009cb0bf
- (id)initWithBaseAccessoryIdentifier:(id)arg1 name:(id)arg2 lastModifiedTime:(id)arg3 ruleConfigurations:(id)arg4;	// IMP=0x00000000009cafb8
