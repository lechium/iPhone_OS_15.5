...
+ (id)__transportProtocolToString:(unsigned char)arg1;	// IMP=0x00000000005f9e99
+ (id)logCategory;	// IMP=0x00000000005f9e69
- (void).cxx_destruct;	// IMP=0x00000000005f9e38
...
- (id)attributeDescriptions;	// IMP=0x00000000005f99d5
- (id)initWithJSONDictionary:(id)arg1 critical:(_Bool)arg2;	// IMP=0x00000000005f9924
- (id)initWithJSONDictionary:(id)arg1 name:(id)arg2 critical:(_Bool)arg3;	// IMP=0x00000000005f9862
