...
+ (id)logCategory;	// IMP=0x00000000004a34d8
- (void).cxx_destruct;	// IMP=0x00000000004a3309
...
- (id)logIdentifier;	// IMP=0x00000000004a324f
- (void)routeSiriEndpointDeleteSiriHistoryMessage:(id)arg1;	// IMP=0x00000000004a30f6
- (void)sendDeleteSiriHistoryRequestForAccessoryWithUUID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000004a2e73
- (void)registerForMessagesWithHome:(id)arg1;	// IMP=0x00000000004a2c60
- (id)initWithIdentifier:(id)arg1 messageDispatcher:(id)arg2 router:(id)arg3 localHandler:(id)arg4;	// IMP=0x00000000004a2b0a
