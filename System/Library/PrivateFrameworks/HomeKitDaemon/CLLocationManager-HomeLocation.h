...
+ (long long)hm_hmdRegionStateFromCLRegionState:(long long)arg1;	// IMP=0x00000000003bed2d
+ (long long)hm_hmdLocationAuthorizationFromCLAuthorizationStatus:(int)arg1;	// IMP=0x00000000003bed08
+ (_Bool)hm_isLocationAllowedForAuthorizationStatus:(int)arg1;	// IMP=0x00000000003becf9
