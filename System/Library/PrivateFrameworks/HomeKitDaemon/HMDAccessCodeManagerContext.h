...
+ (id)logCategory;	// IMP=0x0000000000043495
- (void).cxx_destruct;	// IMP=0x0000000000043304
...
- (id)generateAccessCodeValueFromConstraints:(id)arg1 accessoryAccessCodes:(id)arg2 homeAccessCodes:(id)arg3;	// IMP=0x0000000000043271
- (id)hapAccessoryWithUUID:(id)arg1;	// IMP=0x0000000000043190
...
- (id)userWithUUID:(id)arg1;	// IMP=0x0000000000042f56
- (id)userForMessage:(id)arg1;	// IMP=0x0000000000042ed3
- (void)redispatchToResidentMessage:(id)arg1;	// IMP=0x0000000000042e1f
- (id)_performMockedReadRequests:(id)arg1;	// IMP=0x0000000000042c6e
- (id)performReadRequests:(id)arg1 withRetries:(long long)arg2 timeInterval:(double)arg3 loggingObject:(id)arg4;	// IMP=0x0000000000042ac4
- (id)performWriteRequests:(id)arg1 withRetries:(long long)arg2 timeInterval:(double)arg3 loggingObject:(id)arg4;	// IMP=0x000000000004291a
- (id)_performMockedWriteRequests:(id)arg1;	// IMP=0x0000000000042769
...
- (void)configure;	// IMP=0x0000000000041e28
- (id)initWithHome:(id)arg1 messageDispatcher:(id)arg2 workQueue:(id)arg3 UUID:(id)arg4;	// IMP=0x0000000000041c8a
- (id)initWithHome:(id)arg1 messageDispatcher:(id)arg2 workQueue:(id)arg3;	// IMP=0x0000000000041bab
