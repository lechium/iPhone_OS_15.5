...
+ (unsigned long long)maxOperationDurationSeconds;	// IMP=0x0000000000010af4
+ (unsigned long long)maxRetryCount;	// IMP=0x0000000000010ad6
+ (unsigned long long)__integerForPreferenceKey:(id)arg1 defaultValue:(unsigned long long)arg2;	// IMP=0x00000000000109ef
+ (id)logCategory;	// IMP=0x00000000000109bf
...
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x0000000000010658
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000010641
- (void)finishWithResult:(id)arg1;	// IMP=0x000000000001062d
@property(nonatomic) _Bool shouldRetry;
- (void)dealloc;	// IMP=0x000000000001028f
- (id)initWithActivity:(id)arg1 options:(id)arg2 container:(id)arg3 useAnonymousRequests:(_Bool)arg4 promise:(id)arg5;	// IMP=0x000000000001007b
