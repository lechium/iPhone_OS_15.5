...
+ (id)eventWithBudgetRate:(struct _HMFRate)arg1;	// IMP=0x00000000003b4e6c
@property(readonly, nonatomic) struct _HMFRate budgetRate; // @synthesize budgetRate=_budgetRate;
- (id)initWithBudgetRate:(struct _HMFRate)arg1;	// IMP=0x00000000003b4e01
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000b74145
