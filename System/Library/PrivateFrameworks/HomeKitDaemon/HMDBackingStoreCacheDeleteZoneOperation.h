...
- (void).cxx_destruct;	// IMP=0x00000000001e97ca
...
- (id)mainReturningError;	// IMP=0x00000000001e8d0e
- (id)initWithZone:(id)arg1 resultBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000001e8c83
