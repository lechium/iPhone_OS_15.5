...
- (void).cxx_destruct;	// IMP=0x0000000000994b11
...
- (id)description;	// IMP=0x0000000000994a29
- (id)initWithSnapshotCharacteristicEventUUID:(id)arg1 snapshotFile:(id)arg2 timer:(id)arg3;	// IMP=0x0000000000994963
