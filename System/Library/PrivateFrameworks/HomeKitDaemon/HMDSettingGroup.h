...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000008d303a
- (void).cxx_destruct;	// IMP=0x00000000008d2fe6
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000008d2d18
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000008d2c62
- (void)addGroup:(id)arg1;	// IMP=0x00000000008d2b71
- (void)addSetting:(id)arg1;	// IMP=0x00000000008d2a80
@property(readonly, copy) NSArray *groups;
@property(readonly, copy) NSArray *settings;
- (id)initWithIdentifier:(id)arg1 parentIdentifier:(id)arg2 name:(id)arg3 groups:(id)arg4 settings:(id)arg5;	// IMP=0x00000000008d2864
- (id)initWithModel:(id)arg1;	// IMP=0x00000000008d2749
