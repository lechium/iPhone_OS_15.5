...
+ (id)logCategory;	// IMP=0x00000000006ad6b9
- (void).cxx_destruct;	// IMP=0x00000000006ad505
...
- (void)_generateAllCombinations;	// IMP=0x00000000006ab924
- (id)createReselectedVideoParameters:(id)arg1;	// IMP=0x00000000006ab7b9
- (id)createSelectedVideoParameters;	// IMP=0x00000000006ab3c6
- (id)createSRTPParamters;	// IMP=0x00000000006ab346
- (_Bool)_selectParametersFromCodec:(id)arg1 profiles:(id)arg2 levels:(id)arg3 packetizationModes:(id)arg4 videoAttributes:(id)arg5;	// IMP=0x00000000006aaa62
- (_Bool)selectVideoParameters;	// IMP=0x00000000006a9aae
- (id)logIdentifier;	// IMP=0x00000000006a9a5e
- (void)_setVideoResolutionPreference;	// IMP=0x00000000006a9724
- (id)initWithSessionID:(id)arg1 videoTierParameters:(id)arg2 supportedVideoConfiguration:(id)arg3 supportedRTPConfiguration:(id)arg4 streamingCapabilities:(id)arg5;	// IMP=0x00000000006a9534
