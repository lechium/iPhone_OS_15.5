...
- (void).cxx_destruct;	// IMP=0x00000000007f3dad
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000007f38a2
- (unsigned long long)hash;	// IMP=0x00000000007f353d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007f2f71
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007f2bf6
- (void)copyTo:(id)arg1;	// IMP=0x00000000007f28c7
- (void)writeTo:(id)arg1;	// IMP=0x00000000007f2561
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000007f2554
- (id)dictionaryRepresentation;	// IMP=0x00000000007f1bc6
- (id)description;	// IMP=0x00000000007f1b17
...
- (int)StringAsCredentialType:(id)arg1;	// IMP=0x00000000007f16a7
- (id)credentialTypeAsString:(int)arg1;	// IMP=0x00000000007f1641
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x00000000007f14aa
- (id)certifiedAsString:(int)arg1;	// IMP=0x00000000007f1444
...
- (int)StringAsTransportType:(id)arg1;	// IMP=0x00000000007f1290
- (id)transportTypeAsString:(int)arg1;	// IMP=0x00000000007f11de
