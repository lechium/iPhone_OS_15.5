...
- (void).cxx_destruct;	// IMP=0x000000000088f40e
...
- (id)initWithConfigureState:(long long)arg1 isPrimaryResident:(_Bool)arg2 trustStatusCounts:(struct CloudShareTrustManagerTrustStatusCounts)arg3;	// IMP=0x000000000088f10b
