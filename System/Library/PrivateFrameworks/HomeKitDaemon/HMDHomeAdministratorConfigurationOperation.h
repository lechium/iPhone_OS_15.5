...
+ (id)logCategory;	// IMP=0x00000000007428cf
+ (double)timeout;	// IMP=0x00000000007427f1
- (void).cxx_destruct;	// IMP=0x000000000074261d
...
- (id)logIdentifier;	// IMP=0x00000000007424ee
- (void)main;	// IMP=0x000000000074241d
- (id)initWithMessage:(id)arg1 home:(id)arg2 dispatcher:(id)arg3;	// IMP=0x00000000007422d2
