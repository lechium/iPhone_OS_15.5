...
+ (id)logCategory;	// IMP=0x0000000000257cbb
+ (id)shortDescription;	// IMP=0x0000000000257cae
- (void).cxx_destruct;	// IMP=0x0000000000255c13
...
- (id)setVolumeOnEndpoint:(id)arg1 outputDeviceUID:(id)arg2;	// IMP=0x00000000002555d2
- (id)getVolumeCapabilitiesForEndpoint:(id)arg1 outputDeviceUID:(id)arg2;	// IMP=0x000000000025532f
- (id)connectToEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x0000000000255098
- (id)discoverRemoteControlEndpointsForUIDs:(id)arg1;	// IMP=0x0000000000254eb4
- (_Bool)cancelOnSetup;	// IMP=0x0000000000254905
- (void)generateOverallResultAndFinishWithDeviceStatuses:(id)arg1;	// IMP=0x0000000000253de4
- (void)main;	// IMP=0x0000000000253b7f
- (id)initWithRouteIDs:(id)arg1 volume:(id)arg2;	// IMP=0x0000000000253afb
- (id)initWithRouteIDs:(id)arg1 volume:(id)arg2 externalObjectInterface:(id)arg3;	// IMP=0x00000000002539a6
