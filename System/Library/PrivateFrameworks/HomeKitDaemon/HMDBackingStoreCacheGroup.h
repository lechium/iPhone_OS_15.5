...
- (void).cxx_destruct;	// IMP=0x00000000001e9d12
...
- (id)dumpDebug;	// IMP=0x00000000001e9a83
- (id)initWithGroupID:(long long)arg1 zone:(id)arg2 rootRecord:(id)arg3 serverChangeToken:(id)arg4 subscriptionName:(id)arg5 owner:(id)arg6 subscription:(id)arg7;	// IMP=0x00000000001e9928
