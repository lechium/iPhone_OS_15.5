...
+ (id)logCategory;	// IMP=0x00000000006db0dd
- (void).cxx_destruct;	// IMP=0x00000000006db08a
...
- (id)logIdentifier;	// IMP=0x00000000006dafe2
- (void)startKeepAlive;	// IMP=0x00000000006dafdc
- (void)dealloc;	// IMP=0x00000000006daec3
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2;	// IMP=0x00000000006dad79
