...
- (void).cxx_destruct;	// IMP=0x00000000000252f5
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000024fd5
- (id)description;	// IMP=0x0000000000024ebe
- (id)initWithUser:(id)arg1 presenceAuthStatus:(id)arg2 presenceComputeStatus:(id)arg3 presenceRegion:(id)arg4 reason:(id)arg5;	// IMP=0x0000000000024dad
