...
- (void).cxx_destruct;	// IMP=0x00000000001ee029
...
- (id)mainReturningError;	// IMP=0x00000000001edd63
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x00000000001edca7
