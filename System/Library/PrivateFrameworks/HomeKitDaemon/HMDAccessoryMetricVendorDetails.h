...
+ (unsigned long long)maximumDifferentiationNumber;	// IMP=0x00000000004ed6ff
- (void).cxx_destruct;	// IMP=0x00000000004ed5ec
...
- (id)initWithAccessory:(id)arg1;	// IMP=0x00000000004ed211
