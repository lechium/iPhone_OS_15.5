...
+ (id)rm_createMAIDAccountWithStore:(id)arg1 username:(id)arg2 description:(id)arg3 dsid:(id)arg4 altDSID:(id)arg5 personaIdentifier:(id)arg6 enrollmentURL:(id)arg7;	// IMP=0x00000000000017f3
+ (id)rm_createBearerAccountWithStore:(id)arg1 username:(id)arg2 description:(id)arg3 enrollmentURL:(id)arg4 authToken:(id)arg5;	// IMP=0x000000000000169d
+ (id)rm_createTestAccountWithStore:(id)arg1 username:(id)arg2 description:(id)arg3 enrollmentURL:(id)arg4;	// IMP=0x0000000000001578
- (_Bool)rm_isAccountSchemeMAID;	// IMP=0x0000000000001c82
- (_Bool)rm_isAccountSchemeBearer;	// IMP=0x0000000000001c37
- (_Bool)rm_isAccountSchemeTest;	// IMP=0x0000000000001bec
