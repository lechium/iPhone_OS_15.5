...
@interface FCProxyHeadline : NSProxy <FCHeadlineProviding>
{
    ...
    id <FCHeadlineMetadata> _overrideMetadata;	// 16 = 0x10
    unsigned long long _overrideStoryType;	// 24 = 0x18
    FCTopStoriesStyleConfiguration *_overrideStoryStyle;	// 32 = 0x20
}

- (void).cxx_destruct;	// IMP=0x0000000000166a4d
@property(readonly, copy, nonatomic) id <FCHeadlineProviding> originalHeadline;
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000000166a15
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x00000000001669f8
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000001669e3
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x00000000001669c8
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x00000000001669ab
...
- (id)initWithHeadline:(id)arg1 overrideMetadata:(id)arg2 configuration:(id)arg3;	// IMP=0x000000000016641b
