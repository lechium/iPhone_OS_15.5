...
{
    NSArray *_relatedChannelsForOnboarding;	// 8 = 0x8
}

- (void).cxx_destruct;	// IMP=0x00000000002d85b3
...
- (id)initWithRelatedChannelsForOnboarding:(id)arg1;	// IMP=0x00000000002d8536
