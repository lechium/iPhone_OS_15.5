...
+ (id)transformationWithTagIDs:(id)arg1 feedContextByFeedID:(id)arg2;	// IMP=0x000000000001ace5
- (void).cxx_destruct;	// IMP=0x000000000001b08c
...
- (id)transformFeedItems:(id)arg1;	// IMP=0x000000000001ad71
