...
+ (id)readValueFromKeyValuePair:(id)arg1;	// IMP=0x0000000000015f5e
+ (int)keyValuePairType;	// IMP=0x0000000000015f53
- (void)writeToKeyValuePair:(id)arg1;	// IMP=0x0000000000015f73
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000014f9a
