...
- (void).cxx_destruct;	// IMP=0x000000000127d3a6
- (unsigned long long)hash;	// IMP=0x000000000127d2cf
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000127d16f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000127cf3e
- (void)writeTo:(id)arg1;	// IMP=0x000000000127cc21
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000127cc12
- (id)jsonRepresentation;	// IMP=0x000000000127cb00
- (id)dictionaryRepresentation;	// IMP=0x000000000127c5ab
- (id)description;	// IMP=0x000000000127c4fc
- (void)dealloc;	// IMP=0x000000000127b618
- (id)initWithData:(id)arg1;	// IMP=0x000000000127b5bc
- (id)init;	// IMP=0x000000000127b560
