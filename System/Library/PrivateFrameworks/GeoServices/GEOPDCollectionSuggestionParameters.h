...
- (void).cxx_destruct;	// IMP=0x0000000000514ce5
- (unsigned long long)hash;	// IMP=0x000000000051459b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000514417
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000513edf
- (void)writeTo:(id)arg1;	// IMP=0x00000000005137ab
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000051379c
- (id)jsonRepresentation;	// IMP=0x0000000000512abe
- (id)dictionaryRepresentation;	// IMP=0x00000000005123bc
- (id)description;	// IMP=0x000000000051230d
- (id)initWithData:(id)arg1;	// IMP=0x00000000005111a7
- (id)init;	// IMP=0x000000000051114b
