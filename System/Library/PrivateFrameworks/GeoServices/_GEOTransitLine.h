...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000001085828
- (void).cxx_destruct;	// IMP=0x00000000010859f2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000001085952
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000001085830
...
- (id)initWithLine:(id)arg1 system:(id)arg2 locationHint:(CDStruct_c3b9c2ee)arg3;	// IMP=0x0000000001085343
