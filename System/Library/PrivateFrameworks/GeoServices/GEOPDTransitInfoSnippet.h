...
+ (id)transitInfoSnippetForPlaceData:(id)arg1;	// IMP=0x00000000009f5fa3
- (void).cxx_destruct;	// IMP=0x0000000000c13260
- (unsigned long long)hash;	// IMP=0x0000000000c1313b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c12eec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c128e1
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c122e4
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c122d5
- (id)jsonRepresentation;	// IMP=0x0000000000c116d9
- (id)dictionaryRepresentation;	// IMP=0x0000000000c10e7c
- (id)description;	// IMP=0x0000000000c10dcd
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c0f2b4
- (id)init;	// IMP=0x0000000000c0f258
