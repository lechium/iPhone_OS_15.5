...
- (void).cxx_destruct;	// IMP=0x000000000083e883
...
- (id)_placecardLayoutConfiguration;	// IMP=0x000000000083e85b
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x000000000083e853
...
- (id)_yelpID;	// IMP=0x000000000083e548
...
- (id)_urlForWritingAReview;	// IMP=0x000000000083e530
- (id)_urlForReview:(id)arg1;	// IMP=0x000000000083e528
- (id)_urlForPhotoWithUID:(id)arg1;	// IMP=0x000000000083e520
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x000000000083e49d
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x000000000083e495
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x000000000083e0f8
- (unsigned int)_travelDistanceForTransportType:(int)arg1;	// IMP=0x000000000083e0b6
- (unsigned int)_travelTimeForTransportType:(int)arg1;	// IMP=0x000000000083e074
- (_Bool)_hasTravelTimeForTransportType:(int)arg1;	// IMP=0x000000000083e057
- (int)_recommendedTransportType;	// IMP=0x000000000083e04c
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x000000000083e02f
...
- (id)weatherDisplayName;	// IMP=0x000000000083df87
- (id)addressObject;	// IMP=0x000000000083ded4
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x000000000083d8f5
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic) int referenceFrame;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x000000000083d838
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithPlace:(id)arg1;	// IMP=0x000000000083d654
- (id)initWithPlaceResult:(id)arg1;	// IMP=0x000000000083d57b
