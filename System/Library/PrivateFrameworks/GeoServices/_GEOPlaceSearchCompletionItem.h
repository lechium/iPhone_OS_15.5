...
- (void).cxx_destruct;	// IMP=0x0000000000726241
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000725e33
@property(readonly, nonatomic) NSData *metadata;
@property(readonly, nonatomic) NSData *entryMetadata;
- (void)sendFeedback;	// IMP=0x0000000000725d3d
- (_Bool)getCoordinate:(CDStruct_c3b9c2ee *)arg1;	// IMP=0x0000000000725bcb
...
- (id)calloutTitle;	// IMP=0x000000000072582c
- (id)queryLine;	// IMP=0x000000000072570d
- (id)highlightsForLine:(unsigned long long)arg1;	// IMP=0x00000000007256be
- (id)initWithEntry:(id)arg1 traits:(id)arg2 entryListIndex:(int)arg3 entryIndex:(int)arg4 mapItems:(id)arg5 collections:(id)arg6 publishers:(id)arg7;	// IMP=0x00000000007240fa
