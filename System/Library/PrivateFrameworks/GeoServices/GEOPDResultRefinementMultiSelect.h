...
- (void).cxx_destruct;	// IMP=0x0000000000d31ca0
- (unsigned long long)hash;	// IMP=0x0000000000d31b9a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d319be
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d31603
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d312ae
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d3129f
- (id)jsonRepresentation;	// IMP=0x0000000000d30f1e
- (id)dictionaryRepresentation;	// IMP=0x0000000000d307be
- (id)description;	// IMP=0x0000000000d3070f
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d2f787
- (id)init;	// IMP=0x0000000000d2f72b
