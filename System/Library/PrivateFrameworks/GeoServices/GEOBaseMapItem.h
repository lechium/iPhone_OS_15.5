...
- (void)iterateGroundViewsWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000010107e7
...
- (id)_bestHeroBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x00000000010107b7
- (id)_bestNavbarBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x00000000010107af
- (id)_bestAvatarBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x00000000010107a7
...
- (id)weatherDisplayName;	// IMP=0x0000000001010704
- (id)shortAddress;	// IMP=0x00000000010106fc
- (id)addressObject;	// IMP=0x00000000010106f4
...
- (id)_firstRelatedPlaceListForType:(int)arg1;	// IMP=0x00000000010106d4
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x00000000010106cc
...
- (id)_mapItemByStrippingOptionalData;	// IMP=0x0000000001010633
...
- (id)_asPlaceInfo;	// IMP=0x0000000001010613
...
- (int)_recommendedTransportType;	// IMP=0x00000000010105c0
...
- (id)_urlForWritingAReview;	// IMP=0x00000000010105a8
- (id)_urlForReview:(id)arg1;	// IMP=0x00000000010105a0
- (id)_urlForPhotoWithUID:(id)arg1;	// IMP=0x0000000001010598
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x0000000001010535
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x000000000101052d
...
- (void)loadTransitAttributionDetails:(CDUnknownBlockType)arg1;	// IMP=0x00000000010103ae
- (id)_transitAttributionSummaries;	// IMP=0x00000000010103a6
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x000000000101032a
- (unsigned int)_travelDistanceForTransportType:(int)arg1;	// IMP=0x0000000001010322
- (unsigned int)_travelTimeForTransportType:(int)arg1;	// IMP=0x000000000101031a
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x0000000001010312
...
- (_Bool)_hasTravelTimeForTransportType:(int)arg1;	// IMP=0x00000000010102cf
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x00000000010101a4
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x0000000001010165
