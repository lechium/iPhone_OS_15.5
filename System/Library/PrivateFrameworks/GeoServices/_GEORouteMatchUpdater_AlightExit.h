...
- (id).cxx_construct;	// IMP=0x0000000001096cbd
- (void).cxx_destruct;	// IMP=0x0000000001096c59
- (_Bool)_isLocationNearAlightNode:(id)arg1;	// IMP=0x0000000001096bcf
- (_Bool)updateRouteMatch:(id)arg1 previousRouteMatch:(id)arg2 forLocation:(id)arg3;	// IMP=0x0000000001096659
- (id)initWithTransitRouteMatcher:(id)arg1 alightStep:(id)arg2;	// IMP=0x00000000010961ee
