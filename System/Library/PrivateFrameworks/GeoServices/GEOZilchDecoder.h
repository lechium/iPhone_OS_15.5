...
+ (_Bool)decodingSupported;	// IMP=0x0000000000c40cc8
- (id).cxx_construct;	// IMP=0x0000000000c4108e
- (void).cxx_destruct;	// IMP=0x0000000000c4103f
...
- (void)requestComplete:(id)arg1;	// IMP=0x0000000000c40f75
- (void)trackRequest:(id)arg1;	// IMP=0x0000000000c40ee9
- (id)decodeZilchMessage:(shared_ptr_27244a92)arg1 pathHandler:(CDUnknownBlockType)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000c40db3
- (void)setRequestQueue:(id)arg1;	// IMP=0x0000000000c40d9f
- (id)requestQueue;	// IMP=0x0000000000c40d8a
- (id)init;	// IMP=0x0000000000c40ce1
