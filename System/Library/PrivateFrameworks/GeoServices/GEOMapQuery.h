...
- (void).cxx_destruct;	// IMP=0x0000000000c9213a
- (unsigned long long)hash;	// IMP=0x0000000000c91ece
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c91b53
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c917b7
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c911ed
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c911e0
- (id)jsonRepresentation;	// IMP=0x0000000000c90f70
- (id)dictionaryRepresentation;	// IMP=0x0000000000c907ef
- (id)description;	// IMP=0x0000000000c90740
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c8f3e9
- (id)init;	// IMP=0x0000000000c8f38d
