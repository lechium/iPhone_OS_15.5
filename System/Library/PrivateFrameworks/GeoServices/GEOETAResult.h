...
- (void).cxx_destruct;	// IMP=0x0000000001309a4a
- (unsigned long long)hash;	// IMP=0x0000000001309942
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000001309770
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000013092eb
- (void)writeTo:(id)arg1;	// IMP=0x0000000001308d4f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000001308d40
- (id)jsonRepresentation;	// IMP=0x0000000001307b60
- (id)dictionaryRepresentation;	// IMP=0x0000000001307323
- (id)description;	// IMP=0x0000000001307274
- (id)initWithData:(id)arg1;	// IMP=0x0000000001305fdd
- (id)init;	// IMP=0x0000000001305f81
