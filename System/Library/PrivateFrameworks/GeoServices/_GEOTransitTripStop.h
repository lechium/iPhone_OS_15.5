...
+ (id)transitTripStopsForPlaceData:(id)arg1;	// IMP=0x000000000100f948
- (void).cxx_destruct;	// IMP=0x0000000001010111
...
- (id)initWithTransitSnippet:(id)arg1 departureSequence:(id)arg2;	// IMP=0x000000000100fde5
