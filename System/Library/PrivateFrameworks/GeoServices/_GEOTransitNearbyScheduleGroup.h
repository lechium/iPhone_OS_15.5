...
+ (id)lineSectionsForNearbyTransitGroup:(id)arg1 departureSequenceContainers:(id)arg2 departureSequences:(id)arg3;	// IMP=0x0000000001088b24
- (void).cxx_destruct;	// IMP=0x0000000001088e81
...
- (id)initWithTransitScheduleGroup:(id)arg1 departureSequenceContainers:(id)arg2 scheduledDepartureSequences:(id)arg3 incidentsMap:(id)arg4;	// IMP=0x00000000010888f8
