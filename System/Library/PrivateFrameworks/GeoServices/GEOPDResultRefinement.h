...
- (void).cxx_destruct;	// IMP=0x0000000000d22fdc
- (unsigned long long)hash;	// IMP=0x0000000000d226bc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d2250a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d22296
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d21e17
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d21e08
- (id)jsonRepresentation;	// IMP=0x0000000000d1ca1c
- (id)dictionaryRepresentation;	// IMP=0x0000000000d1c4a2
- (id)description;	// IMP=0x0000000000d1c3f3
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d1b43e
- (id)init;	// IMP=0x0000000000d1b3e2
