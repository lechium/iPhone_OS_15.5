...
- (void).cxx_destruct;	// IMP=0x00000000011b4fe7
...
- (id)_chooseMostImportantTransitLegInRoute:(id)arg1;	// IMP=0x00000000011b4e5d
- (id)description;	// IMP=0x00000000011b4da3
- (id)initWithComposedRoute:(id)arg1;	// IMP=0x00000000011b4cfe
