...
@interface GEOURLBackedMapItem <GEOMapItemStorageSerializable>
{
    ...
    GEOMuninViewState *_muninViewState;	// 24 = 0x18
    GEOFeatureStyleAttributes *_styleAttributes;	// 32 = 0x20
    GEOMapItemIdentifier *_identifier;	// 40 = 0x28
    CDStruct_2c43369c _coordinate;	// 48 = 0x30
    _Bool _hasMUID;	// 64 = 0x40
    unsigned long long _muid;	// 72 = 0x48
    GEOAddress *_geoAddress;	// 80 = 0x50
    NSString *_name;	// 88 = 0x58
}

+ (_Bool)urlContainsExtraStorage:(id)arg1;	// IMP=0x0000000000fba615
- (void).cxx_destruct;	// IMP=0x0000000000fbac50
...
- (id)mapItemStorageForGEOMapItem;	// IMP=0x0000000000fbaae0
...
- (id)initWithURL:(id)arg1;	// IMP=0x0000000000fba6e1
- (id)init;	// IMP=0x0000000000fba6b7
