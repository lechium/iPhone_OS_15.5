...
+ (id)dbValue:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x00000000002a41dc
- (void).cxx_destruct;	// IMP=0x00000000002a42d1
...
- (id)initWithParent:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x00000000002a412a
