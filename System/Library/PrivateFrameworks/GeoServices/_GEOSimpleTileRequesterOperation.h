...
- (void).cxx_destruct;	// IMP=0x000000000109e14a
...
- (void)dataSession:(id)arg1 didCompleteTask:(id)arg2;	// IMP=0x000000000109c3d4
- (void)dataSession:(id)arg1 shouldConvertDataTask:(id)arg2 toDownloadTaskForEstimatedResponseSize:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000109c23f
...
- (double)startTime;	// IMP=0x000000000109c0c2
- (double)elapsed;	// IMP=0x000000000109c072
- (void)clearAllRelatedOperations;	// IMP=0x000000000109c040
- (void)cancel;	// IMP=0x000000000109be93
- (void)start;	// IMP=0x000000000109b860
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) unsigned long long contentLength;
@property(readonly, nonatomic) NSURL *URL;
@property unsigned int priority;
- (id)initWithRequest:(id)arg1 delegateQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x000000000109b0a2
- (id)init;	// IMP=0x000000000109b094
