...
- (void).cxx_destruct;	// IMP=0x00000000010d3db0
...
- (id)description;	// IMP=0x00000000010d3c50
- (double)distanceFromCoordinate:(CDStruct_c3b9c2ee)arg1 outCoordinateOnSegment:(CDStruct_c3b9c2ee *)arg2 outRouteCoordinate:(struct PolylineCoordinate *)arg3;	// IMP=0x00000000010d3b1f
