...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0000000000db9e19
- (void).cxx_destruct;	// IMP=0x0000000000dbb723
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000dbb507
- (unsigned long long)hash;	// IMP=0x0000000000dbb0fa
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000dbad3e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000dba9bd
- (void)copyTo:(id)arg1;	// IMP=0x0000000000dba745
- (void)writeTo:(id)arg1;	// IMP=0x0000000000dba3d9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000dba3cc
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000db9bce
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000db9bbc
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000db944c
- (id)jsonRepresentation;	// IMP=0x0000000000db943d
- (id)dictionaryRepresentation;	// IMP=0x0000000000db8e2d
- (id)description;	// IMP=0x0000000000db8d7e
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000db76bc
- (id)init;	// IMP=0x0000000000db7660
