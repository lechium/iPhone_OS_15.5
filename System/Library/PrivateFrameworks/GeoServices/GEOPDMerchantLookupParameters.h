...
- (unsigned long long)hash;	// IMP=0x0000000000558168
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000557ccc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000055781e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000557268
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000557259
- (id)jsonRepresentation;	// IMP=0x0000000000556ed8
- (id)dictionaryRepresentation;	// IMP=0x0000000000555f73
- (id)description;	// IMP=0x0000000000555ec4
- (id)initWithData:(id)arg1;	// IMP=0x0000000000554095
- (id)init;	// IMP=0x0000000000554039
