...
- (void).cxx_destruct;	// IMP=0x0000000000d45988
- (unsigned long long)hash;	// IMP=0x0000000000d4585f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d4565f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d453d7
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d45161
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d45152
- (id)jsonRepresentation;	// IMP=0x0000000000d45040
- (id)dictionaryRepresentation;	// IMP=0x0000000000d44aab
- (id)description;	// IMP=0x0000000000d449fc
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d43b8f
- (id)init;	// IMP=0x0000000000d43b33
