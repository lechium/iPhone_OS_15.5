...
- (void).cxx_destruct;	// IMP=0x0000000001287e04
...
- (void)setSectionOptions:(id)arg1;	// IMP=0x0000000001287dbe
- (void)setRideSelections:(id)arg1;	// IMP=0x0000000001287daa
- (void)setIsWalkingOnlyRoute:(_Bool)arg1;	// IMP=0x0000000001287d9a
