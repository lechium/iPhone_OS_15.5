...
+ (id)_resourcesDirectory:(id)arg1;	// IMP=0x00000000009ebc7e
+ (Class)_resourceLoaderClass;	// IMP=0x00000000009ebc6d
- (void).cxx_destruct;	// IMP=0x00000000009ef67f
...
- (id)_staleResourceForResource:(id)arg1;	// IMP=0x00000000009ee49b
- (void)_loadImmediateResources:(id)arg1 conditionalWifiResources:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000009edc1f
- (void)removeOldData:(id)arg1;	// IMP=0x00000000009ed335
- (void)populateTileGroup:(id)arg1;	// IMP=0x00000000009ed00b
- (void)cancel;	// IMP=0x00000000009ecdec
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x00000000009ebcd7
- (id)_resourcesDirectory;	// IMP=0x00000000009ebcaf
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (id)initWithMigrator:(id)arg1 manifestConfiguration:(id)arg2 newTileGroup:(id)arg3 inResourceManifest:(id)arg4 dataSet:(id)arg5 oldTileGroup:(id)arg6 activeScales:(id)arg7 activeScenarios:(id)arg8;	// IMP=0x00000000009eb9b7
- (id)init;	// IMP=0x00000000009eb98d
