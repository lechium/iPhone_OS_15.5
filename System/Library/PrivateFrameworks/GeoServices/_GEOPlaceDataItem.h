...
@interface _GEOPlaceDataItem : NSObject <GEOMapItem>
{
    ...
    GEOStorefrontInfo *_storefrontInfo;	// 88 = 0x58
    GEOStorefrontPresentationInfo *_storefrontPresentationInfo;	// 96 = 0x60
    id <GEOMapItemVenueInfo> _venueInfo;	// 104 = 0x68
    NSArray *_additionalPlaces;	// 112 = 0x70
    GEOAddressObject *_addressObject;	// 120 = 0x78
    NSString *_name;	// 128 = 0x80
    GEOBusinessHours *_businessHours;	// 136 = 0x88
    NSArray *_spatialMappedPlaceCategories;	// 144 = 0x90
    NSArray *_childItems;	// 152 = 0x98
    NSArray *_captionedPhotoAlbums;	// 160 = 0xa0
    GEOPlacecardLayoutData *_placecardLayoutData;	// 168 = 0xa8
    NSDictionary *_relatedPlacesByComponentId;	// 176 = 0xb0
    NSArray *_allPhotoAttributions;	// 184 = 0xb8
    geo_reentrant_isolater *_lazyReentrantIvarIsolater;	// 192 = 0xc0
    NSTimeZone *_timeZone;	// 200 = 0xc8
    NSArray *_prioritizedBusinessHours;	// 208 = 0xd0
    _Bool _checkedPrioritizedBusinessHours;	// 216 = 0xd8
}

- (void).cxx_destruct;	// IMP=0x0000000000ca7081
...
- (void)iterateGroundViewsWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000ca54f5
...
- (id)_bestHeroBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x0000000000ca4ca8
- (id)_bestNavbarBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x0000000000ca4c99
- (id)_bestAvatarBrandIconURLForSize:(struct CGSize)arg1 allowSmaller:(_Bool)arg2;	// IMP=0x0000000000ca4814
...
- (id)weatherDisplayName;	// IMP=0x0000000000ca3afd
- (id)shortAddress;	// IMP=0x0000000000ca3a2d
- (id)addressObject;	// IMP=0x0000000000ca3984
...
- (id)_relatedPlacesByComponentId;	// IMP=0x0000000000ca322e
- (id)_firstRelatedPlaceListForType:(int)arg1;	// IMP=0x0000000000ca30d1
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x0000000000ca304a
...
- (id)_mapItemBySettingIsTransitDisplayFeature:(_Bool)arg1;	// IMP=0x0000000000ca1e74
- (id)_mapItemByStrippingOptionalData;	// IMP=0x0000000000ca1dfc
...
- (id)_asPlaceInfo;	// IMP=0x0000000000ca12b3
...
- (void)_refreshPhotoAttributions;	// IMP=0x0000000000ca0516
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x0000000000c9f8d5
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x0000000000c9f7d6
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x0000000000c9e3bf
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x0000000000c9e33c
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x0000000000c9cfc0
...
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x0000000000c9c665
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithPlaceData:(id)arg1 detourInfo:(id)arg2 additionalPlaceDatas:(id)arg3;	// IMP=0x0000000000c9c478
- (id)initWithPlaceData:(id)arg1 detourInfo:(id)arg2;	// IMP=0x0000000000c9c44e
- (id)initWithPlaceData:(id)arg1;	// IMP=0x0000000000c9c424
- (id)initWithPlaceData:(id)arg1 attributionMap:(id)arg2 disambiguationLabel:(id)arg3 detourInfo:(id)arg4 externalTransitStationCode:(id)arg5 additionalPlaces:(id)arg6;	// IMP=0x0000000000c9c00f
