...
- (void).cxx_destruct;	// IMP=0x0000000000b2dd10
- (unsigned long long)hash;	// IMP=0x0000000000b2d8d4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b2d609
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b2d089
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b2ca23
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b2ca14
- (id)jsonRepresentation;	// IMP=0x0000000000b2b405
- (id)dictionaryRepresentation;	// IMP=0x0000000000b2a963
- (id)description;	// IMP=0x0000000000b2a8b4
- (void)dealloc;	// IMP=0x0000000000b2890d
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b288b1
- (id)init;	// IMP=0x0000000000b28855
