...
- (id).cxx_construct;	// IMP=0x000000000035eda5
- (void).cxx_destruct;	// IMP=0x000000000035ed5d
...
- (id)findAccessPoints:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000035ed1e
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1;	// IMP=0x000000000035ece3
- (id)findGeometryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000035ea43
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *internalName;
@property(readonly, nonatomic) unsigned long long transitID;
@property(readonly, nonatomic) CDStruct_c3b9c2ee coordinate;
- (void)dealloc;	// IMP=0x000000000035e919
- (id)initWithMap:(id)arg1 node:(shared_ptr_52e51bdf)arg2;	// IMP=0x000000000035e82a
