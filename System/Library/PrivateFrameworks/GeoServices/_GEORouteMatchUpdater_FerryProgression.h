...
- (void).cxx_destruct;	// IMP=0x00000000010980b3
- (unsigned long long)priority;	// IMP=0x00000000010980a8
- (_Bool)updateRouteMatch:(id)arg1 previousRouteMatch:(id)arg2 forLocation:(id)arg3;	// IMP=0x0000000001097ea1
- (id)initWithRoute:(id)arg1 tripSegment:(id)arg2;	// IMP=0x0000000001097cd7
