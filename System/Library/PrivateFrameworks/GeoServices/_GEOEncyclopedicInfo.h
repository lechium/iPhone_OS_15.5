...
- (void).cxx_destruct;	// IMP=0x0000000000732e8a
- (id)firstFactoidForSemantic:(int)arg1;	// IMP=0x0000000000732d2d
- (id)factoidAtIndex:(int)arg1;	// IMP=0x0000000000732c7d
...
- (id)initWithPlaceData:(id)arg1 attributionMap:(id)arg2;	// IMP=0x00000000007326f2
