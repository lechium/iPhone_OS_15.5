...
- (void).cxx_destruct;	// IMP=0x000000000052aafb
- (unsigned long long)hash;	// IMP=0x000000000052aa3c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000052a8bd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000052a681
- (void)writeTo:(id)arg1;	// IMP=0x000000000052a3a4
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000052a395
- (id)jsonRepresentation;	// IMP=0x000000000052a014
- (id)dictionaryRepresentation;	// IMP=0x000000000052994f
- (id)description;	// IMP=0x00000000005298a0
- (void)dealloc;	// IMP=0x00000000005285d6
- (id)initWithData:(id)arg1;	// IMP=0x000000000052857a
- (id)init;	// IMP=0x000000000052851e
