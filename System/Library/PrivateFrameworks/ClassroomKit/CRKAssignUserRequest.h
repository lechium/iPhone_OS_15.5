...
@interface CRKAssignUserRequest : CATTaskRequest
{
    ...
    NSArray *_enrolledCourseIdentifiers;	// 88 = 0x58
}

+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000625da
- (void).cxx_destruct;	// IMP=0x0000000000062f90
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000062b53
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000625e2
