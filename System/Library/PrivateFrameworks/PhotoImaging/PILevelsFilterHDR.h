...
+ (id)customAttributes;	// IMP=0x0000000000012a8a
+ (id)_customAttributesForKey:(id)arg1;	// IMP=0x00000000000129b5
+ (id)defaultValueForKey:(id)arg1;	// IMP=0x0000000000012822
- (void).cxx_destruct;	// IMP=0x0000000000016139
...
- (id)outputImage;	// IMP=0x0000000000015834
- (id)_LUTImage;	// IMP=0x000000000001385c
- (double)floatValueForKey:(id)arg1 defaultValue:(double)arg2 clearIfNotDefault:(_Bool *)arg3;	// IMP=0x00000000000137ea
- (void)setDefaults;	// IMP=0x000000000001330a
- (id)P3KernelHDR;	// IMP=0x00000000000132da
