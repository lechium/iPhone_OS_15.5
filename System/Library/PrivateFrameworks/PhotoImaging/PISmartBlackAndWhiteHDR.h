...
+ (id)customAttributes;	// IMP=0x000000000008c5a2
- (void).cxx_destruct;	// IMP=0x000000000008d77d
...
- (id)outputImage;	// IMP=0x000000000008d234
- (id)smartBlackWhiteKernel;	// IMP=0x000000000008d204
- (id)hueArrayImage:(float *)arg1;	// IMP=0x000000000008cff5
- (float *)createHueArray;	// IMP=0x000000000008ced9
- (void)getNonNormalizedSettings:(CDStruct_31328b19 *)arg1;	// IMP=0x000000000008cbce
