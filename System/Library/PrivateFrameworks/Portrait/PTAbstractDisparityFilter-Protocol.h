...
- (int)temporalDisparityFilter:(id <MTLCommandBuffer>)arg1 inDisplacement:(id <MTLTexture>)arg2 inStatePrev:(id <MTLTexture>)arg3 inDisparity:(id <MTLTexture>)arg4 outDisparityFiltered:(id <MTLTexture>)arg5 outState:(id <MTLTexture>)arg6;
