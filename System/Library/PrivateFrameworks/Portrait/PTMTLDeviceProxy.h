...
#import <Portrait/MTLDeviceSPI-Protocol.h>

@class MTLGPUBVHBuilder, MTLTargetDeviceArchitecture, NSArray, NSDictionary, NSMutableArray, NSString;
@protocol MTLDeviceSPI;

@interface PTMTLDeviceProxy : NSObject <MTLDeviceSPI>
{
    id <MTLDeviceSPI> _delegate;	// 8 = 0x8
    NSMutableArray *_allocatedTextures;	// 16 = 0x10
}

- (void).cxx_destruct;	// IMP=0x000000000005bc6b
@property(retain) NSMutableArray *allocatedTextures; // @synthesize allocatedTextures=_allocatedTextures;
@property(retain) id <MTLDeviceSPI> delegate; // @synthesize delegate=_delegate;
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x000000000005bb8e
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000005bb16
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000005b9b1
