...
+ (id)sharedNotifier;	// IMP=0x0000000000042022
...
- (void)postLocalNotification;	// IMP=0x0000000000042448
- (void)postLocalNotificationIfNeeded;	// IMP=0x00000000000423ad
- (void)dealloc;	// IMP=0x0000000000042351
- (id)_initSingleton;	// IMP=0x0000000000042087
