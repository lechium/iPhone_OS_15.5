...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000020839
- (void).cxx_destruct;	// IMP=0x0000000000021fa0
...
- (id)lockupWithOffer:(id)arg1;	// IMP=0x0000000000021d8b
- (id)lockupByAddingFeature:(id)arg1;	// IMP=0x0000000000021ac5
- (id)featureWithClass:(Class)arg1;	// IMP=0x0000000000021978
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000020f9b
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000020d5a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000020b0a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000020841
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9;	// IMP=0x00000000000207f8
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9 features:(id)arg10;	// IMP=0x00000000000205f7
- (id)lockupWithSignpostTags:(id)arg1;	// IMP=0x0000000000015a21
@property(readonly, copy, nonatomic) NSSet *signpostTags;
- (id)initWithID:(id)arg1 kind:(id)arg2 icon:(id)arg3 heading:(id)arg4 title:(id)arg5 subtitle:(id)arg6 ageRating:(id)arg7 offer:(id)arg8;	// IMP=0x0000000000022020
