...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002cd6c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002d28c
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002d100
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002cf6f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002cd74
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4 screenshots:(id)arg5 trailers:(id)arg6 developerName:(id)arg7;	// IMP=0x000000000002cc1b
