...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000c175
- (void).cxx_destruct;	// IMP=0x000000000000da93
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000ce6d
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x000000000000c9b6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000c9ab
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000c6cf
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000c17d
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 baseBuyParams:(id)arg7 metricsBuyParams:(id)arg8 additionalHeaders:(id)arg9 preflightPackageURL:(id)arg10 bundleID:(id)arg11 itemName:(id)arg12 vendorName:(id)arg13;	// IMP=0x000000000000bf19
