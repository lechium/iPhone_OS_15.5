...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001747c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000017db1
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00000000000179f4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000179e9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000177a9
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000017484
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 alertTitle:(id)arg7 alertMessage:(id)arg8 alertButtonOffer:(id)arg9 alertButtonTitle:(id)arg10;	// IMP=0x00000000000172a5
