...
- (void).cxx_destruct;	// IMP=0x0000000000050bec
...
- (void)finishAllWithError:(id)arg1;	// IMP=0x0000000000050aa9
- (void)cancelAll;	// IMP=0x0000000000050a5f
- (void)enumerateBinaryPromises:(CDUnknownBlockType)arg1 andPromises:(CDUnknownBlockType)arg2;	// IMP=0x000000000005073a
- (void)addPromise:(id)arg1;	// IMP=0x000000000005049a
- (_Bool)containsPromise:(id)arg1;	// IMP=0x0000000000050392
@property(readonly, nonatomic) _Bool hasPromises;
- (void)addBinaryPromise:(id)arg1;	// IMP=0x000000000004ff39
- (_Bool)containsBinaryPromise:(id)arg1;	// IMP=0x000000000004fe31
@property(readonly, nonatomic) NSMutableArray *promises;
@property(readonly, nonatomic) NSMutableArray *binaryPromises;
- (id)init;	// IMP=0x000000000004fd2d
