...
- (void).cxx_destruct;	// IMP=0x0000000000043b76
...
- (void)cancelGestureDidChange:(id)arg1;	// IMP=0x0000000000043a79
- (void)invalidate;	// IMP=0x00000000000437c9
- (void)installWithCancelBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000432eb
- (void)dealloc;	// IMP=0x00000000000432ad
- (id)initWithView:(id)arg1;	// IMP=0x000000000004322f
