...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000003e7f3
- (void).cxx_destruct;	// IMP=0x000000000003f789
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003f00a
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x000000000003ecf0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003ece5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003eb0d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003e7fb
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x000000000003e64e
