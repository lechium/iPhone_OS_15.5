...
+ (id)logCategory;	// IMP=0x000000000060415f
- (void).cxx_destruct;	// IMP=0x000000000060414c
@property(readonly) HMFMessage *message; // @synthesize message=_message;
- (id)attributeDescriptions;	// IMP=0x000000000060400a
@property(readonly) HMDDevice *remoteSourceDevice;
@property(readonly, copy) NSUUID *messageIdentifier;
- (id)initWithMessage:(id)arg1;	// IMP=0x0000000000603e48
