...
+ (_Bool)hasMessageReceiverChildren;	// IMP=0x000000000002e924
+ (id)logCategory;	// IMP=0x000000000002e8f4
- (void).cxx_destruct;	// IMP=0x000000000002c509
...
- (_Bool)supportsDeviceWithCapabilities:(id)arg1;	// IMP=0x000000000002c1ef
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
- (void)handleResidentDeviceUpdated:(id)arg1;	// IMP=0x000000000002c16c
- (void)session:(id)arg1 didEndWithError:(id)arg2;	// IMP=0x000000000002beb1
@property(readonly) NSString *logIdentifier;
- (void)_updateSessionRestoreRegistration;	// IMP=0x000000000002bcb2
- (void)_resetCurrentRecordingSession:(id)arg1;	// IMP=0x000000000002b76a
- (void)_startSessionRetryTimer;	// IMP=0x000000000002b4d2
- (void)_resetRetryContextWithReason:(id)arg1;	// IMP=0x000000000002b364
- (void)_closeCurrentSessionsWithReason:(unsigned short)arg1;	// IMP=0x000000000002b15e
- (unsigned short)_closeEventReasonForRecordingSessionError:(id)arg1;	// IMP=0x000000000002b0e3
- (void)_handleDataReceived:(id)arg1;	// IMP=0x000000000002a9a1
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000002a704
- (void)_readDataForCurrentSession;	// IMP=0x000000000002a5d8
- (void)_handleBulkSendSessionCreated:(id)arg1;	// IMP=0x000000000002a33a
- (void)_startRecordingSessionForTrigger:(unsigned long long)arg1 homePresenceByPairingIdentity:(id)arg2 reason:(id)arg3 completionCallback:(CDUnknownBlockType)arg4;	// IMP=0x0000000000029c47
- (id)bulkSendSessionOpenReasonWithError:(id *)arg1;	// IMP=0x00000000000297ca
- (void)_processQueuedCameraRecordingSessionStartRequests;	// IMP=0x00000000000295d4
- (void)handleStartRecordingSessionRequest:(id)arg1;	// IMP=0x0000000000028f8d
- (void)_startRecordingSessionForTrigger:(unsigned long long)arg1 homePresenceByPairingIdentity:(id)arg2 reason:(id)arg3;	// IMP=0x0000000000028e2f
- (void)_createRecordingSessionForTrigger:(unsigned long long)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x0000000000028770
- (void)_submitLoadBalancingEventWithDecision:(id)arg1 numberOfRetries:(unsigned long long)arg2;	// IMP=0x00000000000283ed
- (void)_forwardRecordingSessionForTrigger:(unsigned long long)arg1 withLoadBalancerDecision:(id)arg2 deviceFilter:(CDUnknownBlockType)arg3 sessionCoordinationLogEvent:(id)arg4 retryAttemptNumber:(long long)arg5;	// IMP=0x0000000000027df0
@property(readonly) NSDictionary *homePresenceByPairingIdentity;
- (void)_coordinateRecordingSessionForTrigger:(unsigned long long)arg1;	// IMP=0x000000000002771c
- (void)_clipManagerDidStartUpCloudZone;	// IMP=0x00000000000274e5
- (void)_shutDown;	// IMP=0x000000000002734a
- (void)_start;	// IMP=0x0000000000026cc5
- (void)recordingSettingsControlDidFailToConfigure:(id)arg1;	// IMP=0x0000000000026af5
- (void)recordingSettingsControlDidConfigure:(id)arg1;	// IMP=0x000000000002675d
- (void)handleCameraSettingsDidChangeNotification:(id)arg1;	// IMP=0x00000000000266ec
- (void)clipManagerDidStop:(id)arg1;	// IMP=0x000000000002667b
- (void)clipManagerDidStartUpCloudZone:(id)arg1;	// IMP=0x000000000002660a
- (void)notificationTrigger:(id)arg1 didObserveTriggerType:(unsigned long long)arg2 changeToActive:(_Bool)arg3;	// IMP=0x000000000002630b
- (void)shutDown;	// IMP=0x000000000002629a
- (void)start;	// IMP=0x0000000000026229
- (void)dealloc;	// IMP=0x0000000000026116
- (id)initWithCamera:(id)arg1 recordingManagementService:(id)arg2 dependencyFactory:(id)arg3 notificationCenter:(id)arg4;	// IMP=0x0000000000025b61
- (id)initWithCamera:(id)arg1 recordingManagementService:(id)arg2;	// IMP=0x0000000000025aae
