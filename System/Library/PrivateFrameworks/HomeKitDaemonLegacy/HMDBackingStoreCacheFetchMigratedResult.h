...
- (void).cxx_destruct;	// IMP=0x00000000001e494d
...
- (id)mainReturningError;	// IMP=0x00000000001e433e
- (id)initWithGroup:(id)arg1 update:(_Bool)arg2 migration:(_Bool)arg3 fetchResult:(CDUnknownBlockType)arg4;	// IMP=0x00000000001e4261
