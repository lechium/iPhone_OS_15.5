...
#import <HomeKitDaemonLegacy/HMDMetricsSerializable-Protocol.h>
...
+ (id)coalescedEventFromHouseholdDataLogEvents:(id)arg1;	// IMP=0x0000000000434833
...
- (id)serializedMetric;	// IMP=0x00000000004346d1
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000043457a
