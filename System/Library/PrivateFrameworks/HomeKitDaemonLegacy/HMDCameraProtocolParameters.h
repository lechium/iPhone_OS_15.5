...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000462b3d
- (void).cxx_destruct;	// IMP=0x0000000000462ab7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000046289c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000046273e
