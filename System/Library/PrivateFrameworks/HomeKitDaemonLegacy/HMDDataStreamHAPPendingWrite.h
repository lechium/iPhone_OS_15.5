...
- (void).cxx_destruct;	// IMP=0x00000000006536ee
...
- (id)popNextFrameUpToMaxLength:(unsigned long long)arg1;	// IMP=0x00000000006535d2
- (_Bool)isComplete;	// IMP=0x0000000000653571
- (id)initWithData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000006534c5
