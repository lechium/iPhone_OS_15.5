...
- (void).cxx_destruct;	// IMP=0x00000000007e9f22
...
- (id)initWithTrustActivityType:(long long)arg1 privilege:(unsigned long long)arg2 isPrimaryResident:(_Bool)arg3;	// IMP=0x00000000007e9dee
