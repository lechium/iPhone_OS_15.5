...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000540a58
- (void).cxx_destruct;	// IMP=0x0000000000540a05
...
- (id)description;	// IMP=0x0000000000540750
@property(readonly, nonatomic) NSString *wakeAddressString;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000540320
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005400a2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000053fdb3
- (unsigned long long)hash;	// IMP=0x000000000053fc8f
- (id)initWithWakeVersion:(unsigned char)arg1 wakePort:(unsigned short)arg2 wakeAddress:(id)arg3 wakeType:(long long)arg4 wakePacketType:(long long)arg5 wakePattern:(id)arg6;	// IMP=0x000000000053fa9f
- (id)initWithPrimaryIdentifier:(id)arg1 wifiIdentifiers:(id)arg2;	// IMP=0x000000000053f924
