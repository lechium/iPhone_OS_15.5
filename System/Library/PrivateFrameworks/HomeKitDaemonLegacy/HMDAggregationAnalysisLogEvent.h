...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x000000000008f0b1
- (void).cxx_destruct;	// IMP=0x000000000008f06f
...
- (id)metricForAWD;	// IMP=0x000000000008d982
- (unsigned int)AWDMessageType;	// IMP=0x000000000008d977
@property(readonly, nonatomic) NSDictionary *serializedEvent;
@property(readonly, nonatomic) NSString *eventName;
- (void)submitAtDate:(id)arg1;	// IMP=0x000000000008b3ae
- (id)alertMessageForRadarDialogWithCloudSyncBytesThreshold:(unsigned long long)arg1 remoteMessageCountThreshold:(unsigned long long)arg2;	// IMP=0x000000000008b069
- (id)alertMessageForRadarDialog;	// IMP=0x000000000008af0f
- (id)initWithDataSyncStateDescription:(id)arg1 eventCountersManager:(id)arg2 eventFlagsManager:(id)arg3;	// IMP=0x000000000008ae6d
