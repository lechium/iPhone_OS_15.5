...
+ (id)logCategory;	// IMP=0x000000000037dd30
- (void).cxx_destruct;	// IMP=0x000000000037d901
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000037d671
- (id)logIdentifier;	// IMP=0x000000000037d65f
- (void)_callDelegate;	// IMP=0x000000000037d59e
- (void)_handleStatusUpdateMessageError:(id)arg1 responseTime:(double)arg2;	// IMP=0x000000000037d488
- (void)_send;	// IMP=0x000000000037c738
- (void)send;	// IMP=0x000000000037c6c7
- (id)attributeDescriptions;	// IMP=0x000000000037c4a3
- (void)dealloc;	// IMP=0x000000000037c360
- (id)initWithDelegate:(id)arg1 workQueue:(id)arg2 targetUUID:(id)arg3 messageDispatcher:(id)arg4 user:(id)arg5 presenceAuthStatus:(id)arg6 presenceComputeStatus:(id)arg7 presenceRegionStatus:(id)arg8 reason:(id)arg9;	// IMP=0x000000000037c03a
