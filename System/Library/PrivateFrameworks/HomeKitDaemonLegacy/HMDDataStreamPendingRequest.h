...
- (void).cxx_destruct;	// IMP=0x00000000002e9689
...
- (unsigned long long)hash;	// IMP=0x00000000002e9613
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002e9548
- (id)initWithIdentifier:(id)arg1 protocol:(id)arg2 topic:(id)arg3 payload:(id)arg4 callback:(CDUnknownBlockType)arg5;	// IMP=0x00000000002e9448
