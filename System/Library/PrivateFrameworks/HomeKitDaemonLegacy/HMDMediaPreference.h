...
+ (void)load;	// IMP=0x0000000000241f5e
- (void).cxx_destruct;	// IMP=0x0000000000241f4b
@property(readonly) HMFSystemPreference *homeKitPreference; // @synthesize homeKitPreference=_homeKitPreference;
- (id)stringValue;	// IMP=0x0000000000241ee5
- (id)numberValue;	// IMP=0x0000000000241dbc
- (_Bool)boolValue;	// IMP=0x0000000000241d78
...
- (id)initWithKey:(id)arg1 options:(unsigned long long)arg2 defaultValue:(id)arg3;	// IMP=0x0000000000241ae5
