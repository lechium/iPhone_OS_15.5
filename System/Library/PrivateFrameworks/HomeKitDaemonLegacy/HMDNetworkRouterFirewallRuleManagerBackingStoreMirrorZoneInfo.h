...
- (void).cxx_destruct;	// IMP=0x000000000079ddd6
...
- (void)forceRefresh;	// IMP=0x000000000079dd12
- (void)markDeleted;	// IMP=0x000000000079dd01
- (void)markChanged;	// IMP=0x000000000079dcf0
- (id)initWithZoneID:(id)arg1;	// IMP=0x000000000079dc39
