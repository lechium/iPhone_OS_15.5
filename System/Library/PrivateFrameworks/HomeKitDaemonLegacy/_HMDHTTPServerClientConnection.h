...
+ (id)shortDescription;	// IMP=0x0000000000659c5f
- (void).cxx_destruct;	// IMP=0x0000000000658f45
...
- (void)_reallySendMessage:(id)arg1 timeout:(double)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006588af
- (void)sendMessage:(id)arg1 timeout:(double)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000658671
- (id)dequeueRequest;	// IMP=0x0000000000658423
- (void)queueRequest:(id)arg1;	// IMP=0x000000000065824f
- (CDUnknownBlockType)removeCompletionHandlerForTransactionIdentifier:(id)arg1;	// IMP=0x0000000000657f30
- (void)addCompletionHandler:(CDUnknownBlockType)arg1 forTransactionIdentifier:(id)arg2;	// IMP=0x0000000000657e5e
@property(readonly, nonatomic, getter=isConnected) _Bool connected;
- (id)description;	// IMP=0x0000000000657e17
- (id)debugDescription;	// IMP=0x0000000000657e00
- (id)descriptionWithPointer:(_Bool)arg1;	// IMP=0x0000000000657cba
- (id)shortDescription;	// IMP=0x0000000000657bcd
- (void)invalidate;	// IMP=0x000000000065773d
- (id)initWithDevice:(id)arg1;	// IMP=0x0000000000657453
- (id)init;	// IMP=0x00000000006573ab
