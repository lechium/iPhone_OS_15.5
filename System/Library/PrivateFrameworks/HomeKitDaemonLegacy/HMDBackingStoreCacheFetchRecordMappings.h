...
- (void).cxx_destruct;	// IMP=0x00000000001e4005
...
- (id)mainReturningError;	// IMP=0x00000000001e3d3f
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x00000000001e3c83
