...
- (void).cxx_destruct;	// IMP=0x00000000008683e5
...
- (void)handleUpdatedDestination:(id)arg1;	// IMP=0x00000000008682f2
- (void)handleMediaDestinationUpdatedNotification:(id)arg1;	// IMP=0x0000000000867f05
- (id)initWithDestination:(id)arg1 messageDispatcher:(id)arg2 notificationCenter:(id)arg3 dataSource:(id)arg4 delegate:(id)arg5;	// IMP=0x0000000000867d94
