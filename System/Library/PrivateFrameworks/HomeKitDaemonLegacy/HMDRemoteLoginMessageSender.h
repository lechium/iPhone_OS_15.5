...
+ (id)logCategory;	// IMP=0x0000000000648fb9
- (void).cxx_destruct;	// IMP=0x0000000000648e32
...
- (void)sendRemoteMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006489e6
- (id)logIdentifier;	// IMP=0x0000000000648996
- (id)initWithTarget:(id)arg1 accessory:(id)arg2 device:(id)arg3 workQueue:(id)arg4 messageDispatcher:(id)arg5;	// IMP=0x000000000064887b
