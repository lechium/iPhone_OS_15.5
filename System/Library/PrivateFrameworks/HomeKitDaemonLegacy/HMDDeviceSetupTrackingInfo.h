...
- (void).cxx_destruct;	// IMP=0x000000000003a246
...
- (id)initWithIdentifier:(id)arg1 startTime:(id)arg2 endTime:(id)arg3 role:(long long)arg4 accessoryUUID:(id)arg5;	// IMP=0x000000000003a0b4
