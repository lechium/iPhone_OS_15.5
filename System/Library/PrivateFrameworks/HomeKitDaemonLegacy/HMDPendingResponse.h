...
+ (id)tupleForMessage:(id)arg1 originalRequestIdentifier:(id)arg2 requestCount:(unsigned long long)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000000a1812
- (void).cxx_destruct;	// IMP=0x00000000000a17ae
...
- (id)retrieveAndClearLatestResponses;	// IMP=0x00000000000a1605
- (id)retrieveAndClearAllResponses;	// IMP=0x00000000000a154f
- (void)addResponsesToPendingResponse:(id)arg1;	// IMP=0x00000000000a147f
- (void)addToPendingResponses:(id)arg1;	// IMP=0x00000000000a13b7
- (id)description;	// IMP=0x00000000000a12f6
