...
+ (id)nonSPIEntitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00000000002dc61b
+ (id)entitledMessageWithName:(id)arg1 identifier:(id)arg2 messagePayload:(id)arg3;	// IMP=0x00000000002dc5a3
+ (id)entitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00000000002dc479
+ (id)internalMessageWithName:(id)arg1 destination:(id)arg2 messagePayload:(id)arg3;	// IMP=0x0000000000531c26
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000531bd7
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0000000000531b88
+ (id)homeLocationAuthorizedAndEntitledMessageWithName:(id)arg1 target:(id)arg2 messagePayload:(id)arg3;	// IMP=0x0000000000722a03
+ (id)locationAuthorizedMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0000000000722999
- (unsigned long long)homeManagerOptions;	// IMP=0x00000000002dc428
...
- (_Bool)_supportsFeature:(unsigned long long)arg1 forCapabilitiesKey:(id)arg2;	// IMP=0x00000000003eb686
- (_Bool)supportsRequestedFeature:(unsigned long long)arg1;	// IMP=0x00000000003eb66d
- (_Bool)supportsRequiredFeature:(unsigned long long)arg1;	// IMP=0x00000000003eb654
...
- (id)userForHome:(id)arg1;	// IMP=0x000000000090ce28
- (id)matchingRemoteIdentityUserForHome:(id)arg1;	// IMP=0x000000000090ca4d
- (_Bool)isSingleReadWriteRequest;	// IMP=0x0000000000a9a4c1
