...
+ (id)logCategory;	// IMP=0x0000000000ab54c4
- (void).cxx_destruct;	// IMP=0x0000000000ab5424
...
- (void)service:(id)arg1 account:(id)arg2 identifier:(id)arg3 didSendWithSuccess:(_Bool)arg4 error:(id)arg5;	// IMP=0x0000000000ab51b3
- (void)_callFileTransferFailed:(id)arg1;	// IMP=0x0000000000ab50b1
- (void)dealloc;	// IMP=0x0000000000ab4fcc
- (void)_sendFile:(id)arg1;	// IMP=0x0000000000ab4a63
- (void)sendFile:(id)arg1;	// IMP=0x0000000000ab49b2
- (id)logIdentifier;	// IMP=0x0000000000ab4962
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 destinationID:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5;	// IMP=0x0000000000ab4888
