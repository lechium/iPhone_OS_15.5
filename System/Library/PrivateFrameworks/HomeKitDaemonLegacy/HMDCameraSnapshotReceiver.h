...
+ (id)logCategory;	// IMP=0x0000000000728829
- (void).cxx_destruct;	// IMP=0x0000000000728772
...
- (void)_sendConfirmationToResident:(CDUnknownBlockType)arg1;	// IMP=0x00000000007284c4
- (id)_sendRequestWithTierType:(unsigned long long)arg1 toResident:(CDUnknownBlockType)arg2;	// IMP=0x000000000072810a
- (id)_sendMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000727f5d
- (id)logIdentifier;	// IMP=0x0000000000727f0d
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 options:(id)arg3 accessory:(id)arg4 delegateQueue:(id)arg5 uniqueIdentifier:(id)arg6 snapshotRequestHandler:(id)arg7 residentMessageHandler:(id)arg8;	// IMP=0x0000000000727d7a
