...
- (void).cxx_destruct;	// IMP=0x00000000009eb2e5
...
- (id)initWithDoorStatus:(id)arg1 accessoryUUID:(id)arg2 characteristicUUID:(id)arg3 timeStamp:(id)arg4 homeUUID:(id)arg5 homePresence:(id)arg6;	// IMP=0x00000000009eb13f
