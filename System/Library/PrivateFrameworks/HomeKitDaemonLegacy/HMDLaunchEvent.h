...
- (void).cxx_destruct;	// IMP=0x00000000008ce851
...
- (void)markXPCMessageTransportStarted;	// IMP=0x00000000008ce391
- (id)init;	// IMP=0x00000000008ce33d
@property(readonly, copy) NSString *diagnosticReportEventSubType;
@property(readonly, copy) NSString *diagnosticReportEventType;
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000ab3126
