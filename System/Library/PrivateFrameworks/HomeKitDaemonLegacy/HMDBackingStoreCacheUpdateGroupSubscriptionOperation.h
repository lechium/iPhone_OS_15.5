...
- (void).cxx_destruct;	// IMP=0x00000000001e09bc
...
- (id)mainReturningError;	// IMP=0x00000000001e06a3
- (id)initWithGroup:(id)arg1 subscription:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000001e05ea
