...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x000000000030e48b
+ (id)eventWithReachable:(_Bool)arg1 changed:(_Bool)arg2 duration:(double)arg3 accessory:(id)arg4 transportReport:(id)arg5;	// IMP=0x000000000030e3fd
- (void).cxx_destruct;	// IMP=0x000000000030e388
...
- (id)__initWithReachable:(_Bool)arg1 changed:(_Bool)arg2 duration:(double)arg3 accessory:(id)arg4 transportReport:(id)arg5;	// IMP=0x000000000030db27
- (id)init;	// IMP=0x000000000030da7f
