...
- (void).cxx_destruct;	// IMP=0x00000000001e1c8b
...
- (id)mainReturningError;	// IMP=0x00000000001e1a29
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x00000000001e196d
