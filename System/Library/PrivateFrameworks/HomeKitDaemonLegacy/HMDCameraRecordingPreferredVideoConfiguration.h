...
- (void).cxx_destruct;	// IMP=0x00000000007701ce
...
- (id)description;	// IMP=0x0000000000770096
- (id)initWithResolution:(long long)arg1 bitRateByFrameRate:(id)arg2 keyFrameInterval:(id)arg3 h264Level:(long long)arg4;	// IMP=0x000000000076ffe5
