...
+ (id)shortDescription;	// IMP=0x000000000001b885
- (void).cxx_destruct;	// IMP=0x000000000001b856
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x000000000001b39f
- (id)initWithBiomeEventManager:(id)arg1 dataSource:(id)arg2;	// IMP=0x000000000001b2fd
