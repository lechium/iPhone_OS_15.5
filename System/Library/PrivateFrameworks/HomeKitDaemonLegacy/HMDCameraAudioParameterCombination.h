...
- (void).cxx_destruct;	// IMP=0x00000000002f361b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002f3459
- (id)description;	// IMP=0x00000000002f3303
- (id)initWithCodecGroup:(id)arg1 bitrateSetting:(id)arg2 sampleRate:(id)arg3 maximumBitrate:(id)arg4 minimumBitrate:(id)arg5 rtcpInterval:(id)arg6 rtpPtime:(id)arg7;	// IMP=0x00000000002f320a
- (id)initWithCodecGroup:(id)arg1 bitrateSetting:(id)arg2 sampleRate:(id)arg3;	// IMP=0x00000000002f3144
