...
- (void).cxx_destruct;	// IMP=0x00000000001bd974
...
- (void)addModelToBeUpdated:(id)arg1;	// IMP=0x00000000001bd8bb
- (void)removeModelWithIdentifier:(id)arg1;	// IMP=0x00000000001bd849
- (void)addModel:(id)arg1;	// IMP=0x00000000001bd7d7
- (void)addSettingModel:(id)arg1;	// IMP=0x00000000001bd692
- (id)initForInitialCreationWithTransactionLabel:(id)arg1;	// IMP=0x00000000001bd5c6
- (id)initWithTransactionLabel:(id)arg1;	// IMP=0x00000000001bd4fa
