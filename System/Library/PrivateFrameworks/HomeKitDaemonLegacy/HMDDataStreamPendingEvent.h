...
- (void).cxx_destruct;	// IMP=0x00000000002e97e7
...
- (id)initWithProtocol:(id)arg1 topic:(id)arg2 payload:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000002e96d2
