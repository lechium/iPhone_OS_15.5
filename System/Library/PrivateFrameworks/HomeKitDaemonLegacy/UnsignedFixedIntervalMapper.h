...
- (void).cxx_destruct;	// IMP=0x0000000000055deb
...
- (id)intervalForValue:(unsigned long long)arg1;	// IMP=0x0000000000055d17
- (id)intervalIndexForValue:(unsigned long long)arg1;	// IMP=0x0000000000055b89
- (id)initWithBins:(id)arg1 intervalCreationBlock:(CDUnknownBlockType)arg2 valueComparisonBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000558ab
