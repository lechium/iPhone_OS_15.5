...
+ (id)logCategory;	// IMP=0x0000000000a41753
- (void).cxx_destruct;	// IMP=0x0000000000a3fefc
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000a3fcb0
- (id)didOccurEvent:(id)arg1 causingDevice:(id)arg2;	// IMP=0x0000000000a3fbfd
- (void)_callExecutionCompleteIfNoMoreOutstandingRequests;	// IMP=0x0000000000a3fa81
- (void)handleSessionPlaybackStateUpdatedNotification:(id)arg1;	// IMP=0x0000000000a3f984
- (void)_handleMonitoringEvent:(id)arg1;	// IMP=0x0000000000a3f61c
- (void)_restoreState;	// IMP=0x0000000000a3f16e
- (void)_removeUserDialog;	// IMP=0x0000000000a3f0cb
- (void)_callExecutionComplete:(id)arg1;	// IMP=0x0000000000a3f0b4
- (void)_submitAnalyticsData:(id)arg1;	// IMP=0x0000000000a3eae6
- (void)_callExecutionComplete:(id)arg1 callDelegate:(_Bool)arg2;	// IMP=0x0000000000a3e48f
- (id)valueInActionSetWriteResponse:(id)arg1 actionSetUUID:(id)arg2 accUUID:(id)arg3 serviceID:(id)arg4 characteristicID:(id)arg5;	// IMP=0x0000000000a3e367
- (id)_createMonitoringEvents:(id)arg1;	// IMP=0x0000000000a3d3c7
- (void)_activateEvents:(id)arg1;	// IMP=0x0000000000a3d0d3
- (void)_activateMonitoringEvents;	// IMP=0x0000000000a3d087
- (void)_activateDurationEvents;	// IMP=0x0000000000a3d03b
- (void)_handleActionSetExecutionResponse:(id)arg1 actionSetError:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000a3c934
- (void)_directlyExecuteActionSetsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000a3c7cd
- (void)_addEvent:(id)arg1 causingDevice:(id)arg2;	// IMP=0x0000000000a3c370
- (void)addEvent:(id)arg1 causingDevice:(id)arg2;	// IMP=0x0000000000a3c294
- (void)_userResponse:(unsigned long long)arg1 device:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000a3bc89
- (void)userResponse:(unsigned long long)arg1 device:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000a3bba1
- (id)durationEndEvents;	// IMP=0x0000000000a3b9b5
- (void)postponeRestoreIfWaitingForEndEvent;	// IMP=0x0000000000a3b944
- (void)cancelSessionIfWaitingForUserResponse;	// IMP=0x0000000000a3b8d3
- (_Bool)containsSecureActionSet;	// IMP=0x0000000000a3b79a
- (void)_executeTriggerAfterEvaluatingCondition:(id)arg1;	// IMP=0x0000000000a3b054
- (void)_evaluateFiringTrigger;	// IMP=0x0000000000a3a4a6
- (void)evaluateFiringTrigger;	// IMP=0x0000000000a3a435
- (id)dumpState;	// IMP=0x0000000000a3a083
@property(readonly, nonatomic) _Bool needsUserConfirmation;
- (id)logIdentifier;	// IMP=0x0000000000a3a029
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000a39f41
- (id)initWithEventTrigger:(id)arg1 predicateUtilities:(id)arg2 triggerEvent:(id)arg3 causingDevice:(id)arg4 workQueue:(id)arg5 actionSets:(id)arg6 evaluationCondition:(id)arg7 recurrences:(id)arg8 endEvents:(id)arg9 msgDispatcher:(id)arg10;	// IMP=0x0000000000a39af1
