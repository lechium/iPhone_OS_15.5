...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000008bfee5
- (void).cxx_destruct;	// IMP=0x00000000008bfe81
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000008bfccc
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000008bfb35
- (unsigned long long)hash;	// IMP=0x00000000008bfaf1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008bfa1e
- (id)description;	// IMP=0x00000000008bf907
- (id)initWithVideoResolution:(id)arg1 framerate:(id)arg2 minBitRate:(id)arg3 maxBitRate:(id)arg4 rtcpInterval:(id)arg5;	// IMP=0x00000000008bf7ef
