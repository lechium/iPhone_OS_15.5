...
- (void).cxx_destruct;	// IMP=0x000000000063e55d
@property(readonly, copy, nonatomic) NSString *sessionIdentifier; // @synthesize sessionIdentifier=_sessionIdentifier;
- (id)dumpState;	// IMP=0x000000000063e330
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000063ded4
...
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x000000000063d9a4
