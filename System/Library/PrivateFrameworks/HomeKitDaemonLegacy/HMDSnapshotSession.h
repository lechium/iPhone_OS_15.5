...
+ (id)logCategory;	// IMP=0x00000000006f5748
- (void).cxx_destruct;	// IMP=0x00000000006f56e4
...
- (void)respond:(id)arg1 payload:(id)arg2;	// IMP=0x00000000006f5219
- (void)dealloc;	// IMP=0x00000000006f519d
- (id)logIdentifier;	// IMP=0x00000000006f514d
- (id)initWithSessionID:(id)arg1 accessory:(id)arg2 snapshotGetter:(id)arg3 message:(id)arg4 waitPeriod:(double)arg5 streamingTierType:(unsigned long long)arg6 cameraLocallyReachable:(_Bool)arg7 snapshotForNotification:(_Bool)arg8;	// IMP=0x00000000006f4f81
