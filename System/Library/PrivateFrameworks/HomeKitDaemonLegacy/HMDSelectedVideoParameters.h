...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000007885b
- (void).cxx_destruct;	// IMP=0x0000000000078808
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000786ac
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000783b1
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000078199
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000077e91
- (id)tlvData;	// IMP=0x0000000000077ca2
- (id)initWithCodec:(id)arg1 codecParameter:(id)arg2 attribute:(id)arg3 rtpParameter:(id)arg4;	// IMP=0x0000000000077bab
