...
- (void).cxx_destruct;	// IMP=0x0000000000701862
...
- (void)main;	// IMP=0x000000000070122d
- (id)initWithStore:(id)arg1 clearCloud:(_Bool)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000701161
