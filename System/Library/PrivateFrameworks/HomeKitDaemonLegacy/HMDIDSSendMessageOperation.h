...
+ (id)logCategory;	// IMP=0x000000000034d9fa
+ (id)shortDescription;	// IMP=0x000000000034d9e8
+ (double)timeout;	// IMP=0x000000000034d90a
- (void).cxx_destruct;	// IMP=0x000000000034d8b7
...
- (void)service:(id)arg1 account:(id)arg2 identifier:(id)arg3 didSendWithSuccess:(_Bool)arg4 error:(id)arg5 context:(id)arg6;	// IMP=0x000000000034d672
- (id)logIdentifier;	// IMP=0x000000000034d617
- (void)main;	// IMP=0x000000000034cf07
@property(readonly, copy, nonatomic) NSArray *attributeDescriptions;
@property(readonly, copy) NSString *description;
@property(readonly, copy) NSString *privateDescription;
@property(readonly, copy) NSString *shortDescription;
- (id)initWithMessage:(id)arg1 service:(id)arg2;	// IMP=0x000000000034c95a
- (id)initWithMessage:(id)arg1;	// IMP=0x000000000034c8bb
