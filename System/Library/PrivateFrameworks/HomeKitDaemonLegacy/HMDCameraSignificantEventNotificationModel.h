...
+ (id)significantEventsBetweenDatesQueryWithIsAscending:(_Bool)arg1;	// IMP=0x00000000002876a6
+ (id)hmbQueries;	// IMP=0x00000000002875db
+ (id)hmbExternalRecordType;	// IMP=0x00000000002875ce
+ (id)hmbProperties;	// IMP=0x000000000028759e
- (id)createClipSignificantEventWithCameraProfileUUID:(id)arg1 faceClassification:(id)arg2;	// IMP=0x0000000000287dd3
