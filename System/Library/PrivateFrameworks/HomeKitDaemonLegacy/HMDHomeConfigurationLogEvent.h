...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x00000000004b0ad3
- (void).cxx_destruct;	// IMP=0x00000000004afede
...
- (id)initWithHome:(id)arg1 metadataVersion:(unsigned int)arg2 databaseSize:(unsigned int)arg3 homeIndex:(unsigned long long)arg4;	// IMP=0x00000000004aa8fe
- (long long)weeksSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x00000000004aa892
- (long long)daysSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x00000000004aa7cd
- (void)setHomeConfigurationBitMasks;	// IMP=0x00000000004aa6c6
