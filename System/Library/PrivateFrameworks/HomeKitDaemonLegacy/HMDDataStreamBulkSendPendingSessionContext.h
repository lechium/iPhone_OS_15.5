...
- (void).cxx_destruct;	// IMP=0x0000000000733e2d
...
- (id)initWithSessionStartCallback:(CDUnknownBlockType)arg1 handleOpenRequestResponseTimer:(id)arg2 sendCloseEventTimer:(id)arg3;	// IMP=0x0000000000733ca9
