...
- (void).cxx_destruct;	// IMP=0x000000000034328a
...
- (id)description;	// IMP=0x0000000000343153
- (id)initWithHomePresence:(id)arg1 userPresence:(id)arg2 update:(_Bool)arg3 causingDevice:(id)arg4;	// IMP=0x000000000034307b
