...
- (void).cxx_destruct;	// IMP=0x000000000047745f
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000476f81
- (unsigned long long)hash;	// IMP=0x0000000000476bf6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004766eb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000476396
- (void)copyTo:(id)arg1;	// IMP=0x000000000047606e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000475d0b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000475cfe
- (id)dictionaryRepresentation;	// IMP=0x0000000000475401
- (id)description;	// IMP=0x0000000000475352
