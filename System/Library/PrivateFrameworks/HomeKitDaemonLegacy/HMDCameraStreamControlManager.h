...
+ (id)logCategory;	// IMP=0x00000000008150ad
- (void).cxx_destruct;	// IMP=0x0000000000814f60
...
- (id)logIdentifier;	// IMP=0x0000000000814e50
- (void)_callStreamStoppedWithError:(id)arg1;	// IMP=0x0000000000814bfe
- (void)_callStreamReconfigured;	// IMP=0x0000000000814a54
- (void)_callStreamFirstFrameReceived;	// IMP=0x00000000008148aa
- (void)_callStreamStarted;	// IMP=0x0000000000814700
- (void)_callStreamRemoteConnectionSetup;	// IMP=0x0000000000814556
- (void)_callStreamNegotiated:(id)arg1;	// IMP=0x000000000081437a
- (id)managerProtocol;	// IMP=0x000000000081433e
- (void)_reportInternalErrorCode:(long long)arg1;	// IMP=0x00000000008142eb
- (void)_reportErrorCode:(long long)arg1;	// IMP=0x0000000000814298
- (void)_cleanUpStreamSessionWithError:(id)arg1;	// IMP=0x00000000008141e2
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 streamSnapshotHandler:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5 accessory:(id)arg6 streamManagementService:(id)arg7 isLocal:(_Bool)arg8;	// IMP=0x0000000000813faf
