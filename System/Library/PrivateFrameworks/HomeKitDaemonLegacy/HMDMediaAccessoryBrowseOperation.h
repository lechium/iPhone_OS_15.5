...
+ (id)logCategory;	// IMP=0x000000000035bfa8
+ (double)defaultTimeout;	// IMP=0x000000000035bf7b
- (void).cxx_destruct;	// IMP=0x000000000035b974
@property(readonly, copy) NSString *accessoryIdentifier; // @synthesize accessoryIdentifier=_accessoryIdentifier;
- (void)cancel;	// IMP=0x000000000035b918
- (void)main;	// IMP=0x000000000035b6ff
...
- (void)dealloc;	// IMP=0x000000000035b2c0
- (id)initWithAccessoryIdentifier:(id)arg1 timeout:(double)arg2;	// IMP=0x000000000035b0f9
- (id)initWithAccessoryIdentifier:(id)arg1;	// IMP=0x000000000035b0e4
