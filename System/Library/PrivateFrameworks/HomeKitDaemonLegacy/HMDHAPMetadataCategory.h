...
- (void).cxx_destruct;	// IMP=0x00000000001f724b
...
- (id)description;	// IMP=0x00000000001f70cb
- (id)initWithIdentifier:(id)arg1 uuid:(id)arg2 name:(id)arg3 description:(id)arg4;	// IMP=0x00000000001f6f76
- (id)init;	// IMP=0x00000000001f6ece
