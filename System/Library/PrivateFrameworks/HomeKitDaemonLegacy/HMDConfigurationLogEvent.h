...
+ (void)initialize;	// IMP=0x00000000002515c5
- (void).cxx_destruct;	// IMP=0x0000000000251572
...
- (_Bool)isSubmitted;	// IMP=0x0000000000251286
...
- (id)createHistogrammedAggregateHomeDataCommonDimensionsFormattedForCoreAnalytics;	// IMP=0x000000000025057c
- (id)createHomesCategorizationCommonDimensionsFormattedForCoreAnalytics;	// IMP=0x0000000000250431
- (id)createDeviceCapabilitiesAndEnablementsCommonDimensionsFormattedForCoreAnalytics;	// IMP=0x00000000002501f9
- (id)initWithHomeConfigurations:(id)arg1;	// IMP=0x000000000024f810
- (id)initWithHomeManager:(id)arg1 metadataVersion:(unsigned int)arg2;	// IMP=0x000000000024f5a5
- (int)convertToAWDNetworkProtectionStatus:(int)arg1;	// IMP=0x00000000007b905e
- (int)convertToAWDMultiUserValueType:(int)arg1;	// IMP=0x00000000007b903f
- (id)convertToAWDMultiUserSettings:(id)arg1;	// IMP=0x00000000007b8c84
- (id)convertToAWDMultiUserSettingsList:(id)arg1;	// IMP=0x00000000007b8aa2
- (id)getHomeConfiguration:(id)arg1;	// IMP=0x00000000007b7e5e
- (id)generateAWDHomeConfiguration:(id)arg1;	// IMP=0x00000000007b7c7c
- (id)metricForAWD;	// IMP=0x00000000007b7977
- (unsigned int)AWDMessageType;	// IMP=0x00000000007b796c
