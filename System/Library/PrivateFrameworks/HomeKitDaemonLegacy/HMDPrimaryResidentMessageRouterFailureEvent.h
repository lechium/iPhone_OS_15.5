...
- (void).cxx_destruct;	// IMP=0x000000000007c4ec
...
- (id)attributeDescriptions;	// IMP=0x000000000007c320
@property(readonly, nonatomic) NSDictionary *serializedEvent;
@property(readonly, nonatomic) NSString *eventName;
- (id)initWithMessageName:(id)arg1 failureType:(long long)arg2;	// IMP=0x000000000007c188
