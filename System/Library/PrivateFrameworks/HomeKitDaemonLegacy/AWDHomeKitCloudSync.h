...
+ (Class)topErrorsType;	// IMP=0x000000000041c94d
+ (Class)topReasonsType;	// IMP=0x000000000041c93c
- (void).cxx_destruct;	// IMP=0x000000000041bd49
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000041b770
- (unsigned long long)hash;	// IMP=0x000000000041b4d3
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000041b0e3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000041aba0
- (void)copyTo:(id)arg1;	// IMP=0x000000000041a85b
- (void)writeTo:(id)arg1;	// IMP=0x000000000041a411
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000041a404
- (id)dictionaryRepresentation;	// IMP=0x00000000004199b8
- (id)description;	// IMP=0x0000000000419909
...
- (int)StringAsDataSyncState:(id)arg1;	// IMP=0x00000000004195bc
- (id)dataSyncStateAsString:(int)arg1;	// IMP=0x0000000000419522
...
- (id)topErrorsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000004193b6
- (unsigned long long)topErrorsCount;	// IMP=0x0000000000419399
- (void)addTopErrors:(id)arg1;	// IMP=0x000000000041932f
- (void)clearTopErrors;	// IMP=0x0000000000419312
- (id)topReasonsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000004192f5
- (unsigned long long)topReasonsCount;	// IMP=0x00000000004192d8
- (void)addTopReasons:(id)arg1;	// IMP=0x000000000041926e
- (void)clearTopReasons;	// IMP=0x0000000000419251
