...
+ (id)logCategory;	// IMP=0x00000000002edb16
- (void).cxx_destruct;	// IMP=0x00000000002ed061
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000002ece2c
- (void)transport:(id)arg1 didReceiveRawFrame:(id)arg2;	// IMP=0x00000000002eb0a5
- (void)transportDidOpen:(id)arg1;	// IMP=0x00000000002eacd8
- (void)transportDidClose:(id)arg1;	// IMP=0x00000000002eaa06
- (void)transport:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00000000002ea6fc
- (void)setTrafficClass:(unsigned long long)arg1;	// IMP=0x00000000002ea5ee
- (void)protocolDidUpdateActiveStatus:(id)arg1;	// IMP=0x00000000002ea5e4
- (void)sendRequestForProtocol:(id)arg1 topic:(id)arg2 payload:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000002ea2e4
- (void)sendRequestForProtocol:(id)arg1 topic:(id)arg2 identifier:(unsigned long long)arg3 payload:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000000002ea1e8
- (void)sendResponseForRequestHeader:(id)arg1 payload:(id)arg2 status:(unsigned short)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000002ea14d
- (void)sendEventForProtocol:(id)arg1 topic:(id)arg2 payload:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000002e9f76
- (id)protocolDelegateHandle;	// IMP=0x00000000002e9f6d
- (id)protocolWithName:(id)arg1;	// IMP=0x00000000002e9ec4
- (void)addProtocol:(id)arg1 name:(id)arg2;	// IMP=0x00000000002e9e38
- (void)close;	// IMP=0x00000000002e9c1e
- (void)connect;	// IMP=0x00000000002e9b25
@property(nonatomic, getter=isActive) _Bool active; // @synthesize active=_active;
- (id)initWithTransport:(id)arg1 sessionEncryption:(id)arg2 workQueue:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x00000000002e9825
