...
+ (id)eventWithIsEnabled:(_Bool)arg1 options:(unsigned long long)arg2 areActivityNotificationsEnabledForPersonalRequests:(_Bool)arg3 numEnabledAccessories:(unsigned long long)arg4 numCapableAccessories:(unsigned long long)arg5;	// IMP=0x00000000003fbc77
...
- (id)metricForAWD;	// IMP=0x00000000007bff49
- (unsigned int)AWDMessageType;	// IMP=0x00000000007bff3e
