...
+ (id)XPCMessageCountersLogEventWithType:(id)arg1 peerInformation:(id)arg2 messageName:(id)arg3 count:(id)arg4;	// IMP=0x00000000002dc95e
- (void).cxx_destruct;	// IMP=0x00000000002dc90b
...
- (_Bool)shouldSubmit;	// IMP=0x00000000002dc87d
- (id)__initWithType:(id)arg1 peerInformation:(id)arg2 messageName:(id)arg3 count:(id)arg4;	// IMP=0x00000000002dc745
