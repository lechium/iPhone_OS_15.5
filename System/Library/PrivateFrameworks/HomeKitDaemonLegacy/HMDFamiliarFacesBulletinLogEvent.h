...
- (void).cxx_destruct;	// IMP=0x000000000007c806
...
- (id)initWithNumberOfKnownPersons:(long long)arg1 numberOfUnknownPersons:(long long)arg2 bulletinReason:(id)arg3 doorbellPressed:(_Bool)arg4 secondsFromDoorbellToFaceClassification:(double)arg5;	// IMP=0x000000000007c6e4
