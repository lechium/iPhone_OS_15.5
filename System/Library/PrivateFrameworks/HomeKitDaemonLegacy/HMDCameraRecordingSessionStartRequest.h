...
- (void).cxx_destruct;	// IMP=0x0000000000663b0f
...
- (id)initWithHomePresenceByPairingIdentity:(id)arg1 trigger:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006639fb
