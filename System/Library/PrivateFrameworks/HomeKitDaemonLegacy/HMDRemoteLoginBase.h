...
+ (id)logCategory;	// IMP=0x000000000068b656
+ (_Bool)hasMessageReceiverChildren;	// IMP=0x000000000068b64e
- (void).cxx_destruct;	// IMP=0x000000000068b5dd
...
- (id)logIdentifier;	// IMP=0x000000000068b52d
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)registerForMessages;	// IMP=0x000000000068b503
- (void)configureWithWorkQueue:(id)arg1 messageDispatcher:(id)arg2;	// IMP=0x000000000068b4a2
@property(readonly, copy) NSString *description;
- (id)initWithUUID:(id)arg1 accessory:(id)arg2 remoteLoginHandler:(id)arg3;	// IMP=0x000000000068b2b4
