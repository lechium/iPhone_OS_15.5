...
- (void).cxx_destruct;	// IMP=0x0000000000501c6e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000501885
@property(readonly) unsigned long long hash;
- (id)initWithAccount:(id)arg1;	// IMP=0x00000000005017ef
- (id)init;	// IMP=0x0000000000501747
