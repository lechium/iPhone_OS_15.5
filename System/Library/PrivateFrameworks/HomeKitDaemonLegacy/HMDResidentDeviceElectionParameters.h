...
- (void).cxx_destruct;	// IMP=0x00000000009e8758
...
- (id)attributeDescriptions;	// IMP=0x00000000009e8462
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009e83df
- (unsigned long long)hash;	// IMP=0x00000000009e839b
- (long long)compare:(id)arg1 outCriteria:(unsigned long long *)arg2;	// IMP=0x00000000009e7d19
- (long long)compare:(id)arg1;	// IMP=0x00000000009e7d05
@property(readonly, copy) NSDictionary *dictionaryRepresentation;
- (id)initWithResident:(id)arg1 enabled:(id)arg2 location:(long long)arg3 accessories:(id)arg4;	// IMP=0x00000000009e785d
- (id)initWithResident:(id)arg1 dictionaryRepresentation:(id)arg2;	// IMP=0x00000000009e7669
