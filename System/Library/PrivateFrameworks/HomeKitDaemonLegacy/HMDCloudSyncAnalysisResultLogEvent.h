...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x00000000007f085c
- (void).cxx_destruct;	// IMP=0x00000000007f218e
...
- (id)metricForAWD;	// IMP=0x00000000007f086f
- (unsigned int)AWDMessageType;	// IMP=0x00000000007f0864
