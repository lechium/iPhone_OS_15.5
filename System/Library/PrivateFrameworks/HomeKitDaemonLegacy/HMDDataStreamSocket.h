...
+ (id)logCategory;	// IMP=0x0000000000479578
- (void).cxx_destruct;	// IMP=0x0000000000479143
...
- (void)closeInitiated;	// IMP=0x0000000000479027
- (void)handleIncomingData:(id)arg1;	// IMP=0x0000000000478efd
- (void)closeWithError:(id)arg1;	// IMP=0x0000000000478d6d
- (id)readData;	// IMP=0x0000000000478c48
- (void)_writeData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000478b6c
- (void)writeData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000478ac2
- (_Bool)writeData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000478a30
- (void)close;	// IMP=0x0000000000478a1c
...
- (id)initWithStreamProtocol:(id)arg1 applicationProtocolName:(id)arg2 workQueue:(id)arg3;	// IMP=0x00000000004783bc
