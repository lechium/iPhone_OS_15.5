...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000049ba40
- (void).cxx_destruct;	// IMP=0x000000000049afeb
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000049a841
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000049a70e
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000049a090
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000049995f
- (id)initWithClientIdentifier:(id)arg1 macAddress:(id)arg2 ipAddressList:(id)arg3 lanIdentifier:(id)arg4 name:(id)arg5 rssi:(id)arg6;	// IMP=0x0000000000499837
- (id)init;	// IMP=0x0000000000499808
