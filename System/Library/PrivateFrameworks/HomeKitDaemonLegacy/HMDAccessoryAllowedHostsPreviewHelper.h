...
+ (id)helperForHome:(id)arg1;	// IMP=0x0000000000292e33
- (void).cxx_destruct;	// IMP=0x0000000000292c73
- (id)attributeDescriptions;	// IMP=0x0000000000292bad
- (id)watchedAccessoryIdentifiersForFirewallRuleManager:(id)arg1;	// IMP=0x0000000000292856
- (void)fetchAllowedHostsForAccessory:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000002925eb
