...
+ (id)sharedState;	// IMP=0x00000000007604f6
- (void).cxx_destruct;	// IMP=0x000000000076027c
- (void)_callDidUpdateReachabilityChangeForCompanion:(_Bool)arg1 forDelegate:(id)arg2;	// IMP=0x000000000076020f
- (void)registerDelegate:(id)arg1;	// IMP=0x0000000000760144
...
- (id)init;	// IMP=0x000000000075fc1a
