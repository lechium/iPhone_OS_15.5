...
+ (id)logCategory;	// IMP=0x00000000006d2970
+ (double)timeout;	// IMP=0x00000000006d2892
- (void).cxx_destruct;	// IMP=0x00000000006d2436
...
- (id)logIdentifier;	// IMP=0x00000000006d2307
- (void)main;	// IMP=0x00000000006d1ea9
- (id)initWithMessage:(id)arg1 home:(id)arg2 dispatcher:(id)arg3;	// IMP=0x00000000006d1d5e
