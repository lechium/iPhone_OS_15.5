...
+ (id)logCategory;	// IMP=0x0000000000910cf7
- (void).cxx_destruct;	// IMP=0x000000000091091d
...
- (id)attributeDescriptions;	// IMP=0x0000000000910617
- (_Bool)_isCancelledError:(id)arg1;	// IMP=0x000000000091058d
- (void)_handleFatalOperationFailure;	// IMP=0x00000000009103ae
- (void)_startNextOperation;	// IMP=0x0000000000910275
- (void)_operationCompleted:(id)arg1 finalizeOnError:(_Bool)arg2 future:(id)arg3;	// IMP=0x000000000090ffeb
- (id)_addOperation:(id)arg1 finalizeClipOnError:(_Bool)arg2;	// IMP=0x000000000090fd4c
- (id)_createClipWithSignificantEvent:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x000000000090fb90
- (id)_createClip;	// IMP=0x000000000090fa0a
- (_Bool)hasAddedCreateClipOperation;	// IMP=0x000000000090f9d7
- (id)finish;	// IMP=0x000000000090f8d7
- (id)addVideoSegmentData:(id)arg1 duration:(double)arg2 timeOffsetWithinClip:(double)arg3 clipFinalizedBecauseMaxDurationExceeded:(_Bool)arg4;	// IMP=0x000000000090f5d8
- (id)addVideoInitData:(id)arg1;	// IMP=0x000000000090f340
- (id)addNotificationForSignificantEvent:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x000000000090effd
- (id)createClip;	// IMP=0x000000000090ee14
- (id)initWithClipUUID:(id)arg1 startDate:(id)arg2 targetFragmentDuration:(double)arg3 quality:(long long)arg4 localZone:(id)arg5 workQueue:(id)arg6 logIdentifier:(id)arg7 encryptionManager:(id)arg8 factory:(id)arg9;	// IMP=0x000000000090ec1b
- (id)initWithClipUUID:(id)arg1 startDate:(id)arg2 targetFragmentDuration:(double)arg3 quality:(long long)arg4 localZone:(id)arg5 workQueue:(id)arg6 logIdentifier:(id)arg7;	// IMP=0x000000000090eb0d
