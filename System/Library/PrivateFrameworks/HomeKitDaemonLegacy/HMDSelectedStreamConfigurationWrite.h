...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000079faf
- (void).cxx_destruct;	// IMP=0x0000000000079f6d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000079e57
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000079bf8
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000079a5d
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000079768
- (id)tlvData;	// IMP=0x00000000000795ed
- (id)initWithSessionControl:(id)arg1;	// IMP=0x000000000007957f
- (id)initWithSessionControl:(id)arg1 videoParameters:(id)arg2 audioParameters:(id)arg3;	// IMP=0x00000000000794b9
