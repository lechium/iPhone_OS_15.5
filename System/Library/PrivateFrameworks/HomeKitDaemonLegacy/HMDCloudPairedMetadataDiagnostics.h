...
+ (id)logCategory;	// IMP=0x00000000007258cd
- (void).cxx_destruct;	// IMP=0x000000000072588b
...
- (id)attributeDescriptions;	// IMP=0x000000000072547a
- (id)initWithAccessoryIdentifier:(id)arg1 privacyPolicyURL:(id)arg2 uploadDestination:(id)arg3 consentVersion:(unsigned long long)arg4 uploadType:(unsigned long long)arg5;	// IMP=0x0000000000725380
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x0000000000724f55
