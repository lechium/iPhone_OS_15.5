...
+ (id)frameWorkFetchResultsWithOperationResults:(id)arg1;	// IMP=0x00000000002874b5
- (void).cxx_destruct;	// IMP=0x0000000000287462
...
- (id)attributeDescriptions;	// IMP=0x0000000000287242
- (id)initWithKeyPath:(id)arg1 setting:(id)arg2 metadata:(id)arg3 error:(id)arg4;	// IMP=0x0000000000287156
