...
- (void).cxx_destruct;	// IMP=0x0000000000589524
...
- (void)setValueUpdatedTime:(id)arg1 stateNumber:(id)arg2;	// IMP=0x0000000000589408
- (id)initWithError:(id)arg1;	// IMP=0x000000000058939a
- (id)initWithValue:(id)arg1 updateIdentifier:(id)arg2 remoteDevice:(id)arg3;	// IMP=0x00000000005892d4
