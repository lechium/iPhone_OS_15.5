...
- (void).cxx_destruct;	// IMP=0x00000000002f6bce
...
- (id)initWithMessageName:(id)arg1 qualityOfService:(long long)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000002f6a8d
