...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000a973
- (void).cxx_destruct;	// IMP=0x000000000000a92a
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000a810
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000a653
@property(readonly, copy) NSString *name;
@property(readonly, copy) id value;
- (id)initWithIdentifier:(id)arg1 parentIdentifier:(id)arg2 type:(id)arg3 numberValue:(id)arg4 dataValue:(id)arg5;	// IMP=0x000000000000a37b
