...
+ (id)shortDescription;	// IMP=0x00000000009f5123
- (void).cxx_destruct;	// IMP=0x00000000009f508e
...
- (id)replayTransaction:(id)arg1 stagedTransaction:(id)arg2;	// IMP=0x00000000009f4b29
- (void)loadObjectChanges;	// IMP=0x00000000009f4b06
- (id)changeWithRecordName:(id)arg1;	// IMP=0x00000000009f4a83
- (id)changeWithObjectID:(id)arg1;	// IMP=0x00000000009f4a00
...
- (void)updateCloudCache;	// IMP=0x00000000009f47e0
- (void)setDeleteAsProcessedWithRecordID:(id)arg1;	// IMP=0x00000000009f476e
- (void)resetRecordWithRecordID:(id)arg1;	// IMP=0x00000000009f46fc
- (void)setSaveAsProcessedWithRecord:(id)arg1;	// IMP=0x00000000009f468a
- (void)fetchBatchToUpload:(CDUnknownBlockType)arg1;	// IMP=0x00000000009f4618
- (_Bool)moreChangesToProcess;	// IMP=0x00000000009f45d4
- (void)setAllChangedAsProcessed;	// IMP=0x00000000009f4597
- (void)loadCloudRecordsAndDetermineDeletesFromCache:(CDUnknownBlockType)arg1;	// IMP=0x00000000009f4403
- (void)cachedCloudRecordWithObjectID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000009f437d
- (id)cachedCloudRecordWithObjectID:(id)arg1;	// IMP=0x00000000009f42fa
@property(readonly) _Bool doRecordsExistInCache;
- (_Bool)doesRecordExistInCacheWithObjectID:(id)arg1;	// IMP=0x00000000009f423f
- (_Bool)doesRecordExistWithObjectID:(id)arg1;	// IMP=0x00000000009f41c8
@property(readonly, nonatomic) _Bool hasValidChanges;
- (void)removeChangeWithObjectID:(id)arg1;	// IMP=0x00000000009f4112
- (void)addChangeWithDeletedRecordID:(id)arg1;	// IMP=0x00000000009f40a0
- (void)addChangeWithRecord:(id)arg1;	// IMP=0x00000000009f402e
- (void)addChangeWithObjectChange:(id)arg1;	// IMP=0x00000000009f3fbc
...
- (id)description;	// IMP=0x00000000009f3ce0
- (id)shortDescription;	// IMP=0x00000000009f3bb0
- (void)updateCloudZone:(id)arg1;	// IMP=0x00000000009f3b2b
- (id)initWithType:(unsigned long long)arg1 temporaryCache:(_Bool)arg2 noLocalData:(_Bool)arg3;	// IMP=0x00000000009f3a88
- (id)initWithType:(unsigned long long)arg1 temporaryCache:(_Bool)arg2;	// IMP=0x00000000009f3a73
- (id)init;	// IMP=0x00000000009f39cb
