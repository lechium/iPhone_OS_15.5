...
- (void).cxx_destruct;	// IMP=0x000000000019710e
...
- (id)initWithReadCharacteristicType:(id)arg1 writeCharacteristicType:(id)arg2 format:(id)arg3 mandatory:(_Bool)arg4;	// IMP=0x0000000000196ff3
