...
- (void).cxx_destruct;	// IMP=0x000000000086ef9a
@property(nonatomic) __weak id <HMDCoordinationAddOnImplDelegate> delegate; // @synthesize delegate=_delegate;
- (void)didChangeNodesForMeshController:(id)arg1;	// IMP=0x000000000086ef11
- (void)meshController:(id)arg1 didTransitionToState:(unsigned long long)arg2;	// IMP=0x000000000086ee92
