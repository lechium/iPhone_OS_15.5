...
- (void).cxx_destruct;	// IMP=0x000000000058464c
...
- (void)setError:(id)arg1;	// IMP=0x0000000000584533
- (id)metricForAWD;	// IMP=0x0000000000584521
- (unsigned int)AWDMessageType;	// IMP=0x0000000000584516
- (id)initWithSessionID:(id)arg1;	// IMP=0x000000000058442f
