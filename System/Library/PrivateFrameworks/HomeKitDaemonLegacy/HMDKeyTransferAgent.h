...
+ (id)logCategory;	// IMP=0x000000000062b2df
- (void).cxx_destruct;	// IMP=0x000000000062b28e
...
- (void)resetConfig;	// IMP=0x000000000062b08d
- (void)beginPairingWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000062af6e
- (id)initWithHomeManager:(id)arg1;	// IMP=0x000000000062ae17
