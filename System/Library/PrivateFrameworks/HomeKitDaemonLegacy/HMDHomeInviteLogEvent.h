...
+ (id)updateWithInvitationState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x000000000056c91a
+ (id)updateWithState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x000000000056c8df
...
- (id)initWithHomeInviteLogEventState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x000000000056c150
