...
- (void).cxx_destruct;	// IMP=0x0000000000241a58
...
- (void)logRateTrigger:(id)arg1 triggerValue:(unsigned long long)arg2;	// IMP=0x0000000000241885
- (void)updatedCounterForEventName:(id)arg1 fromOldValue:(unsigned long long)arg2 toNewValue:(unsigned long long)arg3;	// IMP=0x00000000002414d1
- (void)dealloc;	// IMP=0x0000000000241497
- (id)initWithThreshold:(unsigned long long)arg1 windowSize:(unsigned long long)arg2 counterName:(id)arg3 uploadImmediately:(_Bool)arg4 timeSourceBlock:(CDUnknownBlockType)arg5;	// IMP=0x00000000002413ae
- (id)initWithThreshold:(unsigned long long)arg1 windowSize:(unsigned long long)arg2 counterName:(id)arg3 uploadImmediately:(_Bool)arg4;	// IMP=0x0000000000241388
- (id)initWithThreshold:(unsigned long long)arg1 windowSize:(unsigned long long)arg2 counterName:(id)arg3;	// IMP=0x0000000000241373
