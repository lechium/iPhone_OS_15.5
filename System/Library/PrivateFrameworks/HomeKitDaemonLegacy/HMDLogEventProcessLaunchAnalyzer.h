...
+ (id)managedEventCounterRequestGroups;	// IMP=0x00000000007875a2
- (void).cxx_destruct;	// IMP=0x000000000078750b
...
- (void)resetAggregationAnalysisContext;	// IMP=0x0000000000787473
- (void)populateAggregationAnalysisLogEvent:(id)arg1;	// IMP=0x0000000000787275
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000007871f5
- (void)submitProcessLaunchEventWithCurrentAnalysis;	// IMP=0x000000000078705c
- (void)handleExitContextForHomed:(id)arg1;	// IMP=0x0000000000786af2
- (void)updateProcessLaunchInfoFromDisk;	// IMP=0x000000000078690c
- (void)submitProcessLaunchInfoEventPendingConfiguration;	// IMP=0x0000000000786875
- (void)handleDataSyncStateUpdateLogEvent:(id)arg1;	// IMP=0x00000000007867aa
- (void)handleProcessLaunchLogEvent:(id)arg1;	// IMP=0x0000000000786633
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000786501
- (id)initWithProcessLaunchInfoTimer:(id)arg1 eventCountersManager:(id)arg2 logEventSubmitter:(id)arg3;	// IMP=0x0000000000786426
