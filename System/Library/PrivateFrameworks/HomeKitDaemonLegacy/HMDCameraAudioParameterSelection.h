...
+ (id)logCategory;	// IMP=0x0000000000090c83
- (void).cxx_destruct;	// IMP=0x0000000000090b86
...
- (void)_generateAllCombinations:(id)arg1;	// IMP=0x00000000000904c8
- (id)createSelectedAudioParameters;	// IMP=0x0000000000090101
- (id)createSRTPParamters;	// IMP=0x0000000000090081
- (_Bool)_selectParametersFromCodec:(id)arg1 bitRateSettings:(id)arg2 sampleRates:(id)arg3 audioChannelCount:(id)arg4;	// IMP=0x000000000008fabc
- (_Bool)selectAudioParameters;	// IMP=0x000000000008f29d
- (id)logIdentifier;	// IMP=0x000000000008f24d
- (id)initWithSessionID:(id)arg1 supportedAudioConfiguration:(id)arg2 supportedRTPConfiguration:(id)arg3 streamingCapabilities:(id)arg4;	// IMP=0x000000000008f0b9
