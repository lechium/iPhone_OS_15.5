...
+ (id)logCategory;	// IMP=0x000000000094aad1
- (void).cxx_destruct;	// IMP=0x000000000094aa57
...
- (id)logIdentifier;	// IMP=0x000000000094a9ab
@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)__handleXPCMessage:(id)arg1;	// IMP=0x000000000094a7e0
- (void)registerForMessage:(id)arg1 policies:(id)arg2;	// IMP=0x000000000094a6f7
- (id)shortDescription;	// IMP=0x000000000094a67d
- (void)dealloc;	// IMP=0x000000000094a5c0
- (id)initWithReceiver:(id)arg1 handler:(id)arg2;	// IMP=0x000000000094a525
