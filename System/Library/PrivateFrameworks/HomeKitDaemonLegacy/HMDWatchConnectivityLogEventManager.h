...
+ (id)sharedInstance;	// IMP=0x000000000042359c
- (void).cxx_destruct;	// IMP=0x0000000000423383
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000423234
- (struct HMDWatchConnectivityLogEventManagerSnapshot)currentWatchConnectivitySnapshot;	// IMP=0x0000000000423116
- (void)completeCurrentReport;	// IMP=0x0000000000423074
- (void)incrementWatchRemovedNotificationCount;	// IMP=0x0000000000422fd2
- (void)incrementWatchAddedNotificationCount;	// IMP=0x0000000000422f30
- (id)init;	// IMP=0x0000000000422e42
