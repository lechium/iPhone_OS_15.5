...
- (void).cxx_destruct;	// IMP=0x000000000021eae8
...
- (void)dealloc;	// IMP=0x000000000021e9b7
- (id)initWithSessionID:(id)arg1 cameraAccessory:(id)arg2 isLocal:(_Bool)arg3;	// IMP=0x000000000021e8fe
