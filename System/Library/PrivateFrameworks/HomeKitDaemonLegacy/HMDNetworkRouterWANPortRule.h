...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000495d57
- (void).cxx_destruct;	// IMP=0x0000000000495d03
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000495559
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000495426
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000494da8
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000494683
- (id)initWithProtocol:(id)arg1 hostDNSName:(id)arg2 hostIPStart:(id)arg3 hostIPEnd:(id)arg4 hostPortStart:(id)arg5 hostPortEnd:(id)arg6;	// IMP=0x000000000049455b
- (id)init;	// IMP=0x000000000049452c
- (void)addTo:(id)arg1;	// IMP=0x000000000041e684
