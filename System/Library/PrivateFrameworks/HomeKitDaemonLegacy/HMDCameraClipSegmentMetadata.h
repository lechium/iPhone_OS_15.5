...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000860967
- (unsigned long long)hash;	// IMP=0x000000000086069d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000860515
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000086040f
- (void)copyTo:(id)arg1;	// IMP=0x000000000086032c
- (void)writeTo:(id)arg1;	// IMP=0x000000000086021a
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000086020d
- (id)dictionaryRepresentation;	// IMP=0x000000000085ff2d
- (id)description;	// IMP=0x000000000085fe7e
@property(nonatomic) _Bool hasHeight;
@property(nonatomic) _Bool hasWidth;
- (int)StringAsType:(id)arg1;	// IMP=0x000000000085fd56
- (id)typeAsString:(int)arg1;	// IMP=0x000000000085fcf0
