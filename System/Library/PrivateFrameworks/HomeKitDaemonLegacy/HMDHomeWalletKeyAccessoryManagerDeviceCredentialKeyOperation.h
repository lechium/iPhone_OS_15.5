...
- (void).cxx_destruct;	// IMP=0x00000000008c059c
...
- (id)attributeDescriptions;	// IMP=0x00000000008c03bc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000008c03b1
- (id)operationByMergingWithOperation:(id)arg1;	// IMP=0x00000000008c026d
- (id)initWithDeviceCredentialKey:(id)arg1 accessories:(id)arg2 user:(id)arg3;	// IMP=0x00000000008c0041
- (id)initWithDeviceCredentialKey:(id)arg1 accessoriesUUIDs:(id)arg2 user:(id)arg3;	// IMP=0x00000000008bff53
