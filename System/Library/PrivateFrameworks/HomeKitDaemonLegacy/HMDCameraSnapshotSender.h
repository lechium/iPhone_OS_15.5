...
+ (id)logCategory;	// IMP=0x0000000000421fbd
- (void).cxx_destruct;	// IMP=0x0000000000421e80
...
- (void)_sendImageSendFailure:(id)arg1;	// IMP=0x0000000000421a43
- (id)logIdentifier;	// IMP=0x00000000004219f3
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 device:(id)arg3 accessory:(id)arg4 delegateQueue:(id)arg5 uniqueIdentifier:(id)arg6;	// IMP=0x000000000042186b
