...
+ (_Bool)submitEventWithHistogrammedAggregateHomeDataCommonDimensions;	// IMP=0x000000000063ed76
- (void).cxx_destruct;	// IMP=0x000000000063ed34
...
- (id)initWithSubmissionState:(long long)arg1 dataSyncState:(id)arg2 timeIntervalSincePreviousProcessLaunch:(double)arg3 millisecondsSinceLaunchToDataSyncStateGood:(unsigned long long)arg4 numUncommittedRecords:(long long)arg5 numUncommittedAndPushedRecords:(long long)arg6 processExitType:(id)arg7 processExitReason:(id)arg8 processLaunchCount:(unsigned long long)arg9 processJetsamCount:(unsigned long long)arg10 processCrashCount:(unsigned long long)arg11;	// IMP=0x000000000063e745
