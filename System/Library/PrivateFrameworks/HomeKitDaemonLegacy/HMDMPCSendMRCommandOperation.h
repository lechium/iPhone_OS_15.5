...
+ (id)logCategory;	// IMP=0x0000000000912247
+ (id)shortDescription;	// IMP=0x000000000091223a
- (void).cxx_destruct;	// IMP=0x0000000000911965
...
- (void)main;	// IMP=0x00000000009110d5
- (id)initWithPlaybackArchive:(id)arg1 destination:(id)arg2 options:(id)arg3 externalObjectInterface:(id)arg4;	// IMP=0x0000000000910fc5
- (id)initWithPlaybackArchive:(id)arg1 options:(id)arg2 destination:(id)arg3;	// IMP=0x0000000000910f1e
- (id)initWithCommand:(unsigned int)arg1 destination:(id)arg2 options:(id)arg3 externalObjectInterface:(id)arg4;	// IMP=0x0000000000910e01
- (id)initWithCommand:(unsigned int)arg1 options:(id)arg2 destination:(id)arg3;	// IMP=0x0000000000910d77
