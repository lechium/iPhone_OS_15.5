...
- (void).cxx_destruct;	// IMP=0x0000000000561f09
...
- (id)attributeDescriptions;	// IMP=0x0000000000561ce9
@property(readonly, nonatomic) NSDictionary *serializedEvent;
@property(readonly, nonatomic) NSString *eventName;
- (id)initWithModel:(id)arg1 failureCode:(unsigned long long)arg2 error:(id)arg3;	// IMP=0x0000000000561a2c
