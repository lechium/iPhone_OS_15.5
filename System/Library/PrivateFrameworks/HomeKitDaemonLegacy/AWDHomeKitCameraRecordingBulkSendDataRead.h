...
- (void).cxx_destruct;	// IMP=0x0000000000873522
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000873296
- (unsigned long long)hash;	// IMP=0x0000000000873100
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000872e8b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000872cc0
- (void)copyTo:(id)arg1;	// IMP=0x0000000000872b27
- (void)writeTo:(id)arg1;	// IMP=0x000000000087296e
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000872961
- (id)dictionaryRepresentation;	// IMP=0x000000000087255d
- (id)description;	// IMP=0x00000000008724ae
