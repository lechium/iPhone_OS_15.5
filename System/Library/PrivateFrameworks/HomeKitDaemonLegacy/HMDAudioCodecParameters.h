...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000071376
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000007112d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000070e0a
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000070c2c
- (id)tlvData;	// IMP=0x0000000000070a20
- (_Bool)_parseFromTLVData;	// IMP=0x000000000007085f
- (id)initWithChannelCount:(id)arg1 bitRateSetting:(id)arg2 audioSampleRate:(id)arg3 rtpPtime:(id)arg4;	// IMP=0x0000000000070768
