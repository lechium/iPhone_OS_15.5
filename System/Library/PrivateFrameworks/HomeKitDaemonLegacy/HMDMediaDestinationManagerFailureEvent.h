...
- (void).cxx_destruct;	// IMP=0x0000000000abe02e
...
- (id)attributeDescriptions;	// IMP=0x0000000000abde50
@property(readonly, nonatomic) NSDictionary *serializedEvent;
@property(readonly, nonatomic) NSString *eventName;
- (id)initWithFailureCode:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x0000000000abdc06
