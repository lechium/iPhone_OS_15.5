...
- (void).cxx_destruct;	// IMP=0x0000000000629086
...
- (id)description;	// IMP=0x0000000000628e09
- (id)initWithOperationType:(unsigned long long)arg1 zoneName:(id)arg2 delayRespected:(_Bool)arg3;	// IMP=0x0000000000628df1
- (id)initWithOperationType:(unsigned long long)arg1 zoneName:(id)arg2 cloudConflict:(_Bool)arg3 delayRespected:(_Bool)arg4;	// IMP=0x0000000000628d3b
