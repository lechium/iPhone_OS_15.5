...
- (void).cxx_destruct;	// IMP=0x000000000077c77a
...
- (id)dictionaryRepresentation:(_Bool)arg1;	// IMP=0x000000000077bfc0
- (id)initWithMediaAction:(id)arg1 source:(id)arg2 clientName:(id)arg3;	// IMP=0x000000000077be62
- (id)initWithDictionaryRepresentation:(id)arg1 profileSource:(id)arg2;	// IMP=0x000000000077b42d
- (id)initWithMediaProfiles:(id)arg1 playbackState:(id)arg2 playbackVolume:(id)arg3 playbackArchive:(id)arg4 source:(id)arg5 clientName:(id)arg6;	// IMP=0x000000000077b052
