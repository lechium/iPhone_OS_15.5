...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000048ecbd
+ (id)ruleFromFirewallRuleLAN:(id)arg1;	// IMP=0x00000000004211d6
+ (id)ruleForHAP;	// IMP=0x0000000000421025
- (void).cxx_destruct;	// IMP=0x000000000048e3e7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000048dc3d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000048db0a
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000048d48c
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000048cd67
- (id)initWithDirection:(id)arg1 lanIdentifierList:(id)arg2 protocol:(id)arg3 advertisementProtocol:(id)arg4 flags:(id)arg5 serviceType:(id)arg6;	// IMP=0x000000000048cc3f
- (id)init;	// IMP=0x000000000048cc10
- (void)addTo:(id)arg1;	// IMP=0x000000000041ec6b
