...
+ (id)logCategory;	// IMP=0x00000000008a682b
+ (id)shortDescription;	// IMP=0x00000000008a6819
- (void).cxx_destruct;	// IMP=0x00000000008a67a6
...
- (void)clearData;	// IMP=0x00000000008a65e8
...
- (_Bool)encodeObjectChange:(id)arg1;	// IMP=0x00000000008a5b2e
- (id)extractObjectChange;	// IMP=0x00000000008a505a
- (id)description;	// IMP=0x00000000008a4fee
- (id)shortDescription;	// IMP=0x00000000008a4efe
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2 cloudZone:(id)arg3;	// IMP=0x00000000008a4da6
- (id)init;	// IMP=0x00000000008a4cfe
