...
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0000000000931fa0
- (void).cxx_destruct;	// IMP=0x0000000000931f6d
...
- (id)initWithBuilder:(id)arg1;	// IMP=0x0000000000931df2
