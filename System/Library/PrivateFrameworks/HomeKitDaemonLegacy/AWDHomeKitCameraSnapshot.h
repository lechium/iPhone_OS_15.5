...
- (void).cxx_destruct;	// IMP=0x000000000047de09
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000047d97f
- (unsigned long long)hash;	// IMP=0x000000000047d721
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000047d361
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000047d0a6
- (void)copyTo:(id)arg1;	// IMP=0x000000000047ce7b
- (void)writeTo:(id)arg1;	// IMP=0x000000000047cc49
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000047cc3c
- (id)dictionaryRepresentation;	// IMP=0x000000000047c6a7
- (id)description;	// IMP=0x000000000047c5f8
...
- (int)StringAsCertified:(id)arg1;	// IMP=0x000000000047c2b8
- (id)certifiedAsString:(int)arg1;	// IMP=0x000000000047c252
