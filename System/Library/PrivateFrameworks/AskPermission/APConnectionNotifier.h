...
+ (id)sharedNotifier;	// IMP=0x0000000000001a27
- (void).cxx_destruct;	// IMP=0x00000000000021df
...
- (id)_newRemoteConnection;	// IMP=0x0000000000001bc4
- (id)_remoteConnection;	// IMP=0x0000000000001a7c
@property(readonly, nonatomic) id <ConnectionProtocol> remoteObjectProxy;
- (id)init;	// IMP=0x000000000000177d
