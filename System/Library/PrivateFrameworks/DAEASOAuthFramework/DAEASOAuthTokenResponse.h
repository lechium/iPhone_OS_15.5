...
@interface DAEASOAuthTokenResponse : NSObject
{
    ...
    NSString *_idToken;	// 40 = 0x28
    NSDate *_expiryDate;	// 48 = 0x30
    NSError *_error;	// 56 = 0x38
    NSString *_errorMessage;	// 64 = 0x40
    NSString *_user_id;	// 72 = 0x48
}

- (void).cxx_destruct;	// IMP=0x00000000000029ca
...
- (id)usernameFromJWTToken:(id)arg1;	// IMP=0x0000000000002691
- (id)initWithData:(id)arg1 urlResponse:(id)arg2 error:(id)arg3;	// IMP=0x000000000000201c
