...
- (void).cxx_destruct;	// IMP=0x00000000000189f4
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000001895d
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithImg_input:(id)arg1 featureInfo:(id)arg2;	// IMP=0x00000000000188cb
