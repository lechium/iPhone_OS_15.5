...
+ (id)defaultURLOfModelInThisBundle;	// IMP=0x00000000000fcb87
- (void).cxx_destruct;	// IMP=0x00000000000fcdb4
...
- (_Bool)preheatWithError:(id *)arg1;	// IMP=0x00000000000fcd3d
- (id)inputBatchFromTextFeatures:(id)arg1 image:(id)arg2 featureWidth:(double)arg3 configuration:(id)arg4;	// IMP=0x00000000000fcd35
- (id)predictFromInputs:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000fcd2d
- (id)initWithConfiguration:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000fccfe
- (_Bool)supportCharacterBoxes;	// IMP=0x00000000000fccf6
@property(readonly) NSURL *modelURL;
- (id)populateInputBatchData:(float *)arg1 textFeatures:(id)arg2 image:(id)arg3 batchSize:(long long)arg4 width:(double)arg5 configuration:(id)arg6;	// IMP=0x00000000000fbf71
- (void)dealloc;	// IMP=0x00000000000fbf2a
