...
- (NSProgress *)fetchContentsForItemWithID:(FPItemID *)arg1 version:(NSFileProviderItemVersion *)arg2 request:(NSFileProviderRequest *)arg3 extent:(NSValue *)arg4 options:(unsigned long long)arg5 completionHandler:(void (^)(FPSandboxingURLWrapper *, FPItem *, FPExtensionResponse *, NSValue *, NSError *))arg6;
