...
- (void).cxx_destruct;	// IMP=0x00000000000543d0
...
- (id)initWithName:(id)arg1 withDefaultValue:(id)arg2 withHelpText:(id)arg3 withShortName:(id)arg4 andIsBoolFlag:(_Bool)arg5;	// IMP=0x00000000000540b0
