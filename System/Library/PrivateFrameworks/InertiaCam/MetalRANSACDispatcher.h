...
- (void).cxx_destruct;	// IMP=0x000000000004501c
...
- (void)assureSizeAndCopyToMetalBuffer:(id *)arg1 fromData:(const void *)arg2 dataSize:(unsigned long long)arg3 metalResourceOptions:(unsigned long long)arg4;	// IMP=0x0000000000044db0
- (void)performRansacOnData:(unsigned int)arg1 firstPointSet:(const float *)arg2 secondPointSet:(const float *)arg3 pointWeights:(const float *)arg4 homographies:(const struct ransac_homography_record *)arg5 numHomographies:(unsigned int)arg6 homScores:(float *)arg7;	// IMP=0x0000000000044b0c
- (id)initWithMaxCorrespondences:(unsigned long long)arg1;	// IMP=0x0000000000044912
