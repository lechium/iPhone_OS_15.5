...
- (void).cxx_destruct;	// IMP=0x000000000001bc58
...
- (void)DrainIfAbove:(unsigned int)arg1 downTo:(unsigned int)arg2;	// IMP=0x000000000001b906
- (void)StartWatchingForFrames;	// IMP=0x000000000001b843
- (void)FrameRequestCallback;	// IMP=0x000000000001b370
- (id)FindFrameWithIndex:(long long)arg1;	// IMP=0x000000000001b289
- (_Bool)WaitForFinish;	// IMP=0x000000000001b032
- (unsigned long long)FramesInQueue;	// IMP=0x000000000001afe3
- (void)AddAFrame:(id)arg1;	// IMP=0x000000000001af5a
- (void)dealloc;	// IMP=0x000000000001af2b
- (id)initWithOutputURL:(id)arg1 forMovieDimensions:(struct CGSize)arg2 outputTransform:(struct CGAffineTransform)arg3 startTime:(CDStruct_1b6d18a9)arg4 endTime:(CDStruct_1b6d18a9)arg5;	// IMP=0x000000000001ab0c
