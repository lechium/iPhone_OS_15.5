...
{
    UIView<NTKKeylineView> *_secondaryKeylineView;	// 24 = 0x18
}

+ (id)keylineWithImage:(id)arg1 secondaryKeylineView:(id)arg2;	// IMP=0x00000000000cfc3e
- (void).cxx_destruct;	// IMP=0x00000000000cfed6
...
- (void)layoutSubviews;	// IMP=0x00000000000cfcca
