...
- (void).cxx_destruct;	// IMP=0x0000000000031997
...
- (void)performAction;	// IMP=0x0000000000031963
- (id)initWithTitle:(id)arg1 image:(id)arg2 buttonType:(long long)arg3 action:(CDUnknownBlockType)arg4;	// IMP=0x0000000000031870
