...
+ (id)diskStores;	// IMP=0x0000000000018668
+ (id)diskStoreForURL:(id)arg1;	// IMP=0x00000000000182f3
- (void).cxx_destruct;	// IMP=0x000000000001889a
...
- (void)executeBlock:(CDUnknownBlockType)arg1 onQueue:(id)arg2;	// IMP=0x00000000000184da
- (id)description;	// IMP=0x000000000001849b
- (id)initWithURL:(id)arg1;	// IMP=0x0000000000017efd
