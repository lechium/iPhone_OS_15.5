...
- (double)heightForWidth:(double)arg1 inView:(id)arg2;	// IMP=0x000000000000718f
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000007164
- (void)layoutSubviews;	// IMP=0x0000000000006756
- (double)_labelsAndLinksBaselineOffsetForView:(id)arg1;	// IMP=0x000000000000668b
@property(retain, nonatomic) UIColor *bottomLineColor;
- (void)setLinkText:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000006302
- (void)setTitleText:(id)arg1;	// IMP=0x000000000000628b
- (void)_linkButtonPressed;	// IMP=0x0000000000006271
- (void)tintColorDidChange;	// IMP=0x0000000000006160
@property(nonatomic) struct CGSize iconSize;
@property(retain, nonatomic) NSString *iconAccessibilityLabel;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000059ac
