...
- (id)description;	// IMP=0x0000000000016b8b
- (void)updateBookAttributesByCopyingFromBook:(id)arg1;	// IMP=0x0000000000016abd
- (id)friendlyName;	// IMP=0x000000000001699c
- (id)manifestDictionary;	// IMP=0x00000000000167bf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000165b3
- (id)initWithManifestDictionary:(id)arg1;	// IMP=0x00000000000163db
- (id)init;	// IMP=0x00000000000163c7
- (id)initWithMDMBook:(id)arg1;	// IMP=0x00000000000224a8
