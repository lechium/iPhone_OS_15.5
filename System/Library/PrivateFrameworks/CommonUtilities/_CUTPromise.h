...
- (void)registerResultBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000009324
- (void)_fulfillWithResult:(id)arg1;	// IMP=0x00000000000091f7
- (id)initWithQueue:(id)arg1;	// IMP=0x000000000000915b
