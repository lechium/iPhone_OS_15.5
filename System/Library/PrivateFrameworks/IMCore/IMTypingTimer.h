...
+ (_Bool)shouldAdjustTimeoutIntervalForBeginDate;	// IMP=0x0000000000062ab4
- (void).cxx_destruct;	// IMP=0x0000000000062eb6
...
- (void)invalidate;	// IMP=0x0000000000062db7
- (void)triggerTimeout;	// IMP=0x0000000000062d1a
- (void)timerCallback;	// IMP=0x0000000000062c85
- (id)initWithHandle:(id)arg1 beginDate:(id)arg2 timeoutInterval:(double)arg3 delegate:(id)arg4;	// IMP=0x0000000000062abc
