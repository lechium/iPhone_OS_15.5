...
- (void).cxx_destruct;	// IMP=0x0000000000008076
@property(readonly, nonatomic) CDUnknownBlockType invalidationHandler;
- (void)fetchCapturedErrorWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000007d4b
- (void)setRouterDelegate:(id)arg1;	// IMP=0x0000000000007bd9
- (void)setRouterMode:(long long)arg1;	// IMP=0x0000000000007a4a
- (id)initWithQueue:(id)arg1;	// IMP=0x00000000000079d7
