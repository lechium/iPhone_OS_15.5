...
- (void).cxx_destruct;	// IMP=0x0000000000016bee
...
- (id)initWithDuration:(CDStruct_1b6d18a9)arg1 trackTime:(CDStruct_1b6d18a9)arg2 summaryTime:(CDStruct_1b6d18a9)arg3 gainFunction:(id)arg4;	// IMP=0x0000000000016af8
