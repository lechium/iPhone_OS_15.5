...
+ (id)summaryFromSummaries:(id)arg1 targetTimeScale:(int)arg2;	// IMP=0x00000000000146b8
- (void).cxx_destruct;	// IMP=0x0000000000016aaf
...
- (id)initWithDictionary:(id)arg1 targetTimeScale:(int)arg2;	// IMP=0x0000000000015f02
