...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000f8048
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000f7e0f
- (void).cxx_destruct;	// IMP=0x00000000000f879c
...
- (id)descriptionSubstitutionMap;	// IMP=0x00000000000f8643
...
- (unsigned long long)hash;	// IMP=0x00000000000f853d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f8401
- (id)serverRepresentation;	// IMP=0x00000000000f8227
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000f8128
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000f8050
- (void)mergePropertiesFromDescription:(id)arg1;	// IMP=0x00000000000f8833
