...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000ff02a
- (void).cxx_destruct;	// IMP=0x00000000000ff6e0
...
- (_Bool)hasGuestPlayers;	// IMP=0x00000000000ff3b8
- (unsigned long long)hash;	// IMP=0x00000000000fefbb
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000fe857
- (id)init;	// IMP=0x00000000000fe7e1
