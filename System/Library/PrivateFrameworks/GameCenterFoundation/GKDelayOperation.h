...
- (void).cxx_destruct;	// IMP=0x00000000000f7d79
...
- (void)main;	// IMP=0x00000000000f7cd6
- (id)initWithDelay:(double)arg1 andOperation:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f7c4f
