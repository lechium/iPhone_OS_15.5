...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000000009715c
- (void).cxx_destruct;	// IMP=0x00000000000977f0
...
- (id)description;	// IMP=0x0000000000097611
- (id)initWithGameSummary:(id)arg1;	// IMP=0x00000000000972c6
