...
+ (id)defaultCustomTournamentForTournamentDefinition:(id)arg1;	// IMP=0x0000000000039877
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000394c8
- (void).cxx_destruct;	// IMP=0x0000000000039d6c
