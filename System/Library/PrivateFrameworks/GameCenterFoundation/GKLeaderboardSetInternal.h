...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000f92fe
- (void).cxx_destruct;	// IMP=0x00000000000f96c1
...
- (unsigned long long)hash;	// IMP=0x00000000000f95c4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f94f0
