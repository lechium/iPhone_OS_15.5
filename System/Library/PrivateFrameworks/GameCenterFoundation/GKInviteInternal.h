...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000fff7d
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x00000000000ffeee
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x00000000000ffd35
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x00000000000ff766
- (void).cxx_destruct;	// IMP=0x000000000010068f
...
- (id)descriptionSubstitutionMap;	// IMP=0x00000000001003da
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001002ff
- (unsigned long long)hash;	// IMP=0x00000000001002bb
- (id)init;	// IMP=0x00000000000fff1d
