...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000f698c
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000f6984
- (void).cxx_destruct;	// IMP=0x00000000000f6cba
...
- (unsigned long long)hash;	// IMP=0x00000000000f6b85
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f6a6b
