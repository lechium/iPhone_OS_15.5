...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000f7809
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000f7801
- (void).cxx_destruct;	// IMP=0x00000000000f7a4a
...
- (unsigned long long)hash;	// IMP=0x00000000000f79d3
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f7903
