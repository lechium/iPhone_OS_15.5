...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000035baa
- (void).cxx_destruct;	// IMP=0x0000000000035ee7
...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000035d98
- (id)initWithInternalRepresentation:(id)arg1;	// IMP=0x0000000000035d30
- (id)init;	// IMP=0x0000000000035cd6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000035c5d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000035bb2
