...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000f1a41
- (void).cxx_destruct;	// IMP=0x00000000000f2408
...
- (id)description;	// IMP=0x00000000000f1d84
- (id)serverRepresentation;	// IMP=0x00000000000f1d72
- (unsigned long long)hash;	// IMP=0x00000000000f19fd
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f1950
- (id)defaultCategory;	// IMP=0x00000000000f247e
- (unsigned short)numberOfCategories;	// IMP=0x00000000000f246c
