...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000f89d1
- (void).cxx_destruct;	// IMP=0x00000000000f91a4
...
- (unsigned long long)hash;	// IMP=0x00000000000f8e70
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f8d9c
