...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000ead7f
- (void).cxx_destruct;	// IMP=0x00000000000eb1d1
...
- (_Bool)transitionToState:(long long)arg1;	// IMP=0x00000000000eafb2
- (_Bool)isNetworkError;	// IMP=0x00000000000eaf71
- (_Bool)isTimeout;	// IMP=0x00000000000eaf30
- (_Bool)isCancelled;	// IMP=0x00000000000eaeef
- (_Bool)isFinished;	// IMP=0x00000000000eaeae
- (int)_incrementSequence;	// IMP=0x00000000000eae9d
