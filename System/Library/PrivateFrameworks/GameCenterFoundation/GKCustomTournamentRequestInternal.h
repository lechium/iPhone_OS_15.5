...
+ (id)customTournamentRequestWithTournamentDefinition:(id)arg1 player:(id)arg2;	// IMP=0x000000000003860a
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000000038414
- (void).cxx_destruct;	// IMP=0x0000000000038988
