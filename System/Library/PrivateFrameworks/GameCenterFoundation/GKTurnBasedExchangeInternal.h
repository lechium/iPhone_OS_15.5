...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000fdf84
- (void).cxx_destruct;	// IMP=0x00000000000fe4b0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000fe2cc
- (unsigned long long)hash;	// IMP=0x00000000000fe2af
