...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000db524
- (void).cxx_destruct;	// IMP=0x00000000000db801
...
- (id)description;	// IMP=0x00000000000db3ff
@property(readonly) NSString *scopeAsString;
- (unsigned long long)hash;	// IMP=0x00000000000db2c9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000db05c
