...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000000000f2fa6
+ (id)gameRecordForGame:(id)arg1;	// IMP=0x00000000000f2d67
- (void).cxx_destruct;	// IMP=0x00000000000f3328
...
- (void)updateWithGame:(id)arg1;	// IMP=0x00000000000f2dd9
