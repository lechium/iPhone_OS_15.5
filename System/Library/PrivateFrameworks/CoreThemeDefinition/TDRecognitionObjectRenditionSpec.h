...
+ (id)fetchRequest;	// IMP=0x0000000000067471
- (id)createCSIRepresentationWithCompression:(_Bool)arg1 colorSpaceID:(unsigned long long)arg2 document:(id)arg3;	// IMP=0x000000000000aa67
