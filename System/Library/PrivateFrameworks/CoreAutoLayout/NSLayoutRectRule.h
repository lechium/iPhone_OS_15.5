...
- (id)makeChildRules;	// IMP=0x0000000000003b52
@property(readonly, copy) NSString *identifier;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003abf
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003a6d
- (void)dealloc;	// IMP=0x0000000000003a23
