...
- (id)makeChildRules;	// IMP=0x0000000000003714
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003689
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003637
- (void)dealloc;	// IMP=0x00000000000035ed
