...
+ (id)_derivedExtensionAuxiliaryHostProtocolWithContextClass:(Class)arg1;	// IMP=0x000000000000f305
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000f2fd
+ (id)_extensionContextForIdentifier:(id)arg1;	// IMP=0x000000000000f276
+ (id)_extensionContextVendorProtocolWithAllowedErrorClasses:(id)arg1;	// IMP=0x000000000000f11a
+ (id)_defaultExtensionContextVendorProtocol;	// IMP=0x000000000000f094
+ (id)_extensionContextHostProtocolWithAllowedPayloadCompletionClasses:(id)arg1 AllowedErrorClasses:(id)arg2;	// IMP=0x000000000000ed01
+ (id)_extensionContextHostProtocolAllowedClassesForItems;	// IMP=0x000000000000eacc
- (void).cxx_destruct;	// IMP=0x0000000000012023
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000000011c01
- (void)___nsx_pingHost:(CDUnknownBlockType)arg1;	// IMP=0x0000000000011bf6
- (void)_willPerformHostCallback:(CDUnknownBlockType)arg1;	// IMP=0x0000000000011a8d
@property(readonly, copy) NSString *description;
- (void)_openURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000011806
- (void)_loadPreviewImageForPayload:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000001169d
- (void)_loadItemForPayload:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000011368
- (void)openURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000110ee
- (void)cancelRequestWithError:(id)arg1;	// IMP=0x0000000000010e14
- (void)completeRequestReturningItems:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000001047d
- (void)_completeRequestReturningItemsSecondHalf:(CDUnknownBlockType)arg1;	// IMP=0x0000000000010472
- (_Bool)_isHost;	// IMP=0x000000000001043f
- (void)dealloc;	// IMP=0x00000000000103ea
- (void)invalidate;	// IMP=0x00000000000102da
- (void)_initializeAuxillaryConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x000000000000fdbd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000fd44
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000fd39
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000fbe5
- (id)initWithInputItems:(id)arg1 listenerEndpoint:(id)arg2 contextUUID:(id)arg3 extensionContext:(id)arg4;	// IMP=0x000000000000f5ce
