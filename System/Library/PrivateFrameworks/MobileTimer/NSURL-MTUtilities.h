...
+ (id)mtURLForScheme:(id)arg1;	// IMP=0x0000000000058035
+ (id)mtURLForClockAppSection:(int)arg1 timerManager:(id)arg2;	// IMP=0x0000000000057dd6
+ (id)mtURLForClockAppSection:(int)arg1;	// IMP=0x0000000000057dc2
