...
- (void).cxx_destruct;	// IMP=0x00000000001ee236
...
- (void)main;	// IMP=0x00000000001ed9cc
- (int)operationType;	// IMP=0x00000000001ed9c1
- (id)activityCreate;	// IMP=0x00000000001ed998
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000001ed8e7
