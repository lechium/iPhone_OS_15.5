...
- (void).cxx_destruct;	// IMP=0x00000000001e4c41
...
- (id)description;	// IMP=0x00000000001e4b54
- (id)CKPropertiesDescription;	// IMP=0x00000000001e47e4
- (void)performCallback;	// IMP=0x00000000001e4440
- (id)initWithAggregator:(id)arg1;	// IMP=0x00000000001e435c
