...
+ (id)options;	// IMP=0x00000000000c8ff1
- (void).cxx_destruct;	// IMP=0x00000000000c99ac
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000c98a1
- (unsigned long long)hash;	// IMP=0x00000000000c982d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c972d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c966c
- (void)copyTo:(id)arg1;	// IMP=0x00000000000c95e9
- (Class)responseClass;	// IMP=0x00000000000c95d8
- (unsigned int)requestTypeCode;	// IMP=0x00000000000c95cd
- (void)writeTo:(id)arg1;	// IMP=0x00000000000c954b
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000c953e
- (id)dictionaryRepresentation;	// IMP=0x00000000000c915f
- (id)description;	// IMP=0x00000000000c90b0
