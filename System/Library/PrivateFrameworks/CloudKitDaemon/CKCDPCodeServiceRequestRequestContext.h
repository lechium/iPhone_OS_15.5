...
- (void).cxx_destruct;	// IMP=0x000000000030f7fb
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000030f510
- (unsigned long long)hash;	// IMP=0x000000000030f399
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000030f107
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000030ef15
- (void)copyTo:(id)arg1;	// IMP=0x000000000030ed91
- (void)writeTo:(id)arg1;	// IMP=0x000000000030ec19
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000030ec0c
- (id)dictionaryRepresentation;	// IMP=0x000000000030e3ea
- (id)description;	// IMP=0x000000000030e33b
...
- (int)StringAsDatabaseType:(id)arg1;	// IMP=0x000000000030e188
- (id)databaseTypeAsString:(int)arg1;	// IMP=0x000000000030e0ef
@property(nonatomic) _Bool hasDatabaseType;
@property(nonatomic) int databaseType; // @synthesize databaseType=_databaseType;
- (int)StringAsDatabaseEnvironment:(id)arg1;	// IMP=0x000000000030e023
- (id)databaseEnvironmentAsString:(int)arg1;	// IMP=0x000000000030dfce
