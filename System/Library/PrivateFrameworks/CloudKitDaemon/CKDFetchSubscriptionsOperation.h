...
- (void).cxx_destruct;	// IMP=0x000000000016b60e
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000016b51c
- (void)main;	// IMP=0x000000000016b1a2
- (int)operationType;	// IMP=0x000000000016b197
- (void)_handleSubscriptionFetched:(id)arg1 withID:(id)arg2 responseCode:(id)arg3;	// IMP=0x000000000016af2f
- (id)activityCreate;	// IMP=0x000000000016af06
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000016ae36
