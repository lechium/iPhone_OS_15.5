...
- (void).cxx_destruct;	// IMP=0x00000000002628fe
...
- (id)analyticsPayload;	// IMP=0x00000000002625d6
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000026253b
- (void)main;	// IMP=0x000000000026236e
- (void)_handleAnonymousZoneDataObjects:(id)arg1 schedulerInfo:(id)arg2;	// IMP=0x0000000000261795
- (void)_sendFetchDatabaseChangesRequestWithChangeToken:(id)arg1 previousRequestSchedulerInfo:(id)arg2;	// IMP=0x000000000025fb31
- (int)operationType;	// IMP=0x000000000025fb26
- (void)_handleFetchDatabaseChangesRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x000000000025f605
- (id)activityCreate;	// IMP=0x000000000025f5dc
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (_Bool)shouldReturnServerChangeTokensToAdopter;	// IMP=0x000000000025f448
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000025f1c9
