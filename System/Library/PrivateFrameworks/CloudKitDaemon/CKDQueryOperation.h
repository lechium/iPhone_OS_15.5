...
- (void).cxx_destruct;	// IMP=0x0000000000068058
...
- (id)relevantZoneIDs;	// IMP=0x0000000000067dda
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000067d74
- (void)main;	// IMP=0x000000000006734d
- (void)_sendQueryRequestWithCursor:(id)arg1 previousRequestSchedulerInfo:(id)arg2;	// IMP=0x0000000000066061
- (void)_handleRecordResponses:(id)arg1 perRequestSchedulerInfo:(id)arg2;	// IMP=0x0000000000065375
- (id)_wrapError:(id)arg1 format:(id)arg2;	// IMP=0x000000000006516c
- (void)_handleQueryRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x0000000000064abf
- (id)activityCreate;	// IMP=0x0000000000064a96
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (int)operationType;	// IMP=0x0000000000064a7e
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000006471d
