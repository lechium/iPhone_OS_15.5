...
- (void).cxx_destruct;	// IMP=0x0000000000245b58
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000244de6
- (id)generateRequestOperations;	// IMP=0x0000000000244be3
- (id)requestOperationClasses;	// IMP=0x0000000000244b77
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x0000000000244b6f
- (_Bool)allowsAnonymousAccount;	// IMP=0x0000000000244b55
- (id)initWithOperation:(id)arg1 previousServerChangeTokenData:(id)arg2;	// IMP=0x0000000000244a4b
