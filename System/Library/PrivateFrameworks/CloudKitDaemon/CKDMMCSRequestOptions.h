...
- (void).cxx_destruct;	// IMP=0x0000000000291310
...
- (id)MMCSOptions;	// IMP=0x00000000002904e7
- (_Bool)usesBackgroundSession;	// IMP=0x0000000000290493
- (id)description;	// IMP=0x0000000000290481
- (id)CKPropertiesDescription;	// IMP=0x000000000028ffd7
- (id)initWithOperation:(id)arg1;	// IMP=0x000000000028fc95
