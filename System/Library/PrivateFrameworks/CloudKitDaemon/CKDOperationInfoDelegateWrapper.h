...
- (void).cxx_destruct;	// IMP=0x0000000000236260
...
- (void)performWithDelegate:(CDUnknownBlockType)arg1;	// IMP=0x0000000000236130
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000002360b2
