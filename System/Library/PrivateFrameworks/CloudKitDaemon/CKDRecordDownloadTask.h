...
- (void).cxx_destruct;	// IMP=0x00000000002636b8
...
- (void)didCompleteTaskWithError:(id)arg1;	// IMP=0x0000000000263135
- (void)didFillOutURLInfo:(id)arg1 error:(id)arg2;	// IMP=0x0000000000263013
- (void)didDownloadAsset:(id)arg1 error:(id)arg2;	// IMP=0x0000000000262e51
- (id)initWithRecord:(id)arg1 trackProgress:(_Bool)arg2 assetsToDownload:(id)arg3 assetsToDownloadInMemory:(id)arg4 packageIndexSets:(id)arg5 assetURLInfosToFillOut:(id)arg6;	// IMP=0x00000000002629a8
