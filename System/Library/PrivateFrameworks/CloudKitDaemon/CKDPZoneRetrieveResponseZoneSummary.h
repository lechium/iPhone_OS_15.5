...
- (void).cxx_destruct;	// IMP=0x0000000000104492
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000010411b
- (unsigned long long)hash;	// IMP=0x0000000000103f5e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000103c5e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000103a37
- (void)copyTo:(id)arg1;	// IMP=0x0000000000103881
- (void)writeTo:(id)arg1;	// IMP=0x00000000001036c5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001036b8
- (id)dictionaryRepresentation;	// IMP=0x0000000000102c32
- (id)description;	// IMP=0x0000000000102b83
