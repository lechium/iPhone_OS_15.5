...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002ea988
+ (id)dataWithShareID:(id)arg1 pcsData:(id)arg2;	// IMP=0x00000000002ea509
+ (id)dataWithShare:(id)arg1 serviceType:(unsigned long long)arg2;	// IMP=0x00000000002ea28f
- (void).cxx_destruct;	// IMP=0x00000000002eb23c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002eadbe
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002eab9b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002ea990
- (id)CKPropertiesDescription;	// IMP=0x00000000002ea7a6
@property(nonatomic) struct _OpaquePCSShareProtection *invitedPCS;
- (void)dealloc;	// IMP=0x00000000002ea57f
- (id)initWithShareID:(id)arg1 pcsData:(id)arg2;	// IMP=0x00000000002ea217
