...
- (void).cxx_destruct;	// IMP=0x00000000002b7d6e
...
- (void)_setupDecryptCallbackForQueue:(id)arg1;	// IMP=0x00000000002b7a0d
- (id)initWithRecord:(id)arg1 callbackQueue:(id)arg2;	// IMP=0x00000000002b7899
- (id)init;	// IMP=0x00000000002b781d
