...
- (void).cxx_destruct;	// IMP=0x000000000005e829
...
- (id)CKPropertiesDescription;	// IMP=0x000000000005e781
- (id)description;	// IMP=0x000000000005e76f
- (void)invokeWaitCompletedHandler:(_Bool)arg1;	// IMP=0x000000000005e65b
- (id)initWithWaiter:(id)arg1 zoneIDs:(id)arg2 waitCompletedHandler:(CDUnknownBlockType)arg3 activity:(id)arg4;	// IMP=0x000000000005e54e
