...
- (void).cxx_destruct;	// IMP=0x00000000001b10da
...
- (id)initWithEncryptedData:(id)arg1 changeType:(int)arg2 deleteType:(int)arg3;	// IMP=0x00000000001b103d
- (id)initWithEncryptedData:(id)arg1;	// IMP=0x00000000001b0fd2
