...
- (void).cxx_destruct;	// IMP=0x0000000000256641
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000256504
- (unsigned long long)hash;	// IMP=0x0000000000256367
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000256205
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000256107
- (void)copyTo:(id)arg1;	// IMP=0x0000000000256047
- (void)writeTo:(id)arg1;	// IMP=0x0000000000255f79
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000255f6c
- (id)dictionaryRepresentation;	// IMP=0x0000000000255a81
- (id)description;	// IMP=0x00000000002559d2
