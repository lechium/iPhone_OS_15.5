...
- (void).cxx_destruct;	// IMP=0x0000000000209873
...
- (void)forwardInvocation:(id)arg1;	// IMP=0x00000000002096bf
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x0000000000209511
- (id)initWithOperationID:(id)arg1 callbackProtocol:(id)arg2 completionSelector:(SEL)arg3 operationInfoCache:(id)arg4;	// IMP=0x0000000000209476
