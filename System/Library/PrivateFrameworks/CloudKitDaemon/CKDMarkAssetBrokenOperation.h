...
- (void).cxx_destruct;	// IMP=0x0000000000254228
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000253efb
- (void)main;	// IMP=0x0000000000253ee7
- (id)checkPreconditions;	// IMP=0x0000000000253e22
- (id)assetOrPackageForFetchedRecord;	// IMP=0x0000000000253c6c
- (id)repairContainer;	// IMP=0x0000000000253835
- (void)_markAssetBroken;	// IMP=0x0000000000252411
- (int)operationType;	// IMP=0x0000000000252406
- (void)_breakAsset;	// IMP=0x000000000025164d
- (void)_touchCreateRepairZone;	// IMP=0x0000000000250d47
- (void)_touchFetchRepairZone;	// IMP=0x000000000025041b
- (void)_fetchRecord;	// IMP=0x000000000024fc18
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x000000000024fb80
- (_Bool)makeStateTransition;	// IMP=0x000000000024f712
- (id)activityCreate;	// IMP=0x000000000024f6e9
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000024f588
