...
- (void).cxx_destruct;	// IMP=0x00000000002c1b02
...
- (void)cancel;	// IMP=0x00000000002c1a18
...
- (id)activityCreate;	// IMP=0x00000000002c17ae
- (id)initWithPackage:(id)arg1 trackProgress:(_Bool)arg2;	// IMP=0x00000000002c1608
