...
+ (id)ik_stylesheetBodyFromRuleList:(id)arg1 forStyleMarkup:(id)arg2 withHeader:(id)arg3;	// IMP=0x0000000000015ac0
+ (id)safe_initWithStyleSheetId:(id)arg1 rules:(id)arg2;	// IMP=0x00000000000d0970
