...
- (void).cxx_destruct;	// IMP=0x00000000000e2d11
...
- (id)_sparseObjectFromObject:(id)arg1 usingPropertyPaths:(id)arg2;	// IMP=0x00000000000e23d8
- (void)updateUsageIndexesWithChangeSet:(id)arg1;	// IMP=0x00000000000e229a
- (void)removeUsageForIndex:(long long)arg1;	// IMP=0x00000000000e2284
- (void)addUsageForIndex:(long long)arg1;	// IMP=0x00000000000e222c
@property(readonly, copy, nonatomic) NSIndexSet *usageIndexes;
- (id)initWithPrototype:(id)arg1 dataItem:(id)arg2;	// IMP=0x00000000000e2041
- (void)dsepm_setViewElement:(id)arg1;	// IMP=0x0000000000002d1a
- (id)dsepm_viewElement;	// IMP=0x0000000000002d09
