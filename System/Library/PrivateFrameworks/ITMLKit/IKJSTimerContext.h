...
- (void).cxx_destruct;	// IMP=0x00000000000b6857
...
- (void)dealloc;	// IMP=0x00000000000b67e6
- (void)removeManagedReferences;	// IMP=0x00000000000b66b3
- (id)description;	// IMP=0x00000000000b6631
- (id)initWithCallback:(id)arg1 callbackArgs:(id)arg2 repeating:(_Bool)arg3 ownerObject:(id)arg4 timer:(id)arg5;	// IMP=0x00000000000b647a
