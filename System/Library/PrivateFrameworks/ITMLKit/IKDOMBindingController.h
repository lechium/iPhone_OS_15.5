...
+ (id)_prototypeGroupsByTypeForDOMElement:(id)arg1;	// IMP=0x000000000009528e
+ (id)_parsedMutationRulesForDOMElement:(id)arg1;	// IMP=0x0000000000094ddf
+ (id)instantiateDOMElementForItem:(id)arg1 withPrototype:(id)arg2 parentDOMElement:(id)arg3 existingDOMElement:(id)arg4;	// IMP=0x0000000000093c85
+ (id)domBindingControllerForDOMElement:(id)arg1;	// IMP=0x0000000000092425
+ (void)prepareForDOMElement:(id)arg1;	// IMP=0x000000000009236b
+ (id)parsedBindingForDOMElement:(id)arg1;	// IMP=0x0000000000091b4f
- (void).cxx_destruct;	// IMP=0x00000000000972b7
...
- (void)_evaluateMutationRules;	// IMP=0x0000000000096fd2
- (void)_resolveBinding;	// IMP=0x0000000000095cd1
- (_Bool)_canBeReused;	// IMP=0x0000000000095a52
- (void)dataObservable:(id)arg1 didChangePropertyPathWithString:(id)arg2 extraInfo:(id)arg3;	// IMP=0x00000000000944b1
- (id)findPrototypeForDataItem:(id)arg1;	// IMP=0x00000000000940af
- (void)scheduleUpdateUsingPreUpdate:(CDUnknownBlockType)arg1 update:(CDUnknownBlockType)arg2;	// IMP=0x000000000009356f
- (void)dealloc;	// IMP=0x00000000000934be
- (id)initWithDOMElement:(id)arg1;	// IMP=0x000000000009243a
