...
- (void).cxx_destruct;	// IMP=0x0000000000011fd9
@property(readonly, copy, nonatomic) NSString *identifier; // @synthesize identifier=_identifier;
@property(readonly, nonatomic) __weak IKDOMElement *domElement; // @synthesize domElement=_domElement;
- (void)mutateWithDOMElement:(id)arg1;	// IMP=0x0000000000011ed2
- (_Bool)passesForDataItem:(id)arg1 default:(_Bool)arg2;	// IMP=0x0000000000011bca
...
- (id)initWithDOMElement:(id)arg1;	// IMP=0x0000000000011671
