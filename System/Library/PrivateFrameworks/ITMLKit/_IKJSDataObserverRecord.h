...
+ (id)hashForObserver:(id)arg1;	// IMP=0x00000000000252b9
- (void).cxx_destruct;	// IMP=0x0000000000025551
...
- (_Bool)isAffectedByPropertyPathWithString:(id)arg1 subpathString:(id *)arg2;	// IMP=0x00000000000253e7
- (id)initWithObserver:(id)arg1 pathString:(id)arg2;	// IMP=0x00000000000252de
