...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000004cbd3
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x000000000004df3e
- (void).cxx_destruct;	// IMP=0x000000000004d934
...
- (id)buildDictionaryRepresentation;	// IMP=0x000000000004d67a
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x000000000004d135
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004cf22
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004cbdb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004cbc8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004c87e
@property(readonly) unsigned long long hash;
- (id)_descriptionWithIndent:(unsigned long long)arg1;	// IMP=0x000000000004c0c9
@property(readonly, copy) NSString *description;
- (id)initWithTimerID:(id)arg1 timerURL:(id)arg2 isFiring:(_Bool)arg3 title:(id)arg4 state:(long long)arg5 duration:(double)arg6 type:(long long)arg7 fireTimeInterval:(double)arg8 fireDate:(id)arg9 firedDate:(id)arg10 dismissedDate:(id)arg11 lastModifiedDate:(id)arg12;	// IMP=0x000000000004bf01
- (id)mutatedCopyWithMutator:(CDUnknownBlockType)arg1;	// IMP=0x000000000004dfad
