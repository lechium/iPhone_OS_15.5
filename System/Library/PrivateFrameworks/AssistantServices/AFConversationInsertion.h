...
- (void).cxx_destruct;	// IMP=0x000000000015feb2
...
- (id)initWithConversationItemType:(long long)arg1 aceObject:(id)arg2 aceCommandIdentifier:(id)arg3 transient:(_Bool)arg4 supplemental:(_Bool)arg5 immersiveExperience:(_Bool)arg6 indexPath:(id)arg7;	// IMP=0x000000000015fd70
