...
- (void).cxx_destruct;	// IMP=0x0000000000040018
...
- (id)initWithUpdatedItemIndexPaths:(id)arg1 insertedItemIndexPaths:(id)arg2 presentationStateChangedItemIndexPaths:(id)arg3;	// IMP=0x000000000003ff43
