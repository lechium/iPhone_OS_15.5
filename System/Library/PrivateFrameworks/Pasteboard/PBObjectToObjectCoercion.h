...
- (void).cxx_destruct;	// IMP=0x0000000000024b70
...
- (id)coerceObject:(id)arg1 toObjectOfClass:(Class)arg2 outError:(id *)arg3;	// IMP=0x00000000000247da
- (_Bool)canCoerceToObjectOfClass:(Class)arg1;	// IMP=0x0000000000024698
- (id)availableClasses;	// IMP=0x0000000000024682
- (void)addCoercionToClass:(Class)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000000000245f1
- (id)initWithClass:(Class)arg1;	// IMP=0x0000000000024545
