...
- (void).cxx_destruct;	// IMP=0x000000000000e583
...
- (void)invalidate;	// IMP=0x000000000000e4b5
- (void)performObserverBlock;	// IMP=0x000000000000e45c
- (id)initWithWeakObserver:(id)arg1 notificationName:(id)arg2 observerQueue:(id)arg3 observerBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000000e214
