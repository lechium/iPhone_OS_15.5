...
- (void).cxx_destruct;	// IMP=0x0000000000017486
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000172c9
- (unsigned long long)hash;	// IMP=0x00000000000171ac
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000016fe1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000016e69
- (void)copyTo:(id)arg1;	// IMP=0x0000000000016d50
- (void)writeTo:(id)arg1;	// IMP=0x0000000000016c11
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000016c04
- (id)dictionaryRepresentation;	// IMP=0x00000000000163b5
- (id)description;	// IMP=0x0000000000016306
...
- (int)StringAsCompressionAlgorithm:(id)arg1;	// IMP=0x0000000000016124
- (id)compressionAlgorithmAsString:(int)arg1;	// IMP=0x000000000001607d
