...
+ (id)_comparatorForStrategy:(unsigned long long)arg1 comparisonOptions:(unsigned long long)arg2;	// IMP=0x00000000000038aa
+ (id)_referenceItemsSourceForType:(unsigned long long)arg1;	// IMP=0x000000000000379e
- (void).cxx_destruct;	// IMP=0x0000000000003dc0
...
- (void)addExclusionAreaAt:(struct CGRect)arg1;	// IMP=0x0000000000003c8f
- (void)addSquareGuideAt:(struct CGRect)arg1 withColor:(id)arg2;	// IMP=0x0000000000003c01
- (void)addHorozontalGuideAt:(double)arg1 withColor:(id)arg2;	// IMP=0x0000000000003b75
- (void)addVerticalGuideAt:(double)arg1 withColor:(id)arg2;	// IMP=0x0000000000003aec
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000035df
- (id)initWithReferenceItemsSource:(id)arg1 storeManager:(id)arg2 imageComparator:(id)arg3;	// IMP=0x00000000000034f5
- (id)init;	// IMP=0x00000000000034dc
