...
- (void).cxx_destruct;	// IMP=0x0000000000006af7
...
- (void)assertView:(id)arg1 identifier:(id)arg2 filePath:(id)arg3 lineNumber:(unsigned long long)arg4;	// IMP=0x000000000000624f
@property(readonly, nonatomic) NSArray *drawItems;
@property(readonly, nonatomic) NSString *referenceImagesDirectory;
- (id)initWithTestCase:(id)arg1 configuration:(id)arg2;	// IMP=0x000000000000610b
- (id)initWithTestCase:(id)arg1;	// IMP=0x00000000000060a7
