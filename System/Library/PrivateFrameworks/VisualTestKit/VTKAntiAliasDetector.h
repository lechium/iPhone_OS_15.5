...
- (_Bool)isAntiAliasedAtPointHelper:(struct VTKPoint)arg1 leftContext:(id)arg2 rightContext:(id)arg3;	// IMP=0x0000000000002dde
- (_Bool)isAntiAliasedAtPoint:(struct VTKPoint)arg1;	// IMP=0x0000000000002dc4
- (id)initWithLeftContext:(id)arg1 rightContext:(id)arg2 strategy:(id)arg3;	// IMP=0x0000000000002d0d
