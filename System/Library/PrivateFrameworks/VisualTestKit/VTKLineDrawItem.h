...
- (void).cxx_destruct;	// IMP=0x0000000000005d53
...
- (void)drawAtContext:(id)arg1;	// IMP=0x0000000000005ba3
- (id)initWitColor:(id)arg1 origin:(struct CGPoint)arg2 orientation:(long long)arg3;	// IMP=0x0000000000005a9e
