...
- (void).cxx_destruct;	// IMP=0x0000000000004f81
...
- (void)updateWithMeasurement:(id)arg1;	// IMP=0x0000000000003a4c
- (void)dealloc;	// IMP=0x00000000000039e9
- (id)initWithContainer:(id)arg1 metric:(id)arg2 unitString:(id)arg3;	// IMP=0x000000000000387b
