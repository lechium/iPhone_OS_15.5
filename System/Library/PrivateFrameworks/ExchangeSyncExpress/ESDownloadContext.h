...
- (void).cxx_destruct;	// IMP=0x0000000000001c1c
...
- (void)finishedWithError:(id)arg1;	// IMP=0x0000000000001a24
- (void)updateProgressDownloadedByteCount:(long long)arg1 totalByteCount:(long long)arg2;	// IMP=0x0000000000001889
- (id)initWithAttachmentUUID:(id)arg1 accountID:(id)arg2 queue:(id)arg3 downloadProgressBlock:(CDUnknownBlockType)arg4 completionBlock:(CDUnknownBlockType)arg5;	// IMP=0x000000000000173a
