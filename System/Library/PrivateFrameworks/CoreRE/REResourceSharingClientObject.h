...
- (void)unsubscribeFromResourceAtAssetPath:(id)arg1;	// IMP=0x00000000001cf279
- (void)setSubscriptionOptions:(id)arg1 forResourceAtAssetPath:(id)arg2;	// IMP=0x00000000001ceedf
- (void)fetchResourceAtAssetPath:(id)arg1 withReply:(CDUnknownBlockType)arg2;	// IMP=0x00000000001ce90c
- (id)redactedDescription;	// IMP=0x00000000001ce8e3
@property(readonly, copy) NSString *description;
- (void)invalidate;	// IMP=0x00000000001ce8c4
- (id)initWithAssetService:(struct AssetService *)arg1 resourceSharingManager:(void *)arg2 peerID:(unsigned long long)arg3;	// IMP=0x00000000001ce871
