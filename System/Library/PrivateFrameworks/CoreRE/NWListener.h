...
@interface NWListener : NSObject
{
    ...
    struct os_unfair_lock_s layerLock;	// 44 = 0x2c
    void *layer;	// 48 = 0x30
}

- (void).cxx_destruct;	// IMP=0x00000000007a008b
- (void)waitForReady;	// IMP=0x00000000007a0076
- (void)setListener:(id)arg1;	// IMP=0x000000000079fbb9
- (void)stopListening;	// IMP=0x000000000079fb26
- (id)initWithLayer:(void *)arg1;	// IMP=0x000000000079fac2
