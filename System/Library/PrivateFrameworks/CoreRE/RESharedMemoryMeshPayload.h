...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000002ca97c
- (void).cxx_destruct;	// IMP=0x00000000002cbbb0
...
- (id)redactedDescription;	// IMP=0x00000000002cbaf4
- (id)description;	// IMP=0x00000000002cbae2
@property(readonly, nonatomic, getter=isShareable) _Bool shareable;
@property(readonly, nonatomic) unsigned long long bufferSize;
- (id)bufferWithDevice:(id)arg1;	// IMP=0x00000000002cb217
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002cb03c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002cab6d
- (id)initWithData:(id)arg1 parts:(id)arg2 models:(id)arg3 instances:(id)arg4;	// IMP=0x00000000002ca984
