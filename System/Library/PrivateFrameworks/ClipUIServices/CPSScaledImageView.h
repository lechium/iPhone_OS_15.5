...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000011451
- (void)invalidateIntrinsicContentSize;	// IMP=0x0000000000011415
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000011320
