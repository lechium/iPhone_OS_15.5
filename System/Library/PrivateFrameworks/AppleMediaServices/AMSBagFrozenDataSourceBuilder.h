...
- (void).cxx_destruct;	// IMP=0x00000000000a7aa3
...
- (id)createFrozenDataSource;	// IMP=0x00000000000a770b
- (id)createFrozenBag;	// IMP=0x00000000000a6cc0
- (id)initWithFrozenDataSource:(id)arg1;	// IMP=0x00000000000a6a71
