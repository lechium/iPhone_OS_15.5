...
+ (id)archiveClasses;	// IMP=0x000000000012403c
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000124034
- (void).cxx_destruct;	// IMP=0x0000000000124151
@property(retain, nonatomic) AMSEngagementRequest *request; // @synthesize request=_request;
@property(retain, nonatomic) NSArray *actions; // @synthesize actions=_actions;
@property(retain, nonatomic) NSDictionary *data; // @synthesize data=_data;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000123eed
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000123e0a
