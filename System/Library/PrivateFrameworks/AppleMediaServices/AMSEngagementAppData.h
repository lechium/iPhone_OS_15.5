...
- (void).cxx_destruct;	// IMP=0x000000000011f83b
...
- (id)exportObject;	// IMP=0x000000000011f385
- (id)initWithIdentifier:(id)arg1 cacheObject:(id)arg2;	// IMP=0x000000000011ee1c
