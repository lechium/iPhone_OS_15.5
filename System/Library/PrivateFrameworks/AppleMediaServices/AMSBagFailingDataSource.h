...
- (void).cxx_destruct;	// IMP=0x00000000001b47d2
...
- (void)setDefaultValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000001b4755
- (id)defaultValueForKey:(id)arg1;	// IMP=0x00000000001b474d
- (id)valueForURLVariable:(id)arg1 account:(id)arg2;	// IMP=0x00000000001b4745
- (void)loadWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000001b4550
@property(readonly, nonatomic, getter=isLoaded) _Bool loaded;
- (id)initWithProfile:(id)arg1 profileVersion:(id)arg2 error:(id)arg3 delay:(double)arg4;	// IMP=0x00000000001b444b
