...
- (void).cxx_destruct;	// IMP=0x0000000000182299
...
- (id)_devicePlatform;	// IMP=0x0000000000181f4d
- (void)_addSearchTerm:(id)arg1;	// IMP=0x0000000000181d66
- (void)_addItemIdentifiers:(id)arg1;	// IMP=0x0000000000181b3d
- (void)_addCharts:(id)arg1;	// IMP=0x0000000000181a1e
- (void)_addBundleIdentifiers:(id)arg1;	// IMP=0x0000000000181874
- (id)_queryItemsWithLanguage:(id)arg1;	// IMP=0x0000000000181088
- (id)_pathPromise;	// IMP=0x0000000000180b27
- (id)_languagePromise;	// IMP=0x0000000000180735
- (id)_hostPromise;	// IMP=0x0000000000180670
- (id)_verifyConfiguration;	// IMP=0x0000000000180355
- (id)build;	// IMP=0x000000000017ffd5
- (id)initWithConfig:(id)arg1 clientVersion:(id)arg2 bag:(id)arg3;	// IMP=0x000000000017ff00
