...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000a69c4
- (void).cxx_destruct;	// IMP=0x00000000000a6a12
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a66b0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a64b7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a639e
- (void)setDefaultValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000000a6398
- (id)valueForURLVariable:(id)arg1 account:(id)arg2;	// IMP=0x00000000000a62cc
- (void)loadWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000a624b
- (id)defaultValueForKey:(id)arg1;	// IMP=0x00000000000a611c
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic, getter=isLoaded) _Bool loaded;
- (id)_initWithProfile:(id)arg1 profileVersion:(id)arg2 data:(id)arg3 expirationDate:(id)arg4 account:(id)arg5 processInfo:(id)arg6 defaultValues:(id)arg7;	// IMP=0x00000000000a5ec8
