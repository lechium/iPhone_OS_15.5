...
+ (id)valueForProtocolKey:(id)arg1 inResponse:(id)arg2;	// IMP=0x000000000014acdc
- (void).cxx_destruct;	// IMP=0x000000000014b50b
...
- (id)_valueForProtocolKey:(id)arg1;	// IMP=0x000000000014b3ed
- (id)_performerForPaymentSheetWithDelegateAuthentication:(_Bool)arg1;	// IMP=0x000000000014b2b3
- (id)_performerForDialog;	// IMP=0x000000000014b144
- (id)_performerForCreditDisplay;	// IMP=0x000000000014b062
- (id)_performerForAuthenticate;	// IMP=0x000000000014af5a
- (id)_performerForActionDictionary;	// IMP=0x000000000014aea8
...
- (id)initWithTaskInfo:(id)arg1 decodedObject:(id)arg2;	// IMP=0x000000000014a378
