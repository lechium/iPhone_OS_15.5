...
+ (id)configurationWithBag:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001a1f42
- (void).cxx_destruct;	// IMP=0x00000000001a2881
...
- (id)_generateModifiersIfNeeded;	// IMP=0x00000000001a2483
@property(readonly, nonatomic) NSArray *overrides; // @synthesize overrides=_overrides;
- (id)modifierForEvent:(id)arg1;	// IMP=0x00000000001a215f
- (void)prepareForFlush;	// IMP=0x00000000001a2054
- (id)initWithMetricsDictionary:(id)arg1;	// IMP=0x00000000001a1e8b
