...
- (void).cxx_destruct;	// IMP=0x0000000000212ba6
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x000000000021243c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000021234a
