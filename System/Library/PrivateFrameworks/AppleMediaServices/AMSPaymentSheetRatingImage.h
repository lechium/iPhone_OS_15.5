...
- (void).cxx_destruct;	// IMP=0x00000000001cb6bf
...
- (long long)_ratingTypeForType:(id)arg1;	// IMP=0x00000000001cb523
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000001cac43
- (id)initWithURLString:(id)arg1;	// IMP=0x00000000001cabc8
