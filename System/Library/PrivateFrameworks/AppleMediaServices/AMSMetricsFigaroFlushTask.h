...
- (void).cxx_destruct;	// IMP=0x00000000001a7959
...
- (_Bool)_shouldClearEventsDespiteError:(id)arg1 result:(id)arg2;	// IMP=0x00000000001a763b
- (id)_postBatch:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001a6ad5
- (id)_nextBatchWithConfig:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001a5c32
- (id)_mescalSignatureWithBodyData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001a59f7
- (id)performFlush;	// IMP=0x00000000001a52d9
- (void)cancel;	// IMP=0x00000000001a515e
@property(readonly, nonatomic) AMSURLSession *URLSession; // @synthesize URLSession=_URLSession;
- (id)initWithDataSource:(id)arg1 bag:(id)arg2;	// IMP=0x00000000001a4f90
