...
+ (id)configForType:(long long)arg1;	// IMP=0x000000000017f7ee
- (void).cxx_destruct;	// IMP=0x000000000017fecd
...
- (id)initWithType:(long long)arg1 typeString:(id)arg2 hostBagKey:(id)arg3 realm:(id)arg4 includePlatform:(_Bool)arg5;	// IMP=0x000000000017f724
