...
- (void).cxx_destruct;	// IMP=0x00000000001d854d
...
- (id)description;	// IMP=0x00000000001d8398
- (id)initWithPhoneNumber:(id)arg1 simLabel:(id)arg2 uuid:(id)arg3 isVoicePreferred:(_Bool)arg4;	// IMP=0x00000000001d82d6
