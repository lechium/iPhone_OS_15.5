...
+ (id)cipherRecordFieldWithFieldName:(id)arg1 dataRepresentation:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000d5e5
...
- (id)description;	// IMP=0x000000000000d923
- (void)dealloc;	// IMP=0x000000000000d8cb
- (id)dataRepresentationWithError:(id *)arg1;	// IMP=0x000000000000d7f8
- (id)initWithFieldName:(id)arg1 cipherData:(id)arg2 IV:(id)arg3 tag:(id)arg4;	// IMP=0x000000000000d76c
