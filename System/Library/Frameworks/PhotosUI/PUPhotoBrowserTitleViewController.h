...
- (void).cxx_destruct;	// IMP=0x0000000000296097
...
- (void)_handleTapGestureRecognizer:(id)arg1;	// IMP=0x0000000000295edf
- (void)_updateGestureRecognizersIfNeeded;	// IMP=0x0000000000295dee
- (void)_invalidateGestureRecognizers;	// IMP=0x0000000000295dbb
- (void)_updateLabelsIfNeeded;	// IMP=0x0000000000295979
- (void)_invalidateLabels;	// IMP=0x0000000000295946
- (void)_updatePlayClockDescriptionIfNeeded;	// IMP=0x000000000029576e
- (void)_invalidatePlayClockDescription;	// IMP=0x000000000029573b
- (void)_updateDayAndTimeDescriptionsIfNeeded;	// IMP=0x0000000000295607
- (void)_invalidateDayAndTimeDescriptions;	// IMP=0x00000000002955d4
- (void)_setNeedsUpdate;	// IMP=0x0000000000295528
- (_Bool)_needsUpdate;	// IMP=0x00000000002954c7
- (void)_updateIfNeeded;	// IMP=0x00000000002953b5
- (void)performChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000002952be
- (void)_assertInsideUpdate;	// IMP=0x0000000000295226
- (void)_assertInsideChangeBlock;	// IMP=0x000000000029518e
- (void)_dateFormatterChanged:(id)arg1;	// IMP=0x0000000000295142
@property(retain, nonatomic) UIColor *textColor;
@property(readonly, copy, nonatomic) NSString *subtitle;
@property(readonly, copy, nonatomic) NSString *title;
- (id)init;	// IMP=0x0000000000294ac5
