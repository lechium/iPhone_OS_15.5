...
- (void).cxx_destruct;	// IMP=0x0000000000302225
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x000000000030200f
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x0000000000301f66
- (void)_handleResultPlayerItem:(id)arg1 info:(id)arg2;	// IMP=0x0000000000301ea0
- (id)init;	// IMP=0x0000000000301dc3
