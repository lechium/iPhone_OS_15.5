...
@class NSString, PUBrowsingViewModel, UIColor, UIVisualEffect, UIVisualEffectView, _UIContentUnavailableView;
...
@interface PUBrowsingBackgroundTileViewController <PUBrowsingViewModelChangeObserver>
{
    ...
    _UIContentUnavailableView *__emptyPlaceholderView;	// 48 = 0x30
    UIVisualEffectView *__backgroundBlurView;	// 56 = 0x38
    struct CGRect __emptyPlaceholderFrame;	// 64 = 0x40
}

- (void).cxx_destruct;	// IMP=0x00000000000bebe5
...
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000000bea07
- (void)_updateBackgroundBlurViewAnimated:(_Bool)arg1;	// IMP=0x00000000000be614
- (void)_updateEmptyPlaceholderAnimated:(_Bool)arg1;	// IMP=0x00000000000be116
- (struct CGRect)_emptyPlaceholderFrameForLayoutInfo:(id)arg1;	// IMP=0x00000000000be016
- (void)_updateColorIfNeeded;	// IMP=0x00000000000bde9d
- (void)_invalidateColorWithAnimatorBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000bde37
- (void)_invalidateColor;	// IMP=0x00000000000bde23
- (void)applyLayoutInfo:(id)arg1;	// IMP=0x00000000000bdc8b
- (void)viewDidLoad;	// IMP=0x00000000000bdc24
- (id)initWithReuseIdentifier:(id)arg1;	// IMP=0x00000000000bdbd2
