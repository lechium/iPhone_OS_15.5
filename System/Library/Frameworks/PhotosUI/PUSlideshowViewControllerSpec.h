...
- (void)updateIfNeeded;	// IMP=0x0000000000410e7f
- (id)initWithMode:(unsigned long long)arg1;	// IMP=0x0000000000410e3b
- (id)init;	// IMP=0x0000000000410e27
@property(readonly, nonatomic) PUSlideshowViewControllerSpecChange *currentChange;
- (id)newSpecChange;	// IMP=0x0000000000410dcf
