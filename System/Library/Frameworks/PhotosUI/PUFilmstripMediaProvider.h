...
- (void).cxx_destruct;	// IMP=0x000000000016c7cf
...
- (void)_deliverPlaceholderImage;	// IMP=0x000000000016c60c
- (void)_deliverResult:(id)arg1;	// IMP=0x000000000016c40b
- (void)_deliverPendingResults;	// IMP=0x000000000016bfdb
- (void)_didGenerateImage:(id)arg1 error:(id)arg2 requestedTime:(CDStruct_1b6d18a9)arg3 actualTime:(CDStruct_1b6d18a9)arg4 generatorResult:(long long)arg5 forResult:(id)arg6;	// IMP=0x000000000016bd78
- (void)_generateImageForResult:(id)arg1;	// IMP=0x000000000016bb2e
- (void)dealloc;	// IMP=0x000000000016bae5
- (void)cancelAllRequests;	// IMP=0x000000000016ba74
- (void)cancelImageRequest:(int)arg1;	// IMP=0x000000000016b945
- (void)_handleSourceTimeLoadedForAsset:(id)arg1 time:(double)arg2 targetSize:(struct CGSize)arg3 contentMode:(long long)arg4 requestNumber:(long long)arg5;	// IMP=0x000000000016b803
- (int)requestImageForAsset:(id)arg1 targetSize:(struct CGSize)arg2 contentMode:(long long)arg3 options:(id)arg4 resultHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000000016b4db
- (void)_performIvarWrite:(CDUnknownBlockType)arg1;	// IMP=0x000000000016b38b
- (void)_performIvarRead:(CDUnknownBlockType)arg1;	// IMP=0x000000000016b373
- (id)init;	// IMP=0x000000000016b35d
- (id)initWithAVAsset:(id)arg1 videoComposition:(id)arg2;	// IMP=0x000000000016b038
