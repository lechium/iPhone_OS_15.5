...
+ (_Bool)shouldEnableOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x000000000009c43a
+ (_Bool)canPerformOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x000000000009c41a
- (void).cxx_destruct;	// IMP=0x000000000009c89a
...
- (void)_presentEditViewControllerForReviewAsset:(id)arg1;	// IMP=0x000000000009c5dd
- (void)performUserInteractionTask;	// IMP=0x000000000009c493
