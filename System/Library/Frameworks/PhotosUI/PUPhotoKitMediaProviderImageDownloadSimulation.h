...
- (void).cxx_destruct;	// IMP=0x00000000003017f2
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x00000000003015dc
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x0000000000301533
- (void)_handleResultImage:(id)arg1 info:(id)arg2;	// IMP=0x00000000003013bc
- (id)init;	// IMP=0x000000000030130d
