...
- (void).cxx_destruct;	// IMP=0x0000000000396ded
...
- (void)run;	// IMP=0x000000000039641f
- (id)initWithInputAsset:(id)arg1 imageInfoNode:(id)arg2 renderImageInfoNode:(id)arg3 renderImageDataNode:(id)arg4 videoURLNode:(id)arg5 videoAssetNode:(id)arg6 renderVideoURLNode:(id)arg7 renderVideoAssetNode:(id)arg8 adjustmentURLNode:(id)arg9;	// IMP=0x0000000000396088
