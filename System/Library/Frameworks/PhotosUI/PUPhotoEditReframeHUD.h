...
- (void).cxx_destruct;	// IMP=0x00000000003df314
...
- (void)showStatsForPhoto:(id)arg1;	// IMP=0x00000000003dbd6e
@property(copy, nonatomic) NSString *detailText;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000003dbc57
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003dbc13
