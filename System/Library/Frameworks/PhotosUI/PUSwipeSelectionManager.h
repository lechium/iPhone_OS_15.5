...
- (void).cxx_destruct;	// IMP=0x000000000041ddbd
...
- (void)updateSelectionWithCurrentIndexPath:(id)arg1 leftClosestIndexPath:(id)arg2 aboveClosestIndexPath:(id)arg3;	// IMP=0x000000000041d8a1
- (void)endSelection;	// IMP=0x000000000041d7c6
- (void)beginSelectionFromIndexPath:(id)arg1;	// IMP=0x000000000041d737
- (long long)_selectionModeForRestoringStateOfIndexPath:(id)arg1;	// IMP=0x000000000041d64c
- (id)_indexesPathsRangeForIndexPath:(id)arg1;	// IMP=0x000000000041d0a4
- (void)dealloc;	// IMP=0x000000000041cfb8
- (id)initWithSelectionMode:(long long)arg1 photoSelectionManager:(id)arg2;	// IMP=0x000000000041cf3a
- (id)init;	// IMP=0x000000000041cef6
