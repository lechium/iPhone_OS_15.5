...
- (void).cxx_destruct;	// IMP=0x000000000035d8fd
...
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000035d84e
- (void)layoutSubviews;	// IMP=0x000000000035d748
- (void)prepareForReuse;	// IMP=0x000000000035d672
- (void)_updateSubviewOrdering;	// IMP=0x000000000035d655
- (void)_updateHighlight;	// IMP=0x000000000035d4bc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000035d389
