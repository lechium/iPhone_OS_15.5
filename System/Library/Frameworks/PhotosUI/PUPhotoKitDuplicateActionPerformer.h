...
+ (_Bool)canPerformOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x00000000002f666b
- (void).cxx_destruct;	// IMP=0x00000000002f65dc
...
- (void)performBackgroundTask;	// IMP=0x00000000002f6452
- (void)performUserInteractionTask;	// IMP=0x00000000002f62d0
