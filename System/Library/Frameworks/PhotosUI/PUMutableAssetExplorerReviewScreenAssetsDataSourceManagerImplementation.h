...
- (void).cxx_destruct;	// IMP=0x000000000009aa6a
...
- (void)removeReplacementAssetInDataSourceForUUID:(id)arg1;	// IMP=0x000000000009aa43
- (void)replaceAssetInDataSourceWithAsset:(id)arg1;	// IMP=0x000000000009a9d4
- (id)initWithReplacementAssetsByUUID:(id)arg1;	// IMP=0x000000000009a93b
