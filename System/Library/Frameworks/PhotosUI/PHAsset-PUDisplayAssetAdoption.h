...
+ (id)pu_typeStringForMediaType:(long long)arg1;	// IMP=0x000000000000c170
+ (long long)_pu_mediaTypeForAssets:(id)arg1;	// IMP=0x000000000000bff5
+ (long long)pu_commonMediaTypeForPhotoCount:(long long)arg1 videoCount:(long long)arg2 otherCount:(long long)arg3;	// IMP=0x000000000000bfac
+ (id)pu_typeStringForAssets:(id)arg1;	// IMP=0x000000000000bf00
...
- (unsigned long long)contentChangeFromDisplayAsset:(id)arg1;	// IMP=0x000000000000b82b
- (unsigned long long)isContentEqualTo:(id)arg1;	// IMP=0x000000000000b7bd
@property(readonly, nonatomic) _Bool isTemporaryPlaceholder;
@property(readonly, nonatomic) NSString *localizedGeoDescription;
- (CDStruct_8e0628e6)pu_vitalityPerspectiveTransform;	// IMP=0x00000000001c428d
