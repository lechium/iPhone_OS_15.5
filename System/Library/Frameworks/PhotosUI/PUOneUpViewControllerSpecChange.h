...
@interface PUOneUpViewControllerSpecChange
{
    ...
    _Bool _presentedForPreviewChanged;	// 9 = 0x9
    _Bool _shouldPlaceButtonsInNavigationBarChanged;	// 10 = 0xa
    _Bool _shouldUseCompactTitleViewChanged;	// 11 = 0xb
    _Bool _maximumToolbarHeightChanged;	// 12 = 0xc
    _Bool _maximumAccessoryToolbarHeightChanged;	// 13 = 0xd
    _Bool _shouldUseContentGuideInsetsChanged;	// 14 = 0xe
    _Bool _shouldUseUserTransformTilesChanged;	// 15 = 0xf
    _Bool _shouldDisplayBadgesChanged;	// 16 = 0x10
    _Bool _shouldDisplayAssetExplorerReviewScreenBadgesChanged;	// 17 = 0x11
    _Bool _shouldDisplayPlayButtonsChanged;	// 18 = 0x12
    _Bool _shouldDisplayProgressIndicatorsChanged;	// 19 = 0x13
    _Bool _shouldDisplayPeopleRowChanged;	// 20 = 0x14
    _Bool _shouldAutoplayOnAppearChanged;	// 21 = 0x15
    _Bool _shouldDisplayEmptyPlaceholderChanged;	// 22 = 0x16
    _Bool _shouldDisplayBufferingIndicatorsChanged;	// 23 = 0x17
    _Bool _canDisplayLoadingIndicatorsChanged;	// 24 = 0x18
    _Bool _backgroundColorOverrideChanged;	// 25 = 0x19
    _Bool _progressIndicatorSizeChanged;	// 26 = 0x1a
    _Bool _progressIndicatorContentInsetsChanged;	// 27 = 0x1b
    _Bool _bufferingIndicatorSizeChanged;	// 28 = 0x1c
    _Bool _renderIndicatorSizeChanged;	// 29 = 0x1d
    _Bool _shouldUseCompactCommentsTitleChanged;	// 30 = 0x1e
    _Bool _tileInitialContentModeChanged;	// 31 = 0x1f
    _Bool _shouldCounterrotateReviewScreenBarsChanged;	// 32 = 0x20
    _Bool _shouldPinContentToTopChanged;	// 33 = 0x21
    _Bool _shouldLayoutReviewScreenControlBarVerticallyChanged;	// 34 = 0x22
    _Bool _shouldPlaceScrubberInScrubberBarChanged;	// 35 = 0x23
    _Bool _hideNavigationBarWhenShowingAccessoryView;	// 36 = 0x24
    _Bool _hideScrubberWhenShowingAccessoryView;	// 37 = 0x25
    _Bool _prefersSquareImageInDetails;	// 38 = 0x26
    _Bool _hideStatusBarWhenShowingAccessoryView;	// 39 = 0x27
    _Bool _hideBadgesWhenShowingAccessoryView;	// 40 = 0x28
    _Bool _peopleRowSizeChanged;	// 41 = 0x29
    _Bool _shouldDisplaySyndicationAttribution;	// 42 = 0x2a
}
...
- (_Bool)changed;	// IMP=0x0000000000276be3
