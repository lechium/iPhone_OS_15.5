...
- (void).cxx_destruct;	// IMP=0x00000000004a85e4
...
- (void)_endScroll;	// IMP=0x00000000004a8447
- (void)_incrementScroll;	// IMP=0x00000000004a834c
- (void)scrollWithStartHandler:(CDUnknownBlockType)arg1 incrementHandler:(CDUnknownBlockType)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000004a8193
- (id)initWithScrollView:(id)arg1;	// IMP=0x00000000004a812f
- (id)init;	// IMP=0x00000000004a80b5
