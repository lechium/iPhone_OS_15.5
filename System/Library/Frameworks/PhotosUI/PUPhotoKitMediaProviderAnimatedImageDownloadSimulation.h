...
- (void).cxx_destruct;	// IMP=0x000000000030329f
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x0000000000303089
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x0000000000302fe0
- (void)_handleResultAnimatedImage:(id)arg1 info:(id)arg2;	// IMP=0x0000000000302f1a
- (id)init;	// IMP=0x0000000000302e6b
