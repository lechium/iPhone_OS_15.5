...
+ (void)runSizeTest;	// IMP=0x000000000021ac9c
+ (id)settingsControllerModule;	// IMP=0x000000000021a50d
+ (id)sharedInstance;	// IMP=0x000000000021a4dd
...
- (id)parentSettings;	// IMP=0x000000000021b615
