...
+ (void)captureSnapshotForAsset:(id)arg1 mediaProvider:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000002b8710
...
- (void)_copySourceData:(id)arg1 destinationData:(out id *)arg2 destinationURL:(out id *)arg3;	// IMP=0x00000000002b848d
- (id)_copyDataAtURL:(id)arg1;	// IMP=0x00000000002b83d6
- (id)_copyData:(id)arg1;	// IMP=0x00000000002b8395
- (id)_copyAsset:(id)arg1;	// IMP=0x00000000002b830d
- (id)init;	// IMP=0x00000000002b8229
