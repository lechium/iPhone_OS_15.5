...
- (void).cxx_destruct;	// IMP=0x000000000037a0b5
...
- (void)_handleVideoPlayer:(id)arg1 didChange:(id)arg2;	// IMP=0x0000000000379f30
- (void)_handleViewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x0000000000379ec8
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x0000000000379e11
- (void)_updateCurrentPlaybackTimeAndDurationIfNeeded;	// IMP=0x0000000000379cc3
- (void)_invalidateCurrentPlaybackTimeAndDuration;	// IMP=0x0000000000379c90
- (void)_updateAVPlayerIfNeeded;	// IMP=0x0000000000379be6
- (void)_invalidateAVPlayer;	// IMP=0x0000000000379bb3
- (void)_updatePlayPauseStateIfNeeded;	// IMP=0x0000000000379ad6
- (void)_invalidatePlayPauseState;	// IMP=0x0000000000379aa3
- (void)_updateVideoPlayerIfNeeded;	// IMP=0x00000000003799b7
- (void)_invalidateVideoPlayer;	// IMP=0x0000000000379984
- (void)_setNeedsUpdate;	// IMP=0x00000000003798d8
- (_Bool)_needsUpdate;	// IMP=0x0000000000379877
- (void)_updateIfNeeded;	// IMP=0x0000000000379765
- (void)_performChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000003796bb
- (void)_assertInsideUpdate;	// IMP=0x0000000000379623
- (void)_assertInsideChangeBlock;	// IMP=0x000000000037958b
- (void)_publishChanges;	// IMP=0x0000000000379315
@property(readonly, nonatomic) PUPlayPauseBarItemsControllerChange *_currentChange; // @synthesize _currentChange=__currentChange;
- (void)_stopObservingAVPlayer;	// IMP=0x0000000000379068
- (void)_startObservingAVPlayer;	// IMP=0x0000000000378e54
- (void)unregisterChangeObserver:(id)arg1;	// IMP=0x0000000000378b5d
- (void)registerChangeObserver:(id)arg1;	// IMP=0x0000000000378aab
- (id)init;	// IMP=0x0000000000378a24
