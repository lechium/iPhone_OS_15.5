...
- (void).cxx_destruct;	// IMP=0x0000000000223a75
...
- (void)enumerateObserversWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000223923
- (void)unregisterObserver:(id)arg1;	// IMP=0x0000000000223894
- (void)registerObserver:(id)arg1;	// IMP=0x0000000000223805
- (id)init;	// IMP=0x000000000022377e
