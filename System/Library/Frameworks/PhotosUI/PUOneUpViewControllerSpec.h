...
@interface PUOneUpViewControllerSpec
{
    ...
    _Bool _isPresentedForPreview;	// 9 = 0x9
    _Bool _isShowingPlayPauseButtonInBars;	// 10 = 0xa
    _Bool _shouldPlaceButtonsInNavigationBar;	// 11 = 0xb
    _Bool _shouldUseCompactTitleView;	// 12 = 0xc
    _Bool _shouldUseContentGuideInsets;	// 13 = 0xd
    _Bool _shouldUseUserTransformTiles;	// 14 = 0xe
    _Bool _shouldDisplayBadges;	// 15 = 0xf
    _Bool _shouldDisplayAssetExplorerReviewScreenBadges;	// 16 = 0x10
    _Bool _shouldDisplayPlayButtons;	// 17 = 0x11
    _Bool _shouldDisplayProgressIndicators;	// 18 = 0x12
    _Bool _shouldDisplayPeopleRow;	// 19 = 0x13
    _Bool _shouldAutoplayOnAppear;	// 20 = 0x14
    _Bool _shouldDisplayBufferingIndicators;	// 21 = 0x15
    _Bool _canDisplayLoadingIndicators;	// 22 = 0x16
    _Bool _shouldDisplayEmptyPlaceholder;	// 23 = 0x17
    _Bool _shouldUseCompactCommentsTitle;	// 24 = 0x18
    _Bool _shouldCounterrotateReviewScreenBars;	// 25 = 0x19
    _Bool _shouldPinContentToTop;	// 26 = 0x1a
    _Bool _shouldLayoutReviewScreenControlBarVertically;	// 27 = 0x1b
    _Bool _shouldPlaceScrubberInScrubberBar;	// 28 = 0x1c
    _Bool _shouldDisplaySyndicationAttribution;	// 29 = 0x1d
    _Bool _prefersFloatingiPadInfoPanel;	// 30 = 0x1e
    _Bool _hideNavigationBarWhenShowingAccessoryView;	// 31 = 0x1f
    _Bool _hideScrubberWhenShowingAccessoryView;	// 32 = 0x20
    _Bool _prefersSquareImageInDetails;	// 33 = 0x21
    _Bool _hideStatusBarWhenShowingAccessoryView;	// 34 = 0x22
    _Bool _hideBadgesWhenShowingAccessoryView;	// 35 = 0x23
...
- (void).cxx_destruct;	// IMP=0x0000000000276bd0
...
- (void)_setHideBadgesWhenShowingAccessoryView:(_Bool)arg1;	// IMP=0x0000000000276847
- (void)_setHideStatusBarWhenShowingAccessoryView:(_Bool)arg1;	// IMP=0x00000000002767d9
- (void)_setPrefersSquareImageInDetails:(_Bool)arg1;	// IMP=0x000000000027676b
- (void)_setHideScrubberWhenShowingAccessoryView:(_Bool)arg1;	// IMP=0x00000000002766fd
- (void)_setHideNavigationBarWhenShowingAccessoryView:(_Bool)arg1;	// IMP=0x000000000027668f
- (void)_setShouldDisplaySyndicationAttribution:(_Bool)arg1;	// IMP=0x0000000000276621
- (void)_setRenderIndicatorSize:(struct CGSize)arg1;	// IMP=0x000000000027623f
@property(readonly, nonatomic) struct CGSize playButtonSize;
- (void)updateIfNeeded;	// IMP=0x0000000000275171
@property(readonly, nonatomic) _Bool shouldDisableNavigationBarsVisibility;
- (id)spotlightBackgroundColor;	// IMP=0x000000000027503a
@property(readonly, nonatomic) _Bool shouldUseSpotlightStyling;
- (_Bool)_shouldForceBlackBackground;	// IMP=0x0000000000274fe0
...
- (_Bool)_isAssetExplorerReviewScreen;	// IMP=0x0000000000274f17
@property(readonly, nonatomic) PUOneUpViewControllerSpecChange *currentChange;
- (id)newSpecChange;	// IMP=0x0000000000274ebf
- (id)initWithOptions:(unsigned long long)arg1;	// IMP=0x0000000000274e5f
