...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x00000000003012be
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x00000000003012b8
- (void)_updateSimulatedDownload;	// IMP=0x00000000003010bf
- (void)beginSimulation;	// IMP=0x000000000030108e
- (id)init;	// IMP=0x0000000000300fee
