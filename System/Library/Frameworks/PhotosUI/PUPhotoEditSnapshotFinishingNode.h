...
- (void).cxx_destruct;	// IMP=0x00000000002b80b3
...
- (void)run;	// IMP=0x00000000002b7d02
- (id)initWithAdjustmentNode:(id)arg1 baseMediaNode:(id)arg2 currentImageNode:(id)arg3 currentVideoNode:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000002b7b5a
