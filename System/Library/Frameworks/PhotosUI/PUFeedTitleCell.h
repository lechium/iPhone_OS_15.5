...
- (void).cxx_destruct;	// IMP=0x00000000001490ef
...
- (void)_handleTap:(id)arg1;	// IMP=0x000000000014902e
- (struct CGSize)_performLayoutInRect:(struct CGRect)arg1 updateSubviewFrames:(_Bool)arg2;	// IMP=0x0000000000148dc1
- (void)_updateHeaderTextColorStyle;	// IMP=0x0000000000148d16
- (void)prepareForReuse;	// IMP=0x0000000000148c89
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000148c43
- (void)layoutSubviews;	// IMP=0x0000000000148bd1
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000148950
