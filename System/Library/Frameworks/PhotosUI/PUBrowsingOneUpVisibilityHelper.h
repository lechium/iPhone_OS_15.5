...
- (void).cxx_destruct;	// IMP=0x000000000039121a
...
- (void)dealloc;	// IMP=0x0000000000391171
- (id)initWithBrowsingViewModel:(id)arg1 isPresentedForSecondScreen:(_Bool)arg2;	// IMP=0x00000000003910e3
