...
- (void).cxx_destruct;	// IMP=0x0000000000300675
...
- (void)infoUpdaterDidUpdate:(id)arg1;	// IMP=0x00000000003003f2
- (id)_infoDictionaryForLocalizedTitle:(id)arg1 localizedFileSizeDescription:(id)arg2;	// IMP=0x0000000000300326
- (id)requestInfoOfKind:(id)arg1 withResultHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000300083
- (void)invalidateAssetsForResizing;	// IMP=0x0000000000300046
- (void)setFileSizeMenu:(id)arg1;	// IMP=0x00000000002fffe0
- (void)setResizeTaskDescriptor:(id)arg1;	// IMP=0x00000000002fff39
- (void)performChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000002fff0a
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x00000000002ffdad
