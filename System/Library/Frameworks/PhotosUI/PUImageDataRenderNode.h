...
- (void).cxx_destruct;	// IMP=0x00000000001960e9
...
- (void)_handleRenderCompletedWithJpegData:(id)arg1 baseSize:(struct CGSize)arg2 editedSize:(struct CGSize)arg3;	// IMP=0x0000000000195fe6
- (void)run;	// IMP=0x0000000000195dc6
- (id)_editSource;	// IMP=0x0000000000195b3e
- (_Bool)_isInputValid;	// IMP=0x0000000000195a0a
- (id)initWithImageInfoNode:(id)arg1 videoURLNode:(id)arg2 compositionController:(id)arg3 livePhotoPairingIdentifier:(id)arg4 jpegCompression:(double)arg5;	// IMP=0x0000000000195708
