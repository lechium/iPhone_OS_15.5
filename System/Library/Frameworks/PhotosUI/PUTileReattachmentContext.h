...
- (void).cxx_destruct;	// IMP=0x0000000000439e06
...
- (void)setVelocity:(struct PUDisplayVelocity)arg1 forTileController:(id)arg2;	// IMP=0x0000000000439cef
- (struct PUDisplayVelocity)velocityForTileController:(id)arg1;	// IMP=0x0000000000439c32
