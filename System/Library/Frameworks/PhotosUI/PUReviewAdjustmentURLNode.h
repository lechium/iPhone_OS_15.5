...
- (void).cxx_destruct;	// IMP=0x000000000038caba
...
- (void)run;	// IMP=0x000000000038c8d1
- (id)initWithReviewAsset:(id)arg1 directory:(id)arg2 contentEditingOutput:(id)arg3;	// IMP=0x000000000038c775
