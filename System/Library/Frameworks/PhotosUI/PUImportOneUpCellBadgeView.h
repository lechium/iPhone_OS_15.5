...
- (void).cxx_destruct;	// IMP=0x00000000001b28d5
...
- (void)_createSpinnerIfNecessary;	// IMP=0x00000000001b2741
- (void)performBadgeUpdates:(CDUnknownBlockType)arg1;	// IMP=0x00000000001b2702
- (void)updateBadgeUIIfNeeded;	// IMP=0x00000000001b2596
- (void)setNeedsBadgeUpdate;	// IMP=0x00000000001b257f
- (void)prepareForReuse;	// IMP=0x00000000001b2459
- (void)layoutSubviews;	// IMP=0x00000000001b21f4
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000001b21de
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001b2139
