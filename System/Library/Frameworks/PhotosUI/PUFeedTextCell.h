...
- (void).cxx_destruct;	// IMP=0x0000000000148890
...
- (struct CGSize)_iconSize;	// IMP=0x0000000000148561
- (id)_labelBackgroundColor;	// IMP=0x00000000001484da
- (void)_updateLabelsBackgroundColor;	// IMP=0x00000000001483e8
- (void)_configureButton:(id)arg1 withType:(long long)arg2 size:(long long)arg3 animated:(_Bool)arg4;	// IMP=0x00000000001481b8
- (struct CGSize)_maximumPossibleTextSizeForButtonWithType:(long long)arg1 size:(long long)arg2;	// IMP=0x0000000000147fab
- (struct CGSize)_textSizeForButtonWithType:(long long)arg1 size:(long long)arg2;	// IMP=0x0000000000147e6a
- (void)_invalidateCachedTextSizes;	// IMP=0x0000000000147e29
- (void)_handleButton:(id)arg1;	// IMP=0x0000000000147dcc
- (id)_delegate;	// IMP=0x0000000000147dba
- (void)_updateButtonAnimated:(_Bool)arg1;	// IMP=0x00000000001479ab
- (void)_updateIconImageView;	// IMP=0x0000000000147880
- (void)_updateDetailLabel;	// IMP=0x000000000014771b
- (_Bool)shouldRecognizerTap:(id)arg1;	// IMP=0x00000000001473b4
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000146f8f
- (void)layoutSubviews;	// IMP=0x00000000001465a0
- (void)setButtonType:(long long)arg1 animated:(_Bool)arg2;	// IMP=0x00000000001464bc
- (void)_contentSizeCategoryDidChange:(id)arg1;	// IMP=0x000000000014603b
- (void)_updateShouldUseAccessibilityLayout;	// IMP=0x0000000000145fbd
- (void)dealloc;	// IMP=0x0000000000145f3b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000145d83
