...
- (void).cxx_destruct;	// IMP=0x000000000045bbfb
...
- (void)_endWithTranslationVelocity:(struct CGPoint)arg1 rotationVelocity:(double)arg2 scaleVelocity:(double)arg3 shouldBounce:(_Bool)arg4 finish:(_Bool)arg5 animated:(_Bool)arg6;	// IMP=0x000000000045af96
- (void)_autoUpdate:(id)arg1;	// IMP=0x000000000045af84
- (void)_updateAutoUpdateDisplayLink;	// IMP=0x000000000045ae6a
- (void)_update;	// IMP=0x000000000045a8ba
- (void)cancelWithoutAnimation;	// IMP=0x000000000045a888
- (void)cancelWithTranslationVelocity:(struct CGPoint)arg1 rotationVelocity:(double)arg2 scaleVelocity:(double)arg3 shouldBounce:(_Bool)arg4;	// IMP=0x000000000045a86b
- (void)finishWithTranslationVelocity:(struct CGPoint)arg1 rotationVelocity:(double)arg2 scaleVelocity:(double)arg3 shouldBounce:(_Bool)arg4;	// IMP=0x000000000045a84b
- (void)updateWithTranslation:(struct CGPoint)arg1 rotation:(double)arg2 scale:(double)arg3;	// IMP=0x000000000045a7a4
- (id)initWithView:(id)arg1 sourceFrame:(struct CGRect)arg2 targetFrame:(struct CGRect)arg3 anchorPoint:(struct CGPoint)arg4 shouldUseTargetAspectRatio:(_Bool)arg5 rampUpDuration:(double)arg6 direction:(unsigned long long)arg7;	// IMP=0x000000000045a0e4
