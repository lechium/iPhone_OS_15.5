...
+ (id)settingsControllerModule;	// IMP=0x00000000000668d1
+ (id)sharedInstance;	// IMP=0x00000000000668a1
...
- (void)setDefaultValues;	// IMP=0x000000000006676d
- (id)parentSettings;	// IMP=0x0000000000066754
