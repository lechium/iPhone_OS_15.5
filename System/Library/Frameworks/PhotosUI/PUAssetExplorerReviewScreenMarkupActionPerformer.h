...
+ (_Bool)shouldEnableOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x000000000009cd25
+ (_Bool)canPerformOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x000000000009cd05
- (void).cxx_destruct;	// IMP=0x000000000009d049
...
- (void)_presentMarkupViewControllerForReviewAsset:(id)arg1;	// IMP=0x000000000009cf07
- (void)performUserInteractionTask;	// IMP=0x000000000009cdbd
