...
- (void).cxx_destruct;	// IMP=0x00000000000ed403
...
- (void)aspectRatioButtonPressed:(id)arg1;	// IMP=0x00000000000ed2a7
- (id)initWithLayoutOrientation:(long long)arg1;	// IMP=0x00000000000ec94c
