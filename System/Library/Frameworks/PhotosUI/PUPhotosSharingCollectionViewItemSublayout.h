...
- (void).cxx_destruct;	// IMP=0x000000000035be0d
...
- (void)setFloatingOffset:(struct UIOffset)arg1;	// IMP=0x000000000035bc87
- (void)prepareSublayout;	// IMP=0x000000000035b689
@property(nonatomic) struct CGSize optionBadgeSize;
@property(nonatomic) struct CGSize selectionBadgeSize;
- (id)initWithIndexPath:(id)arg1 itemFrame:(struct CGRect)arg2;	// IMP=0x000000000035b519
