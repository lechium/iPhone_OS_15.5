...
+ (id)settingsControllerModule;	// IMP=0x000000000041fe1c
+ (id)sharedInstance;	// IMP=0x000000000041fdec
...
- (void)setDefaultValues;	// IMP=0x0000000000420237
- (id)parentSettings;	// IMP=0x000000000042021e
