...
+ (id)settingsControllerModule;	// IMP=0x00000000003c6aed
+ (id)sharedInstance;	// IMP=0x00000000003c6abd
...
- (void)setDefaultValues;	// IMP=0x00000000003c6546
- (id)parentSettings;	// IMP=0x00000000003c652d
