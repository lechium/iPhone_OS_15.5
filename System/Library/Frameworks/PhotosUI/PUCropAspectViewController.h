...
- (void).cxx_destruct;	// IMP=0x00000000000ec895
...
- (void)aspectButtonPressed:(id)arg1;	// IMP=0x00000000000ec4c6
- (void)updateAspectConstraints;	// IMP=0x00000000000eafa5
- (void)updateAspectButtons;	// IMP=0x00000000000ea918
- (id)matchingCropAspectTo:(id)arg1;	// IMP=0x00000000000ea66a
- (void)updateAspectButtonSelection;	// IMP=0x00000000000ea4b3
- (void)viewDidLoad;	// IMP=0x00000000000ea017
- (id)initWithLayoutOrientation:(long long)arg1 originalSize:(struct CGSize)arg2 currentSize:(struct CGSize)arg3 currentCropAspect:(id)arg4 spec:(id)arg5;	// IMP=0x00000000000e9f06
