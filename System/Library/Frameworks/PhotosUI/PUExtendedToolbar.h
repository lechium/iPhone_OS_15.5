...
- (void).cxx_destruct;	// IMP=0x000000000012a1b0
...
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x0000000000129f8e
- (void)_updateViewsIfNeededWithAnimatorBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000129625
- (void)_invalidateAccessoryViewContainer;	// IMP=0x00000000001295f2
- (void)_invalidateContainedToolbar;	// IMP=0x00000000001295bf
- (void)_updateAccessoryTopOutsetViewIfNeeded;	// IMP=0x00000000001294d9
- (void)_invalidateAccessoryViewTopOutset;	// IMP=0x00000000001294a6
- (void)_updateAccessoryViewIfNeeded;	// IMP=0x000000000012938b
- (void)_invalidateAccessoryView;	// IMP=0x0000000000129358
- (void)_updateToolbarItemsIfNeeded;	// IMP=0x0000000000129220
- (void)_invalidateToolbarItems;	// IMP=0x00000000001291ed
- (void)_setNeedsUpdate;	// IMP=0x0000000000129140
- (_Bool)_needsUpdate;	// IMP=0x00000000001290cb
- (void)_updateIfNeededWithAnimatorBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000128fa6
- (void)_assertInsideUpdate;	// IMP=0x0000000000128f0e
- (void)_assertInsideChangeBlock;	// IMP=0x0000000000128e75
- (void)_performChanges:(CDUnknownBlockType)arg1 withAnimatorBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000128cfd
- (void)_performChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000128ce9
- (void)_invalidateSize;	// IMP=0x0000000000128ca7
- (void)_getContainedToolbarFrame:(struct CGRect *)arg1 accessoryViewContainerFrame:(struct CGRect *)arg2 forBounds:(struct CGRect)arg3;	// IMP=0x0000000000128af3
- (void)layoutSubviews;	// IMP=0x00000000001288ae
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000128562
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001283bd
- (void)tintColorDidChange;	// IMP=0x000000000012832a
- (void)setBarStyle:(long long)arg1;	// IMP=0x00000000001282b3
- (void)setToolbarViewModel:(id)arg1 withAnimatorBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000001281ce
- (_Bool)_shouldStretchDuringCrossfadeTransition;	// IMP=0x00000000001280f7
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000128033
