...
- (void).cxx_destruct;	// IMP=0x0000000000301d1b
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x0000000000301a87
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x00000000003019de
- (void)_handleResultImageData:(id)arg1 dataUTI:(id)arg2 orientation:(long long)arg3 info:(id)arg4;	// IMP=0x0000000000301932
- (id)init;	// IMP=0x0000000000301883
