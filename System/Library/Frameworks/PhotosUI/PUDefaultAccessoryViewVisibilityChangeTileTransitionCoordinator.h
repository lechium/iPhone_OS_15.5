...
- (void).cxx_destruct;	// IMP=0x000000000010b5e7
...
- (id)_layoutInfoWithDefaultDisappearance:(id)arg1;	// IMP=0x000000000010ae94
- (id)optionsForAnimatingTileController:(id)arg1 toLayoutInfo:(id)arg2 withAnimationType:(long long)arg3;	// IMP=0x000000000010ad62
