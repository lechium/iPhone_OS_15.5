...
- (void).cxx_destruct;	// IMP=0x00000000003baf4e
...
- (id)description;	// IMP=0x00000000003badf3
- (id)concatenatedSynonyms;	// IMP=0x00000000003bad7e
- (id)initWithKeyword:(id)arg1 synonyms:(id)arg2 sceneIdentifier:(unsigned int)arg3 indexed:(_Bool)arg4 threshold:(double)arg5;	// IMP=0x00000000003baca6
