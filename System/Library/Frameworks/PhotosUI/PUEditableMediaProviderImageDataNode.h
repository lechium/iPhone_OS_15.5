...
- (void).cxx_destruct;	// IMP=0x0000000000125417
...
- (void)_handleLoadedImageData:(id)arg1 imageUTI:(id)arg2 imageOrientation:(long long)arg3 info:(id)arg4;	// IMP=0x00000000001251a7
- (void)run;	// IMP=0x0000000000124ffb
- (void)didCancel;	// IMP=0x0000000000124fa8
- (id)initWithAsset:(id)arg1 mediaProvider:(id)arg2 version:(long long)arg3;	// IMP=0x0000000000124ef1
