...
+ (id)settingsControllerModule;	// IMP=0x000000000005cd62
+ (id)sharedInstance;	// IMP=0x000000000005cd32
...
- (id)debugDescription;	// IMP=0x000000000005c9da
- (void)setDefaultValues;	// IMP=0x000000000005c8fd
- (id)parentSettings;	// IMP=0x000000000005c8e4
