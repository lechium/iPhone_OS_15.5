...
+ (Class)_contentViewClass;	// IMP=0x0000000000139295
+ (long long)_videoOverlayButtonStyle;	// IMP=0x000000000013928a
+ (void)preloadResources;	// IMP=0x0000000000139232
...
- (void)_handleCommentButton:(id)arg1;	// IMP=0x0000000000138b46
- (void)_handlePlayButton:(id)arg1;	// IMP=0x0000000000138ae9
- (id)_imageCellDelegate;	// IMP=0x0000000000138ad7
- (void)_updateRoundedCornersOverlayView;	// IMP=0x00000000001389a9
- (void)_invalidateOverlayPlayButtonBackground;	// IMP=0x000000000013893d
- (void)_updateCommentButton;	// IMP=0x00000000001387f6
- (void)_updateOverlays;	// IMP=0x000000000013820c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001381b2
- (void)layoutSubviews;	// IMP=0x000000000013781e
- (void)_layoutImageView;	// IMP=0x0000000000137636
- (void)_updateVideoViewContentMode;	// IMP=0x00000000001374d7
- (void)_updateVideoPlayerContents;	// IMP=0x00000000001372ff
- (void)setAudioSession:(id)arg1;	// IMP=0x0000000000137255
- (void)setImage:(id)arg1 withTag:(long long)arg2;	// IMP=0x0000000000136e69
- (void)setParallaxOffset:(struct CGPoint)arg1;	// IMP=0x0000000000136e0c
- (id)focusEffect;	// IMP=0x0000000000136d8f
- (void)prepareForReuse;	// IMP=0x0000000000136d07
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000136b9a
