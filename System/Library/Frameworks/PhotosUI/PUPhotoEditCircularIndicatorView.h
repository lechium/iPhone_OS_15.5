...
- (void).cxx_destruct;	// IMP=0x00000000002a07e3
...
- (void)resetToDefaults;	// IMP=0x00000000002a06e2
- (void)_updateProgressLayer;	// IMP=0x00000000002a040d
@property(retain, nonatomic) UIColor *ringColor;
- (void)_layoutSubLayers;	// IMP=0x000000000029fef9
- (void)layoutSubviews;	// IMP=0x000000000029feb8
- (void)_setupLayers;	// IMP=0x000000000029fc27
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000029fa77
