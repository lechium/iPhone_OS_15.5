...
- (void).cxx_destruct;	// IMP=0x0000000000003ca4
...
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x00000000000039f4
- (id)initWithTraitContainer:(id)arg1;	// IMP=0x00000000000037ee
