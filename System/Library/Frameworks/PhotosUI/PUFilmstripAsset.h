...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000016a10c
- (long long)compare:(id)arg1;	// IMP=0x000000000016a0cb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000016a04e
...
- (unsigned long long)isContentEqualTo:(id)arg1;	// IMP=0x0000000000169f96
...
- (void)loadSourceTimeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000169da0
- (id)initWithNormalizedTime:(double)arg1 asset:(id)arg2;	// IMP=0x0000000000169c7a
- (id)init;	// IMP=0x0000000000169c63
