...
+ (struct CGSize)bufferingIndicatorTileSize;	// IMP=0x00000000000cff69
+ (_Bool)canShowBufferingIndicatorTileForAsset:(id)arg1;	// IMP=0x00000000000cfef6
- (void).cxx_destruct;	// IMP=0x00000000000cfd88
...
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x00000000000cfbb8
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000000cfaa3
- (void)_updateIndicator;	// IMP=0x00000000000cf82c
- (void)_handleErrorButton:(id)arg1;	// IMP=0x00000000000cf67e
- (void)_setIndicatorStyle:(long long)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000cf04f
- (void)becomeReusable;	// IMP=0x00000000000ceda8
