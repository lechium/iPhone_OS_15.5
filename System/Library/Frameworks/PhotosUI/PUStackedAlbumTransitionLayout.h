...
- (void).cxx_destruct;	// IMP=0x000000000041a3bc
...
- (id)layoutAttributesForDecorationViewOfKind:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x000000000041a253
- (id)layoutAttributesForSupplementaryViewOfKind:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x000000000041a18d
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x000000000041a10c
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x0000000000419eec
- (void)prepareLayout;	// IMP=0x0000000000419ccc
- (struct CGPoint)_centerOfLayoutAttributes:(id)arg1;	// IMP=0x0000000000419a11
- (struct CGPoint)_newCenterForLayoutAttributes:(id)arg1 transitionProgress:(double)arg2;	// IMP=0x0000000000419622
- (id)initWithCurrentLayout:(id)arg1 nextLayout:(id)arg2 isExpanding:(_Bool)arg3;	// IMP=0x000000000041952a
