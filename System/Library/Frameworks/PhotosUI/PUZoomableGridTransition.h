...
- (void).cxx_destruct;	// IMP=0x0000000000496194
...
- (void)cancelInteractiveTransitionAnimated;	// IMP=0x0000000000495f5f
- (void)finishInteractiveTransitionAnimated;	// IMP=0x0000000000495f15
- (void)updateInteractiveTransitionForProgress:(double)arg1 centerOffset:(struct CGSize)arg2;	// IMP=0x0000000000495dc2
- (void)startInteractiveTransition:(id)arg1;	// IMP=0x0000000000495a76
- (id)initWithOriginLevel:(unsigned long long)arg1 targetLevel:(unsigned long long)arg2 zoomLevelManager:(id)arg3 interactive:(_Bool)arg4;	// IMP=0x0000000000495879
