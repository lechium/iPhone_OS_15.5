...
- (void).cxx_destruct;	// IMP=0x00000000003a719c
...
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000003a70b2
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x00000000003a7070
- (void)_updateVisibilityAnimated:(_Bool)arg1;	// IMP=0x00000000003a6ef6
- (void)_updateBarLayout;	// IMP=0x00000000003a6e28
- (void)_updateControls;	// IMP=0x00000000003a6d45
- (void)_handleRetakeButtonTapped:(id)arg1;	// IMP=0x00000000003a6bda
- (void)_handleDoneButtonTapped:(id)arg1;	// IMP=0x00000000003a6b98
- (void)becomeReusable;	// IMP=0x00000000003a6b3e
- (id)loadView;	// IMP=0x00000000003a6a65
