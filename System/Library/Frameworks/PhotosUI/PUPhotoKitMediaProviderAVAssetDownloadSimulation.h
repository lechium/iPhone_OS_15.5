...
- (void).cxx_destruct;	// IMP=0x00000000003027f0
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x0000000000302576
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x00000000003024cd
- (void)_handleResultAVAsset:(id)arg1 audioMix:(id)arg2 info:(id)arg3;	// IMP=0x00000000003023dc
- (id)init;	// IMP=0x00000000003022ff
