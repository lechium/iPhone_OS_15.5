...
+ (void)unregisterTransitionEndPoint:(id)arg1 forViewController:(id)arg2;	// IMP=0x0000000000453ae6
+ (void)registerTransitionEndPoint:(id)arg1 forViewController:(id)arg2;	// IMP=0x0000000000453a4c
+ (id)transitionEndPointWithViewController:(id)arg1;	// IMP=0x000000000045359b
- (void).cxx_destruct;	// IMP=0x00000000004523db
...
- (long long)_barStyleForEndPoint:(id)arg1;	// IMP=0x0000000000451f6c
- (_Bool)_endPointUsesTransientTilingView:(id)arg1;	// IMP=0x0000000000451f0f
- (_Bool)_validateTransitionFromEndPoint:(id)arg1 toEndPoint:(id)arg2;	// IMP=0x0000000000451de8
- (void)animateTransitionWithOperation:(long long)arg1 startedInteractively:(_Bool)arg2;	// IMP=0x0000000000450b56
- (void)_getTransitionProgress:(double *)arg1 backgroundProgress:(double *)arg2 chromeProgress:(double *)arg3;	// IMP=0x0000000000450879
- (void)resumeTransition:(_Bool)arg1;	// IMP=0x00000000004506a6
- (void)updatePausedTransitionWithProgress:(double)arg1 interactionProgress:(double)arg2;	// IMP=0x0000000000450544
- (void)pauseTransitionWithOptions:(unsigned long long)arg1;	// IMP=0x00000000004502b8
- (void)pauseTransition;	// IMP=0x00000000004502a4
- (id)initWithPresentationDuration:(double)arg1 dismissalDuration:(double)arg2;	// IMP=0x0000000000450152
- (id)init;	// IMP=0x000000000045013a
