...
{
    PXSwipeDownTracker *_impl;	// 8 = 0x8
}
...
- (void)trackGestureTranslation:(struct CGPoint)arg1 velocity:(struct CGPoint)arg2;	// IMP=0x0000000000013880
- (void)startTrackingCenter:(struct CGPoint)arg1 bounds:(struct CGRect)arg2 transform:(struct CGAffineTransform)arg3 withInitialGestureLocation:(struct CGPoint)arg4;	// IMP=0x00000000000137d7
- (id)init;	// IMP=0x0000000000013781
