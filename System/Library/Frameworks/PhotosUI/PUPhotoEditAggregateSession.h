...
- (void).cxx_destruct;	// IMP=0x00000000001a1e89
...
- (void)finishSessionWithEnd:(long long)arg1;	// IMP=0x00000000001a1da8
- (id)finishSessionWithEnd:(long long)arg1 newCompositionController:(id)arg2 oldCompositionController:(id)arg3;	// IMP=0x00000000001a1994
- (void)_recordKeys:(id)arg1;	// IMP=0x00000000001a1861
- (id)_sessionKeysWithEnd:(long long)arg1;	// IMP=0x00000000001a16fc
@property(readonly, nonatomic) __weak NSArray *_autoCropKeys;
- (void)notifyDidAdjustCrop;	// IMP=0x00000000001a15c1
- (void)notifyDidResetCrop;	// IMP=0x00000000001a1573
- (void)notifyDidApplyPerspectiveAutoCrop;	// IMP=0x00000000001a155c
- (void)notifyDidApplyAutoCrop;	// IMP=0x00000000001a1518
- (struct __CFString *)_keyForSessionEnd:(long long)arg1;	// IMP=0x00000000001a1498
