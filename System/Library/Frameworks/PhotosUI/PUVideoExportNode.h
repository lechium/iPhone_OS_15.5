...
- (void).cxx_destruct;	// IMP=0x0000000000488ecb
...
- (void)_handleExportCompletedWithSuccess:(_Bool)arg1 editedSize:(struct CGSize)arg2 error:(id)arg3;	// IMP=0x0000000000488ded
- (void)didCancel;	// IMP=0x0000000000488db0
@property(readonly, nonatomic) double progress;
- (void)run;	// IMP=0x0000000000488afa
- (id)_editSource;	// IMP=0x0000000000488993
- (id)_newOutputURL;	// IMP=0x00000000004888aa
- (id)_exportPresetName;	// IMP=0x0000000000488872
- (id)initWithVideoURLNode:(id)arg1 imageURLNode:(id)arg2 quality:(unsigned long long)arg3 livePhotoPairingIdentifier:(id)arg4 compositionController:(id)arg5;	// IMP=0x0000000000488658
