...
- (void).cxx_destruct;	// IMP=0x0000000000049f30
@property(nonatomic) __weak PUAdjustmentsDataSource *dataSource; // @synthesize dataSource=_dataSource;
- (void)dataSource:(id)arg1 adjustmentInfo:(id)arg2 setEnabled:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000049c82
