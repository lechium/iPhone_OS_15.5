...
+ (struct CGSize)playButtonTileSize;	// IMP=0x0000000000378989
- (void).cxx_destruct;	// IMP=0x00000000003788c0
...
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x000000000037864a
- (void)_setShouldShowPlayButton:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000003784f2
- (void)_updateButtonAnimated:(_Bool)arg1;	// IMP=0x000000000037819d
- (void)_playButtonTapped:(id)arg1;	// IMP=0x0000000000378116
@property(readonly, nonatomic) _Bool showPlayButtonWhileActivated;
@property(readonly, nonatomic) _Bool canShowPauseButton;
- (void)becomeReusable;	// IMP=0x0000000000377d76
- (void)dealloc;	// IMP=0x0000000000377d07
- (id)loadView;	// IMP=0x0000000000377bbc
