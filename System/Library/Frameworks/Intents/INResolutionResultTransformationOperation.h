...
- (void).cxx_destruct;	// IMP=0x00000000001bbfbd
...
- (_Bool)isExecuting;	// IMP=0x00000000001bbf47
- (_Bool)isFinished;	// IMP=0x00000000001bbf37
- (void)start;	// IMP=0x00000000001bbe40
- (id)initWithResult:(id)arg1 intent:(id)arg2 intentSlotDescription:(id)arg3 optionsProvider:(id)arg4;	// IMP=0x00000000001bbd49
