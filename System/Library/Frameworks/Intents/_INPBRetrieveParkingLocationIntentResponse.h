...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000043d0d1
- (void).cxx_destruct;	// IMP=0x000000000043ce85
...
- (id)dictionaryRepresentation;	// IMP=0x000000000043cd67
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000043ca5d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000043c99e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000043c90c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000043c80d
- (void)writeTo:(id)arg1;	// IMP=0x000000000043c72a
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000043c71d
