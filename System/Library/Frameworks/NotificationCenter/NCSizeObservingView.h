...
- (void).cxx_destruct;	// IMP=0x0000000000001474
@property(nonatomic) __weak id <NCSizeObservingViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000000001368
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x0000000000001275
