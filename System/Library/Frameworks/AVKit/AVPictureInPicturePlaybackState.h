...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000035fc3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000035fb8
- (id)initWithElapsedTime:(double)arg1 timelineDuration:(double)arg2 timelineRate:(double)arg3 paused:(_Bool)arg4;	// IMP=0x0000000000035ec0
