...
- (void).cxx_destruct;	// IMP=0x0000000000018d8e
...
- (void)_updateSelectionStateForMenu:(id)arg1 selectedIndex:(unsigned long long)arg2;	// IMP=0x0000000000018af6
- (id)_menuForOptions:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0000000000018646
@property(readonly) UIMenu *legibleOptionsMenu;
@property(readonly) UIMenu *audibleOptionsMenu;
- (id)initWithAudibleOptions:(id)arg1 legibleOptions:(id)arg2;	// IMP=0x0000000000018368
