...
+ (id)imageSymbolConfiguration;	// IMP=0x0000000000009d0f
+ (id)stopPictureInPictureButtonImageName;	// IMP=0x0000000000009cf0
+ (id)startPictureInPictureButtonImageName;	// IMP=0x0000000000009cd1
+ (_Bool)isPictureInPictureSupported;	// IMP=0x0000000000009be1
...
- (long long)_sceneActivationState;	// IMP=0x000000000000882d
- (void)_removeSecondScreenConnection;	// IMP=0x000000000000876b
- (void)pictureInPictureViewControllerViewWillDisappear:(id)arg1;	// IMP=0x00000000000084ec
- (void)pictureInPictureViewControllerViewDidAppear:(id)arg1;	// IMP=0x00000000000083e9
- (_Bool)pictureInPictureProxyCanIssueOptionalCommand:(id)arg1;	// IMP=0x00000000000083cc
- (void)pictureInPictureProxy:(id)arg1 didReceiveTestingCommand:(id)arg2;	// IMP=0x000000000000825c
- (void)pictureInPictureProxy:(id)arg1 didReceivePlaybackCommand:(id)arg2;	// IMP=0x0000000000007b1b
- (void)pictureInPictureProxy:(id)arg1 didUpdateResourcesUsageReductionReasons:(unsigned long long)arg2 oldReasons:(unsigned long long)arg3;	// IMP=0x00000000000079fc
- (id)pictureInPictureProxyViewControllerWindowForTransitionAnimation:(id)arg1;	// IMP=0x00000000000079ac
- (long long)pictureInPictureProxyInterfaceOrientationForTransitionAnimation:(id)arg1;	// IMP=0x000000000000793e
- (void)pictureInPictureProxyPictureInPictureInterruptionEnded:(id)arg1;	// IMP=0x0000000000007842
- (void)pictureInPictureProxyPictureInPictureInterruptionBegan:(id)arg1;	// IMP=0x0000000000007746
- (void)pictureInPictureProxy:(id)arg1 didStopPictureInPictureWithAnimationType:(long long)arg2 reason:(long long)arg3;	// IMP=0x0000000000007623
- (void)pictureInPictureProxy:(id)arg1 willStopPictureInPictureWithAnimationType:(long long)arg2 reason:(long long)arg3;	// IMP=0x000000000000749f
- (void)pictureInPictureProxy:(id)arg1 restoreUserInterfaceForPictureInPictureStopWithCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000733d
- (void)pictureInPictureProxy:(id)arg1 failedToStartPictureInPictureWithAnimationType:(long long)arg2 error:(id)arg3;	// IMP=0x0000000000007222
- (void)pictureInPictureProxy:(id)arg1 didStartPictureInPictureWithAnimationType:(long long)arg2;	// IMP=0x0000000000007132
- (void)pictureInPictureProxy:(id)arg1 willStartPictureInPictureWithAnimationType:(long long)arg2;	// IMP=0x0000000000007019
- (struct CGRect)pictureInPictureProxyViewFrameForTransitionAnimation:(id)arg1;	// IMP=0x0000000000006ffa
- (void)_startObservingForPlaybackStateUpdates;	// IMP=0x0000000000006c4f
- (void)_startObservation;	// IMP=0x000000000000687d
- (void)_createProxyIfNeeded;	// IMP=0x0000000000006729
- (void)_updateProxyPlaybackState;	// IMP=0x0000000000006558
- (long long)_proxyControlsStyle;	// IMP=0x000000000000652c
- (void)_updatePictureInPictureShouldStartWhenEnteringBackground;	// IMP=0x0000000000005d89
- (void)updateLayoutDependentBehaviors;	// IMP=0x0000000000005cc6
...
- (void)stopPictureInPictureAndRestoreUserInterface:(_Bool)arg1;	// IMP=0x0000000000005227
- (void)startPictureInPicture;	// IMP=0x0000000000004fe2
- (void)dealloc;	// IMP=0x0000000000004f65
- (id)initWithSource:(id)arg1;	// IMP=0x0000000000004d56
@property(readonly, nonatomic, getter=isContentSourceSupported) _Bool contentSourceSupported;
- (void)_setRoutingVideoToHostedWindow:(_Bool)arg1 pictureInPictureViewController:(id)arg2 source:(id)arg3;	// IMP=0x000000000007960c
- (void)_updateStatusUsingProposedStatus:(long long)arg1;	// IMP=0x0000000000078dc9
- (void)_updateStatus;	// IMP=0x0000000000078d98
- (void)_setStatusAndNotifyDelegateIfNeeded:(long long)arg1;	// IMP=0x0000000000078c76
