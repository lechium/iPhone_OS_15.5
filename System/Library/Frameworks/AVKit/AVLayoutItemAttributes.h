...
- (void).cxx_destruct;	// IMP=0x00000000000dceb0
...
- (id)debugDescription;	// IMP=0x00000000000dcc13
- (unsigned long long)hash;	// IMP=0x00000000000dcbcf
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000dcaf9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000dc8c2
@property(readonly, nonatomic, getter=isCollapsedOrExcluded) _Bool collapsedOrExcluded;
- (id)init;	// IMP=0x00000000000dc7b6
