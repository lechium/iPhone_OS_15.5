...
+ (id)sizesResolvingFirstPrioritizedSize:(id)arg1 secondPrioritizedSize:(id)arg2 inAvailableWidth:(double)arg3;	// IMP=0x0000000000083d28
- (void).cxx_destruct;	// IMP=0x0000000000083cdf
...
- (id)removeLastSizeOfPriority:(unsigned long long)arg1;	// IMP=0x0000000000083af4
- (void)addSize:(struct CGSize)arg1 withPriority:(unsigned long long)arg2;	// IMP=0x00000000000839be
- (id)init;	// IMP=0x00000000000838f2
