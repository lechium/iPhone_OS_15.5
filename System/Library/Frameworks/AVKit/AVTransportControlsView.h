...
@interface AVTransportControlsView <AVScrubberDelegate, AVVolumeControlsControllerLayoutDelegate>
{
    ...
    AVStyleSheet *_styleSheet;	// 32 = 0x20
...
- (void).cxx_destruct;	// IMP=0x00000000000a3888
...
- (_Bool)_subviewIsCustomMenuItemView:(id)arg1;	// IMP=0x00000000000a3442
...
- (void)_updateCustomContentTransitioningInfoPanelLayout;	// IMP=0x00000000000a2bbb
- (void)_updateVolumeControllerLayout;	// IMP=0x00000000000a2bb5
- (id)_scrubInstructionsAttributedText;	// IMP=0x00000000000a2942
- (void)_updateScrubInstructionsFrame;	// IMP=0x00000000000a24c1
- (void)_updateScrubInstructionsLabelsText;	// IMP=0x00000000000a22e9
- (void)_showScrubInstructions;	// IMP=0x00000000000a20c8
- (void)_updateFontSizes;	// IMP=0x00000000000a1e8f
- (unsigned long long)_layoutItemDisplayPriorityForSubview:(id)arg1;	// IMP=0x00000000000a1b80
- (double)_rowSpacingForDoubleRowLayoutAfterRow:(unsigned long long)arg1;	// IMP=0x00000000000a19ee
- (void)_layoutSingleRowViews;	// IMP=0x00000000000a12cb
- (void)_layoutDoubleRowViews;	// IMP=0x00000000000a03ef
- (double)_doubleRowLayoutSpacingAfterSubview:(id)arg1;	// IMP=0x000000000009ff17
- (double)_singeRowLayoutSpacingAfterSubview:(id)arg1;	// IMP=0x000000000009fb36
- (void)endScrubbing:(id)arg1;	// IMP=0x000000000009f9d1
- (void)scrubberValueChanged:(id)arg1;	// IMP=0x000000000009f94c
- (void)beginScrubbing:(id)arg1;	// IMP=0x000000000009f878
@property(readonly, nonatomic, getter=isCollapsedOrExcluded) _Bool collapsedOrExcluded;
- (void)scrubberSlowKnobMovementDetected:(id)arg1;	// IMP=0x000000000009f5c0
- (void)avkit_reevaluateHiddenStateOfItem:(id)arg1;	// IMP=0x000000000009f4a8
- (void)layoutSubviews;	// IMP=0x000000000009eb01
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000009eac0
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000009e755
- (double)layoutHeightThatFitsRowsStartingWithRow:(unsigned long long)arg1;	// IMP=0x000000000009e6fe
- (void)reevaluateHiddenStateOfAllItems;	// IMP=0x000000000009e6c1
- (float)volumeControlsControllerTransportBarHeight:(id)arg1;	// IMP=0x000000000009e203
- (id)initWithFrame:(struct CGRect)arg1 styleSheet:(id)arg2;	// IMP=0x000000000009d6e0
