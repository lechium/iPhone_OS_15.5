...
- (void).cxx_destruct;	// IMP=0x00000000000197ea
...
- (void)restoreVolumeIfNeeded;	// IMP=0x00000000000196f7
- (void)setProgressAwayFromZero:(double)arg1;	// IMP=0x0000000000019528
- (void)setProgressTowardsZero:(double)arg1;	// IMP=0x00000000000193b8
- (_Bool)canAnimateVolumeAwayFromZero;	// IMP=0x00000000000192ae
- (_Bool)canAnimateVolumeTowardsZero;	// IMP=0x00000000000191a4
- (_Bool)currentRouteHasVolumeControl;	// IMP=0x0000000000019159
- (id)initWithPlayerController:(id)arg1;	// IMP=0x00000000000190ee
