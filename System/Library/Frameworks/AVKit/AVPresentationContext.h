...
+ (_Bool)supportsInteractiveCounterRotationDismissals;	// IMP=0x0000000000020329
- (void).cxx_destruct;	// IMP=0x00000000000202b1
...
- (id)dismissalToView;	// IMP=0x0000000000020138
- (id)presentationFromView;	// IMP=0x00000000000200de
...
- (id)presentingView;	// IMP=0x000000000001fad3
@property(readonly, nonatomic) __weak UIView *containerView;
- (id)initWithPresentationController:(id)arg1 configuration:(id)arg2;	// IMP=0x000000000001f8c3
