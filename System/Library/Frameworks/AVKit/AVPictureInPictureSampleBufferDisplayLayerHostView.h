...
+ (Class)layerClass;	// IMP=0x0000000000018357
- (void).cxx_destruct;	// IMP=0x000000000001832e
...
- (void)_updateGeometryIfNeeded;	// IMP=0x0000000000017bf1
- (void)layoutSubviews;	// IMP=0x0000000000017a49
- (void)setFrame:(struct CGRect)arg1 contentDimensions:(struct CGSize)arg2 imageQueueSize:(struct CGSize)arg3;	// IMP=0x00000000000178b6
@property(nonatomic) double beginTime;
@property(nonatomic) unsigned int contextId;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000017600
