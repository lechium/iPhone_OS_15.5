...
- (void).cxx_destruct;	// IMP=0x0000000000037298
...
- (void)_updateLayoutItem;	// IMP=0x0000000000037161
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000370c8
- (void)updateButtonAppearance;	// IMP=0x0000000000036c9f
- (void)_updateCustomButtonMicaPackage;	// IMP=0x0000000000036aec
- (void)setPrioritizesVideoDevices:(_Bool)arg1;	// IMP=0x000000000003697c
@property(readonly, nonatomic) AVButton *customButton;
- (void)layoutAttributesDidChange;	// IMP=0x0000000000036744
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000003620c
