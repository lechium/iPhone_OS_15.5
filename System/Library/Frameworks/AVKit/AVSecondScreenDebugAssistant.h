...
- (void).cxx_destruct;	// IMP=0x000000000005a0b3
...
- (void)_actuallyUpdateDebugLabelTextWithCurrentResolution:(id)arg1 currentVideoDynamicRange:(id)arg2;	// IMP=0x000000000005975e
- (void)_updateDebugLabelText;	// IMP=0x0000000000059530
- (id)_currentVideoDynamicRange;	// IMP=0x00000000000592f3
- (id)_currentDisplay;	// IMP=0x0000000000059060
- (id)_currentEnabledVideoTrack;	// IMP=0x0000000000058def
- (void)dealloc;	// IMP=0x0000000000058bcd
- (id)init;	// IMP=0x0000000000058a1c
