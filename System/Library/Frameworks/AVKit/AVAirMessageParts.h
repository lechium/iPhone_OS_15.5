...
+ (id)messagePartsWithData:(id)arg1 lineSeparator:(id)arg2 data:(id)arg3 headerBodySeparator:(id)arg4 data:(id)arg5 bodyLengthKey:(id)arg6;	// IMP=0x000000000009ac60
+ (void)registerClass:(Class)arg1 forMessageVersion:(id)arg2;	// IMP=0x000000000009b5c1
- (void).cxx_destruct;	// IMP=0x000000000009ac01
...
- (_Bool)shouldCallReverseTransformerAgain;	// IMP=0x000000000009ab41
- (id)decompressBodyUsingNamedAlgorithm:(id)arg1;	// IMP=0x000000000009a956
- (id)decompressBodyUsingAlgorithm:(long long)arg1;	// IMP=0x000000000009a814
...
- (void)_identifyUniqueAndRepeatedHeadersIfNecessary;	// IMP=0x000000000009a1f5
- (void)_setIncomplete;	// IMP=0x000000000009a1eb
- (id)initWithVersion:(id)arg1 headers:(id)arg2 expectedBodyLength:(long long)arg3 body:(id)arg4 extra:(id)arg5;	// IMP=0x000000000009a088
@property(readonly, nonatomic) id airMessage;
- (Class)_matchingClass;	// IMP=0x000000000009b2ee
