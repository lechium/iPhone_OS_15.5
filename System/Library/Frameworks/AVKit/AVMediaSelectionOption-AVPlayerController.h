...
+ (id)avkit_autoOption;	// IMP=0x00000000000f0b53
+ (id)avkit_offOption;	// IMP=0x00000000000f0b42
- (long long)languageCompare:(id)arg1 currentLanguageCode:(id)arg2 currentLanguageIdentifier:(id)arg3;	// IMP=0x00000000000147e3
...
- (id)avkit_title;	// IMP=0x00000000000f0a58
