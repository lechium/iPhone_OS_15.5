...
+ (id)airMessageParser;	// IMP=0x000000000009b4ff
- (void).cxx_destruct;	// IMP=0x000000000009a034
...
- (id)partsWithData:(id)arg1;	// IMP=0x0000000000099d85
- (id)init;	// IMP=0x0000000000099bc6
- (id)initWithLineSeparator:(id)arg1 headerBodySeparator:(id)arg2 bodyLengthKey:(id)arg3 compressionMethodKey:(id)arg4;	// IMP=0x0000000000099ad5
