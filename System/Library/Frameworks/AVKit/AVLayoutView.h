...
+ (Class)layerClass;	// IMP=0x00000000000e1173
...
- (void)layoutAttributesDidChange;	// IMP=0x00000000000e06fa
...
- (id)_includedItemsFromSubviews:(id)arg1 inStackLayout:(id)arg2 thatFitSize:(struct CGSize)arg3;	// IMP=0x00000000000dfc67
- (void)_removeArrangedSubview:(id)arg1;	// IMP=0x00000000000dfb8c
- (void)_insertArrangedSubview:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x00000000000dfad3
- (void)_applyShapeStyle;	// IMP=0x00000000000df6ed
- (void)_updateStackLayoutIfNeeded;	// IMP=0x00000000000df040
@property(readonly, copy) NSString *debugDescription;
- (void)reevaluateHiddenStateOfAllItems;	// IMP=0x00000000000dee88
- (void)setRowSpacing:(double)arg1 afterRow:(unsigned long long)arg2;	// IMP=0x00000000000ded9f
- (_Bool)hasVisibleArrangedSubview;	// IMP=0x00000000000dec1e
@property(nonatomic) struct NSDirectionalEdgeInsets contentLayoutMargins;
- (void)setArrangedSubviews:(id)arg1;	// IMP=0x00000000000de6a0
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000000de62e
- (id)backgroundColor;	// IMP=0x00000000000de5de
- (void)setNeedsLayout;	// IMP=0x00000000000de598
- (double)layoutHeightThatFitsRowsStartingWithRow:(unsigned long long)arg1;	// IMP=0x00000000000de511
- (id)prioritizedSizeThatFitsSize:(struct CGSize)arg1;	// IMP=0x00000000000de495
- (void)layoutSubviews;	// IMP=0x00000000000ddeab
- (id)init;	// IMP=0x00000000000dde79
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000ddb8b
