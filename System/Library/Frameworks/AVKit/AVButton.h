...
+ (id)buttonWithAccessibilityIdentifier:(id)arg1 accessibilityLabel:(id)arg2;	// IMP=0x00000000000dc377
+ (id)buttonWithAccessibilityIdentifier:(id)arg1;	// IMP=0x00000000000dc324
- (void).cxx_destruct;	// IMP=0x00000000000dbc67
...
- (double)_imageViewAlpha;	// IMP=0x00000000000db6ed
- (id)_preferredFont;	// IMP=0x00000000000db655
- (id)_preferredImageName;	// IMP=0x00000000000db609
- (void)_updateBackgroundEffectViewIsHidden;	// IMP=0x00000000000db4c7
- (void)_updateEdgeInsets;	// IMP=0x00000000000db3bf
- (void)_updateTintColorIfNeeded;	// IMP=0x00000000000db2f9
- (void)_updateImageIfNeeded;	// IMP=0x00000000000db2ad
- (void)_updateLayoutItem;	// IMP=0x00000000000db1b8
- (void)_resetTrackedState;	// IMP=0x00000000000db110
- (void)_handleUserInteractionGestureRecognizer:(id)arg1;	// IMP=0x00000000000db094
- (struct CGSize)_preferredLayoutSize;	// IMP=0x00000000000dafbf
- (void)layoutAttributesDidChange;	// IMP=0x00000000000daf66
- (void)layoutSubviews;	// IMP=0x00000000000dae7f
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000dada0
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000000dad51
- (struct CGRect)hitRect;	// IMP=0x00000000000dac56
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x00000000000daa4c
- (id)accessibilityLabel;	// IMP=0x00000000000da9e0
- (void)setTitle:(id)arg1 forState:(unsigned long long)arg2;	// IMP=0x00000000000da866
- (void)setImage:(id)arg1 forState:(unsigned long long)arg2;	// IMP=0x00000000000da47d
- (void)cancelTrackingWithEvent:(id)arg1;	// IMP=0x00000000000da400
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000da383
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000da0c3
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000d9f01
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000d9d6a
- (void)setEnabled:(_Bool)arg1;	// IMP=0x00000000000d9c43
- (void)willMoveToWindow:(id)arg1;	// IMP=0x00000000000d8fdc
- (struct CGSize)minimumSize;	// IMP=0x00000000000d8fca
