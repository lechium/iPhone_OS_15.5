...
- (void).cxx_destruct;	// IMP=0x00000000001b88e8
- (void)_configureBalloonForDataIconImageKeys:(id)arg1 scale:(double)arg2;	// IMP=0x00000000001b803d
- (_Bool)updateCalloutViewIfNeededAnimated:(_Bool)arg1;	// IMP=0x00000000001b76a0
- (void)_addAnchorDotViewIfNeeded;	// IMP=0x00000000001b748b
- (_Bool)shouldShowCallout;	// IMP=0x00000000001b7340
...
- (_Bool)_balloonCalloutShouldOriginateFromSmallSize:(double *)arg1;	// IMP=0x00000000001b7245
@property(readonly, nonatomic, getter=_balloonCalloutStyle) long long balloonCalloutStyle;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000001b711a
- (void)_resolveBalloonAttributesIfNecessary;	// IMP=0x00000000001b6527
- (void)prepareForReuse;	// IMP=0x00000000001b6466
- (id)initWithAnnotation:(id)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000000001b640a
