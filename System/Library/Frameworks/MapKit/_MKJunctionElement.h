...
- (struct CGPoint)rightEdgePointAtDistanceFromBase:(double)arg1;	// IMP=0x00000000002933a8
- (struct CGPoint)leftEdgePointAtDistanceFromBase:(double)arg1;	// IMP=0x000000000029333c
