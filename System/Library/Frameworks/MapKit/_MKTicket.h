...
- (void).cxx_destruct;	// IMP=0x00000000000fa930
...
- (void)applyToPlaceInfo:(id)arg1;	// IMP=0x00000000000fa623
- (void)applyToCorrectedSearch:(id)arg1;	// IMP=0x00000000000fa60d
@property(readonly, nonatomic) GEOMapServiceTraits *traits;
- (void)cancel;	// IMP=0x00000000000fa5e1
- (void)submitWithHandler:(CDUnknownBlockType)arg1 timeout:(long long)arg2 queue:(id)arg3 networkActivity:(CDUnknownBlockType)arg4;	// IMP=0x00000000000fa1aa
- (void)submitWithHandler:(CDUnknownBlockType)arg1 queue:(id)arg2 networkActivity:(CDUnknownBlockType)arg3;	// IMP=0x00000000000fa190
- (void)submitWithRefinedHandler:(CDUnknownBlockType)arg1 networkActivity:(CDUnknownBlockType)arg2;	// IMP=0x00000000000fa179
- (void)submitWithHandler:(CDUnknownBlockType)arg1 networkActivity:(CDUnknownBlockType)arg2;	// IMP=0x00000000000fa133
- (void)submitWithRefinedHandler:(CDUnknownBlockType)arg1 timeout:(long long)arg2 networkActivity:(CDUnknownBlockType)arg3;	// IMP=0x00000000000f98cc
- (void)submitWithHandler:(CDUnknownBlockType)arg1 timeout:(long long)arg2 networkActivity:(CDUnknownBlockType)arg3;	// IMP=0x00000000000f9879
@property(readonly, copy) NSString *description;
- (id)initWithTicket:(id)arg1;	// IMP=0x00000000000f9775
