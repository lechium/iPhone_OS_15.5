...
- (void).cxx_destruct;	// IMP=0x00000000000c9590
@property(nonatomic, getter=isActive) _Bool active; // @synthesize active=_active;
@property(nonatomic) double zoomFraction; // @synthesize zoomFraction=_zoomFraction;
- (void)updateConstraints;	// IMP=0x00000000000c8806
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x00000000000c87b4
- (void)didMoveToWindow;	// IMP=0x00000000000c866b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000c7806
