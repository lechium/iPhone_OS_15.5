...
- (void).cxx_destruct;	// IMP=0x00000000001c630e
...
- (void)reset;	// IMP=0x00000000001c5fd3
- (_Bool)_shiftLocationOfStrings:(id)arg1 startingAtIndex:(unsigned long long)arg2 shiftValue:(long long)arg3;	// IMP=0x00000000001c5ef2
- (_Bool)replaceSeparatorAtIndex:(unsigned long long)arg1 withString:(id)arg2;	// IMP=0x00000000001c5bb9
- (id)initWithMultiPartString:(id)arg1;	// IMP=0x00000000001c5678
