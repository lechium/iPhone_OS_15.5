...
- (double)pointOffsetForDistanceOffset:(double)arg1;	// IMP=0x0000000000114117
- (struct CGPoint)pointInLayer:(id)arg1 bound:(struct CGRect)arg2;	// IMP=0x0000000000113fe5
- (CDStruct_c3b9c2ee)coordinate;	// IMP=0x0000000000113fc8
