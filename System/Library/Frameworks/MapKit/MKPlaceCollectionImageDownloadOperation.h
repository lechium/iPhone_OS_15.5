...
- (void).cxx_destruct;	// IMP=0x0000000000124845
...
- (void)cancel;	// IMP=0x00000000001246d6
- (_Bool)isFinished;	// IMP=0x00000000001246c6
- (_Bool)isExecuting;	// IMP=0x00000000001246b6
- (void)markOperationAsComplete;	// IMP=0x000000000012457e
- (void)main;	// IMP=0x0000000000123dc2
- (void)start;	// IMP=0x0000000000123d14
- (id)initWithUrl:(id)arg1 downloadCache:(id)arg2 cacheId:(id)arg3;	// IMP=0x0000000000123c20
