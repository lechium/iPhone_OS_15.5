...
- (void).cxx_destruct;	// IMP=0x000000000007fbcd
...
- (id)description;	// IMP=0x000000000007fae2
- (id)initWithAttributedString:(id)arg1 range:(struct _NSRange)arg2;	// IMP=0x000000000007fa49
