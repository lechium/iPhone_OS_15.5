...
- (void)setTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x000000000000769b
@property(retain, nonatomic) UIImage *icon;
@property(retain, nonatomic) NSString *seeMoreButtonText; // @synthesize seeMoreButtonText=_seeMoreButtonText;
- (void)updateConstraints;	// IMP=0x0000000000007162
- (void)updateContent;	// IMP=0x00000000000070c2
- (void)createConstraints;	// IMP=0x00000000000061b8
- (_Bool)shouldStack;	// IMP=0x0000000000005e49
- (void)_updateConstraints;	// IMP=0x0000000000005aac
- (void)contentSizeDidChange;	// IMP=0x0000000000005a9b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000057e4
