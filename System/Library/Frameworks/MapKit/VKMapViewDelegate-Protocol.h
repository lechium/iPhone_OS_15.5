...
@class NSError, NSString, VKARWalkingElevationRequestFailureInfo, VKARWalkingFeatureDidUpdateInfo, VKARWalkingFeatureSet, VKLabelMarker, VKMapView, VKMuninJunction, VKMuninRoad, VKVenueBuildingFeatureMarker, VKVenueFeatureMarker;
