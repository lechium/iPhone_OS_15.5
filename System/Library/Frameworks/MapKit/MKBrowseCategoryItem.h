...
- (void).cxx_destruct;	// IMP=0x0000000000263293
...
- (id)imageWithSearchCategory:(id)arg1 nightMode:(_Bool)arg2;	// IMP=0x00000000002631b9
- (id)initWithCategory:(id)arg1 nightMode:(_Bool)arg2;	// IMP=0x00000000002630d3
