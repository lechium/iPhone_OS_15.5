...
- (void).cxx_destruct;	// IMP=0x00000000001ef345
...
- (id)_legendStringForDistanceString:(id)arg1 appendUnits:(_Bool)arg2 index:(int)arg3;	// IMP=0x00000000001ef15f
@property(readonly, nonatomic) NSString *zeroUnitsString; // @synthesize zeroUnitsString=_zeroUnitsString;
- (id)_uncachedLegendStringsForDistanceString:(id)arg1;	// IMP=0x00000000001eee83
...
- (_Bool)canDisplaySegment:(unsigned long long)arg1;	// IMP=0x00000000001ee8e9
- (void)_calculateLegend:(_Bool)arg1;	// IMP=0x00000000001ee173
- (void)setUnits:(id)arg1;	// IMP=0x00000000001edf1d
- (double)_widthForString:(id)arg1 attributes:(id)arg2;	// IMP=0x00000000001ede14
- (void)clearCaches:(id)arg1;	// IMP=0x00000000001eddf7
- (id)init;	// IMP=0x00000000001edbf1
