...
+ (id)markerStyleForTraitCollection:(id)arg1 state:(long long)arg2 styleAttributes:(id)arg3 coordinate:(struct CLLocationCoordinate2D)arg4;	// IMP=0x000000000003953a
- (void).cxx_destruct;	// IMP=0x0000000000039da7
