...
- (void).cxx_destruct;	// IMP=0x00000000000d5dfe
...
- (void)keyUp:(id)arg1;	// IMP=0x00000000000d5d00
- (void)keyDown:(id)arg1;	// IMP=0x00000000000d5c00
- (void)handleArrowMask:(long long)arg1;	// IMP=0x00000000000d5b43
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000d5a5b
