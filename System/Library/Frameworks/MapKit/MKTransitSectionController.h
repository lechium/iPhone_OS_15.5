...
- (void).cxx_destruct;	// IMP=0x00000000000acccc
...
- (void)_buildRows;	// IMP=0x00000000000acc4e
- (void)_setNeedsBuildRows;	// IMP=0x00000000000acc44
- (_Bool)_needsBuildRows;	// IMP=0x00000000000acc3b
- (id)linesToShow;	// IMP=0x00000000000acc02
- (_Bool)hasFilteredLines;	// IMP=0x00000000000acbc9
- (_Bool)hasFilteredRows;	// IMP=0x00000000000acb87
- (unsigned long long)numberOfRows;	// IMP=0x00000000000acb52
- (void)incrementPagingFilter;	// IMP=0x00000000000acaf8
- (id)initWithMapItem:(id)arg1 system:(id)arg2;	// IMP=0x00000000000ac923
- (id)init;	// IMP=0x00000000000ac8f9
