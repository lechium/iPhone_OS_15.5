...
- (void).cxx_destruct;	// IMP=0x0000000000127eb7
- (_Bool)isHighlighted;	// IMP=0x0000000000127ea7
@property(readonly, nonatomic) UIImageView *imageView; // @synthesize imageView=_imageView;
@property(readonly, nonatomic) _MKUILabel *titleLabel; // @synthesize titleLabel=_titleLabel;
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000127de9
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000127dd4
@property(retain, nonatomic) UIImage *image;
@property(retain, nonatomic) NSString *title;
- (void)updateConstraints;	// IMP=0x0000000000127a91
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000127a22
- (void)setTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000127969
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000127560
