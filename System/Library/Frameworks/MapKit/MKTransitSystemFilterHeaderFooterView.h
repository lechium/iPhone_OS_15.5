...
- (void).cxx_destruct;	// IMP=0x00000000001cc9ef
@property(readonly, nonatomic) MKTransitSystemFilterView *filterView; // @synthesize filterView=_filterView;
@property(retain, nonatomic) NSString *titleText;
- (void)_contentSizeDidChange;	// IMP=0x00000000001cc911
- (void)_setupConstraints;	// IMP=0x00000000001cc48b
- (void)_setupSubviews;	// IMP=0x00000000001cc2d3
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001cc261
