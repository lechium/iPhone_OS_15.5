...
{
    _Bool _supportsComplicationForegroundModifier;	// 8 = 0x8
}

+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000024d4d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000024d2a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000024cbb
