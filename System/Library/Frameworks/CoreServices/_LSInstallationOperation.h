...
- (void).cxx_destruct;	// IMP=0x000000000013df51
...
- (id)redactedDescription;	// IMP=0x000000000013dede
- (id)description;	// IMP=0x000000000013de90
- (id)initWithBundleID:(id)arg1 installType:(long long)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000000013dddc
