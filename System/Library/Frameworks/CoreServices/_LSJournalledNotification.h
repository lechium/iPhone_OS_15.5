...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000149a5c
- (void).cxx_destruct;	// IMP=0x0000000000149d2f
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000149bb3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000149b12
- (id)initWithNotification:(int)arg1 bundleIDs:(id)arg2 plugins:(_Bool)arg3 options:(id)arg4;	// IMP=0x0000000000149a64
