...
+ (_Bool)canHandleURLComponents:(id)arg1;	// IMP=0x0000000000046e68
+ (id)plugInClasses;	// IMP=0x0000000000046dfc
- (void).cxx_destruct;	// IMP=0x000000000004710e
...
- (id)appLinksWithContext:(struct LSContext *)arg1 error:(id *)arg2;	// IMP=0x0000000000047065
