...
- (void).cxx_destruct;	// IMP=0x00000000000445a9
...
- (id)eventsFromResult:(id)arg1;	// IMP=0x000000000004362f
- (id)initWithContactStore:(id)arg1 additionalContactKeyDescriptors:(id)arg2;	// IMP=0x0000000000043561
