...
- (void).cxx_destruct;	// IMP=0x000000000006033c
...
- (id)indexPathForContainerInstance:(id)arg1;	// IMP=0x000000000006026d
- (id)indexPathForGroupInstance:(id)arg1;	// IMP=0x0000000000060257
- (id)indexPathForContactInstance:(id)arg1;	// IMP=0x0000000000060241
- (void)_populateSaveRequestIndexTables;	// IMP=0x000000000005fdd1
- (void)dealloc;	// IMP=0x000000000005fd92
@property(readonly, nonatomic) void *addressBook;
- (id)initWithSaveRequest:(id)arg1 response:(id)arg2 addressBook:(void *)arg3;	// IMP=0x000000000005fb9e
