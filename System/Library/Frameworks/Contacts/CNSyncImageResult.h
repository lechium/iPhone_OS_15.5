...
- (void).cxx_destruct;	// IMP=0x000000000011ae15
...
- (id)initWithType:(unsigned long long)arg1 imageData:(id)arg2 cropRect:(struct CGRect)arg3 imageHash:(id)arg4;	// IMP=0x000000000011ad1b
