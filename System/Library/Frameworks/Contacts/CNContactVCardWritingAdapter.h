...
+ (id)descriptorForAllSupportedKeys;	// IMP=0x00000000000abd70
+ (id)adapterWithContact:(id)arg1;	// IMP=0x00000000000abd27
- (void).cxx_destruct;	// IMP=0x00000000000ad0f6
...
- (id)largeImageHashOfType:(id)arg1;	// IMP=0x00000000000acefd
...
- (id)vCardPropertyItemsForProperty:(id)arg1 valueTransform:(CDUnknownBlockType)arg2;	// IMP=0x00000000000acbc6
- (id)vCardPropertyItemsForProperty:(id)arg1;	// IMP=0x00000000000acbb2
...
- (id)initWithContact:(id)arg1;	// IMP=0x00000000000ac0a3
