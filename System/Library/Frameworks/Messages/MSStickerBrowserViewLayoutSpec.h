...
+ (id)specWithSizeClass:(long long)arg1 interfaceOrientation:(long long)arg2;	// IMP=0x0000000000010ef9
...
- (id)initWithSize:(long long)arg1 interfaceOrientation:(long long)arg2;	// IMP=0x0000000000010fcd
