...
- (void).cxx_destruct;	// IMP=0x00000000000abaab
...
- (void)actionSheetPresentationControllerDidDismissActionSheet:(id)arg1;	// IMP=0x00000000000ab9e7
- (id)presentedViewController;	// IMP=0x00000000000ab9d5
- (id)presentationControllerForPresentedViewController:(id)arg1 presentingViewController:(id)arg2 sourceViewController:(id)arg3;	// IMP=0x00000000000ab846
- (void)prepareForPresentationOfController:(id)arg1;	// IMP=0x00000000000ab7df
