...
- (void).cxx_destruct;	// IMP=0x0000000000181f66
...
- (void)setupConstraints;	// IMP=0x000000000018190b
- (void)setupAvatar;	// IMP=0x0000000000181796
- (void)setupNameLabel;	// IMP=0x0000000000181539
- (id)initWithName:(id)arg1;	// IMP=0x00000000001813da
