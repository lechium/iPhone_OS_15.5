...
+ (id)gameCenterConfiguration;	// IMP=0x00000000001ce36f
+ (id)contactsConfiguration;	// IMP=0x00000000001ce31b
+ (id)defaultConfiguration;	// IMP=0x00000000001ce309
