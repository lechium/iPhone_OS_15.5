...
+ (double)actionsLeftMargin;	// IMP=0x000000000016ed95
- (void).cxx_destruct;	// IMP=0x000000000016ec7f
...
- (void)_updateActionsMask;	// IMP=0x000000000016e974
- (CDUnknownBlockType)completionBlockForHidingActions;	// IMP=0x000000000016e8b1
- (CDUnknownBlockType)animationBlockForPreparingToShowActions;	// IMP=0x000000000016e2ea
@property(retain, nonatomic) CNContact *contact;
- (void)updateConstraints;	// IMP=0x000000000016d7f7
- (void)_createViewsIfNeeded;	// IMP=0x000000000016d4d6
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x000000000016d4c0
