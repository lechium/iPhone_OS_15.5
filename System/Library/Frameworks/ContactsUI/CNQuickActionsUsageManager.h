...
+ (_Bool)sortUsingCoreDuetAvailable;	// IMP=0x00000000001b275a
+ (id)managerForContact:(id)arg1;	// IMP=0x00000000001b2681
- (void).cxx_destruct;	// IMP=0x00000000001b2526
...
- (id)sortedActions:(id)arg1;	// IMP=0x00000000001b22db
- (void)_updateDuetInteractionsIfNeeded;	// IMP=0x00000000001b22d5
- (void)updateCachedEnabledStateForAction:(id)arg1;	// IMP=0x00000000001b222c
- (void)cacheEnabledStateForAction:(id)arg1;	// IMP=0x00000000001b2178
- (double)scoreForAction:(id)arg1;	// IMP=0x00000000001b20c4
- (void)actionPerformed:(id)arg1;	// IMP=0x00000000001b2034
- (id)init;	// IMP=0x00000000001b1f37
