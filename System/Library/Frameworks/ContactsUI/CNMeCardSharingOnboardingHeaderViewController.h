...
+ (double)heightForHeaderWithContainerSize:(struct CGSize)arg1 withTitle:(id)arg2 layoutAttributes:(id)arg3 hasAvatar:(_Bool)arg4;	// IMP=0x000000000018ae64
- (void).cxx_destruct;	// IMP=0x000000000018ae11
...
- (void)viewWillLayoutSubviews;	// IMP=0x000000000018a96a
- (void)viewDidLoad;	// IMP=0x000000000018a7a6
- (id)initWithAvatarCarouselViewController:(id)arg1 headerTitle:(id)arg2 layoutAttributes:(id)arg3;	// IMP=0x000000000018a6ce
