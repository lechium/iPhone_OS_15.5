...
- (void).cxx_destruct;	// IMP=0x000000000015f03f
...
- (void)onLongPress:(id)arg1;	// IMP=0x000000000015ecbd
- (void)performAction;	// IMP=0x000000000015ebe0
- (void)updateConstraints;	// IMP=0x000000000015e7cc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000015e209
