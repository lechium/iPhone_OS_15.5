...
+ (id)cellNibForContacts;	// IMP=0x00000000000aacb0
+ (id)cellNibForActions;	// IMP=0x00000000000aac4d
- (void).cxx_destruct;	// IMP=0x00000000000aa9d7
...
- (void)trackHighlight:(id)arg1;	// IMP=0x00000000000aa552
- (void)stopTrackingWithGestureRecognizer:(id)arg1;	// IMP=0x00000000000aa530
- (void)startTrackingWithGestureRecognizer:(id)arg1;	// IMP=0x00000000000aa4bd
- (void)reloadData;	// IMP=0x00000000000a9abd
- (void)_updateHighlightAnimated:(_Bool)arg1;	// IMP=0x00000000000a9948
- (void)prepareForReuse;	// IMP=0x00000000000a98d2
- (void)setHighlighted:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000a9887
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000a9870
- (void)awakeFromNib;	// IMP=0x00000000000a96c3
- (void)_updateFonts;	// IMP=0x00000000000a9573
