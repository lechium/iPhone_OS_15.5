...
- (void).cxx_destruct;	// IMP=0x000000000004cfa6
...
- (id)initWithTitle:(id)arg1;	// IMP=0x000000000004ced3
- (id)initWithImageInsetPercentage:(double)arg1 imageProvider:(CDUnknownBlockType)arg2;	// IMP=0x000000000004ce3a
