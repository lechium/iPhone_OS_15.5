...
- (void).cxx_destruct;	// IMP=0x00000000001518f9
...
- (id)initWithLabel:(id)arg1 accessoryView:(id)arg2 confirmationHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001517f0
- (id)initWithLabel:(id)arg1 accessoryView:(id)arg2;	// IMP=0x00000000001517db
