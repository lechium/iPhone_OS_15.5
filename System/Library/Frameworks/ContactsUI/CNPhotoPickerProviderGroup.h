...
+ (id)addItemsGroupWithProviders:(id)arg1 environment:(id)arg2;	// IMP=0x000000000001562c
+ (id)emojiGroupWithProviders:(id)arg1 environment:(id)arg2 allowAddItem:(_Bool)arg3;	// IMP=0x00000000000155ad
+ (id)animojiGroupWithProviders:(id)arg1 environment:(id)arg2 allowAddItem:(_Bool)arg3;	// IMP=0x000000000001552e
+ (id)suggestionsGroupWithProviders:(id)arg1 environment:(id)arg2 allowAddItem:(_Bool)arg3;	// IMP=0x00000000000154af
+ (id)injectedItemsGroupWithEnvironment:(id)arg1;	// IMP=0x0000000000015462
- (void).cxx_destruct;	// IMP=0x0000000000014d13
...
- (void)providerItemDidUpdate:(id)arg1;	// IMP=0x0000000000014afd
- (_Bool)hasAddedProviderItems;	// IMP=0x0000000000014aac
- (void)removeAllAddedProviderItems;	// IMP=0x0000000000014a75
- (long long)removeProviderItem:(id)arg1;	// IMP=0x0000000000014697
- (long long)addProviderItem:(id)arg1;	// IMP=0x000000000001455c
- (id)providerItemAtIndex:(long long)arg1;	// IMP=0x00000000000144e2
- (long long)numberOfItems;	// IMP=0x000000000001449e
- (void)prepareDisplayItems:(id)arg1;	// IMP=0x00000000000143d6
- (void)reloadDisplayItemsNotifyDelegate:(_Bool)arg1;	// IMP=0x00000000000141d9
- (id)itemsForProviderIdentifier:(id)arg1;	// IMP=0x0000000000014156
- (id)suggestionsProviderPrecedingFacesProvider;	// IMP=0x0000000000014034
- (void)loadProvidersItemsForSize:(struct CGSize)arg1 itemsPerRow:(double)arg2 scale:(double)arg3 RTL:(_Bool)arg4;	// IMP=0x0000000000013ee0
- (id)initWithProviders:(id)arg1 groupType:(long long)arg2 environment:(id)arg3 allowAddItem:(_Bool)arg4;	// IMP=0x0000000000013d17
