...
- (void).cxx_destruct;	// IMP=0x0000000000149c59
...
- (id)loadItemsForSize:(struct CGSize)arg1 scale:(double)arg2 RTL:(_Bool)arg3 renderingQueue:(id)arg4 callbackQueue:(id)arg5 itemDelegate:(id)arg6;	// IMP=0x000000000014999c
- (id)initWithVisualIdentity:(id)arg1;	// IMP=0x00000000001498b3
