...
+ (id)builderWithVisualIdentity:(id)arg1 avatarStore:(id)arg2 environment:(id)arg3 contactViewCache:(id)arg4 photoPickerConfiguration:(id)arg5;	// IMP=0x0000000000164aa0
- (void).cxx_destruct;	// IMP=0x0000000000164a62
...
- (id)build;	// IMP=0x0000000000164750
- (id)emojiContentGroup;	// IMP=0x0000000000164628
- (id)animojiContentGroup;	// IMP=0x00000000001644d3
- (id)photoContentGroup;	// IMP=0x000000000016425c
- (id)injectedItemsGroup;	// IMP=0x00000000001641f9
- (id)addItemsContentGroup;	// IMP=0x0000000000164096
@property(readonly, nonatomic) _Bool includesAnyPhotoContent;
- (id)initWithVisualIdentity:(id)arg1 avatarStore:(id)arg2 environment:(id)arg3 contactViewCache:(id)arg4;	// IMP=0x0000000000163f1b
