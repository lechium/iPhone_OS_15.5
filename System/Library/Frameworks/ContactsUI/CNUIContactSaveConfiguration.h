...
- (void).cxx_destruct;	// IMP=0x0000000000062a6e
...
- (id)copyWithEditingLinkedContacts:(id)arg1;	// IMP=0x000000000006287e
- (id)initWithContact:(id)arg1 mutableContact:(id)arg2 shadowCopyOfReadonlyContact:(id)arg3 editingLinkedContacts:(id)arg4 contactStore:(id)arg5 parentGroup:(id)arg6 parentContainer:(id)arg7 containerContext:(id)arg8 ignoresParentalRestrictions:(_Bool)arg9 saveWasAuthorized:(_Bool)arg10;	// IMP=0x00000000000626fe
