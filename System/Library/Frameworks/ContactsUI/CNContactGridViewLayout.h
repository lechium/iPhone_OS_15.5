...
- (void).cxx_destruct;	// IMP=0x0000000000161377
...
- (CDUnknownBlockType)_animationForReusableView:(id)arg1 toLayoutAttributes:(id)arg2 type:(unsigned long long)arg3;	// IMP=0x00000000001611ea
- (void)_updateLayoutMetrics;	// IMP=0x0000000000160803
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000160560
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x0000000000160236
- (void)prepareForCollectionViewUpdates:(id)arg1;	// IMP=0x0000000000160207
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000160132
