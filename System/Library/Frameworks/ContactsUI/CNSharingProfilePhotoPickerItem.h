...
- (void).cxx_destruct;	// IMP=0x0000000000154e86
...
- (id)compositeImageWithSize:(struct CGSize)arg1;	// IMP=0x0000000000154dcd
- (id)originalImageWithSize:(struct CGSize)arg1;	// IMP=0x0000000000154d30
