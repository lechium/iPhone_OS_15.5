...
- (void).cxx_destruct;	// IMP=0x0000000000064ce3
...
- (void)prepareForReuse;	// IMP=0x0000000000064c2f
@property(readonly, nonatomic) UIContextMenuInteraction *contextMenuInteraction;
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000006465b
