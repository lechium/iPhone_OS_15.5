...
- (void).cxx_destruct;	// IMP=0x00000000001686fc
...
- (void)cancel;	// IMP=0x0000000000167f6d
- (id)initWithPropertyItems:(id)arg1 service:(id)arg2 idsAvailabilityProvider:(id)arg3 schedulerProvider:(id)arg4;	// IMP=0x0000000000167bfa
- (id)initWithPropertyItems:(id)arg1 service:(id)arg2;	// IMP=0x0000000000167b19
