...
+ (id)propertyTransportButtonWithDelegate:(id)arg1;	// IMP=0x000000000010283b
+ (id)quickActionButtonWithDelegate:(id)arg1;	// IMP=0x000000000010258f
- (void).cxx_destruct;	// IMP=0x0000000000102483
...
- (void)stateUpdated;	// IMP=0x0000000000101b6e
- (void)updateForFocusedState:(_Bool)arg1;	// IMP=0x0000000000101b40
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000101a94
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000001019ee
- (void)notifyDelegateAboutUserChoice;	// IMP=0x0000000000101983
- (void)choose;	// IMP=0x0000000000101971
- (void)deselect;	// IMP=0x0000000000101941
- (void)select;	// IMP=0x00000000001018f5
- (void)clickGestureDidUpdate:(id)arg1;	// IMP=0x0000000000101870
- (void)actionViewTouchUp:(id)arg1;	// IMP=0x000000000010185e
- (void)actionViewTouchDown:(id)arg1;	// IMP=0x000000000010184c
- (void)actionViewTapped:(id)arg1;	// IMP=0x000000000010183a
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000101828
- (_Bool)canBecomeFocused;	// IMP=0x0000000000101816
- (void)setupClickGestureRecognizer;	// IMP=0x0000000000101791
- (void)setupConstraints;	// IMP=0x0000000000101218
- (void)setupButton;	// IMP=0x0000000000100f91
- (void)setupLabel;	// IMP=0x0000000000100ecd
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000100e4f
