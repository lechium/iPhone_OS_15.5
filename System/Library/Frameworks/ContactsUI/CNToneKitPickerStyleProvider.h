...
- (id)newAccessoryDisclosureIndicatorViewForVibrationPickerCell;	// IMP=0x00000000001b16ef
- (id)newBackgroundViewForSelectedVibrationPickerCell:(_Bool)arg1;	// IMP=0x00000000001b16dd
...
- (id)newAccessoryDisclosureIndicatorViewForTonePickerCell;	// IMP=0x00000000001b13c2
- (id)newBackgroundViewForSelectedTonePickerCell:(_Bool)arg1;	// IMP=0x00000000001b12b3
