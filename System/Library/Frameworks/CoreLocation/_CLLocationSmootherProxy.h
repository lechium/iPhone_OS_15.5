...
- (void)createConnection;	// IMP=0x000000000002d37b
- (void)didSmoothLocations:(id)arg1 ofType:(id)arg2;	// IMP=0x000000000002d2b6
- (void)dealloc;	// IMP=0x000000000002d227
- (id)initWithCLLocationSmoother:(id)arg1;	// IMP=0x000000000002d11e
