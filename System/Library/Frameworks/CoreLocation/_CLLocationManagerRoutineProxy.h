...
- (void)createConnection;	// IMP=0x000000000000b8eb
- (void)didUpdateLocations:(id)arg1 withReply:(CDUnknownBlockType)arg2;	// IMP=0x000000000000b5e2
- (void)didUpdateLocations:(id)arg1;	// IMP=0x000000000000b343
- (void)dealloc;	// IMP=0x000000000000b29a
- (id)initWithQueue:(id)arg1 locationManagerRoutine:(id)arg2;	// IMP=0x000000000000b0db
