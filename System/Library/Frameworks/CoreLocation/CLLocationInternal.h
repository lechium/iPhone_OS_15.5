...
- (void)dealloc;	// IMP=0x000000000006e74e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006e611
- (id)initWithClientLocation:(CDStruct_2fb123db)arg1 matchInfo:(id)arg2 trustedTimestamp:(double)arg3 groundAltitude:(id)arg4 fusionInfo:(id)arg5 rawHorizontalAccuracy:(double)arg6 rawAltitude:(double)arg7 rawVerticalAccuracy:(double)arg8 rawCourseAccuracy:(double)arg9 positionContextStateType:(int)arg10 probabilityPositionContextStateIndoor:(double)arg11 probabilityPositionContextStateOutdoor:(double)arg12 gnssOdometerInfo:(id)arg13 coarseMetaData:(id)arg14;	// IMP=0x000000000006e4c6
- (id)initWithClientLocation:(CDStruct_2fb123db)arg1 matchInfo:(id)arg2 trustedTimestamp:(double)arg3 groundAltitude:(id)arg4 fusionInfo:(id)arg5 rawHorizontalAccuracy:(double)arg6 rawAltitude:(double)arg7 rawVerticalAccuracy:(double)arg8 rawCourseAccuracy:(double)arg9 positionContextStateType:(int)arg10 probabilityPositionContextStateIndoor:(double)arg11 probabilityPositionContextStateOutdoor:(double)arg12 gnssOdometerInfo:(id)arg13;	// IMP=0x000000000006e46a
- (id)initWithClientLocation:(CDStruct_2fb123db)arg1 matchInfo:(id)arg2 trustedTimestamp:(double)arg3 groundAltitude:(id)arg4;	// IMP=0x000000000006e3ff
- (id)initWithClientLocation:(CDStruct_2fb123db)arg1 clientLocationPrivate:(CDStruct_d25f1cbc)arg2 coarseMetaData:(id)arg3;	// IMP=0x000000000006e38b
- (id)initWithClientLocation:(CDStruct_2fb123db)arg1 clientLocationPrivate:(CDStruct_d25f1cbc)arg2;	// IMP=0x000000000006e11e
- (id)initWithClientLocation:(CDStruct_2fb123db)arg1 coarseMetaData:(id)arg2;	// IMP=0x000000000006e0c1
- (id)initWithClientLocation:(CDStruct_2fb123db)arg1;	// IMP=0x000000000006e014
