...
- (void)dealloc;	// IMP=0x000000000001027c
- (void)invalidate;	// IMP=0x0000000000010267
- (void)performCourtesyPromptIfNeeded;	// IMP=0x000000000001022e
- (void)cancelLingeringRangingRequest;	// IMP=0x00000000000101f7
- (_Bool)hasLingeringRangingRequest;	// IMP=0x0000000000010102
- (void)cancelRangingRequest;	// IMP=0x00000000000100a1
- (void)cancelLocationRequest;	// IMP=0x000000000001005e
- (void)stopUpdatingLocationAutoPaused;	// IMP=0x000000000001001d
- (_Bool)showsBackgroundLocationIndicator;	// IMP=0x0000000000010007
- (void)setShowsBackgroundLocationIndicator:(_Bool)arg1;	// IMP=0x000000000000ffd9
- (_Bool)allowsBackgroundLocationUpdates;	// IMP=0x000000000000ffc3
- (void)setAllowsBackgroundLocationUpdates:(_Bool)arg1;	// IMP=0x000000000000ff95
- (int)PausesLocationUpdatesAutomatically;	// IMP=0x000000000000ff7f
- (void)setPausesLocationUpdatesAutomatically:(int)arg1;	// IMP=0x000000000000ff37
- (id)initWithInfo:(id)arg1 bundleIdentifier:(id)arg2 bundle:(id)arg3 delegate:(id)arg4 silo:(id)arg5;	// IMP=0x000000000000fcb7
