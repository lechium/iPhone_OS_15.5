...
- (void).cxx_destruct;	// IMP=0x0000000000117257
...
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000116a67
- (id)featureValueFromDetectionPrint:(id)arg1 featureName:(id)arg2;	// IMP=0x0000000000116830
- (id)initWithModelDescription:(id)arg1 parameterDictionary:(id)arg2 error:(id *)arg3;	// IMP=0x000000000011598e
