...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000252c9
- (_Bool)hasGPUSupport;	// IMP=0x00000000000252c1
- (id)initWithParameters:(id)arg1;	// IMP=0x0000000000024ffc
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000248a8
