...
- (void).cxx_destruct;	// IMP=0x000000000001ecf6
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000001e32f
- (_Bool)hasGPUSupport;	// IMP=0x000000000001e327
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000001e0e6
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000001ddc5
