...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000006ee4f
- (_Bool)hasGPUSupport;	// IMP=0x000000000006ee47
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000006ed0e
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000006ecf8
