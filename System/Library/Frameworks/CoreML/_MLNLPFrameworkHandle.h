...
+ (id)sharedHandle;	// IMP=0x000000000012880d
...
- (id)predictVectorForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001285d2
- (id)predictLabelForWordString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000128483
- (id)predictLabelsForSentenceString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000128337
- (id)predictTokensLabelsLocationsLengthsForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001281eb
- (const void *)initializeEmbeddingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001281a3
- (const void *)initializeGazetteerModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000012815e
- (const void *)initializeSentenceClassifierModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000128119
- (const void *)initializeWordTaggingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001280d4
- (id)init;	// IMP=0x0000000000127e24
