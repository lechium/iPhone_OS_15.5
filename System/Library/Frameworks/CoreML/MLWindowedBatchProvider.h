...
- (void).cxx_destruct;	// IMP=0x00000000001308a2
...
- (id)featuresAtIndex:(long long)arg1;	// IMP=0x0000000000130842
@property(readonly, nonatomic) long long count;
- (id)initWithBatch:(id)arg1 startIndex:(long long)arg2 windowLength:(long long)arg3 error:(id *)arg4;	// IMP=0x0000000000130687
