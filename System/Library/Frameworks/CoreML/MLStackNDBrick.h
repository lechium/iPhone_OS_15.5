...
- (void).cxx_destruct;	// IMP=0x0000000000027a9b
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x0000000000027452
- (_Bool)hasGPUSupport;	// IMP=0x000000000002744a
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000271dd
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x0000000000026e37
