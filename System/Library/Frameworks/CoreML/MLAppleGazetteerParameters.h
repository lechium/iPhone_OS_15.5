...
- (void).cxx_destruct;	// IMP=0x000000000002a4a5
...
- (id)initWithData:(unsigned long long)arg1 language:(id)arg2 inputFeatureName:(id)arg3 outputFeatureName:(id)arg4 modelData:(id)arg5 labelNames:(id)arg6 metadata:(id)arg7 error:(id *)arg8;	// IMP=0x000000000002a21a
