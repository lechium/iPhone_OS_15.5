...
- (void).cxx_destruct;	// IMP=0x00000000000a155a
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000a135b
- (_Bool)hasGPUSupport;	// IMP=0x00000000000a1353
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000a121a
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000a1204
