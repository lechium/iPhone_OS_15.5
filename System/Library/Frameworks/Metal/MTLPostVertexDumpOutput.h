...
- (id)description;	// IMP=0x0000000000099ebe
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x0000000000099cd9
- (void)dealloc;	// IMP=0x0000000000099c8f
- (id)initWithAirMDType:(id)arg1 dataType:(unsigned long long)arg2 pixelFormat:(unsigned long long)arg3 aluType:(unsigned long long)arg4 name:(id)arg5 offset:(unsigned long long)arg6;	// IMP=0x0000000000099c07
