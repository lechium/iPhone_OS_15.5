...
- (id)description;	// IMP=0x0000000000035106
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x0000000000034f9d
- (id)describe;	// IMP=0x0000000000034f10
- (void)dealloc;	// IMP=0x0000000000034ec9
- (id)initWithValue:(const void *)arg1 type:(unsigned long long)arg2 index:(unsigned long long)arg3;	// IMP=0x0000000000034e4b
