...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b02c9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b0293
- (id)initWithBindIndex:(unsigned long long)arg1;	// IMP=0x00000000000b025b
