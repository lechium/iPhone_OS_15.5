...
- (void).cxx_destruct;	// IMP=0x0000000000092f2b
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000092e1b
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000092d44
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000092d2d
