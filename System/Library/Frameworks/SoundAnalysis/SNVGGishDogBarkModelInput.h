...
- (void).cxx_destruct;	// IMP=0x000000000008d481
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000008d371
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000008d29a
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000008d283
