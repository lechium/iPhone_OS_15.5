...
- (void).cxx_destruct;	// IMP=0x000000000009aa79
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000009a969
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000009a892
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000009a87b
