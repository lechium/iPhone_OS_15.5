...
- (void).cxx_destruct;	// IMP=0x000000000008fec0
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000008fdb0
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000008fcd9
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000008fcc2
