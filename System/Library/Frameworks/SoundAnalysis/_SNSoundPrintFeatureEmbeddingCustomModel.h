...
- (void).cxx_destruct;	// IMP=0x0000000000078931
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000007883b
- (id)initWithModel:(id)arg1 modelDescription:(id)arg2;	// IMP=0x0000000000078648
