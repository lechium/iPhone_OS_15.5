...
- (void).cxx_destruct;	// IMP=0x0000000000080c9b
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000080b8b
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000080ab4
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000080a9d
