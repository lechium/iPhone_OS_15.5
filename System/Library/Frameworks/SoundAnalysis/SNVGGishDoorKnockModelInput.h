...
- (void).cxx_destruct;	// IMP=0x000000000008ad86
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000008ac76
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000008ab9f
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000008ab88
