...
- (void).cxx_destruct;	// IMP=0x0000000000093ed5
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000093dc5
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000093cee
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000093cd7
