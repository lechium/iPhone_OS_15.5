...
- (void).cxx_destruct;	// IMP=0x000000000008ef16
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000008ee06
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000008ed2f
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000008ed18
