...
- (id).cxx_construct;	// IMP=0x00000000000199a9
- (void).cxx_destruct;	// IMP=0x0000000000019983
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000198ca
@property(readonly) MLModelDescription *modelDescription;
- (id)initWithModel:(id)arg1;	// IMP=0x00000000000197e9
