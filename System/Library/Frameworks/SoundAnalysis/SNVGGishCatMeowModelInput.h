...
- (void).cxx_destruct;	// IMP=0x000000000009596a
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000009585a
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000095783
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000009576c
