...
- (void).cxx_destruct;	// IMP=0x0000000000082bef
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000082adf
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x0000000000082a08
- (id)initWithInput1:(id)arg1;	// IMP=0x00000000000829f1
