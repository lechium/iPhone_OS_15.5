...
- (void).cxx_destruct;	// IMP=0x0000000000096914
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000096804
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000009672d
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000096716
