...
- (void).cxx_destruct;	// IMP=0x000000000008bde4
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000008bcfa
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWith_646:(id)arg1 classLabel:(id)arg2;	// IMP=0x000000000008bc41
