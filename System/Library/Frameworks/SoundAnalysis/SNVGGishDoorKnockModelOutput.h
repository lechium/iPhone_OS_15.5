...
- (void).cxx_destruct;	// IMP=0x000000000008aff8
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000008aebb
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput_1:(id)arg1 Confidence:(id)arg2 Detected:(id)arg3 detectedHistoryOut:(id)arg4;	// IMP=0x000000000008adb9
