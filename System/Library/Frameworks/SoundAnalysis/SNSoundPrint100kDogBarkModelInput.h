...
- (void).cxx_destruct;	// IMP=0x000000000008e32c
@property(retain, nonatomic) MLMultiArray *soundprint_Placeholder; // @synthesize soundprint_Placeholder=_soundprint_Placeholder;
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000008e2b8
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithSoundprint_Placeholder:(id)arg1;	// IMP=0x000000000008e22d
