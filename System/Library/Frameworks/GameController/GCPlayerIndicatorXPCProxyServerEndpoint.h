...
- (void).cxx_destruct;	// IMP=0x00000000000a6572
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000a64a6
- (void)invalidateConnection;	// IMP=0x00000000000a63f3
- (void)fetchPlayerIndexWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000a6347
- (void)newPlayerIndex:(long long)arg1;	// IMP=0x00000000000a6299
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000a5ea8
- (void)invalidateClient;	// IMP=0x00000000000a5de7
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(long long)arg1;	// IMP=0x00000000000a5d4d
- (id)initWithIdentifier:(id)arg1 initialValue:(long long)arg2;	// IMP=0x00000000000a5ccd
