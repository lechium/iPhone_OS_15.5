...
- (id)description;	// IMP=0x000000000000a820
...
- (void)cancel;	// IMP=0x000000000000a7cd
- (void)preprocessCommand:(const void *)arg1;	// IMP=0x000000000000a73d
- (id)initWithHapticCommand:(const void *)arg1;	// IMP=0x000000000000a64c
