...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000002267e
...
- (id)description;	// IMP=0x0000000000022544
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000022355
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x00000000000222c2
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x00000000000220d8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000227b8
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000022686
