...
- (void).cxx_destruct;	// IMP=0x0000000000083a4b
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000083989
- (void)invalidateConnection;	// IMP=0x00000000000838d6
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000083667
- (void)invalidateClient;	// IMP=0x00000000000835a6
- (void)triggerGameIntentWithEvent:(long long)arg1;	// IMP=0x0000000000083555
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)init;	// IMP=0x00000000000834c4
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000008344f
