...
- (void).cxx_destruct;	// IMP=0x000000000001c103
...
- (id)observeKeyboardEvents:(CDUnknownBlockType)arg1;	// IMP=0x000000000001bd36
- (void)dealloc;	// IMP=0x000000000001bcdd
- (id)init;	// IMP=0x000000000001bcb2
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x000000000001b999
