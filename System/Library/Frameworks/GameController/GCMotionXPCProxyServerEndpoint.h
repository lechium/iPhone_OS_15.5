...
- (void).cxx_destruct;	// IMP=0x000000000001e682
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000001e5b7
- (void)invalidateConnection;	// IMP=0x000000000001e504
- (void)fetchSensorsActiveWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000001e458
- (void)newSensorsActive:(_Bool)arg1;	// IMP=0x000000000001e3ae
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001dfbe
- (void)invalidateClient;	// IMP=0x000000000001defd
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(_Bool)arg1;	// IMP=0x000000000001de63
- (id)initWithIdentifier:(id)arg1 initialValue:(_Bool)arg2;	// IMP=0x000000000001dde3
