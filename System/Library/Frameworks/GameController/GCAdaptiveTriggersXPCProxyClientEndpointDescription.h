...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000000f851
- (void).cxx_destruct;	// IMP=0x000000000000fdb1
@property(readonly) id <NSObject><NSCopying><NSSecureCoding> identifier; // @synthesize identifier=_identifier;
- (id)materializeWithContext:(id)arg1;	// IMP=0x000000000000fab8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000fa4a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000f922
- (id)init;	// IMP=0x000000000000f8ff
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x000000000000f859
