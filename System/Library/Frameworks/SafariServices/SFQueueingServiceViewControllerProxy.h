...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000000c6408
- (void)forwardInvocation:(id)arg1;	// IMP=0x00000000000c6315
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x00000000000c62a5
- (id)initWithProtocol:(id)arg1;	// IMP=0x00000000000c608d
