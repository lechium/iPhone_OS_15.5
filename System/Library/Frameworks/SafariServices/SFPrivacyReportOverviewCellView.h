...
- (void).cxx_destruct;	// IMP=0x00000000000c84e2
...
- (void)_updateHairlinesIfNeeded;	// IMP=0x00000000000c7a89
- (void)_updateLayoutMargins;	// IMP=0x00000000000c79e7
- (void)willMoveToWindow:(id)arg1;	// IMP=0x00000000000c7909
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000c77f4
