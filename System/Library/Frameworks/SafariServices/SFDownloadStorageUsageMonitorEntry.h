...
- (void)updateWithDictionaryRepresentation:(id)arg1;	// IMP=0x000000000002fc0a
- (void)_updateProgressSubscriptionWithData:(id)arg1;	// IMP=0x000000000002f974
- (void)_didLoseProgress:(id)arg1;	// IMP=0x000000000002f7a3
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000002f719
- (void)_didGainProgress:(id)arg1;	// IMP=0x000000000002f668
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000002f5fb
