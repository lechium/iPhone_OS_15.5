...
- (void).cxx_destruct;	// IMP=0x000000000013933d
...
- (double)_iconWidth;	// IMP=0x0000000000139292
- (void)showPlaceholderImageForDomain:(id)arg1 backgroundColor:(id)arg2;	// IMP=0x0000000000138f31
- (void)setSavedAccount:(id)arg1;	// IMP=0x0000000000138f1d
@property(copy, nonatomic) NSString *subtitle;
@property(copy, nonatomic) NSString *title;
- (void)_hideButtonPressed:(id)arg1;	// IMP=0x0000000000138e1a
- (void)_createHideButton;	// IMP=0x00000000001389d3
- (void)setShowsHideButton:(_Bool)arg1;	// IMP=0x0000000000138848
- (void)setShowsUpgradeCompletionCheckmark:(_Bool)arg1;	// IMP=0x0000000000138676
- (void)showCheckmarkForDetailView;	// IMP=0x0000000000138566
@property(retain, nonatomic) UIImage *icon;
- (id)initWithConfiguration:(unsigned long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000013760e
