...
- (void).cxx_destruct;	// IMP=0x0000000000087064
@property(nonatomic) __weak id <SFSwitchTableViewCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_switchViewStateDidChange:(id)arg1;	// IMP=0x0000000000086f92
@property(nonatomic, getter=isSwitchOn) _Bool switchOn;
- (id)initWithReuseIdentifier:(id)arg1;	// IMP=0x0000000000086e6c
