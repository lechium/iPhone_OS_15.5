...
- (void).cxx_destruct;	// IMP=0x0000000000163ce4
...
- (void)_updateDocumentSizeLabel;	// IMP=0x0000000000163a6c
- (void)_updatePropertiesDefinedByContentSizeCategory;	// IMP=0x000000000016398d
- (void)_configureOrientationBasedConstraints:(long long)arg1;	// IMP=0x00000000001638f8
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000163833
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001630eb
