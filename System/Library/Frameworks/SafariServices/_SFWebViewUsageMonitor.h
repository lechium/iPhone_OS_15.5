...
- (void).cxx_destruct;	// IMP=0x00000000000a097d
...
- (void)checkURL:(id)arg1;	// IMP=0x00000000000a074d
- (void)auditUsageIfNeeded;	// IMP=0x00000000000a051a
@property(readonly, nonatomic) NSString *stringAsAuditKey;
@property(readonly, nonatomic) _Bool shouldAudit;
- (id)initWithHostAppIdentifier:(id)arg1;	// IMP=0x00000000000a03ae
