...
- (void).cxx_destruct;	// IMP=0x000000000010ee14
...
- (void)_updateCountViews;	// IMP=0x000000000010eb67
- (id)initWithDetailLabel:(_Bool)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000010dc08
