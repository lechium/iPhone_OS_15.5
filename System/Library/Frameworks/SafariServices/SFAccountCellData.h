...
+ (id)accountCellDataWithSavedAccount:(id)arg1 warning:(id)arg2 searchPattern:(id)arg3 savedAccountIsOnlySavedAccountForHighLevelDomain:(_Bool)arg4;	// IMP=0x00000000000039f5
- (void).cxx_destruct;	// IMP=0x0000000000003ca8
...
- (unsigned long long)hash;	// IMP=0x0000000000003c27
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003b87
@property(readonly, copy, nonatomic) NSString *highLevelDomain;
- (id)initWithSavedAccount:(id)arg1 warning:(id)arg2 searchPattern:(id)arg3 savedAccountIsOnlySavedAccountForHighLevelDomain:(_Bool)arg4;	// IMP=0x0000000000003a8e
