...
- (void)_updateTitle;	// IMP=0x000000000003ce31
- (void)_selectDetailType:(long long)arg1;	// IMP=0x000000000003cdc2
- (void)_addSegmentForDetailType:(long long)arg1;	// IMP=0x000000000003cc03
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000003c5a9
