...
- (void)setPrimitiveRange:(CDStruct_912cb5d2)arg1;	// IMP=0x0000000000111d68
@property(readonly, nonatomic) long long effectivePrimitiveCount;
@property(readonly, nonatomic) long long primitiveCount;
- (void)setupWithElement:(struct __C3DMeshElement *)arg1;	// IMP=0x0000000000111b77
- (id)description;	// IMP=0x0000000000111aeb
- (void)dealloc;	// IMP=0x0000000000111aab
