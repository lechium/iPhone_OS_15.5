...
- (id)newSubBufferWithBytes:(const void *)arg1 length:(unsigned long long)arg2 renderContext:(id)arg3;	// IMP=0x00000000000debf6
- (id)_newSubBuffer;	// IMP=0x00000000000de9dd
- (void)dealloc;	// IMP=0x00000000000de993
- (id)initWithDevice:(id)arg1 fixedSizeElement:(unsigned long long)arg2 buffersize:(unsigned long long)arg3 name:(id)arg4;	// IMP=0x00000000000de8cc
