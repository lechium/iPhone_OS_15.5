...
- (id)ciImage;	// IMP=0x000000000008d3b2
- (id)textureForSliceIndex:(unsigned long long)arg1;	// IMP=0x000000000008d225
- (_Bool)matchesDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x000000000008d120
@property(readonly, nonatomic) unsigned char renderBufferFormat;
@property(readonly, nonatomic) _Bool viewportDependant;
- (id)description;	// IMP=0x000000000008d06d
- (void)dealloc;	// IMP=0x000000000008d015
- (id)initWithDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x000000000008cfbb
