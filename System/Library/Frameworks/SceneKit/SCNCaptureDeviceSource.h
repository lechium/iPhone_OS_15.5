...
- (void)captureOutput:(id)arg1 didOutputSampleBuffer:(struct opaqueCMSampleBuffer *)arg2 fromConnection:(id)arg3;	// IMP=0x00000000002c9b59
- (id)metalTextureWithEngineContext:(struct __C3DEngineContext *)arg1 textureSampler:(struct __C3DTextureSampler *)arg2 nextFrameTime:(double *)arg3;	// IMP=0x00000000002c96de
- (void)cleanup:(struct __C3DRendererContext *)arg1;	// IMP=0x00000000002c96d8
- (void)connectToProxy:(struct __C3DImageProxy *)arg1;	// IMP=0x00000000002c9660
@property(retain, nonatomic) AVCaptureDevice *captureDevice;
- (void)dealloc;	// IMP=0x00000000002c9528
- (void)discardVideoData;	// IMP=0x00000000002c94c5
