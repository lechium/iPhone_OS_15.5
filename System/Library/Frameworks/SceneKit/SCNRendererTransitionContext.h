...
- (void)dealloc;	// IMP=0x0000000000192b7a
- (id)prepareRendererAtIndex:(int)arg1 withScene:(id)arg2 renderSize:(struct CGSize)arg3 pointOfView:(id)arg4 parentRenderer:(id)arg5;	// IMP=0x0000000000192a08
- (struct __C3DFXPass *)transitionPass;	// IMP=0x00000000001929b4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000192912
