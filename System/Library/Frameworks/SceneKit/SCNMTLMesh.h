...
- (id)bufferForAttribute:(long long)arg1;	// IMP=0x000000000011197a
- (void)dealloc;	// IMP=0x0000000000111914
- (id)description;	// IMP=0x00000000001116aa
...
- (void)buildTessellationVertexDescriptorIfNeeded;	// IMP=0x00000000001112b4
