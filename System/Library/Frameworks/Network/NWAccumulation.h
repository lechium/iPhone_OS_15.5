...
- (void).cxx_destruct;	// IMP=0x0000000000008950
...
- (id)snapshot;	// IMP=0x0000000000008570
- (void)reset;	// IMP=0x0000000000008520
- (void)updateWithState:(id)arg1 atTime:(double)arg2;	// IMP=0x0000000000008160
- (id)description;	// IMP=0x00000000000080c0
- (void)dealloc;	// IMP=0x0000000000008050
- (id)initWithName:(id)arg1;	// IMP=0x0000000000007e90
