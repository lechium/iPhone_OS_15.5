...
+ (void)cacheBackgroundImage:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000114fa9
+ (id)cachedBackgroundImageForKey:(id)arg1;	// IMP=0x0000000000114f90
- (void).cxx_destruct;	// IMP=0x00000000001189da
...
- (id)_generateGridImage;	// IMP=0x0000000000118275
- (void)layoutSubviews;	// IMP=0x00000000001174fc
- (void)_layoutHighlight;	// IMP=0x000000000011717c
- (double)_dayWidth;	// IMP=0x000000000011710b
@property(retain, nonatomic) UIColor *lineColor; // @synthesize lineColor=_lineColor;
@property(nonatomic) double fixedDayWidth;
@property(nonatomic, getter=isSelected) _Bool selected;
- (int)secondAtPosition:(double)arg1;	// IMP=0x0000000000116c6f
- (double)positionOfSecond:(long long)arg1;	// IMP=0x0000000000116c0f
@property(readonly, nonatomic) double timeWidth;
@property(readonly, nonatomic) double widthForOccurrences;
- (struct CGRect)rectForStartSeconds:(long long)arg1 endSeconds:(long long)arg2;	// IMP=0x00000000001169df
@property(nonatomic) _Bool showsRightBorder;
@property(nonatomic) _Bool showsLeftBorder;
- (void)viewTintColorDidChangeForView:(id)arg1 toColor:(id)arg2;	// IMP=0x000000000011669e
- (void)tintColorDidChange;	// IMP=0x0000000000116614
- (void)_updateTimeMarker;	// IMP=0x00000000001160a3
- (id)timeDotImage;	// IMP=0x0000000000115e17
- (void)updateMarkerPosition;	// IMP=0x0000000000115915
- (void)updateHourHeight;	// IMP=0x0000000000115878
@property(readonly, nonatomic) double hourHeight;
@property(readonly, nonatomic) double timeInset;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000011579b
- (double)bottomPadding;	// IMP=0x000000000011575b
@property(readonly, nonatomic) double topPadding;
- (void)setOrientation:(long long)arg1;	// IMP=0x000000000011561a
- (void)didMoveToWindow;	// IMP=0x00000000001155db
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000000011556d
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x00000000001154ff
- (long long)_sizeClass;	// IMP=0x00000000001154b3
- (id)initWithFrame:(struct CGRect)arg1 sizeClass:(long long)arg2 backgroundColor:(id)arg3 opaque:(_Bool)arg4 numberOfDaysToDisplay:(unsigned long long)arg5;	// IMP=0x00000000001150c7
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000115048
