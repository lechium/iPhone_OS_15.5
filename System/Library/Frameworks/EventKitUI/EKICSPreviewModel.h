...
- (void).cxx_destruct;	// IMP=0x000000000009831f
@property(readonly, nonatomic) _Bool shouldUpdate; // @synthesize shouldUpdate=_shouldUpdate;
- (id)importAllIntoCalendar:(id)arg1;	// IMP=0x0000000000097f46
- (id)importEvent:(id)arg1 intoCalendar:(id)arg2;	// IMP=0x0000000000097e06
...
- (id)initWithICSData:(id)arg1 eventStore:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x00000000000977dd
