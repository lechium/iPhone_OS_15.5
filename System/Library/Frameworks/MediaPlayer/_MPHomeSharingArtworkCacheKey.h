...
- (unsigned long long)hash;	// IMP=0x000000000025b682
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000025b59c
- (id)initWithPersistentID:(unsigned long long)arg1 size:(struct CGSize)arg2;	// IMP=0x000000000025b541
