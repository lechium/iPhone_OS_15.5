...
+ (id)allSupportedItemProperties;	// IMP=0x00000000001ec7a8
+ (id)allSupportedGroupProperties;	// IMP=0x00000000001ec6ad
- (void).cxx_destruct;	// IMP=0x00000000001eac95
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001ea905
- (id)modelObjectForItemsArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001ea7df
- (id)modelObjectForRecentlyPlayedArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001ea6b9
- (void)initializeRequestedGroupProperties;	// IMP=0x00000000001ea3c9
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4 storeURLBag:(id)arg5 isListenNow:(_Bool)arg6;	// IMP=0x00000000001ea298
