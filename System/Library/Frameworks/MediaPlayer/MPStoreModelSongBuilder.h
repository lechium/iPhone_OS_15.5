...
+ (id)allSupportedProperties;	// IMP=0x000000000012070d
- (void).cxx_destruct;	// IMP=0x000000000012188c
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x0000000000120d2a
