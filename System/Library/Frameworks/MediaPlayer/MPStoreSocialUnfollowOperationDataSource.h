...
- (void).cxx_destruct;	// IMP=0x0000000000259cf5
@property(retain, nonatomic) MPModelSocialPerson *person; // @synthesize person=_person;
- (id)queryItems;	// IMP=0x0000000000259cd2
- (long long)httpMethod;	// IMP=0x0000000000259cc7
- (long long)httpBodyType;	// IMP=0x0000000000259cbc
- (id)httpBody;	// IMP=0x0000000000259b95
- (id)bagKey;	// IMP=0x0000000000259b88
