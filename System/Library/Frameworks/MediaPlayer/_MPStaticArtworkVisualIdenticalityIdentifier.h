...
- (void).cxx_destruct;	// IMP=0x00000000000cacb4
...
- (id)stringRepresentation;	// IMP=0x00000000000cabbd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000cab6a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000caabd
