...
+ (id)otherConnectedDevicesFromRouteDescription:(id)arg1;	// IMP=0x0000000000127ebc
- (void).cxx_destruct;	// IMP=0x0000000000127e7e
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000127d07
