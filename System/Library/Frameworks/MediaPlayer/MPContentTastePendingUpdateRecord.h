...
- (void).cxx_destruct;	// IMP=0x00000000002d094c
...
- (void)_initializeWithType:(long long)arg1 tasteType:(long long)arg2;	// IMP=0x00000000002d08d9
- (id)initWithStoreAdamID:(long long)arg1 tasteType:(long long)arg2;	// IMP=0x00000000002d0873
- (id)initWithPlaylistGlobalID:(id)arg1 tasteType:(long long)arg2;	// IMP=0x00000000002d07df
