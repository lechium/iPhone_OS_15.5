...
- (void).cxx_destruct;	// IMP=0x00000000000ee2ba
...
- (id)serviceController;	// IMP=0x00000000000ee27d
- (void)dealloc;	// IMP=0x00000000000ee1a1
- (void)synchronizeSettings;	// IMP=0x00000000000ee11d
@property(readonly, nonatomic) UIViewController *remoteViewController;
- (void)requestRemoteViewController;	// IMP=0x00000000000edf59
