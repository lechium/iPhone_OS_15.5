...
+ (id)allSupportedProperties;	// IMP=0x0000000000254ed0
- (void).cxx_destruct;	// IMP=0x0000000000254a3f
...
- (id)modelObjectForRecommendationChildDictionary:(id)arg1 parentGroup:(id)arg2 subgroupsAccumulator:(id)arg3 userIdentity:(id)arg4;	// IMP=0x0000000000253cf6
- (id)initWithRequestedPropertySet:(id)arg1 storeItemMetadataResults:(id)arg2 flatSectionedItems:(id)arg3;	// IMP=0x0000000000253c17
