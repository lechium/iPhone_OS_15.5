...
- (void).cxx_destruct;	// IMP=0x000000000026ad11
...
- (_Bool)_storeItemMetadataIsAvailableForContentIdentifier:(id)arg1;	// IMP=0x000000000026ac21
- (id)_storeItemMetadataForContentIdentifier:(id)arg1;	// IMP=0x000000000026ab30
- (void)_populateUnavailableContentIdentifiersFromPageDataDictionary:(id)arg1;	// IMP=0x000000000026a817
- (void)_populateStorePlatformDataResultsFromRawResponseOutputDictionary:(id)arg1;	// IMP=0x000000000026a625
- (void)_parseUsingAdditionalContentIdentifiersFromPreviousParser;	// IMP=0x000000000026a2f7
- (void)_parseSingleContentListFromPageDataDictionary:(id)arg1 isMemberOfChartSet:(_Bool)arg2;	// IMP=0x000000000026972b
- (_Bool)_parseFeaturedContentChild:(id)arg1 isMemberOfChartSet:(_Bool)arg2 insertingResultsToSectionedCollection:(id)arg3 atSectionIndex:(long long)arg4 additionalContentIdentifiers:(id)arg5 allAdditionalContentIdentifiersNeedingLookup:(id)arg6;	// IMP=0x0000000000268a10
- (void)_parseFeaturedContentStructureModelChildren:(id)arg1;	// IMP=0x00000000002682fa
- (void)_parse;	// IMP=0x0000000000268101
...
- (id)initWithPreviousParser:(id)arg1 additionalStoreItemMetadataResponse:(id)arg2 options:(CDStruct_d2d88407)arg3 sectionBuilder:(id)arg4 contentItemBuilder:(id)arg5 userIdentity:(id)arg6;	// IMP=0x0000000000267ecb
- (id)initWithRawResponseOutput:(id)arg1 options:(CDStruct_d2d88407)arg2 sectionBuilder:(id)arg3 contentItemBuilder:(id)arg4 userIdentity:(id)arg5;	// IMP=0x0000000000267de5
