...
+ (id)allSupportedProperties;	// IMP=0x000000000022f2ca
- (void).cxx_destruct;	// IMP=0x000000000022f01b
...
- (id)convertToStoreItemMetadataDictionary:(id)arg1;	// IMP=0x000000000022ee06
- (id)storeItemMetadataWithMusicAPIMetadataDictionary:(id)arg1;	// IMP=0x000000000022ed77
- (id)modelObjectForRecommendationChildDictionary:(id)arg1 parentGroup:(id)arg2 subgroupsAccumulator:(id)arg3 userIdentity:(id)arg4;	// IMP=0x000000000022e1bf
- (id)initWithRequestedPropertySet:(id)arg1 storeItemMetadataResults:(id)arg2 flatSectionedItems:(id)arg3 storeURLBag:(id)arg4 isListenNow:(_Bool)arg5;	// IMP=0x000000000022e0ba
