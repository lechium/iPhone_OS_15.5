...
- (void).cxx_destruct;	// IMP=0x000000000016eba4
@property(nonatomic) long long libraryAddedStatus; // @synthesize libraryAddedStatus=_libraryAddedStatus;
- (void)setLibraryIdentifierSet:(id)arg1 forIdentifierSet:(id)arg2;	// IMP=0x000000000016eaf0
- (id)libraryIdentifierSetForIdentifierSet:(id)arg1;	// IMP=0x000000000016eada
