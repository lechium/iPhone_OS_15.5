...
+ (id)allSupportedProperties;	// IMP=0x000000000005c8ad
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x000000000005cbb7
