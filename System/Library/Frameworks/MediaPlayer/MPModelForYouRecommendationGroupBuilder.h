...
+ (id)allSupportedItemProperties;	// IMP=0x000000000023fec8
+ (id)allSupportedGroupProperties;	// IMP=0x000000000023fdee
- (void).cxx_destruct;	// IMP=0x000000000023f39d
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x000000000023eec1
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4;	// IMP=0x000000000023eda5
