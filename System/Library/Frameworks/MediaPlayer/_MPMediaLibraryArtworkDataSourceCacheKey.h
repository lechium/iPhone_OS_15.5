...
- (void).cxx_destruct;	// IMP=0x00000000002b3a1d
...
- (unsigned long long)hash;	// IMP=0x00000000002b392f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002b380c
- (id)initWithArtworkCatalog:(id)arg1 representativeSize:(struct CGSize)arg2;	// IMP=0x00000000002b3773
