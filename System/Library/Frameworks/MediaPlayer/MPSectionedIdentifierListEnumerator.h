...
- (void).cxx_destruct;	// IMP=0x00000000000718b6
...
- (id)nextObject;	// IMP=0x000000000007172f
- (id)nextObjectWithExclusiveAccessToken:(id)arg1;	// IMP=0x00000000000711fc
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned long long)arg2 startEntry:(id)arg3 endEntry:(id)arg4 withExclusiveAccessToken:(id)arg5;	// IMP=0x0000000000070ad8
