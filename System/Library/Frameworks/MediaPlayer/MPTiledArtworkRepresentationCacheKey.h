...
- (void).cxx_destruct;	// IMP=0x000000000005549b
- (id)stringRepresentation;	// IMP=0x000000000005545c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000055451
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005530b
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithTiledArtworkRequest:(id)arg1 scaledFittingSize:(struct CGSize)arg2;	// IMP=0x0000000000054f53
- (id)init;	// IMP=0x0000000000054f2f
