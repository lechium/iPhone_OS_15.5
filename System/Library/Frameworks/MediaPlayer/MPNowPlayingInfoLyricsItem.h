...
- (void)dealloc;	// IMP=0x00000000001278bf
- (id)initWithMediaRemoteLyricsItem:(void *)arg1;	// IMP=0x0000000000127852
- (id)initWithLyrics:(id)arg1 userProvided:(_Bool)arg2 token:(id)arg3;	// IMP=0x00000000001277b1
- (id)initWithLyrics:(id)arg1 userProvided:(_Bool)arg2;	// IMP=0x000000000012774a
