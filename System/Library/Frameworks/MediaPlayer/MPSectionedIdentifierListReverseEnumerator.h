...
- (void).cxx_destruct;	// IMP=0x00000000000729e0
...
- (id)_startEntryProxy;	// IMP=0x00000000000728c8
- (id)nextObject;	// IMP=0x00000000000727e3
- (id)nextObjectWithExclusiveAccessToken:(id)arg1;	// IMP=0x00000000000720c8
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned long long)arg2 startEntry:(id)arg3 endEntry:(id)arg4 withExclusiveAccessToken:(id)arg5;	// IMP=0x0000000000071cf1
