...
- (void).cxx_destruct;	// IMP=0x0000000000128285
...
- (id)stringRepresentation;	// IMP=0x000000000012818e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012813b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000012808e
