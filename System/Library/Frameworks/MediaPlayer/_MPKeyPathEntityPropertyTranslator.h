...
+ (id)translatorForKeyPaths:(id)arg1 valueTransformFunction:(CDUnknownFunctionPointerType)arg2;	// IMP=0x0000000000198154
+ (id)translatorForKeyPaths:(id)arg1 valueTransformBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000001980c2
- (void).cxx_destruct;	// IMP=0x000000000019809a
...
- (id)valueFromSource:(id)arg1 context:(id)arg2;	// IMP=0x0000000000198048
