...
- (void)_presentViewController:(id)arg1;	// IMP=0x000000000002dd87
- (void)_unblock;	// IMP=0x000000000002dd14
- (void)preferredContentSizeDidChange:(struct CGSize)arg1;	// IMP=0x000000000002dc40
- (void)engagementTaskDidFinishWithResult:(id)arg1 resultData:(id)arg2 error:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000002da7e
- (void)presentEngagement;	// IMP=0x000000000002d54b
- (id)initWithRequestData:(id)arg1 presentingViewController:(id)arg2 windowScene:(id)arg3;	// IMP=0x000000000002d461
