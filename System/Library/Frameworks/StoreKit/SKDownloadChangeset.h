...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x0000000000005a9a
...
- (id)copyXPCEncoding;	// IMP=0x0000000000005d43
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0000000000005b38
