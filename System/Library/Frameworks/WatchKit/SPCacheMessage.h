...
+ (id)fromProto:(id)arg1;	// IMP=0x000000000003444a
+ (id)toProto:(id)arg1;	// IMP=0x0000000000034233
- (void).cxx_destruct;	// IMP=0x0000000000034708
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000033f1f
