...
- (void).cxx_destruct;	// IMP=0x000000000000eefb
...
- (_Bool)shouldRunWithSamplingRate:(id)arg1;	// IMP=0x000000000000ed48
- (unsigned int)hostHash;	// IMP=0x000000000000ed1d
- (id)initWithConfiguration:(id)arg1;	// IMP=0x000000000000eb71
