...
- (void)_stopCyclingWorkoutDistanceUpdates;	// IMP=0x00000000000ebb96
- (void)_startCyclingWorkoutDistanceUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000eb34e
- (void)_stopOdometerUpdates;	// IMP=0x00000000000eb17f
- (void)_startOdometerUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000eaa92
- (void)_startDaemonConnection;	// IMP=0x00000000000ea46e
- (void)_teardown;	// IMP=0x00000000000ea422
- (void)dealloc;	// IMP=0x00000000000ea3d8
- (id)initWithOdometer:(id)arg1;	// IMP=0x00000000000ea2f6
