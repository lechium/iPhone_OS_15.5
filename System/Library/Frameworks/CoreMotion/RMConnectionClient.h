...
- (void).cxx_destruct;	// IMP=0x00000000000dd9b4
- (void)endpoint:(id)arg1 didReceiveMessage:(id)arg2 withData:(id)arg3 replyBlock:(CDUnknownBlockType)arg4;	// IMP=0x00000000000dd99c
- (void)endpoint:(id)arg1 didReceiveStreamedData:(id)arg2;	// IMP=0x00000000000dd988
- (void)endpointWasInvalidated:(id)arg1;	// IMP=0x00000000000dd523
- (void)endpointWasInterrupted:(id)arg1;	// IMP=0x00000000000dd332
