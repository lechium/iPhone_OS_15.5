...
- (_Bool)_validateOutputImage:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x000000000023d105
- (_Bool)_validateInputImage:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x000000000023d04a
- (_Bool)estimateFlowStream:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x000000000023d005
- (_Bool)estimateFlowFromReference:(struct __CVBuffer *)arg1 target:(struct __CVBuffer *)arg2 error:(id *)arg3;	// IMP=0x000000000023cfc0
- (_Bool)setOutputUV:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x000000000023cf7b
- (void)waitUntilCompleted;	// IMP=0x000000000023cf75
- (id)initWithWidth:(int)arg1 height:(int)arg2 numScales:(int)arg3;	// IMP=0x000000000023cf1c
