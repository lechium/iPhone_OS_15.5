...
- (void).cxx_destruct;	// IMP=0x00000000000ef6d5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ef5dd
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000ef567
- (void)setDefaultSymbologiesForRevision:(unsigned long long)arg1;	// IMP=0x00000000000ef4ed
