...
+ (_Bool)revision:(unsigned long long)arg1 supportsConstellation:(unsigned long long)arg2;	// IMP=0x000000000010ce20
- (void).cxx_destruct;	// IMP=0x000000000010ce0d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010cc48
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000010cb8e
