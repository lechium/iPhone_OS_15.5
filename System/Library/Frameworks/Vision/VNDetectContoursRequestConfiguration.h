...
- (void).cxx_destruct;	// IMP=0x00000000001defcc
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001dee02
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001ded3c
