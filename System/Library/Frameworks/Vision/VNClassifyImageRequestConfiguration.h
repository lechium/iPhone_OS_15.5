...
- (void).cxx_destruct;	// IMP=0x00000000000c8dc3
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c8c78
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000c8c15
