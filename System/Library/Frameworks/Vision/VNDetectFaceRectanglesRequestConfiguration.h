...
- (void).cxx_destruct;	// IMP=0x00000000001b919b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b8f47
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001b8e59
