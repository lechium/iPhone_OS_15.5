...
- (void).cxx_destruct;	// IMP=0x000000000003886d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000038734
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000386b4
