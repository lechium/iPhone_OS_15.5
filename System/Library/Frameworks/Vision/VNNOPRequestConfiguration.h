...
- (void).cxx_destruct;	// IMP=0x000000000010b846
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010b747
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000010b654
