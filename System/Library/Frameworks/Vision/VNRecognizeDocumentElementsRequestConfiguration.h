...
- (void).cxx_destruct;	// IMP=0x00000000001e029f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001e0163
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001e0076
