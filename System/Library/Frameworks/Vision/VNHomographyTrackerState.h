...
- (id).cxx_construct;	// IMP=0x0000000000036e2d
- (void).cxx_destruct;	// IMP=0x0000000000036dfe
- (void)ICReportFrameAnalysis:(id)arg1 forPresentationTime:(CDStruct_1b6d18a9)arg2 withStats:(id)arg3;	// IMP=0x0000000000036998
- (_Bool)ICShouldBeCanceled;	// IMP=0x0000000000036990
- (void)dealloc;	// IMP=0x0000000000036914
- (id)init;	// IMP=0x00000000000367d7
