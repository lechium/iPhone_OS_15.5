...
- (void).cxx_destruct;	// IMP=0x0000000000122a8b
- (id)processVNImageBuffer:(id)arg1 regionOfInterest:(struct CGRect)arg2 withOptions:(id)arg3 warningRecorder:(id)arg4 requestUUID:(id)arg5 error:(id *)arg6;	// IMP=0x0000000000120444
- (id)_VNPointsFromCGPoints:(const void *)arg1;	// IMP=0x00000000001202e4
- (struct __CVBuffer *)_createCroppedAndScaledBufferFromVNImageBuffer:(id)arg1 regionOfInterest:(struct CGRect)arg2 withOptions:(id)arg3 error:(id *)arg4;	// IMP=0x000000000012009f
- (void)dealloc;	// IMP=0x000000000012002d
- (id)initWithFrameAnalysisSpacing:(CDStruct_1b6d18a9)arg1 trajectoryLength:(long long)arg2;	// IMP=0x000000000011f6cf
