...
- (void)releaseAllocations;	// IMP=0x00000000001e3d9b
- (_Bool)makeAllocationsForWidth:(unsigned long long)arg1;	// IMP=0x00000000001e3ccf
- (void)dealloc;	// IMP=0x00000000001e3c5c
- (void)resetBoxBounds;	// IMP=0x00000000001e3c4b
- (void)copyFlagValue:(unsigned long long)arg1 toTarget:(unsigned long long)arg2 atIndex:(unsigned int)arg3;	// IMP=0x00000000001e3c1a
- (unsigned int)checkFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x00000000001e3c05
- (void)clearFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x00000000001e3bf2
- (void)setFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x00000000001e3be2
