...
- (void).cxx_destruct;	// IMP=0x000000000022096b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002208ac
- (void)updateWithPropertiesOfModel:(id)arg1;	// IMP=0x000000000022085d
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000022081a
