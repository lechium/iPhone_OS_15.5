...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000019049d
- (void).cxx_destruct;	// IMP=0x000000000019046a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001903bb
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000190162
