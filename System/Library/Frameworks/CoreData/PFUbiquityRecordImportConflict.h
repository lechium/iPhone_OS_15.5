...
+ (void)initialize;	// IMP=0x000000000026a3ee
- (id)description;	// IMP=0x000000000026d6af
- (id)createSetOfManagedObjectIDsForGlobalIDsInRelationship:(id)arg1 withValue:(id)arg2 withGlobalIDToLocalIDURIMap:(id)arg3 andTransactionLog:(id)arg4;	// IMP=0x000000000026d2da
- (void)dealloc;	// IMP=0x000000000026a4ae
- (id)init;	// IMP=0x000000000026a443
