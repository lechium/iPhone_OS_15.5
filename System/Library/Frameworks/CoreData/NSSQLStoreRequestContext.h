...
- (void)executeEpilogue;	// IMP=0x00000000000536b7
- (_Bool)executeRequestUsingConnection:(id)arg1;	// IMP=0x00000000000532ef
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x00000000000532c1
- (void)executePrologue;	// IMP=0x00000000000532bb
@property(readonly, nonatomic) _Bool isWritingRequest;
@property(readonly, nonatomic) NSSQLRowCache *rowCache;
- (void)dealloc;	// IMP=0x0000000000053137
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x0000000000052fc9
