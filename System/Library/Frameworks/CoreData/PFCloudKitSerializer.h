...
+ (void)_invalidateStaticCaches;	// IMP=0x000000000022294e
+ (id)defaultRecordZoneIDForDatabaseScope:(long long)arg1;	// IMP=0x0000000000222774
+ (void)initialize;	// IMP=0x000000000021893f
- (void).cxx_destruct;	// IMP=0x0000000000222985
- (void)dealloc;	// IMP=0x0000000000218a5e
- (id)initWithMirroringOptions:(id)arg1 metadataCache:(id)arg2 recordNamePrefix:(id)arg3;	// IMP=0x00000000002189be
