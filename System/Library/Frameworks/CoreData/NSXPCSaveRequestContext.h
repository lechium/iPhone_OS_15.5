...
- (id)managedObjectContext;	// IMP=0x00000000002aa7f0
- (void)dealloc;	// IMP=0x00000000002aa78f
- (id)initForStore:(id)arg1 request:(id)arg2 metadata:(id)arg3 forceInsertsToUpdates:(_Bool)arg4 context:(id)arg5;	// IMP=0x00000000002aa6a3
