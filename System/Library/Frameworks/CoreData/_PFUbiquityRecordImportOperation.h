...
- (long long)context:(id)arg1 shouldHandleInaccessibleFault:(id)arg2 forObjectID:(id)arg3 andTrigger:(id)arg4;	// IMP=0x000000000023df4a
@property(readonly, copy) NSString *description;
- (void)respondToStoreTransactionStateChangeNotification:(id)arg1;	// IMP=0x000000000023dade
- (void)main;	// IMP=0x000000000023a31d
- (id)retainedDelegate;	// IMP=0x0000000000237ea0
@property NSObject<_PFUbiquityRecordImportOperationDelegate> *delegate;
- (void)cancel;	// IMP=0x0000000000237d09
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000237cf7
- (id)copy;	// IMP=0x0000000000237cb3
- (void)dealloc;	// IMP=0x0000000000237b94
- (id)init;	// IMP=0x00000000002379f8
