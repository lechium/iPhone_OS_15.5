...
+ (void)initialize;	// IMP=0x00000000000679a9
- (void)unlock;	// IMP=0x0000000000067b83
- (_Bool)tryLock;	// IMP=0x0000000000067b53
- (void)lock;	// IMP=0x0000000000067b2d
- (void)dealloc;	// IMP=0x0000000000067a74
