...
- (void)executeEpilogue;	// IMP=0x00000000002bd0e7
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x00000000002bd019
- (void)executePrologue;	// IMP=0x00000000002bce9d
- (void)visitPredicateExpression:(id)arg1;	// IMP=0x00000000002bcd2d
- (void)visitPredicate:(id)arg1;	// IMP=0x00000000002bcd27
- (id)_createStatement;	// IMP=0x00000000002bcbd9
@property(retain, nonatomic) NSSQLiteStatement *fetchStatement;
- (id)manyToManyPrefetchRequestsForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x00000000002bbdd9
- (id)manyToOnePrefetchRequestForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x00000000002bbda0
- (id)inverseIsToOnePrefetchRequestForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x00000000002bbd67
@property(readonly, nonatomic) NSFetchRequest *request;
- (id)createChildContextForNestedFetchRequest:(id)arg1;	// IMP=0x00000000002bbc6f
- (void)dealloc;	// IMP=0x00000000002bbb13
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x00000000002bb350
