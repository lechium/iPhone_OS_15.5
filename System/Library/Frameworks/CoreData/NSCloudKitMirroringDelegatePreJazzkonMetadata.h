...
- (void).cxx_destruct;	// IMP=0x000000000030b7d6
- (id)description;	// IMP=0x000000000030a781
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000030a5b3
- (void)dealloc;	// IMP=0x000000000030a544
- (id)initWithStore:(id)arg1;	// IMP=0x000000000030a4f2
