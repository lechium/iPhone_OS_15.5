...
+ (void)_setAnnotatesMigrationMetadata:(_Bool)arg1;	// IMP=0x00000000002092f2
+ (_Bool)_annotatesMigrationMetadata;	// IMP=0x00000000002092c8
...
- (void)dealloc;	// IMP=0x0000000000209658
