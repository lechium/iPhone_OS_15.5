...
- (void)dealloc;	// IMP=0x00000000002abdc7
- (id)initWithStack:(id)arg1 andStoreMetadata:(id)arg2;	// IMP=0x00000000002abd7a
- (id)initWithStoreName:(id)arg1 andUbiquityRootLocation:(id)arg2 withLocalPeerID:(id)arg3;	// IMP=0x00000000002abce9
- (id)init;	// IMP=0x00000000002abc80
