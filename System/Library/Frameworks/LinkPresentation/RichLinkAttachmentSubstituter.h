...
- (void).cxx_destruct;	// IMP=0x000000000007aee1
...
- (id)unarchiver:(id)arg1 didDecodeObject:(id)arg2;	// IMP=0x000000000007ae53
- (id)applyAttachmentSubstitutionForObject:(id)arg1;	// IMP=0x000000000007a7ef
- (id)archiver:(id)arg1 willEncodeObject:(id)arg2;	// IMP=0x000000000007a4e2
- (id)init;	// IMP=0x000000000007a474
