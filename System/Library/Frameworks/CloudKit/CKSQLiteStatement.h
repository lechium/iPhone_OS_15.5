...
- (void).cxx_destruct;	// IMP=0x00000000001295c6
- (void)bindText:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x0000000000128cc3
- (void)invalidate:(id)arg1;	// IMP=0x0000000000128944
