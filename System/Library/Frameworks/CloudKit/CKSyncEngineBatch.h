...
- (id)CKDescriptionPropertiesWithPublic:(_Bool)arg1 private:(_Bool)arg2 shouldExpand:(_Bool)arg3;	// IMP=0x000000000002964f
- (id)description;	// IMP=0x000000000002963d
- (id)initWithRecordsToSave:(id)arg1 recordIDsToDelete:(id)arg2;	// IMP=0x00000000000295a0
