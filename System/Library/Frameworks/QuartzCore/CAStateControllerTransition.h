...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000000000d770
- (void)invalidate;	// IMP=0x000000000000d579
- (void)removeAnimationFromLayer:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000000d518
- (void)addAnimation:(id)arg1;	// IMP=0x000000000000d4db
- (id)init;	// IMP=0x000000000000d47d
