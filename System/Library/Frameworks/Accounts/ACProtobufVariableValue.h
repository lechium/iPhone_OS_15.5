...
- (void).cxx_destruct;	// IMP=0x0000000000006118
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000005db1
- (unsigned long long)hash;	// IMP=0x0000000000005b72
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000058dc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000056ea
- (void)copyTo:(id)arg1;	// IMP=0x0000000000005569
- (void)writeTo:(id)arg1;	// IMP=0x00000000000053ed
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000053e0
- (id)dictionaryRepresentation;	// IMP=0x0000000000004b5c
- (id)description;	// IMP=0x0000000000004aad
...
- (_Bool)_setObject:(id)arg1;	// IMP=0x000000000004f871
- (id)initWithObjectValue:(id)arg1;	// IMP=0x000000000004f7f8
