...
- (void).cxx_destruct;	// IMP=0x0000000000053fbd
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000053d2b
- (unsigned long long)hash;	// IMP=0x0000000000053bc8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005395f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000537a4
- (void)copyTo:(id)arg1;	// IMP=0x0000000000053650
- (void)writeTo:(id)arg1;	// IMP=0x00000000000534fd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000534f0
- (id)dictionaryRepresentation;	// IMP=0x0000000000052d53
- (id)description;	// IMP=0x0000000000052ca4
