...
+ (id)sortedRingRatioDirectives;	// IMP=0x00000000000029d1
+ (id)activityRingSizingDirectiveWithIdentifier:(id)arg1 width:(double)arg2 outerRingOffset:(double)arg3 ringThickness:(double)arg4 ringInterspacing:(double)arg5;	// IMP=0x0000000000002df2
...
- (id)description;	// IMP=0x00000000000032df
