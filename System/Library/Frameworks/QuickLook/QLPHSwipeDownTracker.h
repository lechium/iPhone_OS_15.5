...
- (void).cxx_destruct;	// IMP=0x000000000004e62d
...
- (void)trackGestureTranslation:(struct CGPoint)arg1 velocity:(struct CGPoint)arg2;	// IMP=0x000000000004e2e8
- (void)startTrackingCenter:(struct CGPoint)arg1 bounds:(struct CGRect)arg2 transform:(struct CGAffineTransform)arg3 withInitialGestureLocation:(struct CGPoint)arg4;	// IMP=0x000000000004e24f
- (id)init;	// IMP=0x000000000004e1f9
