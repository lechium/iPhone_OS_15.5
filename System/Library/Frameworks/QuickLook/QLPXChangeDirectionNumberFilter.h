...
- (double)updatedOutput;	// IMP=0x0000000000050659
- (double)initialOutputForInput:(double)arg1;	// IMP=0x0000000000050650
- (id)initWithInput:(double)arg1;	// IMP=0x0000000000050606
