...
+ (id)firstChildNavigationControllerFromViewController:(id)arg1;	// IMP=0x0000000000034370
+ (_Bool)useViewTransitionForPreviewController:(id)arg1;	// IMP=0x0000000000034296
+ (_Bool)useImageTransitionForPreviewController:(id)arg1;	// IMP=0x00000000000341f8
+ (_Bool)useZoomTransitionForPreviewController:(id)arg1;	// IMP=0x000000000003417e
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000032afe
- (void).cxx_destruct;	// IMP=0x0000000000034794
...
- (void)setUpTransitionSourceView;	// IMP=0x000000000003369e
- (id)initWithQLPreviewController:(id)arg1 containerView:(id)arg2 toViewController:(id)arg3;	// IMP=0x000000000003323b
- (id)sourceViewSnapshotImage;	// IMP=0x0000000000033216
- (void)_snapshotSourceViewIfNeeded;	// IMP=0x00000000000330e2
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000032cf1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000032b24
- (void)prepareContextToSend;	// IMP=0x0000000000032b06
