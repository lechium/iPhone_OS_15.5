...
- (void)update;	// IMP=0x0000000000057b36
...
- (void)trackRotation:(double)arg1;	// IMP=0x0000000000057ad4
- (void)trackScale:(double)arg1;	// IMP=0x0000000000057ab3
- (void)trackGestureLocation:(struct CGPoint)arg1;	// IMP=0x0000000000057a79
- (void)startTrackingCenter:(struct CGPoint)arg1 bounds:(struct CGRect)arg2 transform:(struct CGAffineTransform)arg3 withInitialGestureLocation:(struct CGPoint)arg4;	// IMP=0x0000000000057941
- (id)init;	// IMP=0x00000000000578ee
