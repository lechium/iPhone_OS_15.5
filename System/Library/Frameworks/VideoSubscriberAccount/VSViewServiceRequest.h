...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000001d3b3
- (void).cxx_destruct;	// IMP=0x000000000001d8db
...
- (id)description;	// IMP=0x000000000001d4f4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001d49a
- (unsigned long long)hash;	// IMP=0x000000000001d461
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001d411
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001d3bb
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001d333
- (id)init;	// IMP=0x000000000001d2cf
