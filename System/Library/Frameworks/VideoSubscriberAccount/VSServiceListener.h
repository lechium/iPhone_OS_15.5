...
- (void).cxx_destruct;	// IMP=0x00000000000636b6
...
- (void)connectionHandlerDidFinish:(id)arg1;	// IMP=0x000000000006363a
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000000000631cd
- (void)_removeConnectionHandler:(id)arg1;	// IMP=0x0000000000063132
- (void)_addConnectionHandler:(id)arg1;	// IMP=0x0000000000063097
- (id)init;	// IMP=0x0000000000063041
