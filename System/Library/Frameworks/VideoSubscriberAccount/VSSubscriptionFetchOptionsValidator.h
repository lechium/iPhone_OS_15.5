...
- (void).cxx_destruct;	// IMP=0x000000000003058c
@property(retain, nonatomic) VSSubscriptionPredicateFactory *predicateFactory; // @synthesize predicateFactory=_predicateFactory;
- (id)standardizedFetchOptionsFromOptions:(id)arg1 withSecurityTask:(id)arg2;	// IMP=0x000000000002f513
- (id)subscriptionFetchOptionsAllowedForSecurityTask:(id)arg1;	// IMP=0x000000000002edb4
