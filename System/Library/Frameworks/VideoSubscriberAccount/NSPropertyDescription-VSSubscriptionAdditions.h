...
- (id)vs_JSONValueTransformer;	// IMP=0x0000000000026d73
...
- (id)vs_propertyListValueTransformer;	// IMP=0x00000000000266d8
...
- (_Bool)vs_isSuitableForPurpose:(long long)arg1;	// IMP=0x000000000002656b
...
- (void)vs_setUserInfoValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000000262d8
@end
