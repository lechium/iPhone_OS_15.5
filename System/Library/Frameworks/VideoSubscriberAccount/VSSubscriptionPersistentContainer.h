...
- (void).cxx_destruct;	// IMP=0x00000000000557c2
...
- (void)performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x0000000000055709
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000556f5
- (void)_performBlock:(CDUnknownBlockType)arg1 andWait:(_Bool)arg2;	// IMP=0x0000000000055374
- (_Bool)_setupPersistenceIfNeeded:(id *)arg1;	// IMP=0x000000000005488f
- (void)_removePersistentStore;	// IMP=0x0000000000054776
- (id)init;	// IMP=0x0000000000054334
