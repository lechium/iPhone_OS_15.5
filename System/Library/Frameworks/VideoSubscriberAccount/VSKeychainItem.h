...
- (void).cxx_destruct;	// IMP=0x00000000000354e5
...
- (id)description;	// IMP=0x000000000003500f
@property(copy, nonatomic) NSData *data;
- (void)didAccessValueForKey:(id)arg1;	// IMP=0x0000000000034f35
- (void)willAccessValueForKey:(id)arg1;	// IMP=0x0000000000034ea9
- (void)willChangeValueForKey:(id)arg1;	// IMP=0x0000000000034dac
- (id)changedValues;	// IMP=0x0000000000034a70
- (id)committedValueForKey:(id)arg1;	// IMP=0x00000000000349ed
- (id)committedValuesForKeys:(id)arg1;	// IMP=0x000000000003496f
- (void)setPrimitiveValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000034756
- (id)primitiveValueForKey:(id)arg1;	// IMP=0x0000000000034642
@property(readonly, nonatomic) _Bool hasPersistentChangedValues;
@property(readonly, nonatomic) _Bool hasChanges;
- (void)_setCommittedValues:(id)arg1 registeringUndo:(_Bool)arg2;	// IMP=0x0000000000034489
- (id)initWithItemKind:(id)arg1 insertIntoEditingContext:(id)arg2;	// IMP=0x000000000003416b
- (id)init;	// IMP=0x00000000000340fc
