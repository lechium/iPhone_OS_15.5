...
- (void).cxx_destruct;	// IMP=0x000000000024a027
...
- (void)invalidate;	// IMP=0x0000000000249d5b
- (void)acquireWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000249a40
- (id)initWithHomeManager:(id)arg1 homeUUID:(id)arg2;	// IMP=0x000000000024996b
