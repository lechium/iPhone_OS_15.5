...
- (void).cxx_destruct;	// IMP=0x000000000036f060
...
- (CDStruct_14d5dc5e)double4x4AtTime:(double)arg1;	// IMP=0x000000000036eee3
- (CDStruct_14d5dc5e)float4x4AtTime:(double)arg1;	// IMP=0x000000000036ee2e
- (_Bool)IsInverseOp;	// IMP=0x000000000036ee25
- (id)initWithName:(id)arg1 inverse:(_Bool)arg2 data:(id)arg3;	// IMP=0x000000000036ed56
