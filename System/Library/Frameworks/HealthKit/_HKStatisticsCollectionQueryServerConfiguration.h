...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001b28fd
- (void).cxx_destruct;	// IMP=0x00000000001b2c86
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001b2aa4
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001b2905
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b2827
