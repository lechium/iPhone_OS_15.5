...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000001575a0
- (void).cxx_destruct;	// IMP=0x0000000000157a15
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001577b9
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001575a8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000015749a
