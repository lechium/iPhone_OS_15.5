...
- (id).cxx_construct;	// IMP=0x000000000021d00c
- (void).cxx_destruct;	// IMP=0x000000000021cfdb
- (id)nextObject;	// IMP=0x000000000021cebc
- (id)initWithElectrocardiogram:(id)arg1 leadIMicroVoltsBegin:(__wrap_iter_9551a0eb)arg2 end:(__wrap_iter_9551a0eb)arg3;	// IMP=0x000000000021cd35
