...
+ (id)nodeWithChildren:(id)arg1 rule:(id)arg2 rangeOfString:(struct _NSRange)arg3;	// IMP=0x000000000001a129
- (void).cxx_destruct;	// IMP=0x000000000001a2a4
@property(readonly, nonatomic) _HKCFGReplacementRule *rule; // @synthesize rule=_rule;
- (id)evaluate;	// IMP=0x000000000001a2f9
