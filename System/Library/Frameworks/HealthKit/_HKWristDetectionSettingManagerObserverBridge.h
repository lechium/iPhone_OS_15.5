...
- (void).cxx_destruct;	// IMP=0x000000000011f166
@property(readonly, nonatomic) HKObserverBridgeHandle *handle; // @synthesize handle=_handle;
- (void)wristDetectionSettingManagerDidObserveWristDetectChange:(id)arg1;	// IMP=0x000000000011effe
- (id)initWithHandle:(id)arg1;	// IMP=0x000000000011ef93
