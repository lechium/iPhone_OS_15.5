...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000c4bc1
- (void).cxx_destruct;	// IMP=0x00000000000c508b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c4e5a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c4bc9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c4a69
