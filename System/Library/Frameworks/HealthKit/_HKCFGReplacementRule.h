...
+ (id)ruleWithLHS:(id)arg1 RHS:(id)arg2 nodeEvaluator:(CDUnknownBlockType)arg3;	// IMP=0x0000000000094247
- (void).cxx_destruct;	// IMP=0x0000000000094881
...
- (id)description;	// IMP=0x0000000000094864
