...
- (void).cxx_destruct;	// IMP=0x0000000000146c65
...
- (id)description;	// IMP=0x0000000000146b75
- (id)initWithIdentifier:(id)arg1 data:(id)arg2 metadata:(id)arg3 device:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0000000000146a46
- (id)init;	// IMP=0x00000000001469cc
