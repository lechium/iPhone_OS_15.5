...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000018362
- (void).cxx_destruct;	// IMP=0x0000000000011957
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008281c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002394
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008275c
