...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000000026505e
+ (id)_experimentalFeatures;	// IMP=0x00000000002661b2
+ (id)_internalDebugFeatures;	// IMP=0x00000000002660e1
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002651e7
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000026510d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000265066
- (void)dealloc;	// IMP=0x0000000000265008
- (id)init;	// IMP=0x0000000000264efe
...
- (void)_setEnabled:(_Bool)arg1 forExperimentalFeature:(id)arg2;	// IMP=0x0000000000266295
- (_Bool)_isEnabledForExperimentalFeature:(id)arg1;	// IMP=0x0000000000266283
- (void)_setEnabled:(_Bool)arg1 forFeature:(id)arg2;	// IMP=0x0000000000266271
- (_Bool)_isEnabledForFeature:(id)arg1;	// IMP=0x000000000026625f
- (void)_setEnabled:(_Bool)arg1 forInternalDebugFeature:(id)arg2;	// IMP=0x00000000002661a0
- (_Bool)_isEnabledForInternalDebugFeature:(id)arg1;	// IMP=0x000000000026618e
