...
- (id).cxx_construct;	// IMP=0x0000000000858918
- (void).cxx_destruct;	// IMP=0x00000000008588ae
...
- (id)initWithFocusedElementInformation:(const void *)arg1 isUserInitiated:(_Bool)arg2 userObject:(id)arg3;	// IMP=0x00000000008586f6
