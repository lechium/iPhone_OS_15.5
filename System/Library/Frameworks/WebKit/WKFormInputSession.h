...
- (id).cxx_construct;	// IMP=0x00000000008586da
- (void).cxx_destruct;	// IMP=0x0000000000858667
- (void)reloadFocusedElementContextView;	// IMP=0x0000000000858649
- (void)invalidate;	// IMP=0x0000000000858602
@property(readonly, nonatomic) _Bool requiresStrongPasswordAssistance;
@property(copy, nonatomic) NSArray *suggestions;
- (void)endEditing;	// IMP=0x000000000085853b
...
- (id)initWithContentView:(id)arg1 focusedElementInfo:(id)arg2 requiresStrongPasswordAssistance:(_Bool)arg3;	// IMP=0x0000000000858252
