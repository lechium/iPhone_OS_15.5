...
+ (id)_replacementsFromMetadataArray:(id)arg1;	// IMP=0x00000000000ab48c
...
- (void)dealloc;	// IMP=0x00000000000ab42e
- (id)_initWithMetadata:(id)arg1;	// IMP=0x00000000000ab130
