...
- (void)remNotifications:(id)arg1;	// IMP=0x0000000000015065
- (void)addNotifications:(id)arg1;	// IMP=0x0000000000015023
- (_Bool)interestedInNotification:(id)arg1;	// IMP=0x0000000000014fdc
- (void)dealloc;	// IMP=0x0000000000014f6c
- (void)unlock;	// IMP=0x0000000000014f5e
- (void)lock;	// IMP=0x0000000000014f50
@property(readonly) int pid; // @dynamic pid;
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000000014e9b
