...
@class CTDataConnectionStatus, CTDataSettings, CTDataStatus, CTDataStatusBasic, CTServiceDescriptor, CTServiceDisconnectionStatus, CTTetheringStatus, CTXPCServiceSubscriptionContext, NSArray;
