...
@class CTCellularPlanProvisioningOnDeviceActivationRequest, CTCellularPlanProvisioningRequest, CTDeviceIdentifier, CTPlan, CTPlanList, CTRemotePlanIdentifier, CTRemotePlanIdentifierList, CTSimSetupUsage, CTXPCServiceSubscriptionContext, CUMessageSession, NSArray, NSData, NSError, NSString;
