...
- (void).cxx_destruct;	// IMP=0x000000000002e020
...
- (void)rotateByAngle:(float)arg1;	// IMP=0x000000000002dd0a
- (double)normalizeAngle:(double)arg1;	// IMP=0x000000000002dcad
- (id)initWithNode:(id)arg1;	// IMP=0x000000000002dbd8
