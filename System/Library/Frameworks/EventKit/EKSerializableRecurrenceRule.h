...
+ (id)classesForKey;	// IMP=0x0000000000087229
- (void).cxx_destruct;	// IMP=0x0000000000087bb2
...
- (id)createRecurrenceRule:(id *)arg1;	// IMP=0x0000000000087976
- (id)initWithRecurrenceRule:(id)arg1;	// IMP=0x0000000000087656
