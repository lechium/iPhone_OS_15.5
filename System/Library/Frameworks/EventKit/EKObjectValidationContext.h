...
- (void).cxx_destruct;	// IMP=0x00000000000b3501
...
- (void)faultIfNeededForObject:(id)arg1;	// IMP=0x00000000000b3448
- (id)initWithRootObject:(id)arg1;	// IMP=0x00000000000b33dd
