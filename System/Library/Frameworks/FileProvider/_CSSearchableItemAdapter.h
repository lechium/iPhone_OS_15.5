...
+ (id)fp_queryFetchAttributes;	// IMP=0x00000000000ab292
...
- (id)fp_appContainerBundleIdentifier;	// IMP=0x00000000000acd84
- (id)sharingCurrentUserPermissions;	// IMP=0x00000000000acd2d
@property(readonly, nonatomic, getter=isMostRecentVersionDownloaded) _Bool mostRecentVersionDownloaded;
- (_Bool)isRecursivelyDownloaded;	// IMP=0x00000000000acc43
@property(readonly, nonatomic, getter=isDownloaded) _Bool downloaded;
- (id)formerIdentifier;	// IMP=0x00000000000acb1b
@property(readonly, copy) NSString *fp_parentDomainIdentifier;
- (_Bool)isInPinnedFolder;	// IMP=0x00000000000aca4f
- (_Bool)isPinned;	// IMP=0x00000000000ac9da
...
- (id)tags;	// IMP=0x00000000000abda0
...
- (id)containerSubitemCount;	// IMP=0x00000000000ab993
- (id)sharingCurrentUserRole;	// IMP=0x00000000000ab943
...
- (id)initWithSearchableItem:(id)arg1;	// IMP=0x00000000000ab211
