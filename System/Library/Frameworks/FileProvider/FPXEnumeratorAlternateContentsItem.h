...
- (void).cxx_destruct;	// IMP=0x00000000001056d9
@property(readonly, copy, nonatomic) NSDate *contentModificationDate;
@property(readonly, copy, nonatomic) NSNumber *documentSize;
- (id)cloudContainerIdentifier;	// IMP=0x000000000010561d
- (_Bool)isContainerPristine;	// IMP=0x0000000000105607
- (_Bool)isContainer;	// IMP=0x00000000001055f1
...
- (id)providerID;	// IMP=0x0000000000105599
...
- (id)initWithOriginalDocumentItem:(id)arg1 alternateContentsURL:(id)arg2;	// IMP=0x00000000001050e9
