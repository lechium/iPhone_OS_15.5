...
- (void).cxx_destruct;	// IMP=0x000000000000d1fa
...
- (void)_performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x000000000000cf69
- (void)libraryDidChange;	// IMP=0x000000000000cf57
@property(nonatomic) ALAssetsLibrary *library;
- (void)setValue:(id)arg1 forProperty:(id)arg2;	// IMP=0x000000000000cede
- (id)valueForProperty:(id)arg1;	// IMP=0x000000000000ce71
- (void)populateAssets;	// IMP=0x000000000000ce53
- (void)updateAlbumFiltering;	// IMP=0x000000000000ce07
- (void)resetAssets;	// IMP=0x000000000000cdc1
- (int)albumFilter;	// IMP=0x000000000000cd46
- (void)dealloc;	// IMP=0x000000000000cc92
- (id)initWithAlbum:(id)arg1 library:(id)arg2;	// IMP=0x000000000000cbb6
