...
- (void).cxx_destruct;	// IMP=0x000000000004b772
...
- (void)sendNetworkExtensionMessage:(id)arg1 forBundleIdentifier:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000000004b524
- (void)invalidate;	// IMP=0x000000000004b4c4
...
- (void)dealloc;	// IMP=0x000000000004b3e2
- (id)initWithConnection:(id)arg1;	// IMP=0x000000000004afa7
