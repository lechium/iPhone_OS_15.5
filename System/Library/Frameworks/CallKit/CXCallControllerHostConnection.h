...
- (void).cxx_destruct;	// IMP=0x00000000000435b2
...
- (oneway void)requestTransaction:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000433c3
- (oneway void)requestCalls:(CDUnknownBlockType)arg1;	// IMP=0x00000000000432bd
- (oneway void)removeCall:(id)arg1;	// IMP=0x000000000004324b
- (oneway void)addOrUpdateCall:(id)arg1;	// IMP=0x00000000000431d9
...
- (void)dealloc;	// IMP=0x0000000000042fd2
- (id)initWithConnection:(id)arg1 serialQueue:(id)arg2;	// IMP=0x00000000000429be
- (id)init;	// IMP=0x00000000000429b0
