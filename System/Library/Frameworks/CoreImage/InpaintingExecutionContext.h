...
- (void)dealloc;	// IMP=0x000000000005627c
- (id)executionTimesLog;	// IMP=0x000000000005625c
- (id)processingResolutionsLog;	// IMP=0x000000000005623c
- (void)appendProcessingResolution:(int)arg1 andTime:(double)arg2;	// IMP=0x00000000000561c2
- (double)lastExecutionTime;	// IMP=0x0000000000056175
- (int)lastProcessingResolution;	// IMP=0x0000000000056129
- (int)filterProcessingCount;	// IMP=0x0000000000056113
- (id)CIImageProcessorDigestObject;	// IMP=0x00000000000560fa
- (id)init;	// IMP=0x000000000005606f
