...
- (id)outputImage;	// IMP=0x00000000000816ff
- (id)skinProtectionMaskWithThreshold:(float)arg1;	// IMP=0x00000000000815fd
- (id)irisProtectionMaskWithThresholdIris:(float)arg1 thresholdSclera:(float)arg2 thresholdSkin:(float)arg3;	// IMP=0x0000000000081491
