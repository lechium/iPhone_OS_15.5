...
- (long long)compareActionAmounts:(id)arg1;	// IMP=0x000000000001d63e
- (long long)compareIndices:(id)arg1;	// IMP=0x000000000001d5cf
- (long long)compareDividers:(id)arg1;	// IMP=0x000000000001d556
