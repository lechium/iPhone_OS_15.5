...
- (float *)colorHistogram;	// IMP=0x00000000000373d0
- (long long)compareImageOrder:(id)arg1;	// IMP=0x000000000003736f
- (long long)compareImageStats:(id)arg1;	// IMP=0x0000000000037367
- (float)computeScore:(float)arg1;	// IMP=0x0000000000037233
- (unsigned short *)aeMatrix;	// IMP=0x0000000000037226
- (void)computeAEMatrix:(id)arg1;	// IMP=0x0000000000037059
- (int)setAEMatrix:(id)arg1;	// IMP=0x0000000000036fe3
- (float)computeAEMatrixDifference:(id)arg1;	// IMP=0x0000000000036fa9
- (float)computeImageDistance:(id)arg1;	// IMP=0x0000000000036f5a
- (float)computeSmilePercentage;	// IMP=0x0000000000036e44
- (float)computeRuleOfThreeDistance;	// IMP=0x0000000000036b94
- (float)computeFacialFocusScoreSum;	// IMP=0x0000000000036616
- (void)collapseSharpnessGrid;	// IMP=0x0000000000036332
- (void)computeImageData:(id)arg1 faceIDCounts:(id)arg2;	// IMP=0x0000000000036106
- (void)writeGridROI:(id)arg1;	// IMP=0x0000000000036035
- (int)canRegister;	// IMP=0x0000000000036014
- (void)computeImageProjections:(id)arg1;	// IMP=0x0000000000035f6b
- (void)performRegistration:(id)arg1 deltaCol:(float *)arg2 deltaRow:(float *)arg3;	// IMP=0x0000000000035265
- (void)flagAsGarbage;	// IMP=0x0000000000035243
- (void)updateROI:(struct GridROI_t)arg1;	// IMP=0x0000000000035129
- (float)computeSmoothedGridROI:(id)arg1 nextStat:(id)arg2;	// IMP=0x0000000000034e8a
- (void)computeBlurStatsOnGrid:(id)arg1;	// IMP=0x0000000000034b98
- (void)computeImageSharpnessOnGrid:(id)arg1;	// IMP=0x0000000000034a1e
- (struct GridROI_t)getSharpnessAndBlurLimits;	// IMP=0x0000000000034a0f
- (void)computeImageColorHistogram:(id)arg1;	// IMP=0x0000000000034897
- (void)dealloc;	// IMP=0x000000000003480a
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000034744
- (void)assignMeanStdBuffers:(float *)arg1;	// IMP=0x0000000000034699
- (void)allocateMeanStdPingPongBuffers:(float **)arg1:(float **)arg2:(float **)arg3:(float **)arg4;	// IMP=0x00000000000345e3
