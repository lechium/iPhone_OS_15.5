...
+ (id)customAttributes;	// IMP=0x00000000000e478f
...
- (id)outputImage;	// IMP=0x00000000000e4b02
- (id)cpuParams;	// IMP=0x00000000000e4957
- (id)kernel;	// IMP=0x00000000000e48fa
- (id)mtlKernel;	// IMP=0x00000000000e488d
