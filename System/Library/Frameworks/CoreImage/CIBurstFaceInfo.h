...
- (float)overlapWithSwRect:(struct CGRect)arg1;	// IMP=0x000000000001dc25
- (float)overlapWithHwRect:(struct CGRect)arg1;	// IMP=0x000000000001db54
- (struct CGRect)swFaceRect;	// IMP=0x000000000001da8d
- (struct CGRect)hwFaceRect;	// IMP=0x000000000001d9c6
- (id)init;	// IMP=0x000000000001d8b7
