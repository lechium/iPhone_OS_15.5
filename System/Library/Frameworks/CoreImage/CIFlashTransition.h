...
+ (id)customAttributes;	// IMP=0x00000000000a29ad
...
- (id)outputImage;	// IMP=0x00000000000a2fb7
- (id)_geomKernel;	// IMP=0x00000000000a2f97
- (id)_colorKernel;	// IMP=0x00000000000a2f77
