...
- (id)outputImage;	// IMP=0x000000000010e64b
- (id)outputImage:(id)arg1 horizontal:(_Bool)arg2;	// IMP=0x000000000010dc72
- (id)noiseColorKernel;	// IMP=0x000000000010dbf4
- (id)_noiseGeneratorKernel;	// IMP=0x000000000010db87
- (id)_kernel:(_Bool)arg1 withAddedNoise:(_Bool)arg2;	// IMP=0x000000000010da83
