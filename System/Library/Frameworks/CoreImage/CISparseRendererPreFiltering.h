...
- (id)outputImage;	// IMP=0x000000000010effb
- (void)dumpImage:(id)arg1 extent:(struct CGRect)arg2 prefixFilename:(id)arg3;	// IMP=0x000000000010ed93
- (id)outputImage:(id)arg1 horizontal:(_Bool)arg2 width:(double)arg3;	// IMP=0x000000000010e90a
- (id)_kernel:(_Bool)arg1;	// IMP=0x000000000010e841
