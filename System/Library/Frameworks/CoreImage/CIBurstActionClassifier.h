...
- (_Bool)isBurstAction;	// IMP=0x000000000001d326
- (float)predictResult;	// IMP=0x000000000001d254
- (double)computeKernelValueWithSupportVector:(const struct CIBurstSupportVector *)arg1;	// IMP=0x000000000001d1dc
- (void)scaleVector;	// IMP=0x000000000001d088
- (id)initWithVersion:(int)arg1;	// IMP=0x000000000001d01f
- (id)init;	// IMP=0x000000000001cfd4
