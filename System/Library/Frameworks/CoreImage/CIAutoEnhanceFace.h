...
- (struct CGRect)faceRect;	// IMP=0x00000000001c2e6a
- (id)description;	// IMP=0x00000000001c2e2c
- (id)initWithBounds:(struct CGRect)arg1 andImage:(id)arg2 usingContext:(id)arg3;	// IMP=0x00000000001c2a86
