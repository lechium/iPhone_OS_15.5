...
+ (id)customAttributes;	// IMP=0x000000000010f198
...
- (id)outputImage;	// IMP=0x000000000011022a
- (id)_kernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x00000000001100f4
- (id)_lutKernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x000000000010ffbe
- (id)baseVecsLUT:(unsigned int)arg1;	// IMP=0x000000000010fed2
- (id)stepsLUT:(unsigned int)arg1;	// IMP=0x000000000010fdb6
- (id)baseVecsLUTGenerator;	// IMP=0x000000000010fd49
- (id)stepsLUTGenerator;	// IMP=0x000000000010fcdc
- (_Bool)_useD2XRenderer;	// IMP=0x000000000010fbbb
- (id)_packageParams:(_Bool)arg1 extent:(struct CGRect)arg2 image:(id)arg3 haveAlpha:(_Bool)arg4;	// IMP=0x000000000010f30c
