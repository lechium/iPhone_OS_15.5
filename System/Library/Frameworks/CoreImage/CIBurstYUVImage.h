...
- (struct __CVBuffer *)pixelBuffer;	// IMP=0x0000000000038b9e
- (void)dealloc;	// IMP=0x0000000000038b2e
- (id)initWithIOSurface:(struct __IOSurface *)arg1 maxDimension:(int)arg2;	// IMP=0x0000000000038880
- (id)initWithCGImage:(struct CGImage *)arg1 maxDimension:(int)arg2;	// IMP=0x00000000000386c1
- (void)convertRGBAToYUV420:(char *)arg1 rgbaBytesPerRow:(int)arg2;	// IMP=0x0000000000038241
