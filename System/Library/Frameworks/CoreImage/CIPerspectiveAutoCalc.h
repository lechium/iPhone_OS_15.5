...
- (_Bool)compute;	// IMP=0x0000000000122aa8
- (void)dealloc;	// IMP=0x0000000000122a6d
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const CDStruct_58ac58eb *)arg3;	// IMP=0x000000000012291b
