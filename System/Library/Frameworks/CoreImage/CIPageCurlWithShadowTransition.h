...
+ (id)customAttributes;	// IMP=0x00000000000fea3d
...
- (id)outputImage;	// IMP=0x00000000000fd084
- (id)_CIPageCurlNoShadowTransition;	// IMP=0x00000000000fd064
- (id)_CIPageCurlWithShadowTransition;	// IMP=0x00000000000fd044
