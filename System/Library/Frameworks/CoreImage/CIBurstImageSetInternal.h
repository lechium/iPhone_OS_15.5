...
+ (id)defaultVersionString;	// IMP=0x0000000000028379
...
- (_Bool)isAction;	// IMP=0x00000000000336c5
- (_Bool)isPortrait;	// IMP=0x0000000000033690
- (_Bool)isFaceDetectionForced;	// IMP=0x0000000000033671
- (id)imageClusterForIdentifier:(id)arg1;	// IMP=0x000000000003327b
- (id)bestImageIdentifiers;	// IMP=0x000000000002f2fb
- (void)selectCoverPhotoFromMultiple:(id)arg1 burstSize:(int)arg2;	// IMP=0x000000000002edc0
- (id)findBestImage:(id)arg1 useActionScores:(_Bool)arg2;	// IMP=0x000000000002e569
- (void)computeAllImageScores;	// IMP=0x000000000002cda3
- (float)computeBeginningVsEndAEMatrixDiffVsAverageAdjacent;	// IMP=0x000000000002ca49
- (float)computeCameraTravelDistance;	// IMP=0x000000000002c515
- (void)performEmotionalRejectionOnCluster:(id)arg1;	// IMP=0x000000000002be82
- (int)computeEmotion:(id)arg1;	// IMP=0x000000000002bd22
- (void)addImageFromIOSurface:(struct __IOSurface *)arg1 properties:(id)arg2 identifier:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000002bb9c
- (void)addYUVImage:(id)arg1 properties:(id)arg2 identifier:(id)arg3 imageProps:(id)arg4 completionBlock:(CDUnknownBlockType)arg5;	// IMP=0x000000000002b6b6
- (void)processClusters:(_Bool)arg1;	// IMP=0x0000000000029178
- (float)computeActionSelectionThreshold;	// IMP=0x0000000000028dda
- (void)dealloc;	// IMP=0x0000000000028b79
- (id)initWithOptions:(id)arg1;	// IMP=0x0000000000028494
- (id)burstDocumentDirectory;	// IMP=0x00000000000283f5
