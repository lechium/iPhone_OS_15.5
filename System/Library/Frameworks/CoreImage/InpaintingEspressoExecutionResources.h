...
+ (void)tearDownEspressoContext:(void **)arg1 andPlan:(void **)arg2;	// IMP=0x0000000000176190
...
- (id)description;	// IMP=0x0000000000176300
- (void)freeEspressoResources;	// IMP=0x000000000017614a
- (void)updateWithModelResourceDescriptor:(id)arg1 modelResourceFileName:(id)arg2 network:(CDStruct_2bc666a5)arg3 plan:(void *)arg4 context:(void *)arg5 inputBlobNames:(id)arg6 outputBlobNames:(id)arg7 membraneModel:(_Bool)arg8 modelInputPixelFormat:(int)arg9 modelOutputPixelFormat:(int)arg10;	// IMP=0x00000000001760d1
- (void)dealloc;	// IMP=0x0000000000176093
- (void)deregisterFilterUsage;	// IMP=0x0000000000176074
- (void)registerFilterUsage;	// IMP=0x0000000000176055
- (void)releaseModelIfNoLongerNeeded;	// IMP=0x0000000000176011
- (_Bool)isModelInitialized;	// IMP=0x0000000000176003
- (_Bool)initializeModelForResourceDescriptor:(id)arg1 resourceFileName:(id)arg2 inputBlobNames:(id)arg3 outputBlobNames:(id)arg4 cpuOnlyModel:(_Bool)arg5 membraneModel:(_Bool)arg6 modelInputPixelFormat:(int)arg7 modelOutputPixelFormat:(int)arg8 error:(id *)arg9;	// IMP=0x0000000000175ef0
- (_Bool)initializeInpaintingModelForResourceDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000175dc5
- (_Bool)descriptorIsAMembraneModel:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000175d77
- (_Bool)parseModelResourceDescriptor:(id)arg1 extractMembraneInfo:(_Bool *)arg2 inputPixelFormat:(int *)arg3 outputPixelFormat:(int *)arg4 andResourceFileName:(id *)arg5 error:(id *)arg6;	// IMP=0x0000000000175bfb
- (id)CIImageProcessorDigestObject;	// IMP=0x0000000000175be2
- (id)init;	// IMP=0x0000000000175ba0
