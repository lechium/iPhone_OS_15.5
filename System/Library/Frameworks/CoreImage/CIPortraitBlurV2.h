...
+ (id)customAttributes;	// IMP=0x0000000000110d50
...
- (id)outputImage;	// IMP=0x000000000011125d
- (double)effectiveScale;	// IMP=0x00000000001111c9
- (id)sensorSize;	// IMP=0x00000000001110a5
