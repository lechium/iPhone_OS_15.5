...
+ (id)customAttributes;	// IMP=0x00000000001b5e4c
+ (int)getDraftMode:(id)arg1;	// IMP=0x00000000001ba795
+ (struct CGImageMetadata *)augmentMetadataWithRenderingPropertiesForImage:(id)arg1;	// IMP=0x00000000001ba6be
+ (struct CGImageMetadata *)metadataFromDictionary:(id)arg1 metadata:(struct CGImageMetadata *)arg2;	// IMP=0x00000000001ba5f5
+ (id)tuningParametersFromMetadata:(struct CGImageMetadata *)arg1;	// IMP=0x00000000001ba5e8
+ (struct CGImageMetadata *)replaceRenderingParameters:(struct CGImageMetadata *)arg1 tuningParameters:(id)arg2;	// IMP=0x00000000001ba5e0
...
- (id)outputImage;	// IMP=0x00000000001b6990
- (id)_getFocusRect:(id)arg1 focusRect:(id)arg2;	// IMP=0x00000000001b6692
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x00000000001b64aa
- (void)prewarm:(id)arg1;	// IMP=0x00000000001b5dde
