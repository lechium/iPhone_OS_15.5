...
+ (id)customAttributes;	// IMP=0x0000000000141e54
...
- (id)outputImage;	// IMP=0x0000000000142888
- (id)defuse:(id)arg1 seed:(int)arg2;	// IMP=0x000000000014261b
- (id)_kernelKmeans;	// IMP=0x00000000001425fb
- (id)_combine:(id)arg1;	// IMP=0x0000000000142131
