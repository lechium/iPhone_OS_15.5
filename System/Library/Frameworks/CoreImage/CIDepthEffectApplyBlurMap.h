...
+ (id)customAttributes;	// IMP=0x00000000001b434d
...
- (id)outputImage;	// IMP=0x00000000001b4bf2
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x00000000001b475b
