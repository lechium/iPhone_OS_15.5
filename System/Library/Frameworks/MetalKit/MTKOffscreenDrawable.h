...
- (void).cxx_destruct;	// IMP=0x00000000000108ac
...
- (void)addPresentedHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000010868
@property(nonatomic) struct CGSize size;
@property(nonatomic) unsigned long long pixelFormat;
@property(readonly) id <MTLTexture> texture;
- (void)presentAtTime:(double)arg1;	// IMP=0x000000000001069d
- (void)presentAfterMinimumDuration:(double)arg1;	// IMP=0x0000000000010679
- (void)present;	// IMP=0x0000000000010657
- (id)initWithDevice:(id)arg1 pixelFormat:(unsigned long long)arg2 size:(struct CGSize)arg3 drawableID:(unsigned long long)arg4;	// IMP=0x00000000000105b4
