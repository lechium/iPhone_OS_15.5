...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000010af0
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000010bea
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000010af8
@property(retain, nonatomic) NSString *deviceIdentifier;
@property(retain, nonatomic) NSString *bundleIdentifier;
@property(retain, nonatomic) NSString *sensor;
- (void)dealloc;	// IMP=0x0000000000010a29
- (id)init;	// IMP=0x00000000000109dd
