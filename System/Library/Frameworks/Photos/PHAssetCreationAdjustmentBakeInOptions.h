...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000aeeb1
+ (id)adjustmentBakeInOptionsForPublishingOriginals;	// IMP=0x00000000000aee10
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ae940
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000ae6d7
- (id)plRepresentation;	// IMP=0x00000000000ae6a7
- (id)description;	// IMP=0x00000000000ae5f4
- (void)encodeToXPCDict:(id)arg1;	// IMP=0x00000000000ae4fd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ae43c
- (id)initWithXPCDict:(id)arg1;	// IMP=0x00000000000ae334
- (id)init;	// IMP=0x00000000000ae2f2
