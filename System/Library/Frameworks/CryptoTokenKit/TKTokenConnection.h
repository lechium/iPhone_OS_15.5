...
- (void).cxx_destruct;	// IMP=0x000000000002d957
...
- (void)dealloc;	// IMP=0x000000000002d8a2
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000000002d7da
- (void)invalidate;	// IMP=0x000000000002d7c4
- (id)initWithToken:(id)arg1;	// IMP=0x000000000002d674
