...
- (id)_un_contentSizeRatio;	// IMP=0x0000000000002e47
...
- (id)_un_customSectionIdentifiers;	// IMP=0x0000000000002aab
- (id)_un_extensionContainerBundleIdentifier;	// IMP=0x00000000000028dc
@end
