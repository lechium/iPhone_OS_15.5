...
- (void).cxx_destruct;	// IMP=0x00000000000852eb
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000084fcc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000084fc1
- (id)description;	// IMP=0x0000000000084db5
@property(readonly) NSDate *expirationDate;
@property(readonly) NSDate *creationDate; // @synthesize creationDate;
- (id)initWithName:(id)arg1 value:(id)arg2 domain:(id)arg3;	// IMP=0x0000000000084b6d
