...
- (void).cxx_destruct;	// IMP=0x0000000000132503
...
- (_Bool)matchCookie:(id)arg1;	// IMP=0x0000000000131b4d
- (long long)_flags;	// IMP=0x0000000000131632
- (id)initWithCookie:(id)arg1;	// IMP=0x00000000001314a0
