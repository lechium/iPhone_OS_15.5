...
- (void)dealloc;	// IMP=0x00000000001fd1fb
- (void)_syncCookies;	// IMP=0x00000000001fd185
- (void)registerForPostingNotificationsWithContext:(id)arg1;	// IMP=0x00000000001fd023
