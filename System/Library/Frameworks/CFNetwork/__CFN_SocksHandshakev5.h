...
- (void).cxx_destruct;	// IMP=0x000000000015c728
- (id)finish:(int)arg1;	// IMP=0x000000000015c560
- (_Bool)parse:(const char *)arg1 len:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000015bbd8
