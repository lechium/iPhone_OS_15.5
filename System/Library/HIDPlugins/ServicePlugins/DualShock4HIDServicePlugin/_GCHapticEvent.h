...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000001dea
...
- (id)description;	// IMP=0x0000000000001cb0
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001ac1
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001a2e
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001844
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001f24
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001df2
