...
+ (_Bool)matchService:(unsigned int)arg1 options:(id)arg2 score:(long long *)arg3;	// IMP=0x000000000000325c
- (void).cxx_destruct;	// IMP=0x00000000000073de
...
- (void)readBatteryWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000007172
- (void)connectToGameIntentServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000007160
- (void)connectToBatteryServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000000707c
- (void)connectToMotionServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000000706a
- (void)connectToAdaptiveTriggersServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000007058
- (void)connectToLightServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000007046
- (void)enqueueTransient:(id)arg1 hapticMotor:(unsigned long long)arg2;	// IMP=0x0000000000006f79
- (void)setHapticMotor:(unsigned long long)arg1 frequency:(float)arg2 amplitude:(float)arg3;	// IMP=0x0000000000006f05
- (void)fetchDeviceRegistryIDWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000006e82
- (void)requestServiceWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000006db7
- (void)ping;	// IMP=0x0000000000006d5b
- (float)defaultHapticDispatchFrequency;	// IMP=0x0000000000006d4d
- (id)defaultHapticMotors;	// IMP=0x0000000000006d34
- (float)defaultRightAxisSnapRadius;	// IMP=0x0000000000006d2b
- (float)defaultLeftAxisSnapRadius;	// IMP=0x0000000000006d22
- (float)defaultRightThumbstickDeadzoneRadius;	// IMP=0x0000000000006d14
- (float)defaultLeftThumbstickDeadzoneRadius;	// IMP=0x0000000000006d06
- (float)defaultIdleTimeoutDuration;	// IMP=0x0000000000006cf8
- (float)defaultRightThumbstickNoiseBuffer;	// IMP=0x0000000000006cef
- (float)defaultLeftThumbstickNoiseBuffer;	// IMP=0x0000000000006ce6
- (void)enableHaptics;	// IMP=0x0000000000006a18
- (_Bool)updateHapticMotor:(id)arg1;	// IMP=0x0000000000006910
- (void)stopHaptics;	// IMP=0x0000000000006726
- (unsigned int)numberOfTimesToSendZeroHapticReport;	// IMP=0x000000000000671b
- (_Bool)isHapticsActive;	// IMP=0x000000000000670f
- (void)updateHaptics:(_Bool)arg1;	// IMP=0x0000000000006709
- (void)dispatchHapticEvent;	// IMP=0x0000000000006703
- (_Bool)isAnyHapticMotorEnabled;	// IMP=0x00000000000064ef
- (void)dispatchShareButtonEventWithValue:(_Bool)arg1;	// IMP=0x000000000000641b
- (void)dispatchOptionsButtonEventWithValue:(_Bool)arg1;	// IMP=0x0000000000006347
- (void)dispatchMenuButtonEventWithValue:(_Bool)arg1;	// IMP=0x0000000000006273
- (void)dispatchHomeButtonEventWithValue:(_Bool)arg1;	// IMP=0x000000000000619f
- (void)dispatchGameControllerExtendedEventWithState:(CDStruct_5be5f302)arg1;	// IMP=0x0000000000005c9e
- (void)dispatchMotionEventWithState:(CDStruct_06597ee6)arg1;	// IMP=0x00000000000059fe
- (_Bool)isTwoAxisInputIdle:(MISSING_TYPE **)arg1 prevInput:(MISSING_TYPE **)arg2 noiseBuffer:(float)arg3;	// IMP=0x00000000000059a5
- (void)applyDeadzone:(float)arg1 axisSnapRadius:(float)arg2 input:(MISSING_TYPE **)arg3;	// IMP=0x00000000000058a4
- (void)dispatchEvent:(id)arg1;	// IMP=0x000000000000588d
- (void)dispatchEvent:(id)arg1 updateLastEventTime:(_Bool)arg2;	// IMP=0x0000000000005811
- (id)createEvent:(unsigned int)arg1;	// IMP=0x00000000000057be
- (_Bool)shouldDisconnectWhenIdle;	// IMP=0x00000000000057b6
- (_Bool)isIdle;	// IMP=0x0000000000005644
- (void)updateIdleState;	// IMP=0x000000000000558a
- (void)scheduleIdleTimer;	// IMP=0x0000000000005454
- (_Bool)shouldCreateBatteryDevice;	// IMP=0x000000000000544c
- (void)sendBatteryReport;	// IMP=0x000000000000533f
- (void)updateClientBattery;	// IMP=0x0000000000005272
- (void)createVirtualHIDDeviceForBattery;	// IMP=0x0000000000004f31
- (void)disconnect;	// IMP=0x0000000000004ccf
- (void)setupRawReportHandling;	// IMP=0x0000000000004cc9
- (void)clientNotification:(id)arg1 added:(_Bool)arg2;	// IMP=0x0000000000004bd5
- (void)setDispatchQueue:(id)arg1;	// IMP=0x0000000000004ae8
- (void)cancel;	// IMP=0x000000000000498d
- (void)activate;	// IMP=0x000000000000490e
- (void)setCancelHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000004710
- (void)setEventDispatcher:(id)arg1;	// IMP=0x0000000000004652
- (id)eventMatching:(id)arg1 forClient:(id)arg2;	// IMP=0x00000000000044e1
- (_Bool)setProperty:(id)arg1 forKey:(id)arg2 client:(id)arg3;	// IMP=0x00000000000043bb
- (id)propertyForKey:(id)arg1 client:(id)arg2;	// IMP=0x000000000000405b
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000003d24
- (id)initWithService:(unsigned int)arg1;	// IMP=0x0000000000003666
- (void)initGameControllerDaemonXPC;	// IMP=0x0000000000003264
