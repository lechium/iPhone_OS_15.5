...
+ (_Bool)matchService:(unsigned int)arg1 options:(id)arg2 score:(long long *)arg3;	// IMP=0x000000000000381d
...
- (void)readBatteryWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000007742
- (void)connectToGameIntentServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000007730
- (void)connectToBatteryServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000000764c
- (void)connectToMotionServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000000763a
- (void)connectToAdaptiveTriggersServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000007628
- (void)connectToLightServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000007616
- (void)enqueueTransient:(id)arg1 hapticMotor:(unsigned long long)arg2;	// IMP=0x0000000000007549
- (void)setHapticMotor:(unsigned long long)arg1 frequency:(float)arg2 amplitude:(float)arg3;	// IMP=0x00000000000074d5
- (void)fetchDeviceRegistryIDWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000007452
- (void)requestServiceWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000007387
- (void)ping;	// IMP=0x000000000000732b
- (float)defaultHapticDispatchFrequency;	// IMP=0x000000000000731d
- (id)defaultHapticMotors;	// IMP=0x0000000000007304
- (float)defaultRightAxisSnapRadius;	// IMP=0x00000000000072fb
- (float)defaultLeftAxisSnapRadius;	// IMP=0x00000000000072f2
- (float)defaultRightThumbstickDeadzoneRadius;	// IMP=0x00000000000072e4
- (float)defaultLeftThumbstickDeadzoneRadius;	// IMP=0x00000000000072d6
- (float)defaultIdleTimeoutDuration;	// IMP=0x00000000000072c8
- (float)defaultRightThumbstickNoiseBuffer;	// IMP=0x00000000000072bf
- (float)defaultLeftThumbstickNoiseBuffer;	// IMP=0x00000000000072b6
- (void)enableHaptics;	// IMP=0x0000000000006fe8
- (_Bool)updateHapticMotor:(id)arg1;	// IMP=0x0000000000006ee0
- (void)stopHaptics;	// IMP=0x0000000000006cf6
- (unsigned int)numberOfTimesToSendZeroHapticReport;	// IMP=0x0000000000006ceb
- (_Bool)isHapticsActive;	// IMP=0x0000000000006cdf
- (void)updateHaptics:(_Bool)arg1;	// IMP=0x0000000000006cd9
- (void)dispatchHapticEvent;	// IMP=0x0000000000006cd3
- (_Bool)isAnyHapticMotorEnabled;	// IMP=0x0000000000006abf
- (void)dispatchShareButtonEventWithValue:(_Bool)arg1;	// IMP=0x00000000000069eb
- (void)dispatchOptionsButtonEventWithValue:(_Bool)arg1;	// IMP=0x0000000000006917
- (void)dispatchMenuButtonEventWithValue:(_Bool)arg1;	// IMP=0x0000000000006843
- (void)dispatchHomeButtonEventWithValue:(_Bool)arg1;	// IMP=0x000000000000676f
- (void)dispatchGameControllerExtendedEventWithState:(CDStruct_5be5f302)arg1;	// IMP=0x000000000000626e
- (void)dispatchMotionEventWithState:(CDStruct_06597ee6)arg1;	// IMP=0x0000000000005fce
- (_Bool)isTwoAxisInputIdle:(MISSING_TYPE **)arg1 prevInput:(MISSING_TYPE **)arg2 noiseBuffer:(float)arg3;	// IMP=0x0000000000005f75
- (void)applyDeadzone:(float)arg1 axisSnapRadius:(float)arg2 input:(MISSING_TYPE **)arg3;	// IMP=0x0000000000005e74
- (void)dispatchEvent:(id)arg1;	// IMP=0x0000000000005e5d
- (void)dispatchEvent:(id)arg1 updateLastEventTime:(_Bool)arg2;	// IMP=0x0000000000005de1
- (id)createEvent:(unsigned int)arg1;	// IMP=0x0000000000005d8e
- (_Bool)shouldDisconnectWhenIdle;	// IMP=0x0000000000005d86
- (_Bool)isIdle;	// IMP=0x0000000000005c14
- (void)updateIdleState;	// IMP=0x0000000000005b5a
- (void)scheduleIdleTimer;	// IMP=0x0000000000005a24
- (_Bool)shouldCreateBatteryDevice;	// IMP=0x0000000000005a1c
- (void)sendBatteryReport;	// IMP=0x000000000000590f
- (void)updateClientBattery;	// IMP=0x0000000000005842
- (void)createVirtualHIDDeviceForBattery;	// IMP=0x0000000000005501
- (void)disconnect;	// IMP=0x000000000000529f
- (void)setupRawReportHandling;	// IMP=0x0000000000005299
- (void)clientNotification:(id)arg1 added:(_Bool)arg2;	// IMP=0x00000000000051a5
- (void)setDispatchQueue:(id)arg1;	// IMP=0x00000000000050b8
- (void)cancel;	// IMP=0x0000000000004f4e
- (void)activate;	// IMP=0x0000000000004ecf
- (void)setCancelHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000004cd1
- (void)setEventDispatcher:(id)arg1;	// IMP=0x0000000000004c13
- (id)eventMatching:(id)arg1 forClient:(id)arg2;	// IMP=0x0000000000004aa2
- (_Bool)setProperty:(id)arg1 forKey:(id)arg2 client:(id)arg3;	// IMP=0x000000000000497c
- (id)propertyForKey:(id)arg1 client:(id)arg2;	// IMP=0x000000000000461c
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000000042e5
- (id)initWithService:(unsigned int)arg1;	// IMP=0x0000000000003c27
- (void)initGameControllerDaemonXPC;	// IMP=0x0000000000003825
