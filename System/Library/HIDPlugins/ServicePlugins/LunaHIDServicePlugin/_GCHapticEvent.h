...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000000000024a2
...
- (id)description;	// IMP=0x0000000000002368
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000002179
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x00000000000020e6
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001efc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000025dc
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000024aa
