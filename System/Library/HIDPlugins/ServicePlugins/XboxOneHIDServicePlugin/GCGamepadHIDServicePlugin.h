...
+ (_Bool)matchService:(unsigned int)arg1 options:(id)arg2 score:(long long *)arg3;	// IMP=0x00000000000043d4
- (void).cxx_destruct;	// IMP=0x0000000000008565
...
- (void)readBatteryWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000082f9
- (void)connectToGameIntentServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000082e7
- (void)connectToBatteryServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000008203
- (void)connectToMotionServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000081f1
- (void)connectToAdaptiveTriggersServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000081df
- (void)connectToLightServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000081cd
- (void)enqueueTransient:(id)arg1 hapticMotor:(unsigned long long)arg2;	// IMP=0x0000000000008100
- (void)setHapticMotor:(unsigned long long)arg1 frequency:(float)arg2 amplitude:(float)arg3;	// IMP=0x000000000000808c
- (void)fetchDeviceRegistryIDWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000008009
- (void)requestServiceWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000007f3e
- (void)ping;	// IMP=0x0000000000007ee2
- (float)defaultHapticDispatchFrequency;	// IMP=0x0000000000007ed4
- (id)defaultHapticMotors;	// IMP=0x0000000000007ebb
- (float)defaultRightAxisSnapRadius;	// IMP=0x0000000000007eb2
- (float)defaultLeftAxisSnapRadius;	// IMP=0x0000000000007ea9
- (float)defaultRightThumbstickDeadzoneRadius;	// IMP=0x0000000000007e9b
- (float)defaultLeftThumbstickDeadzoneRadius;	// IMP=0x0000000000007e8d
- (float)defaultIdleTimeoutDuration;	// IMP=0x0000000000007e7f
- (float)defaultRightThumbstickNoiseBuffer;	// IMP=0x0000000000007e76
- (float)defaultLeftThumbstickNoiseBuffer;	// IMP=0x0000000000007e6d
- (void)enableHaptics;	// IMP=0x0000000000007b9f
- (_Bool)updateHapticMotor:(id)arg1;	// IMP=0x0000000000007a97
- (void)stopHaptics;	// IMP=0x00000000000078ad
- (unsigned int)numberOfTimesToSendZeroHapticReport;	// IMP=0x00000000000078a2
- (_Bool)isHapticsActive;	// IMP=0x0000000000007896
- (void)updateHaptics:(_Bool)arg1;	// IMP=0x0000000000007890
- (void)dispatchHapticEvent;	// IMP=0x000000000000788a
- (_Bool)isAnyHapticMotorEnabled;	// IMP=0x0000000000007676
- (void)dispatchShareButtonEventWithValue:(_Bool)arg1;	// IMP=0x00000000000075a2
- (void)dispatchOptionsButtonEventWithValue:(_Bool)arg1;	// IMP=0x00000000000074ce
- (void)dispatchMenuButtonEventWithValue:(_Bool)arg1;	// IMP=0x00000000000073fa
- (void)dispatchHomeButtonEventWithValue:(_Bool)arg1;	// IMP=0x0000000000007326
- (void)dispatchGameControllerExtendedEventWithState:(CDStruct_5be5f302)arg1;	// IMP=0x0000000000006e25
- (void)dispatchMotionEventWithState:(CDStruct_06597ee6)arg1;	// IMP=0x0000000000006b85
- (_Bool)isTwoAxisInputIdle:(MISSING_TYPE **)arg1 prevInput:(MISSING_TYPE **)arg2 noiseBuffer:(float)arg3;	// IMP=0x0000000000006b2c
- (void)applyDeadzone:(float)arg1 axisSnapRadius:(float)arg2 input:(MISSING_TYPE **)arg3;	// IMP=0x0000000000006a2b
- (void)dispatchEvent:(id)arg1;	// IMP=0x0000000000006a14
- (void)dispatchEvent:(id)arg1 updateLastEventTime:(_Bool)arg2;	// IMP=0x0000000000006998
- (id)createEvent:(unsigned int)arg1;	// IMP=0x0000000000006945
- (_Bool)shouldDisconnectWhenIdle;	// IMP=0x000000000000693d
- (_Bool)isIdle;	// IMP=0x00000000000067cb
- (void)updateIdleState;	// IMP=0x0000000000006711
- (void)scheduleIdleTimer;	// IMP=0x00000000000065db
- (_Bool)shouldCreateBatteryDevice;	// IMP=0x00000000000065d3
- (void)sendBatteryReport;	// IMP=0x00000000000064c6
- (void)updateClientBattery;	// IMP=0x00000000000063f9
- (void)createVirtualHIDDeviceForBattery;	// IMP=0x00000000000060b8
- (void)disconnect;	// IMP=0x0000000000005e56
- (void)setupRawReportHandling;	// IMP=0x0000000000005e50
- (void)clientNotification:(id)arg1 added:(_Bool)arg2;	// IMP=0x0000000000005d5c
- (void)setDispatchQueue:(id)arg1;	// IMP=0x0000000000005c6f
- (void)cancel;	// IMP=0x0000000000005b05
- (void)activate;	// IMP=0x0000000000005a86
- (void)setCancelHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000005888
- (void)setEventDispatcher:(id)arg1;	// IMP=0x00000000000057ca
- (id)eventMatching:(id)arg1 forClient:(id)arg2;	// IMP=0x0000000000005659
- (_Bool)setProperty:(id)arg1 forKey:(id)arg2 client:(id)arg3;	// IMP=0x0000000000005533
- (id)propertyForKey:(id)arg1 client:(id)arg2;	// IMP=0x00000000000051d3
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000004e9c
- (id)initWithService:(unsigned int)arg1;	// IMP=0x00000000000047de
- (void)initGameControllerDaemonXPC;	// IMP=0x00000000000043dc
