...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000000002066
...
- (id)description;	// IMP=0x0000000000001f2c
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001d3d
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001caa
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001ac0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000021a0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000206e
