...
- (void).cxx_destruct;	// IMP=0x002000000008d91e
...
- (void)animateTransition:(id)arg1;	// IMP=0x001000000008cdc5
- (double)transitionDuration:(id)arg1;	// IMP=0x001000000008cd75
- (id)initWithModel:(id)arg1 paletteView:(id)arg2 reverse:(_Bool)arg3;	// IMP=0x001000000008cc90
