...
- (void).cxx_destruct;	// IMP=0x0020000000138380
@property(retain, nonatomic) LargeMonthViewOccurrence *occurrence; // @synthesize occurrence=_occurrence;
- (void)displayLayer:(id)arg1;	// IMP=0x0010000000138169
- (void)setNeedsDisplay;	// IMP=0x001000000013812c
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0010000000137ffa
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000137e12
