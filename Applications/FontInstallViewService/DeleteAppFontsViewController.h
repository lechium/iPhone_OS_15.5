...
- (void).cxx_destruct;	// IMP=0x00200000000020e1
...
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x0010000000001e98
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x0010000000001e30
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x0010000000001e25
- (void)dontDelete:(id)arg1;	// IMP=0x0010000000001def
- (void)doDelete:(id)arg1;	// IMP=0x0010000000001db6
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0010000000001d87
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000001866
- (void)viewDidLoad;	// IMP=0x0010000000001837
