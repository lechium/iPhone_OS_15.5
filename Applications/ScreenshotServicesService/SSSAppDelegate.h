...
- (void)application:(id)arg1 didFinishLaunchingSuspendedWithOptions:(id)arg2;	// IMP=0x001000000002162e
- (_Bool)application:(id)arg1 didFinishLaunchingWithOptions:(id)arg2;	// IMP=0x00100000000215fb
@property(readonly, nonatomic) SSSViewControllerManager *viewControllerManager;
- (void)_setUpDevelopmentUI;	// IMP=0x0010000000021545
- (_Bool)_shouldSetUpDevelopmentUI;	// IMP=0x001000000002151c
