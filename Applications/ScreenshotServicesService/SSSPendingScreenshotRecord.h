...
@interface SSSPendingScreenshotRecord : NSObject
{
    ...
    CDUnknownBlockType;	// 16 = 0x10
}

- (void).cxx_destruct;	// IMP=0x0020000000055d01
...
- (id)initWithScreenshot:(id)arg1 deliveryCompletionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000055c2f
