...
- (void).cxx_destruct;	// IMP=0x002000000003aaf5
@property(nonatomic) __weak id <SSSCropControllerDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) struct CGRect cropRect; // @synthesize cropRect=_cropRect;
- (struct CGRect)cropOverlayViewRectInWindow;	// IMP=0x001000000003aa7f
@property(readonly, nonatomic) UIScrollView *scrollView;
- (void)cropControllerRootView:(id)arg1 changedToCropRect:(struct CGRect)arg2;	// IMP=0x001000000003a9e3
- (void)cropControllerRootViewWillBeginChangingCropRect:(id)arg1;	// IMP=0x001000000003a997
...
- (_Bool)isCropped;	// IMP=0x001000000003a85b
- (void)cancelCrop;	// IMP=0x001000000003a7fe
- (void)doneCrop;	// IMP=0x001000000003a7cd
- (void)resetCrop;	// IMP=0x001000000003a74c
- (void)enterCrop;	// IMP=0x001000000003a736
- (void)prepareForFullscreenExperience:(_Bool)arg1;	// IMP=0x001000000003a720
- (void)setPageCropRect:(struct CGRect)arg1;	// IMP=0x001000000003a70a
- (void)commitInflightEdits;	// IMP=0x001000000003a6f4
- (void)_setCropRect:(struct CGRect)arg1 notify:(_Bool)arg2;	// IMP=0x001000000003a626
