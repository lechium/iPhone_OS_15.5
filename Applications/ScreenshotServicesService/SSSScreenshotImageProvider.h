...
- (void).cxx_destruct;	// IMP=0x002000000002b474
...
- (void)scheduleDeletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000002b23a
- (id)pdfDocument;	// IMP=0x001000000002b14d
- (void)processImageIdentifier:(id)arg1;	// IMP=0x001000000002b011
- (void)_loadUneditedImageIfNecessaryWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000002ad35
- (id)requestCGImageBackedUneditedImageForUIBlocking;	// IMP=0x001000000002abdb
- (void)requestCGImageBackedUneditedImageForUI:(CDUnknownBlockType)arg1;	// IMP=0x001000000002a896
- (id)requestUneditedImageForUIBlocking;	// IMP=0x001000000002a73c
- (void)requestUneditedImageForUI:(CDUnknownBlockType)arg1;	// IMP=0x001000000002a602
- (id)requestOutputImageForUIBlocking;	// IMP=0x001000000002a4a8
- (id)requestOutputImageForSavingBlocking;	// IMP=0x001000000002a329
- (void)requestOutputImageForUI:(CDUnknownBlockType)arg1;	// IMP=0x001000000002a20e
- (void)requestOutputImageInTransition:(_Bool)arg1 forSaving:(CDUnknownBlockType)arg2;	// IMP=0x0010000000029ffe
- (void)requestOutputImageForSaving:(CDUnknownBlockType)arg1;	// IMP=0x0010000000029fe7
- (id)_outputImageOnCurrentUneditedImage;	// IMP=0x0010000000029e38
- (void)_resumeHighQualityQueueIfNecessary;	// IMP=0x0010000000029dd2
- (void)dealloc;	// IMP=0x0010000000029d04
- (id);	// IMP=0x0010000000029b7d
