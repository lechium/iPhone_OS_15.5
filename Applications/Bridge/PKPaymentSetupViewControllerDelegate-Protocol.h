...
@class MISSING_TYPE, NSArray, NSError, NSString, PKFeatureApplication, PKPasscodeUpgradeFlowController, UIViewController;

@protocol PKPaymentSetupViewControllerDelegate <NSObject>
- (void)viewControllerDidTerminateSetupFlow:(UIViewController *)arg1;

@optional
- (_Bool)viewController:(UIViewController *)arg1 requestsReturnToMarker:(NSString *)arg2 reset:(_Bool)arg3;
...
- (MISSING_TYPE *)viewControllerWillPresentChangePasscodeComplex: /* Error: Ran out of types for this method. */;
