...
+ (id)deviceModelHeaderName;	// IMP=0x00400000000ef2c6
+ (id)pairedClientInfoHeaderName;	// IMP=0x00100000000ef2b9
+ (id)clientInfoHeaderForDevice:(id)arg1;	// IMP=0x00100000000eefb8
- (void).cxx_destruct;	// IMP=0x00200000000ef6dd
...
- (id)initWithGizmoDevice:(id)arg1 showWarranty:(_Bool)arg2;	// IMP=0x00100000000ef2d3
