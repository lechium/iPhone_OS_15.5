...
- (void).cxx_destruct;	// IMP=0x00200000000f5a8c
...
- (void)_configureMetrics;	// IMP=0x00100000000f5644
- (void)_updateProgressViewFrame;	// IMP=0x00100000000f5551
- (void)setScanningProgress:(double)arg1 key:(id)arg2;	// IMP=0x00100000000f54bc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000000f50c4
