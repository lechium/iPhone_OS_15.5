...
- (void).cxx_destruct;	// IMP=0x002000000000cd99
...
- (void)sharingSetupDidSucceed;	// IMP=0x001000000000ccf1
- (void)sharingSetupDidFailWithError:(id)arg1;	// IMP=0x001000000000cacb
...
- (id)init;	// IMP=0x001000000000c9c1
