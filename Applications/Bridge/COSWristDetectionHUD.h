...
- (void).cxx_destruct;	// IMP=0x002000000008370f
...
- (void)updateWithSummary:(id)arg1;	// IMP=0x0010000000083460
- (void)updateWithConfidences:(id)arg1;	// IMP=0x0010000000082db4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000000822d8
