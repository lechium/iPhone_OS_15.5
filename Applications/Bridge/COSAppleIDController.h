...
- (void).cxx_destruct;	// IMP=0x002000000002602a
...
- (id)appleIDAuthControllerRequestsPresentingViewController:(id)arg1;	// IMP=0x0010000000025aac
- (void)appleIDAuthController:(id)arg1 didSignInWithSuccess:(_Bool)arg2 error:(id)arg3;	// IMP=0x001000000002579c
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x00100000000256b8
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x0010000000024ada
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0010000000024a57
- (void)_textFieldValueDidChange:(id)arg1;	// IMP=0x00100000000248f3
- (void)tappedForgotButton;	// IMP=0x0010000000024709
- (void)tappedForgotiTunesStoreButton;	// IMP=0x0010000000024687
- (void)tappedForgotFaceTimeButton;	// IMP=0x0010000000024605
- (void)tappedForgotiMessageButton;	// IMP=0x0010000000024583
- (void)tappedForgotiCloudButton;	// IMP=0x0010000000024501
- (void)stopNetworkRequest;	// IMP=0x0010000000024436
- (void)startNetworkRequest;	// IMP=0x00100000000242ed
- (void)loggedInSuccessfullyToAccount:(id)arg1;	// IMP=0x0010000000023e2d
- (void)_removeAppleIDFollowUp;	// IMP=0x0010000000023d72
- (void)_removeStoreFollowUp;	// IMP=0x0010000000023cb7
- (void)tappedSignInToiTunesStore;	// IMP=0x0010000000023ae3
- (void)tappedSignInToFaceTime;	// IMP=0x001000000002390f
- (void)tappedSignInToiMessage;	// IMP=0x001000000002373b
- (void)tappedSignInToiCloud;	// IMP=0x00100000000234af
- (void)enableSignInButtons:(_Bool)arg1;	// IMP=0x00100000000232f4
- (void)openiCloudPaneInSettingsApp;	// IMP=0x0010000000023273
- (void)setPassword:(id)arg1 withSpecifier:(id)arg2;	// IMP=0x001000000002326d
- (id)getiTunesStoreUsernameForSpecifier:(id)arg1;	// IMP=0x0010000000023246
- (id)getFaceTimeUsernameForSpecifier:(id)arg1;	// IMP=0x001000000002321f
- (id)getiMessageUsernameForSpecifier:(id)arg1;	// IMP=0x00100000000231f8
- (id)getiCloudUsernameForSpecifier:(id)arg1;	// IMP=0x00100000000231d1
- (void)handleAccountsInfoReply:(id)arg1 error:(id)arg2;	// IMP=0x0010000000022590
- (void)queryWatchForAccountsInfo;	// IMP=0x0010000000022088
- (_Bool)signingIn;	// IMP=0x0010000000022065
- (id)newPasswordTextFieldSpecifierWithID:(id)arg1;	// IMP=0x0010000000021ed5
- (void)removeForgotPasswordFooterFromSpecifier:(id)arg1;	// IMP=0x0010000000021e2a
- (void)addForgotPasswordFooterToSpecifier:(id)arg1 withActionSelector:(SEL)arg2;	// IMP=0x0010000000021c30
- (id)specifiers;	// IMP=0x0010000000020469
- (void)dealloc;	// IMP=0x0010000000020246
- (id)init;	// IMP=0x001000000001fa0c
