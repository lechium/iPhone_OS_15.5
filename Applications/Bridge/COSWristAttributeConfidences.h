...
- (id)description;	// IMP=0x0010000000098ea3
- (void)divideConfidencesBy:(long long)arg1;	// IMP=0x0000000000098e57
- (void)addConfidences:(id)arg1;	// IMP=0x0010000000098d77
- (id)initWithObservationTime:(double)arg1;	// IMP=0x0010000000098d34
- (id)initWithObservationTime:(double)arg1 none:(double)arg2 invalid:(double)arg3 lr:(double)arg4 ll:(double)arg5 rr:(double)arg6 rl:(double)arg7 palm:(double)arg8 dock:(double)arg9;	// IMP=0x0010000000098c7e
