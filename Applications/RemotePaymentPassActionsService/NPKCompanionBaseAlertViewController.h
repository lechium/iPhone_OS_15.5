...
- (void).cxx_destruct;	// IMP=0x0020000000007697
- (void)_establishPresenterConnectionWithEndpoint:(id)arg1;	// IMP=0x0010000000007556
- (void)dismiss;	// IMP=0x001000000000746f
...
- (void)configureWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000007206
