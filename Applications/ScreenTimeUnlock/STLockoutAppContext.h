...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000001dbd
+ (id)contextWithData:(id)arg1;	// IMP=0x001000000000230a
- (void).cxx_destruct;	// IMP=0x00100000000022cc
...
- (id)debugDescription;	// IMP=0x001000000000215b
- (id)description;	// IMP=0x0010000000002092
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000001ffd
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000001ebb
- (id)initWithEventType:(id)arg1;	// IMP=0x0010000000001dc5
