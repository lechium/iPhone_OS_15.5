...
- (void).cxx_destruct;	// IMP=0x002000000000ea16
...
- (void)startSearchQuery;	// IMP=0x001000000000e783
- (void)showPseudoContactsListForIPhone;	// IMP=0x001000000000e5b4
- (void)showNextContact;	// IMP=0x001000000000e205
- (void)iterateContact;	// IMP=0x001000000000def1
- (void)navigationController:(id)arg1 didShowViewController:(id)arg2 animated:(_Bool)arg3;	// IMP=0x001000000000dedc
- (void)didShow:(id)arg1;	// IMP=0x001000000000dd77
- (void)resetDelegate;	// IMP=0x001000000000dc7b
- (void)prepareForNextTest;	// IMP=0x001000000000dc3d
- (_Bool)prepareForTestWithOptions:(id)arg1;	// IMP=0x001000000000d7d0
