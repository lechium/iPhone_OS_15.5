...
- (void).cxx_destruct;	// IMP=0x0020000000010177
...
- (void)startSearchQueryWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000000ffb8
- (_Bool)prepareForTestWithOptions:(id)arg1;	// IMP=0x001000000000fa97
