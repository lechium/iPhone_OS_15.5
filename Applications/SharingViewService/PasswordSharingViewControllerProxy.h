...
+ (_Bool)_isSecureForRemoteViewService;	// IMP=0x004000000019cb65
- (void).cxx_destruct;	// IMP=0x002000000019c6b4
...
- (void)handleButtonActions:(id)arg1;	// IMP=0x001000000019c428
- (void)showAuthUIWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2 animated:(_Bool)arg3;	// IMP=0x001000000019c404
- (void)_sessionHandleProgress:(unsigned int)arg1 info:(id)arg2;	// IMP=0x001000000019c18b
- (void)_sessionStart;	// IMP=0x001000000019bce6
- (void)_handleDeviceNoLongerNeedsPassword;	// IMP=0x001000000019bc12
- (void)_deviceLost:(id)arg1;	// IMP=0x001000000019bb0c
- (void)_deviceFound:(id)arg1;	// IMP=0x001000000019b8d8
- (void)_deviceDiscoveryEnsureStarted;	// IMP=0x001000000019b789
- (void)showDoneUI:(int)arg1;	// IMP=0x001000000019b231
- (void)ensureStoppedWithDismiss:(_Bool)arg1 reason:(int)arg2;	// IMP=0x001000000019b0d3
- (void)ensureStoppedWithDismiss:(_Bool)arg1;	// IMP=0x001000000019b0bc
- (void)dismiss:(int)arg1;	// IMP=0x001000000019ae22
- (void)invalidateTouchDelayTimer;	// IMP=0x001000000019ace4
- (void)activateTouchDelayTimer;	// IMP=0x001000000019aad3
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x001000000019a9d7
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x001000000019a747
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x001000000019a210
- (unsigned long long)supportedInterfaceOrientations;	// IMP=0x001000000019a148
- (void)configureWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000199c5e
