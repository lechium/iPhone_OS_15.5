...
- (void).cxx_destruct;	// IMP=0x00200000001a4b9c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001a4a21
- (unsigned long long)hash;	// IMP=0x00100000001a493d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001a47a6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001a4684
- (void)copyTo:(id)arg1;	// IMP=0x00100000001a458f
- (void)writeTo:(id)arg1;	// IMP=0x00100000001a4484
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001a3fa3
- (id)dictionaryRepresentation;	// IMP=0x00100000001a3d2b
- (id)description;	// IMP=0x00100000001a3c7c
