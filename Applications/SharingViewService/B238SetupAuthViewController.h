...
@interface B238SetupAuthViewController
{
...
- (void).cxx_destruct;	// IMP=0x002000000017d08c
- (void)_handlePINEntered:(id)arg1;	// IMP=0x001000000017cf15
- (void)_handleKeyboardWillShow:(id)arg1;	// IMP=0x001000000017cbda
- (void)handleDismissButton:(id)arg1;	// IMP=0x001000000017cb35
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x001000000017ca64
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000017c76a
- (void)showWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2;	// IMP=0x001000000017c582
