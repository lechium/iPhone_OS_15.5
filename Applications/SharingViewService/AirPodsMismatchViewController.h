...
- (void).cxx_destruct;	// IMP=0x00200000001ca60d
@property(copy, nonatomic) NSDictionary *userInfo; // @synthesize userInfo=_userInfo;
- (void)handleTapOutsideView:(id)arg1;	// IMP=0x00100000001ca563
- (void)handleDismissButton:(id)arg1;	// IMP=0x00100000001ca4db
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x00100000001ca458
- (_Bool)_canShowWhileLocked;	// IMP=0x00100000001ca450
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00100000001ca3cc
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000001c9fa4
