...
+ (id)jiggleRotationAnimation;	// IMP=0x0020000000058fd7
+ (id)jiggleYTranslationAnimation;	// IMP=0x0010000000058ea5
+ (id)jiggleXTranslationAnimation;	// IMP=0x0010000000058d73
- (void).cxx_destruct;	// IMP=0x0020000000058637
...
- (id)pointerInteraction:(id)arg1 styleForRegion:(id)arg2;	// IMP=0x00100000000582dd
- (id)pointerInteraction:(id)arg1 regionForRequest:(id)arg2 defaultRegion:(id)arg3;	// IMP=0x0010000000058180
- (id)visibleButton;	// IMP=0x001000000005816e
- (void)prepareForReuse;	// IMP=0x0010000000058107
- (void)dragStateDidChange:(long long)arg1;	// IMP=0x0010000000057e7d
- (void)setEnabled:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0010000000057cd1
- (void)setSelected:(_Bool)arg1;	// IMP=0x0010000000057c6d
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0010000000057c09
- (void)updateSelectionState;	// IMP=0x0010000000057b85
- (void)stopRunning;	// IMP=0x0010000000057ae8
- (void)setProgress:(double)arg1 animated:(_Bool)arg2;	// IMP=0x0010000000057600
- (_Bool)isProgressing;	// IMP=0x00100000000575b8
- (void)editButtonPressed:(id)arg1;	// IMP=0x00100000000574f4
- (void)updateEditButtonVisibility;	// IMP=0x001000000005745f
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00100000000571d5
@property(readonly, nonatomic) UIBezierPath *visiblePathForDragging;
- (void)updateIconImage;	// IMP=0x0010000000056cff
- (void)layoutSubviews;	// IMP=0x0010000000056373
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000005609c
