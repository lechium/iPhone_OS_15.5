...
- (void).cxx_destruct;	// IMP=0x00200000000537b4
...
- (void)updateSetupPayload:(id)arg1;	// IMP=0x0010000000053691
@property(readonly, nonatomic) NSString *pairingStatusDescription;
@property(readonly, nonatomic) NSString *pairingStatusTitle;
- (void)pairingController:(id)arg1 didTransitionToPhase:(unsigned long long)arg2 statusTitle:(id)arg3 statusDescription:(id)arg4;	// IMP=0x0010000000053338
- (id)cancelPairingWithError:(id)arg1;	// IMP=0x0010000000053095
- (id)cancelPairing;	// IMP=0x0010000000052f8b
- (id)startPairingWithHome:(id)arg1;	// IMP=0x0010000000052ccb
- (id)initWithPairingContext:(id)arg1 discoveredAccessory:(id)arg2 accessoryAlreadyStaged:(_Bool)arg3;	// IMP=0x00100000000528d2
- (id)initWithPairingContext:(id)arg1 accessoryAlreadyStaged:(_Bool)arg2;	// IMP=0x00100000000528b8
- (id)initWithPairingContext:(id)arg1 discoveredAccessory:(id)arg2;	// IMP=0x00100000000528a3
- (void)dealloc;	// IMP=0x0010000000052835
