...
+ (id)writeConfigurationState:(long long)arg1 toService:(id)arg2;	// IMP=0x00100000000240e2
+ (id)writeVisibilityState:(id)arg1 toInputSourceService:(id)arg2;	// IMP=0x0010000000023d3f
+ (id)disableServices:(id)arg1;	// IMP=0x0010000000023bcc
+ (id)enableServices:(id)arg1;	// IMP=0x0010000000023a59
+ (id)configureServices:(id)arg1 withNames:(id)arg2;	// IMP=0x001000000002376c
+ (id)configureService:(id)arg1 withName:(id)arg2;	// IMP=0x001000000002357c
- (void).cxx_destruct;	// IMP=0x0010000000019bf3
...
- (id)initWithError:(id)arg1;	// IMP=0x001000000001968a
- (id)initWithAccessory:(id)arg1;	// IMP=0x00100000000195c9
- (id)initWithHome:(id)arg1;	// IMP=0x001000000001955a
- (id)updateUserGivenAccessoryName:(id)arg1;	// IMP=0x00100000000193bb
- (_Bool)requiresOwnerToPair;	// IMP=0x0010000000019056
- (id)configureAccessoryWithName:(id)arg1;	// IMP=0x00100000000229af
- (id)configureAccessoryName;	// IMP=0x00100000000228cf
- (id)configureRoom;	// IMP=0x00100000000223ae
- (id)validateNames:(id)arg1;	// IMP=0x00100000000222c9
- (id)validateName:(id)arg1;	// IMP=0x0010000000021df8
