...
- (void).cxx_destruct;	// IMP=0x002000000002ec86
...
- (id)_enablePersonalRequests;	// IMP=0x001000000002e5b4
- (id)_bulletImageWithSystemName:(id)arg1 color:(id)arg2;	// IMP=0x001000000002e4ba
- (id)commitConfiguration;	// IMP=0x001000000002e49a
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x001000000002ddb5
