...
- (void).cxx_destruct;	// IMP=0x0020000000056a1a
...
- (id)shouldSkip;	// IMP=0x0010000000056594
- (_Bool)shouldHideFooterBelowSection:(long long)arg1;	// IMP=0x001000000005658c
- (_Bool)shouldHideHeaderAboveSection:(long long)arg1;	// IMP=0x0010000000056584
- (id)commitConfiguration;	// IMP=0x0010000000056357
- (id)buildItemModuleControllerForModule:(id)arg1;	// IMP=0x0010000000056254
- (void)viewDidLoad;	// IMP=0x001000000005620e
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x0010000000055f48
