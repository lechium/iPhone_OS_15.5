...
- (void).cxx_destruct;	// IMP=0x002000000001bbfe
...
- (_Bool)shouldShowButtonLinkToHomeApp;	// IMP=0x001000000001baba
- (id)launchAdditionalSettings;	// IMP=0x001000000001b5ee
- (id)commitConfiguration;	// IMP=0x001000000001b551
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x001000000001ad72
