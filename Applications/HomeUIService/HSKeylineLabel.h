...
- (void).cxx_destruct;	// IMP=0x002000000003d8d0
...
- (id)lastBaselineAnchor;	// IMP=0x001000000003d60d
- (id)firstBaselineAnchor;	// IMP=0x001000000003d5b9
- (void)setBackgroundColor:(id)arg1;	// IMP=0x001000000003d370
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x001000000003d302
- (struct CGSize)intrinsicContentSize;	// IMP=0x001000000003d2a8
- (void)layoutSubviews;	// IMP=0x001000000003cfbb
- (id)init;	// IMP=0x001000000003caaa
