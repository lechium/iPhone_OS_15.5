...
- (void).cxx_destruct;	// IMP=0x002000000002bf6f
...
- (_Bool)_siriEnabledOnCurrentDevice;	// IMP=0x001000000002bf19
- (id)_disableVoiceRecognition;	// IMP=0x001000000002bc37
- (void)_launchSiriPrivacySheet;	// IMP=0x001000000002bb8b
- (id)commitConfiguration;	// IMP=0x001000000002bb6b
- (void)_handleFooterLabelTouchForOpenURL:(id)arg1;	// IMP=0x001000000002ba05
- (void)viewDidLoad;	// IMP=0x001000000002b708
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x001000000002b50f
