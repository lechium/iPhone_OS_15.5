...
- (void).cxx_destruct;	// IMP=0x002000000000277c
...
- (id)commitConfiguration;	// IMP=0x00100000000026e9
@property(readonly, nonatomic) id <HFIconDescriptor> iconDescriptor;
- (void)viewDidLoad;	// IMP=0x00100000000025ce
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x00100000000024c0
