...
+ (id)allKeys;	// IMP=0x00400000006183b1
- (void).cxx_destruct;	// IMP=0x00200000006194c5
...
- (_Bool)isEqualToState:(id)arg1;	// IMP=0x00100000006192c0
@property(readonly, nonatomic) CDStruct_8024420c engineTypes;
- (void)updateWithInfo:(id)arg1;	// IMP=0x0010000000618b76
- (id)_augmentVehicleInfo:(id)arg1;	// IMP=0x0010000000618a12
- (void)_augmentMutableVehicleInfo:(id)arg1;	// IMP=0x0010000000618772
- (id)initWithAccessory:(id)arg1;	// IMP=0x001000000061852c
- (id)descriptionForKey:(id)arg1;	// IMP=0x0010000000618401
