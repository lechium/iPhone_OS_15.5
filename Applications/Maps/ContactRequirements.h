...
- (_Bool)nameRequired;	// IMP=0x00100000005ad645
- (id)initWithNameRequired:(_Bool)arg1 phoneNumberRequired:(_Bool)arg2 emailAddressRequired:(_Bool)arg3;	// IMP=0x00100000005ad5f4
