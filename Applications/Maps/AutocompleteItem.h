...
+ (id)keysForServerCompletion:(id)arg1;	// IMP=0x00200000001b9992
- (void).cxx_destruct;	// IMP=0x00200000001ba1d4
...
- (id)leafPersonalizedAutocompleteItems;	// IMP=0x00100000001ba0e4
...
- (id)_searchItemForString:(id)arg1;	// IMP=0x00100000001b9eba
- (id)initWithPersonalizedItem:(id)arg1 matchInfo:(id)arg2;	// IMP=0x00100000001b9749
- (id)initWithLocalCompletion:(id)arg1 sourceType:(long long)arg2 sourceSubtype:(long long)arg3 matchInfo:(id)arg4;	// IMP=0x00100000001b9729
- (id)initWithLocalCompletion:(id)arg1 sourceType:(long long)arg2 sourceSubtype:(long long)arg3 hasPriorityOverride:(_Bool)arg4 priorityOverride:(long long)arg5 matchInfo:(id)arg6;	// IMP=0x00100000001b8b16
- (id)initWithServerCompletion:(id)arg1 hasPriorityOverride:(_Bool)arg2 priorityOverride:(long long)arg3 serverResultScoreMetadata:(id)arg4;	// IMP=0x00100000001b8976
- (id)init;	// IMP=0x00100000001b8968
