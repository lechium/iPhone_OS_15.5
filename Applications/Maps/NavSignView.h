...
- (void).cxx_destruct;	// IMP=0x0010000000889901
...
- (double)_calculateInterLabelConstraintConstant;	// IMP=0x001000000088919a
- (void)_configureLabels;	// IMP=0x0010000000888be9
...
- (void)_updateConstraints;	// IMP=0x00100000008883c6
- (void)_setupConstraints;	// IMP=0x0010000000887a10
- (void)_updateLabelText;	// IMP=0x0010000000887a0a
- (void)_setupSubviews;	// IMP=0x001000000088774c
@property(readonly, nonatomic) id <NavSignLayoutDelegate> _defaultSignLayoutDelegate;
- (void)navSignLabel:(id)arg1 didSelectAlternate:(unsigned long long)arg2;	// IMP=0x001000000088773e
- (void)layoutSubviews;	// IMP=0x001000000088735f
- (void)updateTheme;	// IMP=0x0010000000887236
@property(nonatomic) double maxHeight;
- (void)setSignLayoutDelegate:(id)arg1 withAnimation:(id)arg2;	// IMP=0x0010000000887038
...
- (void)refreshSign;	// IMP=0x0010000000886d94
- (void)clearContent;	// IMP=0x0010000000886d00
- (void)_maps_commonInit;	// IMP=0x0010000000886c89
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000886c3d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000886be0
