...
- (void).cxx_destruct;	// IMP=0x00200000001a353e
...
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x00100000001a2f95
- (id)_alternateMapViewContext;	// IMP=0x00100000001a2f83
- (_Bool)isComplete;	// IMP=0x00100000001a2ccd
...
- (void)setCorrectedName:(id)arg1;	// IMP=0x00100000001a29e9
