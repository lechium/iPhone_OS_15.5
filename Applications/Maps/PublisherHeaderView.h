...
- (void).cxx_destruct;	// IMP=0x00200000001d6829
...
- (void)headerViewButtonTapped:(id)arg1;	// IMP=0x00100000001d6617
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00100000001d6559
- (void)setupConstraints;	// IMP=0x00100000001d5d1f
- (void)setupHeaderContainerView;	// IMP=0x00100000001d59c5
- (void)updateImage;	// IMP=0x00100000001d588c
- (void)setupStackView;	// IMP=0x00100000001d565c
- (void)setupSubviews;	// IMP=0x00100000001d55bb
- (double)minimumRequiredHeight;	// IMP=0x00100000001d5592
- (double)maximumRequiredHeight;	// IMP=0x00100000001d5569
- (void)adjustLogoImageViewTopConstraint:(double)arg1;	// IMP=0x00100000001d54d8
- (void)headerHeightChangedWithNewYOffset:(double)arg1;	// IMP=0x00100000001d5326
- (void)resetLogoHeight;	// IMP=0x00100000001d524f
- (id)initWithDelegate:(id)arg1 usingPublisherAttribution:(id)arg2 usingAnalyticsManager:(id)arg3;	// IMP=0x00100000001d514d
