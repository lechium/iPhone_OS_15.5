...
- (void).cxx_destruct;	// IMP=0x00200000005b9c2f
...
- (void)layoutSubviews;	// IMP=0x00100000005b9936
@property(readonly, nonatomic) UIImageView *shieldImageView;
@property(readonly, nonatomic) GuidanceManeuverView *maneuverView;
- (void)updateStyleForTheme;	// IMP=0x00100000005b9314
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000005b9188
