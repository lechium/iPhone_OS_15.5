...
- (void).cxx_destruct;	// IMP=0x002000000069be6d
...
- (void)applyToCorrectedSearch:(id)arg1;	// IMP=0x001000000069bc30
- (void)cancel;	// IMP=0x001000000069bbdd
- (id)_revGeoTicketForCurrentLocation:(id)arg1 traits:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 networkActivityHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000069bad9
- (void)submitWithTraits:(id)arg1 completionHandler:(CDUnknownBlockType)arg2 networkActivityHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000069b7b0
- (id)initWithLocationManager:(id)arg1;	// IMP=0x001000000069b745
