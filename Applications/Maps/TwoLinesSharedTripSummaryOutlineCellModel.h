...
- (void).cxx_destruct;	// IMP=0x0000000000a91a83
@property(readonly, nonatomic) SharedTripSummary *sharedTripSummary; // @synthesize sharedTripSummary=_sharedTripSummary;
- (id)accessoryModels;	// IMP=0x0010000000a91a5d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000a91938
@property(readonly) unsigned long long hash;
- (id)initWithSharedTripSummary:(id)arg1 accessoryModels:(id)arg2 backgroundModel:(id)arg3;	// IMP=0x0010000000a91761
