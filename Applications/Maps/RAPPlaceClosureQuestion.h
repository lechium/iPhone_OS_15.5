...
- (void).cxx_destruct;	// IMP=0x00200000006acd43
...
- (id)_geoBusinessHours;	// IMP=0x00100000006acca3
- (void)_setupSubmissionParameters:(id)arg1;	// IMP=0x00100000006acb5d
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x00100000006ac995
- (_Bool)isComplete;	// IMP=0x00100000006ac962
@property(readonly, nonatomic) RAPCommentQuestion *commentQuestion; // @synthesize commentQuestion=_commentQuestion;
- (int)closureTypeAction;	// IMP=0x00100000006ac7d2
- (void)_captureAnalytics;	// IMP=0x00100000006ac75e
