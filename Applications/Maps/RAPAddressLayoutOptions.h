...
+ (id)allFieldsDisabledOptions;	// IMP=0x0020000000419137
+ (id)allFieldsEnabledOptions;	// IMP=0x00100000004190d8
+ (id)clientOverrideOptions;	// IMP=0x0010000000419049
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000041926c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004191cb
- (id)init;	// IMP=0x001000000041918d
