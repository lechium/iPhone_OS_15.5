...
+ (id)updatedGuidanceWithPreviousGuidance:(id)arg1 currentGuidance:(id)arg2;	// IMP=0x00400000000f0fb4
- (void).cxx_destruct;	// IMP=0x00200000000f218f
...
- (void)_setNeedsChangeNotification;	// IMP=0x00100000000f1eab
- (void)_notifyObserversWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000f1d74
- (id)description;	// IMP=0x00100000000f1792
- (void)removeGuidanceObserver:(id)arg1;	// IMP=0x00100000000f177c
- (void)addGuidanceObserver:(id)arg1;	// IMP=0x00100000000f1766
- (_Bool)matchesManeuver:(int)arg1 minorTextAlternatives:(id)arg2;	// IMP=0x00100000000f165e
- (_Bool)matchesManeuver:(int)arg1 minorTextAlternatives:(id)arg2 shieldInfo:(id)arg3;	// IMP=0x00100000000f14c8
@property(retain, nonatomic) MKServerFormattedString *minorText;
@property(retain, nonatomic) MKServerFormattedString *majorText;
- (id)initWithSignID:(id)arg1 maneuverArtwork:(id)arg2 majorTextAlternatives:(id)arg3 minorTextAlternatives:(id)arg4 shieldInfo:(id)arg5;	// IMP=0x00100000000f113a
