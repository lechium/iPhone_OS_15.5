...
- (void).cxx_destruct;	// IMP=0x00200000005916de
...
- (void)setupHeaderView;	// IMP=0x0010000000591461
- (void)_setMaskOnNavigationBar:(id)arg1;	// IMP=0x0010000000591241
- (void)setupContainerViewWithRootViewController:(id)arg1;	// IMP=0x0010000000590d18
- (void)setScrollContentOffset:(struct CGPoint)arg1;	// IMP=0x0010000000590cba
- (void)popViewController;	// IMP=0x0010000000590c70
- (_Bool)viewControllerUseExtensionFlowHeader:(id)arg1;	// IMP=0x0010000000590c07
- (void)pushViewController:(id)arg1;	// IMP=0x001000000059091f
- (void)handleDismissAction:(id)arg1;	// IMP=0x0010000000590781
- (void)viewDidLoad;	// IMP=0x00100000005906a8
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0010000000590599
- (id)init;	// IMP=0x0010000000590583
