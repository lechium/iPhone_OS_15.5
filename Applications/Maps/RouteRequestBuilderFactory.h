...
- (void).cxx_destruct;	// IMP=0x0020000000171b9c
...
- (id)_routeAttributesBuilders;	// IMP=0x00100000001719c9
- (id)makeRouteRequestBuilder;	// IMP=0x00100000001718c8
...
- (id)initWithTransportTypeRequestInfoProvider:(id)arg1 waypointSet:(id)arg2;	// IMP=0x001000000017158d
