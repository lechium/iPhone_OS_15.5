...
- (void).cxx_destruct;	// IMP=0x0020000000a97430
...
- (id)_routeInArray:(id)arg1 matchingComposedRoute:(id)arg2;	// IMP=0x0010000000a97036
- (id)routeForComposedRoute:(id)arg1;	// IMP=0x0010000000a96fb9
- (id)trafficIncidentsUsingSelectedRoute:(id)arg1 includeUnselectedRoutes:(_Bool)arg2;	// IMP=0x0010000000a96c93
- (void)_conflateWalkingAndDrivingRoutes;	// IMP=0x0010000000a96160
- (CDStruct_c3b9c2ee)_mapPointForRoute:(id)arg1 atIndex:(unsigned int)arg2;	// IMP=0x0010000000a960bd
...
- (id)description;	// IMP=0x0010000000a95acc
- (id)initWithRoutes:(id)arg1;	// IMP=0x0010000000a956ee
- (id)initWithGEOComposedRoutes:(id)arg1;	// IMP=0x0010000000a9559d
