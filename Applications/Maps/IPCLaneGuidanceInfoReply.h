...
+ (id)ipcReplyForLaneGuidanceInfo:(id)arg1;	// IMP=0x0020000000889edb
- (void).cxx_destruct;	// IMP=0x00100000001794d6
...
- (id)description;	// IMP=0x00100000001792f4
- (id)dictionaryValue;	// IMP=0x0010000000179068
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000178ded
- (id)laneGuidanceInfo;	// IMP=0x001000000088a006
