...
- (void).cxx_destruct;	// IMP=0x0020000000709412
...
- (id)_collectionItemImage;	// IMP=0x0010000000709208
@property(readonly, copy, nonatomic) NSString *imageAttribution;
- (void)cancelImageDownload;	// IMP=0x0010000000708e63
- (void)loadImageForSize:(struct CGSize)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000708c96
...
- (id)initWithMKPlaceCollectionMapItem:(id)arg1 usingAttribution:(id)arg2 itemDescription:(id)arg3 itemInUserCollection:(_Bool)arg4 appClip:(id)arg5;	// IMP=0x00100000007087fd
