...
- (void).cxx_destruct;	// IMP=0x0020000000a805fb
@property(retain, nonatomic) GEOURLCollectionStorage *collectionStorage; // @synthesize collectionStorage=_collectionStorage;
- (_Bool)isCompatibleWithRestorationTask;	// IMP=0x0010000000a805ce
- (_Bool)isCompatibleWithNavigation;	// IMP=0x0010000000a805c6
- (id)initWithCollectionStorage:(id)arg1;	// IMP=0x0010000000a80558
