...
+ (double)heightForItem:(id)arg1 width:(double)arg2;	// IMP=0x00400000005e4995
- (void).cxx_destruct;	// IMP=0x00200000005e58ea
...
- (void)setItem:(id)arg1;	// IMP=0x00100000005e4fe4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000005e3989
