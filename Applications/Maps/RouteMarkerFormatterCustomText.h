...
- (void).cxx_destruct;	// IMP=0x00200000003313e0
...
- (id)markerInfoForRoute:(id)arg1;	// IMP=0x00100000003312ce
- (id)initWithRoutes:(id)arg1 selectedRouteIndex:(unsigned long long)arg2 customSelectedRouteText:(id)arg3;	// IMP=0x001000000033120f
