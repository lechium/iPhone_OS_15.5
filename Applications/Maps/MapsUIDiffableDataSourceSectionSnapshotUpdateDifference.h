...
- (void).cxx_destruct;	// IMP=0x0020000000329efa
...
- (id)initWithReloadedItems:(id)arg1 insertedItems:(id)arg2 deletedItems:(id)arg3 movedItems:(id)arg4 expandedItems:(id)arg5 collapsedItems:(id)arg6;	// IMP=0x0010000000329ccc
