...
- (void).cxx_destruct;	// IMP=0x002000000025310b
...
- (_Bool)updateSegmentsIfNeededToFitWidth:(double)arg1;	// IMP=0x0010000000252fd1
@property(nonatomic) long long selectedViewMode;
- (id)initWithDesiredViewModes:(id)arg1;	// IMP=0x0010000000252821
- (id)init;	// IMP=0x0010000000252808
