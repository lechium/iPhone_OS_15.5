...
- (void).cxx_destruct;	// IMP=0x00200000004e3249
...
- (void)recordItemInHistoryWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000004e2ce3
- (void)recordItemInHistory;	// IMP=0x00100000004e2ccf
- (id)initWithTicket:(id)arg1 searchResults:(id)arg2 auxiliaryControlsOrigin:(long long)arg3 hasRefinedMapItems:(_Bool)arg4 tracksRAPReportingOnly:(_Bool)arg5 completionTitle:(id)arg6;	// IMP=0x00100000004e2b8a
