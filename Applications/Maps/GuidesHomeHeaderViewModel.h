...
- (void).cxx_destruct;	// IMP=0x0010000000a63140
...
- (void)publisherLogoImageWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000a62fe2
- (id)initWithGuideLocation:(id)arg1 featuredGuide:(id)arg2 sectionTitle:(id)arg3;	// IMP=0x0010000000a62ab8
- (void)collectionImageForSize:(struct CGSize)arg1 onCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000a631c0
