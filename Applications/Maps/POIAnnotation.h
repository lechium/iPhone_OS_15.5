...
@class AddressBookAddress, GEOFeatureStyleAttributes, MKMapItem, NSSet, NSString, PersonalizedCompoundItem, PersonalizedItemStyleAttributesAdornment, SearchResult, VKCustomFeature, VKLabelMarker;
...
- (void).cxx_destruct;	// IMP=0x0020000000a532f8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000a531c3
- (id)debugDictionary;	// IMP=0x0010000000a53048
...
// Error: Property attributes should begin with the type ('T') attribute, property name: parkedCar
// Property attributes: (null)

@property(readonly, nonatomic) MKMapItem *mapItem;
- (id)feature;	// IMP=0x0010000000a52f1a
- (id)initWithItem:(id)arg1 defaultLocale:(id)arg2;	// IMP=0x0010000000a5208e
