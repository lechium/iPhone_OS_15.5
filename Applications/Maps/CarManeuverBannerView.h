...
- (void).cxx_destruct;	// IMP=0x00200000008e65a1
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00100000008e6561
- (void)updateFromBannerItem;	// IMP=0x00100000008e58be
- (id)maneuverItem;	// IMP=0x00100000008e58ac
- (id)initWithTarget:(id)arg1 item:(id)arg2;	// IMP=0x00100000008e4bd9
