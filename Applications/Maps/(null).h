...
- (void).cxx_destruct;	// IMP=0x00200000007f7ccd
...
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x00100000007f7953
- (id)tableView:(id)arg1 willSelectRowAtIndexPath:(id)arg2;	// IMP=0x00100000007f78f0
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x00100000007f759d
- (void)tableView:(id)arg1 willDisplayCell:(id)arg2 forRowAtIndexPath:(id)arg3;	// IMP=0x00100000007f7556
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x00100000007f74b7
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x00100000007f7411
- (id)titleForSection:(long long)arg1;	// IMP=0x00100000007f720b
- (_Bool)hasStatusMessageToShow;	// IMP=0x00100000007f717f
- (_Bool)isLoading;	// IMP=0x00100000007f70f7
- (void)shouldDismissForHorizontalSwipe_nonUIKitCardsOnly;	// IMP=0x00100000007f70e2
- (struct CGSize)calculatePreferredContentSize;	// IMP=0x00100000007f6fc4
- (void)updatePreferredContentSize;	// IMP=0x00100000007f6f45
- (void)handleDismissAction:(id)arg1;	// IMP=0x00100000007f6e95
- (int)currentMapViewTargetForAnalytics;	// IMP=0x00100000007f6e8a
- (int)currentUITargetForAnalytics;	// IMP=0x00100000007f6e7f
- (void)headerViewTapped:(id)arg1;	// IMP=0x00100000007f6e42
- (void)headerViewButtonTapped:(id)arg1;	// IMP=0x00100000007f6e30
- (void)_determineShieldsFromLines;	// IMP=0x00100000007f6779
- (void)setLines:(id)arg1;	// IMP=0x00100000007f624f
- (void)viewDidLoad;	// IMP=0x00100000007f5462
