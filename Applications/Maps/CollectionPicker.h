...
- (void).cxx_destruct;	// IMP=0x0020000000150d6f
...
- (void)collectionPickerViewController:(id)arg1 unselectCollection:(id)arg2;	// IMP=0x0010000000150cc8
- (void)collectionPickerViewController:(id)arg1 selectCollection:(id)arg2;	// IMP=0x00100000001508eb
- (void)cleanControllers;	// IMP=0x00100000001508b2
@property(readonly, nonatomic) UIViewController *viewController;
- (id)initWithCollectionEditSession:(id)arg1 sourceView:(id)arg2 sourceRect:(struct CGRect)arg3;	// IMP=0x00100000001503f6
