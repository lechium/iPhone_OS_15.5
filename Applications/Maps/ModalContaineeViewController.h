...
- (void).cxx_destruct;	// IMP=0x00200000002d7966
...
- (void)headerViewCloseTapped:(id)arg1;	// IMP=0x00100000002d78b7
- (void)_dismissContainee;	// IMP=0x00100000002d77da
- (void)shoulDismissForVerticalSwipe_nonUIKitCardsOnly;	// IMP=0x00100000002d77c8
- (double)heightForLayout:(unsigned long long)arg1;	// IMP=0x00100000002d76f8
- (void)willChangeContainerStyle:(unsigned long long)arg1;	// IMP=0x00100000002d7635
- (void)handleDismissAction:(id)arg1;	// IMP=0x00100000002d7623
- (void)willTransitionToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x00100000002d752d
- (void)_setupConstraints;	// IMP=0x00100000002d6f23
- (void)_setupViews;	// IMP=0x00100000002d6d57
@property(readonly, nonatomic) ModalCardHeaderView *headerView; // @synthesize headerView=_headerView;
- (id)contentView;	// IMP=0x00100000002d6b02
- (void)viewDidLoad;	// IMP=0x00100000002d6a7b
- (id)initWithChildViewController:(id)arg1 visualEffectDisabled:(_Bool)arg2 headerViewConfigurationProvider:(CDUnknownBlockType)arg3;	// IMP=0x00100000002d68e7
- (id)initWithChildViewController:(id)arg1 visualEffectDisabled:(_Bool)arg2;	// IMP=0x00100000002d680b
- (id)initWithChildViewController:(id)arg1;	// IMP=0x00100000002d67f7
- (_Bool)_canShowWhileLocked;	// IMP=0x00100000002d67ef
