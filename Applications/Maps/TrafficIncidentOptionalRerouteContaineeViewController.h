...
- (void).cxx_destruct;	// IMP=0x0020000000215c8d
...
- (void)userDecisionConfirmationViewDidConfirm:(id)arg1;	// IMP=0x0010000000215a9e
- (void)userDecisionConfirmationViewDidCancel:(id)arg1;	// IMP=0x00100000002158aa
- (double)heightForLayout:(unsigned long long)arg1;	// IMP=0x00100000002157f9
@property(nonatomic) _Bool progressBarHidden;
@property(nonatomic) double rerouteTimerProgress;
- (void)_setupConstraints;	// IMP=0x0010000000215399
- (void)viewDidLoad;	// IMP=0x00100000002152c1
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0010000000215292
- (_Bool)_canShowWhileLocked;	// IMP=0x001000000021528a
