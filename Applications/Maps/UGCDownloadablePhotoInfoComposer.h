...
+ (id)downloadablePhotoForUGCPhoto:(id)arg1;	// IMP=0x00200000001b566b
+ (id)downloadablePhotoForGeoMapItemPhotoInfo:(id)arg1;	// IMP=0x00100000001b55d9
- (void).cxx_destruct;	// IMP=0x00200000001b5740
...
- (id)initWithIdentifier:(id)arg1 url:(id)arg2 timeoutInterval:(double)arg3;	// IMP=0x00100000001b5531
