...
- (void).cxx_destruct;	// IMP=0x0020000000516244
...
- (void)platformController:(id)arg1 didChangeCurrentSessionFromSession:(id)arg2 toSession:(id)arg3;	// IMP=0x0010000000516141
- (void)platformController:(id)arg1 willChangeCurrentSessionFromSession:(id)arg2 toSession:(id)arg3;	// IMP=0x001000000051613b
- (void)removeiOSPlatformController:(id)arg1;	// IMP=0x0010000000516095
- (id)addActiveiOSPlatformControllerForScene:(id)arg1;	// IMP=0x0010000000515f7b
@property(readonly, nonatomic) CoverSheetSceneAssociation *currentlyNavigatingCoverSheetSceneAssociation;
- (id)init;	// IMP=0x0010000000515dc6
