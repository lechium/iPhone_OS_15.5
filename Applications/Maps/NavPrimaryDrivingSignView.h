...
- (void).cxx_destruct;	// IMP=0x00200000006352e6
...
- (id)debugDescription;	// IMP=0x001000000063519d
- (void)_animateTransitioningFromOldLaneGuidance:(id)arg1;	// IMP=0x0010000000634ce3
- (void)_animateShowingLaneGuidanceView;	// IMP=0x00100000006349ae
- (void)hideLaneGuidanceAnimated:(_Bool)arg1;	// IMP=0x0010000000634797
- (void)showLaneGuidance:(id)arg1 animated:(_Bool)arg2;	// IMP=0x00100000006342f0
- (void)updateLaneGuidance:(id)arg1;	// IMP=0x00100000006342a8
- (_Bool)highlightedLanesNotInVisibleRange;	// IMP=0x001000000063422a
@property(readonly, nonatomic) UIView *viewForSecondarySignTextToAlignLeading;
@property(nonatomic) _Bool debugHighlightLanes;
- (void)clearContent;	// IMP=0x0010000000633ffa
- (void)_updateLabelText;	// IMP=0x0010000000633dfe
- (void)_updateConstraints;	// IMP=0x001000000063393b
- (void)_setupConstraints;	// IMP=0x0010000000633507
- (void)refreshSign;	// IMP=0x0010000000633451
- (void)_setupSubviews;	// IMP=0x0010000000633392
- (id)_defaultSignLayoutDelegate;	// IMP=0x0010000000633379
