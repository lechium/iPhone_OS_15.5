...
- (void).cxx_destruct;	// IMP=0x00200000009dbafc
...
- (id)initWithRouteDescription:(id)arg1 etaComparison:(unsigned char)arg2 tollCurrency:(unsigned char)arg3 styleAttributes:(id)arg4;	// IMP=0x00100000009dba19
