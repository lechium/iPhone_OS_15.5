...
+ (struct CGSize)preferredSize;	// IMP=0x0040000000826c6b
- (void).cxx_destruct;	// IMP=0x0020000000826ca1
...
- (void)dismissWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000826a6c
- (void)present;	// IMP=0x0010000000826912
- (id)initWithTrackingStateReason:(unsigned long long)arg1;	// IMP=0x0010000000825e3c
