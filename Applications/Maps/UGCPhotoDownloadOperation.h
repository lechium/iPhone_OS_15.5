...
- (void)cancel;	// IMP=0x00100000001b634d
- (_Bool)isFinished;	// IMP=0x00100000001b633d
- (_Bool)isExecuting;	// IMP=0x00100000001b632d
- (void)_completeOperation;	// IMP=0x00100000001b6200
- (void)main;	// IMP=0x00100000001b5f36
- (void)start;	// IMP=0x00100000001b5e88
- (id)initWithPhotoInfo:(id)arg1 completionQueue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000001b5d98
