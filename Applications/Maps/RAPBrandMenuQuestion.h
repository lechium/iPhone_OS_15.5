...
- (void).cxx_destruct;	// IMP=0x002000000049e9b1
@property(readonly, nonatomic) id <RAPPlace> reportedPlace; // @synthesize reportedPlace=_reportedPlace;
- (id)followUpQuestionForCategory:(long long)arg1;	// IMP=0x001000000049e8ae
@property(readonly, nonatomic) MKMapItem *snippetMapItem;
@property(readonly, nonatomic) long long snippetStyle;
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x001000000049e73d
@property(readonly, nonatomic) _Bool shouldLoadClaimThisBusiness;
- (id)mainMenuItems;	// IMP=0x001000000049e64d
@property(readonly, nonatomic) int analyticTarget;
- (id)initWithReport:(id)arg1 parentQuestion:(id)arg2 reportedPlace:(id)arg3;	// IMP=0x001000000049e5c0
- (id)initWithReport:(id)arg1 reportedPlace:(id)arg2;	// IMP=0x001000000049e5a9
