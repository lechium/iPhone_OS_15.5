...
+ (id)taskForURL:(id)arg1 referringURL:(id)arg2 sourceApplication:(id)arg3 sceneOptions:(id)arg4 mkOptions:(id)arg5 windowSize:(struct CGSize)arg6;	// IMP=0x0040000000356140
- (void).cxx_destruct;	// IMP=0x0020000000356de8
...
- (void)taskFailed;	// IMP=0x0010000000356c8a
- (void)taskFinished:(id)arg1;	// IMP=0x0010000000356c49
- (id)urlScheme;	// IMP=0x0010000000356b4c
- (void)_sendAnalytics;	// IMP=0x0010000000356a90
- (void)_populateSessionAnalytics;	// IMP=0x00100000003568a7
- (id)initWithURL:(id)arg1 referringURL:(id)arg2 sourceApplication:(id)arg3 sceneOptions:(id)arg4 mkOptions:(id)arg5;	// IMP=0x001000000035677d
