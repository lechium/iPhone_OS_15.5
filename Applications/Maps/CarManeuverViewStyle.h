...
+ (id)styleWithVariant:(unsigned long long)arg1 destination:(unsigned long long)arg2 layoutType:(unsigned long long)arg3;	// IMP=0x002000000095ebe8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000095f227
...
- (_Bool)_isDisplayedInWidget;	// IMP=0x001000000095ec41
@property(readonly, nonatomic) _Bool displaysShield;
- (id)initWithVariant:(unsigned long long)arg1 destination:(unsigned long long)arg2 layoutType:(unsigned long long)arg3;	// IMP=0x001000000095eb8e
