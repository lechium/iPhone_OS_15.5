...
- (void).cxx_destruct;	// IMP=0x00200000007f21a6
...
- (void)_setupCustomFeatureForMapItem;	// IMP=0x00100000007f1dfb
- (void)_setupCustomFeatureStore;	// IMP=0x00100000007f1dc0
- (void)_selectCustomFeature:(id)arg1;	// IMP=0x00100000007f1d46
- (id)mapItem;	// IMP=0x00100000007f1d34
@property(readonly, nonatomic) NSArray *excludedActivityTypes;
- (void)setActivityProviderDelegate:(id)arg1;	// IMP=0x00100000007f1bdb
...
- (id)initWithRoute:(id)arg1 startPOIShape:(id)arg2 endPOIShape:(id)arg3 includeRoutingApps:(_Bool)arg4;	// IMP=0x00100000007f1083
