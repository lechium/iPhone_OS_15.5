...
- (void).cxx_destruct;	// IMP=0x0020000000a9149e
@property(readonly, nonatomic) SearchResult *searchResult; // @synthesize searchResult=_searchResult;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000a913aa
@property(readonly) unsigned long long hash;
- (id)initWithSearchResult:(id)arg1 backgroundModel:(id)arg2;	// IMP=0x0010000000a911fb
