...
@interface RAPMapState : NSObject
{
    ...
    id <RAPMuninContext> _reportedMuninContext;	// 88 = 0x58
    id <RAPPlacecardImageryContext> _placecardImageryContext;	// 96 = 0x60
}

- (void).cxx_destruct;	// IMP=0x00200000004cf787
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000004cef82
- (id)copyWithReportedPlace:(id)arg1;	// IMP=0x00100000004cef41
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004cedf7
- (id)initWithMapView:(id)arg1 traits:(id)arg2 place:(id)arg3;	// IMP=0x00100000004cec3a
- (id)initWithTraits:(id)arg1;	// IMP=0x00100000004cebcf
