...
- (void).cxx_destruct;	// IMP=0x0020000000215e4b
@property(readonly, copy, nonatomic) IPCGuidanceStateReply *guidanceState; // @synthesize guidanceState=_guidanceState;
- (void)updateFromGuidanceState:(id)arg1;	// IMP=0x0010000000215d8f
@property(readonly, copy, nonatomic) NSString *uniqueId;
- (id)description;	// IMP=0x0010000000215d40
- (id)initWithGuidanceState:(id)arg1;	// IMP=0x0010000000215ccd
