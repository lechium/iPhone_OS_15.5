...
- (void).cxx_destruct;	// IMP=0x00200000009d8097
...
- (void)addUserPathItem:(int)arg1;	// IMP=0x00100000009d7e54
- (_Bool)isComplete;	// IMP=0x00100000009d7e42
- (void)submitRAPWithWillSubmitBlock:(CDUnknownBlockType)arg1 didSubmitBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000009d7bce
- (void)rapCompleted:(_Bool)arg1 privacyShown:(_Bool)arg2 analyticsEvent:(id)arg3;	// IMP=0x00100000009d7ba8
- (_Bool)isAdjustedCoordinateBeyondThreshold;	// IMP=0x00100000009d7a90
- (id)_geoCoordinateFromUserCorrections;	// IMP=0x00100000009d798d
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x00100000009d7157
@property(readonly, nonatomic) struct CLLocationCoordinate2D currentCoordinate;
- (id)initWithReport:(id)arg1 parentQuestion:(id)arg2 shortcut:(id)arg3;	// IMP=0x00100000009d6e8a
