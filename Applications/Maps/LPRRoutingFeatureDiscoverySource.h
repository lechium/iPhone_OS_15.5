...
- (void).cxx_destruct;	// IMP=0x0020000000573884
...
- (void)virtualGarageDidUpdate:(id)arg1;	// IMP=0x0010000000573718
- (void)valueChangedForGEOConfigKey:(CDStruct_065526f1)arg1;	// IMP=0x00100000005736f3
- (void)_reloadAvailability;	// IMP=0x001000000057358d
- (unsigned long long)numberOfLPRLVehicles;	// IMP=0x00100000005733fa
- (void)_didSelectModel;	// IMP=0x00100000005732bd
- (void)_didViewModel;	// IMP=0x00100000005730c6
- (void)_dismiss;	// IMP=0x0010000000572f8b
@property(readonly, nonatomic) FeatureDiscoveryModel *model;
@property(nonatomic, getter=isAvailable) _Bool available;
- (void)setTransportType:(long long)arg1 routeCollection:(id)arg2;	// IMP=0x00100000005727f8
- (void)dealloc;	// IMP=0x00100000005727c2
- (id)initWithPriority:(long long)arg1 delegate:(id)arg2;	// IMP=0x00100000005723c9
