...
- (void).cxx_destruct;	// IMP=0x0020000000139d6d
...
- (id)leafPersonalizedAutocompleteItems;	// IMP=0x0010000000139c92
...
- (id)suggestion;	// IMP=0x0010000000139519
...
- (id)initWithSuggestion:(id)arg1 order:(unsigned short)arg2 sourceType:(long long)arg3 sourceSubtype:(long long)arg4 hasPriorityOverride:(_Bool)arg5 priorityOverride:(long long)arg6;	// IMP=0x0010000000139144
