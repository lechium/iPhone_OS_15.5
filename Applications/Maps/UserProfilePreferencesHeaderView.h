...
- (void).cxx_destruct;	// IMP=0x00200000007c8881
@property(nonatomic, getter=isCollapsed) _Bool collapsed; // @synthesize collapsed=_collapsed;
@property(nonatomic, getter=isFooter) _Bool footer; // @synthesize footer=_footer;
@property(readonly, nonatomic) UILabel *textLabel; // @synthesize textLabel=_textLabel;
- (void)_updateForFooter;	// IMP=0x00100000007c87e2
- (void)setHidden:(_Bool)arg1;	// IMP=0x00100000007c8797
- (void)_updateForCollapsed;	// IMP=0x00100000007c86d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000007c82ec
