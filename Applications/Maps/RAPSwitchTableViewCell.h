...
- (void).cxx_destruct;	// IMP=0x0020000000659de5
...
- (void)updateSwitchState:(_Bool)arg1;	// IMP=0x0010000000659d68
- (void)updateValue:(id)arg1;	// IMP=0x0010000000659ce9
@property(readonly, nonatomic) long long kind;
- (void)_updateContent;	// IMP=0x0010000000659c27
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2 delegate:(id)arg3;	// IMP=0x0010000000659abd
