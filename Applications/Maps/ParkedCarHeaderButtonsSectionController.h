...
- (void).cxx_destruct;	// IMP=0x002000000098e306
@property(nonatomic) __weak id <ParkedCarHeaderButtonsDelegate> actionDelegate; // @synthesize actionDelegate=_actionDelegate;
- (id)sectionView;	// IMP=0x001000000098e221
- (void)placeHeaderButtonsViewController:(id)arg1 didSelectPrimaryType:(unsigned long long)arg2 withPresentationOptions:(id)arg3;	// IMP=0x001000000098e1c4
- (void)_commonInit;	// IMP=0x001000000098df86
- (id)initWithParkedCar:(id)arg1;	// IMP=0x001000000098df3a
