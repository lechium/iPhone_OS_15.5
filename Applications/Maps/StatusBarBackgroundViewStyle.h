...
+ (id)defaultBlurredStyleWithDefaultColorProvider:(CDUnknownBlockType)arg1;	// IMP=0x004000000036f171
- (void).cxx_destruct;	// IMP=0x002000000036f753
...
- (unsigned long long)hash;	// IMP=0x001000000036f645
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000036f456
- (id)description;	// IMP=0x001000000036f382
- (id)initWithGaussianBlurRadius:(double)arg1 defaultColorProvider:(CDUnknownBlockType)arg2 disableBlur:(_Bool)arg3;	// IMP=0x001000000036f2f5
- (id)initWithBlurStyle:(long long)arg1 groupName:(id)arg2 defaultColorProvider:(CDUnknownBlockType)arg3 disableBlur:(_Bool)arg4;	// IMP=0x001000000036f237
- (id)initWithColor:(id)arg1;	// IMP=0x001000000036f1c4
