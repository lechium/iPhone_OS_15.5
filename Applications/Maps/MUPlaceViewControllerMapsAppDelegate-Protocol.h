...
@class CNContact, CNContactViewController, GEOGuideLocation, GEOMapServiceTraits, GEOPlaceCollection, GEOSearchCategory, MISSING_TYPE, MKActivityViewController, MKMapItem, MKMuninView, MKPlaceCardActionItem, MKPlacePhotoGalleryViewController, MUPlaceViewController, NSArray, NSDictionary, NSNumber, NSString, UIMenu, UIMenuElement, UINavigationController, UIView, UIViewController;
@protocol GEOMapItemPhoto, GEOTransitConnectionInfo, GEOTransitDepartureSequence, MKActivityObserving, MKCuratedCollectionsSyncCoordinator, _MKInfoCardAnalyticsDelegate, _MKPlaceItem;
...
- (void)placeViewController:(MUPlaceViewController *)arg1 didRequestSceneActivationForPhotoGalleryViewController:(MKPlacePhotoGalleryViewController *)arg2;
...
- (void)placeViewController:(MUPlaceViewController *)arg1 didSelectAddPhotosWithObserver:(id <MKActivityObserving>)arg2 sourceView:(UIView *)arg3 shouldAddFromPhotoLibrary:(_Bool)arg4;
...
- (void)placeViewController:(MUPlaceViewController *)arg1 photoGalleryDidScroll:(MKPlacePhotoGalleryViewController *)arg2;
- (void)placeViewController:(MUPlaceViewController *)arg1 didSelectPhotoToReport:(id <GEOMapItemPhoto>)arg2 withPhotoGalleryViewController:(MKPlacePhotoGalleryViewController *)arg3;
...
- (_Bool)shouldMoveMuninStorefrontViewForPlaceViewController:(MUPlaceViewController *)arg1;
- (void)placeViewController:(MUPlaceViewController *)arg1 enterMuninForMapItem:(MKMapItem *)arg2 muninView:(MKMuninView *)arg3;
...
- (MISSING_TYPE *)placeViewController:didSelectTransitLine: /* Error: Ran out of types for this method. */;
...
- (MKActivityViewController *)activityViewControllerForPlaceViewController:(MUPlaceViewController *)arg1;
@end
