...
- (void).cxx_destruct;	// IMP=0x001000000010e1fe
...
- (_Bool)shows;	// IMP=0x001000000010e0f2
// Error: Property attributes should begin with the type ('T') attribute, property name: showsBalloonCallout
...
- (id)initWithSearchResult:(id)arg1;	// IMP=0x001000000010de56
- (id)initWithMapItem:(id)arg1 title:(id)arg2;	// IMP=0x001000000010dca4
- (id)leafPersonalizedAutocompleteItems;	// IMP=0x001000000010e435
