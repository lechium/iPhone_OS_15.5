...
- (void).cxx_destruct;	// IMP=0x002000000078f443
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000078f41b
- (id)initWithControlsGeo:(id)arg1 originatingIndex:(unsigned long long)arg2;	// IMP=0x001000000078f38a
