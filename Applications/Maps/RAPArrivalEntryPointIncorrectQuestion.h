...
- (void).cxx_destruct;	// IMP=0x00200000002de845
...
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x00100000002de3ef
- (_Bool)_isRecursivelyComplete;	// IMP=0x00100000002de39b
...
- (id)initWithReport:(id)arg1 parentQuestion:(id)arg2 arrivalPoint:(struct CLLocationCoordinate2D)arg3;	// IMP=0x00100000002ddf83
