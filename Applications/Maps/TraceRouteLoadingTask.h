...
@interface TraceRouteLoadingTask : NSObject
{
    ...
    TraceWaypointRequest *_destinationWaypointTask;	// 56 = 0x38
}

- (void).cxx_destruct;	// IMP=0x0020000000ad2aae
...
- (void)cancel;	// IMP=0x0010000000ad290a
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000ad2507
@property(readonly, nonatomic) Result *result;
@property(readonly, nonatomic) _Bool inProgress;
- (id)initWithTracePath:(id)arg1 originWaypointTask:(id)arg2;	// IMP=0x0010000000ad20c9
