...
+ (id)title;	// IMP=0x00400000001231dd
+ (id)personalizedItemKey;	// IMP=0x0010000000122bd7
- (void).cxx_destruct;	// IMP=0x00200000001234ff
...
- (void)updateFromVehicleEvent:(id)arg1 geoMapItem:(id)arg2;	// IMP=0x0010000000122d57
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1;	// IMP=0x0010000000122ca2
- (id)initWithVehicleEvent:(id)arg1 geoMapItem:(id)arg2;	// IMP=0x0010000000122bf2
- (id)init;	// IMP=0x0010000000122be4
