...
- (void).cxx_destruct;	// IMP=0x002000000071159f
...
- (void)mapsForegrounded;	// IMP=0x00100000007114a8
- (void)mapsBackgrounded;	// IMP=0x0010000000711496
- (void)endSession;	// IMP=0x001000000071115b
- (void)captureIntent:(int)arg1 withFailure:(int)arg2;	// IMP=0x00100000007110ad
- (void)captureStatusIssue:(long long)arg1;	// IMP=0x00100000007110a3
...
- (id)init;	// IMP=0x0010000000710f79
