...
+ (id)keyPathsForValuesAffectingMapItem;	// IMP=0x004000000078b23a
- (void).cxx_destruct;	// IMP=0x001000000078bd93
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000078b614
@property(readonly, nonatomic) MKMapItem *mapItem;
@property(readonly, nonatomic) id <RAPPlace> rapPlace;
@property(readonly, nonatomic) id <_MKPlaceItem> placeItem;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000078b295
- (id)initWithPersonalizedItem:(id)arg1;	// IMP=0x001000000078b103
- (id)initWithLocationOfInterest:(id)arg1;	// IMP=0x001000000078aef1
- (id)initWithMapItem:(id)arg1 chargeStationWaypointInfo:(id)arg2;	// IMP=0x001000000078ae92
- (id)initWithMapItem:(id)arg1 address:(id)arg2;	// IMP=0x001000000078ae0d
- (id)initWithSearchResult:(id)arg1;	// IMP=0x001000000078aca3
- (id)initWithMapItem:(id)arg1;	// IMP=0x001000000078abef
- (id)init;	// IMP=0x001000000078abe1
- (id)_venueIdentifier;	// IMP=0x00100000003f6182
