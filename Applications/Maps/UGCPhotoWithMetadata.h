...
- (id)initWithImageData:(id)arg1 PHAsset:(id)arg2 sourceType:(long long)arg3;	// IMP=0x00100000001ab3f7
- (id)initWithImageData:(id)arg1 date:(id)arg2 location:(id)arg3 source:(long long)arg4;	// IMP=0x00100000001ab1db
