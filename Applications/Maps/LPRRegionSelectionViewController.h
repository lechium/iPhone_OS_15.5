...
- (void).cxx_destruct;	// IMP=0x002000000048549b
...
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x0010000000484fc4
- (id)tableView:(id)arg1 viewForHeaderInSection:(long long)arg2;	// IMP=0x0010000000484980
- (double);	// IMP=0x0010000000484916
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x00100000004848d2
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x001000000048485e
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x00100000004846b2
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0010000000484608
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000484518
- (void)viewDidLoad;	// IMP=0x001000000048352c
- (id)initWithVehicle:(id)arg1 scenario:(long long)arg2;	// IMP=0x00100000004834b2
