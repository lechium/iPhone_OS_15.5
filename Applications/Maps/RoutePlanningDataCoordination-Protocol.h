...
@class CyclePreferences, DrivePreferences, MISSING_TYPE, NSString, RideBookingRideOptionStateObserverProxy, Route, RouteCollection, RoutePlanningError, RoutePlanningTiming, RoutePlanningWaypointRequest, TransitPreferences, VGVirtualGarage, WaypointSet;
...
- (MISSING_TYPE *)updateVirtualGarage: /* Error: Ran out of types for this method. */;
