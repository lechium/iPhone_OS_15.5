...
@class GEOApplicationAuditToken, GEOAutomobileOptions, GEOCompanionRouteContext, GEOCyclingOptions, GEOMapServiceTraits, GEOTransitOptions, GEOWalkingOptions, MISSING_TYPE, NSDate, NanoDirectionWaypoint;

__attribute__((visibility("hidden")))
@interface NanoRoutePlanningRequest : NSObject
{
    MISSING_TYPE *_startNavigationAutomatically;	// 8 = 0x8
...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000052636e
+ (id)requestForPlaceholderDirections;	// IMP=0x00100000005260cc
+ (id)requestForDirectionsWithCompanionRouteDetails:(id)arg1 companionRouteContext:(id)arg2;	// IMP=0x0010000000525e40
+ (id)requestForDirectionsFromOrigin:(id)arg1 toDestination:(id)arg2 viaTransportType:(unsigned long long)arg3 traits:(id)arg4 companionRouteContext:(id)arg5;	// IMP=0x0010000000525cbd
- (void).cxx_destruct;	// IMP=0x0020000000526abb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000526741
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000526376
- (void)_populateCopy:(id)arg1;	// IMP=0x001000000052629b
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000526267
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000526233
@property(readonly, nonatomic) int resolvedTransportType;
- (id)requestedCompanionRouteDetails;	// IMP=0x001000000052611d
- (id)init;	// IMP=0x0010000000525bb4
