...
- (void).cxx_destruct;	// IMP=0x00200000005a7f75
...
- (void)_incrementPriority;	// IMP=0x00100000005a7c00
- (void)_disappearAndReturn;	// IMP=0x00100000005a7b8d
- (void)_dismiss;	// IMP=0x00100000005a7b41
- (void)_decreaseHeight;	// IMP=0x00100000005a7b0b
- (void)_increaseHeight;	// IMP=0x00100000005a7ad5
- (void)viewDidLayoutSubviews;	// IMP=0x00100000005a7845
- (void)_updateLabel;	// IMP=0x00100000005a76f5
- (id)_buttonWithTitle:(id)arg1;	// IMP=0x00100000005a75eb
- (void)viewDidLoad;	// IMP=0x00100000005a5d15
- (id)init;	// IMP=0x00100000005a5cc4
