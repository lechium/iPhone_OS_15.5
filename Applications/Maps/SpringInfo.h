...
- (id)description;	// IMP=0x001000000025078d
- (double)valueAtTime:(double)arg1;	// IMP=0x00100000002506f6
- (id)initWithMass:(double)arg1 stiffness:(double)arg2 damping:(double)arg3 initialVelocity:(double)arg4;	// IMP=0x001000000024fe22
