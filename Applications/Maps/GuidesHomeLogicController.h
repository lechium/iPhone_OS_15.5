...
- (void).cxx_destruct;	// IMP=0x00200000006b164a
...
- (void)scrollToSelectedFilter;	// IMP=0x00100000006b1460
- (id)routeToSelectedGuidesHomeFilterAtIndexPath:(id)arg1;	// IMP=0x00100000006b12d6
- (id)routeToSelectedAllCollectionsFilterAtIndexPath:(id)arg1;	// IMP=0x00100000006b12ce
- (id)routeToSelectedFilterAtIndexPath:(id)arg1;	// IMP=0x00100000006b12c6
- (id)selectedFilterIndexPath;	// IMP=0x00100000006b1276
- (void)initializeSectionsUsingMaxWidth:(double)arg1 traitEnvironment:(id)arg2;	// IMP=0x00100000006afdbc
- (id)itemsForSectionAtIndex:(unsigned long long)arg1;	// IMP=0x00100000006af97b
- (id)filterValueAtIndex:(unsigned long long)arg1;	// IMP=0x00100000006af8c4
- (id)sectionAtIndex:(unsigned long long)arg1;	// IMP=0x00100000006af81c
- (id)allSections;	// IMP=0x00100000006af7d4
- (void)appendBatchOfCollections:(id)arg1;	// IMP=0x00100000006af6d0
- (void)updateFilteredCollectionsFromResults:(id)arg1 collectionIds:(id)arg2;	// IMP=0x00100000006af2e0
- (void)willDisplayCellAtIndexpath:(id)arg1;	// IMP=0x00100000006af1e3
- (void)initializeFonts;	// IMP=0x00100000006af137
- (id)initWithGuidesHomeResult:(id)arg1 maxWidth:(double)arg2 traitEnvironment:(id)arg3 guideFetcher:(id)arg4 guideConsumer:(id)arg5 guideLocation:(id)arg6;	// IMP=0x00100000006aeff4
