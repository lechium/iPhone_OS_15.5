...
- (void).cxx_destruct;	// IMP=0x0020000000ae956f
...
- (id)chartViewDataRowID;	// IMP=0x0010000000ae94cc
- (id)chartViewDataValueForColumn:(id)arg1;	// IMP=0x0010000000ae93fc
- (id)columnsInChartView;	// IMP=0x0010000000ae93ef
