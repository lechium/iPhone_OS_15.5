...
- (void).cxx_destruct;	// IMP=0x0020000000b1083f
...
- (void)dragAndDropAnchorViewCellDidUpdateContent:(id)arg1;	// IMP=0x0010000000b107b8
- (void)dragAndDropItem:(id)arg1 didResolveMapItem:(id)arg2;	// IMP=0x0010000000b10758
@property(readonly, nonatomic) DragAndDropPreviewImage *renderPreviewImage;
- (CDStruct_02837cd9)presentationMapRectForMapItem:(id)arg1;	// IMP=0x0010000000b1059d
- (id)imageRepresentation;	// IMP=0x0010000000b100e7
- (void)updateWithSnapshot:(id)arg1;	// IMP=0x0010000000b10072
- (void)createSnapshot;	// IMP=0x0010000000b0fbfc
- (id)mapItem;	// IMP=0x0010000000b0fbc2
- (id)dragFeatures;	// IMP=0x0010000000b0fb06
- (id)initWithDragAndDropMapItem:(id)arg1 traitCollection:(id)arg2;	// IMP=0x0010000000b0fa0a
- (id)init;	// IMP=0x0010000000b0f9df
