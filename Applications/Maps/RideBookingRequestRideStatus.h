...
+ (id)statusWithApplication:(id)arg1 rideOption:(id)arg2 startingWaypointCoordinate:(struct CLLocationCoordinate2D)arg3 origin:(id)arg4 destination:(id)arg5 loadingRequestRideStatus:(_Bool)arg6 etaMinutesAtStartWaypoint:(id)arg7;	// IMP=0x0040000000706d6d
+ (id)statusWithApplication:(id)arg1 error:(unsigned long long)arg2;	// IMP=0x0010000000706d01
- (void).cxx_destruct;	// IMP=0x0010000000707149
...
- (id)description;	// IMP=0x0010000000706fd4
