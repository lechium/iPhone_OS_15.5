...
- (void).cxx_destruct;	// IMP=0x00200000009fc9b9
...
- (_Bool)needsReloadFromPreviousViewModel:(id)arg1;	// IMP=0x00100000009fc966
@property(readonly, nonatomic) UICollectionViewCellRegistration *cellRegistration;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000009fc7b5
@property(readonly) unsigned long long hash;
- (id)initWithButtonTitle:(id)arg1 dropDownTitles:(id)arg2 selectedIndex:(long long)arg3 delegate:(id)arg4 backgroundModel:(id)arg5;	// IMP=0x00100000009fc674
