...
- (void).cxx_destruct;	// IMP=0x00200000002bfb3c
...
- (void)updateWithRefinedWaypoints:(id)arg1;	// IMP=0x00100000002bf925
- (id)makeRouteAttributesBuilderWithNavigationMode:(unsigned long long)arg1;	// IMP=0x00100000002bf8bc
@property(readonly, nonatomic) CyclePreferences *cyclePreferences;
- (id)initWithPreferences:(id)arg1 timing:(id)arg2;	// IMP=0x00100000002bf815
