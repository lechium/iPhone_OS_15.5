...
+ (id)sharedController;	// IMP=0x00200000003f512f
- (void).cxx_destruct;	// IMP=0x00200000003f6026
...
- (long long)_computedLightLevel;	// IMP=0x00100000003f5a24
- (void)externalLightMonitorDidUpdate:(id)arg1;	// IMP=0x00100000003f59f3
- (void)astronomicalConditionMonitorDidUpdate:(id)arg1;	// IMP=0x00100000003f5850
- (void)ambientLightMonitorDidUpdate:(id)arg1;	// IMP=0x00100000003f581f
- (void)lightMonitorDidUpdate:(id)arg1;	// IMP=0x00100000003f5753
- (void)didUpdateMitigationNamed:(id)arg1;	// IMP=0x00100000003f5664
- (void)reloadForChangedLightLevelTrackers;	// IMP=0x00100000003f562e
- (void)removeObserver:(id)arg1;	// IMP=0x00100000003f55eb
- (void)addObserver:(id)arg1;	// IMP=0x00100000003f55b4
@property(readonly, nonatomic) _Bool shouldUseNightMode;
- (void)setCurrentLightLevel:(long long)arg1 forceUpdate:(_Bool)arg2;	// IMP=0x00100000003f531f
- (id)init;	// IMP=0x00100000003f5010
