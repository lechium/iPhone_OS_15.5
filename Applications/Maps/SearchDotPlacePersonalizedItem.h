...
- (void).cxx_destruct;	// IMP=0x0020000000860771
...
- (id)initWithSearchDotPlace:(id)arg1;	// IMP=0x001000000086028a
...
// Error: Property attributes should begin with the type ('T') attribute, property name: isRouteStartOrEnd
