...
- (void).cxx_destruct;	// IMP=0x00200000004d1e45
...
- (void)_scheduleUpdateHandlerWithDelay:(double)arg1;	// IMP=0x00100000004d1cb6
- (id)initWithThrottlingInterval:(double)arg1 updateHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000004d1a75
- (id)init;	// IMP=0x00100000004d1a59
