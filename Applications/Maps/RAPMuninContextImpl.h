...
@interface RAPMuninContextImpl : NSObject
{
    _Bool _muninLabelsEnabled;	// 8 = 0x8
    unsigned int _muninMetadataTileBuildId;	// 12 = 0xc
    unsigned long long _muninImageDataId;	// 16 = 0x10
    NSData *_muninSnapshotImageData;	// 24 = 0x18
...
- (void).cxx_destruct;	// IMP=0x002000000032b8e8
...
- (id)initWithMuninView:(id)arg1;	// IMP=0x001000000032b6a7
