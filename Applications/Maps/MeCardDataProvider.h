...
- (void).cxx_destruct;	// IMP=0x002000000061dc28
...
- (void)shortcutManagerMeCardDidChange:(id)arg1;	// IMP=0x001000000061dbf5
- (void)_updateMeCardAndNotifyObservers:(_Bool)arg1;	// IMP=0x001000000061d9ac
@property(readonly, nonatomic) GEOObserverHashTable *observers;
- (id)init;	// IMP=0x001000000061d896
