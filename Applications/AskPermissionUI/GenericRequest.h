...
- (void).cxx_destruct;	// IMP=0x0020000000007f45
...
- (id)compile;	// IMP=0x0010000000007cec
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000079ca
- (id)initWithDate:(id)arg1 identifier:(id)arg2 itemIdentifier:(id)arg3 localizations:(id)arg4 offerName:(id)arg5 status:(long long)arg6;	// IMP=0x00100000000078be
