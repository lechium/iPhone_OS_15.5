...
- (void).cxx_destruct;	// IMP=0x00200000000077bb
...
- (id)compile;	// IMP=0x00100000000070d5
- (id)initWithCloudPushDictionary:(id)arg1 bag:(id)arg2;	// IMP=0x00100000000059e8
- (id)initWithCloudPushDictionary:(id)arg1;	// IMP=0x0010000000005967
- (id)initWithApproverDSID:(id)arg1 date:(id)arg2 identifier:(id)arg3 itemBundleID:(id)arg4 itemDescription:(id)arg5 itemIdentifier:(id)arg6 itemTitle:(id)arg7 localizations:(id)arg8 offerName:(id)arg9 mocked:(_Bool)arg10 previewURL:(id)arg11 productType:(id)arg12 productTypeName:(id)arg13 productURL:(id)arg14 requesterName:(id)arg15 requesterDSID:(id)arg16 requestInfo:(id)arg17 status:(long long)arg18;	// IMP=0x00100000000056bc
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000005063
