...
- (void).cxx_destruct;	// IMP=0x002000000000a099
...
- (id)description;	// IMP=0x001000000000a012
- (id)compile;	// IMP=0x0010000000009efe
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000009ce6
- (id)initWithApprove:(id)arg1 body:(id)arg2 decline:(id)arg3 title:(id)arg4;	// IMP=0x0010000000009c0c
