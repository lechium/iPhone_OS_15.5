...
- (void).cxx_destruct;	// IMP=0x0020000000009bc3
...
- (id)compile;	// IMP=0x001000000000996a
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000009648
- (id)initWithDate:(id)arg1 identifier:(id)arg2 itemIdentifier:(id)arg3 localizations:(id)arg4 offerName:(id)arg5 status:(long long)arg6;	// IMP=0x001000000000953c
