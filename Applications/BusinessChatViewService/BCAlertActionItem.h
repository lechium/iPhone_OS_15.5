...
- (void).cxx_destruct;	// IMP=0x0020000000004aca
...
- (id)initWithTitle:(id)arg1 subTitle:(id)arg2 iconName:(id)arg3 actionType:(unsigned long long)arg4 handler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000004843
