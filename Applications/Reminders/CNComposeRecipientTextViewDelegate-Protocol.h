...
@class CNComposeRecipient, CNComposeRecipientAtom, CNComposeRecipientTextView, CNContact, MISSING_TYPE, NSArray, NSString, UIContextMenuConfiguration;

@protocol CNComposeRecipientTextViewDelegate <CNComposeHeaderViewDelegate, NSObject>

@optional
- (MISSING_TYPE *)chooseSelectedSearchResultForComposeRecipientView: /* Error: Ran out of types for this method. */;
