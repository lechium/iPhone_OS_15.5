...
+ (void)logDeviceList:(id)arg1;	// IMP=0x0020000000006ce8
...
- (id)loggableDescription;	// IMP=0x0010000000006cd6
- (_Bool)shouldBeHidden;	// IMP=0x0010000000006cce
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000006cc3
- (id)initWithName:(id)arg1;	// IMP=0x0010000000006ca9
- (id)initWithName:(id)arg1 upgradable:(_Bool)arg2 upgraded:(_Bool)arg3;	// IMP=0x0010000000006c28
