...
- (void).cxx_destruct;	// IMP=0x0020000000004fce
...
- (void)setSpecifierValue:(id)arg1 specifier:(id)arg2;	// IMP=0x0010000000004e41
- (id)specifierValue:(id)arg1;	// IMP=0x0010000000004d67
- (id)_specifierForItem:(id)arg1;	// IMP=0x0010000000004b76
- (void)_filterContentForSearchText:(id)arg1;	// IMP=0x00100000000046ba
- (_Bool)_isFiltering;	// IMP=0x0010000000004653
- (_Bool)_isSearchBarEmpty;	// IMP=0x00100000000045ba
- (void)updateSearchResultsForSearchController:(id)arg1;	// IMP=0x00100000000040d5
- (id)specifiers;	// IMP=0x0010000000004046
- (long long)tableViewStyle;	// IMP=0x001000000000403b
- (_Bool)_canShowWhileLocked;	// IMP=0x0010000000004033
- (void)viewDidLoad;	// IMP=0x0010000000003d99
- (void)dealloc;	// IMP=0x0010000000003cfe
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0010000000003aff
