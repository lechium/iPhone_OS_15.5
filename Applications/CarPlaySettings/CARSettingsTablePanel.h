...
- (void).cxx_destruct;	// IMP=0x002000000000f0e3
...
- (void)_performBatchUpdatesForReloadIndexPaths:(id)arg1 insertIndexPaths:(id)arg2 removeIndexPaths:(id)arg3;	// IMP=0x001000000000ee31
- (void)reloadSpecifiers;	// IMP=0x001000000000e263
- (id)preferredFocusEnvironments;	// IMP=0x001000000000e0e9
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000000e009
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x001000000000df6d
- (void)viewDidLoad;	// IMP=0x001000000000d7f8
