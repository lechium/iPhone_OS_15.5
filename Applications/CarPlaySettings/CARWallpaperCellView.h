...
- (void).cxx_destruct;	// IMP=0x002000000001249a
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00100000000121cf
- (_Bool)canBecomeFocused;	// IMP=0x00100000000121c7
- (struct CGSize)systemLayoutSizeFittingSize:(struct CGSize)arg1;	// IMP=0x0010000000012016
- (id)initWithWallpaper:(id)arg1 wallpaperPreferences:(id)arg2;	// IMP=0x0010000000010ef1
