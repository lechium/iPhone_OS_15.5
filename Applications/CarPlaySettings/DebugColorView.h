...
- (void).cxx_destruct;	// IMP=0x00200000000097fa
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x00100000000096f7
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x001000000000948b
- (_Bool)canBecomeFocused;	// IMP=0x0010000000009483
- (void)_tappyTap;	// IMP=0x0010000000009407
- (id)initWithModel:(id)arg1;	// IMP=0x00100000000088c2
