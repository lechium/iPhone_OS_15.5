...
+ (id)allModes;	// IMP=0x004000000001b05c
+ (id)modeWithFullTitle:(id)arg1 footer:(id)arg2 muteType:(unsigned long long)arg3 announceType:(long long)arg4;	// IMP=0x001000000001af24
- (void).cxx_destruct;	// IMP=0x002000000001b2ad
...
- (id)initWithFullTitle:(id)arg1 footer:(id)arg2 muteType:(unsigned long long)arg3 announceType:(long long)arg4;	// IMP=0x001000000001afab
