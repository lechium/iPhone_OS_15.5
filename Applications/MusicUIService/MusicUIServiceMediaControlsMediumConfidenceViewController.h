...
+ (_Bool)_isSecureForRemoteViewService;	// IMP=0x00200000000038f2
...
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0010000000003d7d
- (void)handleButtonActions:(id)arg1;	// IMP=0x0010000000003c9c
- (void)configureWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000003902
- (_Bool)_shouldRemoveViewFromHierarchyOnDisappear;	// IMP=0x00100000000038fa
- (void)presentAlert;	// IMP=0x0010000000002c8e
- (void)beginDiscoveryForCandidateRoute;	// IMP=0x0010000000002b69
- (_Bool)fetchCandidateOutputDevice;	// IMP=0x001000000000297e
- (void)configurePresentation;	// IMP=0x0010000000002937
- (id)connectionWithEndpoint:(id)arg1;	// IMP=0x001000000000262d
- (void)presentErrorAlert;	// IMP=0x0010000000002311
- (void)dismiss;	// IMP=0x001000000000226e
- (_Bool)prefersStatusBarHidden;	// IMP=0x0010000000002266
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000002225
