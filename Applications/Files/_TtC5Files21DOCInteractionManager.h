...
+ (void)setSharedManagerWith:(id)arg1 to:(id)arg2;	// IMP=0x0020000000047810
+ (void)clearSharedControllerFor:(id)arg1;	// IMP=0x0010000000047720
+ (id)sharedManagerFor:(id)arg1;	// IMP=0x0010000000047610
- (void).cxx_destruct;	// IMP=0x0040000000048140
