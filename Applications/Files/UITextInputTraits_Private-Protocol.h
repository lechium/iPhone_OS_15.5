...
@class NSIndexSet, NSString, UIColor, UIImage, UIInputContextHistory, UITextRange;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: underlineColorForTextAlternatives
