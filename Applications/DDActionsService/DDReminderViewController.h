...
+ (id)_exportedInterface;	// IMP=0x002000000000e710
+ (id)_remoteViewControllerInterface;	// IMP=0x001000000000e6d0
- (void).cxx_destruct;	// IMP=0x002000000000f780
...
- (_Bool)isAllDayDueDate;	// IMP=0x001000000000f6c0
...
- (void)setTitle:(id)arg1;	// IMP=0x001000000000f540
- (void)reminderCreationViewController:(id)arg1 didCreateReminder:(_Bool)arg2 error:(id)arg3;	// IMP=0x001000000000f460
- (void)setCancellable:(_Bool)arg1;	// IMP=0x001000000000f400
- (void)adaptForPresentationInPopover:(_Bool)arg1;	// IMP=0x001000000000f3e0
- (void)prepareForAction:(id)arg1;	// IMP=0x001000000000e750
