...
- (void).cxx_destruct;	// IMP=0x00200000000087d0
...
- (void)updateForCurrentTraitCollection;	// IMP=0x0010000000007ea0
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x0010000000007d10
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000007cb0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2 bag:(id)arg3;	// IMP=0x0010000000007750
