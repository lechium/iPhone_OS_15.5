...
- (void).cxx_destruct;	// IMP=0x0020000000009dd6
@property(nonatomic) __weak id <ServiceAccountPageEmbeddedParent> embeddedParent; // @synthesize embeddedParent=_embeddedParent;
- (void)dismissViewControllerAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000009d11
- (void)dismissAnimated:(_Bool)arg1;	// IMP=0x0010000000009c9c
