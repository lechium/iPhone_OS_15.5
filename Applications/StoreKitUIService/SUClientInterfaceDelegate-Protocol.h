...
@class ISDialog, MISSING_TYPE, SUClientInterface, SUPreviewOverlayViewController, SUScriptInterface, SUTabBarController, UIViewController;
...
- (MISSING_TYPE *)clientInterface:exitStoreWithReason: /* Error: Ran out of types for this method. */;
