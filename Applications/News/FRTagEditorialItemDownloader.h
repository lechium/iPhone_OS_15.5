...
- (void).cxx_destruct;	// IMP=0x00200000000f7aab
...
- (void)downloadEditorialItemWithIDs:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000f73d0
- (id)initWithTagController:(id)arg1 editorialItemEntryManager:(id)arg2;	// IMP=0x00100000000f72e9
