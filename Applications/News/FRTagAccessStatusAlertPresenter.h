...
- (void)presentAlertForTagAccessStatus:(unsigned long long)arg1 withPresentingViewController:(id)arg2;	// IMP=0x001000000008eea5
- (id)initWithExplicitContentRestrictionAlertPresenter:(id)arg1;	// IMP=0x001000000008ee15
- (id)init;	// IMP=0x001000000008ecd0
