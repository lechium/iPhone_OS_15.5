...
+ (void)performOnCollectionView:(id)arg1 withUpdate:(CDUnknownBlockType)arg2 animated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x004000000009195d
- (void).cxx_destruct;	// IMP=0x0020000000092003
