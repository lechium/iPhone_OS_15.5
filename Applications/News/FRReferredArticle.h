...
- (void).cxx_destruct;	// IMP=0x00200000000e3829
...
- (id)headlineWithContentContext:(id)arg1;	// IMP=0x00100000000e3492
- (id)initWithArticleID:(id)arg1 sourceChannelID:(id)arg2 sectionData:(id)arg3 flintDocumentAssetHandle:(id)arg4 articleRecordData:(id)arg5 sourceChannelRecordData:(id)arg6 masterIssueRecordData:(id)arg7;	// IMP=0x00100000000e322e
