...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000065071
- (void).cxx_destruct;	// IMP=0x0020000000065173
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000064e21
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000064aa8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000006407c
