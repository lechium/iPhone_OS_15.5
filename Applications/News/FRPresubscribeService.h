...
- (void).cxx_destruct;	// IMP=0x00200000000a84da
...
- (void)_setHasUserBeenPresubscribed:(_Bool)arg1;	// IMP=0x00100000000a844e
- (_Bool)_hasUserBeenPresubscribed;	// IMP=0x00100000000a83fc
- (void)_subscribeToFeedIDs:(id)arg1 preSubscribedNotificationsChannelIDs:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000a7e49
- (void)subscriptionControllerDidResetToEmpty:(id)arg1;	// IMP=0x00100000000a7ddf
- (void)presubscribeToChannelsIfNeededWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000a7862
- (id)initWithAppConfigurationManager:(id)arg1 tagController:(id)arg2 subscriptionController:(id)arg3 purchaseController:(id)arg4 notificationManager:(id)arg5;	// IMP=0x00100000000a774c
- (id)init;	// IMP=0x00100000000a7607
