...
- (void).cxx_destruct;	// IMP=0x0020000000054d13
...
- (void)loadInRegistry:(id)arg1;	// IMP=0x0010000000052931
- (id)initWithCloudContext:(id)arg1 configurationManager:(id)arg2 appActivityMonitor:(id)arg3;	// IMP=0x001000000005287a
