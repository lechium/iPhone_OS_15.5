...
- (void).cxx_destruct;	// IMP=0x00200000000a3379
...
- (id)initWithLoadJSONOnce:(id)arg1 loadFontsOnce:(id)arg2 loadAssetURLsOnce:(id)arg3 loadAssetsOnce:(id)arg4 loadLinkedContentOnce:(id)arg5;	// IMP=0x00100000000a3245
